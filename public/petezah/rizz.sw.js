  ...
  class i extends e.EventEmitter {
    ...
    async fetch({ request: i }) {
      ...
      try {
        ...
        if (
          ('blob:' === c.meta.url.protocol && ((d.blob = !0), (d.base = d.url = new URL(d.url.pathname))),
          i.referrer && i.referrer.startsWith(location.origin))
        ) {
          const e = new URL(c.sourceUrl(i.referrer));
          ((d.headers.origin || (c.meta.url.origin !== e.origin && 'cors' === i.mode)) && (d.headers.origin = e.origin),
        ...
        if (
          (f.headers['set-cookie'] &&
            (Promise.resolve(c.cookie.setCookies(f.headers['set-cookie'], l, c.meta)).then(() => {
        ...
        return (
          'text/event-stream' === d.headers.accept && (f.headers['content-type'] = 'text/event-stream'),
          ...
          ? (console.error(e),
            (function (e, t, r) {
              ...
              !(function (e) {
                ...
                ? ((i = 500), (s = 'Error processing your request'), (n = 'Internal Server Error'), (o = e instanceof Error ? e.name : 'UNKNOWN'))
                : ((i = e.status), (s = 'Error communicating with the Bare server'), (n = e.body.message), (o = e.body.code), (a = e.body.id));
              return new Response(
                (function (e, t, r, i, s, o, n) {
                  if ('The specified host could not be resolved.' === i)
                    return (function (e, t) {
                      const r = new URL(e),
                        i = `remoteHostname.textContent = ${JSON.stringify(r.hostname)};bareServer.href = ${JSON.stringify(t)};uvHostname.textContent = ${JSON.stringify(location.hostname)};reload.addEventListener("click", () => location.reload());uvVersion.textContent = ${JSON.stringify('1.0.11')};`;
                  ...
                  const a =
                    ...
                    `uvVersion.textContent = ${JSON.stringify('1.0.11')};`;
                  return (
