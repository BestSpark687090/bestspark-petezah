!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : t(
          ((e =
            "undefined" != typeof globalThis ? globalThis : e || self).BareMux =
            {}),
        );
})(this, function (e) {
  "use strict";
  ...
  function i(e) {
    ...
    return (
      s.call(e, { message: { type: "ping" }, port: t.port2 }, [t.port2]),
      r
    );
  }
  function l(e, t) {
  ...
  class p {
    ...
    async sendMessage(e, t) {
      ...
      return (s.call(this.port, { message: e, port: r.port2 }, a), await o);
    }
  }
    ...
    async fetch(e, r) {
      ...
      for (let e = 0; ; e++) {
        let t = (
          ...
          o = new Response(b.includes(t.status) ? void 0 : t.body, {
            headers: new Headers(t.headers),
            status: t.status,
            statusText: t.statusText,
          });
        ((o.rawHeaders = t.headers), (o.finalURL = c.toString()));
        const i = r?.redirect || a.redirect;
        if (!y.includes(o.status)) return o;
        switch (i) {
          case "follow": {
              ...
              (e.ready || (await e.init()),
                await (async function (e, t, r) {
                  ...
                  a.body instanceof ArrayBuffer
                    ? s.call(t, { type: "fetch", fetch: a }, [a.body])
                    : s.call(t, { type: "fetch", fetch: a });
                })(a, r, e));
            } catch (e) {
              w(r, e, "fetch");
            }
              ...
              (e.ready || (await e.init()),
                await (async function (e, t, r) {
                  const [a, o] = r.connect(
                    ...
                    (t) => {
                      s.call(e.websocket.channel, { type: "open", args: [t] });
                    },
                    (t) => {
                    ...
                    (t) => {
                      s.call(e.websocket.channel, { type: "error", args: [t] });
                    },
                  );
