...
!((t, e) => {
  ...
  function d(t, e) {
    while (!Object.prototype.hasOwnProperty.call(t, e) && null !== (t = s(t)));
    return t;
  }
  function y() {
    return (
  ...
  function g(t, e) {
    ...
    if (!n) {
      if (
        ...
        return {
          s: i,
          n: () => (r >= t.length ? { done: !0 } : { done: !1, value: t[r++] }),
          e: (t) => {
            throw t;
          },
          f: i,
  ...
  var b,
    ...
    E = (t, e, n) => {
      var r = t.type,
        i = t.data;
      return _ && i instanceof Blob
        ? e
          ? n(i)
          : R(i, n)
        : O && (i instanceof ArrayBuffer || A(i))
          ? e
            ? n(i)
            : R(new Blob([i]), n)
          : n(m[r] + (i || ""));
  ...
  var L,
    ...
    x = (t, e) => {
      if ("string" != typeof t) return { type: "message", data: j(t, e) };
      var n = t.charAt(0);
      return "b" === n
        ? { type: "message", data: P(t.substring(1), e) }
        : k[n]
          ? t.length > 1
            ? { type: k[n], data: t.substring(1) }
            : { type: k[n] }
          : w;
    },
    P = (t, e) => {
  ...
  function F(t) {
    for (
      ...
      n[r - 1] = arguments[r];
    return n.reduce((e, n) => (t.hasOwnProperty(n) && (e[n] = t[n]), e), {});
  }
  var U = D.setTimeout,
    M = D.clearTimeout;
  function V(t, e) {
    e.useNativeTimers
      ? ((t.setTimeoutFn = U.bind(D)), (t.clearTimeoutFn = M.bind(D)))
      : ((t.setTimeoutFn = D.setTimeout.bind(D)),
        (t.clearTimeoutFn = D.clearTimeout.bind(D)));
  }
  function H(t) {
      ...
      return (
        r(i, [
          ...
          },
          {
            key: "onData",
            value: function (t) {
              var e = x(t, this.socket.binaryType);
              this.onPacket(e);
            },
          },
          {
  ...
  function et(t) {
    var e = t.xdomain;
    try {
      if ("undefined" != typeof XMLHttpRequest && (!e || tt))
        return new XMLHttpRequest();
    } catch (t) {}
    if (!e)
      try {
        return new D[["Active"].concat("Object").join("X")](
          "Microsoft.XMLHTTP",
        );
      } catch (t) {}
  }
  function nt() {}
  var rt = null != new et({ xdomain: !1 }).responseType,
    it = ((t) => {
      o(s, t);
      var n = p(s);
      function s(t) {
      ...
      return (
        r(s, [
          ...
          },
          {
            ...
            value: function (t) {
              (((t, e) => {
                for (var n = t.split(q), r = [], i = 0; i < n.length; i++) {
                  var o = x(n[i], e);
          ...
          },
          {
            key: "doWrite",
            value: function (t, e) {
              var r = this.request({ method: "POST", data: t });
              (r.on("success", e),
                r.on("error", (t, e) => {
          ...
          },
          {
            ...
            value: function (t) {
              if (void 0 !== this.xhr && null !== this.xhr) {
                if (((this.xhr.onreadystatechange = nt), t))
                  try {
                    this.xhr.abort();
                  } catch (t) {}
                ("undefined" != typeof document &&
  ...
  if (
    ((ot.requestsCount = 0), (ot.requests = {}), "undefined" != typeof document)
  )
    if ("function" == typeof attachEvent) attachEvent("onunload", st);
    else if ("function" == typeof addEventListener) {
      addEventListener("onpagehide" in D ? "pagehide" : "unload", st, !1);
    }
  function st() {
    for (var t in ot.requests)
      ot.requests.hasOwnProperty(t) && ot.requests[t].abort();
  }
  var at =
      "function" == typeof Promise && "function" == typeof Promise.resolve
        ? (t) => Promise.resolve().then(t)
        : (t, e) => e(t, 0),
    ct = D.WebSocket || D.MozWebSocket,
    ut =
          ...
          { key: "name", get: () => "websocket" },
          {
            ...
            value: function () {
              if (this.check()) {
                ...
                try {
                  this.ws = ut ? new ct(t, e, n) : e ? new ct(t, e) : new ct(t);
                } catch (t) {
  ...
  var ft = ((t) => {
          ...
          { key: "name", get: () => "webtransport" },
          {
            ...
            value: function () {
              ...
              "function" == typeof WebTransport &&
                ...
                this.transport.closed.then(() => t.onClose()),
                this.transport.ready.then(() => {
                  t.transport.createBidirectionalStream().then((e) => {
                    var n,
                      r = e.readable.getReader();
                    t.writer = e.writable.getWriter();
                    !(function e() {
                      r.read().then((r) => {
                        var i = r.done,
                          o = r.value;
                        i ||
                          (n || 1 !== o.byteLength || 54 !== o[0]
                            ? (t.onPacket(
                                ((t, e, n) => {
                                  L || (L = new TextDecoder());
                                  var r = e || t[0] < 48 || t[0] > 54;
                                  return x(r ? t : L.decode(t), n);
                                })(o, n, "arraybuffer"),
                              ),
                              (n = !1))
                            : (n = !0),
              ...
              for (
                var n = (n) => {
                    var r = t[n],
                      i = n === t.length - 1;
                    !((t, e) => {
                      _ && t.data instanceof Blob
                        ? t.data.arrayBuffer().then(T).then(e)
    ...
    lt = { websocket: ht, webtransport: ft, polling: it },
    pt =
  ...
  function yt(t) {
    ...
    for (var i, o, s = pt.exec(t || ""), a = {}, c = 14; c--; )
      a[dt[c]] = s[c] || "";
    return (
      -1 != n &&
        -1 != r &&
    ...
    function a(n) {
      ...
      return (
        ...
        n
          ...
          : o.host && (o.hostname = yt(o.host).host),
        V(f(r), o),
        (r.secure =
          null != o.secure
            ? o.secure
        ...
        "string" == typeof r.opts.query && (r.opts.query = H(r.opts.query)),
        (r.id = null),
        (r.upgrades = null),
        (r.pingInterval = null),
        (r.pingTimeout = null),
  ...
  ((vt.protocol = 4), vt.protocol);
  var gt = "function" == typeof ArrayBuffer,
    mt = Object.prototype.toString,
    kt =
      "function" == typeof Blob ||
      ("undefined" != typeof Blob &&
        "[object BlobConstructor]" === mt.call(Blob)),
    bt =
      "function" == typeof File ||
      ("undefined" != typeof File &&
        "[object FileConstructor]" === mt.call(File));
  function wt(t) {
    return (
      (gt &&
        (t instanceof ArrayBuffer ||
  ...
  function _t(e, n) {
    ...
    if (Array.isArray(e)) {
      for (var r = 0, i = e.length; r < i; r++) if (_t(e[r])) return !0;
      return !1;
    }
    if (wt(e)) return !0;
    if (e.toJSON && "function" == typeof e.toJSON && 1 === arguments.length)
      return _t(e.toJSON(), !0);
    for (var o in e)
      if (Object.prototype.hasOwnProperty.call(e, o) && _t(e[o])) return !0;
    return !1;
  }
  function Ot(t) {
    var e = [],
  ...
  function At(e, n) {
    ...
    if ("object" === t(e) && !(e instanceof Date)) {
      var s = {};
      for (var a in e)
        Object.prototype.hasOwnProperty.call(e, a) && (s[a] = At(e[a], n));
      return s;
    }
    return e;
  }
  function Et(t, e) {
    return ((t.data = Rt(t.data, e)), delete t.attachments, t);
  }
  function Rt(e, n) {
    if (!e) return e;
    ...
    if (Array.isArray(e)) for (var r = 0; r < e.length; r++) e[r] = Rt(e[r], n);
    else if ("object" === t(e))
      for (var i in e)
        Object.prototype.hasOwnProperty.call(e, i) && (e[i] = Rt(e[i], n));
    return e;
  }
  var Tt,
    Ct = [
      ...
      r(t, [
        {
          key: "encode",
          value: function (t) {
            return (t.type !== Tt.EVENT && t.type !== Tt.ACK) || !_t(t)
              ? [this.encodeAsString(t)]
              : this.encodeAsBinary({
                  type: t.type === Tt.EVENT ? Tt.BINARY_EVENT : Tt.BINARY_ACK,
                  nsp: t.nsp,
                  data: t.data,
                  id: t.id,
                });
        ...
        },
        {
          ...
          value: function (t) {
            var e = "" + t.type;
            return (
              (t.type !== Tt.BINARY_EVENT && t.type !== Tt.BINARY_ACK) ||
                (e += t.attachments + "-"),
              t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
              null != t.id && (e += t.id),
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if ("string" == typeof t) {
                  ...
                  var n = (e = this.decodeString(t)).type === Tt.BINARY_EVENT;
                  n || e.type === Tt.BINARY_ACK
                    ? ((e.type = n ? Tt.EVENT : Tt.ACK),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (n.type === Tt.BINARY_EVENT || n.type === Tt.BINARY_ACK) {
        ...
        r(t, [
          {
            ...
            value: function (t) {
              if (
                ...
                var e = Et(this.reconPack, this.buffers);
        ...
        r(a, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i = { type: Tt.EVENT, data: n, options: {} };
              if (
            ...
            value: function (t, e) {
              ...
              if (void 0 !== i) {
                var o = this.io.setTimeoutFn(() => {
                  delete this.acks[t];
                  for (var n = 0; n < this.sendBuffer.length; n++)
                ...
                if (r === this._queue[0]) {
                  ...
                  if (i)
                    ...
                    for (
                      ...
                      s[a - 1] = arguments[a];
                    e.apply(void 0, [null].concat(s));
                  }
                  return ((r.pending = !1), this._drainQueue());
                }
              }),
                this._queue.push(r),
                this._drainQueue());
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (y(s(a.prototype), "emit", this).apply(this, t),
                this._pid &&
                  t.length &&
              ...
              return () => {
                if (!n) {
                  ...
                  for (
                    ...
                    i[o] = arguments[o];
                  this.packet({ type: Tt.ACK, id: t, data: i });
                }
              };
            },
          },
          ...
          },
          {
            ...
            value: function () {
              return (
                this.connected && this.packet({ type: Tt.DISCONNECT }),
                this.destroy(),
        ...
        r(s, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.engine = new vt(this.uri, this.opts);
              var n = this.engine;
              ...
              var i = Pt(n, "open", () => {
                ...
                o = (n) => {
                  (this.cleanup(),
                    ...
                    t ? t(n) : this.maybeReconnectOnOpen());
                },
                s = Pt(n, "error", o);
              if (!1 !== this._timeout) {
                var a = this._timeout,
            ...
            value: function (t, e) {
              ...
              return (
                n
                  ...
                  : ((n = new qt(this, t, e)), (this.nsps[t] = n)),
                n
              );
            },
          },
  ...
  function Ut(e, n) {
    ...
    var r,
      ...
      s = i.id,
      a = i.path,
      c = Ft[s] && a in Ft[s].nsps;
    return (
      n.forceNew || n["force new connection"] || !1 === n.multiplex || c
        ? (r = new Dt(o, n))
        : (Ft[s] || (Ft[s] = new Dt(o, n)), (r = Ft[s])),
      i.query && !n.query && (n.query = i.queryKey),
      r.socket(i.path, n)
    );
  }
  return (i(Ut, { Manager: Dt, Socket: qt, io: Ut, connect: Ut }), Ut);
});
