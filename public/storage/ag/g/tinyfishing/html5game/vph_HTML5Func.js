...
function js_UpdateInvisibleButton(buttonID, x1, y1, x2, y2, link, active) {
  ...
  btn.style.left =
    Number.parseInt(canvas.style.left, 10) + x1 * scale_scr + "px"; //(wbr-scale_scr * game_width)/2 + x - width * 0.5 + "px";
  btn.style.top = Number.parseInt(canvas.style.top, 10) + y1 * scale_scr + "px"; //(hbr-scale_scr * game_height)/2 + y - height * 0.5 + "px";
