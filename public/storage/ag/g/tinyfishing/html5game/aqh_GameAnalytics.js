        ...
        s = (() => {
          ...
          return (
            ...
            (n.validateArrayOfStrings = (e, n, i, r, s) => {
              ...
              if ((o || (o = "Array"), !s))
                return (
                  t.i(o + " validation failed: array cannot be null. "),
                  !1
                );
              if (0 == i && 0 == s.length)
                return (
                  t.i(o + " validation failed: array cannot be empty. "),
                  !1
                );
              if (e > 0 && s.length > e)
                return (
        ...
        return (
          ...
          (e.getStore = (n) => {
            switch (n) {
              ...
              default:
                return (
                  i.w("GAStore.getStore(): Cannot find store: " + n),
                  null
                );
            }
          }),
        ...
        c = (() => {
          ...
          return (
            ...
            (n.getSdkConfig = () => {
              ...
              var e,
                t = 0;
              for (var i in n.instance.sdkConfigCached)
                (0 === t && (e = i), ++t);
              return e && t > 0
