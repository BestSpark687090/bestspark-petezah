    ...
    Call() {
      if (-1 === this._timerId) {
        const e = Date.now(),
          ...
          n = this._interval;
        t >= n && this._canRunImmediate
          ? ((this._lastCallTime = e), this._RunCallback())
  ...
  (window.DOMElementHandler = class extends DOMHandler {
    constructor(e, t) {
      (super(e, t),
        ...
        this.AddRuntimeMessageHandler("set-visible", (e) =>
          this._OnSetVisible(e),
        ),
        this.AddRuntimeMessageHandler("update-position", (e) =>
          this._OnUpdatePosition(e),
        ),
        this.AddRuntimeMessageHandler("update-state", (e) =>
          this._OnUpdateState(e),
        ),
        this.AddRuntimeMessageHandler("focus", (e) => this._OnSetFocus(e)),
        this.AddRuntimeMessageHandler("set-css-style", (e) =>
          this._OnSetCssStyle(e),
        ));
    }
    SetAutoAttach(e) {
      this._autoAttach = !!e;
  ...
  "use strict");
{
  function t(e) {
    if (e.isStringSrc) {
      ...
      ((t.async = !1), (t.textContent = e.str), document.head.appendChild(t));
    } else
  ...
  window.RuntimeInterface = class e {
    constructor(e) {
      ((this._useWorker = e.useWorker),
        ...
        "cordova" === this._exportType
          ? document.addEventListener("deviceready", () => this._Init(e))
          : this._Init(e));
    }
    Release() {
    ...
    async _Init(e) {
      if ("playable-ad" === this._exportType) {
        ...
        for (let t = 0, n = e.engineScripts.length; t < n; ++t) {
          ...
          this._localFileStrings.hasOwnProperty(n)
            ? (e.engineScripts[t] = {
                isStringSrc: !0,
                str: this._localFileStrings[n],
              })
            : this._localFileBlobs.hasOwnProperty(n) &&
              (e.engineScripts[t] = URL.createObjectURL(
                this._localFileBlobs[n],
              ));
        }
      }
      ...
      ((this._messageChannelPort = t.port1),
        ...
        this._useWorker
          ? await this._InitWorker(e, t.port2)
          : await this._InitDOM(e, t.port2));
    }
    _GetWorkerURL(e) {
      return this._workerScriptBlobURLs.hasOwnProperty(e)
        ? this._workerScriptBlobURLs[e]
        : e.endsWith("/workermain.js") &&
            this._workerScriptBlobURLs.hasOwnProperty("workermain.js")
          ? this._workerScriptBlobURLs["workermain.js"]
          : "playable-ad" === this._exportType &&
              this._localFileBlobs.hasOwnProperty(e.toLowerCase())
            ? URL.createObjectURL(this._localFileBlobs[e.toLowerCase()])
            : e;
    }
    async CreateWorker(t, n, o) {
      if (t.startsWith("blob:")) return new Worker(t, o);
      if (this.IsiOSCordova()) {
        const e = await this.CordovaFetchLocalFileAsArrayBuffer(
            this._scriptFolder + t,
          ),
          n = new Blob([e], { type: "application/javascript" });
    ...
    async _InitWorker(e, t) {
      ...
      (document.body.appendChild(this._canvas),
        ...
        this._worker.postMessage(
          Object.assign(this._GetCommonRuntimeOptions(e), {
            type: "init-runtime",
            isInWorker: !0,
            messagePort: t,
            canvas: a,
        ...
        (self.c3_callFunction = (e, t) =>
          this._runtimeDomHandler._InvokeFunctionFromJS(e, t)),
    ...
    async _InitDOM(n, a) {
      ((this._canvas = document.createElement("canvas")),
        ...
        (this._domHandlers = i.map((e) => new e(this))),
        this._FindRuntimeDOMHandler());
      const o = n.engineScripts.map((e) =>
        "string" == typeof e ? new URL(e, this._baseUrl).toString() : e,
      );
      if (
        (Array.isArray(n.workerDependencyScripts) &&
          o.unshift(...n.workerDependencyScripts),
        ...
        try {
          if (
            (await Promise.all(n.projectScripts.map((e) => t(e[1]))),
            Object.values(e).some((e) => !e))
          )
            return void self.setTimeout(
              () => this._ReportProjectScriptError(e),
              100,
            );
        } catch (t) {
          return (
            console.error("[Preview] Error loading project scripts: ", t),
    ...
    _OnEventFromRuntime(t) {
      ...
      if (!e)
        return void console.warn(
          `[DOM] No event handlers for component '${n}'`,
        );
      const r = e.get(o);
      if (!r)
        return void console.warn(
          `[DOM] No handler '${o}' for component '${n}'`,
        );
      let d = null;
      try {
        d = r(a);
        ...
        return (
          console.error(`Exception in '${n}' handler '${o}':`, e),
          void (null !== i && this._PostResultToRuntime(i, !1, e.toString()))
        );
      }
      null !== i &&
        (d && d.then
          ? d
              .then((e) => this._PostResultToRuntime(i, !0, e))
              .catch((e) => {
                (console.error(`Rejection from '${n}' handler '${o}':`, e),
                  this._PostResultToRuntime(i, !1, e.toString()));
              })
    ...
    AddRuntimeComponentMessageHandler(e, t, n) {
      let a = y.get(e);
      if ((a || ((a = new Map()), y.set(e, a)), a.has(t)))
    ...
    async _WasmDecodeWebMOpus(e) {
      const t = await this.PostToRuntimeComponentAsync(
        "runtime",
        "opus-decode",
        { arrayBuffer: e },
        null,
    ...
    CordovaFetchLocalFile(e) {
      const t =
        window.cordova.file.applicationDirectory + "www/" + e.toLowerCase();
    ...
    _ParseDataURI(t) {
      const n = t.indexOf(",");
      if (0 > n) throw new URIError("expected comma in data: uri");
      ...
      return (
        (u =
          "base64" === d || "base64" === s ? atob(o) : decodeURIComponent(o)),
        { mime_type: e, data: u }
      );
    }
    _BinaryStringToBlob(t, n) {
      let a,
        ...
        e = i >> 2,
        r = new Uint8Array(i),
        s = new Uint32Array(r.buffer, 0, e);
      for (a = 0, o = 0; a < e; ++a)
        s[a] =
          t.charCodeAt(o++) |
          (t.charCodeAt(o++) << 8) |
          (t.charCodeAt(o++) << 16) |
          (t.charCodeAt(o++) << 24);
      for (let e = 3 & i; e--; ) ((r[o] = t.charCodeAt(o)), ++o);
    ...
    _TestTransferablesWork() {
      ...
      return (
        (o.port2.onmessage = (t) => {
          ((t.data && t.data.arrayBuffer) ||
            ((this._transferablesBroken = !0),
            console.warn(
              "MessageChannel transfers determined to be broken. Disabling transferables.",
            )),
            e());
        }),
        o.port1.postMessage({ arrayBuffer: n }, [n]),
        t
      );
    }
  };
}
{
  ...
  async function _(e, t, n) {
    ...
    return (
      ...
      (e = new Blob([o], { type: "image/svg+xml" })),
      await u(e)
    );
  }
  function e(e) {
  ...
  function c() {
    ...
    return (
      "textarea" === n ||
      ("input" === n ? a.has(t.type.toLowerCase() || "text") : e(t))
    );
  }
  const y = new Map([
      ["OSLeft", "MetaLeft"],
  ...
  ((self.C3_GetSvgImageSize = async function (e) {
    ...
    (self.C3_RasterSvgImageBlob = async function (t, n, a, o, r) {
      ...
      ((d.width = o), (d.height = r));
      const s = d.getContext("2d");
      return (s.drawImage(e, 0, 0, n, a), d);
    }));
  let p = !1;
  ...
  const b = class extends DOMHandler {
    constructor(t) {
      (super(t, "runtime"),
        ...
        t.AddRuntimeComponentMessageHandler("canvas", "update-size", (e) =>
          this._OnUpdateCanvasSize(e),
        ),
        t.AddRuntimeComponentMessageHandler("runtime", "invoke-download", (e) =>
          this._OnInvokeDownload(e),
        ),
        t.AddRuntimeComponentMessageHandler(
          "runtime",
          "raster-svg-image",
        ...
        t.AddRuntimeComponentMessageHandler("runtime", "register-sw", () =>
          this._OnRegisterSW(),
        ),
        t.AddRuntimeComponentMessageHandler(
          "runtime",
        ...
        t.AddRuntimeComponentMessageHandler("runtime", "go-to-script", (e) =>
        ...
        t.AddRuntimeComponentMessageHandler("runtime", "debug-highlight", (e) =>
          this._OnDebugHighlight(e),
        ),
        t.AddRuntimeComponentMessageHandler(
          "runtime",
        ...
        t.AddRuntimeComponentMessageHandler("runtime", "add-stylesheet", (e) =>
          this._OnAddStylesheet(e),
        ));
      ...
      (window.addEventListener("selectstart", f),
        ...
        window.addEventListener("touchstart", f, { passive: !1 }),
        "undefined" == typeof PointerEvent
          ? a.addEventListener("touchstart", f)
          : (window.addEventListener("pointerdown", f, { passive: !1 }),
            a.addEventListener("pointerdown", f)),
        (this._mousePointerLastButtons = 0),
        window.addEventListener("mousedown", (e) => {
          1 === e.button && e.preventDefault();
        }),
        window.addEventListener("mousewheel", g, { passive: !1 }),
    ...
    Attach() {
      (window.addEventListener("focus", () =>
        ...
        window.addEventListener("blur", () => {
          (this._PostRuntimeEvent("window-blur", { parentHasFocus: i() }),
            (this._mousePointerLastButtons = 0));
        }),
        ...
        window.addEventListener("dblclick", (e) =>
          this._OnMouseEvent("dblclick", e, l),
        ),
        ...
        "undefined" == typeof PointerEvent
          ...
          : (window.addEventListener("pointerdown", (e) =>
            ...
            "undefined" != typeof window.onpointerrawupdate
              ? ((this._pointerRawUpdateRateLimiter = new RateLimiter(
          ...
          (screen.lockOrientation
            ...
            : screen.webkitLockOrientation
              ...
              : screen.mozLockOrientation
                ...
                : screen.msLockOrientation && (t = screen.msLockOrientation(e)),
    ...
    _OnMouseEventAsPointer(e, n) {
      if (!t(n)) {
        ...
        ("pointerdown" === e && 0 !== t
          ? (e = "pointermove")
          : "pointerup" == e && 0 !== n.buttons && (e = "pointermove"),
          this._PostToRuntimeMaybeSync(
            e,
            {
              pointerId: 1,
    ...
    _OnPointerEvent(e, t) {
      ...
      let n = 0;
      if (
        ("mouse" === t.pointerType && (n = this._mousePointerLastButtons),
        this._PostToRuntimeMaybeSync(
          e,
          {
    ...
    _OnDeviceMotion(t) {
      ...
      a && (n = { x: a.x || 0, y: a.y || 0, z: a.z || 0 });
      let o = null;
      const i = t.accelerationIncludingGravity;
      i && (o = { x: i.x || 0, y: i.y || 0, z: i.z || 0 });
      let e = null;
      const r = t.rotationRate;
      (r &&
        (e = { alpha: r.alpha || 0, beta: r.beta || 0, gamma: r.gamma || 0 }),
        this.PostToRuntime(
          "devicemotion",
          {
            acceleration: n,
    ...
    _OnUpdateCanvasSize(e) {
      ...
      ((n.style.width = e.styleWidth + "px"),
        ...
        this._isFirstSizeUpdate &&
          ((n.style.display = ""), (this._isFirstSizeUpdate = !1)));
    }
    _OnInvokeDownload(t) {
      const n = t.url,
        o = t.filename,
    ...
    async _OnRasterSvgImage(t) {
      ...
      let u;
      return (
        (u = d ? await createImageBitmap(s, d) : await createImageBitmap(s)),
        { imageBitmap: u, transferables: [u] }
      );
    }
...
}
{
  ...
  self.JobSchedulerDOM = class {
    ...
    async _CreateJobWorker() {
      ...
      return (
        this._dispatchWorker.postMessage(
          { type: "_addJobWorker", port: o.port1 },
          [o.port1],
        ),
        a.postMessage(
          {
...
}
{
  function e(e, t) {
    return (
      e.length === t.length && (e === t || e.toLowerCase() === t.toLowerCase())
    );
  }
  const t = class extends DOMHandler {
    constructor(e) {
      (super(e, "audio"),
        ...
        (self.C3Audio_OnMicrophoneStream = (e, t) =>
          this._OnMicrophoneStream(e, t)),
    ...
    async _CreateAudioContext(e) {
      ...
      const t = { latencyHint: e.latencyHint };
    ...
    _ReconnectEffects(e) {
      ...
      if (n && n.length) {
        ...
        for (let e = 0, t = n.length; e < t; ++e) {
          const a = n[e];
          e + 1 === t
            ? a.ConnectTo(this.GetDestinationNode())
            : a.ConnectTo(n[e + 1].GetInputNode());
        }
      }
      for (const n of this.audioInstancesByTag(e)) n.Reconnect(t);
      this._microphoneSource &&
        this._microphoneTag === e &&
    ...
    DecodeAudioData(e, t) {
      return t
        ? this._iRuntime._WasmDecodeWebMOpus(e).then((e) => {
    ...
    *audioInstancesByTag(t) {
    ...
    _AddPendingTag(e) {
      ...
      if (!t) {
        ...
        ((t = { pendingCount: 0, promise: a, resolve: n }),
    ...
    _RemovePendingTag(e) {
      ...
      (t.pendingCount--,
        0 === t.pendingCount && (t.resolve(), this._pendingTags.delete(e)));
    }
    TagReady(e) {
    ...
    PostTrigger(e, t) {
      this.PostToRuntime("trigger", { type: e, tag: t });
    }
    async _Play(t) {
        ...
        ((this._lastAudioInstance = await this._GetAudioInstance(
          ...
          i
            ? (this._lastAudioInstance.SetPannerEnabled(!0),
              ...
              i.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(i.uid))
            : this._lastAudioInstance.SetPannerEnabled(!1),
          this._lastAudioInstance.Play(d, s, u, l));
      } catch (e) {
        return void console.error(
          "[Construct 3] Audio: error starting playback: ",
          e,
        );
      } finally {
      ...
      if ("filter" === n) i = new C3AudioFilterFX(this, ...o);
        ...
        try {
          ...
          return void console.log(
            "[Construct 3] Audio: error loading convolution: ",
            e,
          );
        }
    ...
    _SetEffectParam(t) {
      ...
      !d ||
        0 > a ||
        a >= d.length ||
        (d[a].SetParam(o, i, e, r), this._PostUpdatedFxState());
    }
    _RemoveEffects(e) {
    ...
    _DoPostUpdatedFxState() {
      ...
      (this.PostToRuntime("fxstate", { fxstate: e }),
        (this._isPendingPostFxState = !1));
    }
    ...
    _OnMicrophoneStream(e, t) {
      (this._microphoneSource && this._microphoneSource.disconnect(),
        ...
        (this._microphoneSource =
          this._audioContext.createMediaStreamSource(e)),
...
("use strict",
  (self.C3AudioBuffer = class {
    ...
    static Create(t, n, a, o, i) {
      ...
      return (
        i && e && t._SetHasAnySoftwareDecodedMusic(),
        !i || t.IsPlayMusicAsSound() || e
          ? new C3WebAudioBuffer(t, n, a, o, i, e)
          : new C3Html5AudioBuffer(t, n, a, o, i)
      );
    }
    CreateInstance(e) {
      return "html5" === this._api
        ? new C3Html5AudioInstance(this._audioDomHandler, this, e)
        : new C3WebAudioInstance(this._audioDomHandler, this, e);
    }
    _Load() {}
    Load() {
      return (
  ...
  (self.C3WebAudioBuffer = class extends C3AudioBuffer {
    ...
    async _Fetch() {
      ...
      if ("cordova" === e.GetExportType() && e.IsRelativeURL(this._url))
        ...
        if (!e.ok)
          throw new Error(
            `error fetching audio data: ${e.status} ${e.statusText}`,
          );
    ...
    async _Decode() {
      return this._audioBuffer
        ? this._audioBuffer
        : void ((this._audioBuffer =
            await this._audioDomHandler.DecodeAudioData(
              this._audioData,
    ...
    async _Load() {
      try {
        ...
        ((this._loadState = "failed"),
          console.error(
            `[Construct 3] Failed to load audio '${this._url}': `,
            e,
          ));
      }
    }
  ...
  self.C3AudioInstance = class {
    ...
    Tick(e) {
      -1 !== this._fadeEndTime &&
        ...
        this._audioDomHandler.PostTrigger("fade-ended", this._tag));
    }
    GetOverallVolume() {
    ...
    SetPanXYA(e, t, n) {
      this._isPannerEnabled &&
        (this._pannerNode.setPosition(e, t, 0),
    ...
    GetPanState() {
      ...
      return {
        ...
        orient: [
          e.orientationX.value,
          e.orientationY.value,
          e.orientationZ.value,
        ],
    ...
    Play(e, t, n) {
      ...
      if (
        ...
        try {
          ...
          console.warn(
            `[Construct 3] Exception seeking audio '${this._buffer.GetUrl()}' to position '${n}': `,
            e,
          );
        }
  ...
  (self.C3WebAudioInstance = class extends C3AudioInstance {
    ...
    GetPlaybackTime(e) {
      ...
      return (
        (t = this._isPaused
          ...
          : this.GetCurrentTime() - this._startTime),
        e && (t *= this._playbackRate),
        this._isLooping || (t = Math.min(t, this.GetDuration())),
        t
      );
    ...
    Resume() {
      !this._isPaused ||
        ...
        (this._startTime =
          this.GetCurrentTime() -
          this._resumePosition / (this._playbackRate || 0.001)),
    ...
    SetAudioParam(t, n, a, o) {
      ...
      ((o += i),
        0 === a
          ...
          : 1 === a
            ? (t.setValueAtTime(t.value, i), t.linearRampToValueAtTime(n, o))
            : 2 === a
              ? (t.setValueAtTime(t.value, i),
                t.exponentialRampToValueAtTime(n, o))
              : void 0);
    }
    GetState() {
  ...
  ((self.C3AudioFilterFX = class extends e {
    ...
    SetParam(e, t, n, a) {
      0 === e
        ? ((t = Math.max(Math.min(t / 100, 1), 0)),
          ...
          this.SetAudioParam(this._dryNode.gain, 1 - t, n, a))
        : 1 === e
          ? ((this._params[1] = t),
            this.SetAudioParam(this._filterNode.frequency, t, n, a))
          : 2 === e
            ? ((this._params[2] = t),
              this.SetAudioParam(this._filterNode.detune, t, n, a))
            : 3 === e
              ? ((this._params[3] = t),
                this.SetAudioParam(this._filterNode.Q, t, n, a))
              : 4 === e
                ? ((this._params[4] = t),
                  this.SetAudioParam(this._filterNode.gain, t, n, a))
                : void 0;
    }
  }),
      ...
      SetParam(t, a, o, i) {
        0 === t
          ? ((a = Math.max(Math.min(a / 100, 1), 0)),
            ...
            this.SetAudioParam(this._dryNode.gain, 1 - a, o, i))
          : 4 === t
            ? ((this._params[1] = n(a)),
              this.SetAudioParam(this._delayGainNode.gain, n(a), o, i))
            : 5 === t
              ? ((this._params[0] = a),
                this.SetAudioParam(this._delayNode.delayTime, a, o, i))
              : void 0;
      }
    }),
      ...
      SetParam(e, t, n, a) {
        0 === e
          ? ((t = Math.max(Math.min(t / 100, 1), 0)),
            ...
            this.SetAudioParam(this._dryNode.gain, 1 - t / 2, n, a))
          : 6 === e
            ? ((this._params[1] = t / 1e3),
              this.SetAudioParam(this._oscGainNode.gain, t / 1e3, n, a))
            : 7 === e
              ? ((this._params[2] = t),
                this.SetAudioParam(this._oscNode.frequency, t, n, a))
              : 8 === e
                ? ((this._params[3] = t / 100),
                  this.SetAudioParam(this._feedbackNode.gain, t / 100, n, a))
                : void 0;
      }
    }),
          ...
          : 1 === e
            ...
            : 2 === e
              ...
              : 3 === e
                ...
                : 6 === e
                  ? ((this._params[3] = t),
                    this.SetAudioParam(this._oscGainNode.gain, t, n, a))
                  : 7 === e
                    ? ((this._params[4] = t),
                      this.SetAudioParam(this._oscNode.frequency, t, n, a))
                    : void 0;
    ...
    (self.C3AudioGainFX = class extends e {
      ...
      SetParam(t, a, o, i) {
        4 === t
          ? ((this._params[0] = n(a)),
            this.SetAudioParam(this._node.gain, n(a), o, i))
          : void 0;
      }
    }),
      ...
      SetParam(e, t, n, a) {
        0 === e
          ? ((t = Math.max(Math.min(t / 100, 1), 0)),
            ...
            this.SetAudioParam(this._oscGainNode.gain.value, t / 2, n, a))
          : 7 === e
            ? ((this._params[0] = t),
              this.SetAudioParam(this._oscNode.frequency, t, n, a))
            : void 0;
...
}
{
  const e = class extends DOMHandler {
    constructor(e) {
      (super(e, "mouse"),
        this.AddRuntimeMessageHandler("cursor", (e) =>
          this._OnChangeCursorStyle(e),
        ));
    }
...
}
{
  const e = class extends DOMHandler {
    ...
    async _OnRequestPermission(e) {
      ...
      let n = !0;
      (0 === t
        ? (n = await this._RequestOrientationPermission())
        : 1 === t && (n = await this._RequestMotionPermission()),
        this.PostToRuntime("permission-result", { type: t, result: n }));
    }
    async _RequestOrientationPermission() {
      ...
      try {
        ...
        return (
          console.warn("[Touch] Failed to request orientation permission: ", e),
          !1
        );
      }
    }
    async _RequestMotionPermission() {
      ...
      try {
        ...
        return (
          console.warn("[Touch] Failed to request motion permission: ", e),
          !1
        );
      }
    }
...
}
{
  const e = class extends DOMHandler {
    constructor(e) {
      (super(e, "browser"),
        (this._exportType = ""),
        this.AddRuntimeMessageHandler("get-initial-state", (e) =>
          this._OnGetInitialState(e),
        ),
        this.AddRuntimeMessageHandler("ready-for-sw-messages", () =>
          this._OnReadyForSWMessages(),
        ),
        ...
        this.AddRuntimeMessageHandler("lock-orientation", (e) =>
          this._OnLockOrientation(e),
        ),
        this.AddRuntimeMessageHandler("unlock-orientation", () =>
          this._OnUnlockOrientation(),
        ),
        this.AddRuntimeMessageHandler("navigate", (e) => this._OnNavigate(e)),
        this.AddRuntimeMessageHandler("request-fullscreen", (e) =>
          this._OnRequestFullscreen(e),
        ),
        this.AddRuntimeMessageHandler("exit-fullscreen", () =>
        ...
        "undefined" != typeof Windows &&
          Windows.UI.Core.SystemNavigationManager.getForCurrentView().addEventListener(
            "backrequested",
            (e) => this._OnWin10BackRequested(e),
          ));
    }
    ...
    _OnOnlineStateChanged(e) {
      this.PostToRuntime("online-state", { isOnline: e });
    }
    ...
    _OnLockOrientation(e) {
      ...
      if (screen.orientation && screen.orientation.lock)
        ...
        try {
          let e = !1;
          (screen.lockOrientation
            ? (e = screen.lockOrientation(t))
            : screen.webkitLockOrientation
              ? (e = screen.webkitLockOrientation(t))
              : screen.mozLockOrientation
                ? (e = screen.mozLockOrientation(t))
                : screen.msLockOrientation && (e = screen.msLockOrientation(t)),
    ...
    _OnNavigate(e) {
      ...
      if ("back" === t)
        ...
        const t = e.url,
          n = e.target,
          a = e.exportType;
        "windows-uwp" === a && "undefined" != typeof Windows
    ...
    _OnRequestFullscreen(e) {
      const t = { navigationUI: "auto" },
        n = e.navUI;
      1 === n
        ? (t.navigationUI = "hide")
        : 2 === n && (t.navigationUI = "show");
      const a = document.documentElement;
      a.requestFullscreen
        ? a.requestFullscreen(t)
