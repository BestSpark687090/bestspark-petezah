...
var __extends =
  ...
  (function () {
    ...
    return function (e, i) {
      ...
      e.prototype =
        i === null ? Object.create(i) : ((a.prototype = i.prototype), new a());
    };
  })();
var dragonBones;
    ...
    i.prototype._updateGlobalTransformMatrix = function (e) {
      ...
      if (this.offsetMode === 1) {
        ...
        s.rotation =
          ...
          this.animationPose.rotation;
        s.scaleX =
          this.origin.scaleX * this.offset.scaleX * this.animationPose.scaleX;
        s.scaleY =
          this.origin.scaleY * this.offset.scaleY * this.animationPose.scaleY;
      ...
      if (t >= 0 && this._cachedFrameIndices !== null) {
        ...
        if (e >= 0 && this._cachedFrameIndex === e) {
          ...
          if (this._hasConstraint) {
            for (
              var i = 0, a = this._armature._constraints;
              i < a.length;
              i++
            ) {
              var r = a[i];
...
(function (t) {
  var e = (function (e) {
    ...
    i.prototype._updateDisplayData = function () {
      ...
      if (
        ...
        if (this._meshData !== null) {
          ...
          var s =
            this._textureData.parent.scale * this._armature._armatureData.scale;
          ...
          if (this._meshData !== null) {
            if (this._meshData.weight !== null) {
              ...
              for (var f = 0, _ = this._meshBones.length; f < _; ++f) {
                this._meshBones[f] = this._armature.getBone(
                  this._meshData.weight.bones[f].name,
                );
              }
            } else {
              var m =
                this._meshData.parent.parent.parent.intArray[
                  this._meshData.offset + 0
                ];
    ...
    i.prototype.containsPoint = function (t, e) {
      ...
      return this._boundingBoxData.containsPoint(
        i._helpPoint.x,
        i._helpPoint.y,
      );
    };
  ...
  var i = (function (e) {
    ...
    i.prototype._computeB = function () {
      ...
      n.rotation =
        ...
        c -
        d +
        t.Transform.normalizeRadian(I - M - c) * this._weight;
      n.toMatrix(s);
    };
            ...
            if (u !== null) {
              for (var _ = 0, m = u; _ < m.length; _++) {
                ...
                switch (p.type) {
                  ...
                  case 11: {
                    var n = t.BaseObject.borrowObject(
        ...
        for (var c in N) {
          for (var H = 0, z = N[c]; H < z.length; H++) {
            ...
            this._constraintTimelines.splice(
              this._constraintTimelines.indexOf(n),
              1,
            );
            n.returnToPool();
          }
  ...
  var e = (function (t) {
    ...
    e.prototype._setCurrentTime = function (t) {
      ...
      if (this._actionTimeline !== null && this._frameCount <= 1) {
        ...
        if (r > 0 && (t >= n || t <= -n)) {
          if (
            this.playState <= 0 &&
            this._animationState._playheadState === 3
          ) {
            this.playState = 1;
          }
    ...
    e.prototype.init = function (t, e, i) {
      ...
      if (this._timelineData !== null) {
        ...
        this._timeOffset =
          this._timelineArray[this._timelineData.offset + 1] * 0.01;
      }
    };
...
(function (t) {
        ...
        for (var s = 0; s < r; ++s) {
          ...
          if (l.type === 0) {
            if (l.slot !== null) {
              ...
              for (
                var f = 0, _ = this._armature.getSlots();
                f < _.length;
                f++
              ) {
                var h = _[f];
  ...
  var l = (function (t) {
    ...
    e.prototype._onUpdateFrame = function () {
      ...
      this._result[0] =
        (this._current[0] + this._delta[0] * this._tweenProgress) * 0.01;
      this._result[1] =
        (this._current[1] + this._delta[1] * this._tweenProgress) * 0.01;
      this._result[2] =
        (this._current[2] + this._delta[2] * this._tweenProgress) * 0.01;
      this._result[3] =
        (this._current[3] + this._delta[3] * this._tweenProgress) * 0.01;
  ...
  var h = (function (t) {
    ...
    e.prototype.init = function (e, i, a) {
      ...
      if (this._timelineData !== null) {
        ...
        this._frameFloatOffset =
          this._frameIntArray[r + 4] + this._animationData.frameFloatOffset;
      } else {
        this._valueCount = 0;
      }
    ...
    e.prototype.update = function (e) {
      if (
        this.slot._meshData === null ||
        this.slot._meshData.offset !== this.meshOffset
      ) {
        return;
      }
      t.prototype.update.call(this, e);
          ...
          if (
            ...
            for (var r = 0; r < this._ffdCount; ++r) {
              if (r < this._valueOffset) {
                i[r] +=
                  (this._frameFloatArray[this._frameFloatOffset + r] - i[r]) *
                  a;
...
(function (t) {
  var e = (function (e) {
    ...
    a.prototype._parseSlot = function (e, i) {
      ...
      if (a.ACTIONS in e) {
        this._slotChildActions[r.name] = this._parseActionData(
          e[a.ACTIONS],
          0,
          null,
          null,
          ...
          if (a.ACTIONS in e) {
            ...
            if (
              m === null
                ...
                : this._slot.displayIndex === m.length
            ) {
              for (
                var p = 0, c = this._slotChildActions[this._slot.name];
                p < c.length;
                p++
              ) {
                var _ = c[p];
    ...
    a.prototype._parseTimeline = function (e, r, n, s, o, l, h, u) {
      ...
      if (e !== null) {
        this._timelineArray[c + 0] = Math.round(
          a._getNumber(e, a.SCALE, 1) * 100,
        );
        this._timelineArray[c + 1] = Math.round(
          a._getNumber(e, a.OFFSET, 0) * 100,
        );
      } else {
      ...
      if (f === 1) {
        ...
        this._timelineArray[c + 5 + 0] =
          u.call(this, r[0], 0, 0) - this._animation.frameOffset;
      } else {
        ...
        for (var g = 0, b = 0, T = 0, A = 0; g < d; ++g) {
          if (T + A <= g && b < f) {
            ...
            this._timelineArray[c + 5 + b] =
              u.call(this, D, T, A) - this._animation.frameOffset;
            b++;
          }
          if (t.DragonBones.webAssembly) {
            y.set(v + g, b - 1);
    ...
    a.prototype._parseBoneAllFrame = function (e, i, r) {
      ...
      if (i !== 0) {
        if (this._prevClockwise === 0) {
          n =
            this._prevRotation +
            t.Transform.normalizeRadian(n - this._prevRotation);
        } else {
          if (
            this._prevClockwise > 0
              ? n >= this._prevRotation
              : n <= this._prevRotation
          ) {
            this._prevClockwise =
              this._prevClockwise > 0
    ...
    a.prototype._parseBoneRotateFrame = function (e, i, r) {
      ...
      this._frameFloatArray[o++] =
        a._getNumber(e, a.SKEW, 0) * t.Transform.DEG_RAD;
      return s;
    };
    ...
    a.prototype._parseSlotFFDFrame = function (t, e, i) {
      ...
      if (e === 0) {
        ...
        this._timelineArray[this._timeline.offset + 3] =
          b - this._animation.frameIntOffset;
      }
      return n;
    };
    a.prototype._parseIKConstraintFrame = function (t, e, i) {
      ...
      this._frameIntArray[n++] = a._getBoolean(t, a.BEND_POSITIVE, true)
        ? 1
        : 0;
      ...
      if (a.ROTATE in e || a.SKEW in e) {
        ...
        i.skew =
          t.Transform.normalizeRadian(
            a._getNumber(e, a.SKEW_X, 0) * t.Transform.DEG_RAD,
          ) - i.rotation;
      }
  ...
  var e = (function (e) {
        ...
        if (f === e) {
          ...
          if (l === 0) {
            ...
            if (h !== l) {
              ...
              u = 0;
              if (
                this._inRange(_, m, 1114111) &&
                !this._inRange(_, 55296, 57343)
              ) {
                s = _;
              } else {
                s = f;
            ...
            f =
              this._frameArrayBuffer[
                this._animation.frameOffset +
                  this._timelineArrayBuffer[r.offset + 5 + u]
              ];
            if (u === n - 1) {
              ...
              _ =
                this._frameArrayBuffer[
                  this._animation.frameOffset +
                    this._timelineArrayBuffer[r.offset + 5 + u + 1]
                ] - f;
            }
            u++;
          }
    ...
    i.prototype._parseAnimation = function (e) {
      ...
      i.frameCount = Math.max(
        t.ObjectDataParser._getNumber(e, t.ObjectDataParser.DURATION, 1),
        1,
      );
      i.playTimes = t.ObjectDataParser._getNumber(
        e,
        t.ObjectDataParser.PLAY_TIMES,
        1,
      );
      i.duration = i.frameCount / this._armature.frameRate;
      i.fadeInTime = t.ObjectDataParser._getNumber(
        e,
        t.ObjectDataParser.FADE_IN_TIME,
        0,
      );
...
(function (t) {
  var e = (function () {
    ...
    e.prototype._buildSlots = function (e, i) {
      ...
      for (var l = 0, h = e.armature.sortedSlots; l < h.length; l++) {
        ...
        if (o !== null) {
          var _ = new Array();
          for (
            var m = 0, p = t.DragonBones.webAssembly ? o.size() : o.length;
            m < p;
            ++m
          ) {
    ...
    e.prototype.replaceSlotDisplayList = function (e, i, a, r) {
      ...
      var o = 0;
      for (
        var l = 0, h = t.DragonBones.webAssembly ? s.size() : s.length;
        l < h;
        ++l
      ) {
      ...
      for (var l = 0, h = e.getSlots(); l < h.length; l++) {
        ...
        for (var _ = 0, m = u.displayList; _ < m.length; _++) {
          ...
          if (p instanceof t.Armature) {
            ...
            if (
              c !== null &&
              f < (t.DragonBones.webAssembly ? c.size() : c.length)
            ) {
...
(function (t) {
  ...
  Phaser.Image.prototype.updateTransform = function (e) {
    ...
    if (n || s) {
      ...
      this.worldRotation =
        Phaser.Math.HALF_PI - (l > 0 ? Math.acos(-o / p) : -Math.acos(o / p));
      ...
      if (this._displayIndex >= 0 && this._display !== null && i !== null) {
        ...
        if (r !== null) {
          if (e !== null) {
            ...
            this._textureScale =
              i.parent.scale * this._armature._armatureData.scale;
