            ...
            if (b.arrayBuffer)
              var v = [
                ...
                _ =
                  ...
                  function (e) {
                    return (
                      e && v.indexOf(Object.prototype.toString.call(e)) > -1
                    );
                  };
          ...
          s = (function () {
            function e(t) {
              (o(this, e),
                (this._config = t || {}),
                (this._url =
                  t.url || "https://msgrt.gamedistribution.com/collect"));
            }
            return (
              i(e, [
                {
                  ...
                  value: function (e, t) {
                    ...
                    (t &&
                      ...
                      (n = encodeURIComponent(
                        r.Base64.encode(JSON.stringify(n)),
                      )),
                      fetch(
                        this._url +
                          "?tp=com.gdsdk." +
            ...
            function e(t, n, i) {
              ...
              ((this.options = i ? (0, s.extendDefaults)(c, i) : c),
                ...
                (this.thirdPartyContainer =
                  "" !== t ? document.getElementById(t) : null),
                (this.options.width =
                  ...
                  value: function () {
                    ...
                    (this._startSafetyTimer(12e3, "start()"),
                      ...
                      this.eventBus.subscribe("LOADED", function () {
                        (e._clearSafetyTimer("LOADED"),
                          e._startSafetyTimer(8e3, "LOADED"));
                      }),
                      this.eventBus.subscribe(
                                  ...
                                  window.idhbgd.que.push(function () {
                                    (window.idhbgd.setAdserverTargeting(o),
                                      ...
                                      window.idhbgd.setRefererUrl(
                                        encodeURIComponent(e.parentUrl),
                                      ),
                    ...
                    return new Promise(function (t) {
                      ...
                      var o = (0, s.getMobilePlatform)(),
                        i =
                          1 === e.adTypeCount
                            ? "preroll1"
                            : "midroll" + e.adCount.toString(),
                        r = (0, s.getQueryString)("ch", window.location.href),
                        a = (0, s.getQueryString)(
                          "ch_date",
                            ...
                            ? n.forEach(function (t) {
                                ...
                                void 0 !== window.ga &&
                                  ...
                                  window.ga("gd.send", {
                                    hitType: "event",
                                    eventCategory:
                                      "AD_ERROR_" + t.bidder.toUpperCase(),
                                    eventAction:
                                      e.getError().getErrorCode().toString() ||
                                      e
                                        .getError()
        ...
        var a = o(e("../package.json")),
          ...
          p = (function () {
            function e(t) {
              ...
              if (
                (this._analytics(m, p),
                ["razda.com", "74.127.72.247"].indexOf(p) > -1)
              )
                return (
                  void 0 !== window.ga &&
                    window.ga("gd.send", {
              ...
              ((this.options.testing =
                this.options.testing || b.indexOf(p) > -1),
                this.options.testing &&
                  (0, h.dankLog)(
                    "SDK_TESTING_ENABLED",
                    this.options.testing,
              ...
              try {
                if ("developer.gamedistribution.com" === p) {
                  ...
                  ("html5.api.gamedistribution.com" !== p &&
                    "localhost:3000" !== p) ||
                    (localStorage.setItem("gd_debug", "true"),
                    localStorage.setItem("gd_midroll", "0"));
              ...
              var y = new Promise(function (e) {
                ...
                fetch(i)
                  ...
                  .then(function (o) {
                    if (o.error)
                      (0, h.dankLog)("SDK_GAME_DATA_READY", o.error, "warning");
                    else if (o.success) {
                      var i = {
              ...
              (y
                .then(function (e) {
                  ...
                  if (e.advertisements) {
                    ...
                    e.preroll
                      ? (n.videoAdInstance.options.autoplay || t) &&
                        n._createSplash(e, t)
              ...
              s(e, [
                {
                  ...
                  value: function (e) {
                    var t =
                        document.location.search.indexOf("gdpr-tracking") >= 0,
                      n =
                    ...
                    var r =
                      ...
                      s =
                        document.location.search.indexOf("gdpr-targeting=1") >=
                        0,
                      a = "",
                      d = "";
                    (r
                    ...
                    var c =
                        document.location.search.indexOf("gdpr-third-party") >=
                        0,
                      u =
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    ((d.innerHTML = a),
                      (d.id = this.options.prefix + "splash"));
