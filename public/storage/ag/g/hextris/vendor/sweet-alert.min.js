!(function (e, t, n) {
  function o(e) {
    ...
    if (
      ((n.innerHTML = e.html ? e.title : E(e.title).split("\n").join("<br>")),
      (o.innerHTML = e.html
        ? e.text
        : E(e.text || "")
            .split("\n")
      ...
      (T(t, e.customClass), t.setAttribute("data-custom-class", e.customClass));
    else {
    ...
    if ((O(t.querySelectorAll(".sa-icon")), e.type && !u())) {
      ...
      switch ((A(d), e.type)) {
        case "success":
          (T(d, "animate"),
            T(d.querySelector(".sa-tip"), "animateSuccessTip"),
            T(d.querySelector(".sa-long"), "animateSuccessLong"));
          break;
        case "error":
          (T(d, "animateErrorIcon"),
            T(d.querySelector(".sa-x-mark"), "animateXMark"));
          break;
        case "warning":
          (T(d, "pulseWarning"),
            T(d.querySelector(".sa-body"), "pulseWarningIns"),
            T(d.querySelector(".sa-dot"), "pulseWarningIns"));
      }
    }
    if (e.imageUrl) {
      ...
      m.setAttribute(
        "style",
        m.getAttribute("style") + "width:" + p + "px; height:" + y + "px",
      );
    }
    (t.setAttribute("data-has-cancel-button", e.showCancelButton),
      e.showCancelButton ? (a.style.display = "inline-block") : O(a),
      t.setAttribute("data-has-confirm-button", e.showConfirmButton),
      e.showConfirmButton ? (r.style.display = "inline-block") : O(r),
      e.cancelButtonText && (a.innerHTML = E(e.cancelButtonText)),
      e.confirmButtonText && (r.innerHTML = E(e.confirmButtonText)),
      (r.style.backgroundColor = e.confirmButtonColor),
      i(r, e.confirmButtonColor),
      t.setAttribute("data-allow-ouside-click", e.allowOutsideClick));
  ...
  ((v = b =
    function () {
      ...
      function u(t) {
        ...
        if (-1 !== [9, 13, 32, 27].indexOf(a)) {
          for (
            var r = o.target || o.srcElement, s = -1, c = 0;
            c < D.length;
            c++
          )
            if (r === D[c]) {
          ...
          9 === a
            ? ((r = -1 === s ? I : s === D.length - 1 ? D[0] : D[s + 1]),
              P(o),
              r.focus(),
              i(r, g.confirmButtonColor))
            : ((r =
                13 === a || 32 === a
                  ? -1 === s
                    ? I
                    : n
                  : 27 === a && g.allowEscapeKey === !0
                    ? O
                    : n),
              r !== n && N(r, o));
        }
      ...
      var b = arguments[0];
      if (arguments[0] === n)
        return (f("SweetAlert expects at least 1 attribute!"), !1);
      var g = r({}, S);
      switch (typeof arguments[0]) {
        ...
        case "object":
          if (arguments[0].title === n)
            return (f('Missing "title" argument!'), !1);
          ...
          ((g.confirmButtonText = g.showCancelButton
            ? "Confirm"
            : S.confirmButtonText),
            (g.confirmButtonText = s("confirmButtonText")),
            (g.doneFunction = arguments[1] || null));
          break;
        default:
          return (
            f(
      ...
      for (
        var B = x(),
          E = function (t) {
            ...
            switch (n.type) {
              case "mouseover":
                r && (o.style.backgroundColor = a(g.confirmButtonColor, -0.04));
                break;
              case "mouseout":
                r && (o.style.backgroundColor = g.confirmButtonColor);
                break;
              case "mousedown":
                r && (o.style.backgroundColor = a(g.confirmButtonColor, -0.14));
                break;
              case "mouseup":
                r && (o.style.backgroundColor = a(g.confirmButtonColor, -0.04));
                break;
              ...
              case "click":
                if (r && i && s)
                  (g.doneFunction(!0), g.closeOnConfirm && v.close());
                else if (i && s) {
                  var u = String(g.doneFunction).replace(/\s/g, ""),
                    f =
                      "function(" === u.substring(0, 9) &&
                      ")" !== u.substring(9, 10);
                  (f && g.doneFunction(!1), g.closeOnCancel && v.close());
                } else v.close();
            }
          },
          q = B.querySelectorAll("button"),
          A = 0;
        A < q.length;
        A++
      )
    ...
    (v.close = b.close =
      function () {
        ...
        (B(a, "animate"),
          B(a.querySelector(".sa-tip"), "animateSuccessTip"),
          B(a.querySelector(".sa-long"), "animateSuccessLong"));
        var r = o.querySelector(".sa-icon.sa-error");
        (B(r, "animateErrorIcon"),
          B(r.querySelector(".sa-x-mark"), "animateXMark"));
        var s = o.querySelector(".sa-icon.sa-warning");
        (B(s, "pulseWarning"),
          B(s.querySelector(".sa-body"), "pulseWarningIns"),
          B(s.querySelector(".sa-dot"), "pulseWarningIns"),
          (e.onkeydown = p),
          (t.onclick = m),
          d && d.focus(),
          (y = n),
    ...
    "function" == typeof define && define.amd
      ...
      : "undefined" != typeof module && module.exports
        ? (module.exports = v)
        : "undefined" != typeof e && (e.sweetAlert = e.swal = v));
})(window, document);
