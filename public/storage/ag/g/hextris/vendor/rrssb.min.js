+(function (t, e, r) {
  ...
  e.fn.rrssb = function (t) {
    ...
    for (var i in s) s.hasOwnProperty(i) && s[i] !== r && (s[i] = a(s[i]));
    (s.url !== r &&
      (e(this)
        .find(".rrssb-facebook a")
        .attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + s.url),
      e(this)
        .find(".rrssb-tumblr a")
        .attr(
          "href",
          "http://tumblr.com/share/link?url=" +
            s.url +
            (s.title !== r ? "&name=" + s.title : "") +
            (s.description !== r ? "&description=" + s.description : ""),
        ),
      e(this)
        ...
        .attr(
          ...
          "http://www.linkedin.com/shareArticle?mini=true&url=" +
            ...
            (s.description !== r ? "&summary=" + s.description : ""),
        ),
      e(this)
      ...
      e(this)
        ...
        .attr(
          ...
          "http://www.reddit.com/submit?url=" +
            s.url +
            (s.description !== r ? "&text=" + s.description : "") +
            (s.title !== r ? "&title=" + s.title : ""),
        ),
      e(this)
      ...
      e(this)
        ...
        .attr(
          ...
          "http://pinterest.com/pin/create/button/?url=" +
            s.url +
            (s.image !== r ? "&amp;media=" + s.image : "") +
            (s.description !== r ? "&amp;description=" + s.description : ""),
        ),
      e(this)
        .find(".rrssb-pocket a")
        .attr("href", "https://getpocket.com/save?url=" + s.url),
      e(this).find(".rrssb-github a").attr("href", s.url)),
      s.emailAddress !== r &&
        e(this)
          .find(".rrssb-email a")
          .attr(
            ...
            "mailto:" +
              s.emailAddress +
              "?" +
              (s.emailSubject !== r ? "subject=" + s.emailSubject : "") +
              (s.emailBody !== r ? "&amp;body=" + s.emailBody : ""),
          ));
  };
  var i = function () {
      var t = e("<div>"),
      ...
      for (var i = 0; i < r.length; i++)
        if ((t.css("width", r[i] + "(1px)"), 1 === t.width())) {
          s.calc = r[i];
          break;
        }
      t.remove();
    ...
    n = function () {
      e(".rrssb-buttons").each(function (t) {
        var r = e(this),
          ...
          i = s.length,
          a = 100 / i;
        s.css("width", a + "%").attr("data-initwidth", a);
      });
    },
    l = function () {
      e(".rrssb-buttons").each(function (t) {
        var r = e(this),
          s = r.width(),
          i = e("li", r).not(".small").first().width();
        (i > 170 && e("li.small", r).length < 1
      ...
      e(".rrssb-buttons").each(function (t) {
        ...
        if (c === s.length) {
          ...
          m > d + o &&
            ...
            i.first().removeClass("small"),
            h());
        } else {
          s.not(".small").each(function (t) {
            var r = e(this),
              s = parseFloat(r.attr("data-size")) + 55,
    ...
    c = function (t) {
      (e(".rrssb-buttons").each(function (t) {
        var r = e(this),
          s = e("li", r);
        e(s.get().reverse()).each(function (t, r) {
          var i = e(this);
          if (i.hasClass("small") === !1) {
            var a = parseFloat(i.attr("data-size")) + 55,
    ...
    f = (function () {
      ...
      return function (e, r, s) {
        (s || (s = "Don't call this twice without a uniqueId"),
          t[s] && clearTimeout(t[s]),
          (t[s] = setTimeout(e, r)));
      };
    })();
  (e(document).ready(function () {
    (e(".rrssb-buttons a.popup").on("click", function (t) {
      var r = e(this);
