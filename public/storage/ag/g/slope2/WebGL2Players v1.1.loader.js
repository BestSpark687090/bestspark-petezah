          ...
          "zlib/inflate.js": function (e, t, n) {
            ...
            function u(e) {
              if (ve) {
                var t;
                for (
                  b = new w.Buf32(512), g = new w.Buf32(32), t = 0;
                  t < 144;
                ...
                for (
                  x(S, e.lens, 0, 288, b, 0, e.work, { bits: 9 }), t = 0;
                  t < 32;
            ...
            function p(e, t) {
              ...
              return e && e.state
                ? ((n = e.state),
                  0 === (2 & n.wrap) ? A : ((n.head = t), (t.done = !1), R))
                : A;
            }
            function m(e, t) {
              var n,
              ...
              for (;;) {
                ...
                if (R > I && (Z & x) !== k) {
                  for (
                    ...
                    (N++, (H <<= 1));
                  if (((D += 1 << N), (e === l && D > i) || (e === d && D > o)))
                    return 1;
                  ((k = Z & x), (m[k] = (I << 24) | (N << 16) | (_ - b) | 0));
                }
              }
              return (
                0 !== Z && (m[_ + Z] = ((R - T) << 24) | (64 << 16) | 0),
                (w.bits = I),
                0
              );
            };
