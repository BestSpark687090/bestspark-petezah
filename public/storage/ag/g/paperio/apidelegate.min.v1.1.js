var APIDelegate = {
  VERSION: "1.1",
  startupObj: { callback: null, context: null },
  enterGameObj: { callback: null, context: null },
  get LogoUrl() {
  ...
  startup: function (b, a) {
    com4j.debug("APIDelegate VERSION: 1.1");
  ...
  loadProgress: function (a) {
    this._dispatch(MGEvent.LOAD_PROGRESS, { percent: a });
  },
  ...
  levelWin: function (a) {
    this._dispatch(MGEvent.LEVEL_WIN, { level: a });
  },
  levelLose: function (a) {
    this._dispatch(MGEvent.LEVEL_FAIL, { level: a });
  },
  resizeHandler: function (c, a, b) {
    com4j.resize.add(c, a, b);
  },
...
com4j.initCallbackObj = {
  callback: APIDelegate._onApiInited,
  context: APIDelegate,
};
