...
var MGEvent = (function () {
  ...
  a.LOAD_START = "LOAD_START";
  a.LOAD_PROGRESS = "LOAD_PROGRESS";
  a.LOAD_COMPLETE = "LOAD_COMPLETE";
  a.LOAD_ERROR = "LOAD_ERROR";
  a.START_GAME = "START_GAME";
  a.PAUSE_GAME = "PAUSE_GAME";
  a.WIN_GAME = "WIN_GAME";
  a.LOSE_GAME = "LOSE_GAME";
  a.ENTER_GAME = "ENTER_GAME";
  a.ADDED_TO_STAGE = "ADDED_TO_STAGE";
  a.FRAMEWORK_INFO_REQUEST = "FRAMEWORK_INFO_REQUEST";
  a.FRAMEWORK_INFO_RESPONSE = "FRAMEWORK_INFO_RESPONSE";
  a.CLICK_MORE = "CLICK_MORE";
  a.CLICK_MINILOGO = "CLICK_MINILOGO";
  a.OPEN_URL = "OPEN_URL";
  a.OPEN_EMAIL = "OPEN_EMAIL";
  a.SHARE = "SHARE";
  a.CLICK_CREDITS = "CLICK_CREDITS";
  a.SHOW_WIN = "SHOW_WIN";
  a.SHOW_LOSE = "SHOW_LOSE";
  a.LEVEL_FAIL = "LEVEL_FAIL";
  a.LEVEL_WIN = "LEVEL_WIN";
  a.SCREENSHOT = "SCREENSHOT";
  a.DOWNLOAD_APP = "DOWNLOAD_APP";
  a.CONTINUE_GAME = "CONTINUE_GAME";
  a.CHANGE_SCENE = "CHANGE_SCENE";
  a.FULLSCREEN = "FULLSCREEN";
  a.GAME_STARTUP = "GAME_STARTUP";
  return a;
})();
...
var MGDelegate = (function () {
  function a() {}
  a.getListenerIndex = function (d, e, b) {
    if (!a._eventMap[d]) {
      return -1;
    }
    for (var c = 0; c < a._eventMap[d].length; c++) {
      var f = a._eventMap[d][c];
      if (f[0] == e && f[1] == b) {
        return c;
      }
    }
  ...
  a.hasListener = function (b) {
    if (!a._eventMap[b]) {
      return false;
    }
    return true;
  };
  a.addEventListener = function (c, d, b) {
    if (!a._eventMap[c]) {
      a._eventMap[c] = [];
    }
    if (a.getListenerIndex(c, d, b) == -1) {
      a._eventMap[c].push([d, b]);
    }
  };
  a.removeEventListener = function (d, e, b) {
    if (!a._eventMap[d]) {
      return;
    }
    var c = a.getListenerIndex(d, e, b);
    if (c != -1) {
      a._eventMap[d].splice(c, 1);
    }
    if (a._eventMap[d].length == 0) {
      delete a._eventMap[d];
    }
  };
  a.dispatcherEvent = function (f) {
    var d = f.type;
    if (!a._eventMap[d]) {
      return;
    }
...
var com4j = {
  ...
  fullscreen: function (a) {
    if (!com4j.fullscreenEnabled) {
      com4j.debug(
        "Can not fullscreen, please check and set iframe allowfullscreen = 'allowfullscreen'",
      );
      return;
    }
    if (!a) {
  ...
  onFullscreenChanged: function (a) {
...
com4j.config = {
  ...
  parameters: {},
  getParam: function (a) {
    if (this.parameters.hasOwnProperty(a)) {
      if (this.parameters[a] === undefined || this.parameters[a] === null) {
        return true;
      } else {
  ...
  set ForJoyH5_BigLogo(a) {
    this._ForJoyH5_BigLogo = a;
  },
  ForJoyH5_DefaultSmallLogo: "",
  _ForJoyH5_SmallLogo: "",
  ...
  set ForJoyH5_SmallLogo(a) {
    this._ForJoyH5_SmallLogo = a;
  },
  ...
  set ForJoyH5_BgColor(a) {
    this._ForJoyH5_BgColor = a;
  },
  ...
  set ForJoyH5_Website(a) {
    this._ForJoyH5_Website = a;
  },
  ForJoyH5_mid: 19,
  NameID: "allgames",
  v: "",
  ...
  init: function () {
    ...
    var b = /(test\/|games\/|games-test\/)?([^/]+)/g;
    var f = b.exec(j);
    if (f && f[1] != undefined) {
      com4j.config.NameID = f[2];
    }
    var b = /(\s*)(.+)(\s*)/g;
...
com4j.loadScript = function (d, e, c) {
...
com4j.resize = {
  ...
  indexOf: function (e, c) {
    var b = 0,
      a = this._queue.length;
    for (b = 0; b < a; b++) {
      var d = this._queue[b];
      if (d.callback == e && d.context == c) {
        return b;
      }
    }
    return -1;
  ...
  add: function (d, b, c) {
    var a = this.indexOf(d, b);
    if (a == -1) {
      if (c && c.constructor != Array) {
        c = [c];
      }
      this._queue.push({ callback: d, context: b, params: c });
    } else {
  ...
  _onHandler: function (g) {
    var c = 0,
      a = com4j.resize._queue.length;
    for (c = 0; c < a; c++) {
      var f = com4j.resize._queue[c];
      try {
        var d = f.callback;
        var b = f.context;
        var j = f.params;
...
com4j.moregames = {
  ...
  get showable() {
    ...
    var a = b - this._lastTime;
    if (a >= this.MoreInterval * 1000) {
      return true;
    } else {
      var c = Math.ceil(this.MoreInterval - a / 1000);
      com4j.debug("Please call com4j.more.show() later, wait " + c + "s");
      return false;
    }
  },
  ...
  init: function () {
    var a = $(".new_ui_box-content");
    var c = $(".new_ui_games-list");
    var e = Math.floor(new Date().getTime() / 432000000);
    var d =
      com4j.config.host + "moregames/" + com4j.config.NameID + ".json?v=" + e;
    $.get(d, function (h, g, i) {
      if (g == "success") {
        com4j.moregames.moreData = h;
    ...
    function f() {
      var h = ($(window).height() - a.height()) / 2;
      if (h < 0) {
        h = 0;
      }
      var g = ($(window).width() - a.width()) / 2;
      if (g < 0) {
        g = 0;
      }
      a.css("margin-top", h + "px");
      a.css("margin-left", g + "px");
      c.css("height", a.height() - 60 + "px");
    }
    com4j.resize.add(f, com4j.moregames);
    com4j.resize.handler();
    var b = com4j.config.touchEnabled ? "touchstart touchend" : "mouseup";
    $("#closeMoreBtn").bind(b, function (g) {
  ...
  randomInit: function () {
    ...
    var d = com4j.moregames.moreData.concat();
    ...
    while (d.length > 0) {
      ...
      d.splice(b, 1);
      if (
        !com4j.config.ForJoyH5_ShowCopyright &&
        e.hasOwnProperty("copyright") &&
        e.copyright == true
      ) {
        continue;
      }
      var a =
        ...
        e.nameid +
        "/index.php?pubid=" +
        com4j.config.ForJoyH5_pubid;
      f += "<a href='" + a + "'>";
      f += "<div class='new_ui_big-button-menu new_ui_single-game-row'>";
      var g = com4j.config.host + "thumb/" + e.nameid + ".jpg";
      f += "<img class='new_ui_img-icon' src='" + g + "'>";
      f += "<p class='new_ui_game-info'>";
      f += "<span class='new_ui_game-name'>" + e.name + "</span>";
      f += "<span class='new_ui_stars-container'>";
      for (var c = 1; c <= 5; c++) {
        if (c < e.rating5) {
          f += "<span class='new_ui_sprite new_ui_star-yellow'></span>";
        } else {
          if (c > Math.floor(e.rating5) && c <= Math.ceil(e.rating5)) {
            f += "<span class='new_ui_sprite new_ui_star-yellow-grey'></span>";
          } else {
            f += "<span class='new_ui_sprite new_ui_star-grey'></span>";
          }
        }
      }
      f += "</span>";
      f += "</p>";
      f +=
        "<span class='new_ui_sprite new_ui_button-next new_ui_icon-right-big-button'></span>";
      f += "</div>";
      f += "</a>";
    }
    $(".new_ui_games-list").append(f);
  },
  show: function (a) {
...
com4j.ad = {
  ...
  get adType() {
    var a = com4j.config.ForJoyH5_PreGameAdType;
    if (com4j.ad.finishedPre) {
      a = com4j.config.ForJoyH5_InGameAdType;
    }
    switch (a) {
      case 0:
        return "all";
  ...
  get adTagUrl() {
    return "http://googleads.g.doubleclick.net/pagead/ads?ad_type=video_text_image_flash&client=ca-games-pub-8558226521654845&description_url=http%3A%2F%2Ffun.touchpal.com%2Fgame%2Friseup%2Findex.html&channel=5695472211&videoad_start_delay=0&hl=en&max_ad_duration=30000";
    var b =
      "game=" +
      com4j.config.ForJoy_gameid +
      "&pubid=" +
      com4j.config.ForJoyH5_pubid +
      "&video=" +
      com4j.ad.adType +
      ...
      com4j.config.ForJoy_gameid +
      "&mid=" +
      com4j.config.ForJoyH5_mid;
    b = encodeURIComponent(b);
    var a =
      "https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/324879675/pregame_h5.4j.com_parnter&cust_params=" +
      b +
      "&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1";
    return a;
  },
  check: function () {
    if (com4j.config.isVIP) {
      return false;
    }
  ...
  _init: function () {
    ...
    if (com4j.ad.intervalID == -1) {
      com4j.ad.intervalID = setTimeout(com4j.ad.onAdClose, 30000);
    }
    com4j.ad._imaContainer = $("#imaContainer")[0];
    com4j.ad._videoContent = $("#imaVideo")[0];
    var a = new google.ima.AdDisplayContainer(
      com4j.ad._imaContainer,
      com4j.ad._videoContent,
    );
    a.initialize();
    com4j.ad._adsLoader = new google.ima.AdsLoader(a);
    com4j.ad._adsLoader.addEventListener(
      google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
      com4j.ad.onAdsManagerLoaded,
      false,
    );
    com4j.ad._adsLoader.addEventListener(
  ...
  onAdsManagerLoaded: function (a) {
    com4j.ad._adsManager = a.getAdsManager(com4j.ad._videoContent);
    com4j.ad._adsManager.addEventListener(
      google.ima.AdErrorEvent.Type.AD_ERROR,
      com4j.ad.onAdError,
    );
    com4j.ad._adsManager.addEventListener(
      google.ima.AdEvent.Type.ALL_ADS_COMPLETED,
      com4j.ad.onAllAdsCompleted,
    );
    com4j.ad._adsManager.addEventListener(
      google.ima.AdEvent.Type.USER_CLOSE,
      com4j.ad.onUserClose,
    );
    com4j.ad._adsManager.addEventListener(
      google.ima.AdEvent.Type.COMPLETE,
      com4j.ad.onAdComplete,
    );
    com4j.ad._adsManager.addEventListener(
  ...
  onTypeTest: function (a) {},
  onAdLoaded: function (c) {
    ...
    var d = com4j.ad._adsManager.getCurrentAd().getContentType();
    var b = 0;
    if (d == "text") {
      b = 0;
    } else {
    ...
    var a = new MGEvent("CMD_AD_TYPE_LOG");
    a.data = { ad_type: b };
  ...
  onAdError: function (a) {
    console.warn(a.getError());
    com4j.ad.onAdClose();
  },
  onAdComplete: function (a) {},
  onAllAdsCompleted: function (a) {
    com4j.ad.onAdClose();
  },
  onAdClose: function () {
    var a = "AD_CLOSE";
    ...
    com4j.ad.close();
    MGDelegate.dispatcherEvent(new MGEvent(a));
  },
  onUserClose: function (a) {
    com4j.ad.onAdClose();
  },
  resizeAd: function () {
    if (com4j.ad._adsManager) {
      com4j.ad._adsManager.resize(
        $(window).width(),
        $(window).height(),
        google.ima.ViewMode.FULLSCREEN,
      );
  ...
  get showable() {
    if (com4j.ad._lastInGameAdTime === -1) {
      return true;
    }
    var b = new Date().getTime();
    var a = b - com4j.ad._lastInGameAdTime;
    if (a >= com4j.config.ForJoyH5_InGameAdInterval * 1000) {
      return true;
    } else {
      var c = Math.ceil(com4j.config.ForJoyH5_InGameAdInterval - a / 1000);
      com4j.debug("Please call com4j.ad.show() later, wait " + c + "s");
      return false;
    }
  },
  updateLastInGameAdTime: function () {
    var a = new Date().getTime();
    com4j.ad._lastInGameAdTime = a;
  },
  show: function (b, d) {
    ...
    com4j.modal.show();
    com4j.ad._callbackObj = b;
    if (!com4j.ad._adsRequest) {
      com4j.ad._init();
    }
    if (!com4j.config.ForJoyH5_stats && !d) {
...
com4j.game = {
  ...
  _lastLeft: NaN,
  _lastTop: NaN,
  set enterGameEnabled(a) {
    this._enterGameEnabled = a;
    if (a) {
      this.enterGame();
    }
  },
  ...
  c2Ready: function (a) {
    ...
    $(a).attr("onload", com4j.game.c2GameLoaded);
  },
  ...
  cocosReady: function (a) {
    com4j.config.engineType = "cocos";
    $(a).attr("onload", com4j.game.cocosEngineLoaded);
    a = $("script[src='game.js']")[0];
    $(a).attr("onload", com4j.game.cocosGameLoaded);
  },
  cocosEngineLoaded: function () {
    $(com4j.config.canvasId).css("position", "");
  },
  cocosGameLoaded: function (a) {
    com4j.game.isReady = true;
  },
  cocosStart: function () {
  ...
  _listenEvents: function () {
    var d = function (g) {
      ...
      switch (g.type) {
        case MGEvent.CLICK_CREDITS:
          com4j.ga.sendEvent("GAME", g.type);
          com4j.credits.show();
          break;
        ...
        case MGEvent.DOWNLOAD_APP:
          var e = g.data.platform;
          com4j.ga.sendEvent("GAME", g.type, e);
          break;
        ...
        case MGEvent.LEVEL_FAIL:
          var h = g.data.level;
          com4j.ga.sendEvent("GAME", g.type, h);
          com4j.moregames.show(false);
          com4j.ad.show();
          break;
        ...
        case MGEvent.CHANGE_SCENE:
          com4j.ad.show(g.data);
          break;
        case MGEvent.FULLSCREEN:
          if (!com4j.config.ForJoyH5_Fullscreen) {
            break;
          }
          com4j.ga.sendEvent("GAME", g.type, !com4j._isFullscreen);
    ...
    var c = [
      MGEvent.CLICK_CREDITS,
      MGEvent.CLICK_MINILOGO,
      MGEvent.CLICK_MORE,
      MGEvent.DOWNLOAD_APP,
      MGEvent.FRAMEWORK_INFO_REQUEST,
      MGEvent.LOAD_COMPLETE,
      MGEvent.PAUSE_GAME,
      MGEvent.SCREENSHOT,
      MGEvent.SHARE,
      MGEvent.SHOW_LOSE,
      ...
      MGEvent.LEVEL_WIN,
      MGEvent.START_GAME,
      MGEvent.CONTINUE_GAME,
      MGEvent.ADDED_TO_STAGE,
      MGEvent.CHANGE_SCENE,
      MGEvent.FULLSCREEN,
    ];
    for (var b = 0, a = c.length; b < a; b++) {
      MGDelegate.addEventListener(c[b], d, this);
    }
    MGDelegate.addEventListener(MGEvent.LOAD_START, this.onLoadStart, this);
    MGDelegate.addEventListener(
      MGEvent.LOAD_PROGRESS,
      this.onLoadProgress,
      this,
    );
    MGDelegate.addEventListener(
  ...
  onLoadProgress: function (b) {
    var a = b.data.percent;
    com4j.loading.setProgress(a);
  },
  onLoadComplete: function (c) {
    var b = 100;
    com4j.loading.setProgress(b);
    var a = new Date().getTime() - com4j.ga._loadStart;
    com4j.ga.sendTiming("LOAD_TIME", a);
    $("#hourglass").animate({ opacity: 0 }, 200);
    setTimeout(function () {
      $("#preloadingB").remove();
  ...
  resizeGame: function () {
    var a = $(com4j.config.canvasId).width();
    var b = $(com4j.config.canvasId).height();
    var d = Math.floor((com4j.resize.sw - a) / 2);
    var c = Math.floor((com4j.resize.sh - b) / 2);
    if (com4j.game._lastLeft != d || com4j.game._lastTop != c) {
      $(com4j.config.canvasId).css("left", d + "px");
      $(com4j.config.canvasId).css("top", c + "px");
    }
  },
  start: function () {
...
com4j.ga = {
  ...
  sendEvent: function (b, a, d, e, f) {
    var c = ["event", com4j.config.NameID].concat(
      arguments.length === 1 ? [arguments[0]] : Array.apply(null, arguments),
    );
    this.send.apply(window, c);
  },
  sendTiming: function (a, e, d, c, f) {
    var b = ["timing", com4j.config.NameID].concat(
      arguments.length === 1 ? [arguments[0]] : Array.apply(null, arguments),
    );
    this.send.apply(window, b);
  },
  sendSocial: function (c, b, d, e) {
    var a = ["social", com4j.config.NameID].concat(
      arguments.length === 1 ? [arguments[0]] : Array.apply(null, arguments),
    );
    this.send.apply(window, a);
  },
  sendException: function (c, b) {
    var a = ["exception"].concat(
      arguments.length === 1 ? [arguments[0]] : Array.apply(null, arguments),
    );
    this.send.apply(window, a);
  },
...
com4j.share = {
  ...
  to: function (a, f, c, b, d) {
    a = a.toLowerCase();
    var e = com4j.share.config[a];
    if (e) {
      f = encodeURIComponent(f);
      c = encodeURIComponent(c);
      b = encodeURIComponent(b);
      d = encodeURIComponent(d);
      e.apply(this, [f, c, b, d]);
    }
  },
  _toWeixin: function (d, b, a, c) {
    try {
  ...
  _toQQ: function (e, c, b, d) {
    var f =
      com4j.share._getTopHref() ||
      com4j.config.host + e + "/index.php?pubid=" + d;
    f = encodeURIComponent(f);
    var a =
  ...
  _toFacebook: function (e, c, b, d) {
    var f =
      com4j.share._getTopHref() ||
      com4j.config.host + e + "/index.php?pubid=" + d;
    f = encodeURIComponent(f);
    var a =
      "https://www.facebook.com/dialog/feed?app_id= 1692226401062334&display=popup&caption=" +
      b +
      "&link=" +
      f +
      "&redirect_uri=" +
  ...
  _toTwitter: function (e, c, b, d) {
    var f =
      com4j.share._getTopHref() ||
      com4j.config.host + e + "/index.php?pubid=" + d;
    f = encodeURIComponent(f);
    var a = "https://twitter.com/share?text=" + b + "&url=" + f;
    window.open(a);
  },
};
com4j.credits = {
  init: function () {
    var a = com4j.config.touchEnabled ? "touchstart touchend" : "mouseup";
    $("#closeCreditsBtn").bind(a, function (b) {
...
com4j.modal = {
  ...
  show: function (a) {
    ...
    $("#modal").css("background", "rgba(0,0,0," + a + ")");
  },
  checkAllHide: function () {},
  hide: function () {
    var a = true;
    $("body > div").each(function (b, c) {
      if ($(this)[0] != $("#modal")[0]) {
        if (
          $(this)[0].id == "moregames" &&
          $(this)[0].id == "credits" &&
          $(this)[0].id == "imaContainer"
        ) {
          if (
...
com4j.loading = {
  ...
  resizeLogo: function () {
    $("#preloadingContainer").css(
      "left",
      (com4j.resize.sw - $("#preloadingContainer").width()) / 2 + "px",
    );
    $("#preloadingContainer").css(
      "top",
      (com4j.resize.sh - $("#preloadingContainer").height()) / 2 + "px",
    );
  },
  setProgress: function (a) {
    $("#preloadingF").css("width", a + "%");
  },
...
com4j.debug = function () {
  var b = function () {
    ...
    for (var g = 0, d = f.length; g < d; g++) {
      var c = f[g];
      if (typeof c === "string") {
        var h = "color:yellow;background:green;";
        var e = "%c%s";
...
com4j.ready = function () {
  ...
  $("body > div").bind("touchstart touchend mousedown mouseup", a);
  $("script[src]").each(function (b, c) {
    if ($(c).attr("src").indexOf("c2runtime.js") != -1) {
      com4j.game.c2Ready(c);
    } else {
      if ($(c).attr("src").indexOf("cocos") != -1) {
        com4j.game.cocosReady(c);
      } else {
        if ($(c).attr("src").indexOf("createjs") != -1) {
          com4j.game.createJsReady(c);
        }
      }
    }
  });
...
com4j.init = function () {
  var e = "color:yellow;background:green;";
  var c = "%c%s";
  console.log(c, e, "Com4jAPI VERSION " + this.VERSION);
  window.addEventListener("resize", com4j.resize.handler);
  window.onorientationchange = com4j.resize.handler;
  document.addEventListener(
    "fullscreenchange",
    com4j.onFullscreenChanged,
    false,
  );
  document.addEventListener(
    "mozfullscreenchange",
  ...
  if (window.location.search != "") {
    ...
    b = o.pubid || "default";
    m = o.v || "";
    if (o.hasOwnProperty("debug") || o.hasOwnProperty("_ijt")) {
      com4j.config.debug = true;
    }
    if (o.hasOwnProperty("dev") && com4j.config.debug) {
      com4j.config.devMode = true;
    }
    com4j.config.parameters = o;
    if (o.hasOwnProperty("isVIP")) {
      com4j.config.isVIP = true;
    }
  }
  var d = true;
  if (
    ...
    window.location.hostname == "office.miagame.com"
  ) {
    d = false;
    com4j.config.debug = true;
  }
  com4j.config.ForJoyH5_pubid = b;
  com4j.config.v = m;
  var j = {
    mid: 147,
    pubid: "touchpal",
    ...
    BigLogo: "img/touchpal_b.png",
    SmallLogo: "",
    ShowMoreGamesButton: false,
    BgColor: "#000000",
    ShowMoreGamesDivWhenClickLogo: false,
    ShowCopyright: false,
    ShowAppLink: false,
    ShowMoreGamesDivWhenGameOver: false,
    MoreGamesUrl: "no",
    AdChannel: "6632825347",
    stats: true,
    ShowAd: false,
  };
  for (var g in j) {
    var l = "ForJoyH5_" + g;
    if (com4j.config.hasOwnProperty(l)) {
      var k = j[g];
      if (typeof k == "string") {
  ...
  com4j.config.ForJoyH5_Fullscreen =
    com4j.fullscreenEnabled && com4j.config.ForJoyH5_Fullscreen;
  com4j.ad.init();
  com4j.loading.init();
  ...
  if (com4j.initCallbackObj) {
    var n = com4j.initCallbackObj.callback;
    var a = com4j.initCallbackObj.context;
    var f = com4j.initCallbackObj.params;
    n.apply(a, f);
  }
};
window.com4j = com4j;
