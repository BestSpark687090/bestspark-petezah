...
!(function (e) {
  var t = (function (t) {
    ...
    return (
      ...
      (r.prototype.loadFile = function (t, r, i) {
        ...
        ((this.resItemDic[n.hashCode] = { item: t, func: r, thisObject: i }),
      ...
      (r.prototype.getRequest = function () {
        ...
        return (
          e ||
            ((e = new egret.HttpRequest()),
            e.addEventListener(egret.Event.COMPLETE, this.onLoadFinish, this),
            e.addEventListener(
      ...
      (r.prototype.destroyRes = function (e) {
        return this.fileDic[e]
          ? (this.onResourceDestroy(this.fileDic[e]),
  ...
  ((e.BinAnalyzer = t), __reflect(t.prototype, "RES.BinAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function () {
...
!(function (e) {
  var t = (function (t) {
    ...
    return (
      ...
      (r.prototype.onLoadFinish = function (e) {
        ...
        if (((i.loaded = e.type == egret.Event.COMPLETE), i.loaded))
          if (t instanceof egret.HttpRequest) {
            ...
            if (o) return (this.loadImage(o, r), void this.recycler.push(t));
          } else {
            var s = new egret.Texture();
            (s._setBitmapData(t.data), this.analyzeBitmap(i, s));
          }
        (t instanceof egret.HttpRequest
          ? this.recycler.push(t)
          : this.recyclerIamge.push(t),
          n.call(r.thisObject, i));
      }),
      (r.prototype.analyzeConfig = function (e, t) {
        ...
        return (
          r &&
            ((this.sheetMap[i] = r), (n = this.getRelativePath(e.url, r.file))),
          n
        );
      }),
      ...
      (r.prototype.parseSpriteSheet = function (e, t, r) {
        ...
        for (var s in i) {
          ...
          if (a.scale9grid) {
            var c = a.scale9grid,
              l = c.split(",");
            u.scale9Grid = new egret.Rectangle(
              parseInt(l[0]),
              parseInt(l[1]),
              parseInt(l[2]),
              parseInt(l[3]),
      ...
      (r.prototype.destroyRes = function (e) {
        ...
        if (t) {
          ...
          for (var i in t._textureMap)
            (null == r &&
              ((r = t._textureMap[i]), this.onResourceDestroy(r), (r = null)),
  ...
  ((e.SheetAnalyzer = t), __reflect(t.prototype, "RES.SheetAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (t) {
    function r() {
      var e = t.call(this) || this;
      return ((e.fileDic = {}), (e.resItemDic = []), (e.recycler = []), e);
    }
    return (
      __extends(r, t),
      (r.prototype.loadFile = function (t, r, i) {
      ...
      (r.prototype.onLoadFinish = function (e) {
        ...
        if (((i.loaded = e.$type == egret.Event.COMPLETE), i.loaded)) {
          ...
          (o._setBitmapData(t.data), this.analyzeData(i, o));
        }
      ...
      (r.prototype.analyzeData = function (e, t) {
        ...
        if (!this.fileDic[r] && t) {
          ...
          if (i && i.scale9grid) {
            var n = i.scale9grid,
              o = n.split(",");
            t.scale9Grid = new egret.Rectangle(
              parseInt(o[0]),
              parseInt(o[1]),
              parseInt(o[2]),
              parseInt(o[3]),
  ...
  ((e.ImageAnalyzer = t), __reflect(t.prototype, "RES.ImageAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (e) {
  ...
  ((e.TextAnalyzer = t), __reflect(t.prototype, "RES.TextAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (e) {
  ...
  ((e.JsonAnalyzer = t), __reflect(t.prototype, "RES.JsonAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (t) {
    ...
    return (
      ...
      (r.prototype.loadGroup = function (t, r, i) {
        if ((void 0 === i && (i = 0), !this.itemListDic[r] && r)) {
          ...
          (this.priorityQueue[i]
            ? this.priorityQueue[i].push(r)
            : (this.priorityQueue[i] = [r]),
      ...
      (r.prototype.getOneResourceItem = function () {
        ...
        for (
          var i, n = r.length, o = 0;
          n > o &&
          (this.queueIndex >= n && (this.queueIndex = 0),
          (i = this.itemListDic[r[this.queueIndex]]),
          !(i.length > 0));
          o++
        )
          this.queueIndex++;
      ...
      (r.prototype.onItemComplete = function (t) {
        ...
        if (!t.loaded) {
          ...
          if (!(i > this.maxRetryTimes))
            return (
              (this.retryTimesDic[t.name] = i + 1),
              this.failedList.push(t),
              void this.next()
            );
          (delete this.retryTimesDic[t.name],
            e.ResourceEvent.dispatchResourceEvent(
              this.resInstance,
              e.ResourceEvent.ITEM_LOAD_ERROR,
              r,
              t,
            ));
        }
        if (r) {
          ...
          if (
            (t.loaded || (this.groupErrorDic[r] = !0),
            e.ResourceEvent.dispatchResourceEvent(
              this.resInstance,
              e.ResourceEvent.GROUP_PROGRESS,
              r,
              t,
              n,
              o,
            ...
            (this.removeGroupName(r),
              ...
              s
                ...
                : e.ResourceEvent.dispatchResourceEvent(
                    this,
                    e.ResourceEvent.GROUP_COMPLETE,
                    r,
                  ));
          }
      ...
      (r.prototype.removeGroupName = function (e) {
        for (var t in this.priorityQueue) {
          for (
            var r = this.priorityQueue[t], i = 0, n = !1, o = r.length, s = 0;
            o > s;
            s++
          ) {
            var a = r[s];
  ...
  ((e.ResourceLoader = t), __reflect(t.prototype, "RES.ResourceLoader"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (e) {
      ...
      (t.prototype.analyzeConfig = function (e, t) {
        ...
        return (
          r
            ...
            : ((r = t), (n = this.getTexturePath(e.url, r))),
          (this.sheetMap[i] = r),
          n
        );
      }),
  ...
  ((e.FontAnalyzer = t), __reflect(t.prototype, "RES.FontAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.createGroup = function (e, t, r) {
        if (
          (void 0 === r && (r = !1),
          (!r && this.groupDic[e]) || !t || 0 == t.length)
        )
          return !1;
...
!(function (e) {
  ...
  ((e.XMLAnalyzer = t), __reflect(t.prototype, "RES.XMLAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  var t = (function (e) {
    ...
    return (
      ...
      (t.dispatchResourceEvent = function (e, r, i, n, o, s) {
        ...
        return (egret.Event.release(a), u);
      }),
      t
    );
  })(egret.Event);
...
!(function (e) {
  ...
  !(function (t) {
    ...
    ((t.Html5VersionController = r),
      __reflect(r.prototype, "RES.web.Html5VersionController", [
...
!(function (e) {
  ...
  !(function (t) {
    var r = (function () {
      ...
      return (
        (e.prototype.fetchVersion = function (e) {
          var t = this;
          if (
            ((t._versionPath = "all.manifest"),
            (t._versionInfo = t.getLocalData(t._versionPath)),
            null == t._versionInfo)
          )
            ...
            i = function (i) {
              if (i)
                for (var n = 0; n < i.length; n++)
                  i[n] &&
                    "" != i[n] &&
                    t._localFileArr.push("resource/" + i[n]);
        ...
        (e.prototype.getList = function (e, t, r) {
          ...
          ((i.onSuccessFunc = function (t) {
            ...
            "assets" == t
              ? egret_native.Game.listResource(r, i)
              : egret_native.Game.listUpdate(r, i));
        }),
        (e.prototype.getChangeList = function () {
          var e = [],
            t = this._localFileArr;
          for (var r in this._versionInfo)
            t.indexOf(this.getVirtualUrl(r)) < 0 &&
              e.push({
        ...
        (e.prototype.getVirtualUrl = function (e) {
          return this._versionInfo && this._versionInfo[e]
            ? "resource/" +
                this._versionInfo[e].v.substring(0, 2) +
                "/" +
                this._versionInfo[e].v +
                "_" +
                this._versionInfo[e].s +
                "." +
        ...
        (e.prototype.getLocalData = function (e) {
          if (
            egret_native.readUpdateFileSync &&
    ...
    ((t.NativeVersionController = r),
      __reflect(r.prototype, "RES.native.NativeVersionController", [
        "RES.VersionController",
        "RES.IVersionController",
      ]),
...
!(function (e) {
  var t = (function (t) {
    function r() {
      var e = t.call(this) || this;
      return ((e.soundDic = {}), (e.resItemDic = []), e);
    }
    return (
      __extends(r, t),
      (r.prototype.loadFile = function (t, r, i) {
  ...
  ((e.SoundAnalyzer = t), __reflect(t.prototype, "RES.SoundAnalyzer"));
})(RES || (RES = {}));
var RES;
!(function (e) {
  function t(e, t) {
  ...
  function c(e, t, r) {
    return (void 0 === r && (r = !1), I.createGroup(e, t, r));
  }
  function l(e) {
    return I.hasRes(e);
  }
  function p(e, t) {
    (void 0 === t && (t = ""), I.parseConfig(e, t));
  }
  function h(e) {
    return I.getRes(e);
  }
  ...
  function d(e, t, r, i) {
    (void 0 === i && (i = ""), I.getResByUrl(e, t, r, i));
  }
  function y(e, t) {
  ...
  function E(e, t, r, i) {
    (void 0 === i && (i = !1), I.removeEventListener(e, t, r, i));
  }
  function m(e) {
  ...
  var _ = (function (t) {
    ...
    return (
      ...
      (r.prototype.loadConfig = function (e, t, r) {
        void 0 === r && (r = "json");
        var i = { url: e, resourceRoot: t, type: r };
      ...
      (r.prototype.startLoadConfig = function () {
        ...
        this.vcs
          ? this.vcs.fetchVersion(c)
          : this.resLoader.loadGroup(o, r.GROUP_CONFIG, Number.MAX_VALUE);
      }),
      ...
      (r.prototype.loadGroup = function (t, r) {
        if ((void 0 === r && (r = 0), -1 != this.loadedGroups.indexOf(t)))
          return void e.ResourceEvent.dispatchResourceEvent(
            this,
            e.ResourceEvent.GROUP_COMPLETE,
            t,
          );
        if (!this.resLoader.isGroupInLoading(t))
          ...
          } else this.groupNameList.push({ name: t, priority: r });
      }),
      ...
      (r.prototype.getResAsync = function (t, r, i) {
        ...
        if (
          "" == n &&
          ((o = e.AnalyzerBase.getStringPrefix(t)),
          (n = this.resConfig.getType(o)),
          "" == n)
        )
        ...
        var u = { key: t, compFunc: r, thisObject: i };
      ...
      (r.prototype.getResByUrl = function (t, r, i, n) {
        ...
        var o = this.$getAnalyzerByType(n),
          ...
          a = o.getRes(s);
        if (a) return void egret.$callAsync(r, i, a, t);
        var u = { key: s, compFunc: r, thisObject: i };
      ...
      (r.prototype.onResourceItemComp = function (e) {
        ...
        for (
          var r = this.$getAnalyzerByType(e.type), i = t.length, n = 0;
          i > n;
          n++
        ) {
          var o = t[n],
        ...
        if (r && r.length > 0) {
          ...
          for (var n = r.length, o = 0; n > o; o++) {
            ...
            if (!t && this.isResInLoadedGroup(s.name));
              ...
              (a.destroyRes(s.name), this.removeLoadedGroupsByItemName(s.name));
            }
          }
          return !0;
        }
  ...
  ((_.GROUP_CONFIG = "RES__CONFIG"), __reflect(_.prototype, "Resource"));
  var I = new _();
})(RES || (RES = {}));
var RES;
!(function (e) {
  ...
  ((e.AnimationAnalyzer = t), __reflect(t.prototype, "RES.AnimationAnalyzer"));
})(RES || (RES = {}));
var egret;
!(function (e) {
  ...
  ((t[3200] =
    "RES.createGroup() passed in non-existed key value in configuration: {0}"),
    (t[3201] = 'RES loaded non-existed or empty resource group:"{0}"'),
    (t[3202] =
      "Do not use the different types of ways to load the same material!"),
    (t[3203] =
      "Can't find the analyzer of the specified file type:{0}。 Please register the specified analyzer in the initialization of the project first,then start the resource loading process。"));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ((e.$locale_strings = e.$locale_strings || {}),
  ...
  ((t[3200] = "RES.createGroup()传入了配置中不存在的键值: {0}"),
    ...
    (t[3203] =
      "找不到指定文件类型的解析器:{0}。 请先在项目初始化里注册指定文件类型的解析器，再启动资源加载。"));
})(egret || (egret = {}));
