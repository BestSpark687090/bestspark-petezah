  ...
  !(function (t) {
    var e = (function (t) {
      function e() {
        ...
        return (
          (e.targetLevel = Number.POSITIVE_INFINITY),
      ...
      return (
        ...
        (e.prototype.invalidateProperties = function (t) {
          (this.invalidatePropertiesFlag ||
            ((this.invalidatePropertiesFlag = !0),
            this.listenersAttached || this.attachListeners()),
            this.targetLevel <= t.$nestLevel &&
              (this.invalidateClientPropertiesFlag = !0),
        ...
        (e.prototype.invalidateSize = function (t) {
          (this.invalidateSizeFlag ||
            ((this.invalidateSizeFlag = !0),
            this.listenersAttached || this.attachListeners()),
            this.targetLevel <= t.$nestLevel &&
              (this.invalidateClientSizeFlag = !0),
        ...
        (e.prototype.invalidateDisplayList = function (t) {
          (this.invalidateDisplayListFlag ||
            ((this.invalidateDisplayListFlag = !0),
            this.listenersAttached || this.attachListeners()),
        ...
        (e.prototype.attachListeners = function () {
          (this.eventDisplay.addEventListener(
        ...
        (e.prototype.doPhasedInstantiationCallBack = function (t) {
          (this.eventDisplay.removeEventListener(
            egret.Event.ENTER_FRAME,
            this.doPhasedInstantiationCallBack,
            this,
          ),
        ...
        (e.prototype.validateClient = function (t) {
          ...
          this.targetLevel === Number.POSITIVE_INFINITY &&
            (this.targetLevel = t.$nestLevel);
          for (
            var r = this.invalidatePropertiesQueue,
              o = this.invalidateSizeQueue,
              s = this.invalidateDisplayListQueue;
            !i;
            ...
            for (
              r.isEmpty() && (this.invalidatePropertiesFlag = !1),
              ...
              if (
                ...
                this.invalidateClientPropertiesFlag &&
                  (e = r.removeSmallestChild(t)))
              ) {
                (r.insert(e), (i = !1));
                break;
            ...
            for (
              o.isEmpty() && (this.invalidateSizeFlag = !1),
                this.invalidateClientPropertiesFlag = !1,
      ...
      return (
        (t.prototype.insert = function (t) {
          ...
          this.maxDepth < this.minDepth
            ? (this.minDepth = this.maxDepth = e)
            : (e < this.minDepth && (this.minDepth = e),
        ...
        (t.prototype.pop = function () {
          ...
          if (e <= this.maxDepth) {
            for (
              var i = this.depthBins[this.maxDepth];
              !i || 0 === i.length;
            ...
            for (
              t = i.pop();
              !((i && 0 != i.length) || (this.maxDepth--, this.maxDepth < e));
        ...
        (t.prototype.shift = function () {
          ...
          if (this.minDepth <= e) {
            for (
              var i = this.depthBins[this.minDepth];
              !i || 0 === i.length;
            ...
            for (
              t = i.pop();
              !((i && 0 != i.length) || (this.minDepth++, this.minDepth > e));
        ...
        (t.prototype.removeLargestChild = function (t) {
          for (
            var e = t.$hashCode, i = t.$nestLevel, n = this.maxDepth, r = i;
            n >= r;
            ...
            if (o && o.length > 0) {
              ...
              n--;
            } else if ((n == this.maxDepth && this.maxDepth--, n--, r > n))
              break;
          }
          return null;
        }),
        (t.prototype.removeSmallestChild = function (t) {
          for (
            var e = t.$nestLevel, i = e, n = this.maxDepth, r = t.$hashCode;
            n >= i;
            ...
            if (o && o.length > 0) {
              ...
              i++;
            } else if ((i == this.minDepth && this.minDepth++, i++, i > n))
              break;
          }
          return null;
        }),
    ...
    var n = (function () {
      ...
      return (
        (t.prototype.insert = function (t) {
          var e = t.$hashCode;
          this.map[e] ||
            ((this.map[e] = !0), this.length++, this.items.push(t));
        }),
        (t.prototype.pop = function () {
...
!(function (t) {
  ...
  !(function (e) {
        ...
        return (
          ...
          (r.prototype.commitProperties = function () {
            ...
            ((e[22] != e[10] || e[23] != e[11]) &&
              ...
              (e[22] = e[10]),
              (e[23] = e[11])),
              (e[20] != this.$getX() || e[21] != this.$getY()) &&
                (t.UIEvent.dispatchUIEvent(this, t.UIEvent.MOVE),
                (e[20] = this.$getX()),
                (e[21] = this.$getY())));
          }),
          ...
          (r.prototype.$setAnchorOffsetX = function (t) {
            return (
              this.$super.$setAnchorOffsetX.call(this, t),
              this.invalidateParentLayout(),
              !0
            );
          }),
          (r.prototype.$setAnchorOffsetY = function (t) {
            return (
              this.$super.$setAnchorOffsetY.call(this, t),
              this.invalidateParentLayout(),
              !0
            );
          }),
          (r.prototype.$setX = function (t) {
            ...
            return (
              e && (this.invalidateParentLayout(), this.invalidateProperties()),
              e
            );
          }),
          ...
          (r.prototype.invalidateProperties = function () {
            ...
            t[24] ||
              ((t[24] = !0), this.$stage && a.invalidateProperties(this));
          }),
          ...
          (r.prototype.invalidateDisplayList = function () {
            var t = this.$UIComponent;
            t[26] ||
              ((t[26] = !0), this.$stage && a.invalidateDisplayList(this));
          }),
          ...
          (r.prototype.setLayoutBoundsSize = function (t, n) {
            if (((n = +n), (t = +t), !(0 > n || 0 > t))) {
              var r,
                ...
                u = Math.min(s[14], h);
              (isNaN(t)
                ? ((s[27] = !1), (r = this.getPreferredUWidth()))
                : ((s[27] = !0), (r = Math.max(l, Math.min(a, t)))),
                isNaN(n)
                  ? ((s[28] = !1), (o = this.getPreferredUHeight()))
                  : ((s[28] = !0), (o = Math.max(u, Math.min(h, n)))));
              var p = this.getAnchorMatrix();
              if (i(p)) return void this.setActualSize(r, o);
              var c = e.MatrixUtil.fitBounds(
                t,
                n,
                p,
                s[8],
                s[9],
                this.getPreferredUWidth(),
                this.getPreferredUHeight(),
                l,
                u,
                a,
                h,
    ...
    ((e.UIComponentImpl = h),
      __reflect(h.prototype, "eui.sys.UIComponentImpl", [
        "eui.UIComponent",
        "egret.DisplayObject",
      ]),
      (e.mixin = r),
      ...
      (i.prototype.initialize = function (e, i) {
        for (var n = this.overrides, r = n.length, o = 0; r > o; o++) {
          ...
          if (s instanceof t.AddItems) {
            var a = e[s.target];
            a &&
              a instanceof t.Image &&
              !a.$parent &&
              (i.addChild(a), i.removeChild(a));
          }
        }
      }),
      i
...
!(function (t) {
  function e(t, e) {
    if (t.hasOwnProperty(i)) t[i].push(e);
    else {
      var n = [e];
...
!(function (t) {
    ...
    return (
      ...
      (i.prototype.$parseSkinName = function () {
        ...
        if (e)
          if (e.prototype) t = new e();
            ...
            var i = void 0,
              n = e.trim();
            if ("<" == n.charAt(0)) i = EXML.parse(n);
            else if (
              ((i = egret.getDefinitionByName(e)),
      ...
      (i.prototype.setSkin = function (e) {
        ...
        if (((i[8] = e), e)) {
          ...
          if (h)
            for (var s = h.length - 1; s >= 0; s--) this.addChildAt(h[s], 0);
      ...
      (i.prototype.$setTouchChildren = function (t) {
        ...
        return (
          (i[6] = t),
          i[3] ? ((i[6] = t), e.prototype.$setTouchChildren.call(this, t)) : !0
        );
      }),
      ...
      (i.prototype.$setEnabled = function (t) {
        ...
        return t === e[3]
          ...
          : ((e[3] = t),
            t
              ? ((this.$touchEnabled = e[7]), (this.$touchChildren = e[6]))
      ...
      (i.prototype.measure = function () {
        ...
        if (e) {
          var i = this.$UIComponent;
          (isNaN(e.width)
            ? (i[16] < e.minWidth && (i[16] = e.minWidth),
              i[16] > e.maxWidth && (i[16] = e.maxWidth))
            : (i[16] = e.width),
            isNaN(e.height)
              ? (i[17] < e.minHeight && (i[17] = e.minHeight),
                i[17] > e.maxHeight && (i[17] = e.maxHeight))
              : (i[17] = e.height));
        }
      }),
  ...
  ((t.Component = e),
    __reflect(e.prototype, "eui.Component", [
      "eui.UIComponent",
      "egret.DisplayObject",
    ]),
...
!(function (t) {
  var e = (function (e) {
    function i() {
      ...
      return (
        ...
        (i.$Group = { 0: 0, 1: 0, 2: 0, 3: 0, 4: !1, 5: !1 }),
    ...
    return (
      ...
      (i.prototype.$setLayout = function (t) {
        return this.$layout == t
          ? !1
          : (this.$layout && (this.$layout.target = null),
            (this.$layout = t),
            t && (t.target = this),
            this.invalidateSize(),
            this.invalidateDisplayList(),
      ...
      (i.prototype.setContentSize = function (e, i) {
        ...
        (r || o) &&
          ...
          (n[1] = i),
          r &&
            t.PropertyEvent.dispatchPropertyEvent(
              this,
              t.PropertyEvent.PROPERTY_CHANGE,
              "contentWidth",
            ),
          o &&
            t.PropertyEvent.dispatchPropertyEvent(
      ...
      (i.prototype.updateScrollRect = function () {
        ...
        if (e) {
          var i = this.$UIComponent;
          this.scrollRect = egret.$TempRectangle.setTo(
            t[2],
            t[3],
            i[10],
            i[11],
      ...
      (i.prototype.measure = function () {
        return this.$layout
          ? void this.$layout.measure()
          : void this.setMeasuredSize(0, 0);
      }),
  ...
  ((t.Group = e),
    __reflect(e.prototype, "eui.Group", [
      "eui.IViewport",
      "eui.UIComponent",
      "egret.DisplayObject",
    ]),
    ...
    return (
      ...
      (e.prototype.partAdded = function (t, e) {
        e === this.labelDisplay
          ...
          : e == this.iconDisplay && (this.iconDisplay.source = this._icon);
      }),
    ...
    return (
      ...
      Object.defineProperty(i.prototype, "useVirtualLayout", {
        ...
        set: function (t) {
          ...
          t !== e[0] &&
            ((e[0] = t), this.$layout && (this.$layout.useVirtualLayout = t));
        },
        enumerable: !0,
        configurable: !0,
      }),
      (i.prototype.$setLayout = function (t) {
        ...
        (this.$layout &&
          ...
          this.$layout &&
            t &&
            this.$layout.$useVirtualLayout != t.$useVirtualLayout &&
            this.onUseVirtualLayoutChanged());
      ...
      (i.prototype.getVirtualElementAt = function (t) {
        if (((t = 0 | +t), 0 > t || t >= this.$dataProvider.length))
          return null;
      ...
      (i.prototype.createVirtualRenderer = function (t) {
        var e,
          ...
          r = this.$DataGroup,
          o = r[3];
        return o[n] && o[n].length > 0
          ? ((e = o[n].pop()),
            (e.visible = !0),
            this.invalidateDisplayList(),
            e)
          : ((r[4] = !0), this.createOneRenderer(i));
      }),
      (i.prototype.createOneRenderer = function (t) {
        ...
        return (
          (i[2][e.$hashCode] = t),
          egret.is(e, "eui.IItemRenderer")
            ? (i[13] && this.setItemRenderSkinName(e, i[13]),
              this.addChild(e),
              e)
            : null
        );
      ...
      (i.prototype.$setDataProvider = function (t) {
        return this.$dataProvider == t || (t && !t.getItemAt)
          ? !1
          : (this.removeDataProviderListener(),
            (this.$dataProvider = t),
      ...
      (i.prototype.removeDataProviderListener = function () {
        this.$dataProvider &&
          this.$dataProvider.removeEventListener(
            t.CollectionEvent.COLLECTION_CHANGE,
      ...
      (i.prototype.itemAdded = function (t, e) {
        if (
          (this.$layout && this.$layout.elementAdded(e),
      ...
      (i.prototype.itemRemoved = function (t, e) {
        ...
        (this.$indexToRenderer.length > e && this.$indexToRenderer.splice(e, 1),
          i &&
            (this.$layout && this.$layout.$useVirtualLayout
              ? this.doFreeRenderer(i)
              : (this.rendererRemoved(i, e, t), this.removeChild(i))));
      }),
      ...
      Object.defineProperty(i.prototype, "itemRendererSkinName", {
        ...
        set: function (t) {
          ...
          e[13] != t &&
            ((e[13] = t),
            this.$UIComponent[29] &&
              ((e[14] = !0), this.invalidateProperties()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (i.prototype.commitProperties = function () {
        ...
        if (
          ((i[5] || this.$dataProviderChanged || i[1]) &&
          ...
          i[8] &&
            ...
            this.$dataProvider &&
              ...
              ((i[12] = this.$dataProvider.getItemAt(0)),
      ...
      (i.prototype.ensureTypicalLayoutElement = function () {
        this.$DataGroup[9] ||
          (this.$dataProvider &&
            this.$dataProvider.length > 0 &&
            ((this.$DataGroup[12] = this.$dataProvider.getItemAt(0)),
            this.measureRendererSize()));
      }),
      (i.prototype.measureRendererSize = function () {
        var t = this.$DataGroup;
        if (!t[12]) return void this.setTypicalLayoutRect(null);
        ...
        (this.$layout && this.$layout.$useVirtualLayout
          ? (t[4] && this.rendererAdded(e, 0, t[12]), this.doFreeRenderer(e))
          : this.removeChild(e),
      ...
      (i.prototype.setTypicalLayoutRect = function (t) {
        ((this.$DataGroup[9] = t),
          this.$layout &&
            (t
              ? this.$layout.setTypicalSize(t.width, t.height)
              : this.$layout.setTypicalSize(0, 0)));
      }),
      (i.prototype.removeAllRenderers = function () {
        ...
        if (s[10]) {
          for (
            var a = s[3], h = Object.keys(a), l = h.length, n = 0;
            l > n;
            n++
          )
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.setValue = function (e) {
        ...
        i[4] !== e &&
          (i[0] > i[2]
            ? (i[4] = Math.min(i[0], Math.max(i[2], e)))
            : (i[4] = e),
          (i[6] = !1),
          this.invalidateDisplayList(),
          t.PropertyEvent.dispatchPropertyEvent(
  ...
  var e = (function (t) {
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "target", {
        ...
        set: function (t) {
          this.$target !== t &&
            ((this.$target = t), this.clearVirtualLayoutCache());
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (e.prototype.setTypicalSize = function (t, e) {
        ((t = +t || 71),
          (e = +e || 22),
          (t !== this.$typicalWidth || e !== this.$typicalHeight) &&
            ((this.$typicalWidth = t),
    ...
    return (
      ...
      Object.defineProperty(i.prototype, "requireSelection", {
        ...
        set: function (t) {
          ...
          var e = this.$ListBase;
          t !== e[0] &&
            ((e[0] = t), t && ((e[1] = !0), this.invalidateProperties()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      Object.defineProperty(i.prototype, "selectedItem", {
        get: function () {
          ...
          if (e != i.NO_SELECTION && null != this.$dataProvider)
            return this.$dataProvider.length > e
              ? this.$dataProvider.getItemAt(e)
              : void 0;
        },
        set: function (t) {
      ...
      (i.prototype.commitProperties = function () {
        ...
        (n &&
          ...
          void 0 !== r[5] &&
            (s ? (r[2] = s.getItemIndex(r[5])) : (r[2] = i.NO_SELECTION),
            (r[5] = void 0)));
        var a = !1;
      ...
      (i.prototype.updateRenderer = function (t, i, n) {
        return (
          this.itemSelected(i, this.$isItemIndexSelected(i)),
      ...
      (i.prototype.commitSelection = function (e) {
        ...
        var n = this.$dataProvider,
          ...
          a = r[2];
        if (
          (a < i.NO_SELECTION && (a = i.NO_SELECTION),
          a > o && (a = o),
          r[0] && a == i.NO_SELECTION && n && n.length > 0)
        )
          return ((r[2] = i.NO_PROPOSED_SELECTION), (r[4] = !1), !1);
        if (r[4]) {
          var h = this.dispatchEventWith(egret.Event.CHANGING, !1, !0, !0);
          if (!h)
            return (
              this.itemSelected(r[2], !1),
        ...
        return (
          ...
          e &&
            (r[4] && (this.dispatchEventWith(egret.Event.CHANGE), (r[4] = !1)),
            t.PropertyEvent.dispatchPropertyEvent(
              this,
              t.PropertyEvent.PROPERTY_CHANGE,
              "selectedIndex",
      ...
      (i.prototype.itemAdded = function (t, n) {
        ...
        r == i.NO_SELECTION
          ? this.$ListBase[0] && this.adjustSelection(n, !0)
          : r >= n && this.adjustSelection(r + 1, !0);
      }),
      (i.prototype.itemRemoved = function (t, n) {
        if (
          (e.prototype.itemRemoved.call(this, t, n),
          ...
          n == r
            ? this.requireSelection &&
              ...
              this.$dataProvider.length > 0
              ? 0 == n
                ? ((this.$ListBase[2] = 0), this.invalidateProperties())
                : this.setSelectedIndex(0, !1)
              : this.adjustSelection(-1, !1)
            : r > n && this.adjustSelection(r - 1, !1);
        }
      }),
      (i.prototype.onCollectionChange = function (n) {
        (e.prototype.onCollectionChange.call(this, n),
          n.kind == t.CollectionEventKind.RESET
            ? 0 == this.$dataProvider.length &&
              this.setSelectedIndex(i.NO_SELECTION, !1)
            : n.kind == t.CollectionEventKind.REFRESH &&
      ...
      (i.prototype.rendererAdded = function (t, e, i) {
        (t.addEventListener(
          ...
          this.onRendererTouchBegin,
          this,
        ),
          t.addEventListener(
            egret.TouchEvent.TOUCH_END,
            this.onRendererTouchEnd,
            this,
          ),
          t.addEventListener(
            egret.TouchEvent.TOUCH_CANCEL,
            this.onRendererTouchCancle,
            this,
          ));
      }),
      (i.prototype.rendererRemoved = function (t, e, i) {
      ...
      (i.prototype.onRendererTouchEnd = function (e) {
        ...
        n == r &&
          (i[8] ||
            (this.setSelectedIndex(n.itemIndex, !0),
            t.ItemTapEvent.dispatchItemTapEvent(
              this,
              t.ItemTapEvent.ITEM_TAP,
              n,
            )),
          (i[8] = !1));
      }),
  ...
  !(function (sys) {
    ...
    function getIds(t, e) {
      if (t.namespace != sys.NS_W && t.attributes.id) {
        ...
        this.repeatedIdMap[i]
          ? e.push(toXMLString(t))
          : (this.repeatedIdMap[i] = !0);
      }
      var n = t.children;
      if (n)
      ...
      if (t) {
        ...
        if (i)
          for (var n = i.length, r = 0; n > r; r++) {
            var o = i[r];
            1 == o.nodeType &&
              (o.attributes.includeIn && e.push(toXMLString(o)),
        ...
        return (
          ...
          (EXMLParser.prototype.parse = function (text) {
            ...
            var exClass = this.parseClass(xmlData, className),
              code = exClass.toCode(),
              clazz = null;
            if (((clazz = eval(code)), hasClass && clazz)) {
              egret.registerClass(clazz, className);
              for (
                var paths = className.split("."),
                  length_16 = paths.length,
                  definition = __global,
                  i = 0;
                length_16 - 1 > i;
                i++
          ...
          (EXMLParser.prototype.parseClass = function (t, e) {
            ...
            var i = e.lastIndexOf(".");
            (-1 != i
              ? (this.currentClass.className = e.substring(i + 1))
              : (this.currentClass.className = e),
              this.startCompile());
            var n = this.currentClass;
            return ((this.currentClass = null), n);
          }),
          (EXMLParser.prototype.startCompile = function () {
            ...
            if (e)
              for (var i = e.length, n = 0; i > n; n++) {
                ...
                if (
                  1 === r.nodeType &&
                  r.namespace == sys.NS_W &&
                  r.localName == DECLARATIONS
                ) {
                  this.declarations = r;
                  break;
                }
              }
            this.currentXML.namespace &&
            ...
            if (!e)
              if (this.isProperty(t)) e = !1;
                ...
                if (this.isProperty(n)) {
                  ...
                  i = sys.exmlConfig.getDefaultPropById(
                    n.localName,
                    n.namespace,
                  );
                var o = sys.exmlConfig.getClassNameById(
                  n.localName,
                  n.namespace,
                );
                e = sys.exmlConfig.getPropertyType(i, o) == TYPE_CLASS;
              }
            return ((t.isInnerClass = e), e);
          }),
          ...
          (EXMLParser.prototype.createVarForNode = function (t) {
            ...
            "" != e &&
              (this.currentClass.getVariableByName(t.attributes.id) ||
                this.currentClass.addVariable(
                  new sys.EXVariable(t.attributes.id),
                ));
          }),
          (EXMLParser.prototype.createFuncForNode = function (t) {
            var e = t.localName,
              i = this.isBasicTypeData(e);
            if (i) return this.createBasicTypeForNode(t);
            var n = this.getClassNameOfNode(t),
              r = new sys.EXFunction(),
              o = "_i",
              s = t.attributes.id;
            ((r.name = s + o), this.currentClass.addFunction(r));
            ...
            return (a.addReturn(h), "this." + r.name + "()");
          }),
              ...
              if (
                ...
                if (this.currentClass.getVariableByName(r)) {
                  var l = "this.",
                    u = o.id,
                    p = l + u + " = t;";
                  (this.currentClass.getVariableByName(u) ||
                    this.createVarForNode(i),
                    t.containsCodeLine(p) || t.addCodeLineAt(p, 1));
                  var c = new sys.EXCodeBlock();
                  ("this" == e
                    ? c.addAssignment(e, l + r, n)
                    : (c.startIf(l + u),
                      c.addAssignment(l + u, l + r, n),
                      c.endBlock()),
                    this.delayAssignmentDic[r] ||
                      (this.delayAssignmentDic[r] = []),
          ...
          (EXMLParser.prototype.initlizeChildNode = function (t, e, i) {
            ...
            if (n && 0 != n.length) {
              for (
                var r,
                  o = sys.exmlConfig.getClassNameById(t.localName, t.namespace),
                  s = [],
                  a = n.length,
                  h = [],
                  l = 0;
                ...
                if (1 == u.nodeType && u.namespace != sys.NS_W)
                  if (this.isInnerClass(u)) {
                    ...
                    if (this.isProperty(u)) {
                      if (!this.isNormalKey(d)) continue;
                      var c = sys.exmlConfig.getPropertyType(u.localName, o);
                      if (!c) continue;
                      if (!u.children || 0 == u.children.length) continue;
                      this.addChildrenToProp(u.children, c, d, e, i, r, h, t);
                    } else s.push(u);
                  }
              }
              if (0 != s.length) {
                var f = sys.exmlConfig.getDefaultPropById(
                    t.localName,
                    t.namespace,
                  ),
          ...
          (EXMLParser.prototype.parseInnerClass = function (t) {
            ...
            var i =
              ...
              n = e.parseClass(t, i);
            return (
              this.currentClass.addInnerClass(n),
              exmlParserPool.push(e),
              i
            );
          }),
          (EXMLParser.prototype.addChildrenToProp = function (
            t,
            e,
            i,
            n,
            ...
            if (l > 1) {
              ...
              else h = this.formatValue(i, d.text, a);
            }
            "" != h &&
              (-1 == h.indexOf("()") && (i = this.formatKey(i, h)),
          ...
          (EXMLParser.prototype.isProperty = function (t) {
            ...
            return ((t.isProperty = e), e);
          }),
          (EXMLParser.prototype.isNormalKey = function (t) {
            return t &&
              -1 == t.indexOf(".") &&
              -1 == t.indexOf(":") &&
              -1 == wingKeys.indexOf(t)
              ? !0
              : !1;
          }),
          ...
          (EXMLParser.prototype.formatValue = function (t, e, i) {
            ...
            if (s) {
              ...
              (i !== this.currentXML && (a += "." + i.attributes.id),
                this.bindings.push(
                  new sys.EXBinding(a, t, s.templates, s.chainIndex),
                ),
                (e = ""));
            } else if (o == RECTANGLE) {
              e = "new " + RECTANGLE + "(" + e + ")";
              ...
              switch (o) {
                ...
                case "number":
                  0 == e.indexOf("#")
                    ? (e = "0x" + e.substring(1))
                    : -1 != e.indexOf("%") &&
                      (e = parseFloat(e.substr(0, e.length - 1)).toString());
                  break;
                case "boolean":
          ...
          (EXMLParser.prototype.formatBinding = function (t, e, i) {
            ...
            for (
              var n = -1 == e.indexOf("+") ? [e] : this.parseTemplates(e),
                r = [],
                o = n.length,
                s = 0;
              o > s;
              ...
              if (a) {
                ...
                if (
                  !(
                    ...
                    (h >= "0" && "9" >= h) ||
                    "-" == h ||
                    (-1 == a.indexOf(".") && -1 != jsKeyWords.indexOf(a))
                  )
                ) {
                  0 == a.indexOf("this.") && (a = a.substring(5));
                  var l = a.split(".")[0];
                  (l != HOST_COMPONENT &&
                    -1 == this.skinParts.indexOf(l) &&
                    (a = HOST_COMPONENT + "." + a),
                    (n[s] = '"' + a + '"'),
                    r.push(s));
                }
              } else (n.splice(s, 1), s--, o--);
            }
            return { templates: n, chainIndex: r };
          }),
          ...
          (EXMLParser.prototype.createConstructFunc = function () {
            ...
            var e = "this";
            if (
              (this.addAttributesToCodeBlock(t, e, this.currentXML),
              this.declarations)
            ) {
            ...
            if (l.length > 0) {
              h = l.length;
              for (var r = 0; h > r; r++)
                ((a = l[r]), t.addCodeLine("this." + a + "_i();"));
              t.addEmptyLine();
            }
            var u = this.skinParts,
              p = "[]";
            if (((h = u.length), h > 0)) {
              for (var r = 0; h > r; r++) u[r] = '"' + u[r] + '"';
              p = "[" + u.join(",") + "]";
            }
            var c = new sys.EXFunction();
            ((c.name = "skinParts"), (c.isGet = !0));
            ...
            for (
              var f,
                y = this.currentXML,
                v = (this.getClassNameOfNode(y), y.attributes),
                g = Object.keys(v),
                m = g.length,
                $ = 0;
              m > $;
              ...
              if (-1 != _) {
                ...
                if (x > 0)
                  for (var r = 0; x > r; r++) {
                    var b = f[r];
                    b.addOverride(new sys.EXSetProperty("", S, T));
                  }
              }
            }
            ...
            if (((h = I.length), h > 0)) {
              ...
              for (var N = !0, r = 0; h > r; r++) {
                ...
                for (var O = b.toCode().split("\n"), A = 0; A < O.length; ) {
                  var M = O[A];
                  (M && t.addCodeLine(L + M), A++);
                }
              }
              t.addCodeLine("];");
            }
          ...
          (EXMLParser.prototype.isStateNode = function (t) {
            var e = t.attributes;
            return (
              e.hasOwnProperty("includeIn") || e.hasOwnProperty("excludeFrom")
            );
          }),
            ...
            if (i == TYPE_STATE) {
              ...
              if (a)
                for (var h = a.length, l = 0; h > l; l++)
                  if (
                    ((o = a[l]), 1 == o.nodeType && "states" == o.localName)
                  ) {
                    ((o.namespace = sys.NS_W), (r = o.children));
                    break;
                  }
              if (r || n)
                if (n)
                  ...
                  for (var d = r.length, l = 0; d > l; l++) {
                    ...
                    if (1 == f.nodeType) {
                      ...
                      if (v.stateGroups)
                        for (
                          var g = v.stateGroups.split(","), m = g.length, $ = 0;
                          m > $;
                          $++
                        ) {
                          var E = g[$].trim();
                          E && (-1 == s.indexOf(E) && s.push(E), y.push(E));
                        }
                      var c = v.name;
                      (-1 == s.indexOf(c) && s.push(c),
            ...
            if (e)
              for (var i = e.length, n = 0; i > n; n++) {
                ...
                if (
                  1 == r.nodeType &&
                  !this.isInnerClass(r) &&
                  (this.createStates(r), r.namespace != sys.NS_W && r.localName)
                )
                  if (this.isProperty(r)) {
                    ...
                    var l = this.getClassNameOfNode(t),
                      u = (sys.exmlConfig.getPropertyType(o, l), a[0]),
                      p = void 0;
                    1 == u.nodeType
                      ? (this.createFuncForNode(u),
                        this.checkIdForState(u),
                        (p = "this." + u.attributes.id))
                      : (p = this.formatValue(o, u.text, t));
                    ...
                    if (d > 0)
                      for (var f = 0; d > f; f++) {
                        var y = c[f];
                        y.addOverride(
                          new sys.EXSetProperty(t.attributes.id, o, p),
                        );
                      }
                    ...
                    if (this.isStateNode(r)) {
                      ...
                      ($.localName == TYPE_ARRAY && ($ = $.parent),
                        ...
                        $ &&
                          $ != this.currentXML &&
                          ((m = $.attributes.id), this.checkIdForState($)));
                      var E = this.findNearNodeId(r),
                        C = [];
                      if (v.includeIn) C = v.includeIn.split(",");
                      else {
                        for (
                          var _ = v.excludeFrom.split(","), S = _.length, f = 0;
                          S > f;
                          f++
                        ) {
                          var T = _[f];
                    ...
                    for (
                      var b = Object.keys(v), I = b.length, L = 0;
                      I > L;
                      L++
                    ) {
                      var N = b[L],
                      ...
                      if (-1 != s) {
                        ...
                        if (!A && ((p = this.formatValue(O, p, r)), !p))
                          continue;
                        ((h = N.substr(s + 1)),
                          (c = this.getStateByName(h, r)));
                        var d = c.length;
          ...
          (EXMLParser.prototype.getStateByName = function (t, e) {
            for (
              var i = [], n = this.stateCode, r = n.length, o = 0;
              r > o;
              o++
            ) {
              var s = n[o];
          ...
          (EXMLParser.prototype.findNearNodeId = function (t) {
            for (
              ...
              this.isProperty(p) ||
                (p == t
                  ? ((a = !0), (s = u))
                  : !a || n || this.isStateNode(p) || (n = p),
                a || this.isStateNode(p) || (i = p));
            }
            return 0 == s
              ? ((e = 0), { position: e, relativeTo: o })
              : s == l - 1
                ? ((e = 1), { position: e, relativeTo: o })
                : n && ((e = 2), (o = n.attributes.id))
                  ? (this.checkIdForState(n), { position: e, relativeTo: o })
                  : { position: 1, relativeTo: o };
          }),
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "gap", {
        ...
        set: function (t) {
          ((t = +t || 0),
            this.$gap !== t &&
              ((this.$gap = t), this.invalidateTargetLayout()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "paddingLeft", {
        ...
        set: function (t) {
          ((t = +t || 0),
            this.$paddingLeft !== t &&
              ((this.$paddingLeft = t), this.invalidateTargetLayout()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "paddingRight", {
        ...
        set: function (t) {
          ((t = +t || 0),
            this.$paddingRight !== t &&
              ((this.$paddingRight = t), this.invalidateTargetLayout()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "paddingTop", {
        ...
        set: function (t) {
          ((t = +t || 0),
            this.$paddingTop !== t &&
              ((this.$paddingTop = t), this.invalidateTargetLayout()));
        },
        enumerable: !0,
        configurable: !0,
      }),
        ...
        set: function (t) {
          ((t = +t || 0),
            this.$paddingBottom !== t &&
              ((this.$paddingBottom = t), this.invalidateTargetLayout()));
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (e.prototype.measure = function () {
        this.$target &&
          (this.$useVirtualLayout ? this.measureVirtual() : this.measureReal());
      }),
      ...
      (e.prototype.updateDisplayList = function (t, e) {
        var i = this.$target;
        if (i)
          return 0 == i.numElements
            ? void i.setContentSize(
                Math.ceil(this.$paddingLeft + this.$paddingRight),
                Math.ceil(this.$paddingTop + this.$paddingBottom),
              )
            : void (this.$useVirtualLayout
                ? this.updateDisplayListVirtual(t, e)
                : this.updateDisplayListReal(t, e));
      }),
      ...
      (e.prototype.elementRemoved = function (e) {
        this.$useVirtualLayout &&
          (t.prototype.elementRemoved.call(this, e),
          this.elementSizeTable.splice(e, 1));
      }),
      (e.prototype.clearVirtualLayoutCache = function () {
        this.$useVirtualLayout &&
          ((this.elementSizeTable = []), (this.maxElementSize = 0));
      }),
      (e.prototype.findIndexAt = function (t, e, i) {
        var n = (0.5 * (e + i)) | 0,
          r = this.getStartPosition(n),
          o = this.getElementSize(n);
        return t >= r && t < r + o + this.$gap
          ? n
          : e == i
            ? -1
            : r > t
              ? this.findIndexAt(t, e, Math.max(e, n - 1))
              : this.findIndexAt(t, Math.min(n + 1, i), i);
      }),
      (e.prototype.scrollPositionChanged = function () {
        if (
          (t.prototype.scrollPositionChanged.call(this), this.$useVirtualLayout)
        ) {
          var e = this.getIndexInView();
          e &&
            ((this.indexInViewCalculated = !0),
  ...
  var e = (function (e) {
    ...
    return (
        ...
        (e.prototype.partAdded.call(this, t, i),
          i == this.thumb
            ? (this.thumb.addEventListener(
                egret.TouchEvent.TOUCH_BEGIN,
                this.onThumbTouchBegin,
                this,
              ),
              this.thumb.addEventListener(
                egret.Event.RESIZE,
                this.onTrackOrThumbResize,
                this,
              ))
            : i == this.track
              ? (this.track.addEventListener(
                  egret.TouchEvent.TOUCH_BEGIN,
                  this.onTrackTouchBegin,
                  this,
                ),
                this.track.addEventListener(
                  egret.Event.RESIZE,
              ...
              : i === this.trackHighlight &&
                ((this.trackHighlight.touchEnabled = !1),
                egret.is(this.trackHighlight, "egret.DisplayObjectContainer") &&
      ...
      (i.prototype.updateWhenTouchMove = function (t) {
        t != this.$SliderBase[7] &&
          (this.liveDragging
            ? (this.setValue(t), this.dispatchEventWith(egret.Event.CHANGE))
            : (this.pendingValue = t));
      }),
      (i.prototype.onStageTouchEnd = function (e) {
        ...
        this.liveDragging ||
          this.value == n[7] ||
          (this.setValue(n[7]), this.dispatchEventWith(egret.Event.CHANGE));
      }),
      (i.prototype.onTouchBegin = function (t) {
        (this.$stage.addEventListener(
          egret.TouchEvent.TOUCH_END,
          this.stageTouchEndHandler,
          this,
        ),
      ...
      (i.prototype.stopAnimation = function () {
        (this.$SliderBase[5].stop(),
          this.setValue(
            this.nearestValidValue(this.pendingValue, this.snapInterval),
          ),
          this.dispatchEventWith(egret.Event.CHANGE),
          t.UIEvent.dispatchUIEvent(this, t.UIEvent.CHANGE_END));
      }),
      (i.prototype.onTrackTouchBegin = function (e) {
        ...
        if (h != l[7])
          if (0 != l[6]) {
            l[5] ||
              ((l[5] = new t.sys.Animation(this.$animationUpdateHandler, this)),
...
!(function (t) {
  function e(e) {
    for (
      var i = e[0],
        n = i instanceof t.Watcher ? i.getValue() : i,
        r = e.length,
        o = 1;
      r > o;
      o++
  ...
  var i = (function () {
    function i() {}
    return (
      (i.bindProperty = function (e, i, n, r) {
...
!(function (t) {
  var e = [],
    ...
    r = (function () {
      function t() {}
      return (
        (t.prototype.getAsset = function (t, r, o) {
          var s = i[t];
...
var eui;
!(function (t) {
  var e = new t.DefaultAssetAdapter(),
    i = (function (i) {
      function n(t) {
      ...
      return (
        ...
        Object.defineProperty(n.prototype, "fillMode", {
          ...
          set: function (t) {
            t != this.$fillMode &&
              ((this.$fillMode = t), this.invalidateDisplayList());
          },
          enumerable: !0,
          configurable: !0,
        }),
        (n.prototype.$setFillMode = function (t) {
        ...
        Object.defineProperty(n.prototype, "source", {
          ...
          set: function (t) {
            t != this._source &&
              ...
              this.$stage
                ? this.parseSource()
                : ((this.sourceChanged = !0), this.invalidateProperties()));
          },
          enumerable: !0,
          configurable: !0,
        }),
        (n.prototype.$setBitmapData = function (t) {
          ...
          var e = i.prototype.$setBitmapData.call(this, t);
          return (
        ...
        (n.prototype.parseSource = function () {
          this.sourceChanged = !1;
          var t = this._source;
          if (t && "string" == typeof t) {
            var i = egret.getImplementation("eui.IAssetAdapter");
            (i || (i = e), i.getAsset(this._source, this.contentChanged, this));
          } else this.$setBitmapData(t);
        }),
        (n.prototype.contentChanged = function (t, e) {
          e === this._source &&
            egret.is(t, "egret.Texture") &&
            (this.$setBitmapData(t),
            t && this.dispatchEventWith(egret.Event.COMPLETE));
        }),
        (n.prototype.$measureContentBounds = function (t) {
          var e = (this.$Bitmap, this.$Bitmap[0]);
          if (e) {
            var i = this.$UIComponent,
              n = i[10],
              r = i[11];
            ...
            ("clip" == this.$fillMode &&
              (n > e.$getTextureWidth() && (n = e.$getTextureWidth()),
          ...
          if (t) {
            ...
            if (0 !== i && 0 !== n) {
              ...
              egret.sys.BitmapNode.$updateTextureData(
                ...
                r[13],
                r[14],
                this.scale9Grid || r[0].scale9Grid,
                this.$fillMode,
                r[10],
              );
            }
        ...
        (n.prototype.measure = function () {
          var t = this.$Bitmap[0];
          t
            ? this.setMeasuredSize(t.$getTextureWidth(), t.$getTextureHeight())
  ...
  ((t.Image = i),
    __reflect(i.prototype, "eui.Image", [
      "eui.UIComponent",
      "egret.DisplayObject",
    ]),
    t.sys.implementUIComponent(i, egret.Bitmap),
    t.registerProperty(i, "scale9Grid", "egret.Rectangle"));
})(eui || (eui = {}));
var eui;
!(function (t) {
    ...
    i = (function (i) {
      ...
      return (
        ...
        (n.prototype.$setStyle = function (t) {
          if (this.$style != t) {
            ...
            if (e) {
              ...
              for (var i in this.$revertStyle) this[i] = this.$revertStyle[i];
        ...
        (n.prototype.$setSize = function (t) {
          return (
            this.$changeFromStyle ||
              (delete this.$revertStyle.size, (this.$styleSetMap.size = !1)),
        ...
        (n.prototype.$setBold = function (t) {
          return (
            this.$changeFromStyle ||
              (delete this.$revertStyle.bold, (this.$styleSetMap.bold = !1)),
        ...
        (n.prototype.$setBorder = function (t) {
          (this.$changeFromStyle ||
            (delete this.$revertStyle.border, (this.$styleSetMap.border = !1)),
        ...
        (n.prototype.measure = function () {
          var t = this.$UIComponent,
            ...
            n = e[3],
            r = 0 / 0;
          (isNaN(this._widthConstraint)
            ? isNaN(t[8])
              ? 1e5 != t[13] && (r = t[13])
              : (r = t[8])
            : ((r = this._widthConstraint), (this._widthConstraint = 0 / 0)),
        ...
        (n.prototype.setLayoutBoundsSize = function (t, i) {
          if (
            (e.prototype.setLayoutBoundsSize.call(this, t, i),
  ...
  ((t.Label = i),
    __reflect(i.prototype, "eui.Label", [
      "eui.UIComponent",
      "egret.DisplayObject",
      "eui.IDisplayText",
    ]),
...
!(function (t) {
  var e = (function (e) {
    function i() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.allowMultipleSelection = !1),
        (t._selectedIndices = []),
        (t.isValidIndex = function (e, i, n) {
          return (
            t.$dataProvider &&
            e >= 0 &&
            e < t.$dataProvider.length &&
            e % 1 == 0
          );
        }),
        t
    ...
    return (
        ...
        get: function () {
          return this._proposedSelectedIndices
            ? this._proposedSelectedIndices.length > 0
              ? this._proposedSelectedIndices[0]
              : -1
      ...
      (i.prototype.setSelectedIndices = function (t, e) {
        ...
        (e && (i[4] = i[4] || e),
          t
            ? (this._proposedSelectedIndices = t)
            : (this._proposedSelectedIndices = []),
          this.invalidateProperties());
      }),
      (i.prototype.commitProperties = function () {
      ...
      (i.prototype.commitSelection = function (i) {
        ...
        if (this._proposedSelectedIndices) {
          if (
            ((this._proposedSelectedIndices =
              this._proposedSelectedIndices.filter(this.isValidIndex)),
          ...
          this._proposedSelectedIndices.length > 0
            ? (n[2] = this._proposedSelectedIndices[0])
            : (n[2] = -1);
        }
        ...
        return (
          a > t.ListBase.NO_SELECTION &&
            (this._proposedSelectedIndices
              ? -1 == this._proposedSelectedIndices.indexOf(a) &&
                this._proposedSelectedIndices.push(a)
              : (this._proposedSelectedIndices = [a])),
          this._proposedSelectedIndices &&
            (-1 != this._proposedSelectedIndices.indexOf(r) &&
              this.itemSelected(r, !0),
            this.commitMultipleSelection()),
          i &&
            s &&
            (n[4] && (this.dispatchEventWith(egret.Event.CHANGE), (n[4] = !1)),
            t.PropertyEvent.dispatchPropertyEvent(
              this,
              t.PropertyEvent.PROPERTY_CHANGE,
              "selectedIndex",
      ...
      (i.prototype.commitMultipleSelection = function () {
        ...
        if (((this._selectedIndices = o), i.length > 0))
          for (e = i.length, t = 0; e > t; t++) this.itemSelected(i[t], !1);
        if (n.length > 0)
          for (e = n.length, t = 0; e > t; t++) this.itemSelected(n[t], !0);
        this._proposedSelectedIndices = null;
      }),
      (i.prototype.$isItemIndexSelected = function (t) {
        return this.allowMultipleSelection
          ? -1 != this._selectedIndices.indexOf(t)
          : e.prototype.$isItemIndexSelected.call(this, t);
      }),
      (i.prototype.dataProviderRefreshed = function () {
        this.allowMultipleSelection ||
          e.prototype.dataProviderRefreshed.call(this);
      }),
      (i.prototype.calculateSelectedIndices = function (t) {
        ...
        if (n > 0) {
          if (1 == n && i[0] == t)
            return this.$ListBase[0] ? (e.splice(0, 0, i[0]), e) : e;
      ...
      (i.prototype.onRendererTouchEnd = function (i) {
        if (this.allowMultipleSelection) {
          ...
          (this.setSelectedIndices(
            this.calculateSelectedIndices(n.itemIndex),
            !0,
          ),
            t.ItemTapEvent.dispatchItemTapEvent(
              this,
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.partRemoved = function (t, i) {
        (e.prototype.partRemoved.call(this, t, i),
          i == this.moveArea
            ? this.moveArea.removeEventListener(
                egret.TouchEvent.TOUCH_BEGIN,
                this.onTouchBegin,
                this,
              )
      ...
      (i.prototype.onCloseButtonClick = function (e) {
        t.UIEvent.dispatchUIEvent(this, t.UIEvent.CLOSING, !0, !0) &&
          this.close();
      }),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      Object.defineProperty(i.prototype, "labelFunction", {
        ...
        set: function (t) {
          this._labelFunction != t &&
            ((this._labelFunction = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      (i.prototype.valueToLabel = function (t, e) {
        return null != this.labelFunction
          ? this._labelFunction(t, e)
          : t + " / " + e;
      }),
      Object.defineProperty(i.prototype, "slideDuration", {
        get: function () {
          ...
          ((t = 0 | +t),
            this._slideDuration !== t &&
              ...
              this.animation.isPlaying &&
                (this.animation.stop(), this.setValue(this.slideToValue))));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(i.prototype, "direction", {
        ...
        set: function (t) {
          this._direction != t &&
            (this.thumb && (this.thumb.x = this.thumbInitX),
      ...
      (i.prototype.$setValue = function (t) {
        ...
        if (this._slideDuration > 0 && this.$stage) {
          ...
          var o =
            this._slideDuration *
            (Math.abs(this.animationValue - this.slideToValue) / (i[0] - i[2]));
      ...
      (i.prototype.partAdded = function (t, i) {
        (e.prototype.partAdded.call(this, t, i),
          i === this.thumb &&
            (this.thumb.x && (this.thumbInitX = this.thumb.x),
    ...
    i = (function (i) {
      ...
      return (
        ...
        Object.defineProperty(n.prototype, "enabled", {
          get: function () {
            return this.$Component[3]
              ? !this.$radioButtonGroup || this.$radioButtonGroup.$enabled
              : !1;
          },
          set: function (t) {
            this.$setEnabled(t);
          ...
          set: function (t) {
            this._group != t &&
              (this.$radioButtonGroup &&
                this.$radioButtonGroup.$removeInstance(this, !1),
              (this._group = t),
        ...
        (n.prototype.updateDisplayList = function (t, e) {
          (i.prototype.updateDisplayList.call(this, t, e),
            this.group &&
              (this.$selected
                ? this._group.$setSelection(this, !1)
                : this.group.selection == this &&
                  this._group.$setSelection(null, !1)));
        }),
        (n.prototype.buttonReleased = function () {
          this.enabled &&
            !this.selected &&
            (this.$radioButtonGroup || this.addToGroup(),
...
!(function (t) {
  function e(t, i) {
    ...
    var o = t.$nestLevel,
      ...
      h = 0;
    return (
      n == r && ((a = n.getChildIndex(t)), (h = r.getChildIndex(i))),
    ...
    n = (function (n) {
      ...
      return (
        ...
        Object.defineProperty(r.prototype, "selectedValue", {
          get: function () {
            return this.selection
              ? null != this.selection.value
                ? this.selection.value
                : this.selection.label
              : null;
          },
          set: function (e) {
            if (((this._selectedValue = e), null == e))
        ...
        (r.prototype.$addInstance = function (t) {
          t.addEventListener(egret.Event.REMOVED, this.removedHandler, this);
        ...
        (r.prototype.$removeInstance = function (t, e) {
          if (t)
            for (
              var i = !1, n = this.radioButtons, r = n.length, o = 0;
              r > o;
              o++
            ) {
              var s = n[o];
              i
                ? (s.$indexNumber = s.$indexNumber - 1)
                : s == t &&
                  (e &&
                    t.addEventListener(
                      egret.Event.ADDED,
        ...
        (r.prototype.addedHandler = function (t) {
          var e = t.target;
          e &&
            (e.removeEventListener(egret.Event.ADDED, this.addedHandler, this),
            this.$addInstance(e));
        }),
    ...
    return (
      ...
      Object.defineProperty(e.prototype, "fillColor", {
        ...
        set: function (t) {
          void 0 != t &&
            this.$fillColor != t &&
            ((this.$fillColor = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "fillAlpha", {
        ...
        set: function (t) {
          this.$fillAlpha != t &&
            ((this.$fillAlpha = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "strokeColor", {
        ...
        set: function (t) {
          this.$strokeColor != t &&
            ((this.$strokeColor = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "strokeAlpha", {
        ...
        set: function (t) {
          this.$strokeAlpha != t &&
            ((this.$strokeAlpha = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "strokeWeight", {
        ...
        set: function (t) {
          this.$strokeWeight != t &&
            ((this.$strokeWeight = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "ellipseWidth", {
        ...
        set: function (t) {
          this.$ellipseWidth != t &&
            ((this.$ellipseWidth = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "ellipseHeight", {
        ...
        set: function (t) {
          this.$ellipseHeight != t &&
            ((this.$ellipseHeight = t), this.invalidateDisplayList());
        },
        enumerable: !0,
        configurable: !0,
      }),
      (e.prototype.updateDisplayList = function (t, e) {
        ...
        (i.clear(),
          this.$strokeWeight > 0 &&
            ...
            0 == this.$ellipseWidth && 0 == this.$ellipseHeight
              ? i.drawRect(
                  this.$strokeWeight / 2,
                  this.$strokeWeight / 2,
                  t - this.$strokeWeight,
          ...
          0 == this.$ellipseWidth && 0 == this.$ellipseHeight
            ? i.drawRect(
                this.$strokeWeight,
                this.$strokeWeight,
                t - 2 * this.$strokeWeight,
                e - 2 * this.$strokeWeight,
              )
            : i.drawRoundRect(
                this.$strokeWeight,
                this.$strokeWeight,
  ...
  var e,
    i = (function (i) {
      function n() {
        ...
        var n = new t.sys.TouchScroll(
            e.horizontalUpdateHandler,
            e.horizontalEndHandler,
            e,
          ),
          r = new t.sys.TouchScroll(
            e.verticalUpdateHandler,
            e.verticalEndHanlder,
            e,
          );
        return (
          (e.$Scroller = {
      ...
      return (
        ...
        (n.prototype.$getThrowInfo = function (i, n) {
          return (
            e
              ? ((e.currentPos = i), (e.toPos = n))
              : (e = new t.ScrollerThrowEvent(
                  t.ScrollerThrowEvent.THROW,
                  !1,
                  !1,
                  i,
                  n,
        ...
        (n.prototype.stopAnimation = function () {
          var e = this.$Scroller,
            i = e[9],
            n = e[8];
          (i.animation.isPlaying
            ? t.UIEvent.dispatchUIEvent(this, t.UIEvent.CHANGE_END)
            : n.animation.isPlaying &&
              t.UIEvent.dispatchUIEvent(this, t.UIEvent.CHANGE_END),
            i.stop(),
            n.stop());
        ...
        (n.prototype.installViewport = function () {
          ...
          (t &&
            ...
            t.addEventListener(
              egret.TouchEvent.TOUCH_BEGIN,
              this.onTouchBeginCapture,
              this,
              !0,
            ),
            t.addEventListener(
              egret.TouchEvent.TOUCH_END,
              this.onTouchEndCapture,
              this,
              !0,
            ),
            t.addEventListener(
              egret.TouchEvent.TOUCH_TAP,
              this.onTouchTapCapture,
              this,
              !0,
            ),
            t.addEventListener(
              egret.Event.REMOVED,
              this.onViewPortRemove,
              this,
            )),
        ...
        (n.prototype.onViewPortRemove = function (t) {
          t.target == this.viewport &&
            ((this.$Scroller[11] = !0), (this.viewport = null));
        }),
        ...
        (n.prototype.onTouchEndCapture = function (t) {
          this.$Scroller[12] && (t.stopPropagation(), this.onTouchEnd(t));
        }),
        (n.prototype.onTouchTapCapture = function (t) {
          this.$Scroller[12] && t.stopPropagation();
        }),
        ...
        (n.prototype.onTouchMove = function (e) {
          if (!e.isDefaultPrevented()) {
            ...
            if (!i[5]) {
              ...
              var o = void 0;
              if (
                ((o = Math.abs(i[4] - e.$stageY) < n.scrollThreshold ? !1 : !0),
                !r && !o)
              )
                return;
            ...
            (i[6] && i[8].update(e.$stageX, h.contentWidth - l[10], h.scrollH),
              i[7] &&
                i[9].update(e.$stageY, h.contentHeight - l[11], h.scrollV));
          }
        }),
        ...
        (n.prototype.dispatchCancelEvent = function (t) {
          ...
          if (e) {
            for (
              var i = new egret.TouchEvent(
                  egret.TouchEvent.TOUCH_CANCEL,
                  t.bubbles,
                  t.cancelable,
                ),
                n = this.downTarget,
                r = this.$getPropagationList(n),
                o = r.length,
                s = 0.5 * r.length,
                a = -1,
                h = 0;
        ...
        (n.prototype.onTouchEnd = function (t) {
          ...
          (e[8].isStarted() && e[8].finish(i.scrollH, i.contentWidth - n[10]),
            e[9].isStarted() &&
              e[9].finish(i.scrollV, i.contentHeight - n[11]));
        }),
        ...
        (n.prototype.horizontalUpdateHandler = function (t) {
          ((this.$Scroller[10].scrollH = t),
            this.dispatchEventWith(egret.Event.CHANGE));
        }),
        (n.prototype.verticalUpdateHandler = function (t) {
          ((this.$Scroller[10].scrollV = t),
            this.dispatchEventWith(egret.Event.CHANGE));
        }),
        ...
        (n.prototype.onChangeEnd = function () {
          ...
          (((i && i.visible) || (n && n.visible)) &&
            (e[2] ||
              ((e[2] = new egret.Timer(200, 1)),
              e[2].addEventListener(
                egret.TimerEvent.TIMER_COMPLETE,
                this.onAutoHideTimer,
                this,
              )),
            e[2].reset(),
            e[2].start()),
      ...
      Object.defineProperty(i.prototype, "hostComponent", {
        ...
        set: function (e) {
          if (this._hostComponent != e) {
            (this._hostComponent &&
              this._hostComponent.removeEventListener(
            ...
            ((i.parent = e),
              e &&
                (this.commitCurrentState(),
                this.$stateValues.intialized ||
                  (e.$stage
                    ? this.initializeStates(e.$stage)
                    : e.once(
                        egret.Event.ADDED_TO_STAGE,
                        this.onAddedToStage,
                        this,
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.$setDataProvider = function (i) {
        ...
        return (
          n &&
            n instanceof t.ViewStack &&
            (n.removeEventListener(
              t.PropertyEvent.PROPERTY_CHANGE,
              this.onViewStackIndexChange,
              this,
            ),
            this.removeEventListener(
              egret.Event.CHANGE,
      ...
      (i.prototype.onViewStackIndexChange = function (t) {
        "selectedIndex" != t.property ||
          this.indexBeingUpdated ||
          this.setSelectedIndex(this.$dataProvider.selectedIndex, !1);
      }),
      i
    );
  })(t.ListBase);
    ...
    i = (function (i) {
      ...
      return (
        ...
        (n.prototype.getCurrentState = function () {
          var t = this.skin;
          return !this.prompt || this.isFocus || this.text
            ? this.enabled
              ? "normal"
              : "disabled"
            : this.enabled && t.hasState("normalWithPrompt")
              ? "normalWithPrompt"
              : !this.enabled && t.hasState("disabledWithPrompt")
                ? "disabledWithPrompt"
                : void 0;
        }),
        (n.prototype.partAdded = function (n, r) {
          ...
          r == this.textDisplay
            ? (this.textDisplayAdded(),
              this.textDisplay instanceof t.EditableText &&
                (this.textDisplay.addEventListener(
                  e.FOCUS_IN,
                  this.focusInHandler,
                  this,
                ),
            ...
            : r == this.promptDisplay &&
              o[0] &&
              (this.promptDisplay.text = o[0]);
        }),
          ...
          (i.prototype.partRemoved.call(this, n, r),
            r == this.textDisplay
              ? (this.textDisplayRemoved(),
                this.textDisplay instanceof t.EditableText &&
                  (this.textDisplay.removeEventListener(
                    e.FOCUS_IN,
                    this.focusInHandler,
                    this,
                  ),
              ...
              : r == this.promptDisplay &&
                (this.$TextInput[0] = this.promptDisplay.text));
        }),
      ...
      (e.prototype.updateSkinDisplayList = function () {
        if (this.thumb && this.track) {
          ...
          if (
            ...
            var u = this.trackHighlight.$parent.globalToLocal(
              o,
              s,
              egret.$TempPoint,
            ).y;
...
!(function (t) {
  var e = (function (e) {
    ...
    return (
      ...
      Object.defineProperty(i.prototype, "selectedIndex", {
        get: function () {
          return this.proposedSelectedIndex != t.ListBase.NO_PROPOSED_SELECTION
            ? this.proposedSelectedIndex
            : this._selectedIndex;
        },
        set: function (t) {
      ...
      (i.prototype.$childAdded = function (i, n) {
        ...
        (-1 == r
          ...
          t.CollectionEvent.dispatchCollectionEvent(
            this,
            t.CollectionEvent.COLLECTION_CHANGE,
            t.CollectionEventKind.ADD,
            n,
            -1,
            [i.name],
          ));
      ...
      (i.prototype.$childRemoved = function (i, n) {
        ...
        (n == r
          ? this.numChildren > 0
            ? 0 == n
              ? ((this.proposedSelectedIndex = 0), this.invalidateProperties())
              : this.setSelectedIndex(0)
            : this.setSelectedIndex(-1)
          : r > n && this.setSelectedIndex(r - 1),
          t.CollectionEvent.dispatchCollectionEvent(
            this,
            t.CollectionEvent.COLLECTION_CHANGE,
            t.CollectionEventKind.REMOVE,
            n,
            -1,
            [i.name],
          ));
      ...
      (i.prototype.commitSelection = function (t) {
        (t >= 0 && t < this.numChildren
          ? ((this._selectedIndex = t),
            ...
            this.showOrHide(this._selectedChild, !0))
          : ((this._selectedChild = null), (this._selectedIndex = -1)),
          this.invalidateSize(),
          this.invalidateDisplayList());
      }),
  ...
  ((t.ViewStack = e),
    __reflect(e.prototype, "eui.ViewStack", [
      "eui.ICollection",
    ...
    s = (function () {
      ...
      return (
        ...
        (s.prototype.reset = function (e) {
          ...
          if (((this.host = e), e))
            if (
              (s.checkBindable(e, this.property),
...
!(function (t) {
  var e = t.sys.UIComponentImpl,
    i = (function (i) {
      function n() {
        var t = i.call(this) || this;
        return (
          (t._widthConstraint = 0 / 0),
          (t.$isShowPrompt = !1),
          (t.$promptColor = 6710886),
          (t.$isFocusIn = !1),
          t.initializeUIValues(),
          (t.type = egret.TextFieldType.INPUT),
          (t.$EditableText = { 0: null, 1: 16777215, 2: !1 }),
          t
        );
      }
      return (
        ...
        (n.prototype.setLayoutBoundsSize = function (t, i) {
          if (
            ...
            isNaN(n[9]) &&
              t != n[16] &&
              ((this._widthConstraint = t), this.invalidateSize());
          }
        }),
        (n.prototype.setLayoutBoundsPosition = function (t, e) {}),
        (n.prototype.getLayoutBounds = function (t) {}),
  ...
  ((t.EditableText = i),
    __reflect(i.prototype, "eui.EditableText", [
      "eui.UIComponent",
      "egret.DisplayObject",
      "eui.IDisplayText",
    ]),
        ...
        return (
          ...
          (l.prototype.update = function (t, e, i) {
            ...
            var n = this.offsetPoint - t,
              r = n + i;
            ((this.offsetPoint = t),
              0 > r && (this.$bounces ? (r -= 0.5 * n) : (r = 0)),
              r > e && (this.$bounces ? (r -= 0.5 * n) : (r = e)),
          ...
          (l.prototype.finish = function (t, e) {
            ...
            for (
              var i = this.velocity * r,
                l = this.previousVelocity,
                u = l.length,
                p = r,
                c = 0;
              u > c;
            ...
            if (y > o)
              if (
                ((g = t + ((f - o) / h) * 2 * this.$scrollFactor),
                0 > g || g > e)
              )
                for (g = t; Math.abs(f) > o; )
                  ((g -= f), (f *= 0 > g || g > e ? s * a : s), v++);
              else v = Math.log(o / y) / h;
            else g = t;
            if (this.target.$getThrowInfo) {
              var m = this.target.$getThrowInfo(t, g);
              g = m.toPos;
            }
            v > 0
              ? (this.$bounces || (0 > g ? (g = 0) : g > e && (g = e)),
                this.throwTo(g, v))
          ...
          (l.prototype.onTick = function (t) {
            ...
            if (e > 10) {
              ...
              (n.length >= i && n.shift(),
                (this.velocity =
                  (this.currentPosition - this.previousPosition) / e),
...
!(function (t) {
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.getCurrentState = function () {
        var t = "up";
        if ((this.touchCaptured && (t = "down"), this._selected)) {
          var e = t + "AndSelected",
            i = this.skin;
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.load = function (e) {
        var i = egret.getImplementation("eui.IThemeAdapter");
        (i || (i = new t.DefaultThemeAdapter()),
          i.getTheme(e, this.onConfigLoaded, this.onConfigLoaded, this));
      }),
      (i.prototype.onConfigLoaded = function (t) {
        var e;
        if ((t && (e = JSON.parse(t)), e && e.skins))
          for (
            var i = this.skinMap,
              n = e.skins,
              r = Object.keys(n),
            ...
            var a = r[s];
            i[a] || this.mapSkin(a, n[a]);
          }
        (e.styles && (this.$styles = e.styles),
          e.exmls && 0 != e.exmls.length
            ? e.exmls[0].gjs
              ? (e.exmls.forEach(function (t) {
              ...
              : e.exmls[0].content
                ? (e.exmls.forEach(function (t) {
                  ...
                  this.onLoaded())
                : EXML.$loadAll(e.exmls, this.onLoaded, this, !0)
            : this.onLoaded());
      }),
      ...
      (i.prototype.getSkinName = function (t) {
        if (!this.initialized)
          return (
            -1 == this.delayList.indexOf(t) && this.delayList.push(t),
            ""
          );
        var e = this.skinMap,
      ...
      (i.prototype.findSkinName = function (t) {
        ...
        return i || "eui.Component" == e
          ? i
          : this.findSkinName(Object.getPrototypeOf(t));
      }),
    ...
    var l = (function (t) {
      ...
      return (
        ...
        (e.prototype.toCode = function () {
          ...
          if (
            (this.isGet
              ? ((t = this.getIndent(this.indent + 2)),
            ...
            for (
              var r = this.codeBlock.toCode().split("\n"), o = r.length, s = 0;
              o > s;
              s++
            ) {
              var a = r[s];
    ...
    var p = (function (t) {
      ...
      return (
        ...
        (i.prototype.toCode = function () {
          for (
            var t = this.getIndent(1),
              i = "new " + e + ' ("' + this.name + '",\n' + t + "[\n",
              n = 0,
              r = !0,
              o = this.addItems.concat(this.setProperty);
            n < o.length;

          ) {
            r ? (r = !1) : (i += ",\n");
            for (
              var s = o[n], a = s.toCode().split("\n"), h = a.length, l = 0;
              h > l;
              l++
            ) {
              var u = a[l];
...
!(function (t) {
    ...
    i = (function (i) {
      ...
      return (
        ...
        (n.prototype.$parseFont = function () {
          if (
            ((this.$fontChanged = !1),
            this.$font && "string" == typeof this.$font)
          ) {
            var e = egret.getImplementation("eui.IAssetAdapter");
            (e || (e = new t.DefaultAssetAdapter()),
              e.getAsset(this.$font, this.$onFontChanged, this));
          } else this.$setFontData(this.$font);
        }),
        (n.prototype.$onFontChanged = function (t, e) {
          e === this.$font && this.$setFontData(t);
        }),
        (n.prototype.$setFontData = function (t) {
          return t == this.$BitmapText[5]
            ? !1
            : ((this.$BitmapText[5] = t), this.$invalidateContentBounds(), !0);
        }),
        (n.prototype.createChildren = function () {
  ...
  ((t.BitmapLabel = i),
    __reflect(i.prototype, "eui.BitmapLabel", [
      "eui.UIComponent",
      "egret.DisplayObject",
      "eui.IDisplayText",
    ]),
...
!(function (t) {
  ...
  function i(t, e, i, n) {
    if ((void 0 === n && (n = !1), n && t in u))
      return void (e && e.call(i, u[t], t));
    var r = l[t];
    return r ? void r.push([e, i]) : ((l[t] = [[e, i]]), void a(t, s));
  }
  function n(t, e, i, n) {
    if ((void 0 === n && (n = !1), !t || 0 == t.length))
      return void (e && e.call(i, [], t));
    var o = [];
    t.forEach(function (s) {
      if (n && s in u) return ((o[s] = ""), void o.push(s));
      var h = function (n, s) {
  ...
  function r(t, e, i, n) {
    ...
    (t.forEach(function (t, i) {
      if (t in u && !e[t]) return void (r[i] = u[t]);
      var n = e[t],
        o = s(t, n);
      r[i] = o;
    }),
  ...
  function a(t, e) {
    ...
    var n = function (i) {
      ...
      r = egret.getImplementation("eui.IThemeAdapter");
    (r || (r = new eui.DefaultThemeAdapter()), r.getTheme(i, n, n, this));
  }
  ...
  !(function (t) {
    ...
    var r = ["Point", "Matrix", "Rectangle"],
      ...
      l = (function () {
        function l() {}
        return (
          (l.prototype.$describe = function (t) {
            if (!t) return null;
            ...
            for (
              var c = Object.keys(i).concat(Object.keys(t)),
                d = c.length,
                f = t.__meta__,
                y = 0;
              d > y;
              ...
              if (
                ...
                var g = void 0;
                if (f && f[v]) g = f[v];
                else if (e(t[v])) g = "Array";
                else {
                  if (((g = typeof t[v]), "function" == g)) continue;
                  -1 == o.indexOf(g) && (g = "any");
                }
                r[v] = g;
              }
            ...
            return (
              Object.getPrototypeOf(s) &&
                ((i.__hashCode__ = a++), (h[i.__hashCode__] = r)),
              r
            );
          }),
...
!(function (t) {
  ...
  ((e[2001] = "EXML parsing error {0}: EXML file can't be found "),
    ...
    (e[2003] =
      "EXML parsing error {0}: the class definitions corresponding to nodes can't be found  \n {1}"),
    (e[2004] =
      "EXML parsing error {0}: nodes cannot contain id property with the same name \n {1}"),
    (e[2005] =
      "EXML parsing error {0}: property with the name of '{1}' does not exist on the node, or the property does not have a default value: \n {2}"),
    (e[2006] =
      "EXML parsing error {0}: undefined view state name: '{1}' \n {2}"),
    (e[2007] =
      "EXML parsing error {0}: only UIComponent objects within the container can use the includeIn and excludeFrom properties\n {1}"),
    (e[2008] =
      "EXML parsing error {0}: fail to assign values of '{1}' class to property: '{2}' \n {3}"),
    (e[2009] =
      "EXML parsing error {0}: only one ID can be referenced in the node property value '{}' label; and complex expression is not allowed to use \n {1}"),
    (e[2010] =
      "EXML parsing error {0}: ID referenced by property: '{1}':  '{2}' does not exist \n {3}"),
    (e[2011] =
      "EXML parsing error {0}: fail to assign more than one child nodes to the same property: '{1}' \n {2}"),
    (e[2012] =
      "EXML parsing error {0}: no default property exists on the node; and you must explicitly declare the property name that the child node  is assigned to \n {1}"),
    (e[2013] =
      "EXML parsing error {0}: view state grammar is not allowed to use on property nodes of Array class \n {1} "),
    (e[2014] =
      "EXML parsing error {0}: assigning the skin class itself to the node property is not allowed \n {1}"),
    (e[2015] =
      "EXML parsing error {0}: class definition referenced by node: {1} does not exist \n {2}"),
    (e[2016] =
      "EXML parsing error {0}: format error of 'scale9Grid' property value on the node: {1}"),
    (e[2017] =
      "EXML parsing error {0}: namespace prefix missing on the node: {1}"),
    (e[2018] =
      "EXML parsing error {0}: format error of 'skinName' property value on the node: {1}"),
    (e[2019] =
      "EXML parsing error {0}: the container’s child item must be visible nodes: {1}"),
    (e[2020] =
      "EXML parsing error {0}: for child nodes in w: Declarations, the includeIn and excludeFrom properties are not allowed to use \n {1}"),
    (e[2021] =
      "Compile errors in {0}, the attribute name: {1}, the attribute value: {2}."),
    (e[2022] =
      "EXML parsing error: there contains illegal characters in the id `{0}`"),
    (e[2101] =
      "EXML parsing warnning : fail to register the class property : {0},there is already a class with the same name in the global,please try to rename the class name for the exml. \n {1}"),
    (e[2102] =
      "EXML parsing warnning {0}: no child node can be found on the property code \n {1}"),
    (e[2103] =
      "EXML parsing warnning {0}: the same property '{1}' on the node is assigned multiple times \n {2}"),
    (e[2104] =
      "EXML parsing warnning, Instantiate class {0} error，the parameters of its constructor method must be empty."),
    (e[2201] = "BasicLayout doesn't support virtualization."),
    (e[2202] =
      "parse skinName error，the parsing result of skinName must be a instance of eui.Skin."),
...
!(function (t) {
  ...
  ((e[2001] = "EXML解析错误 {0}: 找不到EXML文件"),
    ...
    (e[2005] =
      "EXML解析错误 {0}: 节点上不存在名为'{1}'的属性，或者该属性没有初始值:\n{2}"),
    (e[2006] = "EXML解析错误 {0}: 未定义的视图状态名称:'{1}'\n{2}"),
    (e[2007] =
      "EXML解析错误 {0}: 只有处于容器内的 UIComponent 对象可以使用includeIn和excludeFrom属性\n{1}"),
    (e[2008] = "EXML解析错误 {0}: 无法将'{1}'类型的值赋给属性:'{2}'\n{3}"),
    (e[2009] =
      "EXML解析错误 {0}: 在节点属性值的‘{}’标签内只能引用一个ID，不允许使用复杂表达式\n{1}"),
    (e[2010] = "EXML解析错误 {0}: 属性:'{1}'所引用的ID: '{2}'不存在\n{3}"),
    (e[2011] = "EXML解析错误 {0}: 无法将多个子节点赋值给同一个属性:'{1}'\n{2}"),
    (e[2012] =
      "EXML解析错误 {0}: 节点上不存在默认属性，必须显式声明子节点要赋值到的属性名\n{1}"),
    (e[2013] =
      "EXML解析错误 {0}: 类型为Array的属性节点上不允许使用视图状态语法\n{1}"),
    ...
    (e[2101] =
      "EXML解析警告: 在EXML根节点上声明的 class 属性: {0} 注册失败，所对应的类已经存在，请尝试重命名要注册的类名。\n{1}"),
    (e[2102] = "EXML解析警告 {0}: 在属性节点上找不到任何子节点\n{1}"),
    (e[2103] = "EXML解析警告 {0}: 节点上的同一个属性'{1}'被多次赋值\n{2}"),
    (e[2104] =
      "EXML解析警告，无法直接实例化自定义组件：{0} ，在EXML中使用的自定义组件必须要能直接被实例化，否则可能导致后续EXML解析报错。"),
    (e[2201] = "BasicLayout 不支持虚拟化。"),
    (e[2202] =
      "皮肤解析出错，属性 skinName 的值必须要能够解析为一个 eui.Skin 的实例。"),
    (e[2203] = "找不到指定的皮肤类 '{0}'。"),
              ...
              (a.getPreferredBounds(n),
                ...
                isNaN(d) || isNaN(f)
                  ? isNaN(u)
                    ? isNaN(d) && isNaN(f)
                      ? (v = n.y)
                      : ((v = isNaN(d) ? 0 : d), (v += isNaN(f) ? 0 : f))
                    : (v = 2 * Math.abs(u))
                  : (v = d + f));
              var g = n.width,
                m = n.height;
              ((e = Math.ceil(Math.max(e, y + g))),
                (i = Math.ceil(Math.max(i, v + m))));
            }
          }
          ...
          for (
            ...
            if (egret.is(u, r) && u.$includeInLayout) {
              var p = u.$UIComponent,
                ...
                C = 0 / 0;
              (isNaN(f) || isNaN(y)
                ? isNaN(m) || (E = Math.round(i * Math.min(0.01 * m, 1)))
                : (E = i - y - f),
                isNaN(v) || isNaN(g)
                  ? isNaN($) || (C = Math.round(n * Math.min(0.01 * $, 1)))
                  : (C = n - g - v),
      ...
      return (
        ...
        (n.prototype.measureReal = function () {
          for (
            var t = this.$target,
              ...
              r = 0,
              o = 0,
              s = egret.$TempRectangle,
              a = 0;
            i > a;
            a++
          ) {
            var h = t.getElementAt(a);
            egret.is(h, e) && h.$includeInLayout
              ? (h.getPreferredBounds(s),
                (r += s.width),
                (o = Math.max(o, s.height)))
              : n--;
          }
          r += (n - 1) * this.$gap;
        ...
        (n.prototype.measureVirtual = function () {
          for (
            var t = this.$target,
              i = this.$typicalWidth,
              n = this.getElementTotalSize(),
              r = Math.max(this.maxElementSize, this.$typicalHeight),
        ...
        (n.prototype.updateDisplayListReal = function (i, n) {
          var r = this.$target,
            ...
            d =
              this.$verticalAlign == t.JustifyAlign.JUSTIFY ||
              this.$verticalAlign == t.JustifyAlign.CONTENT_JUSTIFY,
            f = 0;
          d ||
            (this.$verticalAlign == egret.VerticalAlign.MIDDLE
              ? (f = 0.5)
              : this.$verticalAlign == egret.VerticalAlign.BOTTOM && (f = 1));
          var y,
            v,
            g,
            m = r.numElements,
            ...
            b = egret.$TempRectangle;
          for (y = 0; m > y; y++) {
            var I = r.getElementAt(y);
            if (egret.is(I, e) && I.$includeInLayout)
              if ((I.getPreferredBounds(b), (x = Math.max(x, b.height)), c))
                _ += b.width;
              else {
                var L = I.$UIComponent;
                isNaN(L[6])
          ...
          if (c) {
            if (0 > O) {
              for (N = P / $, y = 0; m > y; y++)
                ((v = r.getElementAt(y)),
                  egret.is(v, e) &&
                    v.$includeInLayout &&
                    (v.getPreferredBounds(b),
                    b.width <= N && ((P -= b.width), A--)));
              P = P > 0 ? P : 0;
            }
          } else if (S > 0) {
            ...
            for (y = 0; D > y; y++) {
              g = T[y];
              var R = Math.round(g.size + B);
              ((B += g.size - R), (M[g.layoutElement.$hashCode] = R), (P -= R));
            }
            P = P > 0 ? P : 0;
          }
          this.$horizontalAlign == egret.HorizontalAlign.CENTER
            ? (E = o + 0.5 * P)
            : this.$horizontalAlign == egret.HorizontalAlign.RIGHT &&
              (E = o + P);
          var w = o,
            V = a,
            z = 0,
          ...
          for (y = 0; m > y; y++) {
            var j = 0;
            if (
              ((v = r.getElementAt(y)), egret.is(v, e) && v.$includeInLayout)
            ) {
              if (
                (v.getPreferredBounds(b),
                (k = 0 / 0),
                c
                  ? ((F = 0 / 0),
                    O > 0
                      ? (F = (P * b.width) / _)
                      : 0 > O && b.width > N && (F = P / A),
                    isNaN(F) || ((k = Math.round(F + G)), (G += F - k)))
                  : (k = M[v.$hashCode]),
                d)
              )
                ((C = a), v.setLayoutBoundsSize(k, U), v.getLayoutBounds(b));
              else {
                var X = 0 / 0,
                  L = v.$UIComponent;
                if (!isNaN(v.percentHeight)) {
                  var W = Math.min(100, L[7]);
                  X = Math.round(p * W * 0.01);
                }
                (v.setLayoutBoundsSize(k, X),
                  v.getLayoutBounds(b),
                  (j = (p - b.height) * f),
                  (j = j > 0 ? j : 0),
                  (C = a + j));
              }
              (v.setLayoutBoundsPosition(Math.round(E), Math.round(C)),
                (z = Math.ceil(b.width)),
          ...
          if (d) {
            for (var S = this.startIndex; p >= S; S++)
              ((y = r.getVirtualElementAt(S)),
                egret.is(y, e) &&
                  y.$includeInLayout &&
                  (y.getPreferredBounds(v), (C = Math.max(C, v.height))));
            m = Math.ceil(Math.max(g, C));
          }
          for (
            var T,
              P = 0,
            ...
            ((y = r.getVirtualElementAt(N)),
              egret.is(y, e) &&
                y.$includeInLayout &&
                (y.getPreferredBounds(v),
                d || (C = Math.max(C, v.height)),
                c
                  ? ((x = a),
                ...
                I || ((T = isNaN(L[N]) ? E : L[N]), T != v.width && (I = !0)),
                (L[N] = v.width),
                (P = this.getStartPosition(N)),
                y.setLayoutBoundsPosition(Math.round(P), Math.round(x))));
          }
          ((b += a + h),
            (o = this.getStartPosition(u) - l + s),
            (this.maxElementSize = C),
            r.setContentSize(o, b),
        ...
        (n.prototype.getStartPosition = function (t) {
          ...
          for (
            var i = this.$typicalWidth,
              n = this.$paddingLeft,
              r = this.$gap,
              o = this.elementSizeTable,
              s = 0;
            t > s;
            s++
          ) {
        ...
        (n.prototype.getElementTotalSize = function () {
          for (
            var t = this.$typicalWidth,
              e = this.$gap,
              i = 0,
              n = this.$target.numElements,
              r = this.elementSizeTable,
              o = 0;
            n > o;
            o++
          ) {
        ...
        (n.prototype.elementAdded = function (t) {
          this.useVirtualLayout &&
            (i.prototype.elementAdded.call(this, t),
        ...
        (n.prototype.getIndexInView = function () {
          ...
          var i = t.numElements,
            n =
              this.getStartPosition(i - 1) +
              this.elementSizeTable[i - 1] +
              this.$paddingRight,
            r = t.scrollH;
          if (r > n - this.$paddingRight)
            return ((this.startIndex = -1), (this.endIndex = -1), !1);
          ...
          var s = this.startIndex,
            a = this.endIndex;
          return (
            (this.startIndex = this.findIndexAt(r, 0, i - 1)),
    ...
    i = (function (i) {
      ...
      return (
        ...
        Object.defineProperty(n.prototype, "horizontalGap", {
          ...
          set: function (t) {
            ((t = +t),
              t !== this._horizontalGap &&
                ((this.explicitHorizontalGap = t),
        ...
        Object.defineProperty(n.prototype, "paddingLeft", {
          ...
          set: function (t) {
            ((t = +t || 0),
              this._paddingLeft != t &&
                ((this._paddingLeft = t), this.invalidateTargetLayout()));
          },
          enumerable: !0,
          configurable: !0,
        }),
          ...
          set: function (t) {
            ((t = +t || 0),
              this._paddingRight !== t &&
                ((this._paddingRight = t), this.invalidateTargetLayout()));
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "paddingTop", {
          ...
          set: function (t) {
            ((t = +t || 0),
              this._paddingTop != t &&
                ((this._paddingTop = t), this.invalidateTargetLayout()));
          },
          enumerable: !0,
          configurable: !0,
        }),
          ...
          set: function (t) {
            ((t = +t || 0),
              this._paddingBottom !== t &&
                ((this._paddingBottom = t), this.invalidateTargetLayout()));
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "horizontalAlign", {
          ...
          set: function (t) {
            this._horizontalAlign != t &&
              ((this._horizontalAlign = t), this.invalidateTargetLayout());
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "verticalAlign", {
          ...
          set: function (t) {
            this._verticalAlign != t &&
              ((this._verticalAlign = t), this.invalidateTargetLayout());
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "columnAlign", {
          ...
          set: function (t) {
            this._columnAlign != t &&
              ((this._columnAlign = t), this.invalidateTargetLayout());
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "rowAlign", {
          ...
          set: function (t) {
            this._rowAlign != t &&
              ((this._rowAlign = t), this.invalidateTargetLayout());
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(n.prototype, "orientation", {
          ...
          set: function (t) {
            this._orientation != t &&
              ((this._orientation = t), this.invalidateTargetLayout());
          },
          enumerable: !0,
          configurable: !0,
        }),
        ...
        (n.prototype.calculateRowAndColumn = function (i, n) {
          ...
          ((isNaN(this.explicitColumnWidth) || isNaN(this.explicitRowHeight)) &&
          ...
          var d = this._orientation == t.TileOrientation.COLUMNS,
            ...
            y = !isNaN(n),
            v = this._paddingLeft,
            g = this._paddingRight,
            m = this._paddingTop,
            $ = this._paddingBottom;
          if (this._requestedColumnCount > 0 || this._requestedRowCount > 0)
            (this._requestedRowCount > 0 &&
              (this._rowCount = Math.min(this._requestedRowCount, a)),
              this._requestedColumnCount > 0 &&
                (this._columnCount = Math.min(this._requestedColumnCount, a)));
          else if (f || y)
            if (!f || (y && d)) {
              ...
              var C = Math.max(0, i - v - g);
              ((this._columnCount = Math.floor((C + o) / p)),
                (this._columnCount = Math.max(
                  1,
                  Math.min(this._columnCount, a),
                )));
            }
          else {
            var _ = Math.sqrt(a * p * c);
            d
              ? (this._rowCount = Math.max(1, Math.round(_ / c)))
              : (this._columnCount = Math.max(1, Math.round(_ / p)));
          }
          (-1 == this._rowCount &&
            (this._rowCount = Math.max(1, Math.ceil(a / this._columnCount))),
            -1 == this._columnCount &&
              (this._columnCount = Math.max(1, Math.ceil(a / this._rowCount))),
            this._requestedColumnCount > 0 &&
              this._requestedRowCount > 0 &&
              (this._orientation == t.TileOrientation.ROWS
                ? (this._rowCount = Math.max(
                    1,
                    Math.ceil(a / this._requestedColumnCount),
                  ))
                : (this._columnCount = Math.max(
                    1,
                    Math.ceil(a / this._requestedRowCount),
                  ))));
        }),
        (n.prototype.updateMaxElementSize = function () {
          this.$target &&
            (this.$useVirtualLayout
              ? ((this.maxElementWidth = Math.max(
                  this.maxElementWidth,
                  this.$typicalWidth,
                )),
                (this.maxElementHeight = Math.max(
          ...
          if (this._orientation == t.TileOrientation.COLUMNS) {
            ...
            (0 > f && (f = 0),
              (this.startIndex = Math.min(
                i - 1,
                Math.max(0, d * this._rowCount),
              )),
              (this.endIndex = Math.min(
                i - 1,
                Math.max(0, f * this._rowCount - 1),
              )));
          } else {
            ...
            (0 > $ && ($ = 0),
              (this.startIndex = Math.min(
                i - 1,
                Math.max(0, m * this._columnCount),
              )),
              (this.endIndex = Math.min(
                i - 1,
                Math.max(0, $ * this._columnCount - 1),
              )));
          }
        ...
        (n.prototype.updateDisplayList = function (n, r) {
          if ((i.prototype.updateDisplayList.call(this, n, r), this.$target)) {
            ...
            if (this.indexInViewCalculated) this.indexInViewCalculated = !1;
              ...
              if (
                (this.calculateRowAndColumn(n, r),
            ...
            if (
              (this.$useVirtualLayout &&
                (this.calculateRowAndColumn(n, r), this.adjustForJustify(n, r)),
            ...
            for (
              var p,
                ...
                f,
                y,
                v = this._orientation == t.TileOrientation.COLUMNS,
                g = this.startIndex,
                m = isNaN(this._horizontalGap) ? 0 : this._horizontalGap,
                $ = isNaN(this._verticalGap) ? 0 : this._verticalGap,
                E = this._rowCount,
                C = this._columnCount,
                _ = this._columnWidth,
                S = this._rowHeight,
              ...
              ((p = this.$useVirtualLayout
                ? this.target.getVirtualElementAt(T)
                : this.target.getElementAt(T)),
                egret.is(p, e) &&
                  p.$includeInLayout &&
                  (v
                    ? ((f = Math.ceil((g + 1) / E) - 1),
        ...
        (n.prototype.sizeAndPositionElement = function (e, i, n, r, o) {
          var s = 0 / 0,
            a = 0 / 0,
            h = e.$UIComponent;
          (this._horizontalAlign == t.JustifyAlign.JUSTIFY
            ? (s = r)
            : isNaN(h[6]) || (s = r * h[6] * 0.01),
            this._verticalAlign == t.JustifyAlign.JUSTIFY
              ? (a = o)
              : isNaN(h[7]) || (a = o * h[7] * 0.01),
        ...
        (n.prototype.adjustForJustify = function (e, i) {
          var n = this._paddingLeft,
            ...
            a = Math.max(0, e - n - r),
            h = Math.max(0, i - o - s);
          (isNaN(this.explicitVerticalGap) ||
            (this._verticalGap = this.explicitVerticalGap),
            isNaN(this.explicitHorizontalGap) ||
              (this._horizontalGap = this.explicitHorizontalGap),
            (this._verticalGap = isNaN(this._verticalGap)
              ? 0
              : this._verticalGap),
            (this._horizontalGap = isNaN(this._horizontalGap)
              ? 0
              : this._horizontalGap));
          var l,
          ...
          (u > 0 &&
            (this._rowAlign == t.RowAlign.JUSTIFY_USING_GAP
              ? ((l = Math.max(1, this._rowCount - 1)),
                (this._verticalGap = u / l))
              : this._rowAlign == t.RowAlign.JUSTIFY_USING_HEIGHT &&
                this._rowCount > 0 &&
                (this._rowHeight +=
                  (u - (this._rowCount - 1) * this._verticalGap) /
                  this._rowCount)),
            p > 0 &&
              (this._columnAlign == t.ColumnAlign.JUSTIFY_USING_GAP
                ? ((l = Math.max(1, this._columnCount - 1)),
                  (this._horizontalGap = p / l))
                : this._columnAlign == t.ColumnAlign.JUSTIFY_USING_WIDTH &&
                  this._columnCount > 0 &&
                  (this._columnWidth +=
                    (p - (this._columnCount - 1) * this._horizontalGap) /
                    this._columnCount)));
        }),
        n
      );
    ...
    i = (function (i) {
      ...
      return (
        ...
        (n.prototype.measureVirtual = function () {
          for (
            var t = this.$target,
              i = this.$typicalHeight,
              n = this.getElementTotalSize(),
              r = Math.max(this.maxElementSize, this.$typicalWidth),
              o = egret.$TempRectangle,
              s = this.endIndex,
              a = this.elementSizeTable,
              h = this.startIndex;
        ...
        (n.prototype.updateDisplayListReal = function (i, n) {
          var r = this.$target,
            ...
            d =
              this.$horizontalAlign == t.JustifyAlign.JUSTIFY ||
              this.$horizontalAlign == t.JustifyAlign.CONTENT_JUSTIFY,
            f = 0;
          d ||
            (this.$horizontalAlign == egret.HorizontalAlign.CENTER
              ? (f = 0.5)
          ...
          for (y = 0; m > y; y++) {
            var I = r.getElementAt(y);
            if (egret.is(I, e) && I.$includeInLayout)
              if ((I.getPreferredBounds(b), (x = Math.max(x, b.width)), c))
                _ += b.height;
              else {
                var L = I.$UIComponent;
                isNaN(L[7])
          ...
          this.$verticalAlign == egret.VerticalAlign.MIDDLE
            ? (C = a + 0.5 * P)
            : this.$verticalAlign == egret.VerticalAlign.BOTTOM && (C = a + P);
          var w = o,
            V = a,
            z = 0,
            H = 0,
              ...
              if (
                ...
                c
                  ? ((F = 0 / 0),
                    O > 0
                      ? (F = (P * b.height) / _)
                      : 0 > O && b.height > N && (F = P / A),
                    isNaN(F) || ((k = Math.round(F + G)), (G += F - k)))
                  : (k = M[v.$hashCode]),
                d)
              )
                ((E = o), v.setLayoutBoundsSize(U, k), v.getLayoutBounds(b));
              else {
                var X = 0 / 0,
                  L = v.$UIComponent;
                if (!isNaN(L[6])) {
                  var W = Math.min(100, L[6]);
                  X = Math.round(u * W * 0.01);
                }
                (v.setLayoutBoundsSize(X, k),
                  v.getLayoutBounds(b),
                  (j = (u - b.width) * f),
                  (j = j > 0 ? j : 0),
                  (E = o + j));
          ...
          if (d) {
            for (var S = this.startIndex; p >= S; S++)
              ((y = r.getVirtualElementAt(S)),
                egret.is(y, e) &&
                  y.$includeInLayout &&
                  (y.getPreferredBounds(v), (C = Math.max(C, v.width))));
            m = Math.ceil(Math.max(g, C));
          }
          for (
            var T,
              ...
              egret.is(y, e) &&
                ...
                c
                  ...
                  : (y.getLayoutBounds(v),
                    ...
                    (O = O > 0 ? O : 0),
                    (P = a + O)),
                (b = Math.max(b, v.width)),
                I || ((T = isNaN(L[N]) ? $ : L[N]), T != v.height && (I = !0)),
                (L[N] = v.height),
                (x = this.getStartPosition(N)),
                y.setLayoutBoundsPosition(Math.round(P), Math.round(x))));
          }
          ((b += a + h),
            (o = this.getStartPosition(u) - l + s),
            (this.maxElementSize = C),
            r.setContentSize(b, o),
            (I || _ < this.maxElementSize) && r.invalidateSize());
        }),
        (n.prototype.getStartPosition = function (t) {
          if (!this.$useVirtualLayout && this.$target) {
...
!(function (t) {
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.itemUpdated = function (e) {
        ...
        -1 != i &&
          this.dispatchCoEvent(t.CollectionEventKind.UPDATE, i, -1, [e]);
      }),
      ...
      (i.prototype.removeItemAt = function (e) {
        if (!(0 > e || e >= this._source.length)) {
          ...
          return (
            this.dispatchCoEvent(t.CollectionEventKind.REMOVE, e, -1, [i]),
            i
          );
        }
      }),
  ...
  ((t.ArrayCollection = e),
    __reflect(e.prototype, "eui.ArrayCollection", [
      "eui.ICollection",
      "egret.IEventDispatcher",
    ]),
    ...
    return (
      (t.prototype.apply = function (t, e) {
        ...
        if (r && o) {
          ...
          (-1 == i && (i = o.numChildren),
            egret.is(o, "eui.Component") &&
              o.$Component[8].$elementsContent.push(r),
            o.addChildAt(r, i));
        }
      }),
      (t.prototype.remove = function (t, e) {
        ...
        if (
          n &&
          i &&
          (n.$parent === i && i.removeChild(n), egret.is(i, "eui.Component"))
        ) {
  ...
  var e = (function () {
    ...
    return (
      (t.prototype.apply = function (t, e) {
        ...
        i &&
          ((this.oldValue = i[this.name]),
          this.setPropertyValue(i, this.name, this.value, this.oldValue));
      }),
      (t.prototype.remove = function (t, e) {
        var i = this.target ? t[this.target] : t;
        i &&
          (this.setPropertyValue(i, this.name, this.oldValue, this.oldValue),
          (this.oldValue = null));
      }),
...
!(function (t) {
  var e = (function () {
    ...
    return (
      (e.prototype.apply = function (e, i) {
        if (this.target) {
          ...
          (this.oldValue &&
            ...
            n && (this.oldValue = n),
            t.Binding.$bindProperties(
              this.host,
              this.templates.concat(),
              this.chainIndex.concat(),
              this.target,
              this.prop,
            ));
        }
  ...
  !(function (t) {
      ...
      if (0 != y && i > 0) {
        ...
        ((i = Math.max(r, Math.min(h, i))),
          ...
          f >= s &&
            l >= f &&
            0 > u * d + y * f &&
            (!c || a(c.x, c.y, e).width > a(d, f, e).width) &&
            (egret.Point.release(c), (c = egret.Point.create(d, f))));
      }
      if (0 != u && n > 0) {
        var g = 1 / u;
      ...
      if (0 != y && i > 0) {
        ...
        ((i = Math.max(r, Math.min(h, i))),
          ...
          f >= s &&
            l >= f &&
            0 > u * d + y * f &&
            (!c || a(c.x, c.y, e).height > a(d, f, e).height) &&
            (egret.Point.release(c), (c = egret.Point.create(d, f))));
      }
      if (0 != u && n > 0) {
        var g = 1 / u;
    ...
    function o(t, e, i, n, r, o, s, a, h) {
      ...
      var l,
        ...
        y = a * e - t * h;
      return f >= d
        ? ((u = Math.abs(y) < 1e-9 ? i / (t + e) : (a * i) / y),
          (u = Math.max(d, Math.min(u, f))),
          (l = (i - e * u) / t),
          egret.Point.create(l, u))
        : ((p = -(n * t + i) / e),
          (c = -(o * t + i) / e),
          (d = Math.max(r, Math.min(p, c))),
          (f = Math.min(s, Math.max(p, c))),
    ...
    function s(t, e, i, n, r, s, a) {
      ...
      if (
        ...
        return 0 == l || 0 == c
          ? null
          : egret.Point.create(t / Math.abs(l), e / Math.abs(c));
      if (0 == l && 0 == c)
        return 0 == u || 0 == p
          ? null
          : egret.Point.create(e / Math.abs(u), t / Math.abs(p));
      var d = l * p >= 0 ? p : -p,
        f = u * c >= 0 ? c : -c,
        y = l * f - u * d;
      if (Math.abs(y) < 1e-9)
    ...
    var l = 0.1,
      ...
      p = (function () {
        function t() {}
        return (
          (t.fitBounds = function (t, n, r, o, h, p, c, d, f, y, v) {
            ...
            if (isNaN(t) || isNaN(n))
              return isNaN(t)
                ? i(n, r, o, h, p, c, m, $, E, C)
                : e(t, r, o, h, p, c, m, $, E, C);
            if (((g = s(t, n, r, m, $, E, C)), !g)) {
              var _ = void 0;
              if ((_ = e(t, r, o, h, p, c, m, $, E, C))) {
                var S = a(_.x, _.y, r).height;
                S - l > n && (egret.Point.release(_), (_ = null));
              }
              var T = void 0;
              if ((T = i(n, r, o, h, p, c, m, $, E, C))) {
                var P = a(T.x, T.y, r).width;
                P - l > t && (egret.Point.release(T), (T = null));
              }
              ((g = _ && T ? (_.x * _.y > T.x * T.y ? _ : T) : _ ? _ : T),
