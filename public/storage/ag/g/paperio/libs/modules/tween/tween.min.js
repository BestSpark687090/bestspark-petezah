    ...
    return (
      ...
      (e.getElasticInOut = function (t, e) {
        ...
        return function (i) {
          ...
          return (i *= 2) < 1
            ? -0.5 *
                (t * Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - r) * n) / e))
            : t *
                Math.pow(2, -10 * (i -= 1)) *
                Math.sin(((i - r) * n) / e) *
                0.5 +
    ...
    return (
      ...
      (n.tick = function (t, e) {
        ...
        for (var r = n._tweens.concat(), s = r.length - 1; s >= 0; s--) {
          var o = r[s];
          (e && !o.ignoreGlobalPause) ||
            o.paused ||
            o.$tick(o._useTicks ? 1 : i);
        }
        return !1;
      }),
      (n._register = function (e, i) {
        ...
        if (i)
          (r && (r.tween_count = r.tween_count > 0 ? r.tween_count + 1 : 1),
            s.push(e),
            n._inited ||
              ((n._lastTime = t.getTimer()),
              t.sys.$ticker.$startTick(n.tick, null),
              (n._inited = !0)));
        else {
          r && r.tween_count--;
          for (var o = s.length; o--; )
            if (s[o] == e) return void s.splice(o, 1);
        }
      }),
      ...
      (n.prototype.setPosition = function (t, e) {
        ...
        if (
          ...
          for (
            var o = this._steps.length, u = -1, a = 0;
            o > a &&
            !(
              "step" == this._steps[a].type &&
              ((u = a),
              this._steps[a].t <= n && this._steps[a].t + this._steps[a].d >= n)
            );
            a++
          );
          for (var a = 0; o > a; a++)
            if ("action" == this._steps[a].type)
              0 != e &&
                (this._useTicks
                  ? this._runAction(this._steps[a], n, n)
                  : 1 == e && s > n
                    ? (s != this.duration &&
                        this._runAction(this._steps[a], s, this.duration),
                      this._runAction(this._steps[a], 0, n, !0))
                    : this._runAction(this._steps[a], s, n));
            else if ("step" == this._steps[a].type && u == a) {
              var p = this._steps[u];
              this._updateTargetProps(
                p,
                Math.min((this._stepPosition = n - p.t) / p.d, 1),
              );
            }
        }
        ...
        for (var u in t)
          if (void 0 === this._initQueueProps[u]) {
            if (((i = this._target[u]), (e = n._plugins[u])))
              for (r = 0, s = e.length; s > r; r++) i = e[r].init(this, u, i);
            this._initQueueProps[u] = this._curQueueProps[u] =
              void 0 === i ? null : i;
      ...
      (n.prototype.wait = function (t, e) {
        ...
        return this._addStep({ d: t, p0: n, p1: n, v: e });
      }),
      ...
      (n.prototype.call = function (t, e, n) {
        return (
          void 0 === e && (e = void 0),
          void 0 === n && (n = void 0),
          this._addAction({ f: t, p: n ? n : [], o: e ? e : this._target })
        );
      }),
    ...
    var p = (function (e) {
      ...
      return (
        ...
        (i.prototype.applyPath = function (t) {
          var e = this;
          (t instanceof s
            ? this.tween.to(t.props, t.duration, n(t.ease))
            : t instanceof o
              ? this.tween.wait(t.duration, t.passive)
              : t instanceof u
                ? this.tween.set(t.props)
                : t instanceof a && this.tween.$tick(t.delta),
        ...
        (e.prototype.registerEvent = function (t) {
          ...
          this._items &&
            this._items.forEach(function (n) {
              t
                ? n.addEventListener("complete", e.itemComplete, e)
                : n.removeEventListener("complete", e.itemComplete, e);
            });
        }),
        ...
        (e.prototype.itemComplete = function (t) {
          ...
          (this.completeCount++,
            ...
            this.completeCount === this.items.length &&
              (this.dispatchEventWith("complete"), (this.completeCount = 0)));
        }),
        e
      );
    })(t.EventDispatcher);
