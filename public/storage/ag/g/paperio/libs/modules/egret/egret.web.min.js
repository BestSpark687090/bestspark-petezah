    ...
    var r = (function () {
      function t(e) {
        ((this.defaultVertexSrc =
          ...
          (this.program = null),
          (this.uniforms = {
            projectionVector: { type: "2f", value: { x: 0, y: 0 }, dirty: !0 },
          }),
          (this.gl = e));
      }
      return (
        (t.prototype.init = function () {
          var t = this.gl,
            r = e.WebGLUtils.compileProgram(
              t,
              this.defaultVertexSrc,
              this.fragmentSrc,
            );
          (t.useProgram(r),
            (this.aVertexPosition = t.getAttribLocation(r, "aVertexPosition")),
            (this.aTextureCoord = t.getAttribLocation(r, "aTextureCoord")),
            (this.colorAttribute = t.getAttribLocation(r, "aColor")),
          ...
          for (var i in this.uniforms)
            this.uniforms[i].uniformLocation = t.getUniformLocation(r, i);
                ...
                ? ((e.glMatrix = !0),
                  ...
                  "mat2" === i
                    ...
                    : "mat3" === i
                      ...
                      : "mat4" === i && (e.glFunc = t.uniformMatrix4fv))
                : ((e.glFunc = t["uniform" + i]),
                  "2f" === i || "2i" === i
                    ? (e.glValueLength = 2)
                    : "3f" === i || "3i" === i
                      ? (e.glValueLength = 3)
                ...
                e.dirty &&
                  (1 === e.glValueLength
                    ? e.glMatrix === !0
                      ...
                      : e.glFunc.call(t, e.uniformLocation, e.value)
                    : 2 === e.glValueLength
                      ? e.glFunc.call(
                          t,
                          e.uniformLocation,
        ...
        (t.prototype.setProjection = function (e, t) {
          ...
          (r.value.x != e || r.value.y != t) &&
            ((r.value.x = e), (r.value.y = t), (r.dirty = !0));
        }),
        (t.prototype.setAttribPointer = function (e) {
          var t = this.gl;
          (t.vertexAttribPointer(this.aVertexPosition, 2, t.FLOAT, !1, e, 0),
            t.vertexAttribPointer(this.aTextureCoord, 2, t.FLOAT, !1, e, 8),
            t.vertexAttribPointer(this.colorAttribute, 1, t.FLOAT, !1, e, 16));
        }),
        t
      );
    })();
...
(!(function (e) {
  ...
  !(function (t) {
    ...
    (e.registerClass(HTMLImageElement, r),
      e.registerClass(HTMLCanvasElement, r),
      e.registerClass(HTMLVideoElement, r));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {})),
  (function (e) {
    function t(t) {
...
!(function (e) {
  ...
  !(function (t) {
      ...
      function i(t) {
        ...
        return (
          ...
          (i.onPlayEnd = function () {
            return 1 == i.$loops
              ? (i.stop(), void i.dispatchEventWith(e.Event.SOUND_COMPLETE))
              : (i.$loops > 0 && i.$loops--, void i.$play());
          }),
          (i._volume = 1),
    ...
    ((t.HtmlSoundChannel = r),
      __reflect(r.prototype, "egret.web.HtmlSoundChannel", [
        "egret.SoundChannel",
...
!(function (e) {
  ...
  !(function (t) {
        ...
        (i.prototype.load = function (r) {
          ...
          ((this.url = r),
            QZAppExternal.preloadSound(
              function (t) {
                0 == t.code
                  ? ((i.loaded = !0), i.dispatchEventWith(e.Event.COMPLETE))
    ...
    ((r.MUSIC = "music"),
      (r.EFFECT = "effect"),
      (t.QQSound = r),
      __reflect(r.prototype, "egret.web.QQSound", ["egret.Sound"]));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ...
  !(function (t) {
    var r = (function (t) {
      function r() {
        ...
        return (
          ...
          (r.onPlayEnd = function () {
            return 1 == r.$loops
              ? (r.stop(), void r.dispatchEventWith(e.Event.SOUND_COMPLETE))
              : (r.$loops > 0 && r.$loops--, void r.$play());
          }),
          (r._startTime = 0),
          r
        );
      ...
      return (
        ...
        (r.prototype.$play = function () {
          ...
          var r = 0;
          ((r = t.$loops > 0 ? t.$loops - 1 : -1),
            this.$type == e.Sound.EFFECT
              ? QZAppExternal.playLocalSound(function (e) {}, {
                  bid: -1,
                  url: t.$url,
                  loop: r,
                })
    ...
    ((t.QQSoundChannel = r),
      __reflect(r.prototype, "egret.web.QQSoundChannel", [
        "egret.SoundChannel",
        "egret.IEventDispatcher",
      ]));
  })((t = e.web || (e.web = {})));
...
!(function (e) {
  ...
  !(function (t) {
      ...
      function i() {
        ...
        return (
          ...
          i.context.createGain
            ...
            : (i.gain = i.context.createGainNode()),
          i
        );
      }
      return (
        ...
        (i.prototype.$play = function () {
          if (this.isStopped) return void e.$error(1036);
          this.bufferSource &&
            ((this.bufferSource.onended = null), (this.bufferSource = null));
          var t = this.context,
            r = this.gain,
        ...
        Object.defineProperty(i.prototype, "volume", {
          ...
          set: function (t) {
            return this.isStopped
              ? void e.$error(1036)
              : ((this._volume = t), void (this.gain.gain.value = t));
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(i.prototype, "position", {
          get: function () {
            return this.bufferSource
              ? (Date.now() - this._startTime) / 1e3 + this.$startTime
              : 0;
          },
          enumerable: !0,
          configurable: !0,
    ...
    ((t.WebAudioSoundChannel = r),
      __reflect(r.prototype, "egret.web.WebAudioSoundChannel", [
        "egret.SoundChannel",
        "egret.IEventDispatcher",
      ]));
  })((t = e.web || (e.web = {})));
...
!(function (e) {
  ...
  !(function (t) {
      ...
      function r(r, i) {
        ...
        return (
          ...
          (n.onVideoLoaded = function () {
            ...
            ((n.loaded = !0),
              n.posterData &&
                ((n.posterData.width = n.getPlayWidth()),
      ...
      return (
        ...
        (r.prototype.load = function (t, r) {
          ...
          if (
            ...
            var n;
            (!this.video || e.Capabilities.isMobile
        ...
        (r.prototype.play = function (t, r) {
          ...
          (void 0 != t && (n.currentTime = +t || 0),
            ...
            "Windows PC" != e.Capabilities.os &&
              "Mac OS" != e.Capabilities.os &&
              window.setTimeout(function () {
                n.width = 0;
              }, 1e3),
        ...
        (r.prototype.checkFullScreen = function (t) {
          ...
          if (t)
            (null == r.parentElement &&
              (r.removeAttribute("webkit-playsinline"),
              document.body.appendChild(r)),
              e.stopTick(this.markDirty, this),
              this.goFullscreen());
          else if (
            (null != r.parentElement && r.parentElement.removeChild(r),
            r.setAttribute("webkit-playsinline", "true"),
            this.setFullScreenMonitor(!1),
            e.startTick(this.markDirty, this),
            e.Capabilities.isMobile)
          )
            return ((this.video.currentTime = 0), void this.onVideoEnded());
          r.play();
        }),
        (r.prototype.goFullscreen = function () {
          var t,
            r = this.video;
          return (
            (t = e.web.getPrefixStyleName("requestFullscreen", r)),
            r[t] ||
            ((t = e.web.getPrefixStyleName("requestFullScreen", r)), r[t])
              ? (r.removeAttribute("webkit-playsinline"),
                r[t](),
        ...
        (r.prototype.setFullScreenMonitor = function (e) {
          var t = this.video;
          e
            ? (t.addEventListener("mozfullscreenchange", this.screenChanged),
              t.addEventListener("webkitfullscreenchange", this.screenChanged),
              t.addEventListener("mozfullscreenerror", this.screenError),
              t.addEventListener("webkitfullscreenerror", this.screenError))
            : (t.removeEventListener("mozfullscreenchange", this.screenChanged),
        ...
        (r.prototype.$measureContentBounds = function (e) {
          var t = this.bitmapData,
            r = this.posterData;
          t
            ? e.setTo(0, 0, this.getPlayWidth(), this.getPlayHeight())
            : r
              ? e.setTo(0, 0, this.getPlayWidth(), this.getPlayHeight())
              : e.setEmpty();
        }),
        (r.prototype.getPlayWidth = function () {
          return isNaN(this.widthSet)
            ? this.bitmapData
              ? this.bitmapData.width
              : this.posterData
                ? this.posterData.width
                : 0 / 0
            : this.widthSet;
        }),
        (r.prototype.getPlayHeight = function () {
          return isNaN(this.heightSet)
            ? this.bitmapData
              ? this.bitmapData.height
              : this.posterData
                ? this.posterData.height
                : 0 / 0
            : this.heightSet;
        }),
        (r.prototype.$render = function () {
          ...
          (this.isPlayed && !e.Capabilities.isMobile) || !i
            ? this.isPlayed &&
              r &&
              ((t.image = r),
              ...
              (r.webGLTexture = null),
              t.drawImage(0, 0, r.width, r.height, 0, 0, n, o))
            : ((t.image = i),
              (t.imageWidth = n),
              (t.imageHeight = o),
              t.drawImage(0, 0, i.width, i.height, 0, 0, n, o));
        }),
    ...
    ((t.WebVideo = r),
      __reflect(r.prototype, "egret.web.WebVideo", [
        "egret.Video",
        "egret.DisplayObject",
      ]),
      (e.Video = r));
      ...
      return (
        ...
        Object.defineProperty(r.prototype, "response", {
          get: function () {
            ...
            return "document" == this._responseType
      ...
      i = (function (i) {
        ...
        return (
          ...
          (n.prototype.load = function (r) {
            if (
              t.Html5Capatibility._canUseBlob &&
              0 != r.indexOf("wxLocalResource:") &&
              0 != r.indexOf("data:") &&
              0 != r.indexOf("http:") &&
              0 != r.indexOf("https:")
            ) {
              var i = this.request;
              (i ||
                ((i = this.request = new e.web.WebHttpRequest()),
                i.addEventListener(e.Event.COMPLETE, this.onBlobLoaded, this),
                i.addEventListener(
                  e.IOErrorEvent.IO_ERROR,
                  this.onBlobError,
                  this,
                ),
                (i.responseType = "blob")),
          ...
          (n.prototype.loadImage = function (e) {
            ...
            ((this.data = null),
              (this.currentImage = t),
              this._hasCrossOriginSet
                ? this._crossOrigin && (t.crossOrigin = this._crossOrigin)
                : n.crossOrigin && (t.crossOrigin = n.crossOrigin),
      ...
      return (
        ...
        (i.prototype._initElement = function () {
          ...
          ((this.inputDiv.style.left = r * n + "px"),
            (this.inputDiv.style.top = i * o + "px"),
            this.$textfield.multiline &&
            this.$textfield.height > this.$textfield.size
              ? ((this.inputDiv.style.top = i * o + "px"),
                (this.inputElement.style.top =
                  (-this.$textfield.lineSpacing / 2) * o + "px"))
              : ((this.inputDiv.style.top = i * o + "px"),
                (this.inputElement.style.top = "0px")));
          for (var a = this.$textfield, s = 1, l = 1, h = 0; a.parent; )
            ((s *= a.scaleX),
              (l *= a.scaleY),
              (h += a.rotation),
              (a = a.parent));
          var u = e.web.getPrefixStyleName("transform");
          ((this.inputDiv.style[u] = "rotate(" + h + "deg)"),
            (this._gscaleX = n * s),
            (this._gscaleY = o * l));
        }),
        (i.prototype.$show = function () {
          (this.htmlInput.isCurrentStageText(this)
        ...
        (i.prototype.$hide = function () {
          ((this._isNeesHide = !0),
            this.htmlInput &&
              e.web.Html5Capatibility._System_OS == e.web.SystemOSType.IOS &&
        ...
        (i.prototype.resetColor = function () {
          this.inputElement &&
            this.setElementStyle("color", e.toColorString(this.colorValue));
        }),
        (i.prototype.$onBlur = function () {
          t.Html5Capatibility._System_OS == t.SystemOSType.WPHONE &&
        ...
        (i.prototype._onInput = function () {
          ...
          if (t.Html5Capatibility._System_OS == t.SystemOSType.WPHONE) {
            ...
            null == i[35] && null == i[36]
              ? ((r.textValue = r.inputElement.value),
                e.Event.dispatchEvent(r, "updateText", !1))
              : window.setTimeout(function () {
                  r.inputElement &&
                    r.inputElement.selectionStart &&
                    r.inputElement.selectionEnd &&
                    r.inputElement.selectionStart ==
                      r.inputElement.selectionEnd &&
                    ((r.textValue = r.inputElement.value),
                    e.Event.dispatchEvent(r, "updateText", !1));
            ...
            window.setTimeout(function () {
              r.inputElement &&
                r.inputElement.selectionStart == r.inputElement.selectionEnd &&
                ((r.textValue = r.inputElement.value),
                e.Event.dispatchEvent(r, "updateText", !1));
            }, 0);
        }),
        (i.prototype.setAreaHeight = function () {
          ...
          if (t.multiline) {
            ...
            if (t.height <= t.size)
              ...
              this.setElementStyle(
                "height",
                (r + t.lineSpacing) * this._gscaleY + "px",
              );
              var i = (t.height - r) * this._gscaleY,
                n = e.TextFieldUtils.$getValign(t),
                o = i * n,
                a = i - o;
              (this.setElementStyle("padding", o + "px 0px " + a + "px 0px"),
                this.setElementStyle(
                  "lineHeight",
                  (t.size + t.lineSpacing) * this._gscaleY + "px",
                ));
        ...
        (i.prototype.setElementStyle = function (e, t) {
          this.inputElement &&
            this._styleInfoes[e] != t &&
            (this.inputElement.style[e] = t);
        }),
        ...
        (i.prototype.$resetStageText = function () {
          if (this.inputElement) {
            ...
            if (
              (t.stage
                ? ((r = t.localToGlobal(0, 0).x),
                  (r = Math.min(t.width, t.stage.stageWidth - r)))
                : (r = t.width),
              ...
              var n = (t.height - t.size) * this._gscaleY,
                ...
                a = n * o,
                i = n - a;
              (i < (t.size / 2) * this._gscaleY &&
                (i = (t.size / 2) * this._gscaleY),
                this.setElementStyle("padding", a + "px 0px " + i + "px 0px"));
            }
            ((this.inputDiv.style.clip =
              "rect(0px " +
              t.width * this._gscaleX +
              "px " +
              t.height * this._gscaleY +
              "px 0px)"),
  ...
  (function (e) {
    ...
    !(function (t) {
      var r = (function () {
        ...
        return (
          (t.prototype.isInputOn = function () {
          ...
          (t.prototype.$updateSize = function () {
            if (this.canvas) {
              ...
              ((this.StageDelegateDiv.style[o] = this.canvas.style[o]),
                (this.StageDelegateDiv.style[
                  e.web.getPrefixStyleName("transformOrigin")
                ] = "0% 0% 0px"));
            }
          }),
          (t.prototype._initStageDelegateDiv = function (t, r) {
            ...
            i ||
              ...
              (n._inputDIV.style[e.web.getPrefixStyleName("transformOrigin")] =
                "0% 0% 0px"),
          ...
          (t.prototype.disconnectStageText = function (e) {
            (null == this._stageText || this._stageText == e) &&
          ...
          (t.prototype.clearInputElement = function () {
            ...
            if (e._inputElement) {
              ...
              var t = void 0;
              ((t =
                e._simpleElement == e._inputElement
                  ? e._multiElement
                  : e._simpleElement),
          ...
          (t.prototype.getInputElement = function (e) {
            ...
            (t.clearInputElement(),
              ...
              t._stageText.$textfield.multiline
                ? (t._inputElement = t._multiElement)
                : (t._inputElement = t._simpleElement));
            var r;
            return (
              (r =
                t._simpleElement == t._inputElement
                  ? t._multiElement
                  : t._simpleElement),
...
!(function (e) {
  ...
  !(function (e) {
      ...
      i = (function () {
        ...
        return (
          ...
          (e.prototype.resize = function (e, t, r) {
            ...
            if (r) {
              var n = !1;
              (i.width < e && ((i.width = e), (n = !0)),
                i.height < t && ((i.height = t), (n = !0)),
                n ||
                  ((this.context.globalCompositeOperation = "source-over"),
                  this.context.setTransform(1, 0, 0, 1, 0, 0),
                  (this.context.globalAlpha = 1)));
            } else
              (i.width != e && (i.width = e), i.height != t && (i.height = t));
            this.clear();
          }),
          (e.prototype.resizeTo = function (e, i, n, o) {
            ...
            ((r = a),
              ...
              (s.height = Math.max(i, 257)),
              l.setTransform(1, 0, 0, 1, 0, 0),
              l.drawImage(a, n, o),
              (a.height = 1),
              (a.width = 1));
          }),
          (e.prototype.setDirtyRegionPolicy = function (e) {}),
          (e.prototype.beginClip = function (e, t, r) {
            ((t = +t || 0), (r = +r || 0));
            var i = this.context;
            (i.save(), i.beginPath(), i.setTransform(1, 0, 0, 1, t, r));
            for (var n = e.length, o = 0; n > o; o++) {
              var a = e[o];
              (i.clearRect(a.minX, a.minY, a.width, a.height),
                i.rect(a.minX, a.minY, a.width, a.height));
            }
            i.clip();
          }),
    ...
    ((e.CanvasRenderBuffer = i),
      __reflect(i.prototype, "egret.web.CanvasRenderBuffer", [
        "egret.sys.RenderBuffer",
      ]));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
      ...
      return (
        ...
        (r.prototype.addListeners = function () {
          ...
          window.navigator.msPointerEnabled
            ...
            : (e.Capabilities.$isMobile || this.addMouseListener(),
        ...
        (r.prototype.getLocation = function (t) {
          ...
          return (
            90 == this.rotation
              ? ((s = l), (h = i.width - a))
              : -90 == this.rotation && ((s = i.height - l), (h = a)),
            (s /= this.scaleX),
            (h /= this.scaleY),
...
!(function (e) {
  ...
  !(function (t) {
        ...
        (r.prototype.registerListener = function () {
          var t = this,
            r = function () {
              t.isActivate &&
                ((t.isActivate = !1),
                t.stage.dispatchEvent(new e.Event(e.Event.DEACTIVATE)));
            },
            i = function () {
              t.isActivate ||
                ((t.isActivate = !0),
                t.stage.dispatchEvent(new e.Event(e.Event.ACTIVATE)));
            },
            n = function () {
              document[o] ? r() : i();
            };
              ...
              : "undefined" != typeof document.msHidden
                ...
                : "undefined" != typeof document.webkitHidden
                  ...
                  : "undefined" != typeof document.oHidden &&
                    ((o = "oHidden"), (a = "ovisibilitychange")),
            "onpageshow" in window &&
              "onpagehide" in window &&
              (window.addEventListener("pageshow", i, !1),
              window.addEventListener("pagehide", r, !1)),
            o && a && document.addEventListener(a, n, !1));
          ...
          if (((u || l) && (h = !1), h)) {
            ...
            ((c.execWebFn = c.execWebFn || {}),
              (c.execWebFn.postX5GamePlayerMessage = function (e) {
                var t = e.type;
                "app_enter_background" == t
                  ? r()
                  : "app_enter_foreground" == t && i();
              }),
              (window.browser = c));
          }
        }),
    ...
    ((t.WebHideHandler = r),
      __reflect(r.prototype, "egret.web.WebHideHandler"));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ...
  !(function (t) {
    function r(e, t) {
      ...
      return "" == r
        ? e
        : r + e.charAt(0).toUpperCase() + e.substring(1, e.length);
    }
    function i(e, t) {
      if (e in t) return "";
    ...
    ((o.WPHONE = 1),
      ...
      (o.ADNROID = 3),
      (t.SystemOSType = o),
      __reflect(o.prototype, "egret.web.SystemOSType"));
    var a = (function (t) {
      function r() {
      ...
      return (
        ...
        (r.$init = function () {
          ...
          ((r.ua = t),
            (e.Capabilities.$isMobile =
              -1 != t.indexOf("mobile") || -1 != t.indexOf("android")),
            (r._canUseBlob = !1));
          var i,
            a = r._audioType,
            s =
          ...
          if (
            (1 == a || 2 == a || 3 == a
              ? ((i = !1), r.setAudioType(a))
              : ((i = !0), r.setAudioType(n.HTML5_AUDIO)),
            t.indexOf("windows phone") >= 0)
          )
            ((r._System_OS = o.WPHONE), (e.Capabilities.$os = "Windows Phone"));
          else if (t.indexOf("android") >= 0) {
            if (
              ((e.Capabilities.$os = "Android"),
              (r._System_OS = o.ADNROID),
              i &&
                (s
                  ? r.setAudioType(n.WEB_AUDIO)
                  : r.setAudioType(n.HTML5_AUDIO)),
              window.hasOwnProperty("QZAppExternal") && t.indexOf("qzone") >= 0)
            ) {
              ...
              if (l && l.length > 0) r._QQRootPath = l[0].baseURI;
                ...
                -1 == h && (h = window.location.href.length);
            ...
            t.indexOf("ipad") >= 0 ||
            t.indexOf("ipod") >= 0
              ? ((e.Capabilities.$os = "iOS"),
                (r._System_OS = o.IOS),
                r.getIOSVersion() >= 7 &&
                  ((r._canUseBlob = !0), i && r.setAudioType(n.WEB_AUDIO)))
              : -1 != t.indexOf("windows nt")
                ? (e.Capabilities.$os = "Windows PC")
                : -1 != t.indexOf("mac os") && (e.Capabilities.$os = "Mac OS");
...
!(function (e) {
  ...
  !(function (t) {
    ...
    function i() {
      if (u)
        for (
          var e = document.querySelectorAll(".egret-player"),
            t = e.length,
            r = 0;
          t > r;
          r++
    ...
    function n(r) {
      if (!u) {
        ...
        (a(n),
          r.screenAdapter
            ? (e.sys.screenAdapter = r.screenAdapter)
            : e.sys.screenAdapter ||
              (e.sys.screenAdapter = new e.sys.DefaultScreenAdapter()));
        for (
          var s = document.querySelectorAll(".egret-player"),
            l = s.length,
            h = 0;
          l > h;
          h++
          ...
          ((c["egret-player"] = d),
            "webgl" == e.Capabilities.$renderMode &&
              (d.stage.dirtyRegionPolicy = e.DirtyRegionPolicy.OFF));
        }
        "webgl" == e.Capabilities.$renderMode &&
          (e.sys.DisplayList.prototype.setDirtyRegionPolicy = function () {});
      }
    }
    function o(r) {
      "webgl" == r && e.WebGLUtils.checkCanUseWebGL()
        ? ((e.sys.RenderBuffer = t.WebGLRenderBuffer),
          ...
          (e.Capabilities.$renderMode = "webgl"))
        : ((e.sys.RenderBuffer = t.CanvasRenderBuffer),
      ...
      h = {
        ...
        restore: function () {
          ...
          (r.bindBuffer(r.ARRAY_BUFFER, e.vertexBuffer),
            ...
            (e.shaderManager.currentShader = null),
            (e.bindIndices = !1));
    ...
    var r = (function () {
      ...
      return (
        (t.detect = function () {
          ...
          ((r.$isMobile =
            -1 != i.indexOf("mobile") || -1 != i.indexOf("android")),
            r.$isMobile
              ? i.indexOf("windows") < 0 &&
                (-1 != i.indexOf("iphone") ||
                  -1 != i.indexOf("ipad") ||
                  -1 != i.indexOf("ipod"))
                ? (r.$os = "iOS")
                : -1 != i.indexOf("android") && -1 != i.indexOf("linux")
                  ? (r.$os = "Android")
                  : -1 != i.indexOf("windows") && (r.$os = "Windows Phone")
              : -1 != i.indexOf("windows nt")
                ? (r.$os = "Windows PC")
                : -1 != i.indexOf("mac os") && (r.$os = "Mac OS"));
          var n = (
              navigator.language || navigator.browserLanguage
            ).toLowerCase(),
            o = n.split("-");
          (o.length > 1 && (o[1] = o[1].toUpperCase()),
            (r.$language = o.join("-")),
...
!(function (e) {
  ...
  !(function (t) {
    var r = (function (t) {
      function r(r, i, n, o, a) {
        ...
        if (
          ...
          ("canvas" == e.Capabilities.renderMode
            ? (s.renderMode = "Canvas")
            : (s.renderMode = "WebGL"),
            (s.panelX = void 0 === a.x ? 0 : parseInt(a.x)),
            (s.panelY = void 0 === a.y ? 0 : parseInt(a.y)),
            (s.fontColor =
              void 0 === a.textColor
                ? "#ffffff"
                : a.textColor.replace("0x", "#")),
            (s.fontSize = void 0 === a.size ? 12 : parseInt(a.size)),
            e.Capabilities.isMobile && (s.fontSize -= 2));
          var l = document.createElement("div");
          ((l.style.position = "absolute"),
            (l.style.background = "rgba(0,0,0," + a.bgAlpha + ")"),
      ...
      return (
        ...
        (r.prototype.addFps = function () {
          ...
          ((o.style["float"] = "left"),
            (o.innerHTML = "Draw<br/>Dirty<br/>Cost"),
            n.appendChild(o));
        ...
        (r.prototype.addLog = function () {
          var e = document.createElement("div");
          ((e.style.maxWidth =
            document.body.clientWidth - 8 - this.panelX + "px"),
        ...
        (r.prototype.update = function (e, t) {
          ...
          (1 > v && (v = 1),
            ...
            f.fillRect(d - 1, 20 - v, 1, v));
          var g = this.WIDTH_COST;
          ((f = this.contextCost),
            f.drawImage(this.canvasCost, 1, 0, g - 1, p, 0, 0, g - 1, p),
            f.drawImage(
              this.canvasCost,
              g + 2,
              0,
          ...
          (1 > x ? (x = 1) : x > 20 && (x = 20),
            (f.fillStyle = this.bgCanvasColor),
            f.fillRect(g - 1, 0, 1, p),
            f.fillRect(2 * g, 0, 1, p),
            f.fillRect(3 * g + 1, 0, 1, p),
            (f.fillStyle = this.cost1Color),
            f.fillRect(g - 1, 20 - y, 1, y),
            (f.fillStyle = this.cost2Color),
            f.fillRect(2 * g, 20 - m, 1, m),
            (f.fillStyle = this.cost3Color),
            f.fillRect(3 * g + 1, 20 - x, 1, x));
          var b = Math.floor(a / s),
            w = r + " FPS " + this.renderMode;
          (this.showPanle &&
            ((w += "<br/>min" + l + " max" + h + " avg" + b),
            (this.divDraw.innerHTML =
              this.lastNumDraw + "<br/>" + this.lastNumDirty + "%<br/>"),
            (this.divCost.innerHTML =
              '<font  style="color:#18fefe">' +
              i +
              '<font/> <font  style="color:#ffff00">' +
              n +
        ...
        (r.prototype.updateInfo = function (e) {
          for (
            this.arrLog.push(e), this.log.innerHTML = this.arrLog.join("<br/>");
            document.body.clientHeight <
            this.log.offsetHeight +
              this.fpsHeight +
              this.panelY +
              2 * this.fontSize;
    ...
    ((t.WebFps = r),
      __reflect(r.prototype, "egret.web.WebFps", [
        "egret.FPSDisplay",
        "egret.DisplayObject",
      ]),
      (e.FPSDisplay = r));
...
!(function (e) {
  ...
  !(function (t) {
    ...
    ((t.WebExternalInterface = r),
      __reflect(r.prototype, "egret.web.WebExternalInterface", [
        "egret.ExternalInterface",
      ]),
      (e.ExternalInterface = r));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
      ...
      return (
        ...
        (i.prototype.init = function (r, i) {
          var n = this.readOption(r, i),
            o = new e.Stage();
          ((o.$screen = this),
            (o.$scaleMode = n.scaleMode),
            (o.$orientation = n.orientation),
            (o.$maxTouches = n.maxTouches),
            (o.frameRate = n.frameRate),
            (o.textureScaleFactor = n.textureScaleFactor));
          ...
          (h.showPaintRect(n.showPaintRect),
            (n.showFPS || n.showLog) &&
              h.displayFPS(n.showFPS, n.showLog, n.logFilter, n.fpsStyles),
            (this.playerOption = n),
            (this.container = r),
            (this.canvas = s),
            (this.stage = o),
            ...
            (this.webInput = c),
            (this.webHide = u),
            e.web.$cacheTextAdapter(c, o, r, s),
        ...
        (i.prototype.initOrientation = function () {
          ...
          window.addEventListener("orientationchange", function () {
            window.setTimeout(function () {
              e.StageOrientationEvent.dispatchStageOrientationEvent(
                t.stage,
                e.StageOrientationEvent.ORIENTATION_CHANGE,
              );
            }, 350);
          });
        }),
        (i.prototype.readOption = function (t, r) {
          ...
          ((i.entryClassName = t.getAttribute("data-entry-class")),
            (i.scaleMode =
              t.getAttribute("data-scale-mode") || e.StageScaleMode.NO_SCALE),
            ...
            (i.orientation =
              t.getAttribute("data-orientation") || e.OrientationMode.AUTO),
            (i.maxTouches = +t.getAttribute("data-multi-fingered") || 2),
            (i.textureScaleFactor =
              +t.getAttribute("texture-scale-factor") || 1),
            "webgl" == r.renderMode
              ? (i.showPaintRect = !1)
              : (i.showPaintRect =
                  "true" == t.getAttribute("data-show-paint-rect")),
            (i.showFPS = "true" == t.getAttribute("data-show-fps")));
          for (
            var n = t.getAttribute("data-show-fps-style") || "",
              o = n.split(","),
              a = {},
              s = 0;
            s < o.length;
        ...
        (i.prototype.attachCanvas = function (e, t) {
          ...
          ((r.cursor = "inherit"),
            ...
            (r.overflow = "hidden"),
            (r.position = "relative"),
            (r.webkitTransform = "translateZ(0)"));
        }),
        (i.prototype.updateScreenSize = function () {
          ...
          if (!t.userTyping) {
            ...
            o != e.OrientationMode.AUTO &&
              (n =
                (o != e.OrientationMode.PORTRAIT && i.height > i.width) ||
                (o == e.OrientationMode.PORTRAIT && i.width > i.height));
            var a = n ? i.height : i.width,
              s = n ? i.width : i.height;
            ((e.Capabilities.$boundingClientWidth = a),
              (e.Capabilities.$boundingClientHeight = s));
            var l = e.sys.screenAdapter.calculateStageSize(
              ...
              d = l.displayHeight;
            (t.width !== h && (t.width = h),
              t.height !== u && (t.height = u),
              (t.style[e.web.getPrefixStyleName("transformOrigin")] =
                "0% 0% 0px"),
              (t.style.width = c + "px"),
              (t.style.height = d + "px"));
            var p = 0;
            n
              ? o == e.OrientationMode.LANDSCAPE
                ? ((p = 90),
                  (t.style.top = (i.height - c) / 2 + "px"),
                  (t.style.left = (i.width + d) / 2 + "px"))
                : ((p = -90),
                  (t.style.top = (i.height + c) / 2 + "px"),
                  (t.style.left = (i.width - d) / 2 + "px"))
              : ((t.style.top = (i.height - d) / 2 + "px"),
                (t.style.left = (i.width - c) / 2 + "px"));
            var f = "rotate(" + p + "deg)";
            t.style[e.web.getPrefixStyleName("transform")] = f;
            var v = c / h,
              g = d / u;
            (this.webTouchHandler.updateScaleMode(v, g, p),
              this.webInput.$updateSize(),
              this.player.updateStageSize(h, u));
          }
        }),
  ...
  !(function (t) {
    function r(t, r) {
      ...
      if (
        ...
        t.$renderBuffer
          ? (u = t)
          : ((u = new e.RenderTexture()), u.drawToTexture(new e.Bitmap(t)));
        for (
          var c = u.$renderBuffer.getPixels(r.x, r.y, o, a),
            d = new ImageData(o, a),
            p = 0;
          p < c.length;
          p++
      ...
      return (
        l.drawImage(
          f._bitmapData.source,
          f._bitmapX + r.x / e.$TextureScaleFactor,
          f._bitmapY + r.y / e.$TextureScaleFactor,
          (y * r.width) / i,
          (m * r.height) / n,
          v,
          g,
    ...
    ((e.Texture.prototype.toDataURL = i),
      ...
      (e.Texture.prototype.getPixel32 = o),
      (e.Texture.prototype.getPixels = a));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ...
  !(function (t) {
    function r(e) {
      for (
        var t = s.parseFromString(e, "text/xml"),
    ...
    function i(e, t) {
      ...
      for (
        var r = new o(e.localName, t, e.prefix, e.namespaceURI, e.nodeName),
          n = e.attributes,
          s = r.attributes,
          l = n.length,
          h = 0;
...
(!(function (e) {
  ...
  !(function (t) {
    ...
    ((t.WebDeviceOrientation = r),
      __reflect(r.prototype, "egret.web.WebDeviceOrientation", [
    ...
    var r = (function (t) {
        ...
        return (
          ...
          (i.onError = function (t) {
            ...
            t.code == t.PERMISSION_DENIED &&
              (r = e.GeolocationEvent.PERMISSION_DENIED);
      ...
      return (
        ...
        (r.prototype.start = function () {
          ...
          t
            ? (this.watchId = t.watchPosition(this.onUpdate, this.onError))
            : this.onError({
                code: 2,
      ...
      function r() {
        ...
        return (
          (r.onChange = function (t) {
            ...
            ((i.acceleration = n),
              (i.accelerationIncludingGravity = o),
              (i.rotationRate = a),
              r.dispatchEvent(i));
          }),
          r
  ...
  !(function (t) {
    var r = ["source-over", "lighter", "destination-out"],
      ...
      o = (function () {
        ...
        return (
          (o.prototype.render = function (e, t, r, i, o) {
            this.nestLevel++;
            var a = t,
              s = a.context,
              l = o ? e : null;
            (s.pushBuffer(a),
              this.drawDisplayObject(e, a, i, r, null, null, l),
              s.$drawWebGL());
            var h = a.$drawCalls;
            if (
              (a.onRenderFinish(),
          ...
          (o.prototype.drawDisplayObject = function (t, r, i, n, o, a, s) {
            ...
            if (
              (o && !s
                ? (o.isDirty && (h += o.drawToSurface()), (l = o.$renderNode))
                : (l = t.$getRenderNode()),
              l)
            ) {
              if (i) {
              ...
              if (l.needRedraw) {
                ...
                var p = void 0,
                  f = void 0;
                (s
                  ? ((p = t.$getConcatenatedAlphaAt(
                      s,
                      t.$getConcatenatedAlpha(),
                    )),
                    (f = e.Matrix.create().copyFrom(
                      t.$getConcatenatedMatrix(),
                    )),
                    t.$getConcatenatedMatrixAt(s, f),
            ...
            if (v)
              for (var g = v.length, y = 0; g > y; y++) {
                ...
                if (!(!m.$visible || m.$alpha <= 0 || m.$maskedObject)) {
                  var x = m.$getFilters();
                  x && x.length > 0
                    ? (h += this.drawWithFilter(m, r, i, n, a, s))
                    : 0 !== m.$blendMode ||
                        (m.$mask && (m.$mask.$parentDisplayList || s))
                      ? (h += this.drawWithClip(m, r, i, n, a, s))
                      : m.$scrollRect || m.$maskRect
                        ? (h += this.drawWithScrollRect(m, r, i, n, a, s))
                        : m.isFPS
                          ? (r.context.$drawWebGL(),
                            (r.$computeDrawCall = !1),
          ...
          (o.prototype.drawWithFilter = function (t, o, a, s, l, h) {
            var u,
              ...
              p = 0 !== t.$blendMode;
            if (
              (p && ((u = r[t.$blendMode]), u || (u = i)),
              1 == d.length && "colorTransform" == d[0].type && !t.$children)
            )
              return (
                p && o.context.setGlobalCompositeOperation(u),
                (o.context.$filter = d[0]),
                (c +=
                  t.$mask && (t.$mask.$parentDisplayList || h)
                    ? this.drawWithClip(t, o, a, s, l, h)
                    : t.$scrollRect || t.$maskRect
                      ? this.drawWithScrollRect(t, o, a, s, l, h)
                      : this.drawDisplayObject(
                          t,
                          o,
                          a,
                ...
                (o.context.$filter = null),
                p && o.context.setGlobalCompositeOperation(i),
                c
              );
            var f = e.Matrix.create();
            (f.copyFrom(t.$getConcatenatedMatrix()),
              h && t.$getConcatenatedMatrixAt(h, f));
            var v;
            ...
            (y.context.pushBuffer(y),
              y.setTransform(1, 0, 0, 1, -v.minX, -v.minY));
            var m = e.Matrix.create().setTo(1, 0, 0, 1, -v.minX, -v.minY);
            return (
              (c +=
                t.$mask && (t.$mask.$parentDisplayList || h)
                  ? this.drawWithClip(t, y, a, m, v, h)
                  : t.$scrollRect || t.$maskRect
                    ? this.drawWithScrollRect(t, y, a, m, v, h)
                    : this.drawDisplayObject(t, y, a, m, t.$displayList, v, h)),
              e.Matrix.release(m),
              y.context.popBuffer(),
              c > 0 &&
                (p && o.context.setGlobalCompositeOperation(u),
                c++,
                (o.globalAlpha = 1),
                o.setTransform(1, 0, 0, 1, v.minX + s.tx, v.minY + s.ty),
                o.context.drawTargetWidthFilters(d, y),
                p && o.context.setGlobalCompositeOperation(i)),
              n.push(y),
              e.sys.Region.release(v),
              e.Matrix.release(f),
              c
            );
          }),
          (o.prototype.drawWithClip = function (t, o, a, s, l, h) {
            ...
            var y,
              m = e.Matrix.create();
            if (
              (m.copyFrom(t.$getConcatenatedMatrix()), t.$parentDisplayList)
            ) {
            ...
            var T;
            if (
              (p && ((T = e.sys.Region.create()), T.updateRegion(p, m)),
              T && y
                ? (T.intersect(y), e.sys.Region.release(y))
                : !T && y && (T = y),
              T)
            ) {
              if (T.isEmpty() || (l && !l.intersects(T)))
                return (e.sys.Region.release(T), e.Matrix.release(m), c);
            } else
              ((T = e.sys.Region.create()),
            ...
            if (f || (t.$children && 0 != t.$children.length)) {
              ...
              (C.context.pushBuffer(C),
                C.setTransform(1, 0, 0, 1, -T.minX, -T.minY));
              var R = e.Matrix.create().setTo(1, 0, 0, 1, -T.minX, -T.minY);
              if (
                ((c += this.drawDisplayObject(
                  t,
                  C,
                  a,
                  R,
                ...
                (L.context.pushBuffer(L),
                  L.setTransform(1, 0, 0, 1, -T.minX, -T.minY),
                  (R = e.Matrix.create().setTo(1, 0, 0, 1, -T.minX, -T.minY)),
                  (c += this.drawDisplayObject(
                    f,
                    L,
                    a,
                ...
                (C.context.drawTexture(
                  L.rootRenderTarget.texture,
                  0,
                  0,
                  D,
                  A,
              ...
              if (
                ...
                (o.context.drawTexture(
                  ...
                  p && C.context.popMask(),
                  d && o.context.setGlobalCompositeOperation(i));
              }
              return (
                n.push(C),
                e.sys.Region.release(T),
                e.Matrix.release(m),
                c
              );
            }
            if (p) {
              var w = m;
              (o.setTransform(w.a, w.b, w.c, w.d, w.tx - T.minX, w.ty - T.minY),
                o.context.pushMask(p));
            }
            return (
              d && o.context.setGlobalCompositeOperation(u),
              (c += this.drawDisplayObject(t, o, a, s, t.$displayList, l, h)),
              d && o.context.setGlobalCompositeOperation(i),
              p && o.context.popMask(),
              e.sys.Region.release(T),
              e.Matrix.release(m),
          ...
          (o.prototype.drawWithScrollRect = function (t, r, i, n, o, a) {
            ...
            if ((h.copyFrom(t.$getConcatenatedMatrix()), a))
              t.$getConcatenatedMatrixAt(a, h);
            ...
            if ((c.updateRegion(l, h), c.isEmpty() || (o && !o.intersects(c))))
              return (e.sys.Region.release(c), e.Matrix.release(h), s);
            var d = !1;
            if (i) {
            ...
            if (r.$hasScissor || 0 != h.b || 0 != h.c) v.pushMask(l);
              ...
              (v.enableScissor(_ + n.tx, -n.ty - L + r.height, R - _, L - C),
                (g = !0));
            }
            return (
              (s += this.drawDisplayObject(t, r, i, n, t.$displayList, c, a)),
              r.setTransform(h.a, h.b, h.c, h.d, h.tx + n.tx, h.ty + n.ty),
              g ? v.disableScissor() : v.popMask(),
              e.sys.Region.release(c),
              e.Matrix.release(h),
              s
            );
          }),
          ...
          (o.prototype.renderBitmap = function (e, t) {
            ...
            if (n) {
              ...
              var c;
              if (
                (u == u && ((c = t.globalAlpha), (t.globalAlpha *= u)),
                e.filter)
              ) {
                for (t.context.$filter = e.filter; a > s; )
                  t.context.drawImage(
                    n,
                    o[s++],
                    o[s++],
          ...
          (o.prototype.renderMesh = function (e, t) {
            ...
            for (
              a &&
              (t.saveTransform(), t.transform(a.a, a.b, a.c, a.d, a.tx, a.ty));
              n > o;
          ...
          (o.prototype.renderText = function (r, i) {
            ...
            if (
              0 != r.drawData.length &&
              (this.canvasRenderBuffer && this.canvasRenderBuffer.context
                ? r.dirtyRender && this.canvasRenderBuffer.resize(n, o)
                : ((this.canvasRenderer = new e.CanvasRenderer()),
                  (this.canvasRenderBuffer = new t.CanvasRenderBuffer(n, o))),
              this.canvasRenderBuffer.context)
            ) {
              if (
                ((r.x || r.y) &&
                  (r.dirtyRender &&
                    this.canvasRenderBuffer.context.translate(-r.x, -r.y),
                  i.transform(1, 0, 0, 1, r.x, r.y)),
                r.dirtyRender)
              ) {
                var a = this.canvasRenderBuffer.surface;
                this.canvasRenderer.renderText(
                  r,
                  this.canvasRenderBuffer.context,
                );
                var s = r.$texture;
                (s
                  ? i.context.updateTexture(s, a)
                  : ((s = i.context.createTexture(a)), (r.$texture = s)),
                  (r.$textureWidth = a.width),
                  (r.$textureHeight = a.height));
              }
              var l = r.$textureWidth,
                h = r.$textureHeight;
              (i.context.drawTexture(r.$texture, 0, 0, l, h, 0, 0, l, h, l, h),
                (r.x || r.y) &&
                  (r.dirtyRender &&
                    this.canvasRenderBuffer.context.translate(r.x, r.y),
                  i.transform(1, 0, 0, 1, -r.x, -r.y)),
          ...
          (o.prototype.renderGraphics = function (r, i, n) {
            ...
            if (
              ...
              0 != r.drawData.length &&
              (this.canvasRenderBuffer && this.canvasRenderBuffer.context
                ? (r.dirtyRender || n) && this.canvasRenderBuffer.resize(o, a)
                : ((this.canvasRenderer = new e.CanvasRenderer()),
                  (this.canvasRenderBuffer = new t.CanvasRenderBuffer(o, a))),
              this.canvasRenderBuffer.context)
            ) {
              (r.x || r.y) &&
                ((r.dirtyRender || n) &&
              ...
              if (n) {
                (this.canvasRenderer.renderGraphics(
                  r,
                  this.canvasRenderBuffer.context,
                  !0,
                ),
                ...
                if (r.dirtyRender) {
                  ...
                  var l = r.$texture;
                  (l
                    ? i.context.updateTexture(l, s)
                    : ((l = i.context.createTexture(s)), (r.$texture = l)),
          ...
          (o.prototype.renderGroup = function (e, t) {
            var r = e.matrix;
            r &&
              (t.saveTransform(), t.transform(r.a, r.b, r.c, r.d, r.tx, r.ty));
    ...
    ((t.WebGLRenderer = o),
      __reflect(o.prototype, "egret.web.WebGLRenderer", [
        "egret.sys.SystemRenderer",
      ]));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
...
!(function (e) {
  ...
  !(function (e) {
    ...
    ((e.PrimitiveShader = t),
      __reflect(t.prototype, "egret.web.PrimitiveShader"));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ...
  !(function (e) {
    var t = (function (e) {
      function t() {
        ...
        return (
          (t.fragmentSrc =
            "precision mediump float;uniform vec2 blur;uniform sampler2D uSampler;varying vec2 vTextureCoord;uniform vec2 uTextureSize;void main(){const int sampleRadius = 5;const int samples = sampleRadius * 2 + 1;vec2 blurUv = blur / uTextureSize;vec4 color = vec4(0, 0, 0, 0);vec2 uv = vec2(0.0, 0.0);blurUv /= float(sampleRadius);for (int i = -sampleRadius; i <= sampleRadius; i++) {uv.x = vTextureCoord.x + float(i) * blurUv.x;uv.y = vTextureCoord.y + float(i) * blurUv.y;color += texture2D(uSampler, uv);}color /= float(samples);gl_FragColor = color;}"),
          (t.uniforms = {
            projectionVector: { type: "2f", value: { x: 0, y: 0 }, dirty: !0 },
            blur: { type: "2f", value: { x: 2, y: 2 }, dirty: !0 },
            uTextureSize: { type: "2f", value: { x: 100, y: 100 }, dirty: !0 },
          }),
          t
        );
      }
      return (
        __extends(t, e),
        (t.prototype.setBlur = function (e, t) {
...
!(function (e) {
  ...
  !(function (e) {
    ...
    ((e.ColorTransformShader = t),
      __reflect(t.prototype, "egret.web.ColorTransformShader"));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
    ...
    var t = (function (e) {
      function t() {
        ...
        return (
          (t.fragmentSrc = [
            ...
            "uniform vec2 uTextureSize;vec2 px = vec2(1.0 / uTextureSize.x, 1.0 / uTextureSize.y);",
          ...
          (t.uniforms = {
            projectionVector: { type: "2f", value: { x: 0, y: 0 }, dirty: !0 },
            distance: { type: "1f", value: 15, dirty: !0 },
            angle: { type: "1f", value: 1, dirty: !0 },
            color: { type: "4f", value: { x: 1, y: 0, z: 0, w: 0 }, dirty: !0 },
            alpha: { type: "1f", value: 1, dirty: !0 },
            blurX: { type: "1f", value: 1, dirty: !0 },
            blurY: { type: "1f", value: 1, dirty: !0 },
            strength: { type: "1f", value: 1, dirty: !0 },
            inner: { type: "1f", value: 1, dirty: !0 },
            knockout: { type: "1f", value: 1, dirty: !0 },
            hideObject: { type: "1f", value: 0, dirty: !0 },
            uTextureSize: { type: "2f", value: { x: 100, y: 100 }, dirty: !0 },
          }),
          t
        );
      ...
      return (
        ...
        (t.prototype.setColor = function (e, t, r) {
          ...
          (i.value.x != e || i.value.y != t || i.value.z != r) &&
            ((i.value.x = e), (i.value.y = t), (i.value.z = r), (i.dirty = !0));
        }),
...
!(function (e) {
  ...
  !(function (e) {
      ...
      return (
        (t.prototype.setContext = function (t) {
          ((this.gl = t),
            ...
            (this.defaultShader = new e.TextureShader(t)),
            (this.colorTransformShader = new e.ColorTransformShader(t)),
            (this.glowShader = new e.GlowShader(t)),
            (this.blurShader = new e.BlurShader(t)),
        ...
        (t.prototype.activateShader = function (e, t) {
          this.currentShader != e &&
            ...
            e.setAttribPointer(t),
            (this.currentShader = e));
        }),
        (t.prototype.setAttribs = function (e) {
          var t, r;
          for (r = this.tempAttribState.length, t = 0; r > t; t++)
          ...
          var n = this.gl;
          for (r = this.attribState.length, t = 0; r > t; t++)
    ...
    ((e.WebGLShaderManager = t),
      __reflect(t.prototype, "egret.web.WebGLShaderManager"));
  })((t = e.web || (e.web = {})));
})(egret || (egret = {}));
var egret;
!(function (e) {
  ...
  !(function (e) {
    var t = (function () {
      ...
      return (
        (e.prototype.pushDrawRect = function () {
          if (
            0 == this.drawDataLen ||
            1 != this.drawData[this.drawDataLen - 1].type
          ) {
        ...
        (e.prototype.pushDrawTexture = function (e, t, r, i, n) {
          if ((void 0 === t && (t = 2), r)) {
            ...
            ((o.type = 0),
              ...
              (o.textureWidth = i),
              (o.textureHeight = n),
              (this.drawData[this.drawDataLen] = o),
              this.drawDataLen++);
          } else {
            if (
              0 == this.drawDataLen ||
              0 != this.drawData[this.drawDataLen - 1].type ||
              e != this.drawData[this.drawDataLen - 1].texture ||
        ...
        (e.prototype.pushSetBlend = function (e) {
          for (var t = this.drawDataLen, r = !1, i = t - 1; i >= 0; i--) {
            ...
            if (n) {
              if (
                ((0 == n.type || 1 == n.type) && (r = !0), !r && 4 == n.type)
              ) {
        ...
        (e.prototype.pushActivateBuffer = function (e) {
          for (var t = this.drawDataLen, r = !1, i = t - 1; i >= 0; i--) {
            var n = this.drawData[i];
            !n ||
              (4 != n.type && 7 != n.type && (r = !0), r || 7 != n.type) ||
              (this.drawData.splice(i, 1), this.drawDataLen--);
          }
          var o = this.drawData[this.drawDataLen] || {};
          ((o.type = 7),
            (o.buffer = e),
            (o.width = e.rootRenderTarget.width),
            (o.height = e.rootRenderTarget.height),
            (this.drawData[this.drawDataLen] = o),
            this.drawDataLen++);
        }),
...
!(function (e) {
  ...
  !(function (e) {
    var t = (function () {
      ...
      return (
        (e.prototype.reachMaxSize = function (e, t) {
          return (
            void 0 === e && (e = 4),
            void 0 === t && (t = 6),
            this.vertexIndex > this.vertexMaxSize - e ||
              this.indexIndex > this.indicesMaxSize - t
          );
        }),
        ...
        (e.prototype.cacheArrays = function (
          e,
          t,
          r,
          i,
          ...
          var v = e,
            ...
            b = v.tx,
            w = v.ty;
          ((0 != a || 0 != s) && v.append(1, 0, 0, 1, a, s),
            (n / l != 1 || o / h != 1) && v.append(l / n, 0, 0, h / o, 0, 0));
          var T = v.a,
            E = v.b,
            S = v.c,
            _ = v.d,
          ...
          if (
            ...
            for (A = 0, $ = d.length; $ > A; A += 2)
              ((M = (5 * A) / 2),
                ...
                (L[D + M + 4] = t));
            if (this.hasMesh)
              for (var F = 0, W = f.length; W > F; ++F)
                this.indicesForMesh[this.indexIndex + F] =
                  f[F] + this.vertexIndex;
            ...
            if (
              ...
              ((N[this.indexIndex + 0] = 0 + this.vertexIndex),
                (N[this.indexIndex + 1] = 1 + this.vertexIndex),
                (N[this.indexIndex + 2] = 2 + this.vertexIndex),
                (N[this.indexIndex + 3] = 0 + this.vertexIndex),
                (N[this.indexIndex + 4] = 2 + this.vertexIndex),
                (N[this.indexIndex + 5] = 3 + this.vertexIndex));
            }
    ...
    var r = (function (e) {
      function t(t, r, i) {
        ...
        return (
          ...
          (n.width = r || 1),
          (n.height = i || 1),
          (n.texture = n.createTexture()),
          (n.frameBuffer = t.createFramebuffer()),
          ...
          (n.stencilBuffer = t.createRenderbuffer()),
          t.bindRenderbuffer(t.RENDERBUFFER, n.stencilBuffer),
      ...
      return (
        ...
        (t.prototype.resize = function (e, t) {
          ...
          (r.bindTexture(r.TEXTURE_2D, this.texture),
            ...
            r.deleteRenderbuffer(this.stencilBuffer),
            (this.stencilBuffer = r.createRenderbuffer()),
            r.bindRenderbuffer(r.RENDERBUFFER, this.stencilBuffer),
            r.renderbufferStorage(r.RENDERBUFFER, r.DEPTH_STENCIL, e, t),
            (this.width = e),
            (this.height = t));
        }),
...
!(function (e) {
  ...
  !(function (t) {
    ...
    var i = (function () {
      ...
      return (
        (i.getInstance = function (e, t) {
          return this.instance
            ? this.instance
            : ((this.instance = new i(e, t)), this.instance);
        }),
        (i.prototype.pushBuffer = function (e) {
          (this.$bufferStack.push(e),
            e != this.currentBuffer &&
              (this.currentBuffer, this.drawCmdManager.pushActivateBuffer(e)),
        ...
        (i.prototype.initWebGL = function () {
          (this.onResize(),
            ...
            (this.shaderManager = new t.WebGLShaderManager(this.context)));
        }),
        ...
        (i.prototype.getWebGLContext = function () {
          for (
            var t,
              r = { antialias: i.antialias, stencil: !0 },
        ...
        (i.prototype.createTexture = function (e) {
          ...
          return r
            ? ((r.glContext = t),
              ...
              r)
            : void (this.contextLost = !0);
        }),
        (i.prototype.createTextureFromCompressedData = function (
          e,
          t,
          r,
          i,
        ...
        (i.prototype.getWebGLTexture = function (e) {
          return (
            e.webGLTexture ||
              ("image" == e.format
                ? (e.webGLTexture = this.createTexture(e.source))
                : "pvr" == e.format &&
                  (e.webGLTexture = this.createTextureFromCompressedData(
                    e.source.pvrtcData,
                    e.width,
                    e.height,
                    e.source.mipmapsCount,
                    e.source.format,
                  )),
        ...
        (i.prototype.clearRect = function (e, t, r, i) {
          if (
            0 != e ||
            0 != t ||
            r != this.surface.width ||
            i != this.surface.height
          ) {
        ...
        (i.prototype.drawImage = function (e, t, r, i, n, o, a, s, l, h, u) {
          ...
          if (!this.contextLost && e && c) {
            ...
            if (e.texture || (e.source && e.source.texture))
              ((d = e.texture || e.source.texture),
                c.saveTransform(),
                c.transform(1, 0, 0, -1, 0, l + 2 * a));
            else {
              if (!e.source && !e.webGLTexture) return;
              d = this.getWebGLTexture(e);
            }
            d &&
              (this.drawTexture(d, t, r, i, n, o, a, s, l, h, u),
              e.source && e.source.texture && c.restoreTransform());
          }
        }),
        (i.prototype.drawMesh = function (
          ...
          if (!this.contextLost && e && v) {
            var g;
            if (e.texture || (e.source && e.source.texture))
              ((g = e.texture || e.source.texture),
                v.saveTransform(),
                v.transform(1, 0, 0, -1, 0, l + 2 * a));
            else {
              if (!e.source && !e.webGLTexture) return;
        ...
        (i.prototype.drawTexture = function (
          e,
          t,
          r,
          i,
          ...
          if (!this.contextLost && e && v) {
            (d && p
              ? this.vao.reachMaxSize(d.length / 2, p.length) &&
                this.$drawWebGL()
              : this.vao.reachMaxSize() && this.$drawWebGL(),
              c && this.vao.changeToMeshIndices());
            var g = v.globalMatrix,
              y = v.globalAlpha,
              m = p ? p.length / 3 : 2;
            (this.drawCmdManager.pushDrawTexture(e, m, this.$filter),
        ...
        (i.prototype.$drawWebGL = function () {
          if (0 != this.drawCmdManager.drawDataLen && !this.contextLost) {
            ...
            for (
              var e = this.drawCmdManager.drawDataLen, t = 0, r = 0;
              e > r;
              r++
            ) {
              ...
              ((t = this.drawData(i, t)),
                ...
                (0 == i.type || 1 == i.type || 2 == i.type || 3 == i.type) &&
                  this.activatedBuffer &&
                  this.activatedBuffer.$computeDrawCall &&
          ...
          if (e) {
            ...
            switch (e.type) {
              case 0:
                var i = e.filter;
                (i
                  ? "colorTransform" == i.type
                    ? ((r = this.shaderManager.colorTransformShader),
                      r.setMatrix(i.$matrix))
                    : "blur" == i.type
                      ? ((r = this.shaderManager.blurShader),
                        r.setBlur(i.$blurX, i.$blurY),
                        r.setTextureSize(e.textureWidth, e.textureHeight))
                      : "glow" == i.type &&
                        ((r = this.shaderManager.glowShader),
                        r.setDistance(i.$distance || 0),
                        r.setAngle(i.$angle ? (i.$angle / 180) * Math.PI : 0),
                        r.setColor(i.$red / 255, i.$green / 255, i.$blue / 255),
                        r.setAlpha(i.$alpha),
                        r.setBlurX(i.$blurX),
                        r.setBlurY(i.$blurY),
                        r.setStrength(i.$strength),
                        r.setInner(i.$inner ? 1 : 0),
                        r.setKnockout(i.$knockout ? 0 : 1),
                        r.setHideObject(i.$hideObject ? 1 : 0),
                        r.setTextureSize(e.textureWidth, e.textureHeight))
                  : (r = this.shaderManager.defaultShader),
                  r.setProjection(this.projectionX, this.projectionY),
                  this.shaderManager.activateShader(r, 4 * this.vertSize),
                  r.syncUniforms(),
                  (t += this.drawTextureElements(e, t)));
                break;
              case 1:
                ((r = this.shaderManager.primitiveShader),
                  r.setProjection(this.projectionX, this.projectionY),
                  this.shaderManager.activateShader(r, 4 * this.vertSize),
                  r.syncUniforms(),
                  (t += this.drawRectElements(e, t)));
                break;
              case 2:
                ((r = this.shaderManager.primitiveShader),
                  r.setProjection(this.projectionX, this.projectionY),
                  this.shaderManager.activateShader(r, 4 * this.vertSize),
                  r.syncUniforms(),
                  (t += this.drawPushMaskElements(e, t)));
                break;
              case 3:
                ((r = this.shaderManager.primitiveShader),
                  r.setProjection(this.projectionX, this.projectionY),
                  this.shaderManager.activateShader(r, 4 * this.vertSize),
                  r.syncUniforms(),
                  (t += this.drawPopMaskElements(e, t)));
                break;
              case 4:
        ...
        (i.prototype.drawPopMaskElements = function (e, t) {
          var r = this.context,
            ...
            n = this.activatedBuffer;
          if (n)
            if ((n.stencilHandleCount--, 0 == n.stencilHandleCount))
              n.disableStencil();
            else {
              var o = n.stencilHandleCount;
              (r.colorMask(!1, !1, !1, !1),
        ...
        (i.prototype.drawTargetWidthFilters = function (e, r) {
          ...
          var u = e[o - 1];
          (this.drawToRenderTarget(u, r, this.currentBuffer),
            r != n && t.WebGLRenderBuffer.release(r));
        }),
        (i.prototype.drawToRenderTarget = function (r, i, n) {
          if (!this.contextLost) {
            ...
            ("blur" == r.type &&
              (this.blurFilter || (this.blurFilter = new e.BlurFilter(2, 2)),
              0 != r.blurX && 0 != r.blurY
                ? ((this.blurFilter.blurX = r.blurX),
                  (this.blurFilter.blurY = 0),
                  (o = t.WebGLRenderBuffer.create(s, l)),
                  o.setTransform(1, 0, 0, 1, 0, 0),
                  (o.globalAlpha = 1),
                  this.drawToRenderTarget(this.blurFilter, i, o),
                  i != a && t.WebGLRenderBuffer.release(i),
                  (i = o),
                  (this.blurFilter.blurX = 0),
                  (this.blurFilter.blurY = r.blurY))
                : ((this.blurFilter.blurX = r.blurX),
                  (this.blurFilter.blurY = r.blurY)),
              (r = this.blurFilter)),
              n.saveTransform(),
            ...
            ((h =
              "blur" == r.type
                ? { type: "blur", $blurX: r.$blurX, $blurY: r.$blurY }
                : r),
              this.drawCmdManager.pushDrawTexture(
                i.rootRenderTarget.texture,
                2,
                h,
                s,
                l,
...
!(function (e) {
  ...
  !(function (t) {
    var r = (function (r) {
      function n(i, n, o) {
        ...
        if (
          ...
          (a.stencilState = !1),
          (a.$stencilList = []),
          (a.stencilHandleCount = 0),
          (a.$scissorState = !1),
          (a.scissorRect = new e.Rectangle()),
          (a.$hasScissor = !1),
          (a.dirtyRegionPolicy = !0),
          (a._dirtyRegionPolicy = !0),
          (a.$drawCalls = 0),
          (a.$computeDrawCall = !1),
          (a.globalMatrix = new e.Matrix()),
          (a.savedGlobalMatrix = new e.Matrix()),
          (a.context = t.WebGLRenderContext.getInstance(i, n)),
          (a.rootRenderTarget = new t.WebGLRenderTarget(
            a.context.context,
            3,
            3,
          )),
          ...
          (a.context.pushBuffer(a), (a.surface = a.context.surface));
        else {
          var s = a.context.activatedBuffer;
          (s && s.rootRenderTarget.activate(),
            (a.surface = a.rootRenderTarget));
        }
        return a;
      }
      return (
        ...
        (n.prototype.enableStencil = function () {
          this.stencilState ||
            (this.context.enableStencilTest(), (this.stencilState = !0));
        }),
        (n.prototype.disableStencil = function () {
          this.stencilState &&
            (this.context.disableStencilTest(), (this.stencilState = !1));
        }),
        ...
        (n.prototype.resize = function (e, t, r) {
          (this.context.pushBuffer(this),
            (e = e || 1),
            (t = t || 1),
            (e != this.rootRenderTarget.width ||
              t != this.rootRenderTarget.height) &&
        ...
        (n.prototype.beginClip = function (e, t, r) {
          ...
          if (
            ...
            0 == e[0].minX &&
            0 == e[0].minY &&
            e[0].width == this.rootRenderTarget.width &&
            e[0].height == this.rootRenderTarget.height
          )
            return (
              (this.maskPushed = !1),
              this.rootRenderTarget.useFrameBuffer && this.context.clear(),
              void this.context.popBuffer()
            );
          for (var o = 0; i > o; o++) {
            var a = e[o];
          ...
          if (i > 0) {
            if (this.$hasScissor || 1 != i) this.scissorEnabled = !1;
              ...
              var s = a.minX + t,
                ...
                h = a.width,
                u = a.height;
              (this.context.enableScissor(s, -l - u + this.height, h, u),
                (this.scissorEnabled = !0));
            }
            (e.length > 0
              ? (this.context.pushMask(e), (this.maskPushed = !0))
              : (this.maskPushed = !1),
              (this.offsetX = t),
              (this.offsetY = r));
        ...
        (n.prototype.endClip = function () {
          (this.maskPushed || this.scissorEnabled) &&
            (this.context.pushBuffer(this),
            this.maskPushed &&
        ...
        (n.prototype.getPixels = function (e, t, r, i) {
          ...
          for (var a = new Uint8Array(4 * r * i), s = 0; i > s; s++)
            for (var l = 0; r > l; l++)
              ((a[4 * (r * (i - s - 1) + l)] = n[4 * (r * s + l)]),
                (a[4 * (r * (i - s - 1) + l) + 1] = n[4 * (r * s + l) + 1]),
                (a[4 * (r * (i - s - 1) + l) + 2] = n[4 * (r * s + l) + 2]),
                (a[4 * (r * (i - s - 1) + l) + 3] = n[4 * (r * s + l) + 3]));
          return a;
        }),
        ...
        (n.prototype.onRenderFinish = function () {
          ((this.$drawCalls = 0),
            this.root &&
              (!this._dirtyRegionPolicy &&
                this.dirtyRegionPolicy &&
                this.drawSurfaceToFrameBuffer(
                  0,
                  0,
                  this.rootRenderTarget.width,
                  this.rootRenderTarget.height,
                  0,
                  0,
                  this.rootRenderTarget.width,
                  this.rootRenderTarget.height,
        ...
        (n.prototype.drawFrameBufferToSurface = function (
          e,
          t,
          r,
          i,
        ...
        (n.prototype.drawSurfaceToFrameBuffer = function (
          e,
          t,
          r,
          i,
    ...
    ((r.autoClear = !0),
      ...
      __reflect(r.prototype, "egret.web.WebGLRenderBuffer", [
        "egret.sys.RenderBuffer",
      ]));
    var i = [];
  })((t = e.web || (e.web = {})));
