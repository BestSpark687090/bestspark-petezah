      ...
      return (
        ...
        (r.prototype.$intersectInPlace = function (t) {
          ...
          if (s >= o) {
            ...
            if (h >= a) return (this.setTo(o, a, s - o, h - a), this);
          }
          return (this.setEmpty(), this);
        }),
        (r.prototype.intersects = function (t) {
          return (
            Math.max(this.x, t.x) <= Math.min(this.right, t.right) &&
            Math.max(this.y, t.y) <= Math.min(this.bottom, t.bottom)
          );
        }),
        ...
        (r.prototype.union = function (t) {
          ...
          return (
            e.setTo(
              i,
              r,
              Math.max(e.right, t.right) - i,
              Math.max(e.bottom, t.bottom) - r,
            ),
            e
          );
        }),
...
!(function (t) {
    ...
    i = (function (i) {
      ...
      return (
        ...
        (r.prototype.$insertEventBin = function (t, e, i, r, n, o, s) {
          ...
          return (-1 !== a ? t.splice(a, 0, c) : t.push(c), !0);
        }),
        ...
        (r.prototype.dispatchEvent = function (t) {
          return (
            (t.$currentTarget = this.$EventDispatcher[0]),
        ...
        (r.prototype.$notifyListener = function (t, i) {
          ...
          for (var h = 0; s > h; h++) {
            var l = o[h];
            if (
              (l.listener.call(l.thisObject, t),
  ...
  ((t.EventDispatcher = i),
    __reflect(i.prototype, "egret.EventDispatcher", [
  ...
  var i = (function (i) {
    ...
    return (
      ...
      (r.prototype.$getMatrix = function () {
        ...
        return (
          this.$hasFlags(8) &&
            (t[6].$updateScaleAndRotation(t[0], t[1], t[2], t[3]),
            this.$removeFlags(8)),
          t[6]
        );
      }),
        ...
        if (this.$hasFlags(16)) {
          this.$parent
            ? this.$parent
                ...
                .$preMultiplyInto(this.$getMatrix(), e)
            : e.copyFrom(this.$getMatrix());
          ...
          (o
            ? e.$preMultiplyInto(
                t.$TempMatrix.setTo(1, 0, 0, 1, -o.x - r, -o.y - n),
                e,
              )
            : (0 != r || 0 != n) &&
              e.$preMultiplyInto(t.$TempMatrix.setTo(1, 0, 0, 1, -r, -n), e),
      ...
      (r.prototype.$getInvertedConcatenatedMatrix = function () {
        ...
        return (
          this.$hasFlags(32) &&
            (this.$getConcatenatedMatrix().$invertInto(t[8]),
            this.$removeFlags(32)),
          t[8]
        );
      }),
      ...
      (r.prototype.$setScaleY = function (t) {
        return (
          (t = +t || 0),
          t == this.$DisplayObject[1]
            ? !1
            : ((this.$DisplayObject[1] = t), this.$invalidateMatrix(), !0)
        );
      }),
      ...
      (r.prototype.$getWidth = function () {
        return isNaN(this.$getExplicitWidth())
          ? this.$getOriginalBounds().width
          : this.$getExplicitWidth();
      }),
      ...
      (r.prototype.$setWidth = function (t) {
        return (
          (this.$DisplayObject[14] = isNaN(t) ? 0 / 0 : t),
          (t = +t),
          0 > t ? !1 : (this.$invalidateMatrix(), !0)
        );
      }),
      ...
      (r.prototype.$getHeight = function () {
        return isNaN(this.$getExplicitHeight())
          ? this.$getOriginalBounds().height
          : this.$getExplicitHeight();
      }),
      ...
      (r.prototype.$setHeight = function (t) {
        return (
          (this.$DisplayObject[15] = isNaN(t) ? 0 / 0 : t),
          (t = +t),
          0 > t ? !1 : (this.$invalidateMatrix(), !0)
        );
      }),
      ...
      (r.prototype.$setAnchorOffsetX = function (t) {
        return (
          (t = +t || 0),
          t == this.$DisplayObject[12]
            ? !1
            : ((this.$DisplayObject[12] = t), this.$invalidatePosition(), !0)
        );
      }),
      ...
      (r.prototype.$setAnchorOffsetY = function (t) {
        return (
          (t = +t || 0),
          t == this.$DisplayObject[13]
            ? !1
            : ((this.$DisplayObject[13] = t), this.$invalidatePosition(), !0)
        );
      }),
      ...
      (r.prototype.$setScrollRect = function (e) {
        return e || this.$scrollRect
          ? (e
              ? (this.$scrollRect || (this.$scrollRect = new t.Rectangle()),
                this.$scrollRect.copyFrom(e))
      ...
      Object.defineProperty(r.prototype, "blendMode", {
        ...
        set: function (e) {
          ...
          i != this.$blendMode &&
            ((this.$blendMode = i), this.$invalidateTransform());
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (r.prototype.$setMaskRect = function (e) {
        return e || this.$maskRect
          ? (e
              ? (this.$maskRect || (this.$maskRect = new t.Rectangle()),
                this.$maskRect.copyFrom(e))
              : (this.$maskRect = null),
            this.$invalidatePosition(),
            !0)
          : !1;
      ...
      Object.defineProperty(r.prototype, "filters", {
        ...
        set: function (t) {
          ...
          if (
            ...
            for (var i = e.length, r = 0; i > r; r++) e[r].$removeTarget(this);
          if (((this.$DisplayObject[20] = t), t && t.length))
            for (var n = t.length, r = 0; n > r; r++) t[r].$addTarget(this);
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      (r.prototype.$update = function (e, i) {
        ...
        if (e == t.DirtyRegionPolicy.OFF) {
          ...
          var s = r.$displayList || r.$parentDisplayList,
            u = n.renderRegion;
          if (!s) return (u.setTo(0, 0, 0, 0), (n.moved = !1), !1);
          if (!n.moved) return !1;
          n.moved = !1;
          var a = n.renderMatrix;
          a.copyFrom(o);
      ...
      (r.prototype.$measureFiltersOffset = function () {
        ...
        if (e && e.length) {
          for (
            var i = e.length, r = 0, n = 0, o = 0, s = 0, a = 0;
            i > a;
            a++
          ) {
            var h = e[a];
            if ("blur" == h.type) {
              ...
              var c = h.distance || 0,
                ...
                f = 0;
              0 != c &&
                ((d = Math.ceil(c * t.NumberUtils.cos(p))),
                (f = Math.ceil(c * t.NumberUtils.sin(p))),
                d > 0 ? (o += d) : 0 > d && ((r += d), (o -= d)),
                f > 0 ? (s += f) : 0 > f && ((n += f), (s -= f)));
            }
          }
          return { minX: r, minY: n, maxX: o, maxY: s };
        }
        return null;
      }),
      ...
      (r.prototype.$hitTest = function (t, e) {
        ...
        if (n.contains(o, s)) {
          if (!this.$children) {
            ...
            if (a && !a.contains(o, s)) return null;
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.$propagateFlagsDown = function (t, e) {
        if (
          (void 0 === e && (e = !1),
          !this.$hasFlags(t) && (this.$setFlags(t), !e || !this.$displayList))
        )
      ...
      (i.prototype.addChildAt = function (t, e) {
        return (
          (e = 0 | +e),
          (0 > e || e >= this.$children.length) &&
            ((e = this.$children.length), t.$parent == this && e--),
          this.$doAddChild(t, e)
        );
      }),
      (i.prototype.$doAddChild = function (e, r, n) {
        ...
        var s = this.$stage;
        if (
          (s && e.$onAddToStage(s, this.$nestLevel + 1),
        ...
        return (
          this.assignParentDisplayList(e, l, l),
      ...
      (i.prototype.$doRemoveChild = function (e, r) {
        ...
        (this.assignParentDisplayList(o, h, null),
          ...
          o.$setParent(null));
        var l = n.indexOf(o);
        return (-1 != l && n.splice(l, 1), this.$propagateFlagsUp(4), o);
      }),
      ...
      (i.prototype.$measureChildBounds = function (e) {
        ...
        if (0 != r) {
          for (var n = 0, o = 0, s = 0, a = 0, h = !1, l = -1; r > l; l++) {
            var u =
              -1 == l ? e : i[l].$getTransformedBounds(this, t.$TempRectangle);
            u.isEmpty() ||
              (h
                ? ((n = Math.min(n, u.x)),
      ...
      (i.prototype.$hitTest = function (t, i) {
        ...
        if (s && !s.contains(n, o)) return null;
        if (this.$mask && !this.$mask.$hitTest(t, i)) return null;
        for (
          var a = this.$children, h = !1, l = null, u = a.length - 1;
          u >= 0;
          u--
        ) {
          var c = a[u];
        ...
        return l
          ...
          : h
            ? this
            : e.prototype.$hitTest.call(this, t, i);
      }),
...
!(function (t) {
  var e = (function (t) {
    function e() {
      ...
      return ((e.type = null), (e.$targets = []), e);
    }
    return (
      __extends(e, t),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.$setBitmapData = function (e) {
        ...
        if (((i[0] = e), !e))
          return (
            r && t.BitmapData.$removeDisplayObject(this, r),
        ...
        if ((this.$refreshImageData(), this.$stage)) {
          if (r) {
            var n = void 0;
            n =
              r._bitmapData && r._bitmapData.hashCode
                ? r._bitmapData.hashCode
                : r.hashCode;
            var o = void 0;
            if (
              ((o =
                e._bitmapData && e._bitmapData.hashCode
                  ? e._bitmapData.hashCode
                  : e.hashCode),
              n == o)
            )
      ...
      (i.prototype.$setWidth = function (t) {
        ...
        return 0 > t || t == e[11]
          ? !1
          : ((e[11] = t), this.$invalidateContentBounds(), !0);
      }),
      (i.prototype.$setHeight = function (t) {
        var e = this.$Bitmap;
        return 0 > t || t == e[12]
          ? !1
          : ((e[12] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$render = function () {
        ...
        if (e[1]) {
          ...
          t.sys.BitmapNode.$updateTextureData(
            ...
            e[13],
            e[14],
            this.scale9Grid || e[0].scale9Grid,
            this.fillMode,
            e[10],
          );
        }
      ...
      (i.prototype.hitTestPixel = function (e, i) {
        var r,
          n = this.$getInvertedConcatenatedMatrix(),
          o = n.a * e + n.c * i + n.tx,
          s = n.b * e + n.d * i + n.ty,
          a = this.$displayList;
        if (a) {
      ...
      (i.$drawImage = function (
        ...
        (console.warn(
          "deprecated method : Bitmap.$drawImage,use egret.sys.BitmapNode.$drawImage instead of it",
        ),
          t.sys.BitmapNode.$updateTextureData(
            e,
            i,
    ...
    return (
      ...
      (i.prototype.$hitTest = function (e, i) {
        ...
        return l
          ...
          : h
            ? this
            : ((l = t.DisplayObject.prototype.$hitTest.call(this, e, i)),
    ...
    r = (function (r) {
      ...
      return (
        ...
        (n.polar = function (e, r) {
          return new n(
            e * t.NumberUtils.cos(r / i),
            e * t.NumberUtils.sin(r / i),
          );
        }),
    ...
    var e = (function () {
      ...
      return (
        ...
        (t.prototype.drawRoundRect = function (t, e, i, r, n, o) {
          var s = (0.5 * n) | 0,
            a = o ? (0.5 * o) | 0 : s;
          if (!s || !a) return void this.drawRect(t, e, i, r);
          var h = 0.5 * i,
            l = 0.5 * r;
          if ((s > h && (s = h), a > l && (a = l), h === s && l === a))
            return void (s === a
              ? this.drawCircle(t + s, e + a, s)
              : this.drawEllipse(t, e, 2 * s, 2 * a));
          var u = t + i,
            c = e + r,
            p = t + s,
            d = u - s,
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.createTexture = function (e, i, r, n, o, s, a, h, l) {
        ...
        var u = new t.Texture();
        return (
          (u._bitmapData = this.$texture._bitmapData),
          u.$initData(
            this._bitmapX + i,
            this._bitmapY + r,
            n,
            ...
            h,
            l,
            this.$texture._sourceWidth,
            this.$texture._sourceHeight,
          ),
...
!(function (t) {
  var e = (function () {
    function e() {}
    return (
      (e.compileProgram = function (i, r, n) {
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.dispatchProgressEvent = function (e, r, n, o) {
        ...
        ((s.bytesLoaded = n), (s.bytesTotal = o));
    ...
    return (
      ...
      (i.create = function (e, r) {
        if (t.Capabilities.runtimeType === t.RuntimeType.WEB) {
          ...
          var o = new Image();
          return ((o.src = "data:image/png;base64," + n), new i(o));
        }
        var s = null;
      ...
      (i.prototype.$dispose = function () {
        (t.Capabilities.runtimeType == t.RuntimeType.WEB &&
          "webgl" == t.Capabilities.renderMode &&
          this.webGLTexture &&
          (t.WebGLUtils.deleteWebGLTexture(this.webGLTexture),
    ...
    i = (function (i) {
      ...
      return (
        ...
        (r.dispatchTouchEvent = function (e, i, n, o, s, a, h, l) {
          if ((void 0 === l && (l = !1), !n && !e.hasEventListener(i)))
            return !0;
          var u = t.Event.create(r, i, n, o);
          (u.$initTo(s, a, h), (u.touchDown = l));
...
!(function (t) {
  var e = (function (t) {
    function e(e, i, r, n, o, s, a, h, l, u, c) {
      ...
      return ((p.$distance = e), (p.$angle = i), (p.$hideObject = c), p);
    }
    return (
      __extends(e, t),
    ...
    return (
      ...
      (r.prototype.beginFill = function (t, e) {
        (void 0 === e && (e = 1),
          ...
          this.$renderNode.drawData.length > 1 &&
      ...
      (r.prototype.lineStyle = function (t, e, i, r, n, o, s, a) {
        (void 0 === t && (t = 0 / 0),
          ...
          (t = +t || 0),
          0 >= t
            ? ((this.strokePath = null), this.setStrokeWidth(0))
            : ((e = +e || 0),
              (i = +i || 0),
              (a = +a || 0),
      ...
      (r.prototype.drawEllipse = function (t, e, i, r) {
        ...
        (n && n.drawEllipse(t, e, i, r),
          ...
          this.extendBoundsByPoint(t, e),
          this.extendBoundsByPoint(t + i, e + r),
          this.updatePosition(t + i, e + 0.5 * r),
          (this.$renderNode.dirtyRender = !0));
      }),
    ...
    o = (function (o) {
      ...
      return (
        ...
        (s.prototype.scale = function (t, e) {
          (1 !== t && ((this.a *= t), (this.c *= t), (this.tx *= t)),
            1 !== e && ((this.b *= e), (this.d *= e), (this.ty *= e)));
        }),
        ...
        (s.prototype.$updateScaleAndRotation = function (e, n, o, s) {
          if (!((0 != o && o != i) || (0 != s && s != i)))
            return ((this.a = e), (this.b = this.c = 0), void (this.d = n));
          ((o /= r), (s /= r));
          var a = t.NumberUtils.cos(o),
            h = t.NumberUtils.sin(o);
          (o == s
            ? ((this.a = a * e), (this.b = h * e))
            : ((this.a = t.NumberUtils.cos(s) * e),
...
!(function (t) {
  ...
  ((e[1001] = "Could not find Egret entry class: {0}。"),
    ...
    (e[1040] =
      "hitTestPoint can not detect crossOrigin images! Please check if the display object has crossOrigin elements."),
    ...
    (e[4e3] =
      "An Bone cannot be added as a child to itself or one of its children (or children's children, etc.)"),
...
!(function (t) {
  var e = (function () {
    ...
    return (
      (e.create = function () {
        return e.promiseObjectList.length
          ? e.promiseObjectList.pop()
          : new t.PromiseObject();
      }),
      (e.prototype.onSuccess = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        (this.onSuccessFunc &&
          this.onSuccessFunc.apply(this.onSuccessThisObject, t),
          this.destroy());
      }),
      ...
      (e.prototype.downloadingSize = function () {
        ...
        this.downloadingSizeFunc &&
          this.downloadingSizeFunc.apply(this.downloadingSizeThisObject, t);
      }),
      (e.prototype.onResponseHeader = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        this.onResponseHeaderFunc &&
          this.onResponseHeaderFunc.apply(this.onResponseHeaderThisObject, t);
      }),
      ...
      return (
        ...
        (r.prototype.addRegion = function (i) {
          ...
          var a = this.dirtyList,
            h = e.Region.create();
          return (
            a.push(h.setTo(r, n, o, s)),
            this.$dirtyRegionPolicy != t.DirtyRegionPolicy.OFF &&
              this.mergeDirtyList(a),
            !0
          );
        }),
        (r.prototype.clear = function () {
        ...
        (r.prototype.getDirtyRegions = function () {
          ...
          if (o > 0) for (var s = 0; o > s; s++) this.dirtyList[s].intValues();
        ...
        (r.prototype.mergeDirtyList = function (t) {
          ...
          if (2 > r) return !1;
          for (
            var n = this.hasClipRect,
              o = r > 3 ? Number.POSITIVE_INFINITY : 0,
              s = 0,
              a = 0,
              h = 0,
              l = 0;
          ...
          if (
            (n && h / this.clipArea > 0.95 && (this.clipRectChanged = !0),
            s != a)
          ) {
            var f = t[a];
            return (t[s].union(f), e.Region.release(f), t.splice(a, 1), !0);
          }
          return !1;
        }),
...
!(function (t) {
  ...
  !(function (e) {
      ...
      return (
        ...
        (r.prototype.$update = function (e) {
          ...
          if (e == t.DirtyRegionPolicy.OFF) {
            ...
            if ((this.needUpdateRegions && this.updateDirtyRegions(), !o))
              return !1;
            ...
            var h = i.$getOriginalBounds(),
              ...
              l = r.renderRegion;
            if ((this.needUpdateRegions && this.updateDirtyRegions(), !o))
              return (l.setTo(0, 0, 0, 0), (r.moved = !1), !1);
            if (!r.moved) return !1;
            r.moved = !1;
            var s = r.renderMatrix;
            s.copyFrom(n);
        ...
        (r.prototype.updateDirtyRegions = function () {
          ...
          for (var i = this.dirtyRegion, r = e.length, n = 0; r > n; n++) {
            var o = e[n],
              s = o.$getRenderNode();
            if (s)
              if (((s.needRedraw = !1), this.isStage)) {
                s.renderAlpha > 0 &&
                  s.renderVisible &&
                  i.addRegion(s.renderRegion) &&
                  (s.needRedraw = !0);
          ...
          if (r && r.length > 0) {
            ...
            if (
              ...
              var a = o.width,
                h = o.height;
              (this.bitmapData
                ? ((this.bitmapData.source = o),
                  (this.bitmapData.width = a),
                  (this.bitmapData.height = h))
                : (this.bitmapData = new t.BitmapData(o)),
        ...
        (r.prototype.changeSurfaceSize = function () {
          ...
          (this.offsetX != t ||
            ...
            r.surface.height != o) &&
            (this.sizeChanged
              ? r.resizeTo(n, o, this.offsetX - t, this.offsetY - e)
              : ((this.sizeChanged = !0), r.resize(n, o)));
        }),
        (r.prototype.setDirtyRegionPolicy = function (t) {
          ((this.$dirtyRegionPolicy = t),
    ...
    ((e.DisplayList = i),
      __reflect(i.prototype, "egret.sys.DisplayList", [
        "egret.sys.Renderable",
      ]));
  })((e = t.sys || (t.sys = {})));
})(egret || (egret = {}));
var egret;
...
!(function (t) {
  ...
  !(function (e) {
    function i(i, r, n, o) {
      if (
        (r &&
          (t.log = function () {
            for (var t = arguments.length, i = "", r = 0; t > r; r++)
              i += arguments[r] + " ";
            (e.$logToFPS(i), console.log.apply(console, s(arguments)));
          }),
        (l = o ? {} : o),
        (r = !!r),
        (this.showFPS = !!i),
        ...
        ((h = this.fps = new FPS(this.stage, i, r, n, o)),
          (h.x = a),
          (h.y = c));
        for (var p = u.length, d = 0; p > d; d++) h.updateInfo(u[d]);
        u = null;
      }
    }
    function r(t) {
      ((t = !!t),
        this._showPaintRect != t &&
          ((this._showPaintRect = t),
          t
            ? (this.stageDisplayList ||
                (this.stageDisplayList = e.DisplayList.create(this.stage)),
    ...
    var a = (function (s) {
      ...
      return (
        ...
        (a.prototype.start = function () {
          !this.isPlaying &&
            this.stage &&
            ((e.$TempStage = e.$TempStage || this.stage),
            (this.isPlaying = !0),
        ...
        (a.prototype.initialize = function () {
          ...
          if (
            (this.entryClassName &&
              (e = t.getDefinitionByName(this.entryClassName)),
            e)
          ) {
            var i = new e();
            ((this.root = i),
        ...
        (a.prototype.pause = function () {
          this.isPlaying &&
            ((this.isPlaying = !1), e.$ticker.$removePlayer(this));
        }),
        (a.prototype.$render = function (e, i) {
          ...
          if (e && this.showFPS) {
            var l = 0;
            if (a > 0) {
              for (var u = o.length, c = 0, p = 0; u > p; p++) c += o[p].area;
    ...
    ((e.Player = a), __reflect(a.prototype, "egret.sys.Player"));
    var h,
      l,
      u = [];
      ...
      (FPS = (function (i) {
        ...
        return (
          ...
          (r.prototype.update = function (i, r, n, o, s) {
            var a = t.getTimer();
            if (
              ((this.totalTime += a - this.lastTime),
              (this.lastTime = a),
              this.totalTick++,
              (this.drawCalls += i),
              (this.dirtyRatio += r),
              ...
              var h = Math.min(
                  Math.ceil((1e3 * this.totalTick) / this.totalTime),
                  e.$ticker.$frameRate,
                ),
...
!(function (t) {
  ...
  !(function (e) {
      ...
      return (
        ...
        (i.prototype.calculateStageSize = function (e, i, r, n, o) {
          ...
          return (
            s % 2 != 0 && (s += 1),
            a % 2 != 0 && (a += 1),
            { stageWidth: h, stageHeight: l, displayWidth: s, displayHeight: a }
          );
        }),
        i
      );
    ...
    ((e.DefaultScreenAdapter = i),
      __reflect(i.prototype, "egret.sys.DefaultScreenAdapter", [
      ...
      function i() {
        ((this.playerList = []),
          ...
          (this.lastCount = this.frameInterval =
            Math.round(6e4 / this.$frameRate)));
      }
      return (
        (i.prototype.$addPlayer = function (t) {
          -1 == this.playerList.indexOf(t) &&
          ...
          return (
            ...
            0 >= e
              ...
              : this.$frameRate == e
                ...
                : ((this.$frameRate = e),
                  e > 60 && (e = 60),
                  t.Capabilities.runtimeType == t.RuntimeType.NATIVE &&
                    (egret_native.setFrameRate(e), (e = 60)),
        ...
        (i.prototype.update = function () {
          ...
          for (var h = 0; o > h; h++) r[h].call(n[h], a) && (s = !0);
          var l = t.getTimer(),
            u = a - this.lastTimeStamp;
          if (((this.lastTimeStamp = a), u >= this.frameDeltaTime))
            this.lastCount = this.frameInterval;
          else {
            if (((this.lastCount -= 1e3), this.lastCount > 0))
        ...
        (i.prototype.render = function (t, i) {
          ...
          if (0 != n) {
            (this.callLaters(),
              e.$invalidateRenderFlag &&
                (this.broadcastRender(), (e.$invalidateRenderFlag = !1)));
            for (var o = 0; n > o; o++) r[o].$render(t, i);
            e.$requestRenderingFlag = !1;
          }
        }),
        ...
        (i.prototype.callLaters = function () {
          var e, i, r;
          if (
            (t.$callLaterFunctionList.length > 0 &&
              ((e = t.$callLaterFunctionList),
      ...
      return (
        ...
        (i.prototype.onTouchBegin = function (e, i, r) {
          if (!(this.useTouchesCount >= this.maxTouches)) {
            ...
            (null == this.touchDownTarget[r] &&
              ((this.touchDownTarget[r] = n), this.useTouchesCount++),
              t.TouchEvent.dispatchTouchEvent(
                n,
        ...
        (i.$updateTextureData = function (
          ...
          if (r) {
            ...
            if (
              ...
              i.$updateTextureDataWithScale9Grid(
                e,
                y,
                n,
                o,
              ...
              var x = Math.min(u, p),
                ...
                O = s * m,
                E = a * m;
              i.drawClipImage(e, m, n, o, O, E, h, l, x, _);
            } else
              for (var O = s * m, E = a * m, F = 0; p > F; F += u)
                for (var w = 0; d > w; w += c) {
                  var x = Math.min(p - F, u),
                    _ = Math.min(d - w, c);
                  i.drawClipImage(e, m, n, o, O, E, h, l, x, _, F, w);
                }
          }
        }),
        (i.$updateTextureDataWithScale9Grid = function (
          e,
          i,
          r,
          n,
          ...
          var T = r,
            ...
            w = F + b,
            C = f - $ - b,
            R = O * t.$TextureScaleFactor,
            S = C * t.$TextureScaleFactor;
          if (
            (v + O) * t.$TextureScaleFactor > c ||
            ($ + C) * t.$TextureScaleFactor > p
          )
          ...
          var P = a,
            ...
            I = p - y - S;
          ($ > 0 &&
            (v > 0 && e.drawImage(T, E, v, $, P, A, g, y),
            m > 0 && e.drawImage(x, E, m, $, D, A, M, y),
            O > 0 && e.drawImage(_, E, O, $, L, A, R, y)),
            b > 0 &&
              (v > 0 && e.drawImage(T, F, v, b, P, N, g, I),
              m > 0 && e.drawImage(x, F, m, b, D, N, M, I),
              O > 0 && e.drawImage(_, F, O, b, L, N, R, I)),
            C > 0 &&
              (v > 0 && e.drawImage(T, w, v, C, P, B, g, S),
              m > 0 && e.drawImage(x, w, m, C, D, B, M, S),
              O > 0 && e.drawImage(_, w, O, C, L, B, R, S)));
        }),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.drawToTexture = function (e, i, r) {
        if ((void 0 === r && (r = 1), i && (0 == i.width || 0 == i.height)))
          return !1;
...
!(function (t) {
  function e(t, e) {
    var i = null == e.italic ? t.italic : e.italic,
      ...
      s = i ? "italic " : "normal ";
    return ((s += r ? "bold " : "normal "), (s += n + "px " + o));
  }
  function i(t, e) {
    var i = t >> 16,
      r = (t >> 8) & 255,
  ...
  function r(e, r, n, o, s, a) {
    var h;
    h =
      r == t.GradientType.LINEAR
        ? e.createLinearGradient(-1, 0, 1, 0)
        : e.createRadialGradient(0, 0, 0, 0, 0, 1);
  ...
  function o(t, e, i, r) {
    for (
      ...
      var F = t[O + 0],
        ...
        C = t[O + 2],
        R = t[O + 3];
      ((t[O + 0] = n * F + o * w + s * C + a * R + h),
        (t[O + 1] = l * F + u * w + c * C + p * R + d),
        (t[O + 2] = f * F + g * w + y * C + v * R + $),
        (t[O + 3] = m * F + b * w + T * C + x * R + _));
    }
  }
  ...
  function a(t, e, i, r) {
    ...
    for (var s = 4 * e, a = 2 * r + 1, h = 0; i > h; h++) {
      ...
      for (
        var y = l, v = l + s, m = 0, b = y - 4 * r, T = y + 4 * (r + 1);
        v > y;
        y += 4, m += 4, T += 4, b += 4
      )
        (0 === d
  ...
  function h(t, e, i, r) {
    ...
    for (var o = 4 * e, s = 2 * r + 1, a = 0; e > a; a++) {
      ...
      for (
        var g = h, y = h + i * o, $ = 0, m = h - r * o, b = h + (r + 1) * o;
        y > g;
        g += o, $ += 4, b += o, m += o
      )
        (0 === p
          ...
          d || 0 == d
            ...
            : (f || 0 == f) &&
              ...
              (c += -t[m + 2] * f),
              (p += -f)));
      for (var T = 4 * a, y = T + i * o, x = 0; y > T; T += o, x += 4)
        ((t[T + 0] = n[x + 0]),
          (t[T + 1] = n[x + 1]),
          (t[T + 2] = n[x + 2]),
          (t[T + 3] = n[x + 3]));
  ...
  function u(t, e) {
    ...
    for (var r = 0, o = i.length; o > r; r += 4) {
      var s = i[r + 3];
      ((i[r + 0] = e[0] * s), (i[r + 1] = e[1] * s), (i[r + 2] = e[2] * s));
    }
    return i;
  }
  function c(t, e, i, r, o) {
    var s,
      ...
      l = (Math.cos(r) * o) | 0;
    if (_) {
      ((s = new Int32Array(t.buffer)), (a = new Int32Array(s.length)));
      for (var u = 0; i > u; u++) {
        var c = u + h;
        if (!(0 > c || c > i))
          for (var p = 0; e > p; p++) {
  ...
  var y = ["source-over", "lighter", "destination-out"],
    v = "source-over",
    $ = "#000000",
    m = { none: "butt", square: "square", round: "round" },
    b = [],
    T = [],
    x = (function () {
      function n() {
      ...
      return (
        (n.prototype.render = function (t, e, i, r, n) {
          this.nestLevel++;
          var o = e.context,
            s = n ? t : null,
          ...
          if ((this.nestLevel--, 0 === this.nestLevel)) {
            ...
            for (var h = b.length, l = 0; h > l; l++) b[l].resize(0, 0);
            T.length > 1 && ((T.length = 1), T[0].resize(0, 0));
          }
          return a;
        }),
        (n.prototype.drawDisplayObject = function (e, i, r, n, o, s, a) {
          ...
          if (
            (o && !a
              ? (o.isDirty && (l += o.drawToSurface()), (h = o.$renderNode))
              : (h = e.$getRenderNode()),
            h)
          ) {
            if (r) {
            ...
            if (h.needRedraw) {
              var d = void 0,
                f = void 0;
              (a
                ? ((d = e.$getConcatenatedAlphaAt(
                    a,
                    e.$getConcatenatedAlpha(),
                  )),
          ...
          if (g)
            for (var y = g.length, v = 0; y > v; v++) {
              ...
              if (!(!$.$visible || $.$alpha <= 0 || $.$maskedObject)) {
                var m = $.$getFilters();
                m && m.length > 0
                  ? (l += this.drawWithFilter($, i, r, n, s, a))
                  : 0 !== $.$blendMode ||
                      ($.$mask && ($.$mask.$parentDisplayList || a))
                    ? (l += this.drawWithClip($, i, r, n, s, a))
                    : $.$scrollRect || $.$maskRect
                      ? (l += this.drawWithScrollRect($, i, r, n, s, a))
                      : $.isFPS
        ...
        (n.prototype.drawWithFilter = function (e, i, r, n, a, h) {
          if (t.Capabilities.runtimeType == t.RuntimeType.NATIVE) {
            var u,
              ...
              d = 0 !== e.$blendMode;
            if (
              (d && ((u = y[e.$blendMode]), u || (u = v)),
              1 == p.length && "colorTransform" == p[0].type && !e.$children)
            )
              return (
                d && (i.globalCompositeOperation = u),
                i.setGlobalShader(p[0]),
                (c +=
                  e.$mask && (e.$mask.$parentDisplayList || h)
                    ? this.drawWithClip(e, i, r, n, a, h)
                    : e.$scrollRect || e.$maskRect
                      ? this.drawWithScrollRect(e, i, r, n, a, h)
                      : this.drawDisplayObject(
                          e,
                          i,
                          r,
            ...
            $.updateRegion(m, f);
            var x = this.createRenderBuffer($.width, $.height);
            x.context.setTransform(1, 0, 0, 1, -$.minX, -$.minY);
            var _ = t.Matrix.create().setTo(1, 0, 0, 1, -$.minX, -$.minY);
            return (
              (c +=
                e.$mask && (e.$mask.$parentDisplayList || h)
                  ? this.drawWithClip(e, x.context, r, _, $, h)
                  : e.$scrollRect || e.$maskRect
                    ? this.drawWithScrollRect(e, x.context, r, _, $, h)
                    : this.drawDisplayObject(
                        e,
                        x.context,
                        r,
          ...
          var O,
            ...
            w = F.length,
            C = 0 !== e.$blendMode;
          C && ((O = y[e.$blendMode]), O || (O = v));
          var R = t.Matrix.create();
          (R.copyFrom(e.$getConcatenatedMatrix()),
            h && e.$getConcatenatedMatrixAt(h, R));
          var S;
          S = t.sys.Region.create();
          var P = e.$getOriginalBounds();
          S.updateRegion(P, R);
          var D = this.createRenderBuffer(S.width, S.height, !0),
            L = D.context;
          ...
          if (
            ((E +=
              e.$mask && (e.$mask.$parentDisplayList || h)
                ? this.drawWithClip(e, L, r, M, S, h)
                : e.$scrollRect || e.$maskRect
                  ? this.drawWithScrollRect(e, L, r, M, S, h)
                  : this.drawDisplayObject(e, L, r, M, e.$displayList, S, h)),
            t.Matrix.release(M),
            E > 0)
          ) {
            (C && (i.globalCompositeOperation = O),
              E++,
              (i.globalAlpha = 1),
              i.setTransform(1, 0, 0, 1, S.minX + n.tx, S.minY + n.ty));
            for (
              var A = L.getImageData(0, 0, D.surface.width, D.surface.height),
                N = 0;
              w > N;
              N++
            ) {
              var B = F[N];
              if ("colorTransform" == B.type)
                o(A.data, D.surface.width, D.surface.height, B.$matrix);
              else if ("blur" == B.type)
                s(
                  A.data,
                  D.surface.width,
                ...
                var I = B.$red,
                  ...
                  k = B.$blue,
                  U = B.$alpha;
                B.$inner || B.$knockout || B.$hideObject
                  ? g(
                      A.data,
                      D.surface.width,
                      D.surface.height,
            ...
            (L.putImageData(A, 0, 0),
              i.drawImage(D.surface, 0, 0),
              C && (i.globalCompositeOperation = v));
          }
          return (T.push(D), t.sys.Region.release(S), t.Matrix.release(R), E);
        }),
        (n.prototype.drawWithClip = function (e, i, r, n, o, s) {
          var a,
            h = 0,
            l = 0 !== e.$blendMode;
          l && ((a = y[e.$blendMode]), a || (a = v));
          var u,
            c = e.$scrollRect ? e.$scrollRect : e.$maskRect,
            p = e.$mask;
          ...
          var f,
            g = t.Matrix.create();
          if ((g.copyFrom(e.$getConcatenatedMatrix()), e.$parentDisplayList)) {
          ...
          var x;
          if (
            (c && ((x = t.sys.Region.create()), x.updateRegion(c, g)),
            x && f
              ? (x.intersect(f), t.sys.Region.release(f))
              : !x && f && (x = f),
            x)
          ) {
            if (x.isEmpty() || (o && !o.intersects(x)))
              return (t.sys.Region.release(x), t.Matrix.release(g), h);
          } else
          ...
          var _ = !1;
          if (r) {
            for (var O = r.length, E = 0; O > E; E++)
              if (x.intersects(r[E])) {
                _ = !0;
                break;
              }
          } else _ = !0;
          if (!_) return (t.sys.Region.release(x), t.Matrix.release(g), h);
          ...
          if (
            ...
            return (
              (F += this.drawDisplayObject(e, i, r, n, e.$displayList, o, s)),
              i.restore(),
              F
            );
          }
          ...
          if (
            ((h += this.drawDisplayObject(e, C, r, R, e.$displayList, x, s)), p)
          )
            if (
              (t.Capabilities.$runtimeType == t.RuntimeType.WEB &&
                u &&
          ...
          if ((t.Matrix.release(R), h > 0)) {
            if ((h++, l && (i.globalCompositeOperation = a), c)) {
              var T = g;
              (i.save(),
                i.setTransform(
                  T.a,
          ...
          return (b.push(w), t.sys.Region.release(x), t.Matrix.release(g), h);
        }),
        (n.prototype.drawWithScrollRect = function (e, i, r, n, o, s) {
          ...
          if ((l.copyFrom(e.$getConcatenatedMatrix()), s))
          ...
          if ((c.updateRegion(h, l), c.isEmpty() || (o && !o.intersects(c))))
            return (t.sys.Region.release(c), t.Matrix.release(l), a);
          var p = !1;
          if (r) {
          ...
          return p
            ? (i.save(),
              ...
              t.Matrix.release(l),
              a)
            : (t.sys.Region.release(c), t.Matrix.release(l), a);
        }),
        ...
        (n.prototype.renderMesh = function (e, i) {
          ...
          for (
            a &&
            (i.saveTransform(), i.transform(a.a, a.b, a.c, a.d, a.tx, a.ty));
            o > s;
        ...
        (n.prototype.renderText = function (i, r) {
          ...
          for (var n = i.drawData, o = n.length, s = 0; o > s; ) {
            ...
            ((r.fillStyle = t.toColorString(c)),
              ...
              d && ((r.lineWidth = 2 * d), r.strokeText(l, a, h)),
              r.fillText(l, a, h));
          }
        }),
        ...
        (n.prototype.renderPath = function (t, e) {
          e.beginPath();
          for (
            var i = t.$data, r = t.$commands, n = r.length, o = 0, s = 0;
            n > s;
            s++
          ) {
            var a = r[s];
        ...
        (n.prototype.renderGroup = function (t, e) {
          var i = t.matrix,
            r = !1;
          i &&
            (e.saveTransform ? e.saveTransform() : e.save(),
            (r = !0),
          ...
          return (
            r && (e.restoreTransform ? e.restoreTransform() : e.restore()),
            n
          );
        }),
        (n.prototype.createRenderBuffer = function (e, i, r) {
          var n = r ? T.pop() : b.pop();
          return (
            n ? n.resize(e, i, !0) : (n = new t.sys.CanvasRenderBuffer(e, i)),
            n
          );
        }),
        n
  ...
  ((t.CanvasRenderer = x),
    __reflect(x.prototype, "egret.CanvasRenderer", [
...
((egret.Capabilities.$isMobile = testDeviceType()),
  (egret.Capabilities.$runtimeType = testRuntimeType()
    ? egret.RuntimeType.WEB
    : egret.RuntimeType.NATIVE));
var egret;
!(function (t) {
  ...
  var e = (function (t) {
    function e(e, i) {
      ...
      return (
        (r.firstCharHeight = 0),
        "string" == typeof i
          ? (r.charList = r.parseConfig(i))
          : i && i.hasOwnProperty("frames")
            ? (r.charList = i.frames)
            : (r.charList = {}),
        r
      );
    ...
    return (
      ...
      (e.prototype.parseConfig = function (t) {
        ...
        for (
          var e = t.split("\n"),
            i = this.getConfigByKey(e[3], "count"),
            r = {},
            n = 4;
          4 + i > n;
          n++
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.$setText = function (t) {
        ...
        return t == e[2]
          ? !1
          : ((e[2] = t), this.$invalidateContentBounds(), !0);
      }),
      (i.prototype.$getWidth = function () {
      ...
      (i.prototype.$setWidth = function (t) {
        ...
        return 0 > t || t == e[0]
          ? !1
          : ((e[0] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setHeight = function (t) {
        ...
        return 0 > t || t == e[1]
          ? !1
          : ((e[1] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setLineSpacing = function (t) {
        ...
        return e[3] == t
          ? !1
          : ((e[3] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setLetterSpacing = function (t) {
        ...
        return e[4] == t
          ? !1
          : ((e[4] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$setTextAlign = function (t) {
        ...
        return e[10] == t
          ? !1
          : ((e[10] = t), this.$invalidateContentBounds(), !0);
      }),
      ...
      (i.prototype.$render = function () {
        ...
        if (0 != n) {
          ...
          (s.$texture && (a.image = s.$texture._bitmapData),
            (a.smoothing = e[12]));
          for (
            var h = s._getFirstCharHeight(),
              l = Math.ceil(h * i.EMPTY_FACTOR),
              u = !isNaN(e[1]),
              c = e[8],
              p = e[0],
              d = e[1],
              f = e[10],
              g = this.$textOffsetY + this.$textStartY,
              y = this.$lineHeights,
              v = 0;
            n > v;
            v++
            ...
            if (f != t.HorizontalAlign.LEFT) {
              var x = p > c ? p : c;
              f == t.HorizontalAlign.RIGHT
                ? (T += x - o[v])
                : f == t.HorizontalAlign.CENTER &&
                  (T += Math.floor((x - o[v]) / 2));
            }
            for (var _ = 0; b > _; _++) {
              var O = m.charAt(_),
                E = s.getTexture(O);
              if (E) {
                var F = E._bitmapWidth,
                  w = E._bitmapHeight;
                ((a.imageWidth = E._sourceWidth),
                  (a.imageHeight = E._sourceHeight),
                  a.drawImage(
                    E._bitmapX,
                    E._bitmapY,
                    F,
                    ...
                    T + E._offsetX,
                    g + E._offsetY,
                    E.$getScaleBitmapWidth(),
                    E.$getScaleBitmapHeight(),
                  ),
                  (T +=
                    (s.getConfig(O, "xadvance") || E.$getTextureWidth()) +
                    e[4]));
      ...
      (i.prototype.$measureContentBounds = function (t) {
        ...
        0 == e.length
          ...
          : t.setTo(
              ...
              this.$BitmapText[8] - this.$textOffsetX,
              this.$BitmapText[9] - this.$textOffsetY,
            );
      }),
      ...
      (i.prototype.$getTextLines = function () {
        ...
        var s = [];
        if (((this.$lineHeights = s), !r[2] || !r[5])) return n;
        for (
          var a,
            h,
            l,
            ...
            m = r[1],
            b = r[5],
            T = b._getFirstCharHeight(),
            x = Math.ceil(T * i.EMPTY_FACTOR),
            _ = r[2],
            O = _.split(/(?:\r\n|\r|\n)/),
            E = O.length,
            F = !0,
          ...
          for (var S = 0; R > S; S++) {
            ...
            if (
              (a && ((a = !1), (g = Math.min(M, g))),
              F && ((F = !1), (y = Math.min(A, y))),
              v && S > 0 && u + D > $)
            ) {
        ...
        return (
          $ > d &&
            ((B = r[10]),
            B == t.HorizontalAlign.RIGHT
              ? (this.$textStartX = $ - d)
              : B == t.HorizontalAlign.CENTER &&
                (this.$textStartX = Math.floor(($ - d) / 2))),
          m > f &&
            ((B = r[11]),
            B == t.VerticalAlign.BOTTOM
              ? (this.$textStartY = m - f)
              : B == t.VerticalAlign.MIDDLE &&
                (this.$textStartY = Math.floor((m - f) / 2))),
          n
        );
      }),
      i
...
!(function (t) {
  var e = (function () {
    ...
    return (
      (e.prototype.initReplaceArr = function () {
        ((this.replaceArr = []),
        ...
        for (var i = 0, r = e.length; r > i; ) {
          ...
          if (0 > n) (this.addToResultArr(e.substring(i)), (i = r));
            ...
            (-1 == o
              ...
              : "/" == e.charAt(n + 1)
                ? this.stackArray.pop()
                : this.addToArray(e.substring(n + 1, o)),
              (i = o + 1));
          }
        }
      ...
      (e.prototype.addToResultArr = function (t) {
        "" != t &&
          ((t = this.replaceSpecial(t)),
          this.stackArray.length > 0
            ? this.resutlArr.push({
                text: t,
        ...
        if ("i" == t.charAt(0) || "b" == t.charAt(0) || "u" == t.charAt(0))
          ...
          for (var r = 0, n = void 0; (n = t.match(this.getHeadReg())); ) {
            ...
            ((t = t.substring(o.length).trim()),
              '"' == t.charAt(0)
                ? ((r = t.indexOf('"', 1)), (s = t.substring(1, r)), (r += 1))
                : "'" == t.charAt(0)
                  ? ((r = t.indexOf("'", 1)), (s = t.substring(1, r)), (r += 1))
                  : ((s = t.match(/(\S)+/)[0]), (r = s.length)),
              this.addProperty(
                e,
                o.substring(0, o.length - 1).trim(),
                s.trim(),
              ),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype._addStageText = function () {
        this.stageTextAdded ||
          (this._text.$inputEnabled || (this._text.$touchEnabled = !0),
      ...
      (i.prototype._removeStageText = function () {
        this.stageTextAdded &&
          (this._text.$inputEnabled || (this._text.$touchEnabled = !1),
      ...
      (i.prototype.focusHandler = function (e) {
        this._isFocus ||
          ...
          this._text.dispatchEvent(
            new t.FocusEvent(t.FocusEvent.FOCUS_IN, !0),
          ));
      }),
      (i.prototype.blurHandler = function (e) {
        this._isFocus &&
          ...
          this._text.dispatchEvent(
            new t.FocusEvent(t.FocusEvent.FOCUS_OUT, !0),
          ));
      }),
      ...
      (i.prototype._updateProperties = function () {
        if (this._isFocus)
          return (this.stageText.$resetStageText(), void this.updateInput());
  ...
  var i = new RegExp(
    ...
    r = (function (r) {
      function n() {
        ...
        return (
          (i.fontFamily = n.default_fontFamily),
          (e.textNode = i),
          (e.$renderNode = i),
          (e.$TextField = {
            0: n.default_size,
      ...
      return (
        ...
        (n.prototype.$setBold = function (t) {
          ...
          return t == e[15]
            ? !1
            : ((e[15] = t), this.invalidateFontString(), !0);
        }),
        ...
        (n.prototype.$setItalic = function (t) {
          ...
          return t == e[16]
            ? !1
            : ((e[16] = t), this.invalidateFontString(), !0);
        }),
        ...
        (n.prototype.$setVerticalAlign = function (t) {
          ...
          return e[10] == t
            ? !1
            : ((e[10] = t), this.$invalidateTextField(), !0);
        }),
        ...
        (n.prototype.$setType = function (e) {
          ...
          return i[24] != e
            ? ((i[24] = e),
              e == t.TextFieldType.INPUT
                ? (isNaN(i[3]) && this.$setWidth(100),
                  isNaN(i[4]) && this.$setHeight(30),
                  this.$setTouchEnabled(!0),
                  null == this.inputUtils &&
                    (this.inputUtils = new t.InputController()),
                  this.inputUtils.init(this),
                  this.$invalidateTextField(),
                  this.$stage && this.inputUtils._addStageText())
                : (this.inputUtils &&
        ...
        (n.prototype.$setText = function (t) {
          ...
          return (
            this.inputUtils && this.inputUtils._setText(this.$TextField[13]),
            e
          );
        }),
        ...
        (n.prototype.$setStroke = function (t) {
          return this.$TextField[27] != t
            ? (this.$invalidateTextField(), (this.$TextField[27] = t), !0)
            : !1;
        }),
        ...
        (n.prototype.$setMaxChars = function (t) {
          return this.$TextField[21] != t
            ? ((this.$TextField[21] = t), !0)
            : !1;
        }),
        ...
        Object.defineProperty(n.prototype, "maxScrollV", {
          get: function () {
            return (
              this.$getLinesArr(),
              Math.max(
                this.$TextField[29] - t.TextFieldUtils.$getScrollNum(this) + 1,
                1,
              )
            );
          },
          ...
          set: function (t) {
            ...
            if (null == t) ((e[35] = null), (e[36] = null));
              ...
              for (
                ...
                i++;
              0 == i
                ? ((e[35] = null), (e[36] = t.substring(i + 1)))
                : i > 0
                  ? ((e[35] = t.substring(0, i)), (e[36] = t.substring(i + 1)))
                  : ((e[35] = t), (e[36] = null));
            }
          },
          enumerable: !0,
            ...
            if (
              ...
              for (var a = r[2], h = -1, l = e.length, u = 0; l > u; u += 4) {
                var c = e[u],
                  ...
                  f = e[u + 3] || a;
                ((0 > h || h != f) &&
                  ((h = f), (s = i.lineStyle(2, f, 1, t.CapsStyle.NONE))),
                  s.moveTo(c, p),
                  s.lineTo(c + d, p));
              }
          }
        ...
        (n.prototype.setFocus = function () {
          this.type == t.TextFieldType.INPUT &&
            this.$stage &&
        ...
        (n.prototype.$onRemoveFromStage = function () {
          (r.prototype.$onRemoveFromStage.call(this),
            this.removeEvent(),
            this.$TextField[24] == t.TextFieldType.INPUT &&
              this.inputUtils._removeStageText(),
        ...
        (n.prototype.$getRenderBounds = function () {
          ...
          (i.copyFrom(e),
            this.$TextField[31] && ((i.width += 2), (i.height += 2)));
          var r = 2 * this.$TextField[27];
          return (
            r > 0 && ((i.width += 2 * r), (i.height += 2 * r)),
            (i.x -= r + 2),
            (i.y -= r + 2),
        ...
        (n.prototype.$measureContentBounds = function (e) {
          this.$getLinesArr();
          var i = isNaN(this.$TextField[3])
              ? this.$TextField[5]
              : this.$TextField[3],
            r = isNaN(this.$TextField[4])
        ...
        (n.prototype.$render = function () {
          if (this.$TextField[24] == t.TextFieldType.INPUT) {
            if (
              ((this.$hasAnyFlags(2032) || this.$hasAnyFlags(1648)) &&
        ...
        Object.defineProperty(n.prototype, "textFlow", {
          ...
          set: function (t) {
            ...
            this.$TextField[20]
              ? this.$setBaseText(e)
              : ((this.$TextField[13] = e), this.setMiddleStyle(t));
          },
          enumerable: !0,
          configurable: !0,
        }),
            ...
            if (f.text) {
              ...
              for (
                ...
                (null == a[c] &&
                  ...
                  (l = 0)),
                  (u =
                    r[24] == t.TextFieldType.INPUT
                      ? r[0]
                      : Math.max(u, f.style.size || r[0])));
                var m = !0;
                if ("" == y[v]) v == $ - 1 && (m = !1);
                else {
                  ...
                  if (isNaN(o))
                    ((h += b),
                      (l += y[v].length),
                      s.elements.push({ width: b, text: y[v], style: f.style }),
                      v == $ - 1 && (m = !1));
                  else if (o >= h + b)
                    (s.elements.push({ width: b, text: y[v], style: f.style }),
                      (h += b),
                    ...
                    for (var E = O.length, F = 0; E > T; T++) {
                      var w = O[T].length,
                        C = !1;
                      if (1 == w && E - 1 > T) {
                        var R = O[T].charCodeAt(0),
                          S = O[T + 1].charCodeAt(0);
                        if (R >= 55296 && 56319 >= R && 56320 == (64512 & S)) {
                          var P = O[T] + O[T + 1];
                          ((w = 2), (C = !0), (b = e(P, r, f.style)));
                        } else b = e(O[T], r, f.style);
                      } else b = e(O[T], r, f.style);
                      if (0 != h && h + b > o && h + T != 0) break;
                      if (x + b > o)
                        for (
                          var D = O[T].match(/./g), L = 0, M = D.length;
                          M > L;
                          L++
                        ) {
                          var w = D[L].length,
                          ...
                          if (1 == w && M - 1 > L) {
                            ...
                            if (
                              ...
                              var P = D[L] + D[L + 1];
                              ((w = 2), (A = !0), (b = e(P, r, f.style)));
                            } else b = e(D[L], r, f.style);
                          } else b = e(D[L], r, f.style);
                          if (L > 0 && h + b > o) break;
                          ((F += w), (x += b), (h += b), (l += F), A && L++);
                        }
                      else ((F += w), (x += b), (h += b), (l += F));
                      C && T++;
                    }
                    if (T > 0) {
                      s.elements.push({
        ...
        (n.prototype.drawText = function () {
          ...
          a = Math.round(a);
          for (
            var c = t.TextFieldUtils.$getHalign(this),
              p = 0,
              d = [],
              f = h,
              g = i[29];
            ...
            for (var $ = 0, m = y.elements.length; m > $; $++) {
              ...
              (e.drawText(p, a + (v - T) / 2, b.text, b.style),
                b.style.underline &&
                  d.push(p, a + v / 2, b.width, b.style.textColor),
                (p += b.width));
            }
            a += v / 2 + i[1];
          }
            ...
            if (null != i) {
              ...
              if (r && r.href)
                if (r.href.match(/^event:/)) {
                  ...
                  t.TextEvent.dispatchTextEvent(
                    this,
                    t.TextEvent.LINK,
                    r.href.substring(n.length),
                  );
    ...
    return (
      (e.$getStartLine = function (t) {
        ...
        return (
          isNaN(o) ||
            (o > r ||
              (r > o &&
                ((n = Math.max(i[28] - 1, 0)), (n = Math.min(i[29] - 1, n)))),
            i[30] ||
              ((n = Math.max(i[28] - 1, 0)),
      ...
      (e.$getHalign = function (e) {
        var i = e.$getLinesArr(),
          r = 0;
        return (
          e.$TextField[9] == t.HorizontalAlign.CENTER
            ? (r = 0.5)
            : e.$TextField[9] == t.HorizontalAlign.RIGHT && (r = 1),
          e.$TextField[24] == t.TextFieldType.INPUT &&
            !e.$TextField[30] &&
            i.length > 1 &&
            (r = 0),
          r
      ...
      (e.$getTextHeight = function (e) {
        var i =
          t.TextFieldType.INPUT != e.$TextField[24] || e.$TextField[30]
            ? e.$TextField[6] + (e.$TextField[29] - 1) * e.$TextField[1]
            : e.$TextField[0];
        return i;
      }),
      (e.$getValign = function (i) {
        ...
        if (!isNaN(n) && n > r) {
          var o = 0;
          return (
            i.$TextField[10] == t.VerticalAlign.MIDDLE
              ? (o = 0.5)
              : i.$TextField[10] == t.VerticalAlign.BOTTOM && (o = 1),
            o
          );
        }
        return 0;
      ...
      (e.$getTextElement = function (t, i, r) {
        ...
        return n &&
          o[n.lineIndex] &&
          o[n.lineIndex].elements[n.textElementIndex]
          ? o[n.lineIndex].elements[n.textElementIndex]
          : null;
      }),
      (e.$getHit = function (t, i, r) {
        ...
        for (var v = 0, p = 0; p < f.elements.length; p++) {
          var $ = f.elements[p];
          if (v + $.width <= i) v += $.width;
          else if (i > v) return { lineIndex: o - 1, textElementIndex: p };
        }
        return null;
      }),
...
!(function (t) {
  var e = (function () {
    ...
    return (
      (t.encode = function (t) {
        for (
          var e = new Uint8Array(t), i = e.length, r = "", n = 0;
          i > n;
          n += 3
        )
          ((r += chars[e[n] >> 2]),
      ...
      (t.decode = function (t) {
        ...
        for (
          var h = new ArrayBuffer(e), l = new Uint8Array(h), u = 0;
          i > u;
          u += 4
        )
...
!(function (t) {
  ...
  var i = (function () {
    ...
    return (
      (i.prototype._setArrayBuffer = function (t) {
      ...
      (i.prototype.writeBytes = function (t, e, i) {
        ...
        if (
          !(0 > e) &&
          !(0 > i) &&
          ((r = 0 == i ? t.length - e : Math.min(t.length - e, i)), r > 0)
        ) {
      ...
      (i.prototype.validate = function (e) {
        return this.data.byteLength > 0 &&
          this._position + e <= this.data.byteLength
          ? !0
          : void t.$error(1025);
      }),
      ...
      (i.prototype.encodeUTF8 = function (t) {
        for (
          var e = 0, i = this.stringToCodePoints(t), r = [];
          i.length > e;
          ...
          if (this.inRange(n, 55296, 57343)) this.encoderError(n);
            ...
            var o = void 0,
              s = void 0;
            for (
              this.inRange(n, 128, 2047)
                ? ((o = 1), (s = 192))
                : this.inRange(n, 2048, 65535)
                  ? ((o = 2), (s = 224))
                  : this.inRange(n, 65536, 1114111) && ((o = 3), (s = 240)),
                r.push(this.div(n, Math.pow(64, o)) + s);
              o > 0;
      ...
      (i.prototype.decodeUTF8 = function (t) {
        for (
          var e, i = !1, r = 0, n = "", o = 0, s = 0, a = 0, h = 0;
          t.length > r;
          ...
          if (l == this.EOF_byte)
            ...
            this.inRange(l, 0, 127)
              ? (e = l)
              : (this.inRange(l, 194, 223)
                  ? ((s = 1), (h = 128), (o = l - 192))
                  : this.inRange(l, 224, 239)
                    ? ((s = 2), (h = 2048), (o = l - 224))
                    : this.inRange(l, 240, 244)
                      ? ((s = 3), (h = 65536), (o = l - 240))
                      : this.decoderError(i),
                (o *= Math.pow(64, s)),
                (e = null));
          else if (this.inRange(l, 128, 191))
            if (((a += 1), (o += (l - 128) * Math.pow(64, s - a)), a !== s))
              e = null;
            else {
              var u = o,
                c = h;
              ((o = 0),
                ...
                (h = 0),
                (e =
                  this.inRange(u, c, 1114111) && !this.inRange(u, 55296, 57343)
                    ? u
                    : this.decoderError(i, l)));
            }
          else
            ((o = 0),
              (s = 0),
...
(!(function (t) {
  ...
  (function (t) {
    ...
    !(function (t) {
      ...
      for (
        var r = ["normal", "add", "erase"], n = {}, o = r.length, s = 0;
        o > s;
        s++
      ) {
        var a = r[s];
  ...
  var e = (function (e) {
    ...
    return (
      ...
      Object.defineProperty(i.prototype, "scaleMode", {
        ...
        set: function (t) {
          this.$scaleMode != t &&
            ((this.$scaleMode = t), this.$screen.updateScreenSize());
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(i.prototype, "orientation", {
        ...
        set: function (t) {
          this.$orientation != t &&
            ((this.$orientation = t), this.$screen.updateScreenSize());
        },
        enumerable: !0,
        configurable: !0,
      }),
      ...
      Object.defineProperty(i.prototype, "maxTouches", {
        ...
        set: function (t) {
          this.$maxTouches != t &&
            ((this.$maxTouches = t), this.$screen.updateMaxTouches());
        },
        enumerable: !0,
        configurable: !0,
      }),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.$update = function (e) {
        ...
        return (
          t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER),
          r &&
            (this.stop(),
...
!(function (t) {
  function e(t, e, i) {
    ...
    var o,
      s = t.prototype;
    (t.hasOwnProperty("__sets__") ||
      Object.defineProperty(t, "__sets__", { value: {} }),
      (o = t.__sets__));
    var a = o[i];
  ...
  function i(t, e, i) {
    var r,
      n = t.prototype;
    (t.hasOwnProperty("__gets__") ||
      Object.defineProperty(t, "__gets__", { value: {} }),
      (r = t.__gets__));
    var o = r[i];
    ...
    if (null != s) {
      for (; !s.hasOwnProperty(i); )
        if (((s = Object.getPrototypeOf(s)), null == s)) return;
      return (
        (o = Object.getOwnPropertyDescriptor(s, i).get),
        (r[i] = o),
        o.call(e)
      );
    }
      ...
      i = (function () {
        ...
        return (
          ...
          (t.prototype.intersects = function (t) {
            ...
            return e > i
              ? !1
              : ((e = this.minY > t.minY ? this.minY : t.minY),
