/*!jQuery v3.1.0 | (c) jQuery Foundation | jquery.org/license*/ (!(function (
  ...
  (v.extend({
    ...
    clone: function (t, e, i) {
      ...
      return (
        (a = ut(r, "script")).length > 0 && ct(a, !l && ut(t, "script")),
        r
      );
    },
    ...
    (t.widget("ui.button", {
      ...
      t.widget("ui.dialog", {
        ...
        _trackingInstances: function () {
          ...
          return (
            t || ((t = []), this.document.data("ui-dialog-instances", t)),
            t
          );
        },
        _minHeight: function () {
      ...
      (function () {
        ...
        (t.extend(t.effects, {
          ...
          setMode: function (t, e) {
            return (
              "toggle" === e && (e = t.is(":hidden") ? "show" : "hide"),
              e
            );
          },
      ...
      ((this.hasHTML5 = lt),
        ...
        (u = function () {
          ...
          try {
            ...
            return (
              P({ type: "JS_TO_FLASH_EXCEPTION", fatal: !0 }),
              N(!0),
              d(),
              !1
            );
