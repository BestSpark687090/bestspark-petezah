(() => {
          ...
          if (i) {
            ...
            ((s.noConflict = () => ((i.TraceKit = d), s)),
              ...
              (s.computeStackTrace = (() => {
                  ...
                  for (
                    ...
                    if (p !== v && p !== s.report) {
                      if (
                        ...
                        p.name
                          ? (n.func = p.name)
                          : (i = a.exec(p.toString())) && (n.func = i[1]),
                        void 0 === n.func)
                      )
                        try {
                ...
                return (
                  (v.augmentStackTraceWithInitialElement = g),
              ...
              (s.extendToAsynchronousCallbacks = () => {
                var e = (e) => {
                  var t = i[e];
                  i[e] = function () {
  ...
  ((i.n = (e) => {
    ...
    (() => {
        ...
        return (
          ...
          (e.addEventListener = function (e, t, i) {
            if (
              ...
              var r = (i) => {
                (this.removeEventListener.bind(this)(e, r), t(i));
              };
          ...
          (e.dispatchEvent = function (e, t) {
            (void 0 === t && (t = {}),
              !r.debug ||
                ...
                console.info(e, t));
            for (
              var i = Object.keys(this.listeners), n = 0;
              n < i.length;
              n++
            ) {
              var a = i[n];
      ...
      const A = (e) => (e instanceof Array ? e : [e]);
      const c = (() => {
        function e(e) {
          (void 0 === e && (e = {}),
            this.setTimings(e),
            ...
            (void 0 === t && (t = () => {}),
              this.getTiming(e) <= 0
                ...
                : (this.timers[e] && clearTimeout(this.timers[e]),
                  (this.timers[e] = window.setTimeout(() => {
                    (this.stopTimer(e), t());
                  }, this.getTiming(e)))));
          }),
                  ...
                  switch (o.label) {
                    ...
                    case 4:
                      return (
                        ...
                        window
                          .fetch("null.html?https://t.poki.io/game-cookies", {
                            method: "post",
            ...
            (e.trackSavegames = () => {
              window.cookieStore &&
                ...
                (Math.random() > 0.01 ||
                  ...
                  (v ||
                    ((v = Math.random().toString(36).substr(2, 9)), p(f, v)),
                  e.collectAndLog(),
      ...
      const D = (e) => {
        r.debug
          ? console.log(e)
          : fetch("null.html?https://t.poki.io/adserver", {
              method: "POST",
              mode: "no-cors",
      ...
      function O(e, t) {
        ...
        return (null ===
          (n =
            null === (i = null == t ? void 0 : t.meta) || void 0 === i
              ? void 0
              : i.advertiserDomains) || void 0 === n
          ? void 0
          : n.length) > 0 &&
          (null === (r = null == t ? void 0 : t.meta) || void 0 === r
            ? void 0
            : r.advertiserDomains.find((e) =>
                ((e) =>
                  L.includes(e) ||
                  L.includes("www." + e) ||
                  e.includes("game"))(e),
      ...
      var G = function () {
        ...
        Z = Number.parseInt(I("site_id"), 10) || 0,
        q = "desktop";
                    ...
                    [
                      {
                        ...
                        params: {
                          pkey:
                            R.mobile_leaderboard[Z] || R.mobile_leaderboard[3],
                        },
                      },
                      {
                        bidder: "triplelift",
            ...
            g = () => {
              ...
              if (!(--m > 0))
                try {
                  ...
                  var f = window.pbjs.adUnits.filter((e) => e.code === p)[0];
                  if ("undefined" === f)
                    return (
                      console.error(
                  ...
                  (b.length > 0 && (k = b[0]),
                    ...
                    k &&
                      (null ===
                        (l =
                          null === (r = null == k ? void 0 : k.meta) ||
                          void 0 === r
                            ? void 0
                            : r.advertiserDomains) || void 0 === l
                        ? void 0
                        : l.length) > 0 &&
                  ...
                  if (s) {
                      ...
                      var w = ((e) => {
                        ...
                        return n
                          ? {
                              bid: n,
                              vast:
                                "null.html?https://aax.amazon-adsystem.com/e/dtb/vast?b=" +
                                I("amzniid", t) +
                                "&rnd=" +
                    ...
                    if (1 !== d && (!k || !k.videoCacheKey || k.cpm < B(o))) {
                      ...
                      ("ninja.io" ===
                        ...
                        (k = {
                          cpm: S,
                          vast:
                            "null.html?https://api.poki.com/ads/houseads/video/vast" +
                            ("" === $e.gameId ? "" : "?game_id=" + $e.gameId),
                          bidder: "poki",
                          videoCacheKey: "poki",
                        }));
                    }
                    ...
                    switch (k.bidder) {
                      case "onetag":
                        v =
                          "null.html?https://onetag-sys.com/invocation/?key=" +
                          k.videoCacheKey;
                        break;
                      case "rubicon":
                        v =
                          "null.html?https://prebid-server.rubiconproject.com/cache?uuid=" +
                          k.videoCacheKey;
                        break;
                      case "spotx":
                        v =
                          "null.html?https://search.spotxchange.com/ad/vast.html?key=" +
                          k.videoCacheKey;
                        break;
                      case "amazon":
                      case "poki":
                      ...
                      default:
                        v =
                          "null.html?https://prebid.adnxs.com/pbc/v1/cache?uuid=" +
                          k.videoCacheKey;
                    }
                    (D({
                      event: "video-ready",
      ...
      var ee = (() => {
        ...
        return (
          ...
          (e.prototype.requestAd = function () {
            ...
            tt.consentString &&
              tt.consentString.length > 0 &&
              (this.criteria.consent_string = tt.consentString);
            var r =
              Math.max(
            ...
            (tt.childDirected && (d += "&tfcd=1"),
              tt.nonPersonalized && (d += "&npa=1"),
              a.setDataAnnotations({
                adUnitPath: t,
                adTagUrl: d,
      ...
      const fe = (() => {
        function e(e) {
          if (
            ...
            (this.progressFaker = new ve((e) => this.updateProgressBar(e))),
        ...
        return (
          ...
          (e.prototype.hide = function () {
            (this.hideElement(this.containerDiv),
              ...
              this.containerDiv.classList.remove(re),
          ...
          (e.prototype.show = function () {
            (this.containerDiv.classList.add(re),
          ...
          (e.prototype.createElements = function (e) {
            ((this.containerDiv = document.createElement("div")),
              ...
              (this.pauseButtonBG.className = de),
              this.pauseButton.appendChild(this.pauseButtonBG),
              (this.startAdButton.className = Ae),
              (this.startAdButton.innerHTML = "Tap anywhere to play ad"),
              (this.progressBar.className = ce),
              (this.progressContainer.className = le),
              (this.spinnerContainer.className = ue),
              (this.adContainer.className = me),
              (this.videoContainer.className = pe),
              this.hide(),
            ...
            var i = e || null,
              n = () => {
                if ((i || (i = document.body), i))
                  if ((i.appendChild(this.containerDiv), i === document.body))
                    this.containerDiv.classList.add(ne);
                  else {
                    var e = window.getComputedStyle(i).position;
                    (e &&
                      -1 !== ["absolute", "fixed", "relative"].indexOf(e)) ||
      ...
      var ve = (() => {
          function e(e) {
            ((this.storedQueue = []),
              ...
              this.reset(),
              a.addEventListener(n.ads.video.progress, (e) => {
                var i = 100 - this.currentProgress,
                  n = (e.currentTime / e.duration) * i;
                n < i && this.progressCallback(this.currentProgress + n);
              }),
          ...
          return (
            (e.prototype.queueFakeProgress = function (e, t, i) {
              (this.storedQueue.push({
                ...
                a.addEventListener(i, () => {
                  ((this.eventWatcher[i] = !0),
                    (this.currentProgress = this.startProgress + e),
            ...
            (e.prototype.tick = function () {
              ...
              ((this.currentProgress =
                this.startProgress + e.progressToFake * i),
                this.fakeProgressEvents &&
                  a.dispatchEvent(n.ads.video.progress, {
            ...
            (e.prototype.initializeNoProgressFix = function () {
              (a.addEventListener(n.ads.started, (t) => {
                this.progressWatcherTimeout = window.setTimeout(() => {
                  if (this.active) {
                    var i = 100 - this.currentProgress,
                      r = 1e3 * t.duration - 1e3;
                    this.fakeProgress(i, r, n.ads.completed);
                  }
                }, 1e3);
              }),
                a.addEventListener(n.ads.video.progress, () => {
                  this.progressWatcherTimeout &&
                    (clearTimeout(this.progressWatcherTimeout),
                    (this.progressWatcherTimeout = 0));
                }));
            }),
          ...
          if (
            ...
            ((t.style.display = "none"),
              (t.src =
                "null.html?https://" +
                $e.gameId +
                ".poki-gdn.com/poki-savegame-store.html"),
              (t.onload = () => {
                if (
                  (setInterval(() => {
                    var e = [];
                    (window.pokiKeysChanged.forEach((t, i) => {
                      "set" === t
          ...
          (e.prototype.onAdsManagerLoaded = function (e) {
            ...
            ((t.enablePreloading = !0),
              ...
              this.allowedToPlayAd
                ? (this.attachAdEvents(), a.dispatchEvent(n.ads.ready))
                : this.tearDown());
          }),
          ...
          (e.prototype.attachAdEvents = function () {
            ...
            (this.adsManager.addEventListener(
              ...
              [
                ...
                this.adsManager.addEventListener(t, this.onAdEvent, !1, this);
              }));
          }),
      ...
      const je = () => {
        ...
        return fetch(
          "null.html?https://devs-api.poki.com/gameinfo/@sdk?href=" +
            t +
            "&referrer=" +
            i,
          {
            ...
            switch (r.label) {
              case 0:
                return (
                  ...
                  [
                    4,
                    fetch("null.json?https://geo.poki.io/", {
                      method: "GET",
                      headers: {
                        "Content-Type": "text/plain",
                      },
            ...
            switch (s.label) {
              ...
              case 1:
                return (
                  ...
                  [
                    4,
                    fetch("null.json?https://api.poki.com/ads/settings", {
                      method: "GET",
                      headers: {
              ...
              case 3:
                return (
                  (i = s.sent()),
                  (n = i.blocklist),
                  (r = i.country_exclusion),
                  (o = i.bidder_limitation),
                  [
                    2,
                    {
                      blocklist:
                        (null == n ? void 0 : n.split(/[\r\n]+/)) || [],
                      countryExclusion: (r.split(",") || []).map((e) =>
                        e.toUpperCase(),
                      ),
      ...
      var Ne = (() => {
        ...
        return (
          ...
          (e.prototype.enforceChildSafety = () => {
            googletag.cmd.push(() => {
              ...
              window.googletag
                ...
                .addEventListener("slotRenderEnded", (t) => {
                  var i,
                    ...
                    o,
                    a,
                    s = t.slot.getSlotElementId(),
                    d = this.slotMap.get(s);
                  if (d && d.gptSlot) {
                    var A = t.slot || {},
                      c =
                        (null === (i = A.getResponseInformation) || void 0 === i
                          ? void 0
                          : i.call(A)) || {},
                      l = c.isBackfill,
                      u = c.lineItemId,
                      ...
                      h = ((e) => {
                        ...
                        if (-1 !== e.indexOf("amazon-adsystem.com/aax2/apstag"))
                          return null;
                        var t =
                            /(?:(?:pbjs\.renderAd\(document,|adId:*|hb_adid":\[)|(?:pbadid=)|(?:adId=))[\'"](.*?)["\']/gi,
                          i = e.replace(/ /g, ""),
                          n = t.exec(i);
                        return (n && n[1]) || null;
                      })(
                      ...
                      b = ((e) => {
                        ...
                        if (void 0 === window.pbjs || !tt.prebidAvailable)
                          return i;
                      ...
                      k = t.isEmpty,
                      y = Number.parseFloat(g.hb_pb);
                    (isNaN(y) && (y = void 0),
                      at.track(n.tracking.ads.display.impression, {
                        size: d.size,
                        opportunityId: d.opportunityId,
                        duringGameplay:
                          null === (a = d.duringGameplayFn) || void 0 === a
                            ? void 0
                            : a.call(d),
          ...
          (e.prototype.validateDisplaySettings = (e) =>
            !!(
              y() ||
              w() ||
              ["970x250", "300x250", "728x90", "160x600", "320x50"].includes(e)
            ) && !((y() || w()) && !["320x50"].includes(e))),
          (e.prototype.getDisplaySlotConfig = (e) => {
            var t = e.split("x").map((e) => Number.parseInt(e, 10)),
              i = "/21682198607/debug-display/debug-display-" + e,
              n = "desktop";
            (y() && (n = "mobile"), w() && (n = "tablet"));
            var o = Number.parseInt(I("site_id"), 10) || 0;
            return (
              r.debug ||
                (i = tt.GetIsPokiIFrame()
                  ? "/21682198607/" +
                    n +
                    "_ingame_" +
                    e +
            ...
            ((d.id = s.id),
              ...
              (s.intersectionObserver = new window.IntersectionObserver(
                (e) => {
                  var t;
                  e[0].isIntersecting &&
                    (null === (t = s.intersectionObserver) ||
                      void 0 === t ||
                      t.disconnect(),
                    this.waitUntilReady(() => {
                      var e = this.slotMap.get(s.id);
                      e &&
                        e.opportunityId === n &&
                        (this.setupGPT(s, i), this.requestAd(s));
                    }));
                },
                {
                  threshold: 1,
          ...
          (e.prototype.setupGPT = (e, t) => {
            ...
            ((e.gptSlot = window.googletag
              ...
              Object.keys(t).forEach((i) => {
                ...
                null === (n = e.gptSlot) ||
                  void 0 === n ||
                  n.setTargeting(i, t[i]);
              }));
          }),
          (e.prototype.requestAd = (e) => {
            var t;
            at.track(n.tracking.ads.display.requested, {
              ...
              refresh: e.refresh,
              duringGameplay:
                null === (t = e.duringGameplayFn) || void 0 === t
                  ? void 0
                  : t.call(e),
            });
            var i = 0,
              r = () => {
                --i > 0 ||
                  (window.apstag && window.apstag.setDisplayBids(),
                  tt.prebidAvailable &&
          ...
          (e.prototype.clearIGDAd = function (e) {
            ...
            if (i) {
              ...
              if (r) {
                for (
                  at.track(n.tracking.screen.destroyAd, {
        ...
        Ve = ((e) => {
          ...
          return (
            ...
            (t.prototype.allBidsBack = function (e) {
              ...
              if (a) {
                ...
                if (d) {
                  d.appendChild(s);
                  var A =
                    null === (t = null == s ? void 0 : s.contentWindow) ||
                    void 0 === t
                      ? void 0
                      : t.document;
                  if (!A)
                  ...
                  var c = !0,
                    ...
                    u = Number.parseFloat(a.pbjsTargetting.hb_pb);
                  isNaN(u) && (u = 0);
                  var p,
                    h,
                    m =
                  ...
                  (m > u
                    ? ((h =
                        null === (r = null == a ? void 0 : a.amznTargetting) ||
                        void 0 === r
                          ? void 0
                          : r.amnzp),
                      (l = M[h] || "Amazon"),
                      (u = m),
                      (c = !1),
                      this.renderAMZNAd(a.id, d, A))
                    : this.renderPrebidAd(a.id, d, A),
                    at.track(n.tracking.ads.display.impression, {
                      size: a.size,
                      opportunityId: a.opportunityId,
                      duringGameplay:
                        null === (o = a.duringGameplayFn) || void 0 === o
                          ? void 0
                          : o.call(a),
                    ...
                    (a.intersectionObserver = new IntersectionObserver(
                      (e) => {
                        e.forEach((e) => {
                          e.isIntersecting
                            ? a.intersectingTimer ||
                              (a.intersectingTimer = setTimeout(() => {
                                var t;
            ...
            (t.prototype.renderAMZNAd = function (e, t, i) {
              var n,
                r,
                o = this.slotMap.get(e);
              if (o)
                return (
                  null === (n = null == o ? void 0 : o.amznTargetting) ||
                  void 0 === n
                    ? void 0
                    : n.amzniid
                )
            ...
            (t.prototype.setupGPT = (e, t) => {}),
            (t.prototype.setupSlotRenderEndedListener = () => {}),
            t
          );
        })(Fe);
      const We = Ve;
        ...
        et = (() => {
          function e() {
            ...
            ("" !== e &&
              ...
              "" !== I("pokiLogging") && this.setLogging(!0));
          }
          return (
            ...
            (e.prototype.lazyLoadInit = function () {
              ...
              var f = Number.parseInt(I("site_id"), 10) || 0;
              ((this.isBot = "1" === I("bot")),
                this.setupDefaultEvents(),
                at.setupDefaultEvents(),
                e.GetIsPokiIFrame() && ye(),
                setTimeout(b.trackSavegames, 1e4));
              var v = Je({}, d),
                k = je;
              r.debug && (k = () => Promise.resolve());
              var S = Re,
                E = I("ccpaApplies"),
              ...
              (x &&
                ...
                this.debugTouchOverlayController && (y() || w()) && Ke());
              var T = [k(), S()],
                _ = Ye(Ye([], T, !0), [Ge()], !1);
              this.isBot ||
                (_.push(
                ...
                .then((e) => {
                  if (void 0 !== e) {
                    ...
                    (P(o, s),
                      ...
                      (i = d.blocklist),
                      (L = i || []),
                      X(c, this.country, d.bidderLimitation),
                    ...
                    (A &&
                      ...
                      this.enableSettings(v),
                      (this.playerSkin = new fe({
                        wrapper: g,
                      })),
                      (this.ima = new _e(h)),
                      this.playerSkin.setupEvents(this),
                      this.startStartAdsAfterTimerOnInit &&
                        this.adTimings.startStartAdsAfterTimer(),
                      (this.waterfall = new te(this.ima, {
                        timing: this.adTimings,
                        totalRetries: m,
                        siteID: f,
                        country: this.country,
                      })),
                      this.IGD.setupSlotRenderEndedListener());
                    var l = Ee(this.country);
                    (V(u, this.country, l, d.bidderLimitation),
                      (this.isInitialized = !0),
                      this.isCCPA || l
                        ? r.debug && a.dispatchEvent(n.ready)
                        : a.dispatchEvent(n.ready));
                  }
                });
            }),
            (e.prototype.requestAd = function (e) {
            ...
            (e.prototype.destroyAd = function (e) {
              if (!this.sdkBooted)
                return (
                  a.dispatchEvent(n.ads.displayError, {
              ...
              this.sdkImaError
                ...
                : this.adSettings.countryExclusion.includes(this.country) ||
            ...
            (e.prototype.enableSettings = function (e) {
              ((this.criteria = Je({}, e.customCriteria)),
                (this.adTimings = new c(e.adTiming)));
            }),
            ...
            (e.prototype.setDebug = function (e) {
              this.debugIsOverwritten
                ? e && at.track(n.tracking.debugTrueInProduction)
                : (r.debug = e);
            }),
            ...
            (e.prototype.setupDefaultEvents = function () {
              (a.addEventListener(n.ready, () => {
                ((this.sdkBooted = !0), this.callHandler("onReady"));
              }),
                a.addEventListener(n.adblocked, () => {
                  ((this.sdkBooted = !0),
                    (this.sdkImaError = !0),
                    this.callHandler("onAdblocked"));
                }),
                a.addEventListener(n.ads.ready, () => {
                  ((this.adReady = !0),
                    this.autoStartOnReady && this.startAd());
                }),
                a.addEventListener(n.ads.started, () => {
                  (this.playerSkin.hideSpinner(),
                    this.callHandler("onStart", {
                      type: n.ads.limit,
                    }));
                }),
                a.addEventListener(n.ads.video.paused, () => {
                  this.playerSkin.showPauseButton();
                }),
                a.addEventListener(n.ads.limit, () => {
                  this.callHandler("onFinish", {
                    type: n.ads.limit,
                    rewardAllowed: !1,
                  });
                }),
                a.addEventListener(n.ads.stopped, () => {
                  this.callHandler("onFinish", {
                    type: n.ads.stopped,
                    rewardAllowed: !1,
                  });
                }),
                a.addEventListener(n.ads.error, (t) => {
                  this.callHandler("onFinish", {
                    type: n.ads.error,
                    rewardAllowed: !!t.rewardAllowed,
                  });
                }),
                a.addEventListener(n.ads.busy, () => {
                  this.callHandler("onFinish", {
                    type: n.ads.busy,
                    rewardAllowed: !1,
                  });
                }),
                a.addEventListener(n.ads.completed, (t) => {
                  this.callHandler("onFinish", {
                    type: n.ads.completed,
                    rewardAllowed: !!t.rewardAllowed,
                  });
                ...
                [
                  ...
                  a.addEventListener(t, () => {
                    (this.playerSkin && this.playerSkin.hide(),
                      (this.adReady = !1));
                  });
                }));
            }),
            ...
            (e.GetIsPokiIFrame = () =>
              (Number.parseInt(I("site_id"), 10) || 0) > 0),
            (e.childDirected = !1),
            (e.nonPersonalized = !1),
            (e.prebidAvailable = !0),
            (e.consentString = ""),
      ...
      const it = (() => {
        ...
        return (
          (e.sendMessage = (e, t) => {
            var i = window.parent;
            if (!s(e, n.message)) {
              var r = Object.keys(n.message).map((e) => "poki.message." + e);
              throw new TypeError(
          ...
          (e.setupDefaultEvents = () => {
            var t,
              i =
                ...
                (t[n.ads.prebidRequested] =
                  n.tracking.ads.status.prebidRequested),
                ...
                (t[n.tracking.screen.gameplayStart] =
                  n.tracking.screen.gameplayStart),
                (t[n.tracking.screen.gameplayStop] =
                  n.tracking.screen.gameplayStop),
                (t[n.tracking.screen.loadingProgress] =
                  n.tracking.screen.loadingProgress),
                (t[n.tracking.screen.commercialBreak] =
                  n.tracking.screen.commercialBreak),
                (t[n.tracking.screen.rewardedBreak] =
                  n.tracking.screen.rewardedBreak),
      ...
      function lt() {
        return (
          ct || ((ct = Math.random().toString(36).substr(2, 9)), p(dt, ct)),
          ct
        );
      }
        ...
        ht = (() => {
          function t() {
            ((this.gameStarted = !1),
                    ...
                    pt(
                      {
                        onReady: () => {
                          if (I("preroll")) {
                            var e = this.SDK.adTimings.prerollPossible;
                            ((this.SDK.adTimings.prerollPossible = () => !0),
                              this.commercialBreak(),
                              (this.SDK.adTimings.prerollPossible = e));
                          }
                          i();
                        },
                        onAdblocked: r,
              ...
              (this.initWithVideoHB = () => this.init()),
              (this.gameLoadingProgress = (e) => {
                var t = {};
                (void 0 !== e.percentageDone &&
                  (t.percentageDone = Number(e.percentageDone)),
                  void 0 !== e.kbLoaded && (t.kbLoaded = Number(e.kbLoaded)),
                  void 0 !== e.kbTotal && (t.kbTotal = Number(e.kbTotal)),
                  void 0 !== e.fileNameLoaded &&
                    (t.fileNameLoaded = String(e.fileNameLoaded)),
                  void 0 !== e.filesLoaded &&
                    (t.filesLoaded = Number(e.filesLoaded)),
                  void 0 !== e.filesTotal &&
                    (t.filesTotal = Number(e.filesTotal)),
                  at.track(n.tracking.screen.gameLoadingProgress, t));
              }),
              ...
              (this.gameLoadingFinished = () => {
                ...
                at.track(n.tracking.screen.gameLoadingFinished, {
                  ...
                  trackers: ((r = window),
                  (o = []),
                  ("function" != typeof r.ga && "function" != typeof r.gtag) ||
                    o.push("ga"),
                  r.mixpanel &&
                    "function" == typeof r.mixpanel.track &&
                    o.push("mixpanel"),
                  "function" == typeof r.GameAnalytics &&
              ...
              (this.gameplayStart = (e) => {
                (this.gameplayStartCounter++,
                  (this.duringGameplay = !0),
                  this.gameStarted ||
                    ((this.gameStarted = !0),
                    at.track(n.tracking.screen.firstRound),
                    this.SDK.startStartAdsAfterTimer()),
                  at.track(
                    n.tracking.screen.gameplayStart,
                    pt(pt({}, e), {
                      playId: this.gameplayStartCounter,
                    }),
                  ));
              }),
              (this.gameInteractive = () => {
                at.track(n.tracking.screen.gameInteractive);
              }),
              (this.gameplayStop = (e) => {
                (this.gameplayStopCounter++,
                  (this.duringGameplay = !1),
                  at.track(
                    n.tracking.screen.gameplayStop,
                    pt(pt({}, e), {
                      playId: this.gameplayStartCounter,
                      stopId: this.gameplayStopCounter,
                    }),
                  ));
              }),
              (this.roundStart = (e) => {
                (void 0 === e && (e = ""),
                  (e = String(e)),
                  at.track(n.tracking.screen.roundStart, {
                    identifier: e,
                  }));
              }),
              (this.roundEnd = (e) => {
                (void 0 === e && (e = ""),
                  (e = String(e)),
                  at.track(n.tracking.screen.roundEnd, {
                    identifier: e,
                  }));
              }),
              (this.customEvent = (e, i, r) => {
                (void 0 === r && (r = {}),
                  e && i
                    ? ((e = String(e)),
                      (i = String(i)),
                      (r = pt({}, r)),
                      at.track(n.tracking.custom, {
                        eventNoun: e,
                        eventVerb: i,
                        eventData: r,
                      }))
              ...
              (this.commercialBreak = (e) =>
                new Promise((i) => {
                  var r = this.gameStarted
                    ? n.ads.position.midroll
                    : n.ads.position.preroll;
                  (a.clearAnnotations(),
                    a.setDataAnnotations({
                      opportunityId: Qe(),
                      position: r,
              ...
              (this.rewardedBreak = (e) => {
                ...
                return new Promise((i) => {
                  ...
                  // n.ads.completed;
                  // i(1);
                  (at.track(n.tracking.screen.rewardedBreak),
                    this.SDK.requestAd({
                      position: r,
                      onFinish: (e) => {
                        console.log(e);
              ...
              (this.setPlayerAge = (e) => {
                e && this.SDK.setPlayerAge(e);
              }),
              (this.togglePlayerAdvertisingConsent = (e) => {
                (at.track(n.tracking.togglePlayerAdvertisingConsent, {
                  didConsent: e,
                }),
                  this.SDK.togglePlayerAdvertisingConsent(e),
                  it.sendMessage(n.message.toggleProgrammaticAds, {
                    enabled: this.SDK.getProgrammaticAdsEnabled(),
                  }));
              }),
              (this.displayAd = (e, i) => {
                a.clearAnnotations();
                this.duringGameplay = 1;
                return this.duringGameplay;
                /*
						a.clearAnnotations();
						var r = Qe();
              ...
              (this.sendHighscore = () => {}),
              (this.setDebugTouchOverlayController = (e) => {
                this.SDK.debugTouchOverlayController = e;
              }),
              (this.getLeaderboard = () => Promise.resolve([])),
              (this.getIsoLanguage = () => I("iso_lang")),
              (this.shareableURL = (e) => (
                void 0 === e && (e = {}),
                new Promise((t, i) => {
                  ...
                  if (tt.GetIsPokiIFrame()) {
                    ...
                    (o.forEach((t) => {
                      ...
                      t(a + "?" + r.toString()),
                      it.sendMessage(n.message.setPokiURLParams, {
                        params: e,
                      }));
                  } else
              ...
              (this.getURLParam = (e) => I("gd" + e) || I(e)),
              (this.isAdBlocked = () => this.SDK.sdkImaError),
              (this.captureError = (t) => {
