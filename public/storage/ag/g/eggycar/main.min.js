 ...
 * Copyright(c): 2018
 * Version: 1.0.9 (07-08-2018 13:54)
 */
!(function r(s, a, d) {
  function c(t, e) {
    if (!a[t]) {
...
})(
  {
            ...
            (t = function () {
              ...
              var e = "undefined" != typeof window ? window : void 0,
                ...
                d =
                  ...
                  void 0 !== K &&
                  "[object process]" === {}.toString.call(K),
                u =
              ...
              function L(e, t) {
                e._state === w &&
                  ((e._result = t),
                  (e._state = T),
                  0 !== e._subscribers.length && a(O, e));
              }

              function k(e, t) {
                e._state === w && ((e._state = D), (e._result = t), a(C, e));
              }
              ...
              function O(e) {
                ...
                if (0 !== t.length) {
                  for (
                    var i = void 0, o = void 0, r = e._result, s = 0;
                    s < t.length;
                    s += 3
                  )
                    ((i = t[s]), (o = t[s + n]), i ? B(n, i, o, r) : o(r));
                  ...
                  (e.prototype._eachEntry = function (t, e) {
                    ...
                    if (i === E) {
                      ...
                      if (o === b && t._state !== w)
                        ...
                        var r = new n(A);
                        (I(r, t, o), this._willSettleAt(r, e));
                      } else
                        this._willSettleAt(
                          new n(function (e) {
                            return e(t);
    ...
    3: [
      function (e, t, n) {
        ...
        ((r.nextTick = function (e) {
          ...
          (u.push(new f(e, t)), 1 !== u.length || l || d(p));
        }),
            ...
            if (o)
              var r = [
                ...
                d =
                  ...
                  function (e) {
                    return (
                      e && -1 < r.indexOf(Object.prototype.toString.call(e))
                    );
                  };
              ...
              i(e, [
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    for (o = 0; o < i.length; o++)
                      if (i[o].callback === t && (!n || n === i[o].scope)) {
                        r = o;
                        break;
                      }
                    return r;
              ...
              o(e, [
                {
                  ...
                  value: function () {
                    ...
                    var r = document.getElementById("gdsdk__pauseGame"),
                      ...
                      l = document.getElementById("gdsdk__closeDebug");
                    (localStorage.getItem("gd_tag")
                      ? ((c.innerHTML = "Revert Vast tag"),
                        (c.style.background = "#ff8c1c"))
                      : ((c.innerHTML = "Demo VAST tag"),
                        (c.style.background = "#44a5ab")),
                      localStorage.getItem("gd_midroll")
                        ? ((u.innerHTML = "Revert delay"),
                          (u.style.background = "#ff8c1c"))
                        : ((u.innerHTML = "Disable delay"),
                          (u.style.background = "#44a5ab")),
        ...
        var d = null,
          s = (function () {
            function s(e, t, n) {
              ...
              (((d = this).options = n ? (0, u.extendDefaults)(i, n) : i),
                (this.prefix = t),
                (this.adsLoader = null),
                (this.adsManager = null),
                (this.adDisplayContainer = null),
                (this.eventBus = new a.default()),
                ...
                (this.parentDomain = (0, u.getParentDomain)()),
                (this.tag =
                  "https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dlinear&correlator="),
              ...
              ((this.options.responsive = this.options.responsive && o <= 1024),
                (this.options.responsive || this.thirdPartyContainer) &&
              ...
              o(s, [
                  ...
                  value: function () {
                    ...
                    (this._startSafetyTimer(12e3, "start()"),
                      this.eventBus.subscribe(
                        "AD_SDK_LOADER_READY",
                        function () {
                          n._clearSafetyTimer("AD_SDK_LOADER_READY");
                        },
                      ),
                      this.eventBus.subscribe(
                        "AD_SDK_MANAGER_READY",
                        function () {
                          n._clearSafetyTimer("AD_SDK_MANAGER_READY");
                        },
                      ),
                      this._loadScripts()
                        .then(function () {
                          (n._createPlayer(), n._setUpIMA());
                        })
                        .catch(function (e) {
                          return n._onError(e);
                        }),
                      (this.adsLoaderPromise = new Promise(function (e, t) {
                        (n.eventBus.subscribe(
                          "AD_SDK_LOADER_READY",
                          function () {
                            return e();
                          },
                        ),
                          n.eventBus.subscribe("AD_CANCELED", function () {
                            return t(
                              new Error(
                    ...
                    if ("undefined" != typeof google)
                      if (this.requestRunning)
                        ...
                        try {
                          ...
                          this.adCount++;
                          var t = this.adCount - 1,
                            n = this.requestAttempts + 1;
                          (0 === this.requestAttempts && this.adTypeCount++,
                            (this.tag = (0, u.updateQueryStringParameter)(
                              this.tag,
                              "ad_count",
                              this.adCount,
                            )),
                            (this.tag = (0, u.updateQueryStringParameter)(
                              this.tag,
                              "ad_position",
                              1 === this.adTypeCount ? "preroll" : "midroll",
                            )),
                            1 < this.adTypeCount &&
                              (this.tag = (0, u.updateQueryStringParameter)(
                                this.tag,
                          ...
                          var i =
                            ...
                            o =
                              0 <=
                              document.location.search.indexOf(
                                "gdpr-targeting=false",
                              );
                          if (
                            ((this.tag = i
                              ? (0, u.updateQueryStringParameter)(
                                  this.tag,
                                  "npa",
                                  o ? "1" : "0",
                                )
                          ...
                          (this._startSafetyTimer(8e3, "requestAd()"),
                      ...
                      this._onError(
                        "Unable to request ad, google IMA SDK not defined.",
                      );
                  },
                },
                {
                    ...
                    this.adsLoaderPromise
                      .then(function () {
                        (e.adsLoader && e.adsLoader.contentComplete(),
                          ...
                          0 === e.requestAttempts &&
                          "1001spiele.de" === e.parentDomain
                            ? ((0, l.dankLog)(
                                "AD_SDK_REQUEST_ATTEMPT",
                                "Trying to request an advertisement again in 3 seconds...",
                                "warning",
                              ),
                              e.requestAttempts++,
                              setTimeout(function () {
                                ((e.requestRunning = !1), e.requestAd());
                              }, 3e3))
                            : (e._hide(), (e.requestRunning = !1)));
                      })
                      .catch(function () {
                        console.log(
                          new Error("adsLoaderPromise failed to load."),
                        );
                      });
                    var t = "AD_CANCELED";
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.adContainer &&
                      ...
                      setTimeout(function () {
                        ((e.adContainer.style.transform =
                          "translateX(-9999px)"),
                          (e.adContainer.style.zIndex = "0"),
                          e.thirdPartyContainer &&
                            ((e.thirdPartyContainer.style.transform =
                              "translateX(-9999px)"),
                    ...
                    this.adContainer &&
                      ...
                      setTimeout(function () {
                        ((e.adContainer.style.opacity = "1"),
                          e.thirdPartyContainer &&
                            (e.thirdPartyContainer.style.opacity = "1"));
                      }, 10));
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    ((this.adContainer = document.createElement("div")),
                      ...
                      (this.adContainer.style.transform =
                        "translateX(-9999px)"),
                      (this.adContainer.style.backgroundColor =
                        "rgba(0, 0, 0, 0.8)"),
                      (this.adContainer.style.opacity = "0"),
                    ...
                    ((i.id = this.prefix + "advertisement_slot"),
                        ...
                        window.addEventListener("resize", function () {
                          ...
                          ((n.options.width = n.thirdPartyContainer
                            ...
                            (n.options.height = n.thirdPartyContainer
                              ...
                              : t),
                            (i.style.width = n.options.width + "px"),
                            (i.style.height = n.options.height + "px"));
                        }));
                  },
                },
                {
                      ...
                      (this.adDisplayContainer =
                        new google.ima.AdDisplayContainer(
                          document.getElementById(
                            this.prefix + "advertisement_slot",
                          ),
                        )),
                  ...
                  value: function (e) {
                    ...
                    switch (e.type) {
                      ...
                      case google.ima.AdEvent.Type.AD_METADATA:
                        ((t = "AD_METADATA"),
                          (n = "Fired when an ads list is loaded."));
                        break;
                      ...
                      case google.ima.AdEvent.Type.CLICK:
                        ((t = "CLICK"), (n = "Fired when the ad is clicked."));
                        break;
                      case google.ima.AdEvent.Type.COMPLETE:
                        ((t = "COMPLETE"),
                          (n = "Fired when the ad completes playing."));
                        break;
                      ...
                      case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:
                        ((t = "CONTENT_RESUME_REQUESTED"),
                          ...
                          this.adsLoaderPromise
                            .then(function () {
                              if (
                                (i.adsLoader && i.adsLoader.contentComplete(),
                                i.adsManager && i.adsManager.destroy(),
                                1 === i.adCount)
                              ) {
                                var t = [];
                                ...
                                var e = i.category.toLowerCase();
                                i._loadDisplayAd(i.gameId, t, e);
                              }
                              i.requestRunning = !1;
                              var n = "AD_SDK_FINISHED";
                              i.eventBus.broadcast(n, {
                                name: n,
                      ...
                      case google.ima.AdEvent.Type.DURATION_CHANGE:
                        ((t = "DURATION_CHANGE"),
                          (n = "Fired when the ad's duration changes."));
                        break;
                      ...
                      case google.ima.AdEvent.Type.LOADED:
                        ((t = "LOADED"), (n = e.getAd().getContentType()));
                        break;
                      ...
                      case google.ima.AdEvent.Type.MIDPOINT:
                        ((t = "MIDPOINT"),
                          (n = "Fired when the ad playhead crosses midpoint."));
                        break;
                      case google.ima.AdEvent.Type.PAUSED:
                        ((t = "PAUSED"), (n = "Fired when the ad is paused."));
                        break;
                      case google.ima.AdEvent.Type.RESUMED:
                        ((t = "RESUMED"),
                          (n = "Fired when the ad is resumed."));
                        break;
                      ...
                      case google.ima.AdEvent.Type.SKIPPED:
                        ((t = "SKIPPED"),
                          (n = "Fired when the ad is skipped by the user."));
                        break;
                      case google.ima.AdEvent.Type.STARTED:
                        ((t = "STARTED"),
                          (n = "Fired when the ad starts playing."));
                        break;
                      ...
                      case google.ima.AdEvent.Type.USER_CLOSE:
                        ((t = "USER_CLOSE"),
                          (n = "Fired when the ad is closed by the user."));
                        break;
                      case google.ima.AdEvent.Type.VOLUME_CHANGED:
                        ((t = "VOLUME_CHANGED"),
                          (n = "Fired when the ad volume has changed."));
                        break;
                      case google.ima.AdEvent.Type.VOLUME_MUTED:
                        ((t = "VOLUME_MUTED"),
                          (n = "Fired when the ad volume has been muted."));
                    }
                    "" !== t &&
                      "" !== n &&
                      this.eventBus.broadcast(t, {
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    ((0, l.dankLog)(
                      "AD_SAFETY_TIMER",
                      "Invoked timer from: " + t,
                      "success",
                    ),
                      (this.safetyTimer = window.setTimeout(function () {
                        var e = "AD_SAFETY_TIMER";
                        (n.eventBus.broadcast(e, {
                          name: e,
                    ...
                    (d.parentNode.insertBefore(s, d),
                      ...
                      googletag.cmd.push(function () {
                        ...
                        ((e[0] = googletag
                          ...
                          googletag.pubads().setTargeting("crossid", t),
                          googletag.pubads().setTargeting("crosstags", n),
                          googletag.pubads().setTargeting("crosscategory", i),
                          googletag.pubads().disableInitialLoad(),
                          googletag.enableServices(),
                          googletag.display(o.prefix + "baguette"),
                          googletag.pubads().refresh([e[0]]));
                      }));
                  },
                },
              ]),
    ...
    9: [
      function (e, t, n) {
        ...
        var a =
          "object" ===
            ("undefined" == typeof GD_OPTIONS ? "undefined" : o(GD_OPTIONS)) &&
          GD_OPTIONS
            ? GD_OPTIONS
            : window.gdApi &&
        ...
        (window.gdApi &&
          "object" === o(window.gdApi.q[0][0]) &&
          window.gdApi.q[0][0] &&
          (a.hasOwnProperty("advertisementSettings") ||
            (a.advertisementSettings = {
              autoplay: !0,
            })),
          (window.gdsdk = new s.default(a)),
    ...
    10: [
      function (e, t, n) {
        ...
        var _ = r(e("../package.json")),
          A = r(e("./components/VideoAd")),
          w = r(e("./components/EventBus")),
          o = r(e("./components/ImplementationTest")),
          T = e("./modules/dankLog"),
          D = e("./modules/common");
        ...
        var S = null,
          s = (function () {
            function E(e) {
              ...
              (S = this).options = e ? (0, D.extendDefaults)(t, e) : t;
              var n = _.default.version,
                i = console.log(
              ...
              var o = (0, D.getParentUrl)(),
                s = (0, D.getParentDomain)(),
                a = (0, D.getMobilePlatform)();
              this.whitelabelPartner = !1;
              var d = (0, D.getQueryParams)("xanthophyll");
              d.hasOwnProperty("xanthophyll") &&
                "true" === d.xanthophyll &&
              ...
              try {
                if ("developer.gamedistribution.com" === s) {
                  (localStorage.setItem("gd_debug", !0),
                    localStorage.setItem("gd_midroll", "0"));
                  localStorage.setItem(
                    "gd_tag",
              ...
              ((new Image().src =
                ...
                this.eventBus.subscribe(
                  ...
                  function (e) {
                    if (
                      ...
                      "developer.gamedistribution.com" === s ||
                        !0 === new RegExp("^localhost").test(s))
                    ) {
                      new Image().src = "./" + r.options.gameId;
                      try {
                ...
                (this.videoAdInstance = new A.default(
                  this.options.flashSettings.adContainerId,
                  this.options.prefix,
                  this.options.advertisementSettings,
                )));
              var c = "SDK_GDPR_TRACKING",
                u = "SDK_GDPR_TARGETING",
                l = 0 <= document.location.search.indexOf("gdpr-tracking"),
                h = 0 <= document.location.search.indexOf("gdpr-tracking=true"),
                g = 0 <= document.location.search.indexOf("gdpr-targeting"),
                p =
                  0 <= document.location.search.indexOf("gdpr-targeting=true"),
                f = "",
                m = "",
                v = "",
                y = "";
              ...
              var b = new Promise(function (i) {
                ...
                fetch(t)
                  ...
                  .then(function (e) {
                    if (e.error)
                      (0, T.dankLog)("SDK_GAME_DATA_READY", e.error, "warning");
                    else if (e.success) {
                      var t = {
                      ...
                      if (
                        ((o = (0, D.extendDefaults)(o, t)),
                        (0, T.dankLog)("SDK_GAME_DATA_READY", o, "success"),
                        void 0 !== window.ga &&
                          "b92a4170784248bca2ffa0c08bec7a50" !== o.gameId)
                      )
                        try {
                          var n = [];
                          (o.tags.forEach(function (e) {
                            n.push(e.title.toLowerCase());
                          }),
                            window.ga(
                              "gd.set",
                              "dimension2",
                            ...
                            window.ga("gd.set", "dimension3", n.join(", ")));
                        } catch (e) {
                          console.log(e);
                        }
                    }
                  ...
                  .catch(function (e) {
                    ((0, T.dankLog)("SDK_GAME_DATA_READY", e, "success"), i(o));
                  });
              });
              (b
                .then(function (e) {
                  ((r.videoAdInstance.gameId = e.gameId),
                    (r.videoAdInstance.category = e.category),
                    (r.videoAdInstance.tags = e.tags));
                  var t = "" !== a ? "&ad_type=image" : "",
                    n = "";
                  ((n =
                    (!navigator.userAgent.match(/Crosswalk/i) &&
                      void 0 === window.cordova) ||
                    "m.hopy.com" !== s
                      ? "page_url=" + encodeURIComponent(o)
                      : "bundle=com.hopy.frivgames"),
                    (r.videoAdInstance.tag =
                      "https://pub.tunnl.com/opp?" +
                      n +
                      "&player_width=640&player_height=480" +
                      t +
                      "&os=" +
                      a +
                      "&game_id=" +
                  ...
                  (e.advertisements &&
                    (e.preroll
                      ? r.videoAdInstance.options.autoplay && r._createSplash(e)
                      : (r.adRequestTimer = new Date())),
                    r.videoAdInstance.start());
                })
                .catch(function () {
              ...
              i(E, [
                {
                  key: "_onEvent",
                  value: function (e) {
                    (0, T.dankLog)(e.name, e.message, e.status);
                    try {
                      void 0 !== window.ga &&
                        e.analytics &&
                        window.ga("gd.send", {
                          hitType: "event",
                          eventCategory: e.analytics.category
                            ? e.analytics.category
                            : "",
                          eventAction: e.analytics.action
                            ? e.analytics.action
                            : "",
                          eventLabel: e.analytics.label
                            ? e.analytics.label
                            : "",
                        });
                    } catch (e) {
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      var c = (0, D.getCookie)("brzcrz_local");
                      c &&
                        (window.ga("gd.set", "userId", c),
                        window.ga("gd.set", "dimension1", c));
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    n = n
                      ? "https://img.gamedistribution.com/" + n.name
                    ...
                    ((a.innerHTML = s),
                      (a.id = this.options.prefix + "splash"),
                      a.addEventListener("click", function () {
                        t.showBanner();
                      }));
                    var d = this.options.flashSettings.splashContainerId
                      ? document.getElementById(
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.readyPromise
                      .then(function (e) {
                        e.advertisements && !t.whitelabelPartner
                          ? void 0 !== t.adRequestTimer
                            ? new Date().valueOf() -
                                t.adRequestTimer.valueOf() <
                              e.midroll
                              ? ((0, T.dankLog)(
                                  "SDK_SHOW_BANNER",
                              ...
                              : ((0, T.dankLog)(
                                ...
                                (t.adRequestTimer = new Date()),
                                (t.videoAdInstance.requestAttempts = 0),
                                t.videoAdInstance.requestAd())
                            : ((0, T.dankLog)(
                                "SDK_SHOW_BANNER",
                      ...
                      .catch(function (e) {
                        (0, T.dankLog)("SDK_SHOW_BANNER", e, "error");
                      });
                  },
                },
                {
    ...
    11: [
      function (e, t, n) {
        ...
        (Object.defineProperty(n, "__esModule", {
            ...
            if (-1 !== document.referrer.indexOf("gameplayer.io")) {
              ...
              if (n) {
                ...
                "" !== i &&
                  ...
                  "{spilgames}" !== i &&
                  "{portal name}" !== i &&
                  ((t = -1 === (i = s(i)).indexOf("http") ? "http://" + i : i),
          ...
          (n.getQueryParams = r),
          (n.updateQueryStringParameter = function (e, t, n) {
