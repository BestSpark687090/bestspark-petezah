var MainGame = {
  ...
  api_GameContinue: function (withReward) {
    ...
    if (
      withReward &&
      (MainGame.selectedReward == "freeCar" ||
        MainGame.selectedReward == "reward_wheel")
    ) {
    } else {
  ...
  loadSaves: function () {
    MainGame.amount_coins = MainGame.Storage.get(
      MainGame.title + "-" + "amount_coins",
    );
    MainGame.amount_diamonds = MainGame.Storage.get(
      MainGame.title + "-" + "amount_diamonds",
    );
    MainGame.exp = MainGame.Storage.get(MainGame.title + "-" + "exp");
    MainGame.nextCarLevel = MainGame.Storage.get(
      MainGame.title + "-" + "nextCarLevel",
    );
    MainGame.currentLevel = MainGame.Storage.get(
      MainGame.title + "-" + "currentLevel",
    );
    MainGame.LIMIT_parking = MainGame.Storage.get(
      MainGame.title + "-" + "LIMIT_parking",
    );
    MainGame.LIMIT_pilots = MainGame.Storage.get(
      MainGame.title + "-" + "LIMIT_pilots",
    );
    MainGame.box_have = MainGame.Storage.get(MainGame.title + "-" + "box_have");
    MainGame.arDeltaCarLevel = MainGame.Storage.get(
      MainGame.title + "-" + "arDeltaCarLevel",
    );
    MainGame.lastSession = MainGame.Storage.get(
      MainGame.title + "-" + "lastSession",
    );
    MainGame.cdBonusCoins = MainGame.Storage.get(
      MainGame.title + "-" + "cdBonusCoins",
    );
    MainGame.cdBonusSpeed = MainGame.Storage.get(
      MainGame.title + "-" + "cdBonusSpeed",
    );
    MainGame.buffer_boxes = MainGame.Storage.get(
      MainGame.title + "-" + "buffer_boxes",
    );
    MainGame.freeTimeWheel = MainGame.Storage.get(
      MainGame.title + "-" + "freeTimeWheel",
    );
    MainGame.cdNextFree = MainGame.Storage.get(
      MainGame.title + "-" + "cdNextFree",
    );
    MainGame.selectedGun = MainGame.Storage.get(
      MainGame.title + "-" + "selectedGun",
    );
    MainGame.selectedHat = MainGame.Storage.get(
      MainGame.title + "-" + "selectedHat",
    );
    MainGame.arHatsHave = MainGame.Storage.get(
      MainGame.title + "-" + "arHatsHave",
    );
    MainGame.fireLevel = MainGame.Storage.get(
      MainGame.title + "-" + "fireLevel",
    );
    MainGame.levelEarning = MainGame.Storage.get(
      MainGame.title + "-" + "levelEarning",
    );
    MainGame.levelDiscount = MainGame.Storage.get(
      MainGame.title + "-" + "levelDiscount",
    );
  ...
  saveSaves: function () {
    ...
    MainGame.Storage.set(
      MainGame.title + "-" + "amount_coins",
      MainGame.amount_coins,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "amount_diamonds",
      MainGame.amount_diamonds,
    );
    MainGame.Storage.set(MainGame.title + "-" + "exp", MainGame.exp);
    MainGame.Storage.set(
      MainGame.title + "-" + "nextCarLevel",
      MainGame.nextCarLevel,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "currentLevel",
    ...
    MainGame.Storage.set(
      MainGame.title + "-" + "LIMIT_parking",
      MainGame.LIMIT_parking,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "LIMIT_pilots",
      MainGame.LIMIT_pilots,
    );
    ...
    MainGame.Storage.set(
      MainGame.title + "-" + "lastSession",
      MainGame.lastSession,
    );
    MainGame.Storage.set(MainGame.title + "-" + "language", MainGame.language);
    MainGame.Storage.set(
      MainGame.title + "-" + "cdBonusCoins",
      MainGame.cdBonusCoins,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "cdBonusSpeed",
      MainGame.cdBonusSpeed,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "buffer_boxes",
    ...
    MainGame.Storage.set(
      MainGame.title + "-" + "selectedGun",
      MainGame.selectedGun,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "selectedHat",
      MainGame.selectedHat,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "arHatsHave",
      MainGame.arHatsHave,
    ...
    MainGame.Storage.set(
      MainGame.title + "-" + "levelEarning",
      MainGame.levelEarning,
    );
    MainGame.Storage.set(
      MainGame.title + "-" + "levelDiscount",
      MainGame.levelDiscount,
    );
  },
  clearSaves: function () {
  ...
  manage: function (type, mode, game, button, label) {
    switch (mode) {
      case "init": {
        ...
        MainGame.Sfx.status[type] = MainGame.Storage.get(
          MainGame.title + "-" + type,
        );
        if (type == "sound") {
          MainGame.Sfx.sounds = [];
          ...
          MainGame.Sfx.sounds["offline_earning"] =
            game.sound.add("offline_earning3");
          ...
          MainGame.Sfx.sounds["merge"].volume = 0.8;
          MainGame.Sfx.sounds["open_box"].volume = 0.5;
          MainGame.Sfx.sounds["buy"].volume = 0.7;
          ...
          MainGame.Sfx.sounds["autorifle"].volume = 0.7;
          MainGame.Sfx.sounds["autorifle2"].volume = 0.9;
          MainGame.Sfx.sounds["autorifle3"].volume = 0.7;
          MainGame.Sfx.sounds["pistol"].volume = 0.7;
          MainGame.Sfx.sounds["pistol2"].volume = 0.7;
          MainGame.Sfx.sounds["pistol3"].volume = 0.7;
          MainGame.Sfx.sounds["pistol4"].volume = 0.7;
          MainGame.Sfx.sounds["rifle"].volume = 0.7;
          MainGame.Sfx.sounds["rifle2"].volume = 0.7;
          MainGame.Sfx.sounds["rifle3"].volume = 0.7;
          MainGame.Sfx.sounds["rifle4"].volume = 0.9;
          MainGame.Sfx.sounds["rifle5"].volume = 0.9;
          MainGame.Sfx.sounds["shotgun"].volume = 0.7;
          MainGame.Sfx.sounds["shotgun2"].volume = 0.7;
          MainGame.Sfx.sounds["shotgun3"].volume = 0.7;
          MainGame.Sfx.sounds["sniper"].volume = 0.7;
          MainGame.Sfx.sounds["sniper2"].volume = 0.7;
          MainGame.Sfx.sounds["sniper3"].volume = 0.7;
          MainGame.Sfx.sounds["sniper4"].volume = 0.7;
          MainGame.Sfx.sounds["sniper5"].volume = 0.7;
        } else {
...
Bot = function (game, vLayer, vX, vY, vSkin, vLine, vBrain) {
  ...
  this.isAim = false;
  this.isPrised = false;
  this.hero.setMix("run", "sitrun", 0.1);
  this.hero.setMix("run", "idle", 0.12);
  this.hero.setMix("idle", "run", 0.12);
  this.hero.setMix("idle", "sit", 0.08);
  this.hero.setMix("sit", "idle", 0.08);
  this.hero.setMix("sit", "sitrun", 0.18);
  this.hero.setMix("sitrun", "sit", 0.18);
  ...
  this.hpBar_crop = new Phaser.Geom.Rectangle(
    0,
    0,
    hp_bar2.width,
    hp_bar2.height,
...
Bot.prototype.changePosition = function () {
  ...
  if (Math.abs(nPos - cPos) < 2)
    isBarrelNext = this.arrRespawns.indexOf(nPos) != -1;
...
Bot.prototype.updateStatus = function () {
  ...
  switch (this.status) {
    ...
    case STATUS_AIMING:
      ...
      this.tickStrike_max = 150 - Math.round(MainGame.fireLevel * 0.5);
    ...
    case STATUS_STRIKE:
      this.game.botShoot(
        this.skin,
        this.level,
        this.hero.x + this.offsetFlash * this.hero.scaleX,
        this.hero.y - 75,
      );
...
Bot.prototype.updateAction = function (vAction) {
  switch (vAction) {
    ...
    case ACTION_RELOAD:
      ...
      this.isAim = false;
      this.timerReloading = this.game.time.delayedCall(
        2e3,
...
Bot.prototype.damage = function (vValue) {
  ...
  if (this.health <= 0) {
    ...
    if (
      (this.level == 1 && MyMath.randomChance(0.2)) ||
      (this.level == 2 && MyMath.randomChance(0.5)) ||
      (this.level == 3 && MyMath.randomChance(0.8))
    ) {
...
class Boot extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "bg_mergegunfire3",
      "assets/background/bg_mergegunfire3.png",
    );
    this.load.bitmapFont(
      "Panton",
      "assets/fonts/Panton40.png",
      "assets/fonts/Panton40.fnt",
    );
  }
  create() {
    MainGame.world = {
...
class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    const midX = MainGame.Config.DEFAULT_WIDTH * 0.5;
    ...
    this.preloader_crop = new Phaser.Geom.Rectangle(
      0,
      0,
      0,
      this.preloader_bar.height,
    );
    ...
    if (!MainGame.isFromTutorial) {
      if (MainGame.fireLevel == 1) {
        resources["image"].push([
          "bg_mergegunfire2",
          "assets/background/bg_mergegunfire2.png",
        ]);
        resources["atlas"].push(
          [
            "ss_shooter",
            "assets/spritesheets/ss_shooter.png?r=1",
            "assets/spritesheets/ss_shooter.json?r=" +
              MyMath.getRandomInt(0, 99),
          ],
          [
            "ss_ui",
            "assets/spritesheets/ss_ui.png?r=1",
            "assets/spritesheets/ss_ui.json?r=" + MyMath.getRandomInt(0, 99),
          ],
        );
        resources["spine"].push(
          [
            "skeleton",
            "assets/spine/skeleton.json",
            "assets/spine/skeleton.atlas",
          ],
          [
            "spine_shooter",
            "assets/spine/spine_shooter.json",
            "assets/spine/spine_shooter.atlas",
          ],
        );
        resources["audio"].push([
          "music-shoot",
          ["assets/audio/music/music_shoot.mp3"],
        ]);
      } else {
        resources["image"].push(
          ["bg_mergegunfire2", "assets/background/bg_mergegunfire2.png"],
          ["bg_game", "assets/background/bg_game.png"],
        );
        resources["atlas"].push(
          [
            "ss_shooter",
          ...
          [
            "ss_main",
            "assets/spritesheets/ss_main.png?r=1",
            "assets/spritesheets/ss_main.json?r=" + MyMath.getRandomInt(0, 99),
          ],
        );
        resources["spine"].push(
          [
          ...
          [
            "spine_main",
            "assets/spine/spine_main.json",
            "assets/spine/spine_main.atlas",
          ],
        );
        resources["audio"].push(
          ["music-main", ["assets/audio/music/music_game.mp3"]],
          ["music-shoot", ["assets/audio/music/music_shoot.mp3"]],
        );
      }
    } else {
      ...
      resources["audio"].push([
        "music-main",
        ["assets/audio/music/music_game.mp3"],
      ]);
    }
  ...
  updateCamera() {
    ...
    var deltaX = Math.ceil(this.parent.width - this.sizer.width) * 0.5;
    var deltaY = Math.ceil(this.parent.height - this.sizer.height) * 0.5;
    var sdvigY = 0;
    if (window.innerHeight < MainGame.Config.MAX_HEIGHT) {
      deltaY = Math.ceil(window.innerHeight - this.sizer.height) * 0.5;
...
class Game extends Phaser.Scene {
  ...
  create() {
    ...
    MainGame.GAME_TEXT =
      MainGame.TEXT_FILE[MainGame.languages[MainGame.language]];
    this.initResize();
    this.midX = this.GAME_WIDTH / 2;
    this.midY = this.GAME_HEIGHT / 2;
    ...
    this.race_start = this.add.image(
      this.midX - 260,
      480,
      "ss_main",
      "icon_parking_0000",
    ...
    if (MainGame.lastSession && earning_sec > 0) {
      ...
      var countAddFree = Math.floor(
        secondsFromLastSession / this.TIME_NEXT_FREE,
      );
      var secondsDiff =
        Math.floor(secondsFromLastSession) % this.TIME_NEXT_FREE;
      if (countAddFree > 0) {
        ...
        if (MainGame.cdNextFree != null) {
          ...
          if (this.countDownNextFree < 0) {
            ...
            this.countDownNextFree =
              this.TIME_NEXT_FREE - Math.abs(this.countDownNextFree);
          }
        } else {
      ...
      var add_money = Math.round(
        earning_sec * secondsFromLastSession * this.OFFLINE_EARNING,
      );
  ...
  updateSpineMan() {
    ...
    var ar_rifle = [
      7, 8, 9, 10, 11, 12, 13, 14, 15, 18, 19, 22, 23, 24, 25, 26, 27, 28, 29,
      30, 34, 36, 38, 39, 40, 41, 44, 45, 46, 48, 49, 50,
    ];
    ...
    if (MainGame.selectedGun > 0)
      this.stick_man.setSkinByName("gun" + MainGame.selectedGun);
  ...
  updateArmHelp() {
    ...
    for (var i = 0; i < this.LIMIT_parking; i++) {
      ...
      if (parking.type > 0 && parking.type < this.MAX_TYPES_CAR) {
        if (
          parking.obj &&
          parking.obj.count_box_tween != null &&
          parking.obj.count_box_tween <= 0
        ) {
          valuesTypes.push({
            id: parking.id,
            type: parking.type,
  ...
  initTutorial() {
    ...
    this.textTutorial.setOrigin(0.5);
  ...
  updateCamera() {
    ...
    camera.centerOn(
      this.GAME_WIDTH / 2,
      this.GAME_HEIGHT / 2 + offsetY + sdvigY,
    );
  }
  getCarCoins(vNum) {
  ...
  testGetPrices(vValue) {
    ...
    var price2;
    var needPriceAr = [
      0, 100, 1500, 4800, 14880, 46130, 143e3, 443300, 1418560, 4539392,
      14526054, 46483372, 148746792, 475989737, 1523167159, 4874134911,
      15597231715, 49911141488, 159715652763, 511090088843, 1635488284299,
      5233562509759, 0xf3b4ed46bfd, 53591680099934, 0x9bf8e9c6e12e,
      548778804223328,
    ];
  ...
  convertNumberFormat(number) {
    ...
    var toround =
      highnumber == true ? (p_atomepersecond == true ? 100 : 100) : 10;
  ...
  initSettingsGame() {
    ...
    this.DEPTH_text_pilots = 0.015;
    this.DEPTH_icon_pilots = 0.016;
    this.DEPTH_racing_car = 0.017;
    this.DEPTH_platform = 0.018;
    this.DEPTH_hightlight = 0.019;
    this.DEPTH_cars = 0.02;
    this.DEPTH_iconreturn = 0.021;
    this.DEPTH_effect_unboxing = 0.022;
    this.DEPTH_GUI = 0.1;
    this.DEPTH_text_coins = 0.2;
    this.DEPTH_text_field = 0.21;
    this.DEPTH_helicopter = 0.22;
    this.DEPTH_layerMainButtons = 0.24;
    this.DEPTH_layerLevelBar = 0.25;
    this.DEPTH_cursorcar = 0.26;
    this.DEPTH_layerMerge = 0.3;
    this.DEPTH_layerUnlock = 0.31;
    this.DEPTH_layerShop = 0.5;
    this.DEPTH_systemtext = 0.6;
    this.countDownRebootBonusSpeed = 0;
    this.countDownBonusSpeed = 0;
    this.countDownBonusCoins = 0;
    this.countDownNextFree = 0;
    this.VALUE_SELL = 0.25;
    this.DELTA_PRICE = 1.15;
    this.OFFLINE_EARNING = 0.2;
  ...
  timeToHelicopter() {
    ...
    if (
      !this.isShowHelicopter &&
      !this.gameGUI.layerBoosterWindow.visible &&
      !this.isBoostTimer
    ) {
      this.showHelicopter();
    }
  ...
  activateBoost(vTime) {
    ...
    this.gameGUI.updateIndcatorBoostCoins(
      this.secToHHMMSS(this.countDownBonusCoins),
    );
    ...
    if (this.exp >= this.exp_max) {
      ...
      if (vShowLater) {
        ...
        this.time.delayedCall(
          500,
          this.gameGUI.showLevelUpWindow,
          [],
          this.gameGUI,
        );
      }
  ...
  updateSpeedValue(isForRewardCoins) {
    ...
    this.gameGUI.updateSpeedValue(
      converted_value + "/" + MainGame.GAME_TEXT.sec.toUpperCase(),
    );
    return total_speed;
  }
  initEffects() {
  ...
  actionMerge(toParking, fromParking, vType) {
    ...
    if (this.nextCarLevel == nextType) {
      if (MainGame.isAPI) MainGame.API_POKI.happyTime(0.5);
      ...
      for (var i = 0; i < this.LIMIT_parking; i++) {
        ...
        if (dist < this.DISTANCE_DRAG) {
          if (
            parking.obj &&
            parking.busy &&
            this.selectedCar.id != parking.id
          ) {
            if (
              this.selectedCar.type == parking.type &&
              parking.type < this.MAX_TYPES_CAR
            ) {
              ...
              this.actionSwap(
                parking,
                this.arParking[this.selectedCar.id],
                pos.x,
                pos.y,
              );
              action_detected = true;
  ...
  getInputPosition(pointer) {
    const deltaX = Math.ceil(this.parent.width - this.sizer.width) * 0.5;
    const deltaY = Math.ceil(this.parent.height - this.sizer.height) * 0.5;
    const scaleX = this.sizer.width / this.GAME_WIDTH;
    const scaleY = this.sizer.height / this.GAME_HEIGHT;
    const zoom = Math.max(scaleX, scaleY);
  ...
  openBox(vParking, vIsAnimScale) {
    ...
    if (vIsAnimScale) {
      ...
      effect.setDepth(this.DEPTH_effect_unboxing);
      vObj.setScale(this.getScaleCar(0.3));
      vObj.setAlpha(0.5);
      this.tweens.add({
        targets: vObj,
  ...
  addObject(data, vIsSound) {
    ...
    if (free_park_num >= 0) {
      ...
      var car = this.add.image(
        park_place.x + this.CARS_OFFSET.x,
        park_place.y + this.CARS_OFFSET.y,
        "ss_main",
        "icon_f" + num + "_0000",
      );
      ...
      if (!data.alreadyRacing && (data.parkingId == null || data.skinBox)) {
        ...
        car.setScale(this.getScaleCar(0.3));
        car.setAlpha(0.5);
        this.tweens.add({
          targets: car,
          scale: this.getScaleCar(1),
  ...
  getTypeBetterPrice() {
    ...
    switch (vLvl) {
      ...
      case 8:
        ...
        var type = vLvl - 5;
        if (price1 > price2 * 0.5) type = vLvl - 4;
        return type;
        break;
      default:
        ...
        var type = vLvl - 6;
        if (price1 > price2 * 0.5) type = vLvl - 5;
        if (price2 > price3 * 0.5) type = vLvl - 4;
        return type;
        break;
    }
  }
  ...
  setSpriteText(vLayer, vNum) {
    ...
    for (var n in arrayOfNum) {
      symb = this.add.image(
        ...
        0,
        "ss_main",
        "num_" + arrayOfNum[n] + "_0000",
      );
      symb.setScale(0.72);
      symb.setOrigin(0, 0.5);
      vLayer.add(symb);
      symsAr.push(symb);
      length += symb.displayWidth - 2;
    }
    var offsetX = 0;
    var totalLength = Math.floor(length * 0.5);
    for (var s in symsAr) {
  ...
  updateDebugCircle(obj, vX, vY, progress) {
    ...
    this.debugCircles.arc(
      vX,
      vY + 25,
      12,
      Phaser.Math.DegToRad(270.01),
      Phaser.Math.DegToRad((270 + progress * 3.6) % 360),
      false,
    );
  ...
  addParking(vData) {
    var icon_parking = this.add.image(
      vData.x,
      vData.y,
      "ss_main",
      "icon_parking_0000",
    );
    var highlighter = this.add.image(
      vData.x + this.HIGHLIGHTER_OFFSET.x,
      vData.y + this.HIGHLIGHTER_OFFSET.y,
      "ss_main",
      "highlighted_car_0000",
    );
    var icon_panel_number = this.add.image(
      vData.x,
      vData.y,
      "ss_main",
      "panel_number_0000",
  ...
  updateTimerBonusSpeed() {
    ...
    this.gameGUI.updateIndcatorBoostSpeed(
      this.secToHHMMSS(this.countDownBonusSpeed),
    );
  ...
  onInputUpShop(pointer) {
    ...
    this.dragging = false;
    this.current_pos.y = this.limit(
      this.current_pos.y + this.pressed_pos.y - pos.y,
    );
    if (this.fling_enabled) {
      ...
      var delta = distance * Math.exp(-delta_time / this.timeConstant) * 0.2;
  ...
  updateScrollMap() {
    if (!this.dragging && this.fling_enabled && Math.abs(this.fling.y) > 0) {
      ...
      this.fling.y = MyMath.lerp(this.fling.y, 0, 0.04);
      if (Math.abs(this.fling.y) < 0.5) {
        this.fling.y = 0;
      }
    }
  }
  initShop() {
    ...
    var buttonShopTab1 = new ButtonText(
      -370 + offsetX,
      -262,
      "ss_ui",
      "btn_shop1_0000",
    ...
    var buttonShopTab2 = new ButtonText(
      -370 + offsetX,
      -262 + 85,
      "ss_ui",
      "btn_shop2_0000",
    ...
    var item1 = this.add.image(
      225 + 3.5 + offsetX,
      25,
      "ss_ui",
      "scroll_bar1_0000",
    );
    var item2 = this.add.image(
      225 + 4 + offsetX,
      25,
      "ss_ui",
      "scroll_bar2_0000",
    ...
    item1.setAngle(90);
    item2.setAngle(90);
    item2.setOrigin(0, 0.5);
    item2.y -= item1.width * 0.5;
    this.itemPrivilege1 = this.addShopItemsTabPrivilegies1(
      -20 + offsetX,
      140 * 1 - 315,
    );
    this.itemPrivilege2 = this.addShopItemsTabPrivilegies2(
      -20 + offsetX,
      140 * 2 - 315,
    );
    this.arShopCars = [];
    ...
    var text_shop = this.addText(
      this.layerShop,
      -190 + offsetX,
      -275,
      MainGame.GAME_TEXT.shop,
      36,
      true,
    );
    MainGame.updateTextWidth(text_shop, 380);
    this.textCoinsShop = this.addText(
      this.layerShop,
      20 + offsetX,
      -275,
      "0",
    ...
    this.layerShopContent.mask = new Phaser.Display.Masks.BitmapMask(
      this,
      graphicsMask,
    );
    ...
    slider.on(
      ...
      (slider, value, percent) => {
        ...
        var newContentY =
          ((slider.height - this.contentHeight) / 100) * scrollPercent;
    ...
    this.input.on(
      ...
      function (pointer, gameObjects, deltaX, deltaY, deltaZ) {
        ...
        MainGame.state.current_pos.y = MainGame.state.limit(
          MainGame.state.current_pos.y + deltaY * 0.5,
        );
  ...
  updatePrivilegiesFactors() {
    ...
    if (lvlEarning > 1) {
      ...
      var num1 = 1 + itemInfo1.value * 0.01;
    ...
    if (lvlDiscount > 1) {
      ...
      var num2 = 1 - itemInfo2.value * 0.01;
  ...
  updatePrivilegiesItems() {
    ...
    text_value = MainGame.replaceText(
      MainGame.GAME_TEXT.increase_proc,
      itemInfo.value,
    ).toUpperCase();
  ...
  addShopItemsTabPrivilegies1(vX, vY) {
    ...
    item.add(plaha);
    var buttonBuy = new ButtonText(
      vX + 95,
      vY + 25,
      "ss_ui",
      "btn_buy_shop_0000",
      this.clickBuyPrivilege1,
      this,
      "",
    );
    item.add(buttonBuy);
  ...
  addShopItemText(vX, vY, vNum) {
    ...
    text_num.setTint(0);
    var textField_earning = this.addText(
      item,
      vX + 22,
      vY - 42,
      MainGame.GAME_TEXT.earning,
      18,
      true,
    );
  ...
  updateShop(value) {
    ...
    this.iconCoinShop.x =
      this.textCoinsShop.x - this.textCoinsShop.width * 0.5 - 35;
  }
  updateShopItem() {
    if (!this.isShopAdded) return;
    var item;
        ...
        if (i > 0 && this.nextCarLevel < i + 6) {
          if (i == this.nextCarLevel - 5) {
            if (this.ALLOW_ADS_CAR) {
              ...
              item.btn_text.setText(
                " " + MainGame.GAME_TEXT.free.toUpperCase() + " ",
              );
              item.btn_text.setTint(16777215);
              ...
              item.btn_back.setFrame("btn_buy_gray_0000");
              item.btn_text.setText(
                MainGame.GAME_TEXT.unlock_car + " " + (i + 5),
              );
              item.btn_text.setTint(16777215);
              MainGame.updateTextWidth(item.btn_text, 100);
              item.btn.disableInput();
          ...
          var price = Math.round(
            this.arCurrentPricesCar[i] * this.factorDiscount,
          );
  ...
  initWheelOptions() {
    this.wheelOptions = {
      ...
      sliceProbability: [0.14, 0.2, 0.02, 0.2, 0.08, 0.12, 0.04, 0.2],
      rotationTime: 3e3,
      rotationTimeRange: {
        min: 3e3,
        max: 4500,
    ...
    switch (vReward) {
      ...
      case "reward_wheel":
        ...
        var rounds = Phaser.Math.Between(
          this.wheelOptions.wheelRounds.min,
          this.wheelOptions.wheelRounds.max,
        );
        var backDegrees = Phaser.Math.Between(
          this.wheelOptions.backSpin.min,
          this.wheelOptions.backSpin.max,
        );
        var degrees =
          (360 / this.wheelOptions.slices) * item +
          Phaser.Math.Between(0, 29) +
          backDegrees;
        var duration1 = this.wheelOptions.rotationTime;
        var duration2 = 1500;
        MainGame.Sfx.play("sound", "lucky_wheel");
        this.gameGUI.tweenWheelFortune(
          rounds,
          degrees,
          backDegrees,
          duration1,
...
GameGUI.prototype.init = function () {
  ...
  this.typeDronBonus = "";
  this.scaleWindow1 = 0.7;
  this.scaleWindow2 = 0.85;
  this.posWindowY = -40;
...
GameGUI.prototype.initMainButtons = function () {
  ...
  var posX = 770;
  var posY = 570;
  var btnFire = new ButtonText(
    250,
    570,
    "ss_ui",
    "btn_fire_0000",
    _this.showShooterScreen,
    _this,
    MainGame.GAME_TEXT.fire,
  );
  ...
  this.buttonFortuna = new Button(
    btnFire.x - 190,
    160 + 90,
    "ss_ui",
    "btn_fortune_0000",
    this.openFortunaWheelWindow,
    _this,
    this,
  );
  this.buttonFortuna.setDepth(_this.DEPTH_GUI);
  this.buttonChangeGun = new Button(
    btnFire.x - 190,
    posY,
    "ss_ui",
    "btn_change_gun_0000",
    this.showSelectGunWindow,
    _this,
    this,
  );
  this.buttonChangeGun.setDepth(_this.DEPTH_GUI);
  this.buttonHat = new Button(
    btnFire.x - 190,
    posY - 110,
    "ss_ui",
    "btn_hat_0000",
  ...
  var buttonAddCar = new ButtonText(
    posX,
    posY,
    "ss_ui",
    "btn_big_0000",
  ...
  var buttonTurbo = new ButtonText(
    posX - 180,
    posY,
    "ss_ui",
    "btn_turbo_0000",
  ...
  var icon_free_fortune = _this.add.image(
    this.buttonFortuna.x + 35,
    this.buttonFortuna.y - 24,
    "ss_ui",
    "icon_adv_0000",
  );
...
GameGUI.prototype.enableMainButtons = function () {
  ...
  _this = this.gameScreen;
  if (_this.isGoTutorial && _this.tutorialStep >= 3 && _this.tutorialStep <= 5)
    return;
...
GameGUI.prototype.initCoinsPanel = function () {
  ...
  var icon_earnings = _this.add.image(
    posX + 220 + 15,
    35,
    "ss_ui",
    "icon_earnings_0000",
  );
  this.textDiamonds = _this.add.bitmapText(
    posX - 235,
    35,
    "Panton",
    "1000",
  ...
  this.textDiamonds.setOrigin(0, 0.5);
  this.textDiamonds.setTint(16777215);
  this.textCoins = _this.add.bitmapText(
    posX - 10,
    35,
    "Panton",
    "192.640K",
  ...
  this.textSpeed = _this.add.bitmapText(
    posX + 140,
    38,
    "Panton",
    "8.177/SEC",
  ...
  this.textSpeed.setOrigin(0.5, 0.5);
  this.textSpeed.setTint(16769280);
  var text_value_earning = _this.add.bitmapText(
    posX + 243 + 15,
    38,
    "Panton",
    "X1.10",
  ...
  text_value_earning.setOrigin(0, 0.5);
  text_value_earning.setTint(16769280);
  var text_earning = _this.add.bitmapText(
    posX + 240 + 15,
    56,
    "Panton",
    MainGame.GAME_TEXT.earning.toUpperCase(),
    16,
  );
  text_earning.setOrigin(0.5, 0.5);
...
GameGUI.prototype.initProgressBar = function () {
  ...
  this.nextcarBarB = _this.add.image(
    midX + offsetX,
    posY,
    "ss_ui",
    "nextcar1_0000",
  );
  this.nextcarBarT = _this.add.image(
    midX + offsetX,
    posY,
    "ss_ui",
    "nextcar2_0000",
  );
  this.iconCircleNextCar = _this.add.image(
    midX + offsetX + 180,
    posY - 3,
    "ss_ui",
    "icon_nextcar_0000",
  );
  this.nextcarBarT_crop = new Phaser.Geom.Rectangle(
    0,
    0,
    0,
    this.nextcarBarT.height,
  );
  this.nextcarBarT.setCrop(this.nextcarBarT_crop);
  this.textProgressNextCar = _this.add.bitmapText(
    midX + 3,
    posY - 10,
    "Panton",
    "0%",
  ...
  this.textProgressNextCar.setOrigin(0.5, 0.5);
  this.textProgressNextCar.setTint(16758784);
  this.textLevelNextCar = _this.add.bitmapText(
    this.iconCircleNextCar.x - 32,
    this.iconCircleNextCar.y,
    "Panton",
    _this.nextCarLevel,
    24,
  );
  this.textLevelNextCar.setOrigin(0.5, 0.5);
  this.textLevelNextCar.setTint(16777215);
  this.textReadyMerge = _this.addText(
    this.layerProgressCar,
    midX,
    posY + 20,
    MainGame.GAME_TEXT.ready_merge,
    18,
    true,
  );
...
GameGUI.prototype.initLevelBar = function () {
  ...
  this.levelBarB = _this.add.image(
    pos.x + 50,
    pos.y + 12,
    "ss_ui",
    "exp1_0000",
  );
  this.levelBarT = _this.add.image(
    pos.x + 50,
    pos.y + 12,
    "ss_ui",
    "exp2_0000",
  );
  this.levelBarT_crop = new Phaser.Geom.Rectangle(
    0,
    0,
    0,
    this.levelBarT.height,
  );
  this.levelBarT.setCrop(this.levelBarT_crop);
  this.textLevel = _this.add.bitmapText(
    pos.x + 6,
    pos.y,
    "Panton",
    _this.currentLevel,
  ...
  this.textLevel.setOrigin(1, 0.5);
  var text_level = _this.addText(
    this.layerPanelLevel,
    pos.x + 18,
    pos.y - 9,
    MainGame.GAME_TEXT.level,
    18,
    true,
  );
  text_level.setOrigin(0, 0.5);
...
GameGUI.prototype.initBasketTrash = function () {
  ...
  var posX = 250;
  var posY = 570;
  this.icon_trash = _this.add.image(
    posX + 210,
    posY,
    "ss_ui",
    "btn_delete_0000",
  );
  this.icon_trash.setScale(0.9);
...
GameGUI.prototype.showSystemMessage = function (vText) {
  ...
  this.textSystemContainer.alpha = 0.2;
  this.textSystemContainer.y = this.midY - 20;
  this.textSystemContainer.setScale(0.8);
...
GameGUI.prototype.updateFastBuy = function () {
  ...
  this.icon_fast_coin.x =
    this.buttonAddCar.text.x - this.buttonAddCar.text.width * 0.5 - 20;
...
GameGUI.prototype.showHelicopter = function () {
  ...
  this.flagHelicopter = Math.random() >= 0.5;
...
GameGUI.prototype.updateHelicopter = function () {
  ...
  if (this.flagHelicopter) {
    this.dron_body.angle =
      Phaser.Math.RadToDeg(Math.sin(this.waveCount) * 0.07) - 5;
    this.dron_box.angle =
      Phaser.Math.RadToDeg(Math.sin(this.waveCount) * 0.25) - 10;
  } else {
    this.dron_body.angle =
      Phaser.Math.RadToDeg(Math.sin(this.waveCount) * 0.07) + 5;
    this.dron_box.angle =
...
GameGUI.prototype.initUpgradeWindow = function () {
  ...
  var panel_number1 = _this.add.image(
    posX - 135 - 50,
    posY - 100,
    "ss_ui",
    "panel_number_0000",
  ...
  var panel_number2 = _this.add.image(
    posX + 135 - 50,
    posY - 100,
    "ss_ui",
    "panel_number_0000",
  ...
  var buttonClose = new Button(
    ...
    "ss_ui",
    "btn_close_0000",
    this.closeUpgadeWindow,
    _this,
    this,
  );
  this.layerUpgradeWindow.add(buttonClose);
  var buttonContinue = new ButtonText(
    0,
    200,
    "ss_ui",
    "btn_buy2_0000",
    _this.showAdsForFreeUpgrade,
    _this,
    MainGame.GAME_TEXT.free,
  );
  ...
  var text_title = _this.addText(
    this.layerUpgradeWindow,
    0,
    -255,
    MainGame.GAME_TEXT.free_upgrade,
    34,
    true,
  );
  MainGame.updateTextWidth(text_title, 400);
  var text_level1 = _this.addText(
    this.layerUpgradeWindow,
    panel_number1.x + 70,
    panel_number1.y - 2,
    MainGame.GAME_TEXT.level,
  ...
  var text_levelGun1 = _this.addText(
    this.layerUpgradeWindow,
    panel_number1.x - 1,
    panel_number1.y - 2,
    "2",
  ...
  var text_levelGun2 = _this.addText(
    this.layerUpgradeWindow,
    panel_number2.x - 1,
    panel_number2.y - 2,
    "4",
...
GameGUI.prototype.initTurboWindow = function () {
  ...
  var window_icon = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "indicator_big_boost_0000",
  );
  ...
  this.turboBarT_crop = new Phaser.Geom.Rectangle(
    0,
    0,
    0,
    this.turboBarT.height,
  );
  ...
  var text_add_turbo_seconds = _this.addText(
    this.layerTurboWindow,
    0,
    140,
    MainGame.GAME_TEXT.add_turbo_seconds,
    22,
    true,
  );
...
GameGUI.prototype.initBoosterWindow = function () {
  ...
  var helicopter_icon = _this.add.image(
    -30,
    -55,
    "ss_ui",
    "helicopter_icon_0000",
  );
  ...
  var text1 = _this.addText(
    this.layerBoosterWindow,
    0,
    -185,
    MainGame.GAME_TEXT.boost_message,
    30,
    true,
  );
  MainGame.updateTextWidth(text1, 380);
  var text2 = _this.addText(
    this.layerBoosterWindow,
    0,
    75,
    MainGame.GAME_TEXT.better_drop,
    24,
    true,
  );
  MainGame.updateTextWidth(text2, 480);
  var text3 = _this.addText(
    this.layerBoosterWindow,
    142,
    -34,
    "X" + _this.value_boost,
  ...
  var text4 = _this.addText(
    this.layerBoosterWindow,
    0,
    75,
    MainGame.GAME_TEXT.guns_4,
    24,
    true,
  );
...
GameGUI.prototype.initSettingsWindow = function () {
  ...
  var buttonMuteMusic = new ButtonText(
    0,
    -80 - 70,
    "ss_ui",
    "btn_buy_0000",
  ...
  var buttonMuteSound = new ButtonText(
    0,
    buttonMuteMusic.y + 70,
    "ss_ui",
    "btn_buy_0000",
    this.clickMuteSound,
    _this,
    MainGame.GAME_TEXT.sound_on,
    null,
    this,
  );
  ...
  var textTitle = _this.addText(
    this.layerSettingsWindow,
    0,
    -255,
    MainGame.GAME_TEXT.settings,
    30,
    true,
  );
  MainGame.updateTextWidth(textTitle, 380);
  var textDevs = _this.addText(
    this.layerSettingsWindow,
    0,
    logo_tbs.y - 80,
    MainGame.GAME_TEXT.developed_by,
    24,
    true,
  );
  MainGame.updateTextWidth(textDevs, 380);
  var textMusic = _this.addText(
    this.layerSettingsWindow,
    0,
    170,
    MainGame.GAME_TEXT.music_by,
    24,
    true,
  );
...
GameGUI.prototype.openSettings = function () {
  ...
  MainGame.Sfx.update(
    "music",
    this.buttonMuteMusic.icon,
    this.buttonMuteMusic.text,
  );
  MainGame.Sfx.update(
    "sound",
    this.buttonMuteSound.icon,
    this.buttonMuteSound.text,
  );
...
GameGUI.prototype.initOfflineEarningWindow = function () {
  ...
  var lvlup_icon = _this.add.image(
    posX + 0,
    posY + 0,
    "ss_ui",
    "offline_coins_0000",
  ...
  var text_offline_earn = _this.addText(
    this.layerOfflineEarningWindow,
    0,
    -255,
    MainGame.GAME_TEXT.offline_earn,
    34,
    true,
  );
  MainGame.updateTextWidth(text_offline_earn, 400);
  var offline_earning_text = _this.addText(
    this.layerOfflineEarningWindow,
    0,
    95,
    "",
  ...
  var buttonClose = new ButtonText(
    0,
    250,
    "ss_ui",
    "btn_buy2_0000",
    this.closeOfflineEarningWindow,
    _this,
    MainGame.GAME_TEXT.tap_continue,
    null,
    this,
  );
  ...
  buttonClose.back.alpha = 0.01;
  var buttonContinue = new ButtonText(
    0,
    170,
    "ss_ui",
    "btn_buy2_0000",
    _this.showAdsForCoinsX2,
    _this,
    MainGame.GAME_TEXT.coins_x2,
  );
  buttonContinue.text.setFontSize(26);
...
GameGUI.prototype.initLevelUpWindow = function () {
  ...
  var icon_newparking = _this.add.image(
    -75,
    105,
    "ss_ui",
    "icon_newparking_0000",
  );
  ...
  var buttonContinue = new ButtonText(
    ...
    "ss_ui",
    "btn_buy_0000",
    this.closeLevelUpWindow,
    _this,
    MainGame.GAME_TEXT.continue,
    null,
    this,
  );
  buttonContinue.text.setFontSize(26);
  ...
  MainGame.updateTextWidth(buttonContinue.text, 200);
  buttonContinue.text.y = -4;
  var text_levelup = _this.addText(
    this.layerLevelUpWindow,
    0,
    -255,
    MainGame.GAME_TEXT.level_up,
    34,
    true,
  );
  MainGame.updateTextWidth(text_levelup, 400);
  var text_getnew = _this.addText(
    this.layerLevelUpWindow,
    0,
    20,
    MainGame.GAME_TEXT.get_new,
    32,
    true,
  );
  MainGame.updateTextWidth(text_getnew, 400);
  this.levelup_text_level = _this.addText(
    this.layerLevelUpWindow,
    posX,
    posY - 15,
    "",
  ...
  var levelup_text_parking = _this.addText(
    this.layerLevelUpWindow,
    icon_newparking.x - 5,
    icon_newparking.y - 35,
    "+1",
    36,
    true,
  );
  var levelup_text_money = _this.addText(
    this.layerLevelUpWindow,
    icon_newmoney.x,
    icon_newmoney.y + 20,
    "",
...
GameGUI.prototype.initMergeAnimation = function () {
  ...
  var car1_merge = _this.add.image(
    this.midX - 160,
    this.midY - 40,
    "ss_main",
    "icon_f1_0000",
  ...
  var car2_merge = _this.add.image(
    this.midX + 160,
    this.midY - 40,
    "ss_main",
    "icon_f1_0000",
  ...
  back_car.setScale(_this.getScaleCar(0.6));
  back_car.setTint(0);
  ...
  MainGame.updateTextWidth(buttonContinue.text, 200);
  buttonContinue.text.y = -4;
  var text_unlocked = _this.addText(
    this.layerUnlocked,
    0,
    0 - 255,
    MainGame.GAME_TEXT.unlocked,
    34,
    true,
  );
  MainGame.updateTextWidth(text_unlocked, 400);
  var text_next = (this.mergeCars_textNext = _this.addText(
    this.layerUnlocked,
    back_car.x,
    back_car.y - 60,
    MainGame.GAME_TEXT.next,
    22,
    true,
  ));
  MainGame.updateTextWidth(text_next, 120);
  this.mergeCars_textQuestion = _this.addText(
    this.layerUnlocked,
    back_car.x,
    back_car.y,
    "?",
  ...
  var text_earning = _this.addText(
    this.layerUnlocked,
    0,
    0 + 100,
    MainGame.GAME_TEXT.earning,
  ...
  this.textEarning = _this.addText(
    this.layerUnlocked,
    0,
    0 + 130,
    "4/" + MainGame.GAME_TEXT.sec,
    22,
  );
...
GameGUI.prototype.showMergeAnimation = function (vType) {
  ...
  this.coin_merge_window.x =
    this.textEarning.x - this.textEarning.width * 0.5 - 15;
...
GameGUI.prototype.initSelectGunWindow = function () {
  ...
  var posX = 0;
  var posY = -10;
  var flash_select_gun = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "flash_select_gun_0000",
  );
  this.layerSelectGunWindow.add(flash_select_gun);
  var gun = _this.add.image(
    posX,
    posY,
    "ss_main",
    "icon_f" + this.selectedGun + "_0000",
  );
  gun.setScale(1.5);
  ...
  var panel_number = _this.add.image(
    posX - 45,
    posY - 140,
    "ss_ui",
    "panel_number_0000",
  ...
  var buttonSelectP = new Button(
    -200,
    posY,
    "ss_ui",
    "btn_prev_0000",
    this.clickSelectGunPrev,
    _this,
    this,
  );
  this.layerSelectGunWindow.add(buttonSelectP);
  var buttonSelectN = new Button(
    200,
    posY,
    "ss_ui",
    "btn_next_0000",
    this.clickSelectGunNext,
    _this,
    this,
  );
  ...
  MainGame.updateTextWidth(buttonContinue.text, 200);
  buttonContinue.text.y = -4;
  var buttonContinueGray = new ButtonText(
    0,
    210,
    "ss_ui",
    "btn_buy3_0000",
  ...
  var text_title = _this.addText(
    this.layerSelectGunWindow,
    0,
    -255,
    MainGame.GAME_TEXT.select_gun,
    34,
    true,
  );
  MainGame.updateTextWidth(text_title, 400);
  ...
  MainGame.updateTextWidth(text_level, 400);
  var text_unlock_after = _this.addText(
    this.layerSelectGunWindow,
    posX,
    posY + 140,
    MainGame.GAME_TEXT.unlock_after,
    22,
    true,
  );
  text_unlock_after.setCenterAlign();
  MainGame.updateTextWidth(text_unlock_after, 400);
  var text_levelGun = _this.addText(
    this.layerSelectGunWindow,
    panel_number.x - 1,
    panel_number.y - 2,
    "1",
...
GameGUI.prototype.initHelmetWindow = function () {
  ...
  this.arBtnHats = [];
  this.btnHat1 = this.addHatButton(
    0,
    offsetX - 140,
    -160,
    this.clickHat,
  ...
  this.btnHat2 = this.addHatButton(
    2,
    offsetX,
    -160,
    this.clickHat,
  ...
  this.btnHat3 = this.addHatButton(
    3,
    offsetX + 140,
    -160,
    this.clickHat,
  ...
  this.btnHat4 = this.addHatButton(
    4,
    offsetX - 140,
    -20,
    this.clickHat,
  ...
  this.btnHat5 = this.addHatButton(
    5,
    offsetX,
    -20,
    this.clickHat,
  ...
  this.btnHat6 = this.addHatButton(
    6,
    offsetX + 140,
    -20,
    this.clickHat,
  ...
  this.btnHat10 = this.addHatButton(
    10,
    offsetX - 140,
    -160,
    this.clickHat,
  ...
  this.btnHat11 = this.addHatButton(
    11,
    offsetX,
    -160,
    this.clickHat,
  ...
  this.btnHat12 = this.addHatButton(
    12,
    offsetX + 140,
    -160,
    this.clickHat,
  ...
  this.btnHat13 = this.addHatButton(
    13,
    offsetX - 140,
    -20,
    this.clickHat,
  ...
  this.btnHat14 = this.addHatButton(
    14,
    offsetX,
    -20,
    this.clickHat,
  ...
  this.btnHat15 = this.addHatButton(
    15,
    offsetX + 140,
    -20,
    this.clickHat,
  ...
  var buttonHelmetTab1 = new ButtonText(
    -370 + offsetX,
    -262,
    "ss_ui",
    "btn_shop1_0000",
  ...
  var buttonHelmetTab2 = new ButtonText(
    -370 + offsetX,
    -262 + 85,
    "ss_ui",
    "btn_shop2_0000",
    this.clickHelmetTab2,
    _this,
    MainGame.GAME_TEXT.epic,
    null,
    this,
  );
  ...
  var text_currency = _this.addText(
    this.layerHelmetWindow,
    coin.x + 40,
    -275,
    "1000",
    36,
  ...
  text_currency.setOrigin(0, 0.5);
  this.buttonBuyHelmet = buttonBuy;
  this.textFieldHelmetWindow = text_currency;
  this.text_buyNew = _this.addText(
    this.layerHelmetWindow,
    offsetX,
    200,
    MainGame.GAME_TEXT.buy_new,
    24,
    true,
  );
...
GameGUI.prototype.addHatButton = function (
  vNum,
  vX,
  vY,
  vCallBack,
...
GameGUI.prototype.updateWindowHelmet = function () {
  ...
  if (this.selectedHelmetTab == 1) {
    ...
    priceNextHelmet =
      MainGame.priceEpic + MainGame.priceEpic * (1 + countEpicHave);
...
GameGUI.prototype.initFortunaWheelWindow = function () {
  ...
  var posX = 0;
  var posY = -25;
  var flash_fortune = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "flash_fortune_0000",
  ...
  var wheel_fortune = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "wheel_fortune_0000",
  ...
  var ramka_fortune = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "ramka_fortune_0000",
  ...
  var arrow_fortune = _this.add.image(
    posX,
    posY - 152,
    "ss_ui",
    "arrow_fortune_0000",
  ...
  var text_title = _this.addText(
    this.layerFortunaWheelWindow,
    0,
    -255,
    MainGame.GAME_TEXT.lucky_wheel,
    34,
    true,
  );
  MainGame.updateTextWidth(text_title, 400);
  var text_free_time = _this.addText(
    this.layerFortunaWheelWindow,
    -150,
    255,
    "",
  ...
  var text_nextfreein = _this.addText(
    this.layerFortunaWheelWindow,
    150,
    255,
    "",
...
GameGUI.prototype.updateFortunaWheelWindow = function (countDownNextFree) {
  var str1 =
    MainGame.GAME_TEXT.free_time +
    " " +
    this.gameScreen.freeTimeWheel +
    "/" +
    MainGame.maxTimeWheel;
...
GameGUI.prototype.tweenWheelFortune = function (
  rounds,
  degrees,
  backDegrees,
  duration1,
...
GameGUI.prototype.initRewardWindow = function () {
  ...
  var iconRewardWindow = _this.add.image(
    posX,
    posY,
    "ss_ui",
    "reward_box6_0000",
  ...
  var text_title = _this.addText(
    this.layerRewardWindow,
    0,
    -185,
    MainGame.GAME_TEXT.reward,
    34,
    true,
  );
...
class Shooter extends Phaser.Scene {
  ...
  create() {
    ...
    this.text_level.setText(
      MainGame.GAME_TEXT.day.toUpperCase() + " " + MainGame.fireLevel,
    );
    this.updateAmmoText();
  ...
  initSettingsGame() {
    ...
    this.MAX_TOP = 90;
    this.MAX_BOTTOM = 550;
    this.DEPTH_layerMob = 0.21;
    this.DEPTH_layerEffect = 0.22;
    this.DEPTH_layerArm = 0.23;
    this.DEPTH_layerUI = 0.24;
    this.DEPTH_layerText = 0.25;
    this.DEPTH_layerFinish = 0.26;
    this.DEPTH_systemtext = 0.6;
    this.aimScale = 2;
  ...
  initPauseWindow() {
    ...
    var posX = 0;
    var posY = -95;
    var buttonResume = new ButtonText(
      0,
      posY,
      "ss_ui",
      "btn_buy2_0000",
    ...
    MainGame.updateTextWidth(buttonMuteSound.text, 140);
    var buttonHome = new ButtonText(
      0,
      buttonMuteSound.y + 80,
      "ss_ui",
      "btn_buy_0000",
      this.showGameScreen,
      this,
      MainGame.GAME_TEXT.home,
    );
    ...
    this.buttonMuteSound.icon = icon_sound;
    var text_title = this.addText(
      this.layerPauseWindow,
      0,
      -185,
      MainGame.GAME_TEXT.paused,
      34,
      true,
    );
    MainGame.updateTextWidth(text_title, 380);
  ...
  initFinishWindow() {
    ...
    var reward_diamond = this.add.image(
      posX,
      posY,
      "ss_ui",
      "reward_diamond_0000",
    ...
    var buttonIncomeX2 = new ButtonText(
      0,
      90,
      "ss_ui",
      "btn_buy2_0000",
      this.showAdsForDiamondsX2,
      this,
      MainGame.GAME_TEXT.income_x2,
    );
    ...
    var buttonGet = new ButtonText(
      0,
      170,
      "ss_ui",
      "btn_buy_g2_0000",
      this.closeFinishWindow,
      this,
      MainGame.GAME_TEXT.get,
    );
    ...
    var text_diamonds = this.addText(
      this.layerFinishWindow,
      posX + 30,
      posY + 30,
      this.rewardDiamonds,
      60,
    ...
    var buttonRevive = new ButtonText(
      0,
      -22,
      "ss_ui",
      "btn_revive_0000",
    ...
    var text_no_give_up = this.addText(
      this.layerFinishWindow,
      0,
      85,
      MainGame.GAME_TEXT.no_give_up,
      22,
      true,
    );
    var text_try_merge_gun = this.addText(
      this.layerFinishWindow,
      0,
      115,
      MainGame.GAME_TEXT.try_merge_gun,
      22,
      true,
    );
  ...
  initGUI() {
    this.layerRed = this.addCanvas(this.layerUI, 8126464, 0.6);
    ...
    var aim_reloading = this.add.image(
      this.posCursor.x,
      this.posCursor.y,
      "ss_shooter",
      "crosshair4_0000",
    ...
    this.hpBarT_crop = new Phaser.Geom.Rectangle(
      0,
      0,
      this.hpBarT.width,
      this.hpBarT.height,
    ...
    text_hp.setOrigin(0, 0.5);
    text_hp.setTint(2286098);
    var text_level = this.addText(
      this.layerText,
      btnExit.x - 60,
      40,
      "",
    ...
    text_level.setOrigin(1, 0.5);
    var text_frags = this.addText(
      this.layerText,
      icon_frag.x + 90,
      icon_frag.y,
      "10/10",
  ...
  checkCombo(vX, vY) {
    ...
    this.showCombo(
      vX,
      vY,
      this.arComboText[this.poolCombo],
      MainGame.GAME_TEXT["combo" + (this.countCombo - 1)],
    );
    this.poolCombo++;
  ...
  testWeapon(vType) {
    ...
    var ar_rifle3 = [
      9, 11, 13, 15, 23, 29, 30, 31, 36, 37, 38, 40, 41, 46, 47, 48, 49, 50,
    ];
  ...
  onInputMove(pointer) {
    ...
    if (!MainGame.isDesktop) {
      this.posCursor.x =
        this.lastPos.x + (this.posCursor.x - this.posInputDown.x) * 1.5;
      this.posCursor.y =
        this.lastPos.y + (this.posCursor.y - this.posInputDown.y) * 1.2;
    }
    var deltaX = 25;
  ...
  updateReloading(vBool) {
    ...
    if (vBool) {
      ...
      this.timerReloading = this.time.delayedCall(
        this.TIME_RELOADING,
  ...
  updateArm() {
    if (this.posCursor) {
      ...
      this.arm_weapon.y -=
        ...
        this.WEAPON_WEIGHT;
      this.effect_shoot.x =
        this.arm_weapon.x - this.offsetWeapon.x + this.offsetFire.x;
      this.effect_shoot.y =
        this.arm_weapon.y - this.offsetWeapon.y + this.offsetFire.y;
    }
    ...
    if (!this.checkBarrels(this.aim_target.x, this.aim_target.y)) {
      for (var i = 0; i < this.countEnemies; i++) {
        ...
        if (target && target.hero && target.isAlive()) {
          ...
          if (dist < 3200) {
            var isUnderBarrel = this.checkBarrels(
              target.hero.x,
              target.hero.y - 20,
            );
            if (isUnderBarrel && target.isPrised) {
            } else {
  ...
  makeShoot(vTarget, vX, vY) {
    ...
    if (this.isAllowShoot) {
      ...
      var posKickX = (vTarget.hero.x + vX) * 0.5;
  ...
  initLevel() {
    ...
    if (MainGame.fireLevel == 1) {
      ...
      if (MainGame.fireLevel >= 3)
        this.time.delayedCall(1e3 * 1, this.addBotStep3, [], this);
      if (MainGame.fireLevel >= 10)
        this.time.delayedCall(1e3 * 2, this.addBotStep4, [], this);
      if (MainGame.fireLevel >= 15)
        this.time.delayedCall(1e3 * 3, this.addBotStep5, [], this);
      if (MainGame.fireLevel >= 20)
        this.time.delayedCall(1e3 * 4, this.addBotStep6, [], this);
      if (MainGame.fireLevel >= 25)
        this.time.delayedCall(1e3 * 5, this.addBotStep7, [], this);
      if (MainGame.fireLevel >= 30)
        this.time.delayedCall(1e3 * 6, this.addBotStep8, [], this);
      if (MainGame.fireLevel >= 60)
        this.time.delayedCall(1e3 * 7, this.addBotStep9, [], this);
      if (MainGame.fireLevel >= 90)
        this.time.delayedCall(1e3 * 8, this.addBotStep10, [], this);
    }
  }
  addBotStep3() {
  ...
  initTutorial() {
    ...
    var tutor_mobile = this.add.image(
      this.midX + 360,
      340,
      "ss_shooter",
      "tutor_mobile_0000",
    ...
    var buttonStart = new ButtonText(
      this.midX,
      this.midY + 20,
      "ss_ui",
      "btn_buy_g2_0000",
  ...
  checkTutorial() {
    if (this.tutorialStep == 1) {
      ...
      if (
        !this.doska2.info.live &&
        !this.doska3.info.live &&
        !this.doska4.info.live &&
        !this.doska5.info.live
      ) {
        this.textTutorial.visible = false;
        this.plahaTutorial.visible = false;
      }
