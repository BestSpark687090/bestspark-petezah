!(function (t) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t) {
      return (
        o(c, t) || (s && o(u, t) ? (c[t] = u[t]) : (c[t] = l("Symbol." + t))),
        c[t]
      );
    };
  },
          ...
          ((s.noConflict = function () {
            ...
            (s.report = (function () {
              ...
              function d(n, e, i, r, d) {
                if (o)
                  ...
                  ((A.func = s.computeStackTrace.guessFunctionName(
                    A.url,
                    A.line,
                  )),
                    (A.context = s.computeStackTrace.gatherContext(
                      A.url,
                      A.line,
                    )),
                    a(
            ...
            (s.computeStackTrace = (function () {
              ...
              function c(t, e, i) {
                ...
                return (
                  (i -= 1),
                  a && a.length > i && (r = s.exec(a[i])) ? r.index : null
                );
              }
              ...
              function m(t) {
                ...
                return p.length
                  ? (p[0] &&
                      ...
                      !p[0].column &&
                      f &&
                      (p[0].column = c(f[1], p[0].url, p[0].line)),
                    {
                      mode: "stack",
                      name: t.name,
                      message: t.message,
                ...
                for (
                  ...
                  if (m !== g && m !== s.report) {
                    if (
                      ...
                      m.name
                        ? (r.func = m.name)
                        : (e = a.exec(m.toString())) && (r.func = e[1]),
                      void 0 === r.func)
                    )
                      try {
                      ...
                      if (n) {
                        for (
                          ...
                          if (
                            ...
                            if (
                              (!u.func && u.line && (u.func = i(u.url, u.line)),
                              u.line)
                            )
                              try {
              ...
              return (
                (g.augmentStackTraceWithInitialElement = p),
            ...
            (!s.linesOfContext || s.linesOfContext < 1) &&
              (s.linesOfContext = 11),
            (r = []),
            void 0 === (o = "function" == typeof (i = s) ? i.apply(n, r) : i) ||
              (t.exports = o));
        }
  ...
  function (t, n, e) {
    ...
    (t.exports = function (t, n, e, u, l) {
      ...
      if (l) A = t;
        ...
        if ("function" != typeof (m = s(t)))
          throw TypeError("Target is not iterable");
        if (r(m)) {
          for (p = 0, f = o(t.length); f > p; p++)
            if ((g = u ? y(i((w = t[p]))[0], w[1]) : y(t[p])) && g instanceof c)
              return g;
          return new c(!1);
        }
        A = m.call(t);
      ...
      for (h = A.next; !(w = h.call(A)).done; )
        if ("object" == typeof (g = d(A, y, w.value, u)) && g && g instanceof c)
          return g;
      return new c(!1);
    }).stop = function (t) {
      return new c(!0, t);
      ...
      if (
        (B &&
          ...
          p !== Object.prototype &&
            ...
            (l ||
              o(k) === p ||
              (a ? a(k, p) : "function" != typeof k[g] && d(k, g, h)),
            s(k, E, !0, !0),
            l && (A[E] = h))),
        "values" == m &&
          z &&
  ...
  function (t) {
    t.exports = JSON.parse(
      '{"a":"https://game-cdn.poki.comsa/scripts/prebid/2.44.4-0.js"}',
    );
  },
  function (t, n, e) {
    e(69);
  ...
  function (t, n, e) {
    ...
    t.exports =
      ...
      r(function () {
        ...
        ? function (t, n) {
            for (
              var e = d(t), r = arguments.length, u = 1, l = a.f, A = s.f;
              r > u;
              ...
              for (
                var m,
                  p = c(arguments[u++]),
                  f = l ? o(p).concat(l(p)) : o(p),
                  g = f.length,
                  h = 0;
                g > h;

              )
                ((m = f[h++]), (i && !A.call(p, m)) || (e[m] = p[m]));
            return e;
          }
        : u;
  },
  ...
  function (t, n, e) {
    ...
    t.exports = i
      ...
      : function (t, n) {
          o(t);
          for (var e, i = a(n), s = i.length, d = 0; s > d; )
            r.f(t, (e = i[d++]), n[e]);
          return t;
        };
  },
  ...
  function (t, n, e) {
    ...
    var i,
      ...
      Y = function (t, n, e) {
        var i, r;
        (W
          ? (((i = F.createEvent("Event")).promise = n),
            (i.reason = e),
            i.initEvent(t, !1, !0),
            c.dispatchEvent(i))
          : (i = {
          ...
          (r = c["on" + t])
            ...
            : "unhandledrejection" === t &&
              z("Unhandled promise rejection", e));
      },
      $ = function (t, n) {
        E.call(c, function () {
          var e,
          ...
          if (
            ...
            ((e = B(function () {
              U
                ? H.emit("unhandledRejection", i, t)
                : Y("unhandledrejection", t, i);
            })),
    ...
    (V &&
      ...
      (r = function () {
        var t = new i(),
          n = j(t);
        ((this.promise = t),
          (this.resolve = et(rt, t, n)),
          (this.reject = et(it, t, n)));
      }),
      (C.f = X =
        function (t) {
  ...
  function (t, n, e) {
          ...
          ads: {
            status: {
              ...
              manualSkipButtonPressed:
                "pokiTrackingAdsStatusManualSkipButtonPressed",
              minimizeButtonPressed:
                "pokiTrackingAdsStatusMinimizeButtonPressed",
            },
            video: {
          ...
          (t.dispatchEvent = function (t, n) {
            (void 0 === n && (n = {}),
              !this.debug ||
                ...
                console.info(t, n));
            for (
              var e = Object.keys(this.listeners), i = 0;
              i < e.length;
              i++
            ) {
              var r = e[i];
              if (t === r)
                for (var o = this.listeners[r], a = 0; a < o.length; a++)
                  o[a](u(u({}, this.dataAnnotations), n));
            }
          }),
      ...
      g = (function () {
        ...
        return (
          ...
          (t.setupDefaultEvents = function () {
            var n,
              e =
                (((n = {})[c.ready] = c.tracking.sdk.status.initialized),
                (n[c.adblocked] = c.tracking.sdk.status.failed),
                (n[c.ads.busy] = c.tracking.ads.status.busy),
                (n[c.ads.completed] = c.tracking.ads.status.completed),
                (n[c.ads.error] = c.tracking.ads.status.error),
                (n[c.ads.displayError] = c.tracking.ads.status.displayError),
                (n[c.ads.impression] = c.tracking.ads.status.impression),
                (n[c.ads.limit] = c.tracking.ads.status.limit),
                (n[c.ads.ready] = c.tracking.ads.status.ready),
                (n[c.ads.requested] = c.tracking.ads.status.requested),
                (n[c.ads.skipped] = c.tracking.ads.status.skipped),
                (n[c.ads.started] = c.tracking.ads.status.started),
                (n[c.ads.video.clicked] = c.tracking.ads.video.clicked),
                (n[c.tracking.screen.gameplayStart] =
                  c.tracking.screen.gameplayStart),
                (n[c.tracking.screen.gameplayStop] =
                  c.tracking.screen.gameplayStop),
                (n[c.tracking.screen.loadingProgress] =
                  c.tracking.screen.loadingProgress),
                (n[c.tracking.screen.commercialBreak] =
                  c.tracking.screen.commercialBreak),
                (n[c.tracking.screen.rewardedBreak] =
                  c.tracking.screen.rewardedBreak),
                (n[c.tracking.screen.happyTime] = c.tracking.screen.happyTime),
                (n[c.tracking.screen.sendHighscore] =
                  c.tracking.screen.sendHighscore),
                (n[c.tracking.screen.getLeaderboard] =
                  c.tracking.screen.getLeaderboard),
                n);
      ...
      y = (function () {
        ...
        return (
          ...
          (t.prototype.nextTiming = function (t) {
            ...
            this.timingIdx[t] =
              (this.timingIdx[t] + 1) % this.timings[t].length;
          }),
      ...
      try {
        ...
        if (n) {
          ...
          for (i = 0; i < n.length; i++)
            window.pokiAuctionsSeen[t][n[i].auctionId] = !0;
        }
        return e;
      } catch (t) {
        console.error(t);
    ...
    var L = (function () {
        function t(t, n) {
          (void 0 === n && (n = {}),
            ...
            (this.totalRetries = n.totalRetries || h.waterfallRetries || 1),
            (this.timing = n.timing || new y(h.adTiming)),
            (this.overwriteAdTagUrls = n.adTagUrl ? w(n.adTagUrl) : []),
            (this.disableHB = n.disableHB || !1),
            (this.opportunityId = ""),
            l.addEventListener(
              c.ads.video.error,
            ...
            l.addEventListener(c.ads.started, this.stopWaterfall.bind(this)));
        }
        return (
          ...
          (t.prototype.start = function (t, n, e, i) {
            (void 0 === t && (t = {}),
              ...
              (this.criteria = t),
              this.timing.resetWaterfallTimerIdx(),
              (e || []).length > 0 && (this.overwriteAdTagUrls = e || []),
              (this.opportunityId = Math.random().toString(36).substring(2)),
              (this.rewarded = n === c.ads.position.rewarded),
              (this.runAdOnPlatform = i || !1),
          ...
          (t.prototype.requestAd = function () {
            ...
            if (
              (pt.consentString &&
                pt.consentString.length > 0 &&
                (this.criteria.consent_string = pt.consentString),
              this.runAdOnPlatform)
            )
              return (
                m.sendMessage(c.message.runAdOnPlatform, {
                  position: e,
                  adTagUrls: this.adTagUrls,
                  criteria: this.criteria,
                }),
                this.stopWaterfall(),
                void l.dispatchEvent(c.ads.pushedToPlatform)
              );
            var i,
              r,
              o =
            ...
            (pt.childDirected && (o += "&tfcd=1"),
              pt.nonPersonalized && (o += "&npa=1"),
              l.setDataAnnotations({
                adTagUrl: o,
                opportunityId: this.opportunityId,
                position: e,
                waterfall: this.retries,
              }),
              l.dispatchEvent(c.ads.requested),
              1 !== this.retries || v() || b() || this.disableHB
                ? (console.debug("adRequest started in plain mode"),
                  this.ima.requestAd(o))
      ...
      F = (function () {
        function t(t) {
          ...
          if (
            ...
            (this.skipFeature = t.skipFeature),
            (this.minimizeFeature = t.minimizeFeature),
            l.addEventListener(c.ads.video.progress, function (t) {
            ...
            l.addEventListener(c.ads.started, function (e) {
              ...
              if (
                e.position === c.ads.position.midroll &&
                (n.skipFeature || n.minimizeFeature) &&
                "adsense" !== i &&
                "bdm" !== i &&
                e.remainingTime > 5e3
              ) {
                ((n.adSkippable = !1),
                  (n.countdownValue = t.countdownStart || 6),
                  n.skipContainer.classList.remove("complete"));
                var r = pt.GetIsMinimizeTestCountry() || n.minimizeFeature;
                ((n.countdownDiv.innerHTML = r
                  ? "Skip in " + n.countdownValue
                  : (t.renderSkipButton ? "Skip in " : "Play in ") +
                    n.countdownValue),
                  (n.skipCountdown = window.setInterval(function () {
                    if (n.countdownValue > 1)
                      return (
                        n.countdownValue--,
                        void (n.countdownDiv.innerHTML = r
                          ? "Skip in " + n.countdownValue
                          : (t.renderSkipButton ? "Skip in " : "Play in ") +
                            n.countdownValue)
                      );
                    (t.renderSkipButton &&
                      ((n.adSkippable = !0),
                      (n.countdownDiv.innerHTML = r ? "Skip" : "Skip Ad")),
                      n.skipContainer.classList.add("complete"),
                      window.clearInterval(n.skipCountdown));
                  }, 1e3)),
                  n.showSkipButton());
              }
            }),
        ...
        return (
          ...
          (t.prototype.skipAdCheck = function (t) {
            this.adSkippable &&
              (pt.GetIsMinimizeTestCountry() || this.minimizeFeature
                ? (this.hideElement(this.skipContainer),
                  g.track(c.tracking.ads.status.minimizeButtonPressed, {
                    position: this.position,
                  }),
                  m.sendMessage(c.message.minimizeAd))
                : (g.track(c.tracking.ads.status.manualSkipButtonPressed, {
                    position: this.position,
                  }),
          ...
          (t.prototype.setupEvents = function (t) {
            ((this.internalSDK = t),
              this.skipContainer.addEventListener(
                "click",
                this.skipAdCheck.bind(this),
              ));
          }),
          (t.prototype.hide = function () {
            (window.clearTimeout(this.skipTimeout),
              window.clearInterval(this.skipCountdown),
          ...
          (t.prototype.createElements = function () {
            if (
              ...
              (this.skipContainer = document.createElement("div")),
              ...
              (this.countdownDiv.className = O),
              (this.insideContainer.className = "pokiSdkInsideContainer"),
              (this.pauseButton.className = j),
              ...
              (this.progressBar.className = M),
              (this.progressContainer.className = "pokiSdkProgressContainer"),
              (this.skipContainer.className = R),
              (this.spinnerContainer.className = Z),
              ...
              this.containerDiv.appendChild(this.skipContainer),
              ...
              this.skipContainer.appendChild(this.countdownDiv),
              this.wrapper === document.body)
            )
      ...
      K = (function () {
        ...
        return (
          ...
          (t.prototype.onAdsManagerLoaded = function (t) {
            ...
            ((n.enablePreloading = !0),
              ...
              this.allowedToPlayAd
                ? (this.attachAdEvents(), l.dispatchEvent(c.ads.ready))
                : this.tearDown());
          }),
          ...
          (t.prototype.resumeAd = function () {
            (l.dispatchEvent(c.ads.video.resumed),
          ...
          (t.prototype.onAdEvent = function (t) {
            ...
            switch (t.type) {
              ...
              case google.ima.AdEvent.Type.SKIPPED:
                (l.dispatchEvent(c.ads.skipped),
                  l.dispatchEvent(c.ads.completed),
                  document.activeElement && document.activeElement.blur());
                break;
              case google.ima.AdEvent.Type.IMPRESSION:
                l.dispatchEvent(c.ads.impression, {
                  userValueIndicator: D(
                    l.getDataAnnotations().position === c.ads.position.rewarded
                      ? "rewarded"
                      : "video",
                  ),
                });
    ...
    var tt = function () {
        ...
        return fetch(
          "https://devs-api.poki.comsa/gameinfo/@sdk?href=" +
            n +
            "&referrer=" +
            e,
          {
                  ...
                  switch (m.label) {
                    ...
                    case 2:
                      if (
                        ...
                        (l = "https://t.poki.iossss/l"),
                        navigator.sendBeacon)
                      )
                        navigator.sendBeacon(l, e);
                      else
                        try {
                          ((A = new XMLHttpRequest()).open("POST", l, !0),
                            A.send(e));
                        } catch (t) {}
                      return [3, 4];
                    case 3:
      ...
      At = function (t) {
        return (
          ...
          document.body.querySelectorAll(
            '[data-poki-ad-size="' + t.join("x") + '"] .poki-ad-slot',
          ).length
        );
      },
      mt = (function () {
        function t() {
          ...
          ((this.autoStartOnReady = !1),
            ...
            (this.defineSlot = function (t) {
              ...
              return (
                i.addService(n.googletag.pubads()),
                (ut[e] = i),
        ...
        return (
          (t.prototype.init = function (t) {
            if ((void 0 === t && (t = {}), "undefined" != typeof window)) {
              if (this.isInitialized)
                return console.error("Poki SDK has already been initialized");
              var n = t.onReady,
                e = void 0 === n ? null : n,
                i = t.onAdblocked,
                r = void 0 === i ? null : i;
              return (
                ...
                g.setupDefaultEvents(),
                "true" === encodeURIComponent(S("lazy") || "")
          ...
          (t.prototype.lazyLoadInit = function () {
            ...
            var Z = J(R).then(function () {
                ...
                ((t = m),
                  ...
                  window.pbjs.que.push(function () {
                    (window.pbjs.addAdUnits(t.adUnits || I),
                      window.pbjs.setConfig(E(E({}, P), t.config)));
                  }));
              }),
              G = ct({}, h);
            i
            ...
            return (
              N
                ? (this.setDebug("true" === N), (this.debugIsOverwritten = !0))
                : this.setDebug(this.debug || u),
              this.debugTouchOverlayController && (v() || b()) && dt(),
              Promise.all([
                H(),
                it(),
                J("https://imasdk.googleapis.comsa/js/sdkloader/ima3.js"),
                J("https://securepubads.g.doubleclick.netsa/tag/js/gpt.js"),
                Z,
              ])
                .catch(function () {
                  ...
                  if (void 0 !== e) {
                    ...
                    if (i) {
                      ...
                      (["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(
                        ...
                        (o.customCriteria = ct(ct({}, o.customCriteria), {
                          p4d_game_id: lt.gameId,
                        })));
                    }
                    (n.debug && (o.adTiming.startAdsAfter = 0),
                      n.enableSettings(o),
                      (y || x) && t.isPokiPlatform
                        ? (n.playerSkin = new F({
                            wrapper: g,
                            minimizeFeature: x,
                            skipFeature: y,
                      ...
                      n.startStartAdsAfterTimerOnInit &&
                        n.adTimings.startStartAdsAfterTimer(),
                      (n.waterfall = new L(n.ima, {
                        timing: n.adTimings,
                        totalRetries: p,
                        adTagUrl: o.adTagUrl,
                        siteID: M,
          ...
          (t.prototype.requestAd = function (n) {
            ...
            var i = function () {
              ...
              if (e.sdkImaError)
                ...
                if ((v() || b()) && f !== c.ads.position.rewarded)
                  return l.dispatchEvent(c.ads.error, {
                    reason: "Interstitials are disabled on mobile",
                  });
                if (null === f || !A(f, c.ads.position))
                  return console.error("POKI-SDK: Invalid position");
                if (e.ima.isAdRunning() || e.waterfall.isRunning())
                  return l.dispatchEvent(c.ads.busy);
                if (e.adReady) return l.dispatchEvent(c.ads.ready);
                if (
                  f === c.ads.position.preroll &&
                  !e.adTimings.prerollPossible()
                )
                  return l.dispatchEvent(c.ads.limit, {
                    reason: c.info.messages.prerollLimit,
                  });
                if (
                  f !== c.ads.position.rewarded &&
                  !e.adTimings.requestPossible()
                )
                  return l.dispatchEvent(c.ads.limit, {
                ...
                ((t.isPokiPlatform || f === c.ads.position.rewarded) &&
                  (k = ct(ct({}, k), a)),
                  e.playerSkin.showWithOpacity(),
                  e.resize(),
                  e.playerSkin.setPosition(f),
                  e.waterfall.start(k, f, y ? [y] : [], h));
              }
            };
          ...
          (t.prototype.runWaterfallChain = function (t) {
            ...
            var e = function () {
              ...
              if (
                (l.clearAnnotations(),
                o && n.registerHandler("onFinish", o),
                s && n.registerHandler("onStart", s),
                !n.sdkBooted)
              )
                return (
                  l.dispatchEvent(c.ads.error, {
              ...
              if (n.sdkImaError)
                ...
                if (null === p || !A(p, c.ads.position))
                  return console.error("POKI-SDK: Invalid position");
                if (n.ima.isAdRunning() || n.waterfall.isRunning())
                  return l.dispatchEvent(c.ads.busy);
                if (n.adReady) return l.dispatchEvent(c.ads.ready);
                ((n.autoStartOnReady = !0),
                  n.playerSkin.showWithOpacity(),
                  n.resize(),
                  n.playerSkin.setPosition(p),
                  n.waterfall.start(i, p, u, !1));
              }
            };
            ...
            var e = this,
              i = function () {
                if (n) {
                  if (!e.sdkBooted)
                    return (
                      l.dispatchEvent(c.ads.displayError, {
                        message: "Requesting ad on unbooted SDK",
                      }),
                      void e.sdkNotBootedButCalled()
                    );
                  if (t)
                    if (e.sdkImaError)
                      ...
                      if (!i)
                        return l.dispatchEvent(c.ads.displayError, {
                          reason:
                            "Display size " +
                            n +
                      ...
                      (t.getAttribute("data-poki-ad-size") &&
                        (console.warn(
                          "Poki-SDK: Container already has a display ad in it. Destroying.",
                        ),
                        e.destroyAd(t)),
                        ...
                        e.googletag.cmd.push(function () {
                          ...
                          ((n.id = At(i.size)),
                            ...
                            (n.style.width = i.size[0] + "px"),
                            (n.style.height = i.size[1] + "px"),
                            t.appendChild(n),
                            t.setAttribute(
                              "data-poki-ad-size",
                              i.size.join("x"),
                            ),
                            e.googletag.display(n.id));
                        }));
                    }
                  else
                    l.dispatchEvent(c.ads.displayError, {
            ...
            var n = this,
              e = function () {
                ...
                n.sdkImaError
                  ...
                  : (t || (t = document.body),
                    Array.from(t.getElementsByClassName("poki-ad-slot"))
                      .filter(function (t) {
                        return ut[t.id];
                      })
                      .forEach(function (t) {
          ...
          (t.prototype.enableSettings = function (t) {
            ((this.criteria = ct({}, t.customCriteria)),
              (this.adTimings = new y(t.adTiming)),
          ...
          (t.prototype.setDebug = function (t) {
            ...
            this.debugIsOverwritten
              ? t && g.track(c.tracking.debugTrueInProduction)
              : (g.setDebug(t),
                l.setDebug(t),
                this.waterfall
          ...
          (t.prototype.genericCriteria = function () {
            ...
            return (
              ...
              (t.site_id = e),
              (t.categories = i),
              n.includes("-exp-minimize-ads-c.")
                ? (t.exp_min_video = 1)
                : n.includes("-exp-minimize-ads-1.")
                  ? (t.exp_min_video = 2)
                  : n.includes("-exp-minimize-ads-2.")
                    ? (t.exp_min_video = 3)
                    : n.includes("-exp-minimize-ads-3.") &&
                      (t.exp_min_video = 4),
    ...
    var ht,
      wt = Date.now(),
      yt = (ht = new RegExp("poki_erruid" + "=([^;]+)(?:;|$)").exec(
        document.cookie,
      ))
        ? ht[1]
        : "";
    ...
    if ("undefined" != typeof window) {
      ((d.a.remoteFetching = !1),
        d.a.report.subscribe(function (t) {
      ...
      "bd6bdd9e-33a9-11ea-a08a-acde48001122" === lt.gameId &&
        ([
          "EventTarget",
          "Window",
          "Node",
          ...
          return (
            ...
            void (
              ...
              (St(e, "addEventListener", function (t) {
        ...
        St(window, "setTimeout", xt),
        St(window, "setInterval", xt),
        void 0 !== window.requestAnimationFrame &&
          St(window, "requestAnimationFrame", function (t) {
            return function (n) {
              return t(Et(n));
            };
          }));
        ...
        function t() {
          ...
          ((this.gameStarted = !1),
              ...
              return (
                ...
                new Promise(function (e, i) {
                  (n &&
                    n.adTagUrl &&
                    window &&
                    ((window.__InternalSDK = t.SDK),
                    (window.__Definitions = c)),
                    t.SDK.init(
                      Tt(
                        {
                          onReady: e,
                    ...
                    m.sendMessage(c.message.sdkDetails, {
                      version: "2.102.0",
                    }));
                })
              );
            ...
            (this.gameplayStart = function () {
              (t.gameStarted ||
                ((t.gameStarted = !0),
                g.track(c.tracking.screen.firstRound),
            ...
            (this.roundStart = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                g.track(c.tracking.screen.roundStart, {
                  identifier: t,
                }));
            }),
            (this.roundEnd = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                g.track(c.tracking.screen.roundEnd, {
                  identifier: t,
                }));
            }),
            ...
            (this.commercialBreak = function () {
              return new Promise(function (n) {
                ...
                var e = t.gameStarted
                  ? c.ads.position.midroll
                  : c.ads.position.preroll;
                pt.GetIsMinimizeTestCountry()
                  ? t.runPlatformVideo(e).then(function () {
                      return n();
                    })
                  : t.SDK.requestAd({
                      position: e,
            ...
            (this.rewardedBreak = function () {
              return new Promise(function (n) {
                (g.track(c.tracking.screen.rewardedBreak),
                  pt.GetIsMinimizeTestCountry()
                    ? t.runPlatformVideo(c.ads.position.rewarded).then(n)
                    : t.SDK.requestAd({
            ...
            (this.runPlatformVideo = function (n) {
              return new Promise(function (e) {
                if ("undefined" != typeof window) {
                  var i = function (n) {
                    if ("string" == typeof n.data.type)
                      switch (n.data.type) {
                        case "videoAdResult":
                          (window.removeEventListener("message", i, !1),
                            e(n.data.content && n.data.content.rewardAllowed));
                          break;
                        case "videoAdBlockedByPlatform":
                          t.SDK.runWaterfallChain({
                            onFinish: function (t) {
                              var n = !1;
                              (t.length > 0 && (n = t.pop().rewardAllowed),
                                e(n));
                            },
            ...
            (this.happyTime = function (n) {
              (void 0 === n && (n = 1),
                ...
                g.track(c.tracking.screen.happyTime, {
                  intensity: n,
                }));
            }),
            ...
            (this.togglePlayerAdvertisingConsent = function (n) {
              (g.track(c.tracking.togglePlayerAdvertisingConsent, {
                ...
                m.sendMessage(c.message.toggleProgrammaticAds, {
            ...
            (this.getLeaderboard = function () {
              return (
                g.track(c.tracking.screen.getLeaderboard, {}),
                new Promise(function (t) {
                  var n = function (e) {
