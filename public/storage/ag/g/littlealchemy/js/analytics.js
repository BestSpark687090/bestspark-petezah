(!(function () {
  var t,
    ...
    d = function (t, e) {
      f.addEventListener
        ? f.addEventListener(t, e, !1)
        : f.attachEvent && f.attachEvent("on" + t, e);
    },
    p = /:[0-9]+$/,
    v = function (t, e) {
      return (
        ...
        ("protocol" !== e && "port" !== e) ||
          (t.protocol = w(t.protocol) || w(l.location.protocol)),
        "port" === e
          ? (t.port = String(
              Number(t.hostname ? t.port : l.location.port) ||
                ("http" === t.protocol
                  ? 80
                  : "https" === t.protocol
                    ? 443
          ...
          : "host" === e &&
            (t.hostname = (t.hostname || l.location.hostname)
              .replace(p, "")
              .toLowerCase()),
        m(t, e)
      );
  ...
  function S() {
    var t = {},
      e = l.google_tag_data;
    return (
      (l.google_tag_data = void 0 === e ? t : e),
      ((e = (t = l.google_tag_data).gl) && e.decorators) ||
        ((e = { decorators: [] }), (t.gl = e)),
      e
    );
  }
  ...
  function $(t, e) {
    var n = "FORM" === (t.tagName || "").toUpperCase(),
      r = O(e, 1, n),
      a = O(e, 2, n);
    for (var i in ((e = O(e, 3, n)),
    o(r) && ((r = N(r)), n ? G("_gl", r, t) : D("_gl", r, t, !1)),
    !n && o(a) && D("_gl", (n = N(a)), t, !0),
    e))
      e.hasOwnProperty(i) && M(i, e[i], t);
  }
  function M(t, e, n, r) {
    if (n.tagName) {
  ...
  function D(t, e, n, r) {
    n.href &&
      ((t = P(t, e, n.href, void 0 !== r && r)), s.test(t) && (n.href = t));
  }
  function G(t, e, n) {
    if (n && n.action) {
      ...
      if ("get" === r) {
        ...
        a ||
          ((r = f.createElement("input")).setAttribute("type", "hidden"),
          r.setAttribute("name", t),
          r.setAttribute("value", e),
          n.appendChild(r));
      } else
        "post" === r && ((t = P(t, e, n.action)), s.test(t) && (n.action = t));
    }
  }
  function U(t) {
    try {
  ...
  (a("google_tag_data.glBridge.auto", function (t, e, n, r) {
    ...
    a("google_tag_data.glBridge.generate", N),
    a("google_tag_data.glBridge.get", function (t, e) {
      var n = R(!!e);
      return (
        (e = S()).data || ((e.data = { query: {}, fragment: {} }), n(e.data)),
        (n = {}),
        (e = e.data) && (i(n, e.query), t && i(n, e.fragment)),
        n
      );
    }));
})(window),
  (function () {
    ...
    var I = window,
      ...
      G = function (t) {
        ...
        if ((e && e.ioo && e.ioo()) || (t && !0 === M["ga-disable-" + t]))
          return !0;
        try {
          var n = M.external;
      ...
      q = function (t, e, n, r, a, i, o) {
        if (
          !(a =
            !G(a) && !(V.test(L.location.hostname) || ("/" == n && H.test(r))))
        )
          return !1;
        if (
    ...
    var z,
      ...
      Q = function (t) {
        if (ot(t[Dn])) {
          var e;
          if (void 0 === W)
            (e = ((e = Ir.get()) && e._ga) || void 0) && ((W = e), g(81));
            ...
            (a.onload = function () {
              if (((z = !1), 4 == a.readyState)) {
                try {
                  ...
                  r.optOut
                    ? (g(63), it("", "$OPT_OUT", 31536e6))
                    : r.clientId
                      ? it(r.clientId, r.securityToken, 31536e6)
                      : !n && r.alternateUrl
                        ? (K && clearTimeout(K),
                          (z = !0),
                          nt(t, e, r.alternateUrl))
                        : (g(64), it("", "$NOT_FOUND", 36e5));
                } catch (t) {
                  (g(65), it("", "$ERROR", 3e4));
                }
                a = null;
      ...
      mt = function (t, e, n) {
        1 <= 100 * Math.random() ||
          G("?") ||
          ((t = ["t=error", "_e=" + t, "_v=j98", "sr=1"]),
          e && t.push("_f=" + e),
          n && t.push("_m=" + b(n.substring(0, 100))),
          t.push("aip=1"),
          t.push("z=" + Rt()),
          ft(st(!0) + "/u/d", t.join("&"), _));
      },
      wt = function () {
    ...
    function yt(e) {
      if (100 != e.get(In) && t($t(e, mn)) % 1e4 >= 100 * Mt(e, In))
        throw "abort";
    }
    function kt(t) {
    ...
    function Ot(t) {
      ...
      ((a = $t(t, yn)),
        ...
        (a = $t(t, yn)),
        delete _t(a).pending_experiments,
        t.set(te, _, !0));
    }
    function St(t) {
      (wt().expId && t.set(De, wt().expId),
        wt().expVar && t.set(Ge, wt().expVar));
      var e = $t(t, yn);
      ...
      try {
        if (!t.get(Wn) && (t.set(Wn, !0), !t.get("&gtm"))) {
          ...
          if (
            ...
            jt(L.documentElement.getAttribute("data-tag-assistant-present")) &&
              (e = 5);
          if (e) {
            I["google.tagmanager.debugui2.queue"] ||
              ((I["google.tagmanager.debugui2.queue"] = []),
              O(
            ...
            I["google.tagmanager.debugui2.queue"].push({
              ...
              data: { id: t.get(yn), scriptSource: (n && n.src) || "" },
            });
          }
        }
      } catch (t) {}
    ...
    ((bt.prototype.add = function (t) {
      ...
      (bt.prototype.D = function (t) {
        ...
        (e = t.get(te)) != _ && d(e) && (t.set(te, _, !0), setTimeout(e, 10));
      }));
    var Rt = function () {
    ...
    var Jt = zt("adSenseId", "a"),
      ...
      te = zt("hitCallback"),
      ee = zt("hitPayload");
    (zt("nonInteraction", "ni"),
      zt("currencyCode", "cu"),
      zt("dataSource", "ds"));
    var ne = zt("useBeacon", void 0, !1),
      re = zt("transport");
    (zt("sessionControl", "sc", ""),
      zt("sessionGroup", "sg"),
      zt("queueTime", "qt"));
    var ae = zt("_s", "_s");
    zt("screenName", "cd");
    ...
    (zt("campaignId", "ci"),
      zt("campaignName", "cn"),
      zt("campaignSource", "cs"),
      zt("campaignMedium", "cm"),
      zt("campaignKeyword", "ck"),
      zt("campaignContent", "cc"));
    ...
    (zt("appName", "an"),
      zt("appVersion", "av", ""),
      zt("appId", "aid", ""),
      zt("appInstallerId", "aiid", ""),
      zt("exDescription", "exd"),
      zt("exFatal", "exf"));
    var De = zt("expId", "xid"),
      Ge = zt("expVar", "xvar"),
      Ue = zt("exp", "exp"),
      ...
      zt(
        ...
        function (t) {
          ...
          var e = $t(t, mn),
            n = $t(t, $n) || "";
          return (
            (e = "_ga=2." + b(Mr(n + e, 0) + "." + n + "-" + e)),
            (t = Vr(t))
              ? (g(44),
                (t =
                  "&_gac=1." + b([Mr(t.qa, 0), t.timestamp, t.qa].join("."))))
              : (t = ""),
            e + t
          );
        },
    ...
    var sr = function (t) {
        if ("cookie" == t.get(Nn))
          return 0 < (t = U("FPLC")).length ? t[0] : void 0;
      },
      cr = function (t) {
        var e;
        ((e = $t(t, Vn) && t.get(Ke)) &&
          (e = !((e = Ir.get(t.get(Rn))) && e._fplc)),
          e && !sr(t) && t.set(Bn, "0"));
      },
      ur = function (t) {
        var e = {};
      ...
      lr = function (t) {
        ...
        return (
          0 != n &&
          ((t[ke] = e.loadEventStart - n),
          (t[Te] = e.domainLookupEnd - e.domainLookupStart),
          (t[Ce] = e.connectEnd - e.connectStart),
          (t[Se] = e.responseStart - e.requestStart),
          (t[xe] = e.responseEnd - e.responseStart),
          (t[Oe] = e.fetchStart - n),
          (t[Ae] = e.domInteractive - n),
          (t[Ee] = e.domContentLoadedEventStart - n),
          (t[Ne] = Ra.L - n),
          (t[je] = Ra.ya - n),
          I.google_tag_manager &&
            I.google_tag_manager._li &&
            ((e = I.google_tag_manager._li), (t[Re] = e.cst), (t[Ie] = e.cbt)),
          !0)
        );
      },
      gr = function (t) {
      ...
      pr = function (t) {
        if ("cookie" == $t(t, Nn)) {
          ...
          if (
            ((t.get(Sn) || mr(t) != $t(t, $n)) && vr(t, $n, Mn, 864e5),
            t.get(Hn))
          ) {
            if ((e = $t(t, Gn))) {
              ...
              ((n =
                0 === n
                  ? 0
                  : Math.min(n, 1e3 * Mt(t, Un) + n - new Date().getTime())),
                t.data.set(qn, n));
              var r = {},
                a = $t(t, Un),
                i = $t(t, Fn),
              ...
              (i && "aw.ds" != i
                ...
                : ((e = ["1", a, F(e)].join(".")),
                  0 <= n &&
                    (r && (r.ta = !0), q("_gac_" + F(c), e, o, s, c, n, u))),
                Ar(r));
            }
          } else g(75);
          t.get(Hn) &&
            (e = $t(t, Zn)) &&
            ((n =
              0 === (n = Math.min(Mt(t, Jn), 1e3 * Mt(t, On)))
                ? 0
                : Math.min(n, 1e3 * Mt(t, Yn) + n - new Date().getTime())),
            t.data.set(Jn, n),
            (r = {}),
            (u = $t(t, Yn)),
            (o = Sr($t(t, Tn))),
            ...
            (e = ["1", u, F(e)].join(".")),
            0 <= n &&
              (r && (r.ta = !0), q("_gac_gb_" + F(c), e, o, s, c, n, t)),
            Er(r));
        }
      },
      vr = function (t, e, n, r) {
      ...
      _r = function (t) {
        if (t.get(En)) {
          ...
          r &&
            (g(19),
            t.set(He, new Date().getTime(), !0),
            t.set(qe, r.R),
            (e = Nr("__utmz", n, e)) && r.hash == e.hash && t.set(Fe, e.R));
        }
      },
      br = function (t, e) {
        e = F($t(t, e));
      ...
      kr = function (t, e, n) {
        if (!t || 1 > t.length) g(12);
          ...
          if (0 != r.length)
            return (
              g(14),
              1 == (r = xr(r, Tr(e).split(".").length, 0)).length
                ? r[0].s
                : (1 < (r = xr(r, Cr(n), 1)).length && g(41), r[0] && r[0].s)
            );
          g(12);
        }
      },
      ...
      if (t) {
        ...
        if (t.tagName) {
          if ("a" == t.tagName.toLowerCase())
            return void (t.href && (t.href = Gr(this, t.href, e)));
        ...
        if (e && e.action)
          if ("get" == e.method.toLowerCase()) {
            ...
            for (var n = 0; n < t.length; n++) {
              ...
              o ||
                ((i = L.createElement("input")).setAttribute("type", "hidden"),
                i.setAttribute("name", r),
                i.setAttribute("value", a),
                e.appendChild(i));
            }
          } else
            "post" == e.method.toLowerCase() && (e.action = Gr(t, e.action));
      };
    function qr(t, e) {
    ...
    function Vr(t) {
      ...
      if (n && t.get(Hn)) {
        var r = e(t.get(Un));
        if (!(1e3 * r + e(t.get(qn)) <= new Date().getTime()))
    ...
    var Br = /^(GTM|OPT)-[A-Z0-9]+$/,
      ...
      Zr = function (t, e, n, r) {
        ...
        var a = 1;
        zr.test(e) && (a = 2);
        var i = { id: e, type: a, B: n.dataLayer || "dataLayer", G: !1 },
          o = void 0;
        return (
          t.get("&gtm") == e && (i.G = !0),
          1 === a
            ? ((i.ia = !!t.get("anonymizeIp")),
              (i.sync = r),
              "t0" != (e = String(t.get("name"))) && (i.target = e),
              G(String(t.get("trackingId"))) ||
                ((i.clientId = String(t.get(mn))),
                (i.ka = Number(t.get(wn))),
                (n = n.palindrome ? Xr : Kr),
          ...
          (function (t) {
            ...
            return (
              ...
              e("cycle", t.G),
              t.qa && e("gclid", t.qa),
              Wr.test(L.referrer) && e("cb", String(Rt())),
              n
            );
          })(i)
        );
      ...
      Qr = function (t, e, n) {
        !1 === e.get(ar) ||
          e.get(n) ||
          ("1" == U(t.Y)[0] ? e.set(n, "", !0) : e.set(n, "" + Rt(), !0));
      },
      ta = function (t, e) {
          ...
          (a.set(29),
            ...
            (function (t, e) {
              ...
              e.set(cn, function (t) {
                ...
                if (ea(t)) {
                  g(80);
                  var n = { U: ra(t, 1), google: ra(t, 2), count: 0 };
        ...
        if (!t.get("dcLoaded") && "cookie" == t.get(Nn)) {
          ...
          (e && t.set(tr, 1, !0),
            ...
            (e || n) &&
              ...
              t.set(
                nr,
                { U: ra(t, 1), google: ra(t, 2), V: aa(t), count: 0 },
                !0,
              )));
        }
      },
    ...
    var la,
      ...
      da = function (t, e) {
        var n = $t(t, kn);
        if (
          (t.data.set(Mn, "_ga" == n ? "_gid" : n + "_gid"),
          "cookie" == $t(t, Nn))
        ) {
          if (((dr = !1), (n = U($t(t, kn))), !(n = yr(t, n)))) {
            n = $t(t, xn);
            var r = $t(t, An) || A();
            null != (n = Nr("__utma", r, n))
              ? (g(10), (n = n.O[1] + "." + n.O[2]))
              : (n = void 0);
          }
          ...
          (r && (n = void 0),
            n &&
              (t.data.set(_n, n),
              t.data.set(mn, n),
              (n = mr(t)) && t.data.set($n, n)),
            t.get(Hn) &&
              ((n = t.get(Gn)), (r = t.get(Fn)), !n || (r && "aw.ds" != r)) &&
              ((n = {}),
              (r = (L ? B(n) : {})[$t(t, yn)]),
              Ar(n),
              r &&
                0 != r.length &&
                ((n = r[0]),
                t.data.set(Un, n.timestamp / 1e3),
                t.data.set(Gn, n.qa))),
            t.get(Hn) &&
              ((n = t.get(Zn)),
              (r = {}),
              (a = (L ? B(r, "_gac_gb", !0) : {})[$t(t, yn)]),
              Er(r),
              a &&
                0 != a.length &&
                ((a = (r = a[0]).qa),
          ...
          if (
            ...
            if ((g(84), t.data.set(Xn, 1), (i = r._up)))
              if ((i = Rr.exec(L.referrer))) {
                ...
                i =
                  o === i || 0 <= o.indexOf("." + i) || 0 <= i.indexOf("." + o);
              } else i = !1;
            i = !!i;
          }
          o = r.gclid;
            ...
            if ((n && a && g(36), t.get(jn) || ot(t.get(Dn)) || i)) {
              if (
                ...
                o
                  ? (g(82),
                    t.data.set(Gn, o),
                    r.gclsrc && t.data.set(Fn, r.gclsrc))
                  : c &&
                    (a = c.split(".")) &&
                    2 === a.length &&
                    (g(37), t.data.set(Gn, a[0]), t.data.set(Un, a[1])),
                (r = r._fplc) && $t(t, Vn) && (g(83), t.data.set(Bn, r)),
                n)
              )
                t: if (((r = n.indexOf(".")), -1 == r)) g(22);
                  ...
                  if (
                    ...
                    if (
                      ((a = ""),
                      0 < (r = i.indexOf("-"))
                        ? ((a = i.substring(0, r)), (r = i.substring(r + 1)))
                        : (r = i.substring(1)),
                      Fr(a + r, n))
                    ) {
                      g(53);
        ...
        (e && (g(9), t.data.set(mn, b(e))),
          t.get(mn) ||
            ((e =
              (e = I.gaGlobal) && e.from_cookie && "cookie" !== $t(t, Nn)
                ? void 0
                : (e = e && e.vid) && -1 !== e.search(s)
                  ? e
                  : void 0)
              ? (g(17), t.data.set(mn, e))
              : (g(8), t.data.set(mn, w()))),
          t.get($n) || (g(3), t.data.set($n, w())),
          pr(t),
          (e = I.gaGlobal = I.gaGlobal || {}),
          (t = (n = $t(t, mn)) === $t(t, _n)),
      ...
      pa = function (t) {
        ...
        t: {
          ...
          if (/^(https?|android-app):\/\//i.test(c)) {
            ...
            if (((o = "//" + L.location.hostname), !E(c, o))) {
              if (
                s &&
                ((s = o.replace(/\./g, "-") + ".cdn.ampproject.org"), E(c, s))
              ) {
                c = void 0;
                break t;
              }
        ...
        if (
          (i.call(t, oe, c),
          a &&
            ("/" != (i = a.pathname || "").charAt(0) && (g(31), (i = "/" + i)),
            t.set(ie, a.protocol + "//" + a.hostname + i + a.search)),
          r && t.set(ge, r.width + "x" + r.height),
          r && t.set(le, r.colorDepth + "-bit"),
          (r = L.documentElement),
          (c = (i = L.body) && i.clientWidth && i.clientHeight),
          (s = []),
          r &&
          r.clientWidth &&
          r.clientHeight &&
          ("CSS1Compat" === L.compatMode || !c)
            ...
            : c && (s = [i.clientWidth, i.clientHeight]),
          (r = 0 >= s[0] || 0 >= s[1] ? "" : s.join("x")),
          t.set(fe, r),
          (r = t.set),
          (i = (i = I.navigator) ? i.plugins : null) && i.length)
        )
          for (c = 0; c < i.length && !e; c++)
            -1 < (s = i[c]).name.indexOf("Shockwave Flash") &&
              (e = s.description);
        if (!e)
          try {
        ...
        if (
          (e &&
            ...
            3 <= u.length &&
            (e = u[0] + "." + u[1] + " r" + u[2]),
          r.call(t, de, e || void 0),
          t.set(ue, L.characterSet || L.charset),
          t.set(
            he,
          ...
          t.data.set(Gn, S("gclid", !0)),
          t.data.set(Fn, S("gclsrc", !0)),
          t.data.set(Un, Math.round(new Date().getTime() / 1e3)),
          t.get(Gn) ||
            (t.data.set(Zn, S("wbraid", !0)),
            t.data.set(Yn, Math.round(new Date().getTime() / 1e3))),
          a && t.get(Rn) && (n = L.location.hash))
        ) {
    ...
    ((la = new R()),
      (fa = new R()),
      (ha = new R()),
      (ga = { ec: 45, ecommerce: 46, linkid: 47 }));
    var ka = function (t, e, n) {
        e == Ra || e.get(vn);
        var r = la.get(t);
        return (
          !!d(r) &&
          ((e.plugins_ = e.plugins_ || new R()),
      ...
      xa = function (t, e, n, r, a) {
        if (!d(la.get(e)) && !fa.get(e)) {
          ...
          if (
            (!n && ga.hasOwnProperty(e) ? (g(39), (n = e + ".js")) : g(43), n)
          )
            (r && (i = r[Vn]),
              v(i) || (i = void 0),
              (t = Ea(Na(n, i))),
              !i || (Ca(t.protocol) && Sa(t)) || (t = Ea(Na(n))),
              Ca(t.protocol) &&
                Sa(t) &&
                (O(t.url, void 0, a, void 0, o), fa.set(e, !0)));
        }
      },
      Ta = function (t, e) {
        var n = ha.get(t) || [];
    ...
    (ja.ga(),
      (ja.D = function (t) {
        ...
        for (
          e = ja.fa.concat(e), ja.fa = [];
          0 < e.length && !ja.v(e[0]) && (e.shift(), !(0 < ja.fa.length));
      ...
      (ja.J = function (t) {
        for (var e = [], n = 0; n < arguments.length; n++)
          try {
            ...
            (r.g
              ? Oa(r.aa[0], r.aa[1])
              : (r.i && (r.ha = xa(r.da, r.aa[0], r.X, r.W)), e.push(r)),
              ja.ra(arguments[n]));
          } catch (t) {}
        return e;
      }),
      (ja.v = function (t) {
        try {
          if (t.u) t.u.call(I, Ra.j("t0"));
            ...
            if (t.A) {
              if ("t0" == t.da && null === (e = Ra.create.apply(Ra, t.aa)))
                return !0;
            } else if (t.ba) Ra.remove(t.da);
            else if (e)
              if (t.i) {
                if (
                  (t.ha && (t.ha = xa(t.da, t.aa[0], t.X, t.W)),
                  !ka(t.aa[0], e, t.W))
                )
                  return !0;
              } else if (t.K) {
      ...
      (Ra.N = function () {
        ...
        if (!t || 42 != t.answer) {
          ...
          if (
            ...
            Ra.q.splice(0),
            (Ra.qd = 0),
            or("create", (e = I[o] = Ra), e.create),
            or("remove", e, e.remove),
            or("getByName", e, e.j, 5),
            or("getAll", e, e.getAll, 6),
            or("get", (e = ua.prototype), e.get, 7),
            or("set", e, e.set, 4),
            or("send", e, e.send),
            or("requireSync", e, e.ma),
            or("get", (e = Pt.prototype), e.get),
            or("set", e, e.set),
          ...
          (((I.gaplugins = I.gaplugins || {}).Linker = Dr),
            (e = Dr.prototype),
            Oa("linker", Dr),
            or("decorate", e, e.ca, 20),
            or("autoLink", e, e.S, 25),
            or("passthrough", e, e.$, 25),
            Oa("displayfeatures", oa),
            Oa("adfeatures", oa),
            ja.D.apply(Ra, t));
        }
      }));
