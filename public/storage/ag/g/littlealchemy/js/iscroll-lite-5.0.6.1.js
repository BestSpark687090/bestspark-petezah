var IScroll = (function (t, i, e) {
  function s(t, e) {
    for (var s in ((this.wrapper =
      "string" == typeof t ? i.querySelector(t) : t),
    ...
    e))
      this.options[s] = e[s];
    ((this.translateZ =
      this.options.HWCompositing && n.hasPerspective ? " translateZ(0)" : ""),
      (this.options.useTransition =
        n.hasTransition && this.options.useTransition),
      (this.options.useTransform = n.hasTransform && this.options.useTransform),
      ...
      (this.options.bounceEasing =
        "string" == typeof this.options.bounceEasing
          ? n.ease[this.options.bounceEasing] || n.ease.circular
          : this.options.bounceEasing),
    ...
    n = (function () {
      ...
      ((o.getTime =
        ...
        (o.momentum = function (t, i, s, o, n) {
          ...
          return (
            (h = l / c),
            o > (r = t + ((l * l) / (2 * c)) * (0 > a ? -1 : 1))
              ? ((r = n ? o - (n / 2.5) * (l / 8) : o),
                (h = (a = e.abs(r - t)) / l))
              : r > 0 &&
                ((r = n ? (n / 2.5) * (l / 8) : 0),
                (h = (a = e.abs(t) + r) / l)),
            { destination: e.round(r), duration: h }
          );
        }));
      var h = s("transform");
      return (
        ...
        (o.click = function (t) {
          ...
          "SELECT" != s.tagName &&
            "INPUT" != s.tagName &&
            "TEXTAREA" != s.tagName &&
            ((e = i.createEvent("MouseEvents")).initMouseEvent(
              "click",
              !0,
              !0,
              t.view,
  ...
  return (
    (s.prototype = {
      version: "5.0.6",
      _init: function () {
        (this._initEvents(), this.options.mouseWheel && this._initWheel());
      },
      destroy: function () {
      ...
      _start: function (i) {
        if (
          (1 == n.eventType[i.type] || 0 === i.button) &&
          !(
            !this.enabled ||
            (this.initiated && n.eventType[i.type] !== this.initiated) ||
            ("outerLibrary" === this.wrapper.id && "IMG" === i.target.tagName)
          )
        ) {
          (!this.options.preventDefault ||
            n.isAndroidBrowser ||
            ...
            i.preventDefault(),
            n.addEvent(
              this.options.bindToWrapper ? this.wrapper : t,
              "mousemove",
              this,
            ),
            n.addEvent(
          ...
          var s,
            o = i.touches ? i.touches[0] : i;
          ((this.initiated = n.eventType[i.type]),
            (this.moved = !1),
            (this.distX = 0),
            (this.distY = 0),
            (this.directionX = 0),
      ...
      _end: function (i) {
        if (this.enabled && n.eventType[i.type] === this.initiated) {
          (this.options.preventDefault &&
            !n.preventDefaultException(
              i.target,
              this.options.preventDefaultException,
          ...
          var s,
            ...
            r =
              ...
              n.getTime() - this.startTime),
            h = e.round(this.x),
            a = e.round(this.y),
            l = e.abs(h - this.startX),
            c = e.abs(a - this.startY),
            p = 0,
            u = "";
          if (
            (this.scrollTo(h, a),
            (this.isInTransition = 0),
            (this.initiated = 0),
            (this.endTime = n.getTime()),
            !this.resetPosition(this.options.bounceTime))
          )
            return this.moved
              ? this._events.flick && 200 > r && 100 > l && 100 > c
                ? void this._execEvent("flick")
                : (this.options.momentum &&
                    300 > r &&
                    ((s = this.hasHorizontalScroll
                      ? n.momentum(
                          this.x,
                          this.startX,
                          r,
                  ...
                  h != this.x || a != this.y
                    ? ((h > 0 ||
                        ...
                        a < this.maxScrollY) &&
                        (u = n.ease.quadratic),
                      void this.scrollTo(h, a, p, u))
                    : void this._execEvent("scrollEnd"))
              : (this.options.tap && n.tap(i, this.options.tap),
                void (this.options.click && n.click(i)));
        }
      },
      _resize: function () {
        var t = this;
      ...
      refresh: function (t, i) {
        (arguments.length && 0 !== this.wrapperHeight
          ...
          (this.directionX = 0),
          (this.directionY = 0),
          arguments.length || (this.wrapperOffset = n.offset(this.wrapper)),
      ...
      _execEvent: function (t) {
        if (this._events[t]) {
          ...
          if (e) for (; e > i; i++) this._events[t][i].call(this);
        }
      },
      ...
      _transitionTime: function (t) {
        ((t = t || 0),
          (this.scrollerStyle[n.style.transitionDuration] = t + "ms"));
      },
      ...
      _translate: function (t, i) {
        (this.options.useTransform
          ? (this.scrollerStyle[n.style.transform] =
      ...
      _initEvents: function (i) {
        var e = i ? n.removeEvent : n.addEvent,
        ...
        (e(t, "orientationchange", this),
          ...
          n.hasPointer &&
            ...
            (e(this.wrapper, "MSPointerDown", this),
            e(s, "MSPointerCancel", this),
            e(s, "MSPointerUp", this)),
          n.hasTouch &&
      ...
      getComputedPosition: function () {
        ...
        return (
          this.options.useTransform
            ? ((i = +(
                (s = s[n.style.transform].split(")")[0].split(", "))[12] || s[4]
              )),
              (e = +(s[13] || s[5])))
      ...
      _initWheel: function () {
        (n.addEvent(this.wrapper, "wheel", this),
          n.addEvent(this.wrapper, "mousewheel", this),
          n.addEvent(this.wrapper, "DOMMouseScroll", this),
          this.on("destroy", function () {
            (n.removeEvent(this.wrapper, "wheel", this),
              n.removeEvent(this.wrapper, "mousewheel", this),
              n.removeEvent(this.wrapper, "DOMMouseScroll", this));
          }));
      },
      _wheel: function (t) {
        if (this.enabled) {
...
"undefined" != typeof $ && $(document).trigger("IScrollLoaded");
