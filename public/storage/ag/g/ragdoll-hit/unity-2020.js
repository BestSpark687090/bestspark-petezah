!(function (n) {
  ...
  function (n, e, t) {
              ...
              function (n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        (m = document.getElementById("slideshow")),
                    ...
                    case 16:
                      for (
                        t = h(),
                          ...
                          i = 0;
                        i <= S.a.numScreenshots - 1;
                        i++
                      )
                        ((o = document.createElement("div")),
                          (o.className = "bullet".concat(
                            0 === i ? " active" : "",
                          )),
                        ...
                        r = n.sent,
                          ...
                          a = function (n) {
                            var e = h(),
                              t = new Image();
                            ((t.src = ""
                              .concat(B, "screenshots/")
                              .concat(n + 1, "-small.jpg")
                              .concat(I)),
                              e.appendChild(t),
                              e.setAttribute("data-idx", n),
                              1 === n
                                ? (e.className = "".concat(L, " right"))
                                : n === S.a.numScreenshots - 1
                                  ? (e.className = "".concat(L, " left"))
                                  : (e.className = "".concat(L, " inactive")),
                              w.appendChild(e));
                          },
                          c = 1;
                        c <= S.a.numScreenshots - 1;
                        c++
                      )
                        a(c);
                      s();
            ...
            return x.a.wrap(function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    if (
                      ((e = 1e3 * S.a.slideshowInterval),
                      (t = w.querySelector("#slideshow-images .right")),
                      (i = t.getAttribute("data-idx") << 0),
                      t.getAttribute("fullImageLoaded"))
                    ) {
                      n.next = 16;
                      break;
                    }
                  ...
                  case 7:
                    ((r = n.sent),
                      ...
                      a > e
                        ? l()
                        : (window.slideShowTimeoutID = window.setTimeout(
                            l,
                            e - a,
                          )),
                      (n.next = 19));
                  ...
                  case 16:
                    (clearTimeout(window.slideShowMoveTransitionID),
                      clearTimeout(window.slideShowTimeoutID),
                      (window.slideShowTimeoutID = window.setTimeout(l, e)));
                  case 19:
                  case "end":
                    return n.stop();
                }
    ...
    function d(n) {
      ...
      (w.querySelectorAll(".image").forEach(function (n) {
        (n.className === "".concat(L, " left") &&
          (n.className = "".concat(L, " fromLeft")),
          n.className === "".concat(L, " right") &&
            (n.className = "".concat(L, " fromRight")),
          -1 === n.className.indexOf("inactive") &&
            (n.className += " inactive"));
      }),
        (w.querySelector('[data-idx="'.concat(k, '"]')).className = "".concat(
          L,
          " middle",
        )),
        (w.querySelector('[data-idx="'.concat(e, '"]')).className = "".concat(
          L,
          " left",
        )),
        (w.querySelector('[data-idx="'.concat(t, '"]')).className = "".concat(
          L,
          " right",
        )),
        g.querySelectorAll(".bullet").forEach(function (n, e) {
    ...
    function u() {
      ...
      e > S.a.fullImageMaxHeight &&
        ((e = S.a.fullImageMaxHeight), (t = (e * v) / n));
      ...
      y.innerHTML = "\n\t\t#slideshow-images {\n\t\t\theight: "
        ...
        .concat(S.a.transitionDuration, "s;\n\t\t\twidth: ")
        .concat(100 * t, "vw;\n\t\t\theight: ")
        .concat(
          100 * e,
        ...
        .concat(100 * f, "vw) scale(")
        .concat(
          S.a.smallImageSizeOfFullImage,
          ");\n\t\t}\n\t\t#slideshow-images .right {\n\t\t\ttransform: translateX(",
        )
        .concat(100 * h, "vw) scale(")
        .concat(
          S.a.smallImageSizeOfFullImage,
          ");\n\t\t}\n\t\t#slideshow-images .inactive.fromLeft {\n\t\t\ttransform: translateX(",
        )
        .concat(100 * a, "vw) scale(")
        .concat(
          S.a.smallImageSizeOfFullImage * S.a.animationTargetSizeOfSmallImage,
          ");\n\t\t}\n\t\t#slideshow-images .inactive.fromRight {\n\t\t\ttransform: translateX(",
        )
        .concat(100 * s, "vw) scale(")
        .concat(
          S.a.smallImageSizeOfFullImage * S.a.animationTargetSizeOfSmallImage,
          ");\n\t\t}\n\t",
        );
    ...
    var m,
      ...
      T = window.location.pathname.substring(
        0,
  ...
  function (n, e, t) {
    ...
    var u = r.a.thumbnail;
    (u.startsWith("https://img.poki-cdn.com/") &&
      (u =
        "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/".concat(
          u.substr(21),
        )),
      (d.src = u));
  ...
  function (n, e, t) {
    ...
    function h(n, e) {
      var t = e.css,
        i = e.media;
      if ((i && n.setAttribute("media", i), n.styleSheet))
  ...
  function (n, e, t) {
    ...
    function i() {
      ...
      ((d.style.width = "".concat(n, "px")),
        (d.style.height = "".concat(e, "px")),
        t > w.a.maxRatio
          ? (d.style.width = "".concat(e * w.a.maxRatio, "px"))
          : t < w.a.minRatio &&
            (d.style.height = "".concat(n / w.a.minRatio, "px")));
      var i = d.getBoundingClientRect();
      ((d.style.marginLeft = "".concat(-0.5 * i.width, "px")),
        (d.style.marginTop = "".concat(-0.5 * i.height, "px")));
    }
    function o() {
      ((d = document.getElementById("game-container")),
        (u = document.getElementById("loader")),
        (f = document.getElementById("progress-container")),
        (h = document.getElementById("progress-fill")),
        (m = document.getElementById("progress-amount")),
        (p = document.getElementById("progress-comment")),
    ...
    function a(n) {
      var e = 100 * n;
      ((h.style.width = "".concat(e, "%")),
        (m.innerHTML = "".concat(e << 0, "%")),
        w.a.fileSize && (m.innerHTML += " of ".concat(w.a.fileSize, "MB")));
      var t = {
        percentageDone: n,
      };
    ...
    function s() {
      ...
      n
        ? ((p.innerHTML = n[y]),
          y++,
          y >= n.length && (y = 0),
          (g = setTimeout(s, w.a.commentChangeTime)))
        : (p.innerHTML = "");
    }
    function c() {
      var n = document.createElement("script");
      ((n.src = "https://cdn.jsdelivr.net/gh/Collasperz/ragdoll-hit/"
        .concat("Build", "/")
        .concat(w.a.metadata.loader_filename)),
        (w.a.dataUrl = "https://cdn.jsdelivr.net/gh/Collasperz/ragdoll-hit/"
          .concat("Build", "/")
          .concat(w.a.metadata.data_filename)),
        (w.a.frameworkUrl =
          "https://cdn.jsdelivr.net/gh/Collasperz/ragdoll-hit/"
            .concat("Build", "/")
            .concat(w.a.metadata.framework_filename)),
        (w.a.codeUrl = "https://cdn.jsdelivr.net/gh/Collasperz/ragdoll-hit/"
          .concat("Build", "/")
          .concat(w.a.metadata.code_filename)),
        (w.a.streamingAssetsUrl = "StreamingAssets"),
        n.addEventListener("load", function () {
          var n = document.querySelector("#game");
          createUnityInstance(n, w.a, a)
            .then(function (n) {
        ...
        w.a.fileSize &&
          ((m.innerHTML += " of ".concat(w.a.fileSize, "MB")),
          (m.style.width = "12vh"),
  ...
  function (n, e, t) {
    var i = (function (n) {
      ...
      function s(n) {
        function e(i, o, r, a) {
          ...
          if ("throw" !== s.type) {
            var c = s.arg,
              l = c.value;
            return l && "object" == typeof l && w.call(l, "__await")
      ...
      function c(n, e, i) {
        ...
        return function (r, a) {
          ...
          for (i.method = r, i.arg = a; ; ) {
            ...
            "throw" === d.type &&
              ((o = E), (i.method = "throw"), (i.arg = d.arg));
          }
        };
      }
      function l(n, e) {
      ...
      return (
        (o.prototype = j.constructor = r),
        (r.constructor = o),
        (r[x] = o.displayName = "GeneratorFunction"),
        ...
        (n.mark = function (n) {
          return (
            Object.setPrototypeOf
              ...
              : ((n.__proto__ = r), x in n || (n[x] = "GeneratorFunction")),
            (n.prototype = Object.create(j)),
            n
          );
        }),
        (n.awrap = function (n) {
        ...
        (f.prototype = {
          ...
          finish: function (n) {
            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
              ...
              if (t.finallyLoc === n)
                return (this.complete(t.completion, t.afterLoc), u(t), I);
            }
          },
          catch: function (n) {
            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
    ...
    ((window.initPokiBridge = function (n) {
      ...
      window.pokiReady || window.pokiAdBlock
        ? window.pokiReady
          ...
          : window.pokiAdBlock && window.unityGame.SendMessage(n, "adblock")
        : (window.pokiBridge = n);
    }),
      (window.commercialBreak = function () {
        PokiSDK.commercialBreak().then(function () {
          window.unityGame.SendMessage(t, "commercialBreakCompleted");
        });
      }),
      (window.rewardedBreak = function () {
        var n;
        (n = PokiSDK).rewardedBreak.apply(n, arguments).then(function (n) {
      ...
      (window.shareableURL = function (n) {
        PokiSDK.shareableURL(n)
          .then(function (n) {
            window.unityGame.SendMessage(t, "shareableURLResolved", n);
          })
          .catch(function () {
            window.unityGame.SendMessage(t, "shareableURLRejected");
          });
      }));
  },
]);
