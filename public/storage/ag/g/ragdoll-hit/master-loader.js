!(function (t) {
  ...
  function (t, r, n) {
    ...
    if (
      (window.location.href.indexOf("pokiForceLocalLoader") >= 0 &&
        ...
        (c["unity-2020"] = "/unity-2020/dist/unity-2020.js"),
        (i = "/loaders")),
      !window.config)
    )
    ...
    if (!window.config.unityWebglLoaderUrl) {
      var u = window.config.unityVersion
      ...
      switch (s) {
        case "2019":
          window.config.unityWebglLoaderUrl =
            1 === f ? "UnityLoader.2019.1.js" : "UnityLoader.2019.2.js";
          break;
        default:
  ...
  function (t, r, n) {
    ...
    try {
      ...
      window.IDBObjectStore.prototype.put = function () {
        if ("UnityCache" === this.transaction.db.name)
          return {
            onsuccess: function () {},
            onerror: function () {},
          };
        ...
        if ("/idbfs" === this.transaction.db.name) {
          try {
            a ||
              ((a = i(r[1])), localStorage.setItem("savegame_idbfs_hash", a));
          } catch (t) {}
          var o = [].concat(r);
  ...
  function (t, r, n) {
    "use strict";
    function e(t) {
      for (var r, n = "0123456789ABCDEF", e = "", o = 0; o < t.length; o++)
        ((r = t.charCodeAt(o)),
    ...
    function i(t) {
      for (var r = "", n = 0; n < 32 * t.length; n += 8)
        r += String.fromCharCode((t[n >> 5] >>> n % 32) & 255);
      return r;
    }
    function c(t, r) {
          ...
          (e = d(
            (e = d(
                  ...
                  (e = f(
                    (e = f(
                      (e = f(
                        (e = s(
                          ...
                          (o = s(
                            ...
                            (i = s(
                              i,
                              (n = s(n, e, o, i, t[c + 13], 5, -1444681467)),
                              e,
                              o,
                              t[c + 2],
                              9,
                      ...
                      (o = f(
                        ...
                        (i = f(
                          i,
                          (n = f(n, e, o, i, t[c + 1], 4, -1530992060)),
                          e,
                          o,
                          t[c + 4],
                          11,
                    ...
                    (o = f(
                      ...
                      (i = f(
                        i,
                        (n = f(n, e, o, i, t[c + 13], 4, 681279174)),
                        e,
                        o,
                        t[c + 0],
                        11,
              ...
              (o = d(
                ...
                (i = d(
                  i,
                  (n = d(n, e, o, i, t[c + 12], 6, 1700485571)),
                  e,
                  o,
                  t[c + 3],
                  10,
            ...
            (o = d(
              ...
              (i = d(
                i,
                (n = d(n, e, o, i, t[c + 8], 6, 1873313359)),
                e,
                o,
                t[c + 15],
                10,
