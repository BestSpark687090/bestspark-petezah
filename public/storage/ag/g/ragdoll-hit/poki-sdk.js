            ...
            var e = this,
              t = function () {
                ...
                if ("function" == typeof window.PokiSDK[a])
                  if (
                    (null == r ? void 0 : r.resolveFn) ||
                    (null == r ? void 0 : r.rejectFn)
                  ) {
                    var s = "init" === a;
                    if (
                      ((t = window.PokiSDK)[a]
                        ...
                        .catch(function () {
                          for (var t = [], n = 0; n < arguments.length; n++)
                            t[n] = arguments[n];
                          ("function" == typeof r.rejectFn &&
                            r.rejectFn.apply(r, t),
                            s &&
                              setTimeout(function () {
                                e.dequeue();
                              }, 0));
                        ...
                        .then(function () {
                          for (var t = [], n = 0; n < arguments.length; n++)
                            t[n] = arguments[n];
                          ("function" == typeof r.resolveFn &&
                            r.resolveFn.apply(r, t),
                            s &&
                              setTimeout(function () {
                                e.dequeue();
                              }, 0));
    ...
    o ||
      ...
      (window.pokiCancelProgressInterval = setInterval(function () {
        window.parent.postMessage(
          { type: "pokiProgress", downloaded: e() },
          "*",
        );
      }, 1e3)));
  var a = (function () {
      var e =
          ...
          t("ab") ||
          "baeb385ae52d1fe15574a1f68cfa8d3a444a190a",
