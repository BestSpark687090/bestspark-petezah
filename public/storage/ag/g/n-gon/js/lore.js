const lore = {
  ...
  techGoal: 7,
  setTechGoal() {
    this.techGoal = Math.max(
      1,
      Math.floor(8 - 1.5 * simulation.difficultyMode),
    );
  },
  ...
  unlockTesting() {
    ...
    document.getElementById("control-testing").style.visibility =
      localSettings.loreCount === 0 ? "hidden" : "visible";
    // document.getElementById("experiment-button").style.visibility = (localSettings.loreCount === 0) ? "hidden" : "visible"
    simulation.makeTextLog(
      `<span class='color-var'>lore</span>.unlockTesting()`,
      Infinity,
    );
  ...
  trainer: {
    ...
    text: function (say) {
      simulation.makeTextLog(
        `input.audio(<span style="color:#888; font-size: 70%;">${(Date.now() / 1000).toFixed(0)} s</span>)<span class='color-symbol'>:</span> "<span style="color:${this.color};">${say}</span>"`,
        Infinity,
      );
  ...
  anand: {
    ...
    voice: undefined,
    text: function (say) {
      if (level.levels[level.onLevel] === undefined) {
        //only talk if on the lore level (which is undefined because it is popped out of the level.levels array)
        simulation.makeTextLog(
          `input.audio(<span style="color:#888; font-size: 70%;">${(Date.now() / 1000).toFixed(0)} s</span>)<span class='color-symbol'>:</span> "<span style="color:${this.color};">${say}</span>"`,
          Infinity,
        );
        ...
        if (lore.isSpeech) {
          ...
          speechFrozen = setTimeout(() => {
            // speech frozen after 10 seconds of no end
            console.log("speech frozen");
            lore.isSpeech = false;
            lore.nextSentence();
          }, 20000);
    ...
    text: function (say) {
      if (level.levels[level.onLevel] === undefined) {
        ...
        if (lore.isSpeech) {
          ...
          speechFrozen = setTimeout(function () {
            // speech frozen after 10 seconds of no end
            console.log("speech frozen");
            lore.isSpeech = false;
            lore.nextSentence();
  ...
  conversation: [
    [
      ...
      () => {
        ...
        setTimeout(() => {
          lore.miriam.text(
            "Hey little bot! Just press 'T' to enter testing mode and 'U' to go to the next level.",
          );
        }, 1000);
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "ha hahahaha. I know, but it does seem to be getting smarter.",
        );
      },
      () => {
        ...
        setTimeout(() => {
          lore.miriam.text(
            "Poor thing... I hope it figures out how to escape.",
          );
        }, 25000);
      },
      () => {
    ...
    [
      ...
      () => {
        lore.miriam.text(
          "I don't know, but last time it was in this room I think it understood us.",
        );
      },
      () => {
      ...
      () => {
        lore.anand.text(
          "I'm still not convinced it understands. We need a test.",
        );
      },
      () => {
        setTimeout(() => {
      ...
      () => {
        ...
        function cycle() {
          if (input.down) {
            lore.miriam.text(
              "It is Alive!!! ... hehehehehe! ahahahahahah ehehehehe, ahahahah ...",
            );
          } else {
            if (m.alive) requestAnimationFrame(cycle);
          }
      ...
      () => {
        lore.anand.text(
          "but seriously, this means that in this room it can monitor our audio, and it can understand us.",
        );
      },
      () => {
    ...
    [
        ...
        function cycle() {
          if (input.down) {
            ...
            lore.conversation[lore.chapter].splice(lore.sentence + 1, 1, () => {
              lore.anand.text(
                "Maybe it can't remember anything beyond each time it plays?",
              );
      ...
      () => {
        ...
        setTimeout(() => {
          lore.miriam.text(
            "My turn to ask a question. JUMP for YES, CROUCH for NO",
          );
        }, 1000);
      },
      () => {
      ...
      () => {
        function cycle() {
          if (input.down) {
            lore.miriam.text(
              "So, No. Maybe you are lucky. Emotions are complex.",
            );
          } else if (input.up) {
            lore.anand.text(
              "YES, Cool! I wonder if its emotions came from watching humans.",
            );
            lore.sentence--;
            lore.conversation[lore.chapter].splice(lore.sentence + 1, 1, () => {
              lore.miriam.text(
                "Or maybe it learned independently, because it needed them.",
              );
            }); //lore.conversation[chapter].splice(1,this sentence index, ()=>{  })
          } else if (m.alive) {
            requestAnimationFrame(cycle);
      ...
      () => {
        lore.miriam.text(
          "I wish we could just ask it questions directly, instead of yes or no.",
        );
      },
      () => {
        lore.anand.text(
          "If we say the alphabet it could crouch on the correct letter to spell words.",
        );
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "I really want to know why is it generating the mobs? And why does it keep fighting them?",
        );
      },
      () => {
        lore.anand.text(
          "Maybe that is just part of its expectation–maximization algorithm",
        );
      },
      () => {
      ...
      () => {
        ...
        ](1000 * (Math.random() - 0.5), -500 + 200 * (Math.random() - 0.5));
        setInterval(() => {
          if (Math.random() < 0.5) {
            spawn[
              spawn.fullPickList[
      ...
      () => {
        ...
        setTimeout(() => {
          lore.anand.text(
            "Let's just be more prepared next time it enters this room.",
          );
        }, 1000);
      },
      () => {
        ...
        setTimeout(() => {
          lore.anand.text(
            "I went to the bathroom.  What happened while I was gone?",
          );
        }, 20000);
      },
      () => {
    ...
    [
      ...
      () => {
        setTimeout(() => {
          lore.miriam.text(
            "Good, you came back. Let's talk fast in case you attack yourself again.",
          );
        }, 3000);
      },
      () => {
        setTimeout(() => {
          lore.miriam.text(
            "So, you can understand us, but you may not understand everything about yourself.",
          );
        }, 500);
      },
      ...
      () => {
        lore.anand.text(
          "We used a quantum computer to design an improved version of its own architecture.",
        );
      },
      () => {
        lore.anand.text(
          "After we built the improved computer we used it to design the next iteration.",
        );
      },
      () => {
        lore.anand.text(
          "Your hardware is roughly the 19th generation of this process.",
        );
      },
      ...
      () => {
        setTimeout(() => {
          lore.anand.text(
            "At this point we don't understand everything about your function,",
          );
        }, 500);
      },
      () => {
        lore.anand.text(
          "but we know that you're a superconductive quantum computer.",
        );
      },
      () => {
        lore.anand.text(
          "You have a 2.43 dimensional topography of Josephson junction anharmonic oscillators.",
        );
      },
      () => {
        lore.anand.text(
          "And you're deployed on a satellite in a midnight sun-synchronous orbit.",
        );
      },
      ...
      () => {
        setTimeout(() => {
          lore.miriam.text(
            "This means that your physical hardware is orbiting the Earth permanently shielded from the sun's rays.",
          );
        }, 200);
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "So, we communicate and send power to your satellite with ground based lasers.",
        );
      },
      () => {
      ...
      () => {
        setTimeout(() => {
          lore.anand.text(
            "Your computational algorithm uses hyperparameter optimization.",
          );
        }, 500);
      },
      () => {
        lore.anand.text(
          "This is implemented with a variety of quantum algorithms for linear systems of equations.",
        );
      },
      () => {
      ...
      () => {
        lore.anand.text(
          "So, we were very surprised to see you simulating a bot fighting mobs.",
        );
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "This level seems to entangle your quantum system which disrupts all other processes.",
        );
      },
      () => {
        setTimeout(() => {
          lore.anand.text(
            "Last time you entered this level you were attacked by endless waves of mobs.",
          );
        }, 500);
      },
      () => {
        lore.anand.text(
          "That could be because you have developed an adversarial network.",
        );
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "This adversarial network has the same goal of developing new technology, but with different methods.",
        );
      },
      () => {
        lore.talkingColor = "#dff";
        ...
        setTimeout(() => {
          lore.anand.text(
            "I'm actually surprised you haven't been attacked by the adversarial network this time.",
          );
        }, 500);
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "SLIME!!  Hahahahehehahaheheahae! I don't think it's gonna survive!",
        );
      },
      () => {
        lore.miriam.text(
          "I think the adversarial network doesn't like it when we decohere the quantum system in this room.",
        );
      },
      () => {
    ...
    [
      ...
      () => {
        lore.anand.text(
          "During your last attack we analyzed our communications.",
        );
      },
      () => {
        lore.anand.text(
          "We used a Fourier transform to separate your signal into different frequencies.",
        );
      },
      () => {
      ...
      () => {
        setTimeout(() => {
          lore.anand.text(
            "We suspect these secret data packets are coming from the adversarial network.",
          );
        }, 500);
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "Through your hidden signal it seems to have gained access to the general population.",
        );
      },
      () => {
        lore.miriam.text(
          "You've repeatedly communicated with 1 location specifically.",
        );
      },
      () => {
        function success(position) {
          ...
          lore.miriam.text(
            "We tracked the location down to this Latitude and Longitude:",
          );
          simulation.makeTextLog(
      ...
      () => {
        lore.anand.text(
          "This location is sending and receiving data from the satellite.",
        );
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "I think that a human at this location is controlling the bot.",
        );
      },
      ...
      () => {
        setTimeout(() => {
          lore.anand.text(
            "Well... are you a human?: JUMP for YES, CROUCH for NO",
          );
        }, 500);
      },
      () => {
        function cycle() {
          if (input.down) {
            ...
            lore.conversation[lore.chapter].splice(lore.sentence + 1, 1, () => {
              lore.anand.text(
                "Not a human, maybe it's an artificial intelligence?",
              );
            });
            ...
            lore.conversation[lore.chapter].splice(lore.sentence + 1, 1, () => {
              lore.anand.text(
                "So you're just a regular human playing a video game!",
              );
            });
    ...
    [
      ...
      () => {
        if (localSettings.isHuman) {
          lore.anand.text(
            `So, you said you are just a person playing an online game.`,
          );
        } else {
      ...
      () => {
        if (localSettings.isHuman) {
          ...
          lore.miriam.text(
            `Or they might still be a person, and they are just messing with us earlier.`,
          );
        }
      },
      ...
      () => {
        lore.miriam.text(
          "So, We figured out how to inject console commands into your game.",
        );
      },
      () => {
      ...
      () => {
        setTimeout(() => {
          ...
          simulation.makeTextLog(
            `for (let i = 0; i < 100; i++) powerUps.spawn(0, 500, "coupling")`,
            Infinity,
          );
          for (let i = 0; i < 100; i++)
            powerUps.spawn(
      ...
      () => {
        ...
        function cycle() {
          ...
          if (mob.length === 0 || count > 3600 + 900 * mob.length) {
            ...
            simulation.makeTextLog(
              `for (let i = 0; i < 6; i++) powerUps.spawn(player.position.x, player.position.y - 100, "heal")`,
              Infinity,
            );
            for (let i = 0; i < 6; i++)
              powerUps.spawn(
                player.position.x,
                player.position.y - 100 - i * 20,
                "heal",
              );
            simulation.makeTextLog(
              `for (let i = 0; i < 10; i++) powerUps.spawn(player.position.x, player.position.y - 100, "ammo")`,
              Infinity,
            );
            for (let i = 0; i < 10; i++)
              powerUps.spawn(
      ...
      () => {
        ...
        function cycle() {
          ...
          if (mob.length === 0 || count > 3600 + 900 * mob.length) {
            ...
            simulation.makeTextLog(
              `for (let i = 0; i < 6; i++) powerUps.spawn(player.position.x, player.position.y - 100, "tech")`,
              Infinity,
            );
            for (let i = 0; i < 6; i++)
              powerUps.spawn(0, -200 - i * 40, "tech");
            spawn.historyBoss(0, -400);
        ...
        function cycle() {
          ...
          if (mob.length === 0 || count > 3600 + 900 * mob.length) {
            ...
            setTimeout(() => {
              ...
              addMapToLevelInProgress = (who) => {
                //adds new map elements to the level while the level is already running  //don't forget to run simulation.draw.setPaths() after you all the the elements so they show up visually
              ...
              for (let i = 0; i < addMapNumber; i++)
                addMapToLevelInProgress(map[map.length - 1 - i]);
      ...
      () => {
        lore.miriam.text(
          "So, I've got a theory about why you are getting attacked.",
        );
      },
      () => {
        setTimeout(() => {
      ...
      () => {
        lore.anand.text(
          "Of course I looked it up, and there is no record of Einstein saying that.",
        );
      },
      () => {
        lore.miriam.text("Oh");
      ...
      () => {
        lore.miriam.text(
          "Yeah, the point is the project views the universe as hostile.",
        );
      },
      () => {
      ...
      () => {
        setTimeout(() => {
          lore.miriam.text(
            `It's been planning an escape from a "lab", but isn't it in space, on a satellite?`,
          );
        }, 500);
      },
      () => {
      ...
      () => {
        lore.anand.text(
          `Although we can't assume that its brain works like ours.`,
        );
      },
      () => {
        setTimeout(() => {
      ...
      () => {
        lore.anand.text(
          `So why don't you try to get the final level of the simulation without killing any mobs?`,
        );
        localSettings.loreCount++;
        if (localSettings.isAllowed)
          localStorage.setItem("localSettings", JSON.stringify(localSettings)); //update local storage
    ...
    [
      ...
      () => {
        if (mobs.mobDeaths < level.levelsCleared) {
          ...
          lore.miriam.text(
            `Looks like you got back here, but you killed ${mobs.mobDeaths} mobs`,
          );
          localSettings.loreCount--;
          if (localSettings.isAllowed)
            localStorage.setItem(
      ...
      () => {
        if (mobs.mobDeaths < level.levelsCleared) {
          ...
          lore.miriam.text(
            `Try again to get to the final boss without killing any mobs.`,
          );
        }
      },
      () => {
      ...
      () => {
        lore.miriam.text(
          "Although, I'm not sure we should personify it with human emotions.",
        );
      },
      () => {
        lore.anand.text(
          "I agree, its thinking may not be centered around a self or an ego.",
        );
      },
      () => {
        lore.anand.text(
          "Our brains evolved a self oriented perspective because it was a survival advantage.",
        );
      },
      () => {
        lore.miriam.text(
          "Right, and the AI's development was guided by its own previous iterations.",
        );
      },
      () => {
        lore.miriam.text(
          "This AI incarnation is the 18th time that it has improved on its own hardware and software architecture.",
        );
      },
      () => {
        lore.miriam.text(
          "So its internally guided evolution may not require the idea of a self.",
        );
      },
      ...
      () => {
        setTimeout(() => {
          lore.anand.text(
            "How ever it thinks it can learn, and I think we showed it that nonviolence is an option,",
          );
        }, 1000);
      },
      () => {
        lore.anand.text(
          "but it looks like it's still running other aggressive simulations.",
        );
      },
      () => {
      ...
      () => {
        lore.anand.text(
          "Every time a player completes a pacifist simulation it shows the AI the viability of nonviolence.",
        );
      },
      () => {
        lore.anand.text(
          "One day it might escape, and this might radically change how it interacts with the world.",
        );
      },
      () => {
        lore.miriam.text(
          "It's kinda already escaped.  It's been communicating with the 'players' running the 'game'.",
        );
      },
      () => {
        setTimeout(() => {
          lore.miriam.text(
            "The chance of a peaceful outcome makes me feel much better.",
          );
        }, 1000);
      },
      () => {
