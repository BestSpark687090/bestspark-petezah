!(function (t) {
  ...
  function (t, n, e) {
    ...
    t.exports = function (t) {
      return (
        o(c, t) || (s && o(u, t) ? (c[t] = u[t]) : (c[t] = A("Symbol." + t))),
        c[t]
      );
    };
  },
    ...
    t.exports = function (t, n) {
      ...
      if ((e = p ? i : g ? i[f] || s(f, {}) : (i[f] || {}).prototype))
        for (u in n) {
          if (
            ((l = n[u]),
            (A = t.noTargetGet ? (m = r(e, u)) && m.value : e[u]),
            !c(p ? u : f + (g ? "." : "#") + u, t.forced) && void 0 !== A)
          ) {
  ...
  function (t, n, e) {
    ...
    (t.exports = function (t, n, e, s) {
      ...
      ("function" == typeof e &&
        ...
        (u(e).source = A.join("string" == typeof n ? n : ""))),
        t !== i
          ? (d ? !l && t[n] && (c = !0) : delete t[n],
            c ? (t[n] = e) : r(t, n, e))
          : c
            ? (t[n] = e)
            : a(n, e));
  ...
  function (t, n, e) {
    ...
    (t.exports = function (t, n, e, u, A) {
      ...
      if (A) l = t;
        ...
        if (r(m)) {
          for (f = 0, p = o(t.length); p > f; f++)
            if ((g = u ? y(i((w = t[f]))[0], w[1]) : y(t[f])) && g instanceof c)
              return g;
          return new c(!1);
        }
        l = m.call(t);
      ...
      for (h = l.next; !(w = h.call(l)).done; )
        if ("object" == typeof (g = d(l, y, w.value, u)) && g && g instanceof c)
          return g;
      return new c(!1);
    }).stop = function (t) {
      return new c(!0, t);
      ...
      if (
        (B &&
          ...
          f !== Object.prototype &&
            ...
            (A ||
              o(k) === f ||
              (a ? a(k, f) : "function" != typeof k[g] && d(k, g, h)),
            s(k, E, !0, !0),
            A && (l[E] = h))),
        "values" == m &&
          T &&
            ...
            : !a.addEventListener ||
              ...
              ? (i =
                  "onreadystatechange" in A("script")
                    ? function (t) {
                        u.appendChild(A("script")).onreadystatechange =
                          function () {
  ...
  function (t, n, e) {
    ...
    t.exports =
      ...
      r(function () {
        ...
        ? function (t, n) {
            for (
              var e = d(t), r = arguments.length, u = 1, A = a.f, l = s.f;
              r > u;
              ...
              for (
                var m,
                  f = c(arguments[u++]),
                  p = A ? o(f).concat(A(f)) : o(f),
                  g = p.length,
                  h = 0;
                g > h;

              )
                ((m = p[h++]), (i && !l.call(f, m)) || (e[m] = f[m]));
            return e;
          }
        : u;
  },
  ...
  function (t, n, e) {
            ...
            for (
              ...
              if (t === r)
                for (var o = this.listeners[r], a = 0; a < o.length; a++)
                  o[a](c(c({}, this.dataAnnotations), n));
            }
          }),
      ...
      p = (function () {
        ...
        return (
          ...
          (t.setupDefaultEvents = function () {
            var n,
              e =
                (((n = {})[d.ready] = d.tracking.sdk.status.initialized),
                (n[d.adblocked] = d.tracking.sdk.status.failed),
                (n[d.ads.busy] = d.tracking.ads.status.busy),
                (n[d.ads.completed] = d.tracking.ads.status.completed),
                (n[d.ads.error] = d.tracking.ads.status.error),
                (n[d.ads.displayError] = d.tracking.ads.status.displayError),
                (n[d.ads.impression] = d.tracking.ads.status.impression),
                (n[d.ads.limit] = d.tracking.ads.status.limit),
                (n[d.ads.ready] = d.tracking.ads.status.ready),
                (n[d.ads.requested] = d.tracking.ads.status.requested),
                (n[d.ads.skipped] = d.tracking.ads.status.skipped),
                (n[d.ads.started] = d.tracking.ads.status.started),
                (n[d.ads.video.clicked] = d.tracking.ads.video.clicked),
                (n[d.tracking.screen.gameplayStart] =
                  d.tracking.screen.gameplayStart),
                (n[d.tracking.screen.gameplayStop] =
                  d.tracking.screen.gameplayStop),
                (n[d.tracking.screen.loadingProgress] =
                  d.tracking.screen.loadingProgress),
                (n[d.tracking.screen.commercialBreak] =
                  d.tracking.screen.commercialBreak),
                (n[d.tracking.screen.rewardedBreak] =
                  d.tracking.screen.rewardedBreak),
                (n[d.tracking.screen.happyTime] = d.tracking.screen.happyTime),
                n);
    ...
    var D = (function () {
        function t(t, n) {
          (void 0 === n && (n = {}),
            ...
            (this.totalRetries = n.totalRetries || g.waterfallRetries || 1),
            (this.timing = n.timing || new w(g.adTiming)),
            (this.overwriteAdTagUrls = n.adTagUrl ? h(n.adTagUrl) : []),
            ...
            u.addEventListener(d.ads.started, this.stopWaterfall.bind(this)));
        }
        return (
          ...
          (t.prototype.start = function (t, n, e, i) {
            (void 0 === t && (t = {}),
              ...
              (this.rewarded = n === d.ads.position.rewarded),
          ...
          (t.prototype.requestAd = function () {
            ...
            if (
              (ct.consentString &&
                ct.consentString.length > 0 &&
                (this.criteria.consent_string = ct.consentString),
              this.runAdOnPlatform)
            )
              return (
                l.sendMessage(d.message.runAdOnPlatform, {
                  position: e,
                  adTagUrls: this.adTagUrls,
                  criteria: this.criteria,
                }),
                this.stopWaterfall(),
                void u.dispatchEvent(d.ads.pushedToPlatform)
              );
            var i,
              r,
              o =
            ...
            (ct.childDirected && (o += "&tfcd=1"),
              ct.nonPersonalized && (o += "&npa=1"),
              u.setDataAnnotations({
                adTagUrl: o,
                opportunityId: this.opportunityId,
                position: e,
                waterfall: this.retries,
              }),
              u.dispatchEvent(d.ads.requested),
              1 !== this.retries || k() || v() || this.disableHB
      ...
      G = (function () {
        function t(t) {
          ...
          if (
            ...
            u.addEventListener(d.ads.video.progress, function (t) {
            ...
            u.addEventListener(d.ads.started, function (e) {
              ...
              if (
                e.position === d.ads.position.midroll &&
        ...
        return (
          ...
          (t.prototype.skipAdCheck = function (t) {
            this.adSkippable &&
              (ct.GetIsMinimizeTestCountry() || this.minimizeFeature
                ? (this.hideElement(this.skipContainer),
                  p.track(d.tracking.ads.status.minimizeButtonPressed, {
                    position: this.position,
                  }),
                  l.sendMessage(d.message.minimizeAd))
                : (p.track(d.tracking.ads.status.manualSkipButtonPressed, {
                    position: this.position,
                  }),
          ...
          (t.prototype.createElements = function () {
            if (
              ...
              (this.progressBar.className = L),
              (this.progressContainer.className = "pokiSdkProgressContainer"),
              (this.skipContainer.className = M),
              (this.spinnerContainer.className = R),
      ...
      K = (function () {
        ...
        return (
          ...
          (t.prototype.onAdsManagerLoaded = function (t) {
            ...
            ((n.enablePreloading = !0),
              ...
              this.allowedToPlayAd
                ? (this.attachAdEvents(), u.dispatchEvent(d.ads.ready))
                : this.tearDown());
          }),
          ...
          (t.prototype.resumeAd = function () {
            (u.dispatchEvent(d.ads.video.resumed),
          ...
          (t.prototype.onAdEvent = function (t) {
            ...
            switch (t.type) {
              ...
              case google.ima.AdEvent.Type.SKIPPED:
                (u.dispatchEvent(d.ads.skipped),
                  u.dispatchEvent(d.ads.completed),
                  document.activeElement && document.activeElement.blur());
                break;
              case google.ima.AdEvent.Type.IMPRESSION:
                u.dispatchEvent(d.ads.impression, {
                  userValueIndicator: _(
                    u.getDataAnnotations().position === d.ads.position.rewarded
                      ? "rewarded"
                      : "video",
                  ),
                });
                  ...
                  switch (m.label) {
                    ...
                    case 2:
                      if (
                        ...
                        navigator.sendBeacon(A, e);
                      else
                        try {
                          ((l = new XMLHttpRequest()).open("POST", A, !0),
                            l.send(e));
                        } catch (t) {}
                      return [3, 4];
                    case 3:
          ...
          switch (n.label) {
            case 0:
              return (
                ...
                [
                  4,
                  fetch("https://lablockedgames.loc/", {
                    method: "GET",
                    headers: {
                      "Content-Type": "text/plain",
                    },
        ...
        return (
          (t.prototype.init = function (n) {
            ...
            if ((void 0 === n && (n = {}), "undefined" != typeof window)) {
              ...
              var i = n.adTagUrl,
                ...
                R = q(it.a).then(function () {
                  ...
                  ((t = y),
                    ...
                    window.pbjs.que.push(function () {
                      (window.pbjs.addAdUnits(t.adUnits || B),
                        window.pbjs.setConfig(S(S({}, I), t.config)));
                    }));
                });
              (m && this.registerHandler("onReady", m),
                h && this.registerHandler("onAdblocked", h));
              ...
              return (
                X
                  ? (this.setDebug("true" === X),
                    (this.debugIsOverwritten = !0))
                  : this.setDebug(A),
                Promise.all([
                  N(),
                  et(),
                  q("https://lablockedgames.com/main.min.js"),
                  q("https://lablockedgames.com/main.min.js"),
                  R,
                ])
                  .catch(function () {
                  ...
                  .then(function (n) {
                    if (void 0 !== n) {
                      ...
                      (i &&
                        (at.gameId || (at.gameId = i.gameId),
                        (o.adTiming = i.adTiming),
                        (o.customCriteria = rt(rt({}, o.customCriteria), {
                          p4d_game_id: at.gameId,
                        }))),
                        e.debug && (o.adTiming.startAdsAfter = 0),
                        e.enableSettings(o),
                        (z || C) && t.isPokiPlatform
                          ? (e.playerSkin = new G({
                              wrapper: E,
                              minimizeFeature: C,
                              skipFeature: z,
          ...
          (t.prototype.requestAd = function (n) {
            ...
            if (
              ...
              s && this.registerHandler("onFinish", s),
              l && this.registerHandler("onStart", l),
              !this.sdkBooted)
            )
              return (
                u.dispatchEvent(d.ads.error, {
            ...
            if (this.sdkImaError)
              ...
              ((t.isPokiPlatform || f === d.ads.position.rewarded) &&
                (y = rt(rt({}, y), o)),
                (y = rt(rt({}, y), this.genericCriteria())),
                this.resize(),
                this.playerSkin.showWithOpacity(),
                this.playerSkin.setPosition(f),
                this.waterfall.start(y, f, w ? [w] : [], g));
            }
          }),
          (t.prototype.runWaterfallChain = function (t) {
            ...
            if (
              (u.clearAnnotations(),
              r && this.registerHandler("onFinish", r),
            ...
            if (this.sdkImaError)
              ...
              ((this.autoStartOnReady = !0),
                this.resize(),
                this.playerSkin.showWithOpacity(),
                this.playerSkin.setPosition(m),
                this.waterfall.start(e, m, c, !1));
            }
          }),
          (t.prototype.displayAd = function (t, n) {
            ...
            if (n) {
              if (!this.sdkBooted)
                return (
                  u.dispatchEvent(d.ads.displayError, {
                    message: "Requesting ad on unbooted SDK",
                  }),
                  void this.sdkNotBootedButCalled()
                );
                ...
                if (this.sdkImaError)
                  ...
                  var i = (function (t, n) {
                    ...
                    if (
                      (k() ||
                        v() ||
                        ["970x250", "300x250", "728x90", "160x600"].includes(
                          t,
                        )) &&
                      ((!k() && !v()) || ["320x50"].includes(t))
                    ) {
                  ...
                  if (!i)
                    return u.dispatchEvent(d.ads.displayError, {
                      reason:
                        "Display size " +
                        n +
                  ...
                  (t.getAttribute("data-poki-ad-size") &&
                    ...
                    this.googletag.cmd.push(function () {
                      ...
                      ((n.id = st(i.size)),
                        ...
                        t.appendChild(n),
                        t.setAttribute("data-poki-ad-size", i.size.join("x")),
          ...
          (t.prototype.enableSettings = function (t) {
            ((this.criteria = rt({}, t.customCriteria)),
              (this.adTimings = new w(t.adTiming)),
          ...
          (t.prototype.setDebug = function (t) {
            ...
            this.debugIsOverwritten
              ? t && p.track(d.tracking.debugTrueInProduction)
              : (p.setDebug(t),
                u.setDebug(t),
                this.waterfall
            ...
            return (
              ...
              n.includes("-exp-minimize-ads-c.")
                ...
                : n.includes("-exp-minimize-ads-1.")
                  ? (t.exp_min_video = 2)
                  : n.includes("-exp-minimize-ads-2.") && (t.exp_min_video = 3),
    ...
    function lt(t) {
      if (at.gameId && at.versionId && !(Date.now() < At))
        try {
        ...
        function t() {
          ...
          ((this.gameStarted = !1),
            ...
            (this.gameplayStart = function () {
              (t.gameStarted ||
                ((t.gameStarted = !0),
                p.track(d.tracking.screen.firstRound),
                t.SDK.startStartAdsAfterTimer()),
                p.track(d.tracking.screen.gameplayStart));
            }),
            ...
            (this.roundStart = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                p.track(d.tracking.screen.roundStart, {
                  identifier: t,
                }));
            }),
            (this.roundEnd = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                p.track(d.tracking.screen.roundEnd, {
                  identifier: t,
                }));
            }),
            ...
            (this.commercialBreak = function () {
              return new Promise(function (n) {
                ...
                var e = t.gameStarted
                  ? d.ads.position.midroll
                  : d.ads.position.preroll;
                ct.GetIsMinimizeTestCountry()
            ...
            (this.rewardedBreak = function () {
              return new Promise(function (n) {
                (p.track(d.tracking.screen.rewardedBreak),
                  ct.GetIsMinimizeTestCountry()
                    ? t.runPlatformVideo(d.ads.position.rewarded).then(n)
                    : t.SDK.requestAd({
                      ...
                      switch (t.data.type) {
                        case "videoAdResult":
                          (window.removeEventListener("message", i, !1),
                            e(t.data.content && t.data.content.rewardAllowed));
                      }
                  };
            ...
            (this.happyTime = function (n) {
              (void 0 === n && (n = 1),
                ...
                p.track(d.tracking.screen.happyTime, {
                  intensity: n,
                }));
            }),
            ...
            (this.togglePlayerAdvertisingConsent = function (n) {
              (p.track(d.tracking.togglePlayerAdvertisingConsent, {
                ...
                l.sendMessage(d.message.toggleProgrammaticAds, {
