...
var ASM_CONSTS = {
  ...
  8783693: function ($0, $1) {
    alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));
  },
  8785852: function ($0, $1, $2) {
    var w = $0;
    var h = $1;
    var pixels = $2;
...
// STATICTOP = STATIC_BASE + 14835904;
...
for (/**@suppress{duplicate}*/ var i = 0; i < 288; ++i) {
  __miniTempWebGLFloatBuffers[i] = __miniTempWebGLFloatBuffersStorage.subarray(
    0,
    i + 1,
  );
}
...
var _emscripten_GetProcAddress = (Module["_emscripten_GetProcAddress"] =
  createExportWrapper("emscripten_GetProcAddress"));
...
/** @type {function(...*):?} */
var ___set_stack_limit = (Module["___set_stack_limit"] =
  createExportWrapper("__set_stack_limit"));

/** @type {function(...*):?} */
var __growWasmMemory = (Module["__growWasmMemory"] =
  createExportWrapper("__growWasmMemory"));
...
var dynCall_iiiiiidii = (Module["dynCall_iiiiiidii"] =
  createExportWrapper("dynCall_iiiiiidii"));
