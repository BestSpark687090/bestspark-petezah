    ...
    var b = (function () {
      ...
      return (
        ...
        (a.prototype.setItem = function (a, b) {
          ...
          return a.length < 1
            ? void console.error(
                "CordovaStorage: Key cannot be an empty string!",
              )
    ...
    var c = (function () {
      ...
      return (
        ...
        (b.prototype.init = function () {
          var b = this;
          return this.sendMessage({ command: a.StorageCommand.init }).then(
            function () {
              b.enabled = !0;
            },
          );
          ...
          return new Promise(function (f, g) {
            (d.enabled ||
              ...
              (e.port1.onmessage = function (b) {
                ...
                switch (
                  (e.command === a.StorageCommand.init && (c = !0),
              ...
              (d.enabled || b.command === a.StorageCommand.init) &&
                (console.log("Sending message to parent: ", b),
    ...
    var c = (function () {
      ...
      return (
        ...
        (b.prototype._clear = function () {
          for (
            var b = Object.keys(localStorage),
              c = a.StorageUtils.nameSpaceKeyFilter(b, this.namespace),
              d = 0;
            d < c.length;
            d++
          )
...
(!(function (a) {
  var b = (function () {
    function b(c) {
      ...
      a.StorageUtils.isLocalStorageSupport()
  ...
  void 0 !== window.Phaser &&
    Phaser.Utils.mixinPrototype(
      PhaserSuperStorage.StoragePlugin,
      Phaser.Plugin,
    ));
var PhaserSuperStorage;
!(function (a) {
