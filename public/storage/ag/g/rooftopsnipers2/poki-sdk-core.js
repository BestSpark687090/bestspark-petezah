!(function (t) {
      ...
      if (
        (I &&
          ...
          f !== Object.prototype &&
            ...
            (l ||
              o(v) === f ||
              (a ? a(v, f) : "function" != typeof v[g] && d(v, g, h)),
            s(v, E, !0, !0),
            l && (A[E] = h))),
        "values" == m &&
          z &&
  ...
  function (t, n, e) {
        ...
        return (
          ...
          (t.track = function (t, n) {
            if ((void 0 === n && (n = {}), -1 === w.indexOf(t)))
              throw new TypeError(
                "Invalid 'event', must be one of " + w.join(", "),
              );
            if ("object" != typeof n)
          ...
          (t.setupDefaultEvents = function () {
            var n,
              e =
                ...
                (n[A.ads.prebidRequested] =
                  A.tracking.ads.status.prebidRequested),
                ...
                (n[A.tracking.screen.gameplayStart] =
                  A.tracking.screen.gameplayStart),
                (n[A.tracking.screen.gameplayStop] =
                  A.tracking.screen.gameplayStop),
                (n[A.tracking.screen.loadingProgress] =
                  A.tracking.screen.loadingProgress),
                (n[A.tracking.screen.commercialBreak] =
                  A.tracking.screen.commercialBreak),
                (n[A.tracking.screen.rewardedBreak] =
                  A.tracking.screen.rewardedBreak),
    ...
    var G = (function () {
        function t(t, n) {
          (void 0 === n && (n = {}),
            ...
            (this.timing = n.timing || new k(v.adTiming)),
            (this.overwriteAdTagUrls = n.adTagUrl ? b(n.adTagUrl) : []),
            f.addEventListener(
              A.ads.video.error,
              this.moveThroughWaterfall.bind(this),
            ),
            f.addEventListener(
              A.ads.video.loaderError,
              this.moveThroughWaterfall.bind(this),
            ),
            f.addEventListener(
              A.ads.ready,
        ...
        return (
          ...
          (t.prototype.buildAdTagUrls = function (t) {
            ...
            if (this.overwriteAdTagUrls.length > 0 && kt.GetIsPokiPlatform())
          ...
          (t.prototype.requestAd = function () {
            (this.timing.startWaterfallTimer(this.cutOffWaterfall.bind(this)),
              this.retries++,
              kt.GetIsPokiPlatform() ||
                (this.criteria.waterfall = this.retries));
            var t = (this.retries - 1) % this.adTagUrls.length,
              n = this.adTagUrls[t];
            kt.consentString &&
              kt.consentString.length > 0 &&
              (this.criteria.consent_string = kt.consentString);
            var e,
              i,
              r =
                (function (t) {
            ...
            (kt.childDirected && (r += "&tfcd=1"),
              kt.nonPersonalized && (r += "&npa=1"),
              f.setDataAnnotations({
                adTagUrl: r,
      ...
      nt = (function () {
        ...
        return (
          ...
          (t.prototype.resumeAd = function () {
            (f.dispatchEvent(A.ads.video.resumed),
    ...
    var ct = e(67),
      ...
      yt = function (t) {
        googletag.cmd.push(function () {
          ...
          i &&
            i.gptSlot &&
            (y.track(A.tracking.screen.destroyAd, {
              opportunityId: i.opportunityId,
            }),
            googletag.destroySlots([i.gptSlot]),
            null === (n = t.querySelector("div#" + i.id)) ||
              void 0 === n ||
              n.remove(),
        ...
        return (
          ...
          (t.prototype.lazyLoadInit = function () {
            ...
            return (
              ...
              Promise.all([I(), _(), et(""), et(""), et(ct.a), et("")])
                .catch(function () {
                          ...
                          window.googletag
                            ...
                            .addEventListener(
                              ...
                              function (t) {
                                ...
                                e &&
                                  e.gptSlot &&
                                  y.track(A.tracking.ads.display.viewable, {
                                    size: e.size,
                                    opportunityId: e.opportunityId,
                                    adUnitPath: e.adUnitPath,
                                  });
                ...
                if (e.sdkImaError)
                  ...
                  if (null !== m && p(m, A.ads.position))
                    if (e.ima.isAdRunning() || e.waterfall.isRunning())
                      f.dispatchEvent(A.ads.busy);
                    else if (e.adReady) f.dispatchEvent(A.ads.ready);
                    else if (
                      m !== A.ads.position.preroll ||
                      e.adTimings.prerollPossible()
                    )
                      if (
                        m === A.ads.position.rewarded ||
                        e.adTimings.requestPossible()
                      ) {
                        var g = vt(
                          vt(vt({}, e.genericCriteria()), e.criteria),
                          {
                            position: m,
                          },
                        );
          ...
          (t.prototype.enableSettings = function (t) {
            ((this.criteria = vt({}, t.customCriteria)),
              (this.adTimings = new k(t.adTiming)),
    ...
    var xt,
      Tt = Date.now(),
      zt = (xt = new RegExp("poki_erruid" + "=([^;]+)(?:;|$)").exec(
        document.cookie,
      ))
        ? xt[1]
        : "";
    ...
    if ("undefined" != typeof window) {
      ...
      "bd6bdd9e-33a9-11ea-a08a-acde48001122" === bt.gameId &&
        ([
          "EventTarget",
          "Window",
          "Node",
          ...
          ((this.gameStarted = !1),
              ...
              return (
                ...
                new Promise(function (e, i) {
                  (n && n.adTagUrl && window && (window.__InternalSDK = t.SDK),
                    ...
                    g.sendMessage(A.message.sdkDetails, {
                      version: "2.150.0",
                    }));
                })
              );
            ...
            (this.gameLoadingProgress = function (t) {
              ...
              (void 0 !== t.percentageDone &&
                ...
                void 0 !== t.filesLoaded &&
                  (n.filesLoaded = Number(t.filesLoaded)),
                void 0 !== t.filesTotal &&
                  (n.filesTotal = Number(t.filesTotal)),
            ...
            (this.roundStart = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                y.track(A.tracking.screen.roundStart, {
                  identifier: t,
                }));
            }),
            (this.roundEnd = function (t) {
              (void 0 === t && (t = ""),
                (t = String(t)),
                y.track(A.tracking.screen.roundEnd, {
                  identifier: t,
                }));
            }),
            ...
            (this.commercialBreak = function () {
              return new Promise(function (n) {
                var e = t.gameStarted
                  ? A.ads.position.midroll
                  : A.ads.position.preroll;
                (f.clearAnnotations(),
                  f.setDataAnnotations({
                    opportunityId: ft(),
                    position: e,
            ...
            (this.happyTime = function (n) {
              (void 0 === n && (n = 1),
                ...
                y.track(A.tracking.screen.happyTime, {
                  intensity: n,
                }));
            }),
