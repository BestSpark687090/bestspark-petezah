!(function (n) {
  ...
  function (n, e, t) {
                  ...
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (
                        ...
                        (n.prev = 5),
                        (n.next = 8),
                        h("".concat(B, "screenshots/1-small.jpg").concat(I))
                      );
                    case 8:
                      ((e = n.sent), (n.next = 16));
                      break;
                    case 11:
                      return (
                        ...
                        (n.t0 = n.catch(5)),
                        (n.next = 15),
                        h("".concat(B, "screenshots/1.jpg").concat(I))
                      );
                    case 15:
                      e = n.sent;
                    case 16:
    ...
    var m,
      ...
      C = window.location.pathname.substring(
        0,
  ...
  function (n, e, t) {
    ...
    var u = r.a.thumbnail;
    (u.startsWith("https://img.poki.com/") &&
      (u =
        "https://img.poki.com/cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/".concat(
          u.substr(21),
        )),
      (d.src = u));
    ...
    function o(n, e) {
      for (var t = [], i = {}, o = 0; o < n.length; o++) {
        var r = n[o],
          ...
          c = r[2],
          l = r[3],
          d = { css: s, media: c, sourceMap: l };
        i[a] ? i[a].parts.push(d) : t.push((i[a] = { id: a, parts: [d] }));
      }
      return t;
    }
    function r(n, e) {
  ...
  function (n, e, t) {
    ...
    function o() {
      ((d = document.getElementById("game-container")),
        ...
        (h = document.getElementById("progress-container")),
    ...
    function a(n, e) {
      if (n.Module) {
        var t = 100 * e;
        ((f.style.width = "".concat(t, "%")),
          (m.innerHTML = "".concat(t << 0, "%")),
          w.a.fileSize && (m.innerHTML += " of ".concat(w.a.fileSize, "MB")));
        var i = { percentageDone: t };
    ...
    function c() {
      (!(function () {
        ...
        ((n.src = w.a.unityWebglLoaderUrl),
          n.addEventListener("load", function () {
            window.unityGame = window.UnityLoader.instantiate(
              "game",
              w.a.unityWebglBuildUrl,
              { onProgress: a, Module: { onRuntimeInitialized: r } },
            );
          }),
      ...
      return (
        ...
        (h.prototype = {
          ...
          delegateYield: function (n, e, t) {
            return (
              (this.delegate = { iterator: f(n), resultName: e, nextLoc: t }),
