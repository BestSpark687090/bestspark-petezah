...
THREE.Frustum.prototype.contains = function (a) {
  for (
    var b = this.planes,
      c = a.matrixWorld,
      d = c.elements,
      c = -a.geometry.boundingSphere.radius * c.getMaxScaleOnAxis(),
      e = 0;
    e < 6;
    e++
  ) {
...
THREE.Ray = function (a, b) {
  ...
  this.intersectObject = function (a) {
    ...
    if (a instanceof THREE.Particle) {
      ...
      var q = c(this.origin, this.direction, a.matrixWorld.getPosition()),
        r = THREE.Frustum.__v1.set(
          a.matrixWorld.getColumnX().length(),
          a.matrixWorld.getColumnY().length(),
          a.matrixWorld.getColumnZ().length(),
        );
      if (
        q >
        a.geometry.boundingSphere.radius * Math.max(r.x, Math.max(r.y, r.z))
      )
        return n;
      var s,
        i,
...
THREE.Projector = function () {
  ...
  this.projectGraph = function (b, d) {
    ...
    var g = function (b) {
      if (b.visible !== false) {
        if (
          (b instanceof THREE.Mesh || b instanceof THREE.Line) &&
          (b.frustumCulled === false || A.contains(b))
        ) {
        ...
        for (U = ha.length; Y < U; Y++) {
          ...
          if (C instanceof THREE.Face3) {
            ...
            if (F.visible && ea.visible && fa.visible) {
              i =
                (fa.positionScreen.x - F.positionScreen.x) *
                  (ea.positionScreen.y - F.positionScreen.y) -
                  (fa.positionScreen.y - F.positionScreen.y) *
                    (ea.positionScreen.x - F.positionScreen.x) <
                0;
            ...
            if (F.visible && ea.visible && fa.visible && ia.visible) {
              i =
                (ia.positionScreen.x - F.positionScreen.x) *
                  (ea.positionScreen.y - F.positionScreen.y) -
                  (ia.positionScreen.y - F.positionScreen.y) *
                    (ea.positionScreen.x - F.positionScreen.x) <
                  0 ||
                (ea.positionScreen.x - fa.positionScreen.x) *
                  (ia.positionScreen.y - fa.positionScreen.y) -
                  (ea.positionScreen.y - fa.positionScreen.y) *
                    (ia.positionScreen.x - fa.positionScreen.x) <
                  0;
              if (O.doubleSided || i != O.flipSided) {
      ...
      if (O instanceof THREE.Particle) {
        ...
        if (E.z > 0 && E.z < 1) {
          ...
          t.scale.x =
            ...
            Math.abs(
              t.x -
                (E.x + e.projectionMatrix.elements[0]) /
                  (E.w + e.projectionMatrix.elements[12]),
            );
          t.scale.y =
            O.scale.y *
            Math.abs(
              t.y -
                (E.y + e.projectionMatrix.elements[5]) /
                  (E.w + e.projectionMatrix.elements[13]),
            );
...
THREE.Quaternion.prototype = {
  ...
  setFromRotationMatrix: function (a) {
    ...
    this.w =
      Math.sqrt(
        Math.max(0, b + a.elements[0] + a.elements[5] + a.elements[10]),
      ) / 2;
    this.x =
      Math.sqrt(
        Math.max(0, b + a.elements[0] - a.elements[5] - a.elements[10]),
    ...
    this.x =
      a.elements[6] - a.elements[9] < 0 ? -Math.abs(this.x) : Math.abs(this.x);
    this.y =
      a.elements[8] - a.elements[2] < 0 ? -Math.abs(this.y) : Math.abs(this.y);
    this.z =
      a.elements[1] - a.elements[4] < 0 ? -Math.abs(this.z) : Math.abs(this.z);
    this.normalize();
    return this;
  },
  calculateW: function () {
      ...
      for (
        ...
        P.faces.push(
          new THREE.Face3(
            ...
            h,
            [
              new THREE.Vector3(M[j * 3], M[j * 3 + 1], M[j * 3 + 2]),
              new THREE.Vector3(n, o, k),
              new THREE.Vector3(p, q, l),
            ],
            null,
            i,
          ),
      ...
      for (
        ...
        P.faces.push(
          new THREE.Face4(
            ...
            i,
            [
              new THREE.Vector3(M[k * 3], M[k * 3 + 1], M[k * 3 + 2]),
              new THREE.Vector3(p, q, l),
              new THREE.Vector3(r, s, m),
              new THREE.Vector3(t, u, n),
            ],
            null,
            j,
          ),
...
THREE.SceneLoader.prototype.createScene = function (a, b, c) {
  ...
  for (q in D.cameras) {
    v = D.cameras[q];
    v.type == "perspective"
      ? (R = new THREE.PerspectiveCamera(v.fov, v.aspect, v.near, v.far))
      : v.type == "ortho" &&
  ...
  for (n in D.fogs) {
    o = D.fogs[n];
    o.type == "linear"
      ? (P = new THREE.Fog(0, o.near, o.far))
      : o.type == "exp2" && (P = new THREE.FogExp2(0, o.density));
    v = o.color;
  ...
  for (r in D.textures) {
    k = D.textures[r];
    if (k.mapping != void 0 && THREE[k.mapping] != void 0)
  ...
  for (p in D.materials) {
    ...
    for (A in t.parameters)
      if (A == "envMap" || A == "map" || A == "lightMap")
        ...
        t.parameters[A] =
          t.parameters[A] == "flat" ? THREE.FlatShading : THREE.SmoothShading;
      else if (A == "blending")
        t.parameters[A] = THREE[t.parameters[A]]
          ? THREE[t.parameters[A]]
          : THREE.NormalBlending;
      else if (A == "combine")
        t.parameters[A] =
          t.parameters[A] == "MixOperation"
            ? THREE.MixOperation
    ...
    if (t.parameters.opacity !== void 0 && t.parameters.opacity < 1)
...
THREE.MeshBasicMaterial = function (a) {
  ...
  this.vertexColors =
    a.vertexColors !== void 0 ? a.vertexColors : THREE.NoColors;
...
THREE.MeshLambertMaterial = function (a) {
  ...
  this.emissive =
    a.emissive !== void 0 ? new THREE.Color(a.emissive) : new THREE.Color(0);
...
THREE.ParticleBasicMaterial = function (a) {
  ...
  this.sizeAttenuation =
    a.sizeAttenuation !== void 0 ? a.sizeAttenuation : true;
...
THREE.ShaderMaterial = function (a) {
  ...
  a = a || {};
  this.fragmentShader =
    a.fragmentShader !== void 0 ? a.fragmentShader : "void main() {}";
  this.vertexShader =
    a.vertexShader !== void 0 ? a.vertexShader : "void main() {}";
...
THREE.ParticleSystem = function (a, b) {
  ...
  this.material =
    b !== void 0
      ? b
      : new THREE.ParticleBasicMaterial({ color: Math.random() * 16777215 });
...
THREE.SkinnedMesh.prototype.updateMatrixWorld = function (a) {
  ...
  for (
    var b = this.bones.length, c = this.bones, d = this.boneMatrices, a = 0;
    a < b;
    a++
  )
...
THREE.SkinnedMesh.prototype.pose = function () {
  ...
  if (this.geometry.skinVerticesA === void 0) {
    ...
    for (a = 0; a < this.geometry.skinIndices.length; a++) {
      ...
      if (
        this.geometry.skinWeights[a].x + this.geometry.skinWeights[a].y !==
        1
      ) {
        c =
          (1 -
  ...
  this.render = function (c, d) {
    ...
    for (p = b.length; k < p; k++) {
      ...
      if (
        ...
        m.material instanceof THREE.ParticleDOMMaterial
      ) {
        ...
        g &&
          (o.style[g] = "scale(" + m.scale.x * e + "," + m.scale.y * f + ")");
      }
    }
  };
};
    ...
    if (!Ba.isEmpty()) {
      ...
      u < 1 &&
        n.clearRect(
          Math.floor(Ba.getX()),
          Math.floor(Ba.getY()),
          Math.floor(Ba.getWidth()),
          Math.floor(Ba.getHeight()),
        );
      if (u > 0) {
  ...
  this.render = function (a, k) {
        ...
        if (g instanceof THREE.DirectionalLight) {
          ...
          if (!(j <= 0)) {
            j =
              ...
              (g.distance == 0
                ? 1
                : 1 - Math.min(b.distanceTo(h) / g.distance, 1));
            if (j != 0) {
              j = j * g.intensity;
              d.r = d.r + i.r * j;
              d.g = d.g + i.g * j;
    ...
    function t(a, d, e, g, h, l, m, n) {
      ...
      if (n instanceof THREE.MeshBasicMaterial)
        ...
        n.wireframe
          ? Mb(O, n.wireframeLinewidth, n.wireframeLinecap, n.wireframeLinejoin)
          : Eb(O);
      }
    }
      ...
      if (g instanceof THREE.DirectionalLight) {
        ...
        if (!(k <= 0)) {
          k =
            ...
            (g.distance == 0
              ? 1
              : 1 - Math.min(b.distanceTo(j) / g.distance, 1));
          if (k != 0) {
            k = k * g.intensity;
            d.r = d.r + h.r * k;
            d.g = d.g + h.g * k;
...
THREE.WebGLRenderer = function (a) {
  ...
  function e(a) {
    return a.map || a.lightMap || a instanceof THREE.ShaderMaterial
      ? true
      : false;
  }
  function f(a, b, c) {
    ...
    for (var m = j; m !== b; m = m + l) {
      ...
      if (i.render) {
        ...
        if (h) i = h;
          ...
          if (!i) continue;
          g &&
            G.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
        ...
        k instanceof THREE.BufferGeometry
          ? G.renderBufferDirect(d, e, f, i, k, j)
          : G.renderBuffer(d, e, f, i, k, j);
      }
    }
  }
    ...
    for (var h, i, j = 0, k = a.length; j < k; j++) {
      ...
      if (i.visible) {
        if (g) h = g;
          ...
          if (!h) continue;
          f &&
            G.setBlending(h.blending, h.blendEquation, h.blendSrc, h.blendDst);
  ...
  function n(a, b, c, d, e) {
    ...
    if (h) {
      ...
      if (
        ...
        G.gammaInput
          ? j.diffuse.value.copyGammaToLinear(d.color)
          : (j.diffuse.value = d.color);
        (j.map.texture = d.map) &&
          j.offsetRepeat.value.set(
            d.map.offset.x,
            d.map.offset.y,
            d.map.repeat.x,
            d.map.repeat.y,
      ...
      (d instanceof THREE.MeshPhongMaterial ||
        ...
        d.skinning) &&
        g.viewMatrix !== null &&
        i.uniformMatrix4fv(g.viewMatrix, false, a._viewMatrixArray);
      d.skinning &&
        i.uniformMatrix4fv(g.boneGlobalMatrices, false, e.boneMatrices);
    }
    i.uniformMatrix4fv(g.modelViewMatrix, false, e._modelViewMatrix.elements);
    g.normalMatrix &&
      i.uniformMatrix3fv(g.normalMatrix, false, e._normalMatrix.elements);
    g.objectMatrix !== null &&
      i.uniformMatrix4fv(g.objectMatrix, false, e.matrixWorld.elements);
    return f;
  }
  function r(a, b) {
  ...
  function t(a, b) {
    ...
    a === "fragment"
      ...
      : a === "vertex" && (c = i.createShader(i.VERTEX_SHADER));
    i.shaderSource(c, b);
    i.compileShader(c);
        ...
        for (c = f.length; d < c; ++d) {
          if (b) {
            ...
            i.vertexAttribPointer(
              a.position,
              e.vertexPositionBuffer.itemSize,
              i.FLOAT,
              false,
              0,
              f[d].index * 12,
      ...
      if (!d.morphTargets && b.position >= 0) {
        ...
        if (f.morphTargetForcedOrder.length) {
          ...
          for (
            ...
            g < d.numSupportedMorphTargets && g < j.length;
          ...
          g = 0;
          for (
            f.morphTargetBase !== -1 && (j[f.morphTargetBase] = true);
            g < d.numSupportedMorphTargets;
  ...
  this.render = function (a, b, c, d) {
    ...
    for (e = m.length; d < e; d++) {
      ...
      if (
        k.visible &&
        (!(k instanceof THREE.Mesh || k instanceof THREE.ParticleSystem) ||
          !k.frustumCulled ||
          Wa.contains(k))
      ) {
        r(k, b);
  ...
  this.renderImmediateObject = function (a, b, c, d, e) {
    ...
    e.immediateRenderCallback
      ? e.immediateRenderCallback(f, i, Wa)
      : e.render(function (a) {
  ...
  this.initWebGLObjects = function (a) {
    ...
    for (; a.__objectsAdded.length; ) {
          ...
          if (l instanceof THREE.Geometry) {
            if (l.geometryGroups === void 0) {
              ...
              for (t = r.faces.length; s < t; s++) {
                ...
                u instanceof THREE.Face3
                  ? r.geometryGroups[y].faces3.push(s)
                  : r.geometryGroups[y].faces4.push(s);
            ...
            for (j in l.geometryGroups) {
              ...
              if (!n.__webglVertexBuffer) {
                ...
                if (
                  J.geometry.skinWeights.length &&
                  J.geometry.skinIndices.length
                ) {
                ...
                if (R.attributes) {
                  if (Q.__webglCustomAttributesList === void 0)
      ...
      if (!g.__webglActive) {
        if (g instanceof THREE.Mesh) {
          ...
          g instanceof THREE.Ribbon ||
          g instanceof THREE.Line ||
          g instanceof THREE.ParticleSystem
        ) {
          l = g.geometry;
          k(h.__webglObjects, l, g);
        } else
          g instanceof THREE.ImmediateRenderObject || g.immediateRenderCallback
            ? h.__webglObjectsImmediate.push({
                object: g,
                opaque: null,
                transparent: null,
              })
            : g instanceof THREE.Sprite
              ? h.__webglSprites.push(g)
              : g instanceof THREE.LensFlare && h.__webglFlares.push(g);
    ...
    for (; a.__objectsRemoved.length; ) {
      var bb = a.__objectsRemoved[0],
        gb = a;
      bb instanceof THREE.Mesh ||
      bb instanceof THREE.ParticleSystem ||
      bb instanceof THREE.Ribbon ||
      bb instanceof THREE.Line
        ? o(gb.__webglObjects, bb)
        : bb instanceof THREE.Sprite
          ? q(gb.__webglSprites, bb)
          : bb instanceof THREE.LensFlare
            ? q(gb.__webglFlares, bb)
            : (bb instanceof THREE.ImmediateRenderObject ||
                bb.immediateRenderCallback) &&
              o(gb.__webglObjectsImmediate, bb);
        ...
        if (ga instanceof THREE.BufferGeometry) {
          ...
          for (var Cb = 0, nd = ga.geometryGroupsList.length; Cb < nd; Cb++) {
            ...
            if (
              ...
              ga.morphTargetsNeedUpdate ||
              ga.elementsNeedUpdate ||
              ga.uvsNeedUpdate ||
              ga.normalsNeedUpdate ||
              ga.colorsNeedUpdate ||
              ga.tangetsNeedUpdate ||
              ic
            ) {
              var ca = hb,
                od = jb,
                ...
                if (ud) {
                  ...
                  for (fd = Yb.length; Ea < fd; Ea++) {
                    ...
                    if (bc.morphNormals) {
                      i.bindBuffer(
                        i.ARRAY_BUFFER,
                        ca.__webglMorphNormalsBuffers[Ea],
                      );
        ...
        if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || ic) {
          ...
          if ($c) {
            ...
            for (md = $c.length; Rc < md; Rc++) {
              ...
              if (
                pa.needsUpdate &&
                (pa.boundTo === void 0 || pa.boundTo === "vertices")
              ) {
                va = 0;
                oc = pa.value.length;
                if (pa.size === 1)
  ...
  this.initMaterial = function (a, b, c, d) {
    ...
    a: {
      ...
      d = [
        "precision " + z + " float;",
        oa > 0 ? "#define VERTEX_TEXTURES" : "",
        G.gammaInput ? "#define GAMMA_INPUT" : "",
        G.gammaOutput ? "#define GAMMA_OUTPUT" : "",
        G.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "",
      ...
      k = [
        ...
        c.useFog && c.fog instanceof THREE.FogExp2 ? "#define FOG_EXP2" : "",
        c.map ? "#define USE_MAP" : "",
        c.envMap ? "#define USE_ENVMAP" : "",
        c.lightMap ? "#define USE_LIGHTMAP" : "",
        c.vertexColors ? "#define USE_COLOR" : "",
      ...
      i.getProgramParameter(r, i.LINK_STATUS) ||
        console.error(
          "Could not initialise shader\nVALIDATE_STATUS: " +
            i.getProgramParameter(r, i.VALIDATE_STATUS) +
            ", gl error [" +
            i.getError() +
            "]",
        );
    ...
    if (a.attributes)
      for (f in a.attributes)
        q[f] !== void 0 && q[f] >= 0 && i.enableVertexAttribArray(q[f]);
    if (a.morphTargets) {
  ...
  this.setTexture = function (a, b) {
    if (a.needsUpdate) {
      ...
      var c = a.image,
        d =
          (c.width & (c.width - 1)) === 0 && (c.height & (c.height - 1)) === 0,
        e = H(a.format),
        f = H(a.type);
      y(i.TEXTURE_2D, a, d);
      a instanceof THREE.DataTexture
        ? i.texImage2D(i.TEXTURE_2D, 0, e, c.width, c.height, 0, e, f, c.data)
        : i.texImage2D(i.TEXTURE_2D, 0, e, e, f, a.image);
    ...
    if (a && !a.__webglFramebuffer) {
      ...
      if (b) {
        ...
        for (var f = 0; f < 6; f++) {
          ...
          i.texImage2D(
            i.TEXTURE_CUBE_MAP_POSITIVE_X + f,
            0,
            d,
            a.width,
            a.height,
    ...
    for (q = l.length; o < q; o++) {
      ...
      g instanceof THREE.Face3
        ...
        : g instanceof THREE.Face4 &&
          (r = new THREE.Face4(g.a + e, g.b + e, g.c + e, g.d + e));
...
THREE.CurvePath.prototype.getBoundingBox = function () {
  ...
  return { minX: d, minY: e, maxX: b, maxY: c, centroid: j.divideScalar(h) };
};
...
THREE.Path.prototype.getPoints = function (a, b) {
  ...
  d = c[c.length - 1];
  Math.abs(d.x - c[0].x) < 1.0e-10 &&
    Math.abs(d.y - c[0].y) < 1.0e-10 &&
...
THREE.Shape.Utils = {
  removeHoles: function (a, b) {
    ...
    return { shape: c, isolatedPts: q, allpoints: d };
  },
...
THREE.TextPath.prototype.toShapes = function () {
  for (
    var a = THREE.FontUtils.drawText(this.text).paths,
      b = [],
      c = 0,
      d = a.length;
    c < d;
          ...
          for (var c = 0; c < a.hierarchy.length; c++) {
            ...
            if (
              ...
              for (d = 0; d < a.hierarchy[c].keys.length; d++)
                for (
                  var j = 0;
                  j < a.hierarchy[c].keys[d].morphTargets.length;
                  j++
                ) {
  ...
  for (var a = 0; a < this.hierarchy.length; a++)
    if (this.hierarchy[a].animationCache !== void 0) {
      this.hierarchy[a] instanceof THREE.Bone
        ? (this.hierarchy[a].skinMatrix =
            this.hierarchy[a].animationCache.originalMatrix)
        : (this.hierarchy[a].matrix =
            this.hierarchy[a].animationCache.originalMatrix);
...
THREE.Animation.prototype.update = function (a) {
  if (this.isPlaying) {
    ...
    l = parseInt(
      Math.min(p * this.data.fps, this.data.length * this.data.fps),
      10,
    );
    ...
    if (this.JITCompile && k[0][l] === void 0) {
      ...
      for (o = 0; o < this.hierarchy.length; o++)
        k[o][l] =
          this.hierarchy[o] instanceof THREE.Bone
            ? this.hierarchy[o].skinMatrix.clone()
            : this.hierarchy[o].matrix.clone();
    }
  }
};
...
THREE.RollControls = function (a, b) {
  ...
  this.update = function (a) {
    ...
    this.object.translateZ(
      -b * (j > 0 || (this.autoForward && !(j < 0)) ? 1 : j),
    );
...
THREE.TrackballControls = function (a, b) {
  ...
  this.getMouseOnScreen = function (a, b) {
    return new THREE.Vector2(
      ((a - c.screen.offsetLeft) / c.radius) * 0.5,
      ((b - c.screen.offsetTop) / c.radius) * 0.5,
    );
  };
  this.getMouseProjectionOnBall = function (a, b) {
    var d = new THREE.Vector3(
        (a - c.screen.width * 0.5 - c.screen.offsetLeft) / c.radius,
  ...
  this.zoomCamera = function () {
    ...
    if (a !== 1 && a > 0) {
      ...
      c.staticMoving
        ? (l = k)
        : (l.y = l.y + (k.y - l.y) * this.dynamicDampingFactor);
    }
  };
  this.panCamera = function () {
    ...
    if (a.lengthSq()) {
      ...
      c.staticMoving
        ? (p = m)
        : p.addSelf(a.sub(m, p).multiplyScalar(c.dynamicDampingFactor));
    }
  };
  this.checkDistances = function () {
    if (!c.noZoom || !c.noPan) {
      c.object.position.lengthSq() > c.maxDistance * c.maxDistance &&
        c.object.position.setLength(c.maxDistance);
      g.lengthSq() < c.minDistance * c.minDistance &&
        c.object.position.add(c.target, g.setLength(c.minDistance));
    }
  };
  ...
  this.domElement.addEventListener(
    ...
    function (a) {
      if (c.enabled) {
        ...
        f !== -1 &&
          (f === 0 && !c.noRotate
            ? (j = c.getMouseProjectionOnBall(a.clientX, a.clientY))
            : f === 1 && !c.noZoom
              ? (k = c.getMouseOnScreen(a.clientX, a.clientY))
              : f === 2 &&
                !c.noPan &&
  ...
  window.addEventListener(
    ...
    function (a) {
      if (c.enabled && f === -1) {
        a.keyCode === c.keys[0] && !c.noRotate
          ? (f = 0)
          : a.keyCode === c.keys[1] && !c.noZoom
            ? (f = 1)
            : a.keyCode === c.keys[2] && !c.noPan && (f = 2);
        f !== -1 && (e = true);
      }
    },
    false,
    ...
    for (h = 0; h < o; h++)
      for (j = 0; j < p; j++) {
        ...
        l.faceVertexUvs[0].push([
          new THREE.UV(j / p, h / o),
          new THREE.UV(j / p, (h + 1) / o),
          new THREE.UV((j + 1) / p, (h + 1) / o),
          new THREE.UV((j + 1) / p, h / o),
        ]);
      }
  }
  THREE.Geometry.call(this);
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
  ...
  function g(c, d, e, f) {
    ...
    c = f
      ? O.generateBottomUV(A, a, b, c, d, e)
      : O.generateTopUV(A, a, b, c, d, e);
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
  generateTopUV: function (a, b, c, d, e, f) {
    ...
    f = a.vertices[f].y;
    return [
      new THREE.UV(a.vertices[d].x, 1 - a.vertices[d].y),
      new THREE.UV(b, 1 - e),
      new THREE.UV(c, 1 - f),
    ];
  },
...
THREE.PlaneGeometry = function (a, b, c, d) {
  ...
  for (a = 0; a < d; a++)
    for (b = 0; b < c; b++) {
      ...
      this.faces.push(e);
      this.faceVertexUvs[0].push([
        new THREE.UV(b / c, a / d),
        new THREE.UV(b / c, (a + 1) / d),
        new THREE.UV((b + 1) / c, (a + 1) / d),
        new THREE.UV((b + 1) / c, a / d),
      ]);
    }
  this.computeCentroids();
};
...
THREE.TextGeometry = function (a, b) {
  ...
  if (b.bend) {
    ...
    b.bendPath = new THREE.QuadraticBezierCurve(
      new THREE.Vector2(0, 0),
      new THREE.Vector2(d / 2, 120),
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
  ...
  for (b = 0; b < f; b++) {
    ...
    for (d = 0; d < this.segmentsRadius; d++) {
      ...
      p.z = p.z + (l * g.z + j * h.z);
      this.grid[b][d] =
        this.vertices.push(new THREE.Vector3(p.x, p.y, p.z)) - 1;
    }
  }
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
  ...
  function g(a, b, d) {
    var e = a + ":" + b;
    e in t
      ? c("dup vertexNo", a, "oldFaceNo", b, "value", d, "key", e, t[e])
      : (t[e] = d);
  }
  function h(a, b) {
    R[a] === void 0 && (R[a] = []);
    ...
    for (p = y.length; k < p; k++) {
      ...
      for (o = t.length; m < o; m++) {
        ...
        if (
          n.visible &&
          n.castShadow &&
          (!(n instanceof THREE.Mesh) || !n.frustumCulled || e.contains(n))
        ) {
      ...
      for (o = t.length; m < o; m++) {
        ...
        if (r.render) {
          n = r.object;
          r = r.buffer;
          u = n.customDepthMaterial
            ? n.customDepthMaterial
            : n.geometry.morphTargets.length
              ? d
              : c;
          r instanceof THREE.BufferGeometry
            ? b.renderBufferDirect(q, j.__lights, null, u, r, n)
            : b.renderBuffer(q, j.__lights, null, u, r, n);
        }
      }
        ...
        if (
          ...
          if (w.useScreenCoordinates) {
            ...
            b.uniform3f(
              ...
              (w.position.x - o) / o,
              (y - w.position.y) / y,
              Math.max(0, Math.min(1, w.position.z)),
            );
          } else {
...
THREE.DepthPassPlugin = function () {
  ...
  this.update = function (g, h) {
    ...
    for (l = o.length; j < l; j++) {
      ...
      if (
        m.visible &&
        (!(m instanceof THREE.Mesh) || !m.frustumCulled || e.contains(m))
      ) {
    ...
    for (l = o.length; j < l; j++) {
      ...
      if (k.render) {
        ...
        k = k.buffer;
        b.setObjectFaces(m);
        p = m.customDepthMaterial
          ? m.customDepthMaterial
          : m.geometry.morphTargets.length
            ? d
            : c;
        k instanceof THREE.BufferGeometry
          ? b.renderBufferDirect(h, g.__lights, null, p, k, m)
          : b.renderBuffer(h, g.__lights, null, p, k, m);
      }
    }
