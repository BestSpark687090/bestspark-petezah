    ...
    (function () {
      ...
      function y(t, e) {
        ...
        return (
          ...
          Error.captureStackTrace &&
            Error.captureStackTrace(n, g.prototype.create),
          n
        );
      }
      var g =
      ...
      var U = Array.prototype.indexOf
        ...
        Q = Array.prototype.forEach
          ...
          : function (t, e, n) {
              for (
                var r = t.length, i = I(t) ? t.split("") : t, o = 0;
                o < r;
                o++
              )
      ...
      var rt,
        ...
        ct =
          H(G, "Gecko") &&
          !(H(G.toLowerCase(), "webkit") && !H(G, "Edge")) &&
          !(H(G, "Trident") || H(G, "MSIE")) &&
          !H(G, "Edge"),
      ...
      var bt = !at || 9 <= Number(mt),
        ...
        St = (function () {
          ...
          try {
            (E.addEventListener("test", N, e),
              E.removeEventListener("test", N, e));
          } catch (t) {}
          return t;
        })();
      function Tt(t, e) {
      ...
      function Rt(t, e) {
        ...
        if (n in t.a) {
          ...
          ((r = 0 <= o) && Array.prototype.splice.call(i, o, 1),
            r && (At(e), 0 == t.a[n].length && (delete t.a[n], t.b--)));
        }
      }
      function Mt(t, e, n, r) {
      ...
      kt.prototype.add = function (t, e, n, r, i) {
        ...
        return (
          -1 < a
            ? ((e = t[a]), n || (e.Z = !1))
            : (((e = new Nt(e, this.src, o, !!r, i)).Z = n), t.push(e)),
          e
        );
      };
      ...
      function Pt(t, e, n, r, i, o) {
        ...
        if (a && !bt) return null;
        var s = Bt(t);
        if ((s || (t[Ot] = s = new kt(t)), (n = s.add(e, n, r, a, o)).proxy))
          return n;
        if (
          ((r = (function () {
            var e = Vt,
        ...
        if (!C(t) && t && !t.X) {
          ...
          if (e && e[Ct]) Rt(e.c, t);
            ...
            (e.removeEventListener
              ...
              : e.detachEvent
                ? e.detachEvent(qt(n), r)
                : e.addListener && e.removeListener && e.removeListener(r),
              (n = Bt(e))
                ? (Rt(n, t), 0 == n.b && ((n.src = null), (e[Ot] = null)))
                : At(t));
          }
        }
      }
      ...
      function Vt(t, e) {
        return (
          ...
          (bt
            ? Ft(t, new Et(e, this))
            : Ft(t, (e = new Et(e || D("window.event"), this))))
        );
      }
      function Bt(t) {
      ...
      (V(Kt, B),
        (Kt.prototype[Ct] = !0),
        ((b = Kt.prototype).addEventListener = function (t, e, n, r) {
          Lt(this, t, e, n, r);
        }),
        (b.removeEventListener = function (t, e, n, r) {
          !(function t(e, n, r, i, o) {
            if (k(n)) for (var a = 0; a < n.length; a++) t(e, n[a], r, i, o);
            else
              ((i = M(i) ? !!i.capture : !!i),
                (r = Qt(r)),
                e && e[Ct]
                  ? ((e = e.c),
                    (n = String(n).toString()) in e.a &&
                      -1 < (r = Mt((a = e.a[n]), r, i, o)) &&
                      (At(a[r]),
                      Array.prototype.splice.call(a, r, 1),
                      0 == a.length && (delete e.a[n], e.b--)))
                  : (e = e && Bt(e)) &&
                    ((n = e.a[n.toString()]),
                    (e = -1),
                    n && (e = Mt(n, r, i, o)),
        ...
        (b.dispatchEvent = function (t) {
          ...
          if (
            ((i = jt((a = t.a = n), r, !0, t) && i),
            (i = jt(a, r, !1, t) && i),
            e)
          )
            for (o = 0; o < e.length; o++)
              i = jt((a = t.a = e[o]), r, !1, t) && i;
          return i;
        }),
        (b.G = function () {
          ...
          if (this.ba) {
            ...
            0 < t && t < 0.8 * this.b
              ...
              : (this.L && (this.a.clearTimeout(this.L), (this.L = null)),
                ...
                this.ba && (re(this), this.start()));
          }
        }),
        (b.start = function () {
          ((this.ba = !0),
            this.L ||
              ((this.L = this.a.setTimeout(this.f, this.b)), (this.g = F())));
        }),
        (b.G = function () {
      ...
      function Pe(t, e) {
        ((t.v = F()),
          ...
          0 < t.J && (t.B = new oe(x(t.Ka, t, t.a), t.J)),
          ce(t.I, t.a, "readystatechange", t.eb),
          (e = t.h ? $(t.h) : {}),
          t.l
            ? (t.w || (t.w = "POST"),
      ...
      function xe(t, e, n) {
        ...
        (4 == e && 0 == n.length && ((t.c = 1), ye(16), (r = !1)),
          (t.b = t.b && r),
          r || (Qe(t), Ue(t)));
      }
      function qe(t, e) {
      ...
      (((b = ke.prototype).setTimeout = function (t) {
                    ...
                    (this.H
                      ? (xe(this, e, o),
                        ut &&
                          this.b &&
                          3 == e &&
                          (ce(this.I, this.P, "tick", this.cb), this.P.start()))
                      : Ke(this, o),
                      4 == e && Qe(this),
                      this.b &&
                        !this.m &&
                        (4 == e ? this.g.na(this) : ((this.b = !1), Fe(this))));
                  } else
        ...
        (b.cb = function () {
          if (this.a) {
            var t = Jn(this.a),
              e = this.a.aa();
            this.A < e.length &&
              (Be(this), xe(this, t, e), this.b && 4 != t && Fe(this));
          }
        }),
        (b.cancel = function () {
          ((this.m = !0), Qe(this));
        ...
        (b.bb = function () {
          ...
          var t = F();
          0 <= t - this.R
            ? (2 != this.F && (pe(3), ye(17)), Qe(this), (this.c = 2), Ue(this))
            : Ve(this, this.R - t);
        }),
          ...
          t instanceof Xe
            ...
            : t && (n = String(t).match(Ye))
              ? ((this.h = !!e),
                ...
                en(this, n[6] || "", !0),
                (this.g = an(n[7] || "")))
              : ((this.h = !!e), (this.c = new pn(null, this.h))));
      }
      function Je(t) {
        return new Xe(t);
      }
        ...
        return (
          nn(
            ...
            Math.floor(2147483648 * Math.random()).toString(36) +
              Math.abs(Math.floor(2147483648 * Math.random()) ^ F()).toString(
                36,
              ),
          ),
          t
      ...
      ((Xe.prototype.toString = function () {
        ...
        return (
          ...
          (n = this.a) &&
            ...
            t.push(sn(n, "/" == n.charAt(0) ? ln : hn, !0))),
          (n = this.c.toString()) && t.push("?", n),
          (n = this.g) && t.push("#", sn(n, dn)),
          t.join("")
        );
      }),
      ...
      function yn(t, e) {
        (mn(t),
          (e = wn(t, e)),
          He(t.a.b, e) &&
            ((t.c = null), (t.b -= t.a.get(e).length), Ge(t.a, e)));
      }
      function gn(t, e) {
      ...
      function vn(t, e, n) {
        (yn(t, e),
          0 < n.length &&
            ((t.c = null), t.a.set(wn(t, e), j(n)), (t.b += n.length)));
      }
      function bn(t) {
        var e = new pn();
      ...
      function Tn(t) {
        var e = t.a.F.a;
        if (null != e)
          (ye(4), e ? (ye(10), hr(t.a, t, !1)) : (ye(11), hr(t.a, t, !0)));
        else {
          ((t.b = new ke(t, void 0, void 0)),
            (t.b.h = t.h),
            (e = mr((e = t.a), e.Y() ? t.f : null, t.i)),
            ye(4),
            rn(e, "TYPE", "xmlhttp"));
          var n = t.a.j,
            r = t.a.I;
      ...
      function Nn(t) {
        ((this.g = t || An),
          (t = E.PerformanceNavigationTiming
            ? 0 < (t = E.performance.getEntriesByType("navigation")).length &&
              ("hq" == t[0].nextHopProtocol || "h2" == t[0].nextHopProtocol)
            : !!(E.ka && E.ka.Ea && E.ka.Ea() && E.ka.Ea().zb)),
          (this.f = t ? this.g : 1),
          (this.a = null),
          1 < this.f && (this.a = new In()),
          (this.b = null),
          (this.c = []));
      }
      (((b = pn.prototype).add = function (t, e) {
        ...
        (b.set = function (t, e) {
          return (
            mn(this),
            (this.c = null),
            gn(this, (t = wn(this, t))) && (this.b -= this.a.get(t).length),
            this.a.set(t, [e]),
            (this.b += 1),
            this
          );
        ...
        (b.Ga = function (t, e) {
          if (((this.c = t.o), 0 == this.M)) {
            if (!this.a.o && (t = t.a)) {
              ...
              ((this.l = n || null),
                this.a.j && (t = Zn(t, "X-HTTP-Session-Id")) && (this.a.I = t));
            }
            if (e) {
              try {
        ...
        (b.na = function () {
          if (((this.c = this.b.o), this.b.b))
            0 == this.M
              ...
              : 1 == this.M &&
                (this.g
                  ? (ye(11), hr(this.a, this, !0))
                  : (ye(10), hr(this.a, this, !1)));
          else {
      ...
      function kn(t, e) {
        !t.a &&
          (H(e, "spdy") || H(e, "quic") || H(e, "h2")) &&
          ((t.f = t.g), (t.a = new In()), t.b && (_n(t, t.b), (t.b = null)));
      }
      function Rn(t) {
      ...
      function Xn(t) {
        (t.a && t.D && (t.a.ontimeout = null),
          t.m && (E.clearTimeout(t.m), (t.m = null)));
      }
      function Jn(t) {
        ...
        ((this.f = []),
          ...
          (this.ga =
            ...
            this.i =
              null),
          (this.Ra = this.P = 0),
          (this.Pa = !!D("internalChannelParams.failFast", t)),
          (this.ia = this.w = this.s = this.l = this.h = this.c = null),
          (this.oa = !0),
          (this.m = this.ra = this.O = -1),
          (this.S = this.v = this.A = 0),
          (this.Oa = D("internalChannelParams.baseRetryDelayMs", t) || 5e3),
          (this.Sa = D("internalChannelParams.retryDelaySeedMs", t) || 1e4),
          (this.Qa =
            D("internalChannelParams.forwardChannelMaxRetries", t) || 2),
          (this.qa =
            D("internalChannelParams.forwardChannelRequestTimeoutMs", t) ||
            2e4),
          (this.La = (t && t.Ab) || void 0),
          (this.D = void 0),
      ...
      function er(t) {
        if ((nr(t), 3 == t.u)) {
          ...
          (nn(n, "SID", t.H),
            ...
            nn(n, "TYPE", "terminate"),
            ar(t, n),
            ((e = new ke(t, e, void 0)).F = 2),
            (e.f = on(Je(n))),
            (n = !1),
            E.navigator &&
              E.navigator.sendBeacon &&
              (n = E.navigator.sendBeacon(e.f.toString(), "")),
            !n && E.Image && ((new Image().src = e.f), (n = !0)),
      ...
      function nr(t) {
        (t.w && (t.w.abort(), (t.w = null)),
          ...
          t.l && (E.clearTimeout(t.l), (t.l = null)),
          lr(t),
          t.b.cancel(),
          t.h && (C(t.h) && E.clearTimeout(t.h), (t.h = null)));
      }
      function rr(t, e) {
      ...
      function cr(t) {
        return (
          !(t.a || t.l || 3 <= t.v) &&
          (t.S++, (t.l = ve(x(t.Ha, t), fr(t, t.v))), t.v++, !0)
        );
      }
      function hr(t, e, n) {
        var r = e.l;
      ...
      function dr(t, e) {
        if (2 == e) {
          ...
          (n ||
            ...
            (E.location && "http" == E.location.protocol) || Ze(n, "https"),
            on(n)),
            (function (t, e) {
              var n = new le();
              if (E.Image) {
                var r = new Image();
                ((r.onload = q(Vn, n, r, "TestLoadImage: loaded", !0, e)),
                  (r.onerror = q(Vn, n, r, "TestLoadImage: error", !1, e)),
                  (r.onabort = q(Vn, n, r, "TestLoadImage: abort", !1, e)),
                  (r.ontimeout = q(Vn, n, r, "TestLoadImage: timeout", !1, e)),
                  E.setTimeout(function () {
      ...
      function pr(t) {
        ((t.u = 0),
          (t.m = -1),
          t.c &&
            ((0 == Pn(t.b).length && 0 == t.f.length) ||
              ((t.b.c.length = 0), j(t.f), (t.f.length = 0)),
            t.c.sa()));
      }
      function mr(t, e, n) {
        var r = (function (t) {
        ...
        (Kt.call(this),
          ...
          e &&
            ...
            (t
              ...
              : (t = { "X-WebChannel-Client-Profile": e.xa })),
          (this.a.J = t),
          (t = e && e.httpHeadersOverwriteParam) && !W(t) && (this.a.g = t),
      ...
      (((b = Un.prototype).ca = function (t, e, n, r) {
        ...
        ((e = e ? e.toUpperCase() : "GET"),
          ...
          (this.s = this.H ? Te(this.H) : Te(Ie)),
          (this.a.onreadystatechange = x(this.Fa, this)));
        try {
        ...
        (r &&
          ...
          (r = (function (t) {
            t: {
              for (
                var e = Wn, n = t.length, r = I(t) ? t.split("") : t, i = 0;
                i < n;
                i++
              )
          ...
          (n = E.FormData && t instanceof E.FormData),
          0 <= U(jn, e) &&
            !r &&
            !n &&
            i.set(
            ...
            0 < this.o &&
              ((this.D = (function (t) {
                ...
                ? ((this.a.timeout = this.o),
                  (this.a.ontimeout = x(this.Ca, this)))
                : (this.m = ie(this.Ca, this.o, this))),
            (this.l = !0),
            this.a.send(t),
            (this.l = !1));
        } catch (t) {
          ...
          if (this.h)
            if (((this.h = null), 1 == this.u)) {
              if (!t) {
                ...
                var e,
                  n = new ke(this, t, void 0),
                  r = this.i;
                if (
                  (this.J && (r ? et((r = $(r)), this.J) : (r = this.J)),
                  null === this.g && (n.h = r),
                  this.W)
                )
                  t: {
                    for (var i = (e = 0); i < this.f.length; i++) {
                      ...
                      if (
                        void 0 ===
                        (o =
                          "__data__" in o.a && I((o = o.a.__data__))
                            ? o.length
                            : void 0)
                      )
                        break;
                ...
                ((e = sr(this, n, e)),
                  nn((i = Je(this.B)), "RID", t),
                  nn(i, "CVER", 22),
                  this.o && this.j && nn(i, "X-HTTP-Session-Id", this.j),
                  ar(this, i),
                  this.g && r && $n(i, this.g, r),
                  _n(this.b, n),
                  this.W
                    ? (nn(i, "$req", e),
                      nn(i, "SID", "null"),
              ...
              3 == this.u &&
                (t
                  ? or(this, t)
                  : 0 == this.f.length || Rn(this.b) || or(this));
        }),
        (b.Ha = function () {
          ((this.l = null),
            (this.a = new ke(this, "rpc", this.S)),
          ...
          (nn(t, "RID", "rpc"),
            ...
            ar(this, t),
            nn(t, "TYPE", "xmlhttp"),
            this.g && this.i && $n(t, this.g, this.i),
            this.D && this.a.setTimeout(this.D),
            Le(this.a, t, !0, this.ga));
        }),
        (b.Ga = function (t, e) {
              ...
              for (e = n = this.ja.a.parse(e), n = 0; n < e.length; n++) {
                ...
                if (((this.O = r[0]), (r = r[1]), 2 == this.u))
                  if ("c" == r[0]) {
                    ...
                    var i = r[3];
                    (null != i && (this.wa = i),
                      null != (r = r[5]) && C(r) && 0 < r && (this.D = 1.5 * r),
                      this.o &&
                        (r = t.a) &&
                        ((i = Zn(r, "X-Client-Wire-Protocol")) && kn(this.b, i),
                        this.j && (r = Zn(r, "X-HTTP-Session-Id"))) &&
                        ((this.I = r), nn(this.B, this.j, r)),
                      (this.u = 3),
                      this.c && this.c.va(),
                      (r = t),
                      (this.pa = mr(this, this.Y() ? this.ga : null, this.ha)),
                      r.s
                        ? (Ln(this.b, r),
        ...
        (b.na = function (t) {
          ...
          if (((this.m = t.o), 0 != this.u))
            if (t.b)
              1 == n
                ? ((e = F() - t.v),
                  fe.dispatchEvent(new ge(fe, t.l ? t.l.length : 0, e, this.A)),
                  ir(this))
                : ur(this);
            else {
              var r = t.c;
                      ...
                      return (
                        ...
                        (t.h
                          ...
                          : !(
                            ...
                            ((t.h = ve(x(t.Ia, t, e), fr(t, t.A))), t.A++, !0))
                      );
                    })(this, t)) ||
                  (2 == n && cr(this))
                )
        ...
        V(vr, Kt),
        ((b = vr.prototype).addEventListener = function (t, e, n, r) {
        ...
        (b.Wa = function () {
          ...
          (ye(0),
            ...
            null != (n = t.a.F.b)
              ? ((t.f = n[0]), (t.M = 1), Tn(t))
              : (rn(e, "MODE", "init"),
                !t.a.o && t.a.j && rn(e, "X-HTTP-Session-Id", t.a.j),
                (t.b = new ke(t, void 0, void 0)),
                (t.b.h = t.h),
                Le(t.b, e, !1, null),
                (t.M = 0)));
      ...
      ((gr.prototype.createWebChannel = gr.prototype.a),
        (vr.prototype.send = vr.prototype.Xa),
        (vr.prototype.open = vr.prototype.Wa),
        (vr.prototype.close = vr.prototype.close),
        (be.NO_ERROR = 0),
        (be.TIMEOUT = 8),
        (be.HTTP_ERROR = 6),
        (we.COMPLETE = "complete"),
        ((Ee.EventType = Ce).OPEN = "a"),
        (Ce.CLOSE = "b"),
        (Ce.ERROR = "c"),
        (Ce.MESSAGE = "d"),
        (Kt.prototype.listen = Kt.prototype.Aa),
        (Un.prototype.listenOnce = Un.prototype.Ba),
        (Un.prototype.getLastError = Un.prototype.Ya),
        (Un.prototype.getLastErrorCode = Un.prototype.ya),
        (Un.prototype.getStatus = Un.prototype.T),
        (Un.prototype.getStatusText = Un.prototype.za),
        (Un.prototype.getResponseJson = Un.prototype.Va),
      ...
      function Lr(t) {
        switch (t) {
          ...
          default:
            Or.error(
              "Firestore (" + Mr + "): Invalid value passed to `setLogLevel`",
            );
        }
      }
      function Pr(t, e) {
      ...
      (((Ir = Er = Er || {})[(Ir.DEBUG = 0)] = "DEBUG"),
        (Ir[(Ir.ERROR = 1)] = "ERROR"),
        (Ir[(Ir.SILENT = 2)] = "SILENT"));
      var Br =
        ((Ur.setPlatform = function (t) {
      ...
      function li(t) {
        ...
        if ("string" == typeof t)
          return (
            20 < t.length && (t = t.substring(0, 20) + "..."),
            JSON.stringify(t)
          );
        ...
        if ("object" != typeof t)
          return "function" == typeof t
            ? "a function"
            : Fr("Unknown wrong type: " + typeof t);
      ...
      function Ei() {
        if (!Br.getPlatform().base64Available)
          throw new Wr(
            jr.UNIMPLEMENTED,
      ...
      var Ii =
        ((Ci.fromBase64String = function (t) {
          (ti("Blob.fromBase64String", arguments, 1),
            ri("Blob.fromBase64String", "string", 1, t),
            Ei());
          try {
        ...
        (Ci.fromUint8Array = function (t) {
          if (
            (ti("Blob.fromUint8Array", arguments, 1),
            Ti(),
            !(t instanceof Uint8Array))
          )
            throw pi("Blob.fromUint8Array", "Uint8Array", 1, t);
          return new Ci(
            Array.prototype.map
              .call(t, function (t) {
        ...
        (Ci.prototype.toBase64 = function () {
          return (
            ti("Blob.toBase64", arguments, 0),
            Ei(),
            Br.getPlatform().btoa(this._binaryString)
          );
        }),
      ...
      var Di = zr(
        ...
        Ai = "(default)",
        ki =
          (Object.defineProperty(Ri.prototype, "isDefaultDatabase", {
            get: function () {
          ...
          (Ri.prototype.compareTo = function (t) {
            return (
              bi(this.projectId, t.projectId) || bi(this.database, t.database)
            );
          }),
          Ri);
      function Ri(t, e) {
      ...
      var Mi =
        ((Oi.prototype.setPreviousValue = function (t) {
          return (
        ...
        (Oi.prototype.next = function () {
          ...
          return (
            this.writeNewSequenceNumber && this.writeNewSequenceNumber(t),
            t
          );
        }),
        (Oi.INVALID = -1),
      ...
      var _i = "__name__",
        Li =
          (Object.defineProperty(Pi.prototype, "length", {
            get: function () {
              return this.len;
            },
            enumerable: !0,
          ...
          (Pi.prototype.get = function (t) {
            return (
              Vr(t < this.length, "Index out of range"),
      ...
      function Pi(t, e, n) {
        (void 0 === e
          ? (e = 0)
          : e > t.length && Fr("offset " + e + " out of range " + t.length),
          void 0 === n
            ? (n = t.length - e)
            : n > t.length - e &&
              Fr("length " + n + " out of range " + (t.length - e)),
          (this.segments = t),
          (this.offset = e),
          (this.len = n));
      }
      var xi,
        qi =
          (t(Fi, (xi = Li)),
          (Fi.prototype.construct = function (t, e, n) {
            return new Fi(t, e, n);
          }),
          ...
          (Fi.EMPTY_PATH = new Fi([])),
          Fi);
      function Fi() {
        return (null !== xi && xi.apply(this, arguments)) || this;
      }
      var Vi,
        Bi = /^[_a-zA-Z][_a-zA-Z0-9]*$/,
        Ui =
          (t(Qi, (Vi = Li)),
          (Qi.prototype.construct = function (t, e, n) {
            return new Qi(t, e, n);
          }),
          ...
          (Qi.fromServerFormat = function (t) {
            ...
            if ((i(), o))
              throw new Wr(jr.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
            return new Qi(e);
          }),
          (Qi.EMPTY_PATH = new Qi([])),
          Qi);
      function Qi() {
        return (null !== Vi && Vi.apply(this, arguments)) || this;
      }
      var Ki =
        ((ji.prototype.hasCollectionId = function (t) {
          return (
      ...
      (((Gi = Wi = Wi || {}).All = "all"),
        (Gi.ListenStreamIdle = "listen_stream_idle"),
        (Gi.ListenStreamConnectionBackoff = "listen_stream_connection_backoff"),
        (Gi.WriteStreamIdle = "write_stream_idle"),
        (Gi.WriteStreamConnectionBackoff = "write_stream_connection_backoff"),
        (Gi.OnlineStateTimeout = "online_state_timeout"),
        (Gi.ClientMetadataRefresh = "client_metadata_refresh"),
        (Gi.LruGarbageCollection = "lru_garbage_collection"),
        (Gi.RetryTransaction = "retry_transaction"));
      var Hi =
        ((Yi.createAndSchedule = function (t, e, n, r, i) {
        ...
        (Yi.prototype.cancel = function (t) {
          null !== this.timerHandle &&
            ...
            this.deferred.reject(
              new Wr(jr.CANCELLED, "Operation cancelled" + (t ? ": " + t : "")),
            ));
        }),
      ...
      var Xi =
        (Object.defineProperty(Ji.prototype, "isShuttingDown", {
          get: function () {
                  ...
                  return (
                    ...
                    this._isShuttingDown
                      ...
                      : ((this._isShuttingDown = !0),
                        [4, this.enqueueEvenAfterShutdown(e)])
                  );
                case 1:
                  (t.sent(), (t.label = 2));
                case 2:
        ...
        (Ji.prototype.enqueueAfterDelay = function (t, e, n) {
          ...
          (this.verifyNotFailed(),
            ...
            -1 < this.timerIdsToSkip.indexOf(t) && (e = 0));
        ...
        (Ji.prototype.runDelayedOperationsEarly = function (r) {
          ...
          return this.drain().then(function () {
            (Vr(
              r === Wi.All || i.containsDelayedOperation(r),
              "Attempted to drain to missing operation " + r,
            ),
              i.delayedOperations.sort(function (t, e) {
        ...
        (Ji.prototype.removeDelayedOperation = function (t) {
          ...
          (Vr(0 <= e, "Delayed operation not found."),
      ...
      function no(t) {
        for (var e = "", n = 0; n < t.length; n++)
          (0 < e.length && (e = io(e)), (e = ro(t.get(n), e)));
        return io(e);
      }
      function ro(t, e) {
      ...
      function oo(t) {
        var e = t.length;
        if ((Vr(2 <= e, "Invalid path " + t), 2 === e))
          return (
            Vr(
              t.charAt(0) === Zi && t.charAt(1) === $i,
      ...
      var ao =
        ...
        (so.prototype._compareTo = function (t) {
          return this.seconds === t.seconds
            ? bi(this.nanoseconds, t.nanoseconds)
            : bi(this.seconds, t.seconds);
        }),
      ...
      var uo =
        ((co.fromMicroseconds = function (t) {
        ...
        (co.MIN = new co(new ao(0, 0))),
        co);
      function co(t) {
        this.timestamp = t;
      }
      var ho =
        ((lo.prototype.insert = function (t, e) {
          return new lo(
            this.comparator,
            this.root
      ...
      var fo =
        ((po.prototype.getNext = function () {
          Vr(
            0 < this.nodeStack.length,
      ...
      var mo =
        ((yo.prototype.copy = function (t, e, n, r, i) {
          return new yo(
            null != t ? t : this.key,
            null != e ? e : this.value,
            null != n ? n : this.color,
      ...
      function yo(t, e, n, r, i) {
        ((this.key = t),
          (this.value = e),
          (this.color = null != n ? n : yo.RED),
          (this.left = null != r ? r : yo.EMPTY),
          (this.right = null != i ? i : yo.EMPTY),
          (this.size = this.left.size + 1 + this.right.size));
      }
      var go =
        (Object.defineProperty(vo.prototype, "key", {
          get: function () {
      ...
      var Lo =
        ((Po.prototype.applyToRemoteDocument = function (t, e, n) {
          e &&
            Vr(
              e.key.isEqual(t),
        ...
        (Po.prototype.applyToLocalView = function (t, e) {
          ...
          for (var n = 0, r = this.baseMutations; n < r.length; n++)
            (s = r[n]).key.isEqual(t) &&
              (e = s.applyToLocalView(e, e, this.localWriteTime));
          for (var i = e, o = 0, a = this.mutations; o < a.length; o++) {
            var s;
            (s = a[o]).key.isEqual(t) &&
              (e = s.applyToLocalView(e, i, this.localWriteTime));
          }
          return e;
        }),
        ...
        (Po.prototype.isEqual = function (t) {
          return (
            ...
            wi(this.mutations, t.mutations) &&
            wi(this.baseMutations, t.baseMutations)
          );
        }),
        Po);
      function Po(t, e, n, r) {
      ...
      var xo =
        ((qo.from = function (t, e, n, r) {
          ...
          for (var i = ko(), o = t.mutations, a = 0; a < o.length; a++)
        ...
        (Vo.prototype.next = function (r, i) {
          ...
          return (
            this.callbackAttached &&
              Fr("Called next() or catch() twice for PersistencePromise"),
      ...
      var Bo =
        ((Uo.forUser = function (t, e, n, r) {
          return (
            Vr("" !== t.uid, "UserID must not be an empty string."),
            new Uo(t.isAuthenticated() ? t.uid : "", e, n, r)
          );
        }),
        (Uo.prototype.checkEmpty = function (t) {
          ...
          return Wo(t)
            .iterate(
              { index: pu.userMutationsIndex, range: e },
              function (t, e, n) {
                ((r = !1), n.done());
              },
            )
        ...
        (Uo.prototype.addMutationBatch = function (c, h, l, f) {
          ...
          return m.add({}).next(function (t) {
            ...
            for (
              var e = new Lo(t, h, l, f),
                n = d.serializer.toDbMutationBatch(d.userId, e),
                r = [],
                i = new bo(function (t, e) {
              ...
              ((i = i.add(s.key.path.popLast())),
                r.push(m.put(n)),
                r.push(p.put(u, yu.PLACEHOLDER)));
            }
            return (
        ...
        (Uo.prototype.lookupMutationKeys = function (t, n) {
          var r = this;
          return this.documentKeysByBatchId[n]
            ? Fo.resolve(this.documentKeysByBatchId[n])
            : this.lookupMutationBatch(t, n).next(function (t) {
                if (t) {
                  var e = t.keys();
        ...
        (Uo.prototype.getNextMutationBatchAfterBatchId = function (t, e) {
          ...
          return Wo(t)
            .iterate(
              { index: pu.userMutationsIndex, range: n },
              function (t, e, n) {
                (e.userId === r.userId &&
                  (Vr(e.batchId >= i, "Should have found mutation after " + i),
                  (o = r.serializer.fromDbMutationBatch(e))),
                  n.done());
              },
            )
            .next(function () {
        ...
        (Uo.prototype.getHighestUnacknowledgedBatchId = function (t) {
          ...
          return Wo(t)
            .iterate(
              { index: pu.userMutationsIndex, range: e, reverse: !0 },
              function (t, e, n) {
                ((r = e.batchId), n.done());
              },
            )
        ...
        (Uo.prototype.getAllMutationBatches = function (t) {
          ...
          return Wo(t)
            .loadAll(pu.userMutationsIndex, n)
            .next(function (t) {
        ...
        (Uo.prototype.getAllMutationBatchesAffectingDocumentKey = function (
          s,
          u,
        ) {
          var c = this,
            ...
            h = [];
          return Go(s)
            .iterate({ range: e }, function (e, t, n) {
              var r = e[0],
                i = e[1],
                o = e[2],
                a = oo(i);
              if (r === c.userId && u.path.isEqual(a))
                return Wo(s)
                  .get(o)
                  .next(function (t) {
                    if (!t)
                    ...
                    (Vr(
                      ...
                      h.push(c.serializer.fromDbMutationBatch(t)));
                  });
              n.done();
            })
            .next(function () {
        ...
        (Uo.prototype.getAllMutationBatchesAffectingDocumentKeys = function (
          r,
          t,
        ) {
          var u = this,
          ...
          return (
            t.forEach(function (s) {
              var t = yu.prefixForPath(u.userId, s.path),
                e = IDBKeyRange.lowerBound(t),
                n = Go(r).iterate({ range: e }, function (t, e, n) {
                  var r = t[0],
                    i = t[1],
                    o = t[2],
                    a = oo(i);
                  r === u.userId && s.path.isEqual(a)
                    ? (c = c.add(o))
                    : n.done();
                });
              i.push(n);
        ...
        (Uo.prototype.getAllMutationBatchesAffectingQuery = function (t, e) {
          ...
          var u = e.path,
            ...
            h = new bo(bi);
          return Go(t)
            .iterate({ range: r }, function (t, e, n) {
              var r = t[0],
                i = t[1],
                o = t[2],
                a = oo(i);
              r === s.userId && u.isPrefixOf(a)
                ? a.length === c && (h = h.add(o))
                : n.done();
            })
            .next(function () {
        ...
        (Uo.prototype.performConsistencyCheck = function (n) {
          ...
          return this.checkEmpty(n).next(function (t) {
            ...
            var e = IDBKeyRange.lowerBound(yu.prefixForUser(o.userId)),
              i = [];
            return Go(n)
              .iterate({ range: e }, function (t, e, n) {
                if (t[0] === o.userId) {
                  var r = oo(t[1]);
                  i.push(r);
                } else n.done();
      ...
      function Qo(t, o, e) {
        var n = yu.prefixForPath(o, e.path),
          ...
          s = !1;
        return Go(t)
          .iterate({ range: r, keysOnly: !0 }, function (t, e, n) {
            var r = t[0],
              i = t[1];
            t[2];
            (r === o && i === a && (s = !0), n.done());
      ...
      var Ho, Yo;
      (((Yo = Ho = Ho || {})[(Yo.QueryCache = 0)] = "QueryCache"),
        (Yo[(Yo.SyncEngine = 1)] = "SyncEngine"));
      var Xo =
      ...
      var Zo = "SimpleDb",
        $o =
          ((ta.openOrCreate = function (o, t, a) {
            return (
              Vr(
                ta.isAvailable(),
                "IndexedDB not supported in current environment.",
              ),
              Pr(Zo, "Opening database:", o),
              new Fo(function (n, r) {
                ...
                ((i.onsuccess = function (t) {
                  ...
                  (i.onupgradeneeded = function (t) {
                    ...
                    var e = t.target.result;
                    a.createOrUpgrade(e, i.transaction, t.oldVersion, au).next(
                      function () {
                        Pr(
                          Zo,
                          "Database upgrade to version " + au + " complete",
                        );
                      },
                    );
                  }));
          ...
          (ta.delete = function (t) {
            return (
              Pr(Zo, "Removing database:", t),
              sa(window.indexedDB.deleteDatabase(t)).toPromise()
            );
          }),
      ...
      var ea =
        (Object.defineProperty(na.prototype, "isDone", {
          get: function () {
      ...
      var ra =
        ...
        (ia.prototype.store = function (t) {
          ...
          return (
            Vr(!!e, "Object store not part of transaction: " + t),
            new oa(e)
          );
        }),
        ia);
      function ia(t) {
        ...
        ((this.transaction = t),
          (this.aborted = !1),
          (this.completionDeferred = new zi()),
          (this.transaction.oncomplete = function () {
            n.completionDeferred.resolve();
          }),
          (this.transaction.onabort = function () {
            t.error
              ? n.completionDeferred.reject(t.error)
              : n.completionDeferred.resolve();
          }),
      ...
      var oa =
        ((aa.prototype.put = function (t, e) {
          return sa(
            void 0 !== e
              ? (Pr(Zo, "PUT", this.store.name, t, e), this.store.put(e, t))
              : (Pr(Zo, "PUT", this.store.name, "<auto-key>", t),
                this.store.put(t)),
          );
        }),
        ...
        (aa.prototype.delete = function (t) {
          return (
            Pr(Zo, "DELETE", this.store.name, t),
            sa(this.store.delete(t))
          );
        }),
      ...
      var ha =
        ((la.prototype.allocateTargetId = function (e) {
          var n = this;
          return this.retrieveMetadata(e).next(function (t) {
            return (
              (t.highestTargetId = n.targetIdGenerator.after(
                t.highestTargetId,
              )),
              n.saveMetadata(e, t).next(function () {
        ...
        (la.prototype.addQueryData = function (e, n) {
          ...
          return this.saveQueryData(e, n).next(function () {
            return r.retrieveMetadata(e).next(function (t) {
              return (
                (t.targetCount += 1),
                r.updateMetadataFromQueryData(n, t),
                r.saveMetadata(e, t)
              );
            });
          });
        ...
        (la.prototype.removeQueryData = function (e, t) {
          ...
          return this.removeMatchingKeysForTargetId(e, t.targetId)
            ...
            .next(function (t) {
              return (
                Vr(0 < t.targetCount, "Removing from an empty query cache"),
                (t.targetCount -= 1),
                n.saveMetadata(e, t)
              );
            });
          ...
          return fa(r)
            .iterate(function (t, e) {
              ...
              n.sequenceNumber <= i &&
                ...
                (s++, u.push(a.removeQueryData(r, n)));
            })
            .next(function () {
              return Fo.waitFor(u);
            })
        ...
        (la.prototype.getQueryData = function (t, i) {
          ...
          return fa(t)
            .iterate(
              { range: n, index: Iu.queryTargetsIndexName },
              function (t, e, n) {
        ...
        (la.prototype.addMatchingKeys = function (n, t, r) {
          ...
          return (
            t.forEach(function (t) {
              var e = no(t.path);
              (o.push(a.put(new Du(r, e))),
                o.push(i.referenceDelegate.addReference(n, t)));
            }),
            Fo.waitFor(o)
          );
        }),
        (la.prototype.removeMatchingKeys = function (n, t, r) {
          ...
          return Fo.forEach(t, function (t) {
            ...
            return Fo.waitFor([
              o.delete([r, e]),
              i.referenceDelegate.removeReference(n, t),
            ]);
          });
        }),
        ...
        (la.prototype.containsKey = function (t, e) {
          ...
          return ma(t)
            .iterate(
              { index: Du.documentTargetsIndex, keysOnly: !0, range: r },
              function (t, e, n) {
                var r = t[0];
                (t[1], 0 !== r && (i++, n.done()));
              },
      ...
      function la(t, e) {
        ((this.referenceDelegate = t),
          (this.serializer = e),
          (this.targetIdGenerator = Xo.forQueryCache()));
      }
      function fa(t) {
      ...
      var va =
        ((ba.prototype.isEqual = function (t) {
          return (
      ...
      (((Sa = wa = wa || {})[(Sa.Set = 0)] = "Set"),
        (Sa[(Sa.Patch = 1)] = "Patch"),
        (Sa[(Sa.Transform = 2)] = "Transform"),
        (Sa[(Sa.Delete = 3)] = "Delete"));
      var Ea =
        ((Ia.exists = function (t) {
        ...
        (Ia.prototype.isValidFor = function (t) {
          return void 0 !== this.updateTime
            ...
            : void 0 !== this.exists
              ? this.exists === t instanceof xs
              : (Vr(this.isNone, "Precondition should be empty"), !0);
        }),
      ...
      var Ca =
        ((Da.prototype.verifyKeyMatches = function (t) {
          null != t &&
            Vr(
      ...
      var Na,
        Aa =
          (t(ka, (Na = Ca)),
          (ka.prototype.applyToRemoteDocument = function (t, e) {
          ...
          (ka.prototype.applyToLocalView = function (t, e, n) {
            ...
            return new xs(this.key, r, { hasLocalMutations: !0 }, this.value);
          }),
      ...
      var Ra,
        Ma =
          (t(Oa, (Ra = Ca)),
          (Oa.prototype.applyToRemoteDocument = function (t, e) {
            if (
              (this.verifyKeyMatches(t),
              Vr(
                null == e.transformResults,
              ...
              return new Qs(this.key, e.version);
          ...
          (Oa.prototype.applyToLocalView = function (t, e, n) {
            ...
            return new xs(this.key, r, { hasLocalMutations: !0 }, i);
          }),
          ...
          (Oa.prototype.patchDocument = function (t) {
            var e;
            return (
              (e = t instanceof xs ? t.data() : As.EMPTY),
              this.patchObject(e)
            );
          }),
          (Oa.prototype.patchObject = function (n) {
            var r = this;
            return (
              this.fieldMask.fields.forEach(function (t) {
                if (!t.isEmpty()) {
      ...
      var _a,
        La =
          (t(Pa, (_a = Ca)),
          (Pa.prototype.applyToRemoteDocument = function (t, e) {
            if (
              (this.verifyKeyMatches(t),
              Vr(
                null != e.transformResults,
            ...
            return new xs(this.key, i, { hasCommittedMutations: !0 }, o);
          }),
          (Pa.prototype.applyToLocalView = function (t, e, n) {
            ...
            return new xs(this.key, r.version, { hasLocalMutations: !0 }, o);
          }),
          (Pa.prototype.extractBaseValue = function (t) {
            for (
              ...
              null != a &&
                (e = null == e ? As.EMPTY.set(i.field, a) : e.set(i.field, a));
            }
            return e;
          }),
          (Pa.prototype.isEqual = function (t) {
            return (
              t instanceof Pa &&
              this.key.isEqual(t.key) &&
              wi(this.fieldTransforms, t.fieldTransforms) &&
              this.precondition.isEqual(t.precondition)
            );
          }),
          ...
          (Pa.prototype.serverTransformResults = function (t, e) {
            ...
            for (var r = 0; r < e.length; r++) {
              var i = this.fieldTransforms[r],
                o = i.transform,
                a = null;
              (t instanceof xs && (a = t.field(i.field)),
                n.push(o.applyToRemoteDocument(a, e[r])));
            }
            return n;
          }),
          (Pa.prototype.localTransformResults = function (t, e, n) {
            for (
              ...
              var a = o[i],
                s = a.transform,
                u = null;
              (e instanceof xs && (u = e.field(a.field)),
                null === u && n instanceof xs && (u = n.field(a.field)),
                r.push(s.applyToLocalView(u, t)));
            }
            return r;
          }),
      ...
      var xa,
        ...
        Ua =
          (t(Qa, (xa = Ca)),
          (Qa.prototype.applyToRemoteDocument = function (t, e) {
            return (
              this.verifyKeyMatches(t),
              Vr(
                null == e.transformResults,
              ...
              new Vs(this.key, e.version, { hasCommittedMutations: !0 })
            );
          }),
            ...
            return (
              ...
              this.precondition.isValidFor(t)
                ? (t &&
                  ...
                  new Vs(this.key, uo.forDeletedDoc()))
                : t
            );
          }),
      ...
      (((Fa = qa = qa || {})[(Fa.NullValue = 0)] = "NullValue"),
        (Fa[(Fa.BooleanValue = 1)] = "BooleanValue"),
        (Fa[(Fa.NumberValue = 2)] = "NumberValue"),
        (Fa[(Fa.TimestampValue = 3)] = "TimestampValue"),
        (Fa[(Fa.StringValue = 4)] = "StringValue"),
        (Fa[(Fa.BlobValue = 5)] = "BlobValue"),
        (Fa[(Fa.RefValue = 6)] = "RefValue"),
        (Fa[(Fa.GeoPointValue = 7)] = "GeoPointValue"),
        (Fa[(Fa.ArrayValue = 8)] = "ArrayValue"),
        (Fa[(Fa.ObjectValue = 9)] = "ObjectValue"),
        ((Ba = Va = Va || {})[(Ba.Default = 0)] = "Default"),
        (Ba[(Ba.Estimate = 1)] = "Estimate"),
        (Ba[(Ba.Previous = 2)] = "Previous"));
      var Ka =
        ((ja.fromSnapshotOptions = function (t, e) {
                      ...
                      : t === e
                        ...
                        : isNaN(t)
                          ? isNaN(e)
                            ...
                            : -1
                          : 1;
                })(this.internalValue, t.internalValue)
      ...
      var as,
        ss =
          ...
          (us.NAN = new us(NaN)),
          (us.POSITIVE_INFINITY = new us(1 / 0)),
          (us.NEGATIVE_INFINITY = new us(-1 / 0)),
          us);
      function us() {
        ...
        hs =
          ...
          (ls.prototype.compareTo = function (t) {
            return t instanceof ls
              ? bi(this.internalValue, t.internalValue)
              : this.defaultCompareTo(t);
          }),
          ls);
      function ls(t) {
      ...
      var fs,
        ds =
          ...
          (ps.prototype.isEqual = function (t) {
            return (
              t instanceof ps && this.internalValue.isEqual(t.internalValue)
            );
          }),
      ...
      var ms,
        ys =
          ...
          (gs.prototype.value = function (t) {
            return t && t.serverTimestampBehavior === Va.Estimate
              ? new ds(this.localWriteTime).value(t)
              : t &&
                  t.serverTimestampBehavior === Va.Previous &&
                  this.previousValue
          ...
          (gs.prototype.isEqual = function (t) {
            return (
              t instanceof gs && this.localWriteTime.isEqual(t.localWriteTime)
            );
          }),
      ...
      var vs,
        bs =
          (t(ws, (vs = Wa)),
          (ws.prototype.value = function (t) {
            return this.internalValue;
          }),
          (ws.prototype.isEqual = function (t) {
            return (
              t instanceof ws && this.internalValue.isEqual(t.internalValue)
            );
          }),
        ...
        Ts =
          ...
          (Es.prototype.isEqual = function (t) {
            return (
              t instanceof Es &&
              this.key.isEqual(t.key) &&
              this.databaseId.isEqual(t.databaseId)
            );
          }),
          (Es.prototype.compareTo = function (t) {
            if (t instanceof Es) {
      ...
      var Is,
        Cs =
          (t(Ds, (Is = Wa)),
          (Ds.prototype.value = function (t) {
            return this.internalValue;
          }),
          (Ds.prototype.isEqual = function (t) {
            return (
              t instanceof Ds && this.internalValue.isEqual(t.internalValue)
            );
          }),
      ...
      var Ns,
        As =
          (t(ks, (Ns = Wa)),
          (ks.prototype.value = function (n) {
            var r = {};
            return (
              this.internalValue.inorderTraversal(function (t, e) {
                r[t] = e.value(n);
              }),
              r
            );
          ...
          (ks.prototype.isEqual = function (t) {
            if (t instanceof ks) {
              for (
                var e = this.internalValue.getIterator(),
                  n = t.internalValue.getIterator();
                e.hasNext() && n.hasNext();
          ...
          (ks.prototype.set = function (t, e) {
            if (
              ...
              return this.setChild(t.firstSegment(), e);
          ...
          (ks.prototype.delete = function (t) {
            if (
              ...
              return new ks(this.internalValue.remove(t.firstSegment()));
          ...
          (ks.prototype.fieldMask = function () {
            ...
            return (
              this.internalValue.forEach(function (t, e) {
                var n = new Ui([t]);
                if (e instanceof ks) {
          ...
          (Os.prototype.isEqual = function (t) {
            if (t instanceof Os) {
              ...
              for (var e = 0; e < this.internalValue.length; e++)
                if (!this.internalValue[e].isEqual(t.internalValue[e]))
                  return !1;
              return !0;
            }
            return !1;
        ...
        xs =
          ...
          (qs.prototype.field = function (t) {
            ...
            if (void 0 === n) {
              ...
              ((n = void 0 === r ? null : this.converter(r)),
                this.fieldValueCache.set(e, n));
            }
            return n;
          }),
          ...
          (qs.prototype.getProtoField = function (t) {
            ...
            for (
              var e = this.proto.fields
                  ? this.proto.fields[t.firstSegment()]
                  : void 0,
                n = 1;
              n < t.length;
              ++n
          ...
          (qs.compareByField = function (t, e, n) {
            ...
            return null !== r && null !== i
              ? r.compareTo(i)
              : Fr("Trying to compare documents on fields that don't exist");
          }),
          qs);
        ...
        return (
          ...
          Vr(
            void 0 !== a.objectValue ||
              (void 0 !== a.proto && void 0 !== a.converter),
            "If objectValue is not defined, proto and converter need to be set.",
          ),
          (a.hasLocalMutations = !!n.hasLocalMutations),
          (a.hasCommittedMutations = !!n.hasCommittedMutations),
          a
        );
      }
      var Fs,
      ...
      function Bs(t, e, n) {
        ...
        return (
          (r.hasCommittedMutations = !(!n || !n.hasCommittedMutations)),
          r
        );
      }
      var Us,
      ...
      var Gs =
        (Object.defineProperty(zs.prototype, "readTime", {
          get: function () {
            return (
              Vr(
                void 0 !== this._readTime,
          ...
          set: function (t) {
            (Vr(
              void 0 === this._readTime || this._readTime.isEqual(t),
      ...
      var Hs,
        Ys =
          ((Xs.prototype.addEntry = function (t, e, n) {
          ...
          (Xs.prototype.getSizedEntry = function (t, e) {
            ...
            return $s(t)
              ...
              .next(function (t) {
                ...
                return e ? { maybeDocument: e, size: eu(t) } : null;
              });
          }),
          ...
          (Xs.prototype.getSizedEntries = function (t, e) {
            ...
            return this.forEachDbEntry(t, e, function (t, e) {
              var n = r.maybeDecodeDocument(e);
              o = n
                ? ((i = i.insert(t, n)), o.insert(t, eu(e)))
                : ((i = i.insert(t, null)), o.insert(t, 0));
            }).next(function () {
              return { maybeDocuments: i, sizeMap: o };
            });
          }),
          (Xs.prototype.forEachDbEntry = function (t, e, i) {
            ...
            var n = IDBKeyRange.bound(
              ...
              a = o.getNext();
            return $s(t)
              .iterate({ range: n }, function (t, e, n) {
                for (var r = Ki.fromSegments(t); a && Ki.comparator(a, r) < 0; )
                  (i(a, null), (a = o.getNext()));
                (a &&
                  a.isEqual(r) &&
                  (i(a, e), (a = o.hasNext() ? o.getNext() : null)),
                  a ? n.skip(a.path.toArray()) : n.done());
              })
              .next(function () {
                for (; a; )
          ...
          (Xs.prototype.getDocumentsMatchingQuery = function (t, i, e) {
            ...
            if (e.isEqual(uo.MIN)) {
              ...
              ((n.range = IDBKeyRange.lowerBound([u, c], !0)),
                (n.index = wu.collectionReadTimeIndex));
            }
            return $s(t)
              .iterate(n, function (t, e, n) {
                if (t.length === s) {
                  var r = o.serializer.fromDbRemoteDocument(e);
                  i.path.isPrefixOf(r.key.path)
                    ? r instanceof xs &&
                      i.matches(r) &&
                      (a = a.insert(r.key, r))
                    : n.done();
          ...
          (Xs.prototype.getNewDocumentChanges = function (t, e) {
            ...
            return n
              .iterate({ index: wu.readTimeIndex, range: a }, function (t, e) {
          ...
          (Xs.prototype.getLastDocumentChange = function (t) {
            ...
            return e
              .iterate(
                { index: wu.readTimeIndex, reverse: !0 },
                function (t, e, n) {
                  ((r = i.serializer.fromDbRemoteDocument(e)),
                    e.readTime &&
              ...
              .next(function () {
                return { changedDoc: r, readTime: o };
              });
          }),
          (Xs.prototype.newChangeBuffer = function (t) {
            return new Xs.RemoteDocumentChangeBuffer(
              this,
              !!t && t.trackRemovals,
            );
          }),
          ...
          (Xs.prototype.maybeDecodeDocument = function (t) {
            if (t) {
              ...
              return e instanceof Vs && e.version.isEqual(uo.forDeletedDoc())
                ? null
                : e;
            }
            return null;
          }),
          (Xs.RemoteDocumentChangeBuffer =
            (t(Js, (Hs = Gs)),
            (Js.prototype.applyChanges = function (a) {
              var s = this,
                u = [],
                c = 0,
              ...
              return (
                this.changes.forEach(function (t, e) {
                  ...
                  if (
                    ...
                    Vr(
                      !s.readTime.isEqual(uo.MIN),
                      "Cannot add a document with a read time of zero",
                    );
                    var r = s.documentCache.serializer.toDbRemoteDocument(
                      e,
                      s.readTime,
                    );
                    ...
                    var o = s.documentCache.serializer.toDbRemoteDocument(
                      new Vs(t, uo.forDeletedDoc()),
                      s.readTime,
                    );
                ...
                h.forEach(function (t) {
                  u.push(
                    s.documentCache.indexManager.addToCollectionParentIndex(
                      a,
                      t,
                    ),
                  );
                }),
                u.push(this.documentCache.updateMetadata(a, c)),
                Fo.waitFor(u)
              );
            }),
      ...
      function Js(t, e) {
        ...
        return (
          (n.documentCache = t),
          (n.trackRemovals = e),
          (n.documentSizes = new js(function (t) {
            return t.toString();
          })),
          n
        );
      ...
      var nu =
        ((ru.prototype.addToCollectionParentIndex = function (t, e) {
      ...
      var au = 9,
        su =
          ((uu.prototype.createOrUpgrade = function (t, e, n, r) {
            var i = this;
            Vr(
              n < r && 0 <= n && r <= au,
            ...
            n < 1 &&
              ...
              (function (t) {
                (t.createObjectStore(fu.store, { keyPath: fu.keyPath }),
                  t
                    .createObjectStore(pu.store, {
                      keyPath: pu.keyPath,
                      autoIncrement: !0,
                    })
                    .createIndex(
                      pu.userMutationsIndex,
            ...
            return (
              n < 3 &&
                ...
                (0 !== n &&
                  ((function (t) {
                    (t.deleteObjectStore(Du.store),
                      t.deleteObjectStore(Iu.store),
                      t.deleteObjectStore(Au.store));
                  })(t),
                  Ou(t)),
                (a = a.next(function () {
                  return (function (t) {
              ...
              n < 4 &&
                ...
                (a = a.next(function () {
                  !(function (t) {
                    t.createObjectStore(_u.store, { keyPath: _u.keyPath });
                  })(t);
                }))),
              n < 5 &&
                5 <= r &&
                  ...
                  (!(function (t) {
                    ...
                    (function (t) {
                      ...
                      (e.createIndex(wu.readTimeIndex, wu.readTimeIndexPath, {
                        ...
                        e.createIndex(
                          wu.collectionReadTimeIndex,
                          wu.collectionReadTimeIndexPath,
                          { unique: !1 },
                        ));
                    })(e));
                })),
          ...
          (uu.prototype.createCollectionParentIndex = function (t, e) {
            function i(t) {
              if (o.add(t)) {
                var e = t.lastSegment(),
                  n = t.popLast();
                return r.put({ collectionId: e, parent: no(n) });
              }
            }
            t.createObjectStore(Ru.store, { keyPath: Ru.keyPath });
            var r = e.store(Ru.store),
              o = new iu();
            return e
              .store(wu.store)
              .iterate({ keysOnly: !0 }, function (t, e) {
                var n = new qi(t);
                return i(n.popLast());
              })
              .next(function () {
      ...
      var pu =
        ((mu.store = "mutations"),
        (mu.keyPath = "batchId"),
        (mu.userMutationsIndex = "userMutationsIndex"),
        (mu.userMutationsKeyPath = ["userId", "batchId"]),
        mu);
      ...
      var yu =
        ...
        (gu.store = "documentMutations"),
        (gu.PLACEHOLDER = new gu()),
        gu);
      function gu() {}
      var vu = function (t, e) {
        ...
        wu =
          ((Su.store = "remoteDocuments"),
          (Su.readTimeIndex = "readTimeIndex"),
          (Su.readTimeIndexPath = "readTime"),
          (Su.collectionReadTimeIndex = "collectionReadTimeIndex"),
          (Su.collectionReadTimeIndexPath = ["parentPath", "readTime"]),
          Su);
      ...
      var Tu =
        ((Eu.store = "remoteDocumentGlobal"),
        (Eu.key = "remoteDocumentGlobalKey"),
        Eu);
      function Eu(t) {
        this.byteSize = t;
      }
      var Iu =
        ((Cu.store = "targets"),
        (Cu.keyPath = "targetId"),
        (Cu.queryTargetsIndexName = "queryTargetsIndex"),
        (Cu.queryTargetsKeyPath = ["canonicalId", "targetId"]),
        Cu);
      ...
      var Du =
        ((Nu.store = "targetDocuments"),
        (Nu.keyPath = ["targetId", "path"]),
        (Nu.documentTargetsIndex = "documentTargetsIndex"),
        (Nu.documentTargetsKeyPath = ["path", "targetId"]),
        Nu);
      function Nu(t, e, n) {
        ((this.targetId = t),
          (this.path = e),
      ...
      var Ru =
        ((Mu.store = "collectionParents"),
        (Mu.keyPath = ["collectionId", "parent"]),
        Mu);
      function Mu(t, e) {
      ...
      function Ou(t) {
        (t
          .createObjectStore(Du.store, { keyPath: Du.keyPath })
          .createIndex(Du.documentTargetsIndex, Du.documentTargetsKeyPath, {
            unique: !0,
          }),
          t
            .createObjectStore(Iu.store, { keyPath: Iu.keyPath })
      ...
      var Pu,
        ...
        Fu =
          ((Vu.prototype.addToCollectionParentIndex = function (t, e) {
            var n = this;
            if (
              (Vr(e.length % 2 == 1, "Expected a collection path."),
              this.collectionParentsCache.has(e))
            )
              return Fo.resolve();
            var r = e.lastSegment(),
              i = e.popLast();
            return (
              ...
              Bu(t).put({ collectionId: r, parent: no(i) })
            );
          }),
      ...
      (((xu = Pu = Pu || {})[(xu.Listen = 0)] = "Listen"),
        (xu[(xu.ExistenceFilterMismatch = 1)] = "ExistenceFilterMismatch"),
        (xu[(xu.LimboResolution = 2)] = "LimboResolution"));
      var Uu =
        ((Qu.prototype.withSequenceNumber = function (t) {
          return new Qu(
            this.query,
            this.targetId,
            this.purpose,
      ...
      var Ku =
        ((ju.prototype.fromDbRemoteDocument = function (t) {
          if (t.document)
          ...
          return t.unknownDocument
            ? ((e = Ki.fromSegments(t.unknownDocument.path)),
              (n = this.fromDbTimestamp(t.unknownDocument.version)),
              new Qs(e, n))
            : Fr("Unexpected DbRemoteDocument");
        }),
        (ju.prototype.toDbRemoteDocument = function (t, e) {
          ...
          if (t instanceof Vs) {
            ...
            return (
              (o = t.hasCommittedMutations),
              new wu(null, new vu(a, s), null, o, n, r)
            );
          }
          if (t instanceof Qs) {
          ...
          var e,
            ...
            r =
              void 0 !== t.lastLimboFreeSnapshotVersion
                ? this.fromDbTimestamp(t.lastLimboFreeSnapshotVersion)
                : uo.MIN,
            i = t.resumeToken;
          return (
            (e = (function (t) {
      ...
      var Gu =
        ((zu.prototype.nextIndex = function () {
      ...
      var Hu = {
        ...
        Yu =
          ((Xu.withCacheSize = function (t) {
            return new Xu(
              t,
              Xu.DEFAULT_COLLECTION_PERCENTILE,
              Xu.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
            );
          }),
          (Xu.COLLECTION_DISABLED = -1),
          (Xu.MINIMUM_CACHE_SIZE_BYTES = 1048576),
          (Xu.DEFAULT = new Xu(
            (Xu.DEFAULT_CACHE_SIZE_BYTES = 41943040),
            (Xu.DEFAULT_COLLECTION_PERCENTILE = 10),
            (Xu.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
          )),
          (Xu.DISABLED = new Xu(Xu.COLLECTION_DISABLED, 0, 0)),
          Xu);
      function Xu(t, e, n) {
        ...
        ((Zu.prototype.start = function () {
          (Vr(
            ...
            this.garbageCollector.params.cacheSizeCollectionThreshold !==
              Yu.COLLECTION_DISABLED && this.scheduleGC());
        }),
      ...
      var $u =
        ((tc.prototype.calculateTargetCount = function (t, e) {
      ...
      var ec =
        ((nc.prototype.addOnCommittedListener = function (t) {
      ...
      var cc =
        ...
        (hc.prototype.start = function () {
          var e = this;
          return (
            Vr(!this.started, "IndexedDbPersistence double-started!"),
            Vr(null !== this.window, "Expected 'window' to be defined"),
            $o
              .openOrCreate(this.dbName, au, new su(this.serializer))
              .then(function (t) {
                return (
                  (e.simpleDb = t),
                  e.updateClientMetadataAndTryBecomePrimary()
                );
              })
              .then(function () {
                return (
                  e.attachVisibilityHandler(),
                  e.attachWindowUnloadHook(),
                  e.scheduleClientMetadataAndPrimaryLeaseRefreshes(),
                  e.simpleDb.runTransaction(
                    "readonly-idempotent",
                    [Au.store],
                    function (t) {
                      return pa(t);
        ...
        (hc.prototype.setPrimaryStateListener = function (n) {
          var t = this;
          return (
            (this.primaryStateListener = function (e) {
        ...
        (hc.prototype.updateClientMetadataAndTryBecomePrimary = function () {
          ...
          return this.simpleDb.runTransaction("readwrite", qu, function (n) {
            return dc(n)
              ...
              .next(function () {
                if (r.isPrimary)
                  return r.verifyPrimaryLease(n).next(function (t) {
                    t ||
                      ((r.isPrimary = !1),
              ...
              .next(function (t) {
                ...
                return (
                  ...
                  e && !r.isPrimary
                    ? r.releasePrimaryLeaseIfHeld(n)
                    : r.isPrimary
                      ? r.acquireOrExtendPrimaryLease(n)
                      : void 0
                );
              });
          });
            ...
            return p(this, function (t) {
              switch (t.label) {
                        ...
                        this.runTransaction(
                          ...
                          function (t) {
                            ...
                            return e.loadAll().next(function (t) {
                              return (
                                (n = i.filterActiveClients(t, 18e5)),
                ...
                case 1:
                  (t.sent(),
                    r.forEach(function (t) {
                      i.window.localStorage.removeItem(
                        i.zombiedClientLocalStorageKey(t.clientId),
                      );
                    }),
                    (t.label = 2));
                case 2:
        ...
        (hc.prototype.scheduleClientMetadataAndPrimaryLeaseRefreshes =
          function () {
            var t = this;
            this.clientMetadataRefresher = this.queue.enqueueAfterDelay(
              Wi.ClientMetadataRefresh,
              4e3,
              function () {
                return t
        ...
        (hc.prototype.canActAsPrimary = function (e) {
          ...
          return fc(e)
            ...
            .next(function (t) {
              if (
                null !== t &&
                i.isWithinAge(t.leaseTimestampMs, 5e3) &&
                !i.isClientZombied(t.ownerId)
              ) {
                if (i.isLocalClient(t) && i.networkEnabled) return !0;
                if (!i.isLocalClient(t)) {
                  if (!t.allowTabSynchronization)
                    throw new Wr(jr.FAILED_PRECONDITION, ac);
                  return !1;
                }
              }
              return (
                ...
                dc(e)
                  ...
                  .next(function (t) {
                    return (
                      void 0 ===
                      i.filterActiveClients(t, 5e3).find(function (t) {
        ...
        (hc.prototype.filterActiveClients = function (t, e) {
          ...
          return t.filter(function (t) {
            return (
              n.isWithinAge(t.updateTimeMs, e) && !n.isClientZombied(t.clientId)
            );
          });
        }),
              ...
              switch (t.label) {
                case 0:
                  return hc.isAvailable()
                    ? ((e = n + hc.MAIN_DATABASE), [4, $o.delete(e)])
                    : [2, Promise.resolve()];
                case 1:
                  return (t.sent(), [2]);
              }
        ...
        (hc.prototype.runTransaction = function (n, t, r) {
          ...
          return this.simpleDb
            .runTransaction(a, qu, function (e) {
              return (
                (o = new sc(e, i.listenSequence.next())),
                "readwrite-primary" === t ||
                      ...
                      .next(function (t) {
                        if (!t)
                          throw (
                            ...
                            (i.isPrimary = !1),
                            i.queue.enqueueAndForget(function () {
        ...
        (hc.prototype.releasePrimaryLeaseIfHeld = function (t) {
          ...
          return n.get(hu.key).next(function (t) {
            return e.isLocalClient(t)
              ? (Pr(ic, "Releasing primary lease."), n.delete(hu.key))
              : Fo.resolve();
          });
        }),
      ...
      function hc(t, e, n, r, i, o, a, s) {
        if (
          ...
          (this.referenceDelegate = new pc(this, i)),
          (this.dbName = e + hc.MAIN_DATABASE),
          (this.serializer = new Ku(a)),
          (this.document = r.document),
          (this.queryCache = new ha(this.referenceDelegate, this.serializer)),
          (this.indexManager = new Fu()),
          (this.remoteDocumentCache = new Ys(
            this.serializer,
            this.indexManager,
          )),
      ...
      var pc =
        ((mc.prototype.getSequenceNumberCount = function (t) {
        ...
        (mc.prototype.forEachOrphanedDocument = function (t, o) {
          var a,
            ...
            s = Mi.INVALID;
          return e
            .iterate({ index: Du.documentTargetsIndex }, function (t, e) {
              var n = t[0],
                r = (t[1], e.path),
                i = e.sequenceNumber;
              0 === n
                ? (s !== Mi.INVALID && o(new Ki(oo(a)), s), (s = i), (a = r))
                : (s = Mi.INVALID);
            })
            .next(function () {
      ...
      function mc(t, e) {
        ((this.db = t),
          ...
          (this.garbageCollector = new $u(this, e)));
      }
      function yc(t, e) {
        return ma(t).put(
          (function (t, e) {
      ...
      var gc =
        ((vc.prototype.getDocument = function (e, n) {
          var r = this;
        ...
        (vc.prototype.getLocalViewOfDocuments = function (r, i) {
          var o = this;
          return this.mutationQueue
            .getAllMutationBatchesAffectingDocumentKeys(r, i)
            .next(function (t) {
              var e = o.applyLocalMutationsToDocuments(r, i, t),
                n = Io();
              return (
                e.forEach(function (t, e) {
                  ((e = e || new Vs(t, uo.forDeletedDoc())),
                    (n = n.insert(t, e)));
                }),
                n
              );
        ...
        (vc.prototype.getDocumentsMatchingCollectionGroupQuery = function (
          n,
          r,
          i,
        ) {
          ...
          return this.indexManager
            .getCollectionParents(n, a)
            .next(function (t) {
              return Fo.forEach(t, function (t) {
                var e = r.asCollectionQueryAtPath(t.child(a));
                return o
                  .getDocumentsMatchingCollectionQuery(n, e, i)
                  .next(function (t) {
                    t.forEach(function (t, e) {
                      s = s.insert(t, e);
                    });
        ...
        (vc.prototype.getDocumentsMatchingCollectionQuery = function (e, n, t) {
          ...
          return this.remoteDocumentCache
            .getDocumentsMatchingQuery(e, n, t)
            .next(function (t) {
              return (
                (h = t),
                r.mutationQueue.getAllMutationBatchesAffectingQuery(e, n)
              );
            })
            .next(function (t) {
              return (
                (l = t),
                r.addMissingBaseDocuments(e, l, h).next(function (t) {
                  h = t;
      ...
      var bc =
        ...
        wc);
      function wc() {
        ((this.refsByKey = new bo(Sc.compareByKey)),
          (this.refsByTarget = new bo(Sc.compareByTargetId)));
      }
      var Sc =
        ((Tc.compareByKey = function (t, e) {
          return (
            Ki.comparator(t.key, e.key) ||
            bi(t.targetOrBatchId, e.targetOrBatchId)
          );
        }),
      ...
      var Ec = "LocalStore",
        Ic =
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      (e = this.mutationQueue),
                      (y = this.localDocuments),
                      [
                        4,
                        this.persistence.runTransaction(
                          ...
                          function (p) {
                            ...
                            return r.mutationQueue
                              .getAllMutationBatches(p)
                              .next(function (t) {
                                return (
                                  (m = t),
                                  (e = r.persistence.getMutationQueue(i)),
                                  (y = new gc(
                                    r.remoteDocuments,
                                    e,
                                    r.persistence.getIndexManager(),
                                  )),
                                  e.getAllMutationBatches(p)
                                );
                              })
                              .next(function (t) {
                                for (
                                  var e = [], n = [], r = Mo(), i = 0, o = m;
                                  i < o.length;
                                  i++
                                ) {
                                  var a = o[i];
                  ...
                  case 1:
                    return (
                      (n = t.sent()),
                      (this.mutationQueue = e),
                      (this.localDocuments = y),
                      this.queryEngine.setLocalDocumentsView(
                        this.localDocuments,
                      ),
                      [2, n]
                    );
                ...
                function (a) {
                  return c.localDocuments.getDocuments(a, t).next(function (t) {
                    ...
                    for (var e = [], n = 0, r = s; n < r.length; n++) {
                      ...
                      null != o &&
                        e.push(new Ma(i.key, o, o.fieldMask(), Ea.exists(!0)));
                    }
            ...
            return this.persistence.runTransaction(
              ...
              function (t) {
                ...
                return i.mutationQueue
                  .acknowledgeBatch(t, r.batch, r.streamToken)
                  .next(function () {
            ...
            return this.persistence.runTransaction(
              ...
              function (e) {
                ...
                return r.mutationQueue
                  ...
                  .next(function (t) {
                    return (
                      Vr(null !== t, "Attempt to reject nonexistent batch!"),
                      (n = t.keys()),
                ...
                function (o) {
                  ...
                  Xr(u.targetChanges, function (t, e) {
                    ...
                    if (n) {
                      a.push(
                        c.queryCache
                          .removeMatchingKeys(o, e.removedDocuments, t)
                          .next(function () {
                            return c.queryCache.addMatchingKeys(
                              o,
                              e.addedDocuments,
                              t,
                            );
                      ...
                      if (0 < r.length) {
                        var i = n
                          .withResumeToken(r, h)
                          .withSequenceNumber(o.currentSequenceNumber);
                        ((l = l.insert(t, i)),
                          Cc.shouldPersistQueryData(n, i, e) &&
                            a.push(c.queryCache.updateQueryData(o, i)));
                      }
                    }
                  });
                  var s = Io(),
                  ...
                  if (
                    ...
                    a.push(
                      i.getEntries(o, n).next(function (r) {
                        u.documentUpdates.forEach(function (t, e) {
                          var n = r.get(t);
                          (e instanceof Vs && e.version.isEqual(uo.MIN)
                            ? (i.removeEntry(t, h), (s = s.insert(t, e)))
                            : null == n ||
                            ...
                            u.resolvedLimboDocuments.has(t) &&
                              a.push(
                    ...
                    var t = c.queryCache
                      ...
                      .next(function (t) {
                        return (
                          ...
                          c.queryCache.setTargetsMetadata(
                            o,
                            o.currentSequenceNumber,
                            h,
                          )
                        );
                      });
          ...
          (Cc.prototype.notifyLocalViewChanges = function (t) {
            for (var n = this, e = 0, r = t; e < r.length; e++) {
              var i = r[e],
                o = i.targetId;
              if (
                (this.localViewReferences.addReferences(i.addedKeys, o),
                this.localViewReferences.removeReferences(i.removedKeys, o),
                !i.fromCache)
              ) {
          ...
          (Cc.prototype.allocateQuery = function (r) {
            ...
            return this.persistence
              .runTransaction(
                ...
                function (e) {
                  ...
                  return i.queryCache.getQueryData(e, r).next(function (t) {
                    return t
                      ? ((n = t), Fo.resolve(n))
                      : i.queryCache.allocateTargetId(e).next(function (t) {
                          return (
                            (n = new Uu(
                              r,
                              t,
                            ...
                            i.queryCache.addQueryData(e, n).next(function () {
                              return n;
                            })
                          );
                        });
              ...
              .then(function (t) {
                return (
                  Vr(
                    null === i.queryDataByTarget.get(t.targetId),
                    "Tried to allocate an already allocated query: " + r,
                  ),
                  (i.queryDataByTarget = i.queryDataByTarget.insert(
                    t.targetId,
                    t,
                  )),
                  i.targetIdByQuery.set(r, t.targetId),
                  t
                );
              });
          }),
          (Cc.prototype.getQueryData = function (t, e) {
            ...
            return void 0 !== n
              ? Fo.resolve(this.queryDataByTarget.get(n))
              : this.queryCache.getQueryData(t, e);
          }),
          (Cc.prototype.releaseQuery = function (i, o) {
            ...
            return this.persistence
              .runTransaction("Release query", t, function (e) {
                var t = s.targetIdByQuery.get(i);
                (Vr(void 0 !== t, "Tried to release nonexistent query: " + i),
                  (a = t));
                ...
                return o
                  ? Fo.resolve()
                  : Fo.forEach(r, function (t) {
                      return s.persistence.referenceDelegate.removeReference(
                        e,
                        t,
                      );
                    }).next(function () {
              ...
              .then(function () {
                ((s.queryDataByTarget = s.queryDataByTarget.remove(a)),
                  s.targetIdByQuery.delete(i));
              });
          }),
            ...
            return this.persistence.runTransaction(
              ...
              function (e) {
                return r
                  ...
                  .next(function () {
                    return r.queryEngine.getDocumentsMatchingQuery(
                      e,
                      t,
                      n ? i : uo.MIN,
                      n ? o : Mo(),
                  ...
                  .next(function (t) {
                    return { documents: t, remoteKeys: o };
                  });
              },
            );
          }),
                ...
                s = s
                  ...
                  .next(function (t) {
                    ...
                    (Vr(
                      ...
                      (!e || e.version.compareTo(n) < 0) &&
                        ((e = a.applyToRemoteDocument(r, e, i))
                          ? o.addEntry(e, i.commitVersion)
                          : Vr(
                              !t,
                              "Mutation batch " +
                                a +
          ...
          (Cc.prototype.getQueryForTarget = function (e) {
            ...
            return t
              ? Promise.resolve(t.query)
              : this.persistence.runTransaction(
                  "Get query data",
                  "readonly-idempotent",
                  function (t) {
                    return n.queryCache
                      .getQueryDataForTarget(t, e)
                      .next(function (t) {
          ...
          (Cc.prototype.getNewDocumentChanges = function () {
            ...
            return this.persistence
              .runTransaction(
                ...
                "readonly-idempotent",
                function (t) {
                  return r.remoteDocuments.getNewDocumentChanges(
                    t,
                    r.lastDocumentChangeReadTime,
                  );
                },
              )
              .then(function (t) {
          ...
          (Cc.prototype.synchronizeLastDocumentChangeReadTime = function () {
            return d(this, void 0, void 0, function () {
              var e,
                n = this;
              return p(this, function (t) {
                return this.remoteDocuments instanceof Ys
                  ? ((e = this.remoteDocuments),
                    [
                      2,
                      this.persistence
                        .runTransaction(
          ...
          (Cc.RESUME_TOKEN_MAX_AGE_MICROS = 3e8),
          Cc);
      function Cc(t, e, n) {
        ((this.persistence = t),
          (this.queryEngine = e),
          (this.localViewReferences = new bc()),
          (this.queryDataByTarget = new ho(bi)),
          (this.targetIdByQuery = new js(function (t) {
            return t.canonicalId();
          })),
          (this.lastDocumentChangeReadTime = uo.MIN),
          Vr(
            t.started,
      ...
      var Dc =
        ((Nc.prototype.checkEmpty = function (t) {
        ...
        (Nc.prototype.addMutationBatch = function (t, e, n, r) {
          ...
          (this.nextBatchId++,
            0 < this.mutationQueue.length &&
              Vr(
                this.mutationQueue[this.mutationQueue.length - 1].batchId < i,
        ...
        (Nc.prototype.lookupMutationKeys = function (t, e) {
          ...
          return (
            Vr(null != n, "Failed to find local mutation batch."),
            Fo.resolve(n.keys())
          );
        }),
        ...
        (Nc.prototype.getHighestUnacknowledgedBatchId = function () {
          return Fo.resolve(
            0 === this.mutationQueue.length ? -1 : this.nextBatchId - 1,
          );
        }),
        (Nc.prototype.getAllMutationBatches = function (t) {
          return Fo.resolve(this.mutationQueue.slice());
        }),
        (Nc.prototype.getAllMutationBatchesAffectingDocumentKey = function (
          t,
          n,
        ) {
          var r = this,
            ...
            o = [];
          return (
            this.batchesByDocumentKey.forEachInRange([e, i], function (t) {
              Vr(
                n.isEqual(t.key),
        ...
        (Nc.prototype.getAllMutationBatchesAffectingDocumentKeys = function (
          t,
          e,
        ) {
          var r = this,
        ...
        (Nc.prototype.getAllMutationBatchesAffectingQuery = function (t, e) {
          ...
          return (
            this.batchesByDocumentKey.forEachWhile(function (t) {
              ...
              return (
                !!n.isPrefixOf(e) &&
                (e.length === r && (a = a.add(t.targetOrBatchId)), !0)
              );
            }, o),
            Fo.resolve(this.findMutationBatches(a))
          );
        }),
        ...
        (Nc.prototype.removeMutationBatch = function (n, r) {
          var i = this;
          (Vr(
            0 === this.indexOfExistingBatchId(r.batchId, "removed"),
          ...
          return Fo.forEach(r.mutations, function (t) {
            ...
            return (
              (o = o.delete(e)),
              i.referenceDelegate.removeMutationReference(n, t.key)
            );
          }).next(function () {
            i.batchesByDocumentKey = o;
          });
        }),
        (Nc.prototype.removeCachedMutationKeys = function (t) {}),
        (Nc.prototype.containsKey = function (t, e) {
          var n = new Sc(e, 0),
        ...
        (Nc.prototype.indexOfExistingBatchId = function (t, e) {
          ...
          return (
            Vr(
              0 <= n && n < this.mutationQueue.length,
      ...
      function Nc(t, e) {
        ((this.indexManager = t),
          ...
          (this.mutationQueue = []),
          (this.nextBatchId = 1),
          (this.lastStreamToken = Qr()),
          (this.batchesByDocumentKey = new bo(Sc.compareByKey)));
      }
      var Ac =
        ((kc.prototype.getTargetCount = function (t) {
        ...
        (kc.prototype.setTargetsMetadata = function (t, e, n) {
          return (
            ...
            e > this.highestSequenceNumber && (this.highestSequenceNumber = e),
            Fo.resolve()
          );
        }),
        ...
        (kc.prototype.updateQueryData = function (t, e) {
          return (
            Vr(this.queries.has(e.query), "Updating a non-existent query"),
            this.saveQueryData(e),
            Fo.resolve()
          );
        }),
        (kc.prototype.removeQueryData = function (t, e) {
          return (
            Vr(0 < this.targetCount, "Removing a target from an empty cache"),
            Vr(
              this.queries.has(e.query),
          ...
          return (
            this.queries.forEach(function (t, e) {
              e.sequenceNumber <= r &&
                ...
                (o.queries.delete(t),
                s.push(o.removeMatchingKeysForTargetId(n, e.targetId)),
                a++);
            }),
      ...
      function kc(t) {
        ((this.persistence = t),
          (this.queries = new js(function (t) {
            return t.canonicalId();
          })),
          (this.lastRemoteSnapshotVersion = uo.MIN),
          (this.highestTargetId = 0),
          (this.highestSequenceNumber = 0),
          (this.references = new bc()),
          (this.targetCount = 0),
          (this.targetIdGenerator = Xo.forQueryCache()));
      }
      var Rc,
        Mc =
          ((Oc.prototype.addEntry = function (t, e, n) {
            Vr(
              !n.isEqual(uo.MIN),
              "Cannot add a document with a read time of zero",
            );
          ...
          (Oc.prototype.getDocumentsMatchingQuery = function (t, e, n) {
            ...
            for (
              ...
              h.compareTo(n) <= 0 ||
                (c instanceof xs && e.matches(c) && (r = r.insert(c.key, c)));
            }
            return Fo.resolve(r);
          }),
          ...
          (Oc.RemoteDocumentChangeBuffer =
            (t(_c, (Rc = Gs)),
            (_c.prototype.applyChanges = function (n) {
              var r = this,
                i = [];
              return (
                this.changes.forEach(function (t, e) {
                  e
                    ? i.push(r.documentCache.addEntry(n, e, r.readTime))
                    : r.documentCache.removeEntry(t);
                }),
                Fo.waitFor(i)
              );
            }),
      ...
      function Oc(t, e) {
        ((this.indexManager = t),
          (this.sizer = e),
          (this.docs = new ho(Ki.comparator)),
          (this.size = 0));
      }
      function _c(t) {
      ...
      var Lc =
        ((Pc.createLruPersistence = function (t, e, n) {
        ...
        (Pc.prototype.getMutationQueue = function (t) {
          ...
          return (
            e ||
              ((e = new Dc(this.indexManager, this.referenceDelegate)),
      ...
      function Pc(t, e) {
        ...
        ((this.clientId = t),
          (this.mutationQueues = {}),
          (this.listenSequence = new Mi(0)),
          (this._started = !1),
          (this._started = !0),
          (this.referenceDelegate = e(this)),
          (this.queryCache = new Ac(this)));
        ((this.indexManager = new nu()),
          (this.remoteDocumentCache = new Mc(this.indexManager, function (t) {
      ...
      var Vc =
        (Object.defineProperty(Bc.prototype, "orphanedDocuments", {
          get: function () {
      ...
      var Uc =
        ((Qc.prototype.onTransactionStarted = function () {}),
        (Qc.prototype.onTransactionCommitted = function (t) {
          return Fo.resolve();
        }),
        ...
        (Qc.prototype.removeOrphanedDocuments = function (t, n) {
          var r = this,
            ...
            o = e.newChangeBuffer();
          return e
            .forEachDocumentKey(t, function (e) {
      ...
      function Qc(t, e, n) {
        ((this.persistence = t),
          (this.serializer = e),
          (this.inMemoryPins = null),
          (this.orphanedSequenceNumbers = new js(function (t) {
            return no(t.path);
          })),
          (this.garbageCollector = new $u(this, n)));
      }
      var Kc =
        ((jc.prototype.setLocalDocumentsView = function (t) {
          this.localDocumentsView = t;
        }),
        (jc.prototype.getDocumentsMatchingQuery = function (t, e, n, r) {
          return (
            Vr(
              void 0 !== this.localDocumentsView,
              "setLocalDocumentsView() not called",
            ),
            this.localDocumentsView.getDocumentsMatchingQuery(t, e, uo.MIN)
          );
        }),
        jc);
      function jc() {}
      ...
      var $c,
        th,
        eh = "PersistentStream";
      (((th = $c = $c || {})[(th.Initial = 0)] = "Initial"),
        (th[(th.Starting = 1)] = "Starting"),
        (th[(th.Open = 2)] = "Open"),
        (th[(th.Error = 3)] = "Error"),
        (th[(th.Backoff = 4)] = "Backoff"));
      var nh =
        ((rh.prototype.isStarted = function () {
          return (
            this.state === $c.Starting ||
            this.state === $c.Open ||
            this.state === $c.Backoff
          );
        }),
        ...
        (rh.prototype.start = function () {
          this.state !== $c.Error
            ? (Vr(this.state === $c.Initial, "Already started"), this.auth())
            : this.performBackoff();
        }),
        ...
        (rh.prototype.inhibitBackoff = function () {
          (Vr(!this.isStarted(), "Can only inhibit backoff in a stopped state"),
              ...
              switch (t.label) {
                case 0:
                  return (
                    ...
                    e !== $c.Error
                      ? this.backoff.reset()
                      : n && n.code === jr.RESOURCE_EXHAUSTED
                        ? (xr(n.toString()),
                          xr(
        ...
        (rh.prototype.tearDown = function () {}),
        (rh.prototype.auth = function () {
          var n = this;
          (Vr(this.state === $c.Initial, "Must be in initial state to auth"),
            (this.state = $c.Starting));
        ...
        (rh.prototype.handleStreamClose = function (t) {
          return (
            ...
            Pr(eh, "close with error: " + t),
            (this.stream = null),
            this.close($c.Error, t)
          );
        }),
      ...
      function rh(t, e, n, r, i, o) {
        ((this.queue = t),
          ...
          (this.idleTimer = null),
          (this.stream = null),
          (this.backoff = new Jc(t, e)));
      }
      var ih,
        oh =
          (t(ah, (ih = nh)),
          (ah.prototype.startRpc = function (t) {
      ...
      function ah(t, e, n, r, i) {
        var o =
          ih.call(
            this,
            t,
            Wi.ListenStreamConnectionBackoff,
            Wi.ListenStreamIdle,
            e,
            n,
            i,
      ...
      var sh,
        uh =
          (t(ch, (sh = nh)),
          Object.defineProperty(ch.prototype, "handshakeComplete", {
            get: function () {
          ...
          (ch.prototype.writeHandshake = function () {
            (Vr(this.isOpen(), "Writing handshake requires an opened stream"),
              Vr(!this.handshakeComplete_, "Handshake already completed"));
            var t = {};
          ...
          (ch.prototype.writeMutations = function (t) {
            var e = this;
            (Vr(this.isOpen(), "Writing mutations requires an opened stream"),
              Vr(
                this.handshakeComplete_,
                "Handshake must be complete before writing mutations",
              ),
              Vr(
                0 < this.lastStreamToken.length,
      ...
      function ch(t, e, n, r, i) {
        var o =
          sh.call(
            this,
            t,
            Wi.WriteStreamConnectionBackoff,
            Wi.WriteStreamIdle,
            e,
            n,
            i,
        ...
        return (
          (o.serializer = r),
          (o.handshakeComplete_ = !1),
          (o.lastStreamToken = Qr()),
          o
        );
      }
      var hh =
        ((lh.prototype.newPersistentWriteStream = function (t) {
          return new uh(
            this.queue,
            this.connection,
            this.credentials,
        ...
        (lh.prototype.lookup = function (e) {
          ...
          return this.invokeStreamingRPC("BatchGetDocuments", t).then(
            function (t) {
              var n = Io();
              t.forEach(function (t) {
              ...
              return (
                e.forEach(function (t) {
                  var e = n.get(t);
                  (Vr(!!e, "Missing entity in write response for " + t),
                    r.push(e));
                }),
                r
              );
      ...
      var fh,
        ...
        mh,
        yh =
          ((gh.prototype.lookup = function (r) {
            return d(this, void 0, void 0, function () {
              var e,
                n = this;
              return p(this, function (t) {
                  ...
                  case 1:
                    return (
                      (e = t.sent()).forEach(function (t) {
                        t instanceof Vs || t instanceof xs
                          ? n.recordVersion(t)
                          : Fr(
          ...
          (gh.prototype.delete = function (t) {
            (this.write([new Ua(t, this.precondition(t))]),
              this.writtenDocs.add(t));
          }),
      ...
      function gh(t) {
        ((this.datastore = t),
          (this.readVersions = ko()),
          (this.mutations = []),
          (this.committed = !1),
          (this.lastWriteError = null),
          (this.writtenDocs = new Set()));
      }
      (((dh = fh = fh || {})[(dh.Unknown = 0)] = "Unknown"),
        (dh[(dh.Online = 1)] = "Online"),
        (dh[(dh.Offline = 2)] = "Offline"),
        ((mh = ph = ph || {})[(mh.RemoteStore = 0)] = "RemoteStore"),
        (mh[(mh.SharedClientState = 1)] = "SharedClientState"));
      var vh,
        bh,
        wh =
          ((Sh.prototype.handleWatchStreamStart = function () {
            var t = this;
            0 === this.watchStreamFailures &&
              (this.setAndBroadcast(fh.Unknown),
              Vr(
          ...
          (Sh.prototype.handleWatchStreamFailure = function (t) {
            this.state === fh.Online
              ...
              : (this.watchStreamFailures++,
                1 <= this.watchStreamFailures &&
                  (this.clearOnlineStateTimer(),
                  this.logClientOfflineWarningIfNecessary(
                    "Connection failed 1 times. Most recent error: " +
                      t.toString(),
                  ),
                  this.setAndBroadcast(fh.Offline)));
          }),
          (Sh.prototype.set = function (t) {
            (this.clearOnlineStateTimer(),
              (this.watchStreamFailures = 0),
              t === fh.Online && (this.shouldWarnClientIsOffline = !1),
          ...
          (Sh.prototype.logClientOfflineWarningIfNecessary = function (t) {
            ...
            this.shouldWarnClientIsOffline
              ? (xr(e), (this.shouldWarnClientIsOffline = !1))
              : Pr("OnlineStateTracker", e);
          }),
      ...
      (((bh = vh = vh || {})[(bh.OK = 0)] = "OK"),
        (bh[(bh.CANCELLED = 1)] = "CANCELLED"),
        (bh[(bh.UNKNOWN = 2)] = "UNKNOWN"),
        (bh[(bh.INVALID_ARGUMENT = 3)] = "INVALID_ARGUMENT"),
        (bh[(bh.DEADLINE_EXCEEDED = 4)] = "DEADLINE_EXCEEDED"),
        (bh[(bh.NOT_FOUND = 5)] = "NOT_FOUND"),
        (bh[(bh.ALREADY_EXISTS = 6)] = "ALREADY_EXISTS"),
        (bh[(bh.PERMISSION_DENIED = 7)] = "PERMISSION_DENIED"),
        (bh[(bh.UNAUTHENTICATED = 16)] = "UNAUTHENTICATED"),
        (bh[(bh.RESOURCE_EXHAUSTED = 8)] = "RESOURCE_EXHAUSTED"),
        (bh[(bh.FAILED_PRECONDITION = 9)] = "FAILED_PRECONDITION"),
        (bh[(bh.ABORTED = 10)] = "ABORTED"),
        (bh[(bh.OUT_OF_RANGE = 11)] = "OUT_OF_RANGE"),
        (bh[(bh.UNIMPLEMENTED = 12)] = "UNIMPLEMENTED"),
        (bh[(bh.INTERNAL = 13)] = "INTERNAL"),
        (bh[(bh.UNAVAILABLE = 14)] = "UNAVAILABLE"),
        (bh[(bh.DATA_LOSS = 15)] = "DATA_LOSS"));
      var Ih,
        Ch,
        Dh,
        Nh,
        Ah =
          ((kh.emptySet = function (t) {
      ...
      function kh(n) {
        ((this.comparator = n
          ...
          (this.keyedMap = No()),
          (this.sortedSet = new ho(this.comparator)));
      }
      (((Ch = Ih = Ih || {})[(Ch.Added = 0)] = "Added"),
        (Ch[(Ch.Removed = 1)] = "Removed"),
        (Ch[(Ch.Modified = 2)] = "Modified"),
        (Ch[(Ch.Metadata = 3)] = "Metadata"),
        ((Nh = Dh = Dh || {})[(Nh.Local = 0)] = "Local"),
        (Nh[(Nh.Synced = 1)] = "Synced"));
      var Rh =
        ((Mh.prototype.track = function (t) {
          var e = t.doc.key,
            n = this.changeMap.get(e);
          n
            ? t.type !== Ih.Added && n.type === Ih.Metadata
              ? (this.changeMap = this.changeMap.insert(e, t))
              : t.type === Ih.Metadata && n.type !== Ih.Removed
                ? (this.changeMap = this.changeMap.insert(e, {
                    type: n.type,
                    doc: t.doc,
                  }))
                : t.type === Ih.Modified && n.type === Ih.Modified
                  ? (this.changeMap = this.changeMap.insert(e, {
                      type: Ih.Modified,
                      doc: t.doc,
                    }))
                  : t.type === Ih.Modified && n.type === Ih.Added
                    ? (this.changeMap = this.changeMap.insert(e, {
                        type: Ih.Added,
                        doc: t.doc,
                      }))
                    : t.type === Ih.Removed && n.type === Ih.Added
                      ? (this.changeMap = this.changeMap.remove(e))
                      : t.type === Ih.Removed && n.type === Ih.Modified
                        ? (this.changeMap = this.changeMap.insert(e, {
                            type: Ih.Removed,
                            doc: n.doc,
                          }))
                        : t.type === Ih.Added && n.type === Ih.Removed
                          ? (this.changeMap = this.changeMap.insert(e, {
                              type: Ih.Modified,
                              doc: t.doc,
                            }))
        ...
        (Mh.prototype.getChanges = function () {
          var n = [];
          return (
            this.changeMap.inorderTraversal(function (t, e) {
              n.push(e);
            }),
            n
          );
      ...
      var Oh =
        ((_h.fromInitialDocuments = function (t, e, n, r) {
          var i = [];
          return (
            e.forEach(function (t) {
              i.push({ type: Ih.Added, doc: t });
            }),
      ...
      var Lh =
        ((Ph.createSynthesizedRemoteEventForCurrentChange = function (t, e) {
          var n,
            r =
              (((n = {})[t] = xh.createSynthesizedTargetChangeForCurrentChange(
                t,
                e,
              )),
              n);
      ...
      var xh =
        ((qh.createSynthesizedTargetChangeForCurrentChange = function (t, e) {
      ...
      (((Vh = Fh = Fh || {})[(Vh.NoChange = 0)] = "NoChange"),
        (Vh[(Vh.Added = 1)] = "Added"),
        (Vh[(Vh.Removed = 2)] = "Removed"),
        (Vh[(Vh.Current = 3)] = "Current"),
        (Vh[(Vh.Reset = 4)] = "Reset"));
      var Qh = function (t, e, n, r) {
        ...
        Kh =
          (Object.defineProperty(jh.prototype, "current", {
            get: function () {
          ...
          (jh.prototype.toTargetChange = function () {
            var n = Mo(),
              ...
              i = Mo();
            return (
              this.documentChanges.forEach(function (t, e) {
                switch (e) {
                  case Ih.Added:
                    n = n.add(t);
                    break;
      ...
      function jh() {
        ((this.pendingResponses = 0),
          (this.documentChanges = Hh()),
          (this._resumeToken = Qr()),
          (this._current = !1),
          (this._hasPendingChanges = !0));
      }
      var Wh =
        ((Gh.prototype.handleDocumentChange = function (t) {
          for (var e = 0, n = t.updatedTargetIds; e < n.length; e++) {
            var r = n[e];
            t.newDoc instanceof xs
              ? this.addDocumentToTarget(r, t.newDoc)
              : t.newDoc instanceof Vs &&
                this.removeDocumentFromTarget(r, t.key, t.newDoc);
          }
          for (var i = 0, o = t.removedTargetIds; i < o.length; i++)
            ((r = o[i]), this.removeDocumentFromTarget(r, t.key, t.newDoc));
        }),
          ...
          this.forEachTarget(n, function (t) {
            ...
            switch (n.state) {
              case Fh.NoChange:
                ...
                break;
              case Fh.Added:
                (e.recordTargetResponse(),
                  e.isPending || e.clearPendingChanges(),
                  e.updateResumeToken(n.resumeToken));
                break;
              case Fh.Removed:
                (e.recordTargetResponse(),
                  e.isPending || r.removeTarget(t),
                  Vr(
                    !n.cause,
              ...
              case Fh.Current:
                r.isActiveTarget(t) &&
                  (e.markCurrent(), e.updateResumeToken(n.resumeToken));
                break;
              case Fh.Reset:
                r.isActiveTarget(t) &&
                  (r.resetTarget(t), e.updateResumeToken(n.resumeToken));
                break;
              default:
        ...
        (Gh.prototype.createRemoteEvent = function (i) {
          ...
          Xr(this.targetStates, function (t, e) {
            ...
            if (n) {
              if (e.current && n.query.isDocumentQuery()) {
                ...
                null !== o.pendingDocumentUpdates.get(r) ||
                  o.targetContainsDocument(t, r) ||
                  o.removeDocumentFromTarget(t, r, new Vs(r, i));
              }
              e.hasPendingChanges &&
                ((a[t] = e.toTargetChange()), e.clearPendingChanges());
            }
          });
          var r = Mo();
          ...
          return (
            (this.pendingDocumentUpdates = Io()),
            (this.pendingDocumentTargetMapping = zh()),
            (this.pendingTargetResets = new bo(bi)),
            t
          );
        }),
        ...
        (Gh.prototype.removeDocumentFromTarget = function (t, e, n) {
          if (this.isActiveTarget(t)) {
            ...
            (this.targetContainsDocument(t, e)
              ? r.addDocumentChange(e, Ih.Removed)
        ...
        (Gh.prototype.ensureTargetState = function (t) {
          return (
            this.targetStates[t] || (this.targetStates[t] = new Kh()),
            this.targetStates[t]
          );
        }),
        (Gh.prototype.ensureDocumentTargetMapping = function (t) {
          ...
          return (
            e ||
              ((e = new bo(bi)),
              (this.pendingDocumentTargetMapping =
                this.pendingDocumentTargetMapping.insert(t, e))),
            e
          );
        }),
        (Gh.prototype.isActiveTarget = function (t) {
          ...
          return (
            e || Pr("WatchChangeAggregator", "Detected inactive target", t),
            e
          );
        }),
        ...
        (Gh.prototype.resetTarget = function (e) {
          var n = this;
          (Vr(
            !this.targetStates[e].isPending,
            "Should only reset active targets",
          ),
            (this.targetStates[e] = new Kh()),
      ...
      var Yh = "RemoteStore",
        Xh =
                  ...
                  case 1:
                    return (
                      ...
                      this.shouldStartWatchStream()
                        ...
                        : this.onlineStateTracker.set(fh.Unknown),
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      t.sent(),
                      this.onlineStateTracker.set(fh.Offline),
                      [2]
                    );
                }
              });
            ...
            return d(this, void 0, void 0, function () {
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      Pr(Yh, "RemoteStore shutting down."),
                      (this.networkEnabled = !1),
                      [4, this.disableNetworkInternal()]
                    );
                  case 1:
          ...
          (Jh.prototype.listen = function (t) {
            (Vr(
              !Hr(this.listenTargets, t.targetId),
          ...
          (Jh.prototype.startWatchStream = function () {
            (Vr(
              ...
              (this.watchChangeAggregator = new Wh(this)),
          ...
          (Jh.prototype.onWatchStreamOpen = function () {
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                return (
                  Xr(this.listenTargets, function (t, e) {
            ...
            return d(this, void 0, void 0, function () {
              return p(this, function (t) {
                return (
                  ...
                  this.cleanUpWatchStreamState(),
                  this.shouldStartWatchStream()
                    ? (this.onlineStateTracker.handleWatchStreamFailure(e),
                      this.startWatchStream())
                    : this.onlineStateTracker.set(fh.Unknown),
                  [2]
                );
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      this.onlineStateTracker.set(fh.Online),
                      n instanceof Qh && n.state === Fh.Removed && n.cause
                        ? [2, this.handleTargetError(n)]
                        : (n instanceof Bh
                            ? this.watchChangeAggregator.handleDocumentChange(n)
                            : n instanceof Uh
          ...
          (Jh.prototype.raiseWatchSnapshot = function (r) {
            ...
            return (
              Xr(t.targetChanges, function (t, e) {
                if (0 < e.resumeToken.length) {
                  var n = i.listenTargets[t];
                  n &&
                    (i.listenTargets[t] = n.withResumeToken(e.resumeToken, r));
                }
              }),
              t.targetMismatches.forEach(function (t) {
                var e = i.listenTargets[t];
                if (e) {
                  ((i.listenTargets[t] = e.withResumeToken(
                    Qr(),
                    e.snapshotVersion,
                  )),
              ...
              t.targetIds.forEach(function (e) {
                i = i.then(function () {
                  return d(n, void 0, void 0, function () {
                    return p(this, function (t) {
                      return Hr(this.listenTargets, e)
                        ? (delete this.listenTargets[e],
                          this.watchChangeAggregator.removeTarget(e),
                          [2, this.syncEngine.rejectListen(e, r)])
                        : [2];
                    });
                  });
                });
                      ...
                      ? ((e =
                          0 < this.writePipeline.length
                            ? this.writePipeline[this.writePipeline.length - 1]
                                .batchId
                            : -1),
                        [4, this.localStore.nextMutationBatch(e)])
                      : [3, 4];
                  case 1:
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                return (
                  ...
                  n && 0 < this.writePipeline.length
                    ? [
                        2,
                        (this.writeStream.handshakeComplete
                          ? this.handleWriteError(n)
                          : this.handleHandshakeError(n)
                        ).then(function () {
              ...
              return p(this, function (t) {
                return Th(e.code)
                  ? (Pr(
                    ...
                    (this.writeStream.lastStreamToken = Qr()),
                    [2, this.localStore.setLastStreamToken(Qr()).catch(lc)])
                  : [2];
              });
            });
          }),
      ...
      function Jh(t, e, n, r, i) {
        ...
        ((this.localStore = t),
          ...
          this.connectivityMonitor.addCallback(function (t) {
          ...
          (this.onlineStateTracker = new wh(n, r)),
      ...
      var Zh =
        (Object.defineProperty($h.prototype, "latitude", {
          get: function () {
            return this._lat;
          },
          enumerable: !0,
      ...
      function $h(t, e) {
        if (
          (ti("GeoPoint", arguments, 2),
          ri("GeoPoint", "number", 1, t),
          ri("GeoPoint", "number", 2, e),
      ...
      var tl =
        ...
        Object.defineProperty(el.prototype, "orderBy", {
          get: function () {
            if (null === this.memoizedOrderBy) {
              ...
              if (null !== t && null === e)
                t.isKeyField()
                  ? (this.memoizedOrderBy = [kl])
                  : (this.memoizedOrderBy = [new Nl(t), kl]);
              else {
                Vr(
                ...
                for (
                  var n = !(this.memoizedOrderBy = []),
                    r = 0,
                    i = this.explicitOrderBy;
                  r < i.length;
                  r++
                ) {
                  var o = i[r];
        ...
        (el.prototype.canonicalId = function () {
          if (null === this.memoizedCanonicalId) {
            ...
            for (var r = 0, i = this.orderBy; r < i.length; r++)
              ((t += i[r].canonicalId()), (t += ","));
            (Yc(this.limit) || ((t += "|l:"), (t += this.limit)),
              this.startAt &&
        ...
        (el.prototype.toString = function () {
          ...
          return (
            ...
            Yc(this.limit) || (t += ", limit: " + this.limit),
            0 < this.explicitOrderBy.length &&
        ...
        (el.prototype.matches = function (t) {
          return (
            this.matchesPathAndCollectionGroup(t) &&
        ...
        (el.prototype.getFirstOrderByField = function () {
          return 0 < this.explicitOrderBy.length
        ...
        (el.prototype.matchesPathAndCollectionGroup = function (t) {
          var e = t.key.path;
          return null !== this.collectionGroup
            ? t.key.hasCollectionId(this.collectionGroup) &&
                this.path.isPrefixOf(e)
            : Ki.isDocumentKey(this.path)
              ? this.path.isEqual(e)
              : this.path.isImmediateParentOf(e);
        }),
      ...
      var rl =
        ...
        (il.LESS_THAN = new il("<")),
        (il.LESS_THAN_OR_EQUAL = new il("<=")),
        (il.EQUAL = new il("==")),
        (il.GREATER_THAN = new il(">")),
        (il.GREATER_THAN_OR_EQUAL = new il(">=")),
        (il.ARRAY_CONTAINS = new il("array-contains")),
        (il.IN = new il("in")),
        (il.ARRAY_CONTAINS_ANY = new il("array-contains-any")),
        il);
      function il(t) {
        this.name = t;
      }
        ...
        al =
            ...
            if (t.isKeyField())
              return e === rl.IN
                ? (Vr(
                  ...
                  Vr(
                    n.internalValue.every(function (t) {
                ...
                : (Vr(
                  ...
                  Vr(
                    e !== rl.ARRAY_CONTAINS && e !== rl.ARRAY_CONTAINS_ANY,
                    "'" +
                      e.toString() +
            ...
            return e === rl.ARRAY_CONTAINS
              ...
              : e === rl.IN
                ? (Vr(
                  ...
                  new vl(t, n))
                : e === rl.ARRAY_CONTAINS_ANY
                  ? (Vr(
                      n instanceof Ms,
                      "ARRAY_CONTAINS_ANY filter has invalid value: " +
                        n.toString(),
                    ),
                    new Sl(t, n))
                  : new sl(t, e, n);
          ...
          (sl.prototype.isInequality = function () {
            return (
              ...
              [
                rl.LESS_THAN,
                rl.LESS_THAN_OR_EQUAL,
                rl.GREATER_THAN,
                rl.GREATER_THAN_OR_EQUAL,
              ].indexOf(this.op)
            );
          }),
      ...
      var ul,
        cl =
          (t(hl, (ul = al)),
          (hl.prototype.matches = function (t) {
            var e = this.value,
      ...
      var ll,
        fl =
          (t(dl, (ll = al)),
          (dl.prototype.matches = function (e) {
      ...
      var pl,
        ml =
          (t(yl, (pl = al)),
          (yl.prototype.matches = function (t) {
            var e = t.field(this.field);
      ...
      var gl,
        vl =
          (t(bl, (gl = al)),
          (bl.prototype.matches = function (t) {
            var e = this.value,
      ...
      var wl,
        Sl =
          (t(Tl, (wl = al)),
          (Tl.prototype.matches = function (t) {
            var e = this,
              n = t.field(this.field);
            return (
              n instanceof Ms &&
              n.internalValue.some(function (t) {
      ...
      var El =
        ...
        (Il.ASCENDING = new Il("asc")),
        (Il.DESCENDING = new Il("desc")),
        Il);
      function Il(t) {
        this.name = t;
      }
      var Cl =
        ((Dl.prototype.canonicalId = function () {
          for (
      ...
      var Nl =
        ((Al.prototype.compare = function (t, e) {
          var n = this.isKeyOrderBy
            ? xs.compareByKey(t, e)
            : xs.compareByField(this.field, t, e);
          switch (this.dir) {
            case El.ASCENDING:
              return n;
            case El.DESCENDING:
      ...
      var kl = new Nl(Ui.keyField(), El.ASCENDING),
        ...
        Ml =
          ((Ol.prototype.applyToLocalView = function (t, e) {
            return new ys(e, t);
          }),
      ...
      function Ol() {}
      var _l =
        ((Ll.prototype.applyToLocalView = function (t, e) {
          return this.apply(t);
        }),
      ...
      var Pl =
        ((xl.prototype.applyToLocalView = function (t, e) {
          return this.apply(t);
        }),
      ...
      var ql =
        ((Fl.prototype.applyToLocalView = function (t, e) {
      ...
      var Bl =
        ((Ul.prototype.isEqual = function (t) {
      ...
      var Ql,
        Kl,
        jl =
          (((Ql = {})[El.ASCENDING.name] = "ASCENDING"),
          (Ql[El.DESCENDING.name] = "DESCENDING"),
          Ql),
        Wl =
          (((Kl = {})[rl.LESS_THAN.name] = "LESS_THAN"),
          (Kl[rl.LESS_THAN_OR_EQUAL.name] = "LESS_THAN_OR_EQUAL"),
          (Kl[rl.GREATER_THAN.name] = "GREATER_THAN"),
          (Kl[rl.GREATER_THAN_OR_EQUAL.name] = "GREATER_THAN_OR_EQUAL"),
          (Kl[rl.EQUAL.name] = "EQUAL"),
          (Kl[rl.ARRAY_CONTAINS.name] = "ARRAY_CONTAINS"),
          (Kl[rl.IN.name] = "IN"),
          (Kl[rl.ARRAY_CONTAINS_ANY.name] = "ARRAY_CONTAINS_ANY"),
          Kl),
      ...
      var Yl =
        ((Xl.prototype.emptyByteString = function () {
        ...
        (Xl.prototype.toInt32Value = function (t) {
          return this.options.useProto3Json || Yc(t) ? t : { value: t };
        }),
        ...
        (Xl.prototype.fromVersion = function (t) {
          return (
            Vr(!!t, "Trying to deserialize version that isn't set"),
            uo.fromTimestamp(this.fromTimestamp(t))
          );
        }),
        ...
        (Xl.prototype.fromName = function (t) {
          ...
          return (
            ...
            new Ki(this.extractLocalPathFromResourceName(e))
          );
        }),
        ...
        (Xl.prototype.toValue = function (t) {
          if (t instanceof Ha) return { nullValue: "NULL_VALUE" };
          if (t instanceof Ja) return { booleanValue: t.value() };
          if (t instanceof is) return { integerValue: "" + t.value() };
          if (t instanceof ss) {
            var e = t.value();
        ...
        (Xl.prototype.fromValue = function (t) {
          ...
          if ("timestampValue" in t)
            return (
              zl(t.timestampValue, "timestampValue"),
              new ds(this.fromTimestamp(t.timestampValue))
            );
        ...
        (Xl.prototype.fromFound = function (t) {
          ...
          (Vr(
            ...
            zl(t.found.name, "doc.found.name"),
            zl(t.found.updateTime, "doc.found.updateTime"));
        ...
        (Xl.prototype.fromMaybeDocument = function (t) {
          return "found" in t
            ...
            : "missing" in t
              ? this.fromMissing(t)
              : Fr("invalid batch get response: " + JSON.stringify(t));
        }),
        ...
        (Xl.prototype.fromWatchChange = function (t) {
          ...
          if ("targetChange" in t) {
            ...
            (zl(t.documentChange, "documentChange"),
              zl(t.documentChange.document, "documentChange.name"),
              zl(
            ...
            (zl(t.documentDelete, "documentDelete"),
              zl(t.documentDelete.document, "documentDelete.document"));
            var p = t.documentDelete;
            ((c = this.fromName(p.document)),
              (h = p.readTime
                ? this.fromVersion(p.readTime)
                : uo.forDeletedDoc()),
              (l = new Vs(c, h)),
              (d = p.removedTargetIds || []),
              (e = new Bh([], d, l.key, l)));
          } else if ("documentRemove" in t) {
            (zl(t.documentRemove, "documentRemove"),
              zl(t.documentRemove.document, "documentRemove"));
            var m = t.documentRemove;
            ((c = this.fromName(m.document)),
              (d = m.removedTargetIds || []),
              (e = new Bh([], d, c, null)));
          } else {
            if (!("filter" in t))
              return Fr("Unknown change type " + JSON.stringify(t));
            ...
            : "ADD" === t
              ...
              : "REMOVE" === t
                ...
                : "CURRENT" === t
                  ...
                  : "RESET" === t
                    ? Fh.Reset
                    : Fr("Got unexpected TargetChange.state: " + t);
        }),
        ...
        (Xl.prototype.toMutation = function (t) {
          ...
          if (t instanceof Aa)
          ...
          else if (t instanceof Ua) e = { delete: this.toName(t.key) };
            ...
            if (!(t instanceof La))
              return Fr("Unknown mutation type " + t.type);
            e = {
              transform: {
                document: this.toName(t.key),
        ...
        (Xl.prototype.toPrecondition = function (t) {
          return (
            Vr(!t.isNone, "Can't serialize an empty precondition"),
            void 0 !== t.updateTime
        ...
        (Xl.prototype.fromPrecondition = function (t) {
          return void 0 !== t.updateTime
            ? Ea.updateTime(this.fromVersion(t.updateTime))
            : void 0 !== t.exists
              ? Ea.exists(t.exists)
              : Ea.NONE;
        }),
        ...
        (Xl.prototype.fromQueryTarget = function (t) {
          ...
          var h = null;
          return (
            n.endAt && (h = this.fromCursor(n.endAt)),
            new tl(e, i, s, a, u, c, h)
          );
        }),
          ...
          if (0 !== t.length) {
            var n = t.map(function (t) {
              return t instanceof al
                ? e.toUnaryOrFieldFilter(t)
                : Fr("Unrecognized filter: " + JSON.stringify(t));
            });
            return 1 === n.length
              ? n[0]
        ...
        (Xl.prototype.toUnaryOrFieldFilter = function (t) {
          if (t.op === rl.EQUAL) {
            ...
            if (t.value.isEqual(Ha.INSTANCE))
              return {
                unaryFilter: {
                  field: this.toFieldPathReference(t.field),
                  op: "IS_NULL",
      ...
      var Jl = function () {
        ...
        Zl =
          (($l.prototype.listen = function (t) {
            var e = t.query,
              n = !1,
              r = this.queries.get(e);
            return (
              r || ((n = !0), (r = new Jl()), this.queries.set(e, r)),
              r.listeners.push(t),
              Vr(
          ...
          ($l.prototype.onWatchChange = function (t) {
            for (var e = !1, n = 0, r = t; n < r.length; n++) {
              ...
              if (a) {
                for (var s = 0, u = a.listeners; s < u.length; s++)
                  u[s].onViewSnapshot(i) && (e = !0);
                a.viewSnap = i;
              }
            }
          ...
          ($l.prototype.onOnlineStateChange = function (i) {
            ...
            (this.queries.forEach(function (t, e) {
              for (var n = 0, r = e.listeners; n < r.length; n++)
                r[n].applyOnlineStateChange(i) && (o = !0);
            }),
      ...
      function $l(t) {
        ((this.syncEngine = t),
          ...
          (this.onlineState = fh.Unknown),
          (this.snapshotsInSyncListeners = new Set()),
          this.syncEngine.subscribe(this));
      }
      var tf =
        ((ef.prototype.onViewSnapshot = function (t) {
          if (
            (Vr(
              0 < t.docChanges.length || t.syncStateChanged,
          ...
          return (
            this.raisedInitialEvent
              ? this.shouldRaiseEvent(t) &&
                (this.queryObserver.next(t), (o = !0))
              : this.shouldRaiseInitialEvent(t, this.onlineState) &&
                (this.raiseInitialEvent(t), (o = !0)),
            (this.snap = t),
            o
          );
        }),
        ...
        (ef.prototype.applyOnlineStateChange = function (t) {
          ...
          return (
            this.snap &&
              ...
              (this.raiseInitialEvent(this.snap), (e = !0)),
            e
          );
        }),
      ...
      var nf =
        ((rf.fromSnapshot = function (t, e) {
          for (
            var n = Mo(), r = Mo(), i = 0, o = e.docChanges;
            i < o.length;
            i++
          ) {
            var a = o[i];
      ...
      var of = function (t) {
        ...
        sf =
          (Object.defineProperty(uf.prototype, "syncedDocuments", {
            get: function () {
          ...
          (uf.prototype.computeDocChanges = function (t, e) {
            var s = this,
              ...
              f = !1,
              d =
                this.query.hasLimit() && c.size === this.query.limit
                  ? c.last()
                  : null;
            if (
              (t.inorderTraversal(function (t, e) {
                ...
                (n && r
                  ? n.data().isEqual(r.data())
                    ? i !== o &&
                      (u.track({ type: Ih.Metadata, doc: r }), (a = !0))
                    : s.shouldWaitForSyncedDocument(n, r) ||
                      (u.track({ type: Ih.Modified, doc: r }),
                      (a = !0),
                      d && 0 < s.query.docComparator(r, d) && (f = !0))
                  : !n && r
                    ? (u.track({ type: Ih.Added, doc: r }), (a = !0))
                    : n &&
                      !r &&
                      (u.track({ type: Ih.Removed, doc: n }),
                      (a = !0),
                      d && (f = !0)),
                  a &&
                    (h = r
                      ? ((l = l.add(r)), o ? h.add(t) : h.delete(t))
                      : ((l = l.delete(t)), h.delete(t))));
              }),
              this.query.hasLimit())
            )
            ...
            return (
              ...
              { documentSet: l, changeSet: u, needsRefill: f, mutatedKeys: h }
            );
          }),
          ...
          (uf.prototype.applyOnlineStateChange = function (t) {
            return this.current && t === fh.Offline
              ? ((this.current = !1),
                this.applyChanges(
                  {
      ...
      function uf(t, e) {
        ((this.query = t),
          ...
          (this.limboDocuments = Mo()),
          (this.mutatedKeys = Mo()),
          (this.documentSet = new Ah(t.docComparator.bind(t))));
      }
      var cf =
        ...
        (hf.prototype.runWithBackOff = function () {
          ...
          this.backoff.backoffAndRun(function () {
            return d(t, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                return (
                  (e = this.remoteStore.createTransaction()),
                  (n = this.tryRunUpdateFunction(e)) &&
                    n
                      .then(function (t) {
        ...
        (hf.prototype.handleTransactionError = function (t) {
          var e = this;
          0 < this.retries && this.isRetryableTransactionError(t)
            ? ((this.retries -= 1),
              this.asyncQueue.enqueueAndForget(function () {
      ...
      function hf(t, e, n, r) {
        ((this.asyncQueue = t),
          ...
          (this.deferred = r),
          (this.retries = 5),
          (this.backoff = new Jc(this.asyncQueue, Wi.RetryTransaction)));
      }
      var lf = "SyncEngine",
        ff = function (t, e, n) {
        ...
        pf =
          (Object.defineProperty(mf.prototype, "isPrimaryClient", {
            get: function () {
          ...
          (mf.prototype.subscribe = function (t) {
            (Vr(null !== t, "SyncEngine listener cannot be null"),
              Vr(
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      (r = this.queryViewsByQuery.get(a))
                        ? ((e = r.targetId),
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      (e = u.query),
                      [4, this.localStore.executeQuery(e, !0)]
                    );
                  case 1:
                    return (
                      (n = t.sent()),
                      (r = new sf(e, n.remoteKeys)),
                      (i = r.computeDocChanges(n.documents)),
                      (o = xh.createSynthesizedTargetChangeForCurrentChange(
                        u.targetId,
                        c && this.onlineState !== fh.Offline,
                      )),
                      Vr(
                        0 ===
                          (a = r.applyChanges(i, !0 === this.isPrimary, o))
                            .limboChanges.length,
                      ...
                      (s = new ff(e, u.targetId, r)),
                      this.queryViewsByQuery.set(e, s),
                      (this.queryViewsByTarget[u.targetId] = s),
                      [2, a.snapshot]
                    );
                }
              });
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      (e = t.sent()),
                      (n = r.view.synchronizeWithPersistedState(e)),
                      this.isPrimary &&
                        this.updateTrackedLimbos(r.targetId, n.limboChanges),
                      [2, n]
                    );
                }
              });
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      Vr(
                        !!(e = this.queryViewsByQuery.get(r)),
                        "Trying to unlisten on query not found:" + r,
                      ),
                      this.isPrimary
                  ...
                  case 3:
                    return (
                      ...
                      [4, this.localStore.releaseQuery(r, !0)]
                    );
                  case 4:
                    (t.sent(), (t.label = 5));
                  case 5:
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      [4, this.localStore.localWrite(n)]
                    );
                  case 1:
                    return (
                      (e = t.sent()),
                      this.sharedClientState.addPendingMutation(e.batchId),
                      this.addMutationCallback(e.batchId, r),
                      [4, this.emitNewSnapsAndNotifyLocalStore(e.changes)]
                    );
                  case 2:
                    return (
                      t.sent(),
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      t.trys.push([1, 4, , 6]),
                      [4, this.localStore.applyRemoteEvent(n)]
                    );
                  case 2:
                    return (
                      (e = t.sent()),
                      Jr(n.targetChanges, function (t, e) {
                        ...
                        n &&
                          ...
                          0 < e.addedDocuments.size
                            ? (n.receivedDocument = !0)
                            : 0 < e.modifiedDocuments.size
                              ? Vr(
                                  n.receivedDocument,
                                  "Received change for limbo target document without add.",
                                )
                              : 0 < e.removedDocuments.size &&
                                (Vr(
                                  n.receivedDocument,
                                  "Received remove for limbo target document without add.",
                                ),
                                (n.receivedDocument = !1)));
                      }),
          ...
          (mf.prototype.applyOnlineStateChange = function (r, t) {
            if (
              (this.isPrimary && t === ph.RemoteStore) ||
              (!this.isPrimary && t === ph.SharedClientState)
            ) {
              ...
              (this.queryViewsByQuery.forEach(function (t, e) {
                ...
                (Vr(
                  0 === n.limboChanges.length,
                  "OnlineState should not affect limbo documents.",
                ),
                  n.snapshot && i.push(n.snapshot));
              }),
                this.syncEngineListener.onOnlineStateChange(r),
                this.syncEngineListener.onWatchChange(i),
                (this.onlineState = r),
                this.isPrimary && this.sharedClientState.setOnlineState(r));
            }
          }),
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      this.sharedClientState.updateQueryState(u, "rejected", c),
                      (e = this.limboResolutionsByTarget[u]),
                      (n = e && e.key)
                        ? ((this.limboTargetsByKey =
                            this.limboTargetsByKey.remove(n)),
                          delete this.limboResolutionsByTarget[u],
                          (r = (r = new ho(Ki.comparator)).insert(
                            n,
                            new Vs(n, uo.forDeletedDoc()),
                          )),
                          (i = Mo().add(n)),
                          (o = new Lh(uo.MIN, {}, new bo(bi), r, i)),
                          [2, this.applyRemoteEvent(o)])
                        : [3, 1]
                    );
                  case 1:
                    return (
                      Vr(
                        !!(a = this.queryViewsByTarget[u]),
                        "Unknown targetId: " + u,
                      ),
                      [
                        4,
                  ...
                  case 2:
                    (t.sent(),
                      this.syncEngineListener.onWatchError(a.query, c),
                      (t.label = 3));
                  case 3:
                    return [2];
                }
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      [4, this.localStore.lookupMutationDocuments(n)]
                    );
                  case 1:
                    return null === (e = t.sent())
                      ? (Pr(lf, "Cannot apply mutation batch with id: " + n),
                        [2])
                      : "pending" !== r
                        ? [3, 3]
                        : [4, this.remoteStore.fillWritePipeline()];
                  ...
                  case 3:
                    ("acknowledged" === r || "rejected" === r
                      ? (this.processUserCallback(n, i || null),
                        this.localStore.removeCachedMutationBatchMetadata(n))
                      : Fr("Unknown batchState: " + r),
                      (t.label = 4));
                  case 4:
                ...
                switch (t.label) {
                  case 0:
                    (this.assertSubscribed("applySuccessfulWrite()"),
                      (e = r.batch.batchId),
                      this.processUserCallback(e, null),
                      this.triggerPendingWritesCallbacks(e),
                      (t.label = 1));
                  case 1:
                    return (
                      t.trys.push([1, 4, , 6]),
                      [4, this.localStore.acknowledgeBatch(r)]
                    );
                  case 2:
                    return (
                      (n = t.sent()),
                      ...
                      [4, this.emitNewSnapsAndNotifyLocalStore(n)]
                    );
                  case 3:
                    return (t.sent(), [3, 6]);
                  case 4:
                ...
                switch (t.label) {
                  case 0:
                    (this.assertSubscribed("rejectFailedWrite()"),
                      this.processUserCallback(n, r),
                      this.triggerPendingWritesCallbacks(n),
                      (t.label = 1));
                  case 1:
                    return (
                      t.trys.push([1, 4, , 6]),
                      [4, this.localStore.rejectBatch(n)]
                    );
                  case 2:
                    return (
                      (e = t.sent()),
                      ...
                      [4, this.emitNewSnapsAndNotifyLocalStore(e)]
                    );
                  case 3:
                    return (t.sent(), [3, 6]);
                  case 4:
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      this.remoteStore.canUseNetwork() ||
                        Pr(
                          lf,
                          "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.",
                        ),
                      [4, this.localStore.getHighestUnacknowledgedBatchId()]
                    );
                  case 1:
                    return (
                      -1 === (e = t.sent())
                        ? r.resolve()
                        : ((n = this.pendingWritesCallbacks.get(e) || []).push(
                            r,
                          ),
                          this.pendingWritesCallbacks.set(e, n)),
                      [2]
                    );
                }
              });
          ...
          (mf.prototype.trackLimboChange = function (t) {
            ...
            if (!this.limboTargetsByKey.get(e)) {
              ...
              var n = this.limboTargetIdGenerator.next(),
                r = tl.atPath(e.path);
              ((this.limboResolutionsByTarget[n] = new df(e)),
                this.remoteStore.listen(
                  new Uu(r, n, Pu.LimboResolution, Mi.INVALID),
                ),
                ...
                switch (t.label) {
                  case 0:
                    return (
                      ...
                      (a = []),
                      (e = []),
                      this.queryViewsByQuery.forEach(function (t, i) {
                        e.push(
                          Promise.resolve()
                            .then(function () {
                              var n = i.view.computeDocChanges(r);
                              return n.needsRefill
                                ? s.localStore
                                    .executeQuery(i.query, !1)
                                    .then(function (t) {
                                      var e = t.documents;
                  ...
                  case 1:
                    return (
                      t.sent(),
                      this.syncEngineListener.onWatchChange(o),
                      [4, this.localStore.notifyLocalViewChanges(a)]
                    );
                  case 2:
                    return (t.sent(), [2]);
                }
                    ...
                    return (
                      ...
                      e
                        ? (this.rejectOutstandingPendingWritesCallbacks(
                          ...
                          [4, this.localStore.handleUserChange(r)])
                        : [3, 3]
                    );
                  case 1:
                    return (
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 2:
                    ...
                    return [3, 7];
                  case 3:
                    return !1 !== c || !1 === this.isPrimary
                      ? [3, 7]
                      : ((this.isPrimary = !1),
                        (a = []),
                        (s = Promise.resolve()),
                        Xr(this.queryViewsByTarget, function (t, e) {
                  ...
                  case 4:
                    return (
                      t.sent(),
                      [4, this.synchronizeQueryViewsAndRaiseSnapshots(a)]
                    );
                  case 5:
                    return (
                      t.sent(),
          ...
          (mf.prototype.resetLimboDocuments = function () {
            ...
            (Xr(this.limboResolutionsByTarget, function (t) {
              ...
              (this.limboTargetsByKey = new ho(Ki.comparator)));
          }),
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return r < i.length
                      ? ((o = i[r]),
                        (a = void 0),
                        (s = this.queryViewsByTarget[o])
                          ? [4, this.localStore.releaseQuery(s.query, !0)]
                          : [3, 5])
                      : [3, 11];
                  case 2:
                    return (
                      t.sent(),
                      [4, this.localStore.allocateQuery(s.query)]
                    );
                  case 3:
                    return (
                      (a = t.sent()),
                      [4, this.synchronizeViewAndComputeSnapshot(s)]
                    );
                  case 4:
                    return (
                      (u = t.sent()).snapshot && n.push(u.snapshot),
                      [3, 9]
                    );
                  case 5:
                    return (
                      ...
                      [4, this.localStore.getQueryForTarget(o)]
                    );
                  case 6:
                    return (
                      Vr(
                        !!(c = t.sent()),
                        "Query data for target " + o + " not found",
                      ),
                      [4, this.localStore.allocateQuery(c)]
                    );
                  case 7:
                    return (
                      (a = t.sent()),
                      [4, this.initializeViewAndComputeSnapshot(a, !1)]
                    );
                  case 8:
                    (t.sent(), (t.label = 9));
                  case 9:
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    if (this.isPrimary)
                      return (
                        Pr(lf, "Ignoring unexpected query state notification."),
                        [2]
                      );
                  ...
                  case 2:
                    return (
                      (e = t.sent()),
                      (n = Lh.createSynthesizedRemoteEventForCurrentChange(
                        i,
                        "current" === o,
                      )),
                      [4, this.emitNewSnapsAndNotifyLocalStore(e, n)]
                  ...
                  case 5:
                    return (
                      t.sent(),
                      this.syncEngineListener.onWatchError(r.query, a),
                      [3, 7]
                    );
                  case 6:
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return e < n.length
                      ? ((c = n[e]),
                        Vr(
                          !this.queryViewsByTarget[c],
                          "Trying to add an already active target",
                        ),
                        [4, this.localStore.getQueryForTarget(c)])
                      : [3, 6];
                  case 2:
                    return (
                      Vr(
                        !!(r = t.sent()),
                        "Query data for active target " + c + " not found",
                      ),
                      [4, this.localStore.allocateQuery(r)]
                    );
                  case 3:
                    return (
                      (i = t.sent()),
                      [4, this.initializeViewAndComputeSnapshot(i, !1)]
                    );
                  case 4:
                  ...
                  case 6:
                    ((o = function (e) {
                      ...
                      return p(this, function (t) {
                        switch (t.label) {
                          case 0:
                            return (n = a.queryViewsByTarget[e])
                              ? [
                                  4,
                                  a.localStore
                                    .releaseQuery(n.query, !1)
                                    .then(function () {
                                      (h.remoteStore.unlisten(e),
                                        h.removeAndCleanupQuery(n));
                                    })
                                    .catch(lc),
                                ]
                              : [3, 2];
      ...
      function mf(t, e, n, r) {
        ((this.localStore = t),
          ...
          (this.queryViewsByQuery = new js(function (t) {
            return t.canonicalId();
          })),
          (this.queryViewsByTarget = {}),
          (this.limboTargetsByKey = new ho(Ki.comparator)),
          (this.limboResolutionsByTarget = {}),
          (this.limboDocumentRefs = new bc()),
          (this.mutationUserCallbacks = {}),
          (this.pendingWritesCallbacks = new Map()),
          (this.limboTargetIdGenerator = Xo.forSyncEngine()),
          (this.isPrimary = void 0),
          (this.onlineState = fh.Unknown));
      }
      var yf =
        ((gf.prototype.isAuthenticated = function () {
        ...
        (gf.UNAUTHENTICATED = new gf(null)),
        (gf.GOOGLE_CREDENTIALS = new gf("google-credentials-uid")),
        (gf.FIRST_PARTY = new gf("first-party-uid")),
        gf);
      function gf(t) {
        this.uid = t;
      }
      var vf = "SharedClientState",
        ...
        Tf =
          ((Ef.fromWebStorageEntry = function (t, e, n) {
            var r = JSON.parse(n),
              i =
                "object" == typeof r &&
                -1 !==
      ...
      var If =
        ((Cf.fromWebStorageEntry = function (t, e) {
          var n = JSON.parse(e),
            r =
              "object" == typeof n &&
      ...
      var Df =
        ((Nf.fromWebStorageEntry = function (t, e) {
          for (
            var n = JSON.parse(e),
            ...
            ((r = Xc(n.activeTargetIds[o])), (i = i.add(n.activeTargetIds[o])));
          return r
            ? new Nf(t, i)
            : (xr(
                vf,
      ...
      var Af =
        ((kf.fromWebStorageEntry = function (t) {
          var e = JSON.parse(t);
          return "object" == typeof e &&
            e.onlineState in fh &&
            "string" == typeof e.clientId
            ? new kf(e.clientId, fh[e.onlineState])
            : (xr(vf, "Failed to parse online state: " + t), null);
        }),
        kf);
      function kf(t, e) {
      ...
      var Rf =
        ((Mf.prototype.addQueryTarget = function (t) {
          (Vr(
      ...
      var Of =
              ...
              switch (t.label) {
                ...
                case 1:
                  for (e = t.sent(), n = 0, r = e; n < r.length; n++)
                    (i = r[n]) !== this.localClientId &&
                      (o = this.getItem(this.toWebStorageClientStateKey(i))) &&
                      (a = Df.fromWebStorageEntry(i, o)) &&
                      (this.activeClients[a.clientId] = a);
                  for (
        ...
        (_f.prototype.getAllActiveQueryTargets = function () {
          var n = _o();
          return (
            Jr(this.activeClients, function (t, e) {
        ...
        (_f.prototype.handleWebStorageEvent = function (s) {
          ...
          if (s.storageArea === this.storage) {
            if (
              (Pr(vf, "EVENT", s.key, s.newValue),
              s.key === this.localClientStorageKey)
            )
              return void xr(
              ...
              return d(t, void 0, void 0, function () {
                ...
                return p(this, function (t) {
                  ...
                  if (this.clientStateKeyRe.test(s.key)) {
                    if (null == s.newValue)
                      return (
                        (n = this.fromWebStorageClientStateKey(s.key)),
                        [2, this.handleClientStateEvent(n, null)]
                      );
                    if ((e = this.fromWebStorageClientState(s.key, s.newValue)))
                    ...
                    if (
                      null !== s.newValue &&
                      (o = this.fromWebStorageOnlineState(s.newValue))
                    )
                      return [2, this.handleOnlineStateEvent(o)];
                  } else
                    s.key === this.sequenceNumberKey &&
                      (Vr(
        ...
        (_f.prototype.persistOnlineState = function (t) {
          var e = { clientId: this.localClientId, onlineState: fh[t] };
        ...
        (_f.prototype.fromWebStorageClientState = function (t, e) {
          ...
          return (
            Vr(null !== n, "Cannot parse client state key '" + t + "'"),
            Df.fromWebStorageEntry(n, e)
          );
        }),
      ...
      function _f(t, e, n, r, i) {
        ...
        ((this.storage = this.platform.window.localStorage),
          ...
          (this.sequenceNumberKey = "firestore_sequence_number_" + n),
          (this.activeClients[this.localClientId] = new Rf()),
          ...
          (this.queryTargetKeyRe = new RegExp("^" + Sf + "_" + o + "_(\\d+)$")),
          (this.onlineStateKey = "firestore_online_state_" + n),
          this.platform.window.addEventListener(
            "storage",
            this.storageListener,
          ));
      ...
      var Lf =
        ((Pf.prototype.addPendingMutation = function (t) {}),
        (Pf.prototype.updateMutationState = function (t, e, n) {}),
        (Pf.prototype.addLocalQueryTarget = function (t) {
          return (
        ...
        (Pf.prototype.handleUserChange = function (t, e, n) {}),
        (Pf.prototype.setOnlineState = function (t) {}),
        (Pf.prototype.shutdown = function () {}),
        (Pf.prototype.writeSequenceNumber = function (t) {}),
        Pf);
      function Pf() {
        ((this.localState = new Rf()),
          (this.queryState = {}),
          (this.syncEngine = null),
          (this.onlineStateHandler = null),
          (this.sequenceNumberHandler = null));
      ...
      var xf = "FirestoreClient",
        qf =
          ((Ff.prototype.lruParams = function () {
        ...
        Bf =
          ((Uf.prototype.start = function (t) {
            ...
            var r = new zi(),
              ...
              o = !1;
            return (
              this.credentials.setChangeListener(function (e) {
                o
          ...
          (Uf.prototype.canFallback = function (t) {
            return t instanceof Wr
              ? t.code === jr.FAILED_PRECONDITION || t.code === jr.UNIMPLEMENTED
              : !(
                  "undefined" != typeof DOMException &&
                  t instanceof DOMException
                ) ||
          ...
          (Uf.prototype.startIndexedDbPersistence = function (r, i) {
            var t = this,
              ...
              a = new Yl(this.databaseInfo.databaseId, { useProto3Json: !0 });
            return Promise.resolve().then(function () {
              return d(t, void 0, void 0, function () {
                ...
                return p(this, function (t) {
                  switch (t.label) {
                    case 0:
                      if (i.synchronizeTabs && !Of.isAvailable(this.platform))
                        throw new Wr(
                          jr.UNIMPLEMENTED,
                          "IndexedDB persistence is only available on platforms that support LocalStorage.",
                        );
                      return (
                        (e = i.lruParams()),
                        (this.sharedClientState = i.synchronizeTabs
                          ? new Of(
                              this.asyncQueue,
                              this.platform,
                              o,
                    ...
                    case 1:
                      return (
                        ...
                        [
                          2,
                          (this.persistence = n).referenceDelegate
                            .garbageCollector,
                        ]
                      );
                  }
          ...
          (Uf.prototype.startMemoryPersistence = function () {
            return (
              (this.persistence = Lc.createEagerPersistence(this.clientId)),
              (this.sharedClientState = new Lf()),
                    ...
                    return p(this, function (t) {
                      switch (t.label) {
                        case 0:
                          return (
                            (e = new Kc()),
                            (this.localStore = new Ic(this.persistence, e, c)),
                            [4, this.localStore.start()]
                          );
                        case 1:
                          return (
                            t.sent(),
                            h &&
                              (this.lruScheduler = new Ju(
                                h,
                                this.asyncQueue,
                                this.localStore,
                              )),
                            (n = this.platform.newConnectivityMonitor()),
                            (r = this.platform.newSerializer(
                            ...
                            (a = function (t) {
                              return s.syncEngine.applyOnlineStateChange(
                                t,
                                ph.SharedClientState,
                              );
                            }),
                            (this.remoteStore = new Xh(
                              this.localStore,
                              i,
                              this.asyncQueue,
                              o,
                            ...
                            (this.syncEngine = new pf(
                              this.localStore,
                              this.remoteStore,
                              this.sharedClientState,
                              c,
                            )),
                            (this.sharedClientState.onlineStateHandler = a),
                            (this.remoteStore.syncEngine = this.syncEngine),
                            (this.sharedClientState.syncEngine =
                              this.syncEngine),
                            (this.eventMgr = new Zl(this.syncEngine)),
                        ...
                        case 3:
                          return (
                            ...
                            [
                              4,
                              this.persistence.setPrimaryStateListener(
                                function (e) {
          ...
          (Uf.prototype.handleCredentialChange = function (t) {
            return (
              ...
              Pr(xf, "Credential Changed. Current user: " + t.uid),
                  ...
                  return p(this, function (t) {
                    switch (t.label) {
                      ...
                      case 1:
                        return (
                          (e = t.sent()),
                          (n = new sf(i, e.remoteKeys)),
                          (r = n.computeDocChanges(e.documents)),
                          [2, n.applyChanges(r, !1).snapshot]
                        );
                    }
                  });
                });
          ...
          (Uf.prototype.addSnapshotsInSyncListener = function (t) {
            ...
            (this.verifyNotTerminated(),
              this.asyncQueue.enqueueAndForget(function () {
                return (
                  e.eventMgr.addSnapshotsInSyncListener(t),
                  Promise.resolve()
                );
              }));
          }),
          (Uf.prototype.removeSnapshotsInSyncListener = function (t) {
            this.clientTerminated ||
              this.eventMgr.removeSnapshotsInSyncListener(t);
          }),
          ...
          (Uf.prototype.transaction = function (t) {
            ...
            return (
              this.asyncQueue.enqueueAndForget(function () {
                return (
                  e.syncEngine.runTransaction(e.asyncQueue, t, n),
                  Promise.resolve()
                );
              }),
              n.promise
      ...
      function Uf(t, e, n, r) {
        ((this.platform = t),
          ...
          (this.credentials = n),
          (this.asyncQueue = r),
          (this.clientId = gi.newId()));
      }
      var Qf =
        ((Kf.prototype.next = function (t) {
      ...
      var jf =
        ...
        (Wf._DOCUMENT_ID = new Wf(Ui.keyField().canonicalString())),
        Wf);
      function Wf() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !(function (t, e, n, r) {
        ...
        for (var n = 0; n < t.length; ++n)
          if ((ri("FieldPath", "string", n, t[n]), 0 === t[n].length))
            throw new Wr(
              jr.INVALID_ARGUMENT,
      ...
      var zf = function (t, e) {
        ...
        Hf =
          ((Yf.prototype.getToken = function () {
          ...
          (Yf.prototype.setChangeListener = function (t) {
            (Vr(
              ...
              (this.changeListener = t)(yf.UNAUTHENTICATED));
          }),
      ...
      var Xf =
        ((Jf.prototype.getToken = function () {
          ...
          return (
            (this.forceRefresh = !1),
            this.app.INTERNAL.getToken(t).then(function (t) {
              if (e.tokenCounter !== n)
                throw new Wr(
                  jr.ABORTED,
              ...
              return t
                ? (Vr(
                  ...
                  new zf(t.accessToken, e.currentUser))
                : null;
            })
          );
        }),
        ...
        (Jf.prototype.setChangeListener = function (t) {
          (Vr(!this.changeListener, "Can only call setChangeListener() once."),
            (this.changeListener = t)(this.currentUser));
        }),
      ...
      function Jf(t) {
        ...
        ((this.app = t),
          (this.tokenListener = null),
          (this.currentUser = yf.UNAUTHENTICATED),
          (this.tokenCounter = 0),
          (this.changeListener = null),
          (this.forceRefresh = !1),
      ...
      var Zf =
        (Object.defineProperty($f.prototype, "authHeaders", {
          get: function () {
      ...
      function $f(t, e) {
        ((this.gapi = t),
          ...
          (this.user = yf.FIRST_PARTY));
      }
      var td =
        ((ed.prototype.getToken = function () {
          return Promise.resolve(new Zf(this.gapi, this.sessionIndex));
        }),
        (ed.prototype.setChangeListener = function (t) {
          t(yf.FIRST_PARTY);
        }),
        (ed.prototype.removeChangeListener = function () {}),
        (ed.prototype.invalidateToken = function () {}),
        ed);
      function ed(t, e) {
      ...
      var rd =
        ...
        (id.increment = function (t) {
          return (
            ri("FieldValue.increment", "number", 1, t),
            ti("FieldValue.increment", arguments, 1),
            new vd(t)
          );
        }),
      ...
      var od,
        ad = (t(sd, (od = rd)), (sd.instance = new sd()), sd);
      function sd() {
        return od.call(this, "FieldValue.delete") || this;
      }
      var ud,
        cd = (t(hd, (ud = rd)), (hd.instance = new hd()), hd);
      function hd() {
      ...
      var wd = zr(rd, "Use FieldValue.<field>() instead."),
        Sd = /^__.*__$/,
        Td =
          ((Ed.prototype.toMutations = function (t, e) {
            var n = [];
            return (
              null !== this.fieldMask
                ? n.push(new Ma(t, this.data, this.fieldMask, e))
                : n.push(new Aa(t, this.data, e)),
              0 < this.fieldTransforms.length &&
                n.push(new La(t, this.fieldTransforms)),
              n
            );
          }),
          Ed);
      ...
      var Id,
        Cd,
        Dd =
          ((Nd.prototype.toMutations = function (t, e) {
      ...
      (((Cd = Id = Id || {})[(Cd.Set = 0)] = "Set"),
        (Cd[(Cd.Update = 1)] = "Update"),
        (Cd[(Cd.MergeSet = 2)] = "MergeSet"),
        (Cd[(Cd.Argument = 3)] = "Argument"));
      var kd =
        ((Rd.prototype.childContextForField = function (t) {
        ...
        (Rd.prototype.validatePathSegment = function (t) {
          if (Ad(this.dataSource) && Sd.test(t))
      ...
      var Md = function (t, e) {
        ...
        Od =
          ((_d.prototype.parseSetData = function (t, e) {
          ...
          (_d.prototype.parseMergeData = function (t, e, n) {
            ...
            if (n) {
              for (
                var s = new bo(Ui.comparator), u = 0, c = n;
                u < c.length;
                u++
              ) {
                var h = c[u],
          ...
          (_d.prototype.parseQueryValue = function (t, e) {
            ...
            return (
              Vr(null != r, "Parsed data should not be null."),
              Vr(
          ...
          (_d.prototype.parseData = function (t, e) {
            if (Ld((t = this.runPreConverter(t, e))))
              return (
                Pd("Unsupported field value:", e, t),
                this.parseObject(t, e)
              );
            if (t instanceof rd)
          ...
          (_d.prototype.parseSentinelFieldValue = function (t, e) {
            ...
            if (t instanceof ad) {
              if (e.dataSource !== Id.MergeSet)
                throw e.dataSource === Id.Update
                  ? (Vr(
                      0 < e.path.length,
              ...
              e.fieldTransforms.push(new va(e.path, Ml.instance));
          ...
          (_d.prototype.parseScalarValue = function (t, e) {
            ...
            if (t instanceof ao)
              return new ds(
                new ao(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3)),
              );
      ...
      function Ud(t) {
        if (void 0 === t.host) {
          ...
          (oi("settings", "non-empty string", "host", t.host),
            (this.host = t.host),
            ai("settings", "boolean", "ssl", t.ssl),
            (this.ssl = Yr(t.ssl, !0)));
        if (
          (di("settings", t, [
            "host",
          ...
          ai("settings", "object", "credentials", t.credentials),
          (this.credentials = t.credentials),
          ai(
            "settings",
            "boolean",
          ...
          (this.timestampsInSnapshots = Yr(t.timestampsInSnapshots, !0)),
          ai("settings", "number", "cacheSizeBytes", t.cacheSizeBytes),
          void 0 === t.cacheSizeBytes)
        )
          this.cacheSizeBytes = Yu.DEFAULT_CACHE_SIZE_BYTES;
        else {
          if (
            t.cacheSizeBytes !== Vd &&
            t.cacheSizeBytes < Yu.MINIMUM_CACHE_SIZE_BYTES
          )
            throw new Wr(
              jr.INVALID_ARGUMENT,
              "cacheSizeBytes must be at least " + Yu.MINIMUM_CACHE_SIZE_BYTES,
            );
          this.cacheSizeBytes = t.cacheSizeBytes;
        }
        (ai(
      ...
      var Qd =
        ((Kd.prototype.settings = function (t) {
          if (
            (ti("Firestore.settings", arguments, 1),
            ri("Firestore.settings", "object", 1, t),
            Hr(t, "persistence"))
          )
            throw new Wr(
              jr.INVALID_ARGUMENT,
          ...
          var e = new Bd(t);
          if (this._firestoreClient && !this._settings.isEqual(e))
            throw new Wr(
              jr.FAILED_PRECONDITION,
          ...
          void 0 !== (this._settings = e).credentials &&
        ...
        (Kd.prototype.enablePersistence = function (t) {
          ...
          return (
            ...
            this.configureClient(new qf(this._settings.cacheSizeBytes, e))
          );
        }),
        ...
        (Kd.prototype.waitForPendingWrites = function () {
          return (
            this.ensureClientConfigured(),
            this._firestoreClient.waitForPendingWrites()
          );
        }),
        (Kd.prototype.onSnapshotsInSync = function (t) {
          if ((this.ensureClientConfigured(), nd(t)))
            return this.onSnapshotsInSyncInternal(t);
        ...
        (Kd.prototype.onSnapshotsInSyncInternal = function (t) {
          ...
          return (
            this._firestoreClient.addSnapshotsInSyncListener(n),
            function () {
        ...
        (Kd.prototype.ensureClientConfigured = function () {
          return (
            this._firestoreClient || this.configureClient(new Vf()),
        ...
        (Kd.prototype.configureClient = function (t) {
          (Vr(!!this._settings.host, "FirestoreSettings.host is not set"),
            Vr(
              !this._firestoreClient,
        ...
        (Kd.prototype.collection = function (t) {
          return (
            ti("Firestore.collection", arguments, 1),
            ri("Firestore.collection", "non-empty string", 1, t),
            this.ensureClientConfigured(),
            new up(qi.fromString(t), this)
          );
        }),
        (Kd.prototype.doc = function (t) {
          return (
            ti("Firestore.doc", arguments, 1),
            ri("Firestore.doc", "non-empty string", 1, t),
            this.ensureClientConfigured(),
            Hd.forPath(qi.fromString(t), this)
          );
        }),
        (Kd.prototype.collectionGroup = function (t) {
          if (
            (ti("Firestore.collectionGroup", arguments, 1),
            ri("Firestore.collectionGroup", "non-empty string", 1, t),
            0 <= t.indexOf("/"))
          )
            throw new Wr(
              jr.INVALID_ARGUMENT,
          ...
          return (
            this.ensureClientConfigured(),
            new rp(new tl(qi.EMPTY_PATH, t), this)
          );
        }),
        (Kd.prototype.runTransaction = function (e) {
          var n = this;
          return (
            ti("Firestore.runTransaction", arguments, 1),
            ri("Firestore.runTransaction", "function", 1, e),
            this.ensureClientConfigured().transaction(function (t) {
              return e(new jd(n, t));
            })
          );
        }),
        ...
        (Kd.setLogLevel = function (t) {
          switch (
            (ti("Firestore.setLogLevel", arguments, 1),
            ri("Firestore.setLogLevel", "non-empty string", 1, t),
            t)
          ) {
            case "debug":
              Lr(Er.DEBUG);
      ...
      function Kd(t) {
        ...
        if (
                ...
                return p(this, function (t) {
                  switch (t.label) {
                    case 0:
                      return (
                        this.ensureClientConfigured(),
                        [4, this._firestoreClient.terminate()]
                      );
                    case 1:
                      return (t.sent(), [2]);
                  }
          ...
          var n = t;
          ((this._firebaseApp = n),
            (this._databaseId = Kd.databaseIdFromApp(n)),
            (this._persistenceKey = n.name),
            (this._credentials = new Xf(n)));
        } else {
          var r = t;
          if (!r.projectId)
            throw new Wr(jr.INVALID_ARGUMENT, "Must provide projectId");
          ((this._databaseId = new ki(r.projectId, r.database)),
            (this._persistenceKey = "[DEFAULT]"),
            (this._credentials = new Hf()));
        }
        ((this._settings = new Bd({})),
          (this._dataConverter = this.createDataConverter(this._databaseId)));
      }
      var jd =
        ((Wd.prototype.get = function (t) {
          var n = this;
          ...
          return this._transaction.lookup([r._key]).then(function (t) {
            if (!t || 1 !== t.length)
              return Fr("Mismatch in docs returned from document lookup.");
            var e = t[0];
            if (e instanceof Vs)
              return new Zd(n._firestore, r._key, null, !1, !1);
        ...
        (Wd.prototype.set = function (t, e, n) {
          ...
          var r = dp("Transaction.set", t, this._firestore),
            i =
              (n = hp("Transaction.set", n)).merge || n.mergeFields
        ...
        (Wd.prototype.update = function (t, e, n) {
          ...
          return (
            (i =
              "string" == typeof e || e instanceof jf
                ? (ei("Transaction.update", arguments, 3),
                  (r = dp("Transaction.update", t, this._firestore)),
                  this._firestore._dataConverter.parseUpdateVarargs(
                    "Transaction.update",
                    e,
                    n,
                    o,
                  ))
                : (ti("Transaction.update", arguments, 2),
                  (r = dp("Transaction.update", t, this._firestore)),
                  this._firestore._dataConverter.parseUpdateData(
                    "Transaction.update",
                    e,
                  ))),
      ...
      var Gd =
        ...
        (zd.prototype.update = function (t, e, n) {
          ...
          return (
            ...
            (i =
              "string" == typeof e || e instanceof jf
                ? (ei("WriteBatch.update", arguments, 3),
                  (r = dp("WriteBatch.update", t, this._firestore)),
                  this._firestore._dataConverter.parseUpdateVarargs(
                    "WriteBatch.update",
                    e,
                    n,
                ...
                : (ti("WriteBatch.update", arguments, 2),
                  (r = dp("WriteBatch.update", t, this._firestore)),
                  this._firestore._dataConverter.parseUpdateData(
                    "WriteBatch.update",
                    e,
            ...
            (this._mutations = this._mutations.concat(
              i.toMutations(r._key, Ea.exists(!0)),
            )),
            this
          );
        }),
        (zd.prototype.delete = function (t) {
          ...
          return (
            (this._mutations = this._mutations.concat(new Ua(e._key, Ea.NONE))),
            this
          );
        }),
      ...
      var Hd =
        ...
        (Yd.prototype.collection = function (t) {
          if (
            (ti("DocumentReference.collection", arguments, 1),
            ri("DocumentReference.collection", "non-empty string", 1, t),
            !t)
          )
            throw new Wr(
              jr.INVALID_ARGUMENT,
        ...
        (Yd.prototype.isEqual = function (t) {
          if (!(t instanceof Yd))
            throw pi("isEqual", "DocumentReference", 1, t);
        ...
        (Yd.prototype.set = function (t, e) {
          ...
          var n =
            (e = hp("DocumentReference.set", e)).merge || e.mergeFields
        ...
        (Yd.prototype.update = function (t, e) {
          ...
          return (
            (n =
              "string" == typeof t || t instanceof jf
                ? (ei("DocumentReference.update", arguments, 2),
                  this.firestore._dataConverter.parseUpdateVarargs(
                    "DocumentReference.update",
                    t,
                    e,
                    r,
                  ))
                : (ti("DocumentReference.update", arguments, 1),
                  this.firestore._dataConverter.parseUpdateData(
                    "DocumentReference.update",
                    t,
                  ))),
            this._firestoreClient.write(n.toMutations(this._key, Ea.exists(!0)))
          );
        }),
        (Yd.prototype.delete = function () {
          return (
            ti("DocumentReference.delete", arguments, 0),
            this._firestoreClient.write([new Ua(this._key, Ea.NONE)])
          );
        }),
        (Yd.prototype.onSnapshot = function () {
          ...
          "object" != typeof t[i] ||
            nd(t[i]) ||
            (di("DocumentReference.onSnapshot", (r = t[i]), [
          ...
          return (
            (n = nd(t[i])
              ? t[i]
              : (ri("DocumentReference.onSnapshot", "function", i, t[i]),
                ii("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]),
                ii("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]),
        ...
        (Yd.prototype.get = function (n) {
          var r = this;
          return (
            ni("DocumentReference.get", arguments, 0, 1),
            fp("DocumentReference.get", n),
            new Promise(function (e, t) {
              n && "cache" === n.source
                ? r.firestore
                    .ensureClientConfigured()
                    .getDocumentFromLocalCache(r._key)
                    .then(function (t) {
                      e(
                        new Zd(
                          r.firestore,
                          ...
                          t,
                          !0,
                          t instanceof xs && t.hasLocalMutations,
                        ),
                      );
                    }, t)
                : r.getViaSnapshotListener(e, t, n);
            })
          );
        }),
      ...
      var Zd =
        (($d.prototype.data = function (t) {
          return (
            ni("DocumentSnapshot.data", arguments, 0, 1),
            (t = lp("DocumentSnapshot.data", t)),
            this._document
              ? this.convertObject(
                  this._document.data(),
                  Ka.fromSnapshotOptions(
                    t,
        ...
        ($d.prototype.get = function (t, e) {
          if (
            (ni("DocumentSnapshot.get", arguments, 1, 2),
            (e = lp("DocumentSnapshot.get", e)),
            this._document)
          ) {
      ...
      var rp =
        ((ip.prototype.where = function (t, e, n) {
          (ti("Query.where", arguments, 3),
            fi("Query.where", 3, n),
            "in" !== e &&
          ...
          var r,
            ...
            o = rl.fromString(e);
          if (i.isKeyField()) {
            if (o === rl.ARRAY_CONTAINS || o === rl.ARRAY_CONTAINS_ANY)
              throw new Wr(
                jr.INVALID_ARGUMENT,
            ...
            ((o !== rl.IN && o !== rl.ARRAY_CONTAINS_ANY) ||
              this.validateDisjunctiveFilterElements(n, o),
              (r = this.firestore._dataConverter.parseQueryValue(
                "Query.where",
                n,
              )));
          ...
          return (
            ...
            new ip(this._query.addFilter(h), this.firestore)
          );
        }),
        (ip.prototype.orderBy = function (t, e) {
          var n;
          if (
            (ni("Query.orderBy", arguments, 1, 2),
            ii("Query.orderBy", "non-empty string", 2, e),
            void 0 === e || "asc" === e)
          )
            n = El.ASCENDING;
          else {
          ...
          return (
            ...
            new ip(this._query.addOrderBy(i), this.firestore)
          );
        }),
        (ip.prototype.limit = function (t) {
          if (
            (ti("Query.limit", arguments, 1),
            ri("Query.limit", "number", 1, t),
            t <= 0)
          )
            throw new Wr(
              jr.INVALID_ARGUMENT,
        ...
        (ip.prototype.boundFromDocument = function (t, e, n) {
          for (var r = [], i = 0, o = this._query.orderBy; i < o.length; i++) {
            ...
            if (a.field.isKeyField())
              r.push(new Ts(this.firestore._databaseId, e.key));
            else {
        ...
        (ip.prototype.onSnapshot = function () {
          ...
          return (
            "object" != typeof t[i] ||
              nd(t[i]) ||
              (di("Query.onSnapshot", (r = t[i]), ["includeMetadataChanges"]),
              ai(
                "Query.onSnapshot",
                "boolean",
                "includeMetadataChanges",
            ...
            (n = nd(t[i])
              ? t[i]
              : (ri("Query.onSnapshot", "function", i, t[i]),
                ii("Query.onSnapshot", "function", i + 1, t[i + 1]),
                ii("Query.onSnapshot", "function", i + 2, t[i + 2]),
                { next: t[i], error: t[i + 1], complete: t[i + 2] })),
        ...
        (ip.prototype.get = function (n) {
          var r = this;
          return (
            ni("Query.get", arguments, 0, 1),
            fp("Query.get", n),
            new Promise(function (e, t) {
              n && "cache" === n.source
                ? r.firestore
                    .ensureClientConfigured()
                    .getDocumentsFromLocalCache(r._query)
                    .then(function (t) {
        ...
        (ip.prototype.parseDocumentIdValue = function (t) {
          if ("string" == typeof t) {
            ...
            if (!this._query.isCollectionGroupQuery() && -1 !== t.indexOf("/"))
              throw new Wr(
                jr.INVALID_ARGUMENT,
        ...
        (ip.prototype.validateNewFilter = function (t) {
          if (t instanceof al) {
            ...
            if (t.isInequality()) {
              ...
              var s = null;
              if (
                (i && (s = this._query.findFilterOperator(n)),
                null === s && r && (s = this._query.findFilterOperator(e)),
                null != s)
              )
                throw s === t.op
                  ? new Wr(
      ...
      var op =
        (Object.defineProperty(ap.prototype, "docs", {
          get: function () {
            var e = [];
            return (
              this.forEach(function (t) {
        ...
        (ap.prototype.forEach = function (e, n) {
          var r = this;
          (ni("QuerySnapshot.forEach", arguments, 1, 2),
            ri("QuerySnapshot.forEach", "function", 1, e),
        ...
        (ap.prototype.docChanges = function (t) {
          t &&
            (di("QuerySnapshot.docChanges", t, ["includeMetadataChanges"]),
            ai(
          ...
          return (
            (this._cachedChanges &&
              ...
              ((this._cachedChanges = (function (i, e, o) {
                if (o.oldDocs.isEmpty()) {
                  ...
                  return o.docChanges.map(function (t) {
                    ...
                    return (
                      ...
                      Vr(
                        !n || o.query.docComparator(n, t.doc) < 0,
                ...
                return o.docChanges
                  ...
                  .map(function (t) {
                    ...
                    return (
                      t.type !== Ih.Added &&
                        (Vr(
                          0 <= (n = a.indexOf(t.doc.key)),
                          "Index for document not found",
                        ),
                        (a = a.delete(t.doc.key))),
                      t.type !== Ih.Removed &&
                        (r = (a = a.add(t.doc)).indexOf(t.doc.key)),
                      {
                        type: (function (t) {
                          switch (t) {
                            case Ih.Added:
      ...
      function ap(t, e, n) {
        ((this._firestore = t),
          ...
          (this.metadata = new Xd(n.hasPendingWrites, n.fromCache)));
      }
      a(
        ["length", "forEach", "map"],
      ...
      var sp,
        up =
          (t(cp, (sp = rp)),
          Object.defineProperty(cp.prototype, "id", {
            get: function () {
          ...
          (cp.prototype.doc = function (t) {
            if (
              (ni("CollectionReference.doc", arguments, 0, 1),
              0 === arguments.length && (t = gi.newId()),
              ri("CollectionReference.doc", "non-empty string", 1, t),
              "" === t)
            )
              throw new Wr(
                jr.INVALID_ARGUMENT,
          ...
          (cp.prototype.add = function (t) {
            (ti("CollectionReference.add", arguments, 1),
              ri("CollectionReference.add", "object", 1, t));
            var e = this.doc();
      ...
      function hp(t, e) {
        ...
        if (
          (di(t, e, ["merge", "mergeFields"]),
          ai(t, "boolean", "merge", e.merge),
          si(
            t,
            "mergeFields",
      ...
      function lp(t, e) {
        return void 0 === e
          ? {}
          : (di(t, e, ["serverTimestamps"]),
            ui(t, 0, "serverTimestamps", e.serverTimestamps, [
              "estimate",
              "previous",
              "none",
            ]),
      ...
      function fp(t, e) {
        (ii(t, "object", 1, e),
          e &&
            (di(t, e, ["source"]),
            ui(t, 0, "source", e.source, ["default", "server", "cache"])));
      }
      function dp(t, e, n) {
        if (e instanceof Hd) {
          if (e.firestore !== n)
      ...
      var Cp =
        ((Dp.prototype.addCallback = function (t) {}),
        (Dp.prototype.shutdown = function () {}),
        Dp);
      function Dp() {}
      var Np = "ConnectivityMonitor",
        Ap =
          ((kp.prototype.addCallback = function (t) {
          ...
          (kp.prototype.shutdown = function () {
            (window.removeEventListener(
              ...
              window.removeEventListener(
                "offline",
                this.networkUnavailableListener,
              ));
          }),
      ...
      var Rp =
        ((Mp.prototype.onOpen = function (t) {
          (Vr(!this.wrappedOnOpen, "Called onOpen on stream twice!"),
            (this.wrappedOnOpen = t));
        }),
        (Mp.prototype.onClose = function (t) {
          (Vr(!this.wrappedOnClose, "Called onClose on stream twice!"),
            (this.wrappedOnClose = t));
        }),
        (Mp.prototype.onMessage = function (t) {
          (Vr(!this.wrappedOnMessage, "Called onMessage on stream twice!"),
      ...
      var Op = "Connection",
        _p = { BatchGetDocuments: "batchGet", Commit: "commit" },
        Lp = "gl-js/ fire/" + Mr,
        Pp =
          ((xp.prototype.modifyHeadersForRequest = function (t, e) {
            if (e)
                ...
                try {
                  switch (a.getLastErrorCode()) {
                    case Nr.NO_ERROR:
                      ...
                      break;
                    case Nr.TIMEOUT:
                      (Pr(Op, 'RPC "' + s + '" timed out'),
                        o(new Wr(jr.DEADLINE_EXCEEDED, "Request time out")));
                      break;
                    case Nr.HTTP_ERROR:
                      var e = a.getStatus();
                      if (
                        ...
                        if (n && n.status && n.message) {
                          var r = (function (t) {
                            ...
                            return 0 <= Object.values(jr).indexOf(e)
                              ? e
                              : jr.UNKNOWN;
                          })(n.status);
                        ...
                        (Pr(Op, 'RPC "' + s + '" failed'),
                          o(new Wr(jr.UNAVAILABLE, "Connection failed.")));
                      break;
                    default:
                      Fr(
                        'RPC "' +
          ...
          (xp.prototype.openStream = function (t, e) {
            ...
            var s = r.createWebChannel(o, i),
              ...
              h = new Rp({
                sendFn: function (t) {
                  c
                    ? Pr(Op, "Not sending because WebChannel is closed:", t)
                    : (u ||
                        (Pr(Op, "Opening WebChannel transport."),
                        s.open(),
                        (u = !0)),
                      Pr(Op, "WebChannel sending:", t),
                      s.send(t));
                },
                closeFn: function () {
                  return s.close();
            ...
            return (
              a(kr.EventType.OPEN, function () {
                c || Pr(Op, "WebChannel transport opened.");
              }),
              a(kr.EventType.CLOSE, function () {
                c ||
                  ((c = !0),
                  Pr(Op, "WebChannel transport closed"),
                  h.callOnClose());
              }),
              a(kr.EventType.ERROR, function (t) {
                c ||
                  ((c = !0),
                  Pr(Op, "WebChannel transport errored:", t),
                  h.callOnClose(
                    new Wr(
                      jr.UNAVAILABLE,
                  ...
                  if (r) {
                    ...
                    (void 0 === o &&
                      ...
                      (a =
                        ...
                        r.message)),
                      (c = !0),
                      h.callOnClose(new Wr(o, a)),
                      s.close());
                  } else
                    (Pr(Op, "WebChannel received:", e), h.callOnMessage(e));
                }
              }),
              setTimeout(function () {
                h.callOnOpen();
      ...
      var qp =
        (Object.defineProperty(Fp.prototype, "document", {
          get: function () {
        ...
        (Fp.prototype.newSerializer = function (t) {
          return new Yl(t, { useProto3Json: !0 });
        }),
