!((t, e) => {
  ...
  try {
    (() => {
      ...
      function n(t, e) {
        ...
        var n,
          ...
          s = [];
        try {
          while ((void 0 === e || 0 < e--) && !(n = o.next()).done)
            s.push(n.value);
        } catch (t) {
          i = { error: t };
        } finally {
      ...
      (d(b, "_index", ["name", "keyPath", "multiEntry", "unique"]),
        v(b, "_index", IDBIndex, [
          "get",
          "getKey",
          "getAll",
        ...
        y(b, "_index", IDBIndex, ["openCursor", "openKeyCursor"]),
        d(w, "_cursor", ["direction", "key", "primaryKey", "value"]),
        v(w, "_cursor", IDBCursor, ["update", "delete"]),
        ["advance", "continue", "continuePrimaryKey"].forEach((r) => {
          r in IDBCursor.prototype &&
            (w.prototype[r] = function () {
              var t = arguments;
              return Promise.resolve().then(
                () => (
                  this._cursor[r].apply(this._cursor, t),
                  f(this._request).then((t) => {
                    if (t) return new w(t, this._request);
                  })
                ),
              );
            });
        ...
        d(S, "_store", ["name", "keyPath", "indexNames", "autoIncrement"]),
        v(S, "_store", IDBObjectStore, [
          "put",
          "add",
          "delete",
          "clear",
        ...
        y(S, "_store", IDBObjectStore, ["openCursor", "openKeyCursor"]),
        m(S, "_store", IDBObjectStore, ["deleteIndex"]),
        (E.prototype.objectStore = function () {
          return new S(this._tx.objectStore.apply(this._tx, arguments));
        }),
        d(E, "_tx", ["objectStoreNames", "mode"]),
        m(E, "_tx", IDBTransaction, ["abort"]),
        (T.prototype.createObjectStore = function () {
          return new S(this._db.createObjectStore.apply(this._db, arguments));
        }),
        d(T, "_db", ["name", "version", "objectStoreNames"]),
        m(T, "_db", IDBDatabase, ["deleteObjectStore", "close"]),
        (C.prototype.transaction = function () {
          return new E(this._db.transaction.apply(this._db, arguments));
        }),
        d(C, "_db", ["name", "version", "objectStoreNames"]),
        m(C, "_db", IDBDatabase, ["close"]),
        ["openCursor", "openKeyCursor"].forEach((i) => {
          [S, b].forEach((t) => {
            i in t.prototype &&
              (t.prototype[i.replace("open", "iterate")] = function () {
                var t = ((t) => Array.prototype.slice.call(t))(arguments),
                  e = t[t.length - 1],
      ...
      var I,
        ...
        P = 36e5,
        j =
          (((I = {})["missing-app-config-values"] =
            "Missing App configuration values."),
          (I["create-installation-failed"] =
            "Could not register Firebase Installation."),
          (I["generate-token-failed"] = "Could not generate Auth Token."),
          (I["not-registered"] = "Firebase Installation is not registered."),
          (I["installation-not-found"] = "Firebase Installation not found."),
          (I["request-failed"] =
            '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"'),
          (I["app-offline"] =
            "Could not process request. Application offline."),
          (I["delete-pending-registration"] =
      ...
      function N(t) {
        ...
        return { appName: e, projectId: n, apiKey: i, appId: o };
      }
      function D(t) {
        var e = t.projectId;
      ...
      function x(t) {
        return {
          token: t.token,
          requestStatus: 2,
          expiresIn: ((t) => Number(t.replace("s", "000")))(t.expiresIn),
      ...
      function B(t, e) {
        var r = e.refreshToken,
          n = q(t);
        return (n.append("Authorization", ((t) => F + " " + t)(r)), n);
      }
      function K(r) {
        return u(this, void 0, void 0, function () {
          var e;
      ...
      var G,
        W,
        J = "firebase-installations-database",
        Y = 1,
            ...
            switch (t.label) {
              ...
              case 1:
                return (
                  (r = t.sent()),
                  (n = r.transaction(Q, "readwrite")),
                  [4, (i = n.objectStore(Q)).get(e)]
                );
              case 2:
                return (
                  (o = t.sent()),
                  void 0 !== (s = c(o)) ? [3, 4] : [4, i.delete(e)]
                );
              case 3:
                return (t.sent(), [3, 6]);
              case 4:
            ...
            switch (t.label) {
              case 0:
                return [
                  ...
                  rt(i, (t) => {
                    var e = ((t) =>
                        st(t || { fid: U(), registrationStatus: 0 }))(t),
                      r = ((t, e) => {
              ...
              case 3:
                return [2, { installationEntry: e, registrationPromise: n }];
            }
          });
        });
      }
      ...
      function st(t) {
        return ((t) =>
          1 === t.registrationStatus && t.registrationTime + k < Date.now())(t)
            ...
            switch (t.label) {
              case 0:
                return (
                  ...
                  (r = B(a, c)),
                  (n = { installation: { sdkVersion: O } }),
                  (i = { method: "POST", headers: r, body: JSON.stringify(n) }),
                  [4, K(() => fetch(e, i))]
                );
              case 1:
                      ...
                      if (
                        ...
                        ((t) =>
                          ...
                          !((t) => {
                            ...
                            return (
                              e < t.creationTime ||
                              t.creationTime + t.expiresIn < e + P
                            );
                          })(t))(e)
                      )
                        return t;
                      if (1 === e.requestStatus)
                        return (
                          (n = (function (n) {
                            return u(this, void 0, void 0, function () {
                              var e, r;
                              return _(this, (t) => {
                                switch (t.label) {
                                  ...
                                  case 4:
                                    return ((e = t.sent()), [3, 2]);
                                  case 5:
                                    if (0 === (r = e.authToken).requestStatus)
                                      throw A.create("generate-token-failed");
                                    return [2, r];
                                }
                              });
                            });
      ...
      function ut(t) {
        return rt(t, (t) => {
          if (!lt(t)) throw A.create("not-registered");
          return ((t) =>
            1 === t.requestStatus && t.requestTime + k < Date.now())(
            t.authToken,
          )
                        ...
                        return _(this, (t) => {
                          switch (t.label) {
                            ...
                            case 1:
                              return (
                                (e = t.sent()),
                                (r = e.installationEntry),
                                (n = e.registrationPromise) ? [4, n] : [3, 3]
                              );
                            case 2:
                              return (t.sent(), [3, 4]);
                            case 3:
                              if (2 !== r.registrationStatus)
                                throw A.create("create-installation-failed");
                              t.label = 4;
                            case 4:
                              return [2];
                          }
                    ...
                    switch (t.label) {
                      ...
                      case 1:
                        return (
                          ...
                          (i = r.registrationPromise) && i.catch(() => {}),
                          2 === n.registrationStatus && ct(e).catch(() => {}),
                          [2, n.fid]
                        );
                    }
                  });
      ...
      var dt = G.INFO,
        vt =
          (Object.defineProperty(mt.prototype, "logLevel", {
            get: function () {
      ...
      var yt,
        bt =
          ((wt.prototype.isCachedDataFresh = function (t, e) {
            if (!e)
              return (
                this.logger.debug(
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      ...
                      (r = e[0]),
                      (n = e[1]) &&
                      this.isCachedDataFresh(s.cacheMaxAgeMillis, r)
                        ? [2, n]
                        : ((s.eTag = n && n.eTag), [4, this.client.fetch(s)])
                    );
                  case 2:
                    return (
                      (i = t.sent()),
                      ...
                      200 === i.status &&
                        o.push(this.storage.setLastSuccessfulFetchResponse(i)),
                      [4, Promise.all(o)]
                    );
                  case 3:
                    return (t.sent(), [2, i]);
      ...
      var _t =
          (((yt = {})["registration-window"] =
            "Undefined window object. This SDK only supports usage in a browser environment."),
          (yt["registration-project-id"] =
            "Undefined project identifier. Check Firebase app initialization."),
          (yt["registration-api-key"] =
            "Undefined API key. Check Firebase app initialization."),
          (yt["registration-app-id"] =
              ...
              switch (t.label) {
                ...
                case 5:
                  throw (
                    ...
                    "AbortError" === h.name && (p = "fetch-timeout"),
                    St.create(p, { originalErrorMessage: h.message })
                  );
                case 6:
                  if (
                    ((g = f.status),
                    (d = f.headers.get("ETag") || void 0),
                    200 !== f.status)
                  )
                    return [3, 11];
                  ((y = void 0), (t.label = 7));
                ...
                case 11:
                  if (
                    ...
                    throw St.create("fetch-status", { httpStatus: g });
                  return [2, { status: g, eTag: d, config: v }];
              }
            });
          });
        }),
      ...
      var Ct =
        ((It.prototype.addEventListener = function (t) {
      ...
      var kt = ["1", "true", "t", "yes", "y", "on"],
        Ot =
          ((Ft.prototype.asString = function () {
            return this._value;
          }),
          (Ft.prototype.asBoolean = function () {
            return (
              "static" !== this._source &&
              0 <= kt.indexOf(this._value.toLowerCase())
            );
          }),
      ...
      var Mt =
        ((Pt.prototype.setLogLevel = function (t) {
          switch (t) {
            case "debug":
                  ...
                  return (
                    ...
                    r && r.config && r.eTag && r.eTag !== n
                      ? [
                          4,
                          Promise.all([
                            this._storageCache.setActiveConfig(r.config),
                            this._storage.setActiveConfigEtag(r.eTag),
                          ]),
                        ]
                      : [2, !1]
                  );
          ...
          return (
            this._initializePromise ||
              (this._initializePromise = this._storageCache
                .loadFromStorage()
                .then(() => {
                  this._isInitializationComplete = !0;
                })),
            this._initializePromise
          );
        }),
                    ...
                    switch (t.label) {
                      ...
                      case 4:
                        return (
                          (r = t.sent()),
                          (n = ((t, e) =>
                            t instanceof h && -1 !== t.code.indexOf(e))(
                            r,
                            "fetch-throttle",
                          )
                            ? "throttle"
        ...
        (Pt.prototype.getValue = function (t) {
          ...
          return e && void 0 !== e[t]
            ...
            : this.defaultConfig && void 0 !== this.defaultConfig[t]
              ? new Ot("default", String(this.defaultConfig[t]))
              : (this._logger.debug(
      ...
      function jt(t, e) {
        ...
        return St.create(e, { originalErrorMessage: r && r.message });
      }
          ...
          (n = new Promise((e, r) => {
            ...
            ((t.onerror = (t) => {
              ...
              (t.onupgradeneeded = (t) => {
                ...
                switch (t.oldVersion) {
                  case 0:
                    e.createObjectStore(At, { keyPath: "compositeKey" });
                }
              }));
          })),
          (this.appId = t),
      ...
      var Rt =
        ((qt.prototype.getLastFetchStatus = function () {
            ...
            return _(this, function (t) {
              switch (t.label) {
                ...
                case 2:
                  return (
                    (o = t.sent()) &&
                      (this.lastSuccessfulFetchTimestampMillis = o),
                    [4, n]
                  );
                case 3:
                      ...
                      throttleEndTimeMillis:
                        ...
                        ((t) => {
                          var e = 1e3 * Math.pow(2, t),
                            r = Math.round(0.5 * e * (Math.random() - 0.5) * 2);
      ...
      var Vt;
      (Vt = zt).INTERNAL.registerService(
        "remoteConfig",
        (t, e, r) => {
          if ("undefined" == typeof window)
            throw St.create("registration-window");
          var n = t.options,
            i = n.projectId,
            o = n.apiKey,
            s = n.appId;
    ...
    throw (
      console.error(t),
      new Error(
        "Cannot instantiate firebase-remote-config - be sure to load firebase-app.js first.",
      )
    );
  }
});
