    ...
    (function (core) {
      ...
      var CurveTimeline = (function () {
        function CurveTimeline(frameCount) {
          ...
          this.curves = core.Utils.newFloatArray(
        ...
        CurveTimeline.prototype.getCurvePercent = function (
          frameIndex,
          percent,
        ) {
      ...
      var RotateTimeline = (function (_super) {
        ...
        RotateTimeline.prototype.setFrame = function (
          frameIndex,
          time,
          degrees,
        ) {
        ...
        RotateTimeline.prototype.apply = function (
          ...
          if (time >= frames[frames.length - RotateTimeline.ENTRIES]) {
            if (pose == MixPose.setup)
              bone.rotation =
                bone.data.rotation +
                frames[frames.length + RotateTimeline.PREV_ROTATION] * alpha;
            else {
              var r_2 =
                bone.data.rotation +
      ...
      var TranslateTimeline = (function (_super) {
        ...
        function TranslateTimeline(frameCount) {
          var _this = _super.call(this, frameCount) || this;
          _this.frames = core.Utils.newFloatArray(
        ...
        TranslateTimeline.prototype.setFrame = function (
          frameIndex,
          time,
          x,
          y,
      ...
      var DeformTimeline = (function (_super) {
        ...
        DeformTimeline.prototype.apply = function (
          ...
          if (
            !(slotAttachment instanceof core.VertexAttachment) ||
              ...
              case MixPose.setup:
                ...
                if (vertexAttachment.bones == null) {
                  ...
                  if (zeroVertices.length < vertexCount)
                    zeros = zeroVertices =
                      core.Utils.newFloatArray(vertexCount);
                }
              ...
              case MixPose.current:
                ...
                if (vertexAttachment.bones == null) {
                  ...
                  for (var i_1 = 0; i_1 < vertexCount; i_1++)
                    vertices[i_1] +=
                      (setupVertices[i_1] - vertices[i_1]) * alpha;
                } else {
                  alpha = 1 - alpha;
          ...
          if (alpha == 1) {
            ...
            if (vertexAttachment.bones == null) {
              ...
              for (var i_6 = 0; i_6 < vertexCount; i_6++) {
                ...
                vertices[i_6] =
                  setup +
                  (prev + (nextVertices[i_6] - prev) * percent - setup) * alpha;
              }
            } else {
              for (var i_7 = 0; i_7 < vertexCount; i_7++) {
                var prev = prevVertices[i_7];
                vertices[i_7] =
                  (prev + (nextVertices[i_7] - prev) * percent) * alpha;
              }
            }
          } else {
            for (var i_8 = 0; i_8 < vertexCount; i_8++) {
              ...
              vertices[i_8] +=
                (prev + (nextVertices[i_8] - prev) * percent - vertices[i_8]) *
                alpha;
            }
          }
        };
            ...
            if (pose == MixPose.setup) {
              ...
              constraint.bendDirection =
                direction == MixDirection.out
                  ...
                  : frames[
                      frames.length + IkConstraintTimeline.PREV_BEND_DIRECTION
                    ];
            } else {
              constraint.mix +=
                (frames[frames.length + IkConstraintTimeline.PREV_MIX] -
      ...
      var TransformConstraintTimeline = (function (_super) {
        ...
        TransformConstraintTimeline.prototype.setFrame = function (
          ...
          this.frames[frameIndex] = time;
          this.frames[frameIndex + TransformConstraintTimeline.ROTATE] =
            rotateMix;
          this.frames[frameIndex + TransformConstraintTimeline.TRANSLATE] =
            translateMix;
          this.frames[frameIndex + TransformConstraintTimeline.SCALE] =
            scaleMix;
          this.frames[frameIndex + TransformConstraintTimeline.SHEAR] =
            shearMix;
        };
        TransformConstraintTimeline.prototype.apply = function (
          ...
          if (
            ...
            translate =
              frames[frame + TransformConstraintTimeline.PREV_TRANSLATE];
          ...
          if (pose == MixPose.setup) {
            ...
            constraint.scaleMix =
              data.scaleMix + (scale - data.scaleMix) * alpha;
            constraint.shearMix =
              data.shearMix + (shear - data.shearMix) * alpha;
          } else {
      ...
      var PathConstraintPositionTimeline = (function (_super) {
        ...
        PathConstraintPositionTimeline.prototype.getPropertyId = function () {
          return (
            (TimelineType.pathConstraintPosition << 24) +
        ...
        PathConstraintPositionTimeline.prototype.setFrame = function (
          ...
          this.frames[frameIndex] = time;
          this.frames[frameIndex + PathConstraintPositionTimeline.VALUE] =
            value;
        };
        PathConstraintPositionTimeline.prototype.apply = function (
          ...
          if (
            ...
            position =
              frames[frame + PathConstraintPositionTimeline.PREV_VALUE];
            var frameTime = frames[frame];
            var percent = this.getCurvePercent(
            ...
            position +=
              (frames[frame + PathConstraintPositionTimeline.VALUE] -
                position) *
              percent;
          }
          if (pose == MixPose.setup)
      ...
      var PathConstraintSpacingTimeline = (function (_super) {
        ...
        PathConstraintSpacingTimeline.prototype.getPropertyId = function () {
          return (
            (TimelineType.pathConstraintSpacing << 24) +
            this.pathConstraintIndex
          );
        };
        PathConstraintSpacingTimeline.prototype.apply = function (
          ...
          if (
            time >=
            frames[frames.length - PathConstraintSpacingTimeline.ENTRIES]
          )
            spacing =
      ...
      var PathConstraintMixTimeline = (function (_super) {
        ...
        PathConstraintMixTimeline.prototype.getPropertyId = function () {
          return (
            (TimelineType.pathConstraintMix << 24) + this.pathConstraintIndex
          );
        };
        PathConstraintMixTimeline.prototype.setFrame = function (
          ...
          this.frames[frameIndex] = time;
          this.frames[frameIndex + PathConstraintMixTimeline.ROTATE] =
            rotateMix;
        ...
        PathConstraintMixTimeline.prototype.apply = function (
          ...
          var rotate = 0,
            translate = 0;
          if (
            time >= frames[frames.length - PathConstraintMixTimeline.ENTRIES]
          ) {
            rotate =
            ...
            translate =
              frames[frame + PathConstraintMixTimeline.PREV_TRANSLATE];
            var frameTime = frames[frame];
            var percent = this.getCurvePercent(
            ...
            rotate +=
              ...
              percent;
            translate +=
              (frames[frame + PathConstraintMixTimeline.TRANSLATE] -
                translate) *
              percent;
          }
          if (pose == MixPose.setup) {
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var AnimationState = (function () {
        ...
        AnimationState.prototype.apply = function (skeleton) {
          ...
          for (var i = 0, n = tracks.length; i < n; i++) {
            ...
            applied = true;
            var currentPose =
              i == 0 ? core.MixPose.current : core.MixPose.currentLayered;
            ...
            if (mix == 1) {
              ...
              for (var ii = 0; ii < timelineCount; ii++) {
                ...
                var pose =
                  timelineData[ii] >= AnimationState.FIRST
                    ? core.MixPose.setup
                    : currentPose;
        ...
        AnimationState.prototype.applyRotateTimeline = function (
          ...
          if (time >= frames[frames.length - core.RotateTimeline.ENTRIES])
            r2 =
              bone.data.rotation +
              frames[frames.length + core.RotateTimeline.PREV_ROTATION];
          else {
            var frame = core.Animation.binarySearch(
              frames,
              time,
              core.RotateTimeline.ENTRIES,
            );
            var prevRotation =
              frames[frame + core.RotateTimeline.PREV_ROTATION];
            var frameTime = frames[frame];
            var percent = rotateTimeline.getCurvePercent(
              (frame >> 1) - 1,
              1 -
                (time - frameTime) /
                  (frames[frame + core.RotateTimeline.PREV_TIME] - frameTime),
            );
          ...
          var r1 =
            pose == core.MixPose.setup ? bone.data.rotation : bone.rotation;
          var total = 0,
            diff = r2 - r1;
          if (diff == 0) {
            ...
            var current = diff > 0,
              dir = lastTotal >= 0;
            if (
              core.MathUtils.signum(lastDiff) != core.MathUtils.signum(diff) &&
          ...
          if (
            entry.loop
              ...
              : animationTime >= animationEnd &&
                entry.animationLast < animationEnd
          ) {
        ...
        AnimationState.prototype.addAnimationWith = function (
          ...
          if (last == null) {
            ...
            if (delay <= 0) {
              ...
              if (duration != 0)
                delay +=
                  duration * (1 + ((last.trackTime / duration) | 0)) -
        ...
        AnimationState.prototype.expandToIndex = function (index) {
          ...
          core.Utils.ensureArrayCapacity(
            this.tracks,
        ...
        AnimationState.prototype.setAnimationByName = function (
          ...
          if (!AnimationState.deprecatedWarning1) {
            ...
            console.warn(
              "Deprecation Warning: AnimationState.setAnimationByName is deprecated, please use setAnimation from now on.",
            );
          }
        ...
        AnimationState.prototype.addAnimationByName = function (
          ...
          if (!AnimationState.deprecatedWarning2) {
            ...
            console.warn(
              "Deprecation Warning: AnimationState.addAnimationByName is deprecated, please use addAnimation from now on.",
            );
          }
        ...
        AnimationState.prototype.hasAnimationByName = function (animationName) {
          if (!AnimationState.deprecatedWarning3) {
            ...
            console.warn(
              "Deprecation Warning: AnimationState.hasAnimationByName is deprecated, please use hasAnimation from now on.",
            );
          }
      ...
      var TrackEntry = (function () {
        ...
        TrackEntry.prototype.setTimelineData = function (
          to,
          mixingToArray,
          propertyIDs,
        ) {
          ...
          var lastEntry =
            this.mixingFrom != null
              ? this.mixingFrom.setTimelineData(
                  this,
                  mixingToArray,
                  propertyIDs,
                )
          ...
          var timelineData = core.Utils.setArraySize(
            this.timelineData,
            timelinesCount,
          );
          this.timelineDipMix.length = 0;
          var timelineDipMix = core.Utils.setArraySize(
            this.timelineDipMix,
            timelinesCount,
          );
        ...
        Object.defineProperty(TrackEntry.prototype, "time", {
          get: function () {
            if (!TrackEntry.deprecatedWarning1) {
              ...
              console.warn(
                "Deprecation Warning: TrackEntry.time is deprecated, please use trackTime from now on.",
              );
            }
        ...
        Object.defineProperty(TrackEntry.prototype, "endTime", {
          get: function () {
            if (!TrackEntry.deprecatedWarning2) {
              ...
              console.warn(
                "Deprecation Warning: TrackEntry.endTime is deprecated, please use trackEnd from now on.",
              );
            }
            return this.trackTime;
          },
      ...
      var EventQueue = (function () {
        ...
        EventQueue.prototype.deprecateStuff = function () {
          if (!EventQueue.deprecatedWarning1) {
            ...
            console.warn(
              "Deprecation Warning: onComplete, onStart, onEnd, onEvent art deprecated, please use listeners from now on. 'state.addListener({ complete: function(track, event) { } })'",
            );
          }
          return true;
        };
          ...
          for (var i = 0; i < objects.length; i += 2) {
            ...
            switch (type) {
              case EventType.start:
                ...
                entry.onStart &&
                  this.deprecateStuff() &&
                  entry.onStart(entry.trackIndex);
              ...
              case EventType.end:
                ...
                entry.onEnd &&
                  this.deprecateStuff() &&
                  entry.onEnd(entry.trackIndex);
                this.animState.onEnd &&
                  this.deprecateStuff() &&
                  this.animState.onEnd(entry.trackIndex);
              ...
              case EventType.complete:
                ...
                entry.onComplete &&
                  this.deprecateStuff() &&
                  entry.onComplete(entry.trackIndex, count);
              ...
              case EventType.event:
                ...
                entry.onEvent &&
                  this.deprecateStuff() &&
                  entry.onEvent(entry.trackIndex, event_3);
                this.animState.onEvent &&
                  this.deprecateStuff() &&
                  this.animState.onEvent(entry.trackIndex, event_3);
                break;
            }
          }
          this.clear();
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var AnimationStateData = (function () {
        ...
        AnimationStateData.prototype.setMixByName = function (
          fromName,
          toName,
          duration,
        ) {
        ...
        AnimationStateData.prototype.setMixWith = function (
          from,
          to,
          duration,
        ) {
    ...
    (function (core) {
      var Bone = (function () {
            ...
            case core.TransformMode.NoScaleOrReflection: {
              ...
              if (
                ...
                core.TransformMode.NoScaleOrReflection
                  ? pa * pd - pb * pc < 0
                  : (this.skeleton.flipX != this.skeleton.flipY) != Bone.yDown
              ) {
                m.c = -m.c;
                m.d = -m.d;
              }
        ...
        Bone.prototype.getWorldRotationX = function () {
          return (
            Math.atan2(this.matrix.b, this.matrix.a) * core.MathUtils.radDeg
          );
        };
        Bone.prototype.getWorldRotationY = function () {
          return (
            Math.atan2(this.matrix.d, this.matrix.c) * core.MathUtils.radDeg
          );
        };
        ...
        Bone.prototype.updateAppliedTransform = function () {
          ...
          if (this.ascaleX > 0.0001) {
            ...
            this.ashearY =
              Math.atan2(ra * rb + rc * rd, det) * core.MathUtils.radDeg;
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      ...
      (function (TransformMode) {
        ...
        TransformMode[(TransformMode["OnlyTranslation"] = 1)] =
          "OnlyTranslation";
    ...
    (function (core) {
      var IkConstraint = (function () {
        ...
        IkConstraint.prototype.apply1 = function (
          ...
          var rotationIK =
            Math.atan2(ty, tx) * core.MathUtils.radDeg -
            bone.ashearX -
            bone.arotation;
        ...
        IkConstraint.prototype.apply2 = function (
          ...
          a2 =
            ((a2 + os) * core.MathUtils.radDeg - child.ashearX) * s2 +
            os2 -
            rotation;
          if (a2 > 180) a2 -= 360;
        ...
        PathConstraint.prototype.update = function () {
          ...
          if (scale || lengthSpacing) {
            ...
            for (var i = 0, n = spacesCount - 1; i < n; ) {
              ...
              spaces[++i] =
                ((lengthSpacing ? setupLength + spacing : spacing) * length_1) /
                setupLength;
            }
          } else {
          ...
          for (var i = 0, p = 3; i < boneCount; i++, p += 3) {
            ...
            if (scale) {
              ...
              if (length_2 != 0) {
                var s =
                  (Math.sqrt(dx * dx + dy * dy) / length_2 - 1) * rotateMix + 1;
                mat.a *= s;
                mat.b *= s;
              }
            }
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var Skeleton = (function () {
        function Skeleton(data) {
          ...
          for (var i = 0; i < data.ikConstraints.length; i++) {
            ...
            this.ikConstraints.push(
              new core.IkConstraint(ikConstraintData, this),
            );
          }
          ...
          for (var i = 0; i < data.transformConstraints.length; i++) {
            ...
            this.transformConstraints.push(
              new core.TransformConstraint(transformConstraintData, this),
            );
          }
          ...
          for (var i = 0; i < data.pathConstraints.length; i++) {
            ...
            this.pathConstraints.push(
              new core.PathConstraint(pathConstraintData, this),
            );
          }
        ...
        Skeleton.prototype.getAttachment = function (
          slotIndex,
          attachmentName,
        ) {
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var SkeletonBounds = (function () {
          ...
          for (var i = 0; i < slotCount; i++) {
            ...
            if (attachment instanceof core.BoundingBoxAttachment) {
              ...
              if (polygon.length != boundingBox.worldVerticesLength) {
                polygon = core.Utils.newFloatArray(
        ...
        SkeletonBounds.prototype.containsPointPolygon = function (
          polygon,
          x,
          y,
        ) {
          ...
          outer: for (var i = 0; i < trianglesLength; i += 3) {
            ...
            for (var p = 0; p < polygonsCount; p++) {
              ...
              if (this.clip(x1, y1, x2, y2, x3, y3, polygons[p], clipOutput)) {
                ...
                var clippedVerticesItems = core.Utils.setArraySize(
                  clippedVertices,
                ...
                var clippedTrianglesItems = core.Utils.setArraySize(
                  clippedTriangles,
            ...
            for (var ii = 0; ii < inputVerticesLength; ii += 2) {
              ...
              if (deltaX * (inputY - edgeY2) - deltaY * (inputX - edgeX2) > 0) {
                ...
                var c0 = inputY2 - inputY,
                  c2 = inputX2 - inputX;
                var ua =
                  (c2 * (edgeY - inputY) - c0 * (edgeX - inputX)) /
      ...
      var SkeletonJson = (function () {
        ...
        SkeletonJson.prototype.readSkeletonData = function (json) {
          ...
          if (root.path) {
            for (var i = 0; i < root.path.length; i++) {
              ...
              if (
                data.spacingMode == core.SpacingMode.Length ||
                data.spacingMode == core.SpacingMode.Fixed
              )
                data.spacing *= scale;
              data.rotateMix = this.getValue(constraintMap, "rotateMix", 1);
              data.translateMix = this.getValue(
        ...
        SkeletonJson.prototype.readAttachment = function (
          ...
          switch (type) {
            ...
            case "clipping": {
              var clip = this.attachmentLoader.newClippingAttachment(
                skin,
                name,
              );
              ...
              if (end != null) {
                ...
                if (clip.name != slot.name) clip.endSlot = slot;
              }
              var vertexCount = map.vertexCount;
        ...
        SkeletonJson.prototype.readAnimation = function (
            ...
            for (var slotName in map.slots) {
              ...
              for (var timelineName in slotMap) {
                ...
                if (timelineName == "attachment") {
                  var timeline = new core.AttachmentTimeline(
                    timelineMap.length,
                  );
              ...
              for (var timelineName in boneMap) {
                ...
                if (timelineName === "rotate") {
                  ...
                  duration = Math.max(
                    ...
                    timeline.frames[
                      (timeline.getFrameCount() - 1) *
                        core.TranslateTimeline.ENTRIES
                    ],
                  );
                } else
                  throw new Error(
          ...
          if (map.ik) {
            for (var constraintName in map.ik) {
              ...
              var timeline = new core.IkConstraintTimeline(
              ...
              duration = Math.max(
                ...
                timeline.frames[
                  (timeline.getFrameCount() - 1) *
                    core.IkConstraintTimeline.ENTRIES
                ],
              );
            }
          }
          if (map.transform) {
            for (var constraintName in map.transform) {
              ...
              var timeline = new core.TransformConstraintTimeline(
                constraintMap.length,
              );
              ...
              duration = Math.max(
                ...
                timeline.frames[
                  (timeline.getFrameCount() - 1) *
                    core.TransformConstraintTimeline.ENTRIES
                ],
              );
            }
          }
              ...
              for (var timelineName in constraintMap) {
                ...
                if (timelineName === "position" || timelineName === "spacing") {
                  ...
                  if (timelineName === "spacing") {
                    timeline = new core.PathConstraintSpacingTimeline(
                      timelineMap.length,
                    );
                    if (
                      data.spacingMode == core.SpacingMode.Length ||
                    ...
                    timeline = new core.PathConstraintPositionTimeline(
                      timelineMap.length,
                    );
                    if (data.positionMode == core.PositionMode.Fixed)
                      timelineScale = scale;
                  ...
                  duration = Math.max(
                    ...
                    timeline.frames[
                      (timeline.getFrameCount() - 1) *
                        core.PathConstraintPositionTimeline.ENTRIES
                    ],
                  );
                } else if (timelineName === "mix") {
                  var timeline = new core.PathConstraintMixTimeline(
                    timelineMap.length,
                  );
                  timeline.pathConstraintIndex = index;
                  var frameIndex = 0;
                  ...
                  duration = Math.max(
                    ...
                    timeline.frames[
                      (timeline.getFrameCount() - 1) *
                        core.PathConstraintMixTimeline.ENTRIES
                    ],
                  );
                }
              }
              ...
              for (var slotName in deformMap) {
                ...
                for (var timelineName in slotMap) {
                  ...
                  for (var j = 0; j < timelineMap.length; j++) {
                    ...
                    var deform = void 0;
                    var verticesValue = this.getValue(
                      valueMap,
                      "vertices",
                      null,
                    );
                    if (verticesValue == null)
                      deform = weighted
                        ? core.Utils.newFloatArray(deformLength)
                        : vertices;
                    else {
          ...
          if (drawOrderNode != null) {
            ...
            for (var j = 0; j < drawOrderNode.length; j++) {
              ...
              if (offsets != null) {
                ...
                var unchanged = core.Utils.newArray(
          ...
          if (map.events) {
            ...
            for (var i = 0; i < map.events.length; i++) {
              ...
              var event_5 = new core.Event(
                core.Utils.toSinglePrecision(eventMap.time),
                eventData,
              );
          ...
          skeletonData.animations.push(
            new core.Animation(name, timelines, duration),
          );
        };
        SkeletonJson.prototype.readCurve = function (
          map,
          timeline,
          frameIndex,
        ) {
          ...
          var iterateParser = function () {
            while (true) {
              ...
              if (line.length == 0) page = null;
                ...
                var orig = new PIXI.Rectangle(
                  0,
                  0,
                  originalWidth,
                  originalHeight,
                );
                var trim = new PIXI.Rectangle(
                  offsetX,
                ...
                if (PIXI.VERSION[0] != "3") {
                  region.texture = new PIXI.Texture(
                    region.page.baseTexture,
                    frame,
                    orig,
                    trim,
                    rotate,
        ...
        TransformConstraint.prototype.applyAbsoluteWorld = function () {
          ...
          for (var i = 0, n = bones.length; i < n; i++) {
            ...
            if (translateMix != 0) {
              var temp = this.temp;
              target.localToWorld(
                temp.set(this.data.offsetX, this.data.offsetY),
              );
        ...
        TransformConstraint.prototype.applyRelativeWorld = function () {
          ...
          for (var i = 0, n = bones.length; i < n; i++) {
            ...
            if (shearMix > 0) {
              ...
              r =
                Math.atan2(d, b) +
                (r - core.MathUtils.PI / 2 + offsetShearY) * shearMix;
              var s = Math.sqrt(b * b + d * d);
              mat.c = Math.cos(r) * s;
              mat.d = Math.sin(r) * s;
              modified = true;
    ...
    (function (core) {
      ...
      var Pow = (function (_super) {
        ...
        Pow.prototype.applyInternal = function (a) {
          ...
          return (
            Math.pow((a - 1) * 2, this.power) / (this.power % 2 == 0 ? -2 : 2) +
            1
          );
        };
        return Pow;
      ...
      var PowOut = (function (_super) {
        ...
        PowOut.prototype.applyInternal = function (a) {
          return (
            Math.pow(a - 1, this.power) * (this.power % 2 == 0 ? -1 : 1) + 1
          );
        };
        return PowOut;
      })(Pow);
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var PointAttachment = (function (_super) {
        ...
        PointAttachment.prototype.computeWorldPosition = function (
          bone,
          point,
        ) {
          var mat = bone.matrix;
      ...
      var RegionAttachment = (function (_super) {
        ...
        RegionAttachment.prototype.updateOffset = function () {
          ...
          var localX =
            ...
            this.region.offsetX * regionScaleX;
          var localY =
            (-this.height / 2) * this.scaleY +
            this.region.offsetY * regionScaleY;
  ...
  (function (pixi_spine) {
    ...
    (function (core) {
      var JitterEffect = (function () {
        ...
        JitterEffect.prototype.transform = function (
          position,
          uv,
          light,
          dark,
        ) {
          position.x += core.MathUtils.randomTriangular(
            -this.jitterX,
            this.jitterY,
          );
          position.y += core.MathUtils.randomTriangular(
            -this.jitterX,
            this.jitterY,
          );
        };
    ...
    function atlasParser() {
      return function (resource, next) {
        ...
        var metadataSkeletonScale = metadata
          ? resource.metadata.spineSkeletonScale
          : null;
        ...
        if (metadataAtlas && metadataAtlas.pages) {
          var spineJsonParser = new pixi_spine.core.SkeletonJson(
            new pixi_spine.core.AtlasAttachmentLoader(metadataAtlas),
          );
        ...
        var atlasPath =
          resource.url.substr(0, resource.url.lastIndexOf(".")) +
          metadataAtlasSuffix;
        ...
        this.add(
          ...
          function (atlasResource) {
            new pixi_spine.core.TextureAtlas(
              atlasResource.xhr.responseText,
              adapter,
              function (spineAtlas) {
                var spineJsonParser = new pixi_spine.core.SkeletonJson(
                  new pixi_spine.core.AtlasAttachmentLoader(spineAtlas),
                );
                if (metadataSkeletonScale) {
                  spineJsonParser.scale = metadataSkeletonScale;
                }
                resource.spineData = spineJsonParser.readSkeletonData(
                  resource.data,
                );
  ...
  (function (pixi_spine) {
    ...
    var Spine = (function (_super) {
      ...
      Object.defineProperty(Spine.prototype, "autoUpdate", {
        ...
        set: function (value) {
          this.updateTransform = value
            ? Spine.prototype.autoUpdateTransform
        ...
        for (var i = 0, n = slots.length; i < n; i++) {
          ...
          if (attachment instanceof pixi_spine.core.RegionAttachment) {
            ...
            if (slotContainer.transform) {
              ...
              slotContainer.displayObjectUpdateTransform =
                SlotContainerUpdateTransformV3;
            }
      ...
      Spine.prototype.createSprite = function (slot, attachment, defName) {
        ...
        sprite.rotation =
          attachment.rotation * pixi_spine.core.MathUtils.degRad;
        sprite.anchor.x = 0.5;
        sprite.anchor.y = 0.5;
      ...
      Spine.prototype.hackTextureBySlotIndex = function (
        slotIndex,
        texture,
        size,
      ) {
      ...
      Spine.prototype.hackTextureBySlotName = function (
        slotName,
        texture,
        size,
      ) {
      ...
      Spine.prototype.newMesh = function (
        texture,
        vertices,
        uvs,
        indices,
