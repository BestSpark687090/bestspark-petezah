  ...
  (() => {
    ...
    function be(e, t) {
      ...
      var n,
        ...
        r =
          t.width ||
          ((i = we((n = e), "border-left-width")),
          (o = we(n, "border-right-width")),
          n.clientWidth + i + o),
        a =
          t.height ||
          (function (e) {
            ...
            case 0:
              return (
                ...
                (n && !Le(e.src)) || (i && !Le(e.href.baseVal))
                  ? [4, je((o = n ? e.src : e.href.baseVal), Be(o), t)]
                  : [2]
              );
            case 1:
              return (
      ...
      var a = function () {
        if (pn || !fn || !An.length || o > 10)
          return (
            ...
            window.removeEventListener("contextmenu", jn),
            clearInterval(t),
        ...
        ((o = 0),
          Gn(!1),
          ni.__playtestCaptureHTML === Kn
            ? ((ni.__playtestCaptureHTML = ""), Vn(!1))
          ...
          ((this.gameStarted = !1),
            ...
            (this.setDebug = function (t) {
              (void 0 === t && (t = !0),
                window.location.hostname.endsWith("poki-gdn.com")
                  ? t && Li.track(e.tracking.debugTrueInProduction)
                  : ((T.debug = t),
            ...
            (this.gameLoadingFinished = function () {
              ...
              (clearInterval(window.pokiCancelProgressInterval),
                Li.track(e.tracking.screen.gameLoadingFinished, {
                  transferSize: Yt(),
                  trackers: ((i = window),
                  (o = []),
            ...
            (this.gameplayStart = function (n) {
              if (i.ignoreEvents())
                ...
                ((i.duringGameplay = !0),
                  i.gameStarted ||
                    ((i.gameStarted = !0),
                    Li.track(e.tracking.screen.firstRound),
                    i.monetization.startStartAdsAfterTimer()));
                var o = i.badEventsCounter;
                (setTimeout(function () {
                  var r;
                  (performance.now() - t.lastInteractionTime < 5e3 &&
                    (r = i.lastInteractionEvent),
                    Li.track(
            ...
            (this.playtestSetCanvas = function (e) {
              e
                ? ((t.__playtestCanvas = [].concat(e)), Fn(t.__playtestCanvas))
                : (t.__playtestCanvas = []);
            }),
                ...
                new Promise(function (n, i) {
                  ...
                  if (S.isPokiIframe || S.isInspector) {
                    ...
                    (r.forEach(function (e) {
                      ...
                      _.sendMessage(e.message.setPokiURLParams, {
                        params: t,
                      }));
                  } else
            ...
            (this.__playerIsActiveEvent = function () {
              (window.removeEventListener(
                ...
                Li.track(e.tracking.screen.playerActive),
                (i.playerActiveTimeout = setTimeout(function () {
                  (window.addEventListener(
                    "pointermove",
                    i.__playerIsActiveEvent,
    ...
    var pi,
      ...
      bi = 0,
      ki = fi(
        fi([], Object.values(e.tracking.screen), !0),
        [
      ...
      xi =
        (((pi = {})[e.tracking.screen.commercialBreak] = "commercialBreak"),
        (pi[e.tracking.screen.gameLoadingFinished] = "gameLoadingFinished"),
        (pi[e.tracking.screen.gameplayStart] = "gameplayStart"),
        (pi[e.tracking.screen.gameplayStop] = "gameplayStop"),
        (pi[e.tracking.screen.rewardedBreak] = "rewardedBreak"),
        pi),
      Ii = [],
      Ei = [];
    try {
          ...
          if (gi) {
            ...
            gi.addEventListener("close", function (t) {
              (console.info(
                ...
                (gi = null),
                _i(),
                Li.track(e.tracking.playtest.closed, {
                  reason: ""
                    .concat(t.reason, ":")
                    .concat(t.code, ":")
                    .concat(t.wasClean),
      ...
      if (n) {
        ...
        (Li.track(e.tracking.playtest.showModal, {
          ...
          new Promise(function (e, t) {
              ...
              var t = performance.now() + 12e4,
                i = setInterval(function () {
                  ...
                  !(function () {
                    ...
                    yi &&
                    o - yi > 1e4 &&
                    (Li.track(e.tracking.playtest.noCanvas),
                    console.info(
                  ...
                  o > t &&
                    (Li.track(e.tracking.playtest.notLoaded),
                    clearInterval(i),
                    console.info(
            ...
            .catch(function (t) {
              (Li.track(e.tracking.playtest.rejected),
                console.info(
        ...
        if (t.metrictestID) {
          ...
          r = setInterval(function () {
            ...
            if ((a || (d = 6e4), e - i > d))
              return (
                clearInterval(r),
                removeEventListener("beforeunload", s),
                void ui(t.metrictestID, o, i, n, !0)
              );
      ...
      Mi = (function () {
        ...
        return (
          (n.track = function (t, i) {
            ...
            if (-1 === Bi.indexOf(t))
              throw new TypeError(
                "Invalid 'event', must be one of ".concat(Bi.join(", ")),
              );
            if ("object" != typeof a)
          ...
          (n.setupObserver = function () {
            ((Di._pokiSessionGlobalName = "pokiSession"),
              (Di._pokiUserGlobalName = "pokiUser"),
              (Di._pokiContextGlobalName = "pokiContext"),
              (Di._pokiTrackerGlobalName = "pokiTracker"),
              (function (e, n, s) {
                var h = null;
                try {
                  ((h = l())
    ...
    var Oi,
      ...
      Hi = function () {
        (Vi++,
          (Oi = setTimeout(Hi, 100 * Vi)),
          window.__tcfapi &&
            window.__tcfapi("ping", 2, function (e, t) {
              t &&
                (null == e ? void 0 : e.cmpLoaded) &&
                ((Gi = !0), clearTimeout(Oi));
            }));
      },
      Fi = function () {
        (Vi++,
          (ji = setTimeout(Fi, 100 * Vi)),
          window.__uspapi &&
    ...
    function no() {
      var e = S.country;
      return "US" === e ? 1.49 : $i.includes(e) ? 0.49 : 0.15;
    }
                ...
                if ((y.length > 0 && (v = y[0]), v)) {
                  var w =
                    null ===
                      ...
                      ? void 0
                      : h.join(",");
                  ("richaudience" === v.bidderCode && (w = v.meta),
                    L.addVideoDataAnnotations({
                      adDomain: w,
                      HBAdDomain: w,
    ...
    var Fo,
      ...
      Xo = function () {
        return Qo
          ...
          : "/"
              .concat(Xi, "/")
              .concat(Wo, "_ingame_rewarded_google/")
              .concat(S.siteID, "_")
              .concat(Wo, "_ingame_rewarded_google");
      },
      Zo = function (t) {
                  ...
                  googletag.defineOutOfPageSlot &&
                    ...
                    Object.keys(e).forEach(function (t) {
                      var n,
                        i = e[t];
                      "" !== i &&
                        (null === (n = null == Fo ? void 0 : Fo.setTargeting) ||
                          void 0 === n ||
                          n.call(Fo, t, i));
                    }));
                })(t),
      ...
      Jo = (function () {
        function t(t, n) {
          ...
          ((this.retries = 0),
            ...
            (this.usePokiAdserver = Ho()),
            (this.totalRetries = n.totalRetries || Zi.waterfallRetries || 1),
            (this.timing = n.timing || new Yi(Zi.adTiming)),
        ...
        return (
          ...
          (t.prototype.start = function () {
            this.activeQueue.length > 0 ||
              ((this.activeQueue = Ko([], this.storedQueue, !0)),
              (this.active = !0),
              this.continue());
          }),
      ...
      return nr(this, void 0, void 0, function () {
        ...
        return ir(this, function (t) {
          switch (t.label) {
            case 0:
              (tr ||
                ((tr = document.createElement("video")).setAttribute(
                  "playsinline",
                  "playsinline",
                ),
              ...
              fetch(
                ...
                .then(function (o) {
                  ((t.innerAdContainer.innerHTML = '<a href="'
                    ...
                    (n.houseAdId = o.id),
                    (n.isEmpty = !1),
                    Li.track(e.tracking.ads.display.impression, n),
                    R(
                      Er(Er({}, i), {
                        event: "impression",
                      }),
      ...
      return (
                ...
                if (s && s.gptSlot) {
                  ...
                  (s.onDisplayRendered && s.onDisplayRendered(g),
                    ...
                    g && s.backfillHouseads
                      ...
                      : Li.track(e.tracking.ads.display.impression, k));
                }
              }),
              window.googletag
                .pubads()
                .addEventListener("impressionViewable", function (n) {
                  ...
                  (((null ===
                    ...
                    Li.track(e.tracking.ads.rewardedWeb.impression),
                    setTimeout(function () {
        ...
        (t.prototype.renderAd = function (e) {
          ...
          (w.refreshNumber > 0 && (b = w.innerAdContainer),
            b ||
              (i.appendChild(w.innerAdContainer),
                ...
                : window.googletag.cmd.push(function () {
                    ...
                    e &&
                      ...
                      (n.totalRefreshNumber[w.adUnitPath] ||
                        (n.totalRefreshNumber[w.adUnitPath] = 0),
                      n.setupGPT(
                        w,
                        Er(Er({}, s), {
            ...
            if (r) {
              for (
                r.onCanDestroy &&
                  ...
                  Li.track(e.tracking.screen.destroyAd, {
        ...
        return (
          ...
          (t.prototype.loadPokiSettings = function () {
            ...
            (T.init(o, a),
              ...
              Li.setupDefaultEvents(),
              Ni(),
              (this.playerSkin = new lr({
                wrapper: s,
              })),
              window.addEventListener(
                "resize",
                  ...
                  case 2:
                    return (
                      ...
                      S.familyFriendly || S.nonPersonalized
                        ? (S.familyFriendly && _r.enforceFamilyFriendlyFlow(),
                          E("nonPersonalized", "true"),
                          _r.enforceNonPersonalized())
                        : v.push(
                            O(
                              "https://a.poki-cdn.com/prebid/prebid8.52.2-multi.js",
                            ),
                            O("https://c.amazon-adsystem.com/aax2/apstag.js"),
                          ),
                          ...
                          .then(function (t) {
                            try {
                              ...
                              ("rejected" === n.status && (m.GPTRejected = !0),
                                Uo(i, m.adSettings.bidderLimitation),
                              ...
                              if (
                                ...
                                (m.criteria = zr({}, a.customCriteria)),
                                (m.ima = new fr(s)),
                                m.playerSkin.setupEvents(m),
                                m.startStartAdsAfterTimerOnInit &&
                                  Nr.startStartAdsAfterTimer(),
                                (m.waterfall = new Yo(m.ima, {
                                  timing: Nr,
                                  totalRetries: d,
                                })),
                  ...
                  if (f === e.ads.position.rewarded || Nr.requestPossible())
                    if (
                      ...
                      if (!this.ima || this.sdkImaError || this.IMARejected)
                        ...
                        var m = zr(
                          zr(zr({}, this.genericCriteria()), this.criteria),
                          {
                            position: f,
            ...
            (L.addEventListener(e.ready, function () {
              ...
              L.addEventListener(e.ads.video.error, function () {
                ...
                (null == n ? void 0 : n.HBVastUrl) &&
                  ...
                  O("https://a.poki.com/ads/vast-client-2.js", !0)
                    .then(function () {
