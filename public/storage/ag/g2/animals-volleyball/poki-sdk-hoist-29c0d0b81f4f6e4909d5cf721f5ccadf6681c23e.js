(() => {
  ...
  function u() {
    ...
    try {
      ...
      try {
        r(e, "getSession", sessionStorage.getItem(i));
      } catch (t) {
        r(e, "getSession", t);
      }
    }
  ...
  function l() {
    ...
    try {
      ...
      try {
        r(e, "getPreviousSessionCount", sessionStorage.getItem(i));
      } catch (t) {
    ...
    try {
      ...
      try {
        r(e, "getPreviousSessionCount", t(i));
      } catch (t) {
        r(e, "getPreviousSessionCount", t);
      }
    }
  ...
  function p() {
    ...
    try {
      ...
      if (o) {
        var a = JSON.parse(o);
        !c(a, !0) || (n && a.id !== n.id) || (e = Math.max(e, a.depth));
      }
    } catch (e) {
      var s = null;
      try {
  ...
  const v = function (e, t) {
      ...
      e = e.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
      var o = new RegExp("(?:[\\?&]|^)".concat(e, "=([^&#]*)")).exec(
        t ||
          (null ===
            (n =
  ...
  var y,
    ...
    A = {
      ...
      device: g() ? "mobile" : m() ? "tablet" : "desktop",
        ...
        (null ===
          (w =
            null === document || void 0 === document
              ? void 0
              : document.referrer) || void 0 === w
          ? void 0
          : w.includes("inspector.poki.dev")) ||
        "1" === v("inspector"),
      houseAdsOnly: !1,
      ccpaApplies: v("ccpaApplies"),
      country: (v("country") || "").toUpperCase(),
      gameID: v("game_id"),
      gdprApplies: ((b = (v("country") || "").toUpperCase()), h.includes(b)),
  ...
  const x = (function () {
    function t() {}
    return (
      (t.sendMessage = function (t, n, o) {
        if ((void 0 === o && (o = window.parent), !f(t, e.message))) {
          var r = Object.keys(e.message).map(function (e) {
            return "poki.message.".concat(e);
          });
          throw new TypeError(
            "Argument 'type' must be one of ".concat(r.join(", ")),
          );
        }
        var i = n || {};
        (S.gameID &&
          S.versionID &&
          (i.pokifordevs = { game_id: S.gameID, game_version_id: S.versionID }),
          null == o || o.postMessage({ type: t, content: i }, "*"));
      }),
      t
    );
  })();
    ...
    return (
      ...
      (e.init = function (t, n) {
        ...
        (void 0 === t &&
          ...
          S.isInspector
            ? ((t = !0), (n = !0))
            : i.endsWith(".poki-gdn.com") && ((t = !1), (n = !1)),
          S.debugMode && (t = !0),
          S.logMode && (n = !0),
          void 0 === n && (n = t),
          (e.debug = t),
  ...
  var I = function (e) {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        "object" == typeof e[n] ? (t = t.concat(I(e[n]))) : t.push(e[n]);
      }),
      t
    );
  };
      ...
      return (
        ...
        (e.addEventListener = function (e, t, n) {
          ...
          if (
            ...
            var r = function (n) {
              (o.removeEventListener.bind(o)(e, r), t(n));
            };
            ...
            T.debug &&
              "test" !==
                (null ===
                  ...
                  : o.NODE_ENV) &&
              console.info(e, t));
          for (var r = Object.keys(this.listeners), i = 0; i < r.length; i++) {
            var a = r[i];
            if (e === a)
              for (var s = this.listeners[a], c = 0; c < s.length; c++)
                s[c](C(C({}, this.videoDataAnnotations), t));
          }
        }),
  ...
  const D = function (e) {
    ...
    if ("undefined" != typeof window && "undefined" != typeof fetch) {
      ...
      T.debug
        ? console.log("PokiAdServer Tracking: ", r)
  ...
  const O = function (e, t) {
    return (
      ...
      new Promise(function (n, o) {
        ...
        ((r.type = t ? "module" : "text/javascript"),
          (r.async = !0),
          (r.src = e));
        var i = function () {
          (r.readyState &&
            ...
            (n(), (r.onload = null), (r.onreadystatechange = null));
        };
        ((r.onload = i),
  ...
  var j = function (e, t) {
      ...
      return null !== n && (n.constructor.name === t.name || j(n, t));
    },
    H = new Set([
      "cx",
      "cy",
    ...
    U = { html: void 0, svg: void 0 };
  function q(e, t) {
    var n;
    void 0 === t && (t = {});
    var o = j(e, SVGElement) ? "svg" : "html",
      r = U[o];
    if (r) return r;
    var i =
  ...
  function W(e, t) {
    ...
    var n,
      ...
      i =
        t.width ||
        ((o = K((n = e), "border-left-width")),
        (r = K(n, "border-right-width")),
        n.clientWidth + o + r),
      a =
        t.height ||
        (function (e) {
          var t = K(e, "border-top-width"),
            n = K(e, "border-bottom-width");
    ...
    return R(this, void 0, void 0, function () {
      ...
      return B(this, function (a) {
        return (
          ...
          r.setAttribute("width", "".concat(t)),
          r.setAttribute("height", "".concat(n)),
          r.setAttribute("viewBox", "0 0 ".concat(t, " ").concat(n)),
  ...
  function X(e, t, n, o) {
    var r = ".".concat(e, ":").concat(t),
      i = n.cssText
        ...
        : (function (e, t) {
            return q(document.documentElement, t)
              .map(function (t) {
                var n = e.getPropertyValue(t),
                  o = e.getPropertyPriority(t);
                return ""
                  .concat(t, ": ")
                  .concat(n)
                  .concat(o ? " !important" : "", ";");
      ...
      return ie(this, function (i) {
        switch (i.label) {
          case 0:
            return [4, fetch(e, t)];
          case 1:
            if (404 === (o = i.sent()).status)
              throw new Error('Resource "'.concat(o.url, '" not found'));
            return [4, o.blob()];
          case 2:
            return (
              (r = i.sent()),
        ...
        switch (c.label) {
          ...
          case 1:
            return (
              ...
              [
                4,
                ce(e, n.fetchRequestInit, function (e) {
                  var n = e.res,
                    o = e.result;
                  return (
    ...
    return de(this, void 0, void 0, function () {
      ...
      return pe(this, function (o) {
        switch (o.label) {
          case 0:
            try {
              if (e.getContext("2d")) return [2, J(e.toDataURL())];
            } catch (e) {}
  ...
  function ye(e, t, n) {
    return (
      (function (e, t, n) {
        ...
        if (o) {
          ...
          r.cssText
            ...
            : q(e, n).forEach(function (n) {
                var i = r.getPropertyValue(n);
                if ("font-size" === n && i.endsWith("px")) {
                  var a =
                    Math.floor(parseFloat(i.substring(0, i.length - 2))) - 0.1;
                  i = "".concat(a, "px");
                }
                (j(e, HTMLIFrameElement) &&
                  "display" === n &&
                  "inline" === i &&
                  (i = "block"),
                  "d" === n &&
                    t.getAttribute("d") &&
                    (i = "path(".concat(t.getAttribute("d"), ")")),
      ...
      j(t, HTMLElement) &&
      ((function (e, t) {
        (j(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
          j(e, HTMLInputElement) && t.setAttribute("value", e.value));
      })(e, t),
      (function (e, t) {
                    ...
                    return (function (e, t) {
                      return de(this, void 0, void 0, function () {
                        return pe(this, function (n) {
                          return j(e, HTMLCanvasElement)
                            ? [2, fe(e)]
                            : j(e, HTMLVideoElement)
                              ? [2, he(e, t)]
                              : j(e, HTMLIFrameElement)
                                ? [2, ve(e, t)]
                                : [2, e.cloneNode(me(e))];
                            ...
                            case 0:
                              return me(t)
                                ...
                                : ((o = []),
                                  0 ===
                                    (o =
                                      ge(e) && e.assignedNodes
                                        ? F(e.assignedNodes())
                                        : j(e, HTMLIFrameElement) &&
                                            (null === (r = e.contentDocument) ||
                                            void 0 === r
                                              ? void 0
                                              : r.body)
                          ...
                          switch (v.label) {
                            ...
                            case 1:
                              return h < n.length
                                ...
                                : [3, 4];
                            case 2:
                              ((c[u] = v.sent()), (v.label = 3));
                            case 3:
                              return (h++, [3, 1]);
                            case 4:
                              if ((l = Object.values(o)).length) {
                                for (
                                  d = "http://www.w3.org/1999/xhtml",
                                    (p = document.createElementNS(
                                      d,
                                      "svg",
                                    )).setAttribute("xmlns", d),
      ...
      return ke(this, function (i) {
        return Te(e)
          ? ((o = (function (e, t) {
              ...
              return n
                ? e.replace(xe, function (e) {
                    for (;;) {
                      var t = Se.exec(e) || [],
                        o = t[0],
                        r = t[2];
                      if (!r) return "";
                      if (r === n) return "src: ".concat(o, ";");
                    }
                  })
                : e;
            })(e, n)),
  ...
  function Le(e, t) {
    return Pe(this, void 0, void 0, function () {
      return Ce(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, _e("background", e, t)];
          case 1:
            return n.sent() ? [3, 3] : [4, _e("background-image", e, t)];
          case 2:
            (n.sent(), (n.label = 3));
          case 3:
            return [4, _e("mask", e, t)];
          case 4:
            return n.sent() ? [3, 6] : [4, _e("mask-image", e, t)];
          case 5:
            (n.sent(), (n.label = 6));
          case 6:
            return [2];
    ...
    return Pe(this, void 0, void 0, function () {
      ...
      return Ce(this, function (a) {
        switch (a.label) {
          case 0:
            return (
              (n = j(e, HTMLImageElement)),
              (o = j(e, SVGImageElement)),
              (n && !ae(e.src)) || (o && !ae(e.href.baseVal))
                ? [4, le((r = n ? e.src : e.href.baseVal), oe(r), t)]
                : [2]
            );
          case 1:
            return (
              ...
              [
                ...
                new Promise(function (t, o) {
                  ...
                  var r = e;
                  (r.decode && (r.decode = t),
                    "lazy" === r.loading && (r.loading = "eager"),
  ...
  function Oe(e, t) {
    return Pe(this, void 0, void 0, function () {
      return Ce(this, function (n) {
        switch (n.label) {
          case 0:
            return z(e) ? [4, Le(e, t)] : [3, 4];
          case 1:
            return (n.sent(), [4, Me(e, t)]);
          case 2:
            return (n.sent(), [4, De(e, t)]);
          case 3:
            (n.sent(), (n.label = 4));
          case 4:
            return [2];
  ...
  function Ge(e) {
    return Re(this, void 0, void 0, function () {
      ...
      return Be(this, function (o) {
        switch (o.label) {
          case 0:
            return null != (t = Ne[e]) ? [2, t] : [4, fetch(e)];
          case 1:
          ...
          (i = r.map(function (r) {
            return Re(a, void 0, void 0, function () {
              ...
              return Be(this, function (a) {
                return (
                  (i = r.replace(o, "$1")).startsWith("https://") ||
                    (i = new URL(i, e.url).href),
                  [
                    2,
                    ce(i, t.fetchRequestInit, function (e) {
                      var t = e.result;
                      return (
                        (n = n.replace(r, "url(".concat(t, ")"))),
                        [r, t]
                      );
                    }),
                  ]
  ...
  function Fe(e) {
    ...
    for (
      ...
      if (null === (a = o.exec(n))) break;
      t.push(a[0]);
    }
    n = n.replace(o, "");
    for (
      var r = /@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,
        i = new RegExp(
      ...
      return Be(this, function (r) {
        return (
          ...
          e.forEach(function (n) {
            if ("cssRules" in n)
              try {
                F(n.cssRules || []).forEach(function (e, r) {
  ...
  function je(e) {
    return e
      ...
      .filter(function (e) {
        return Te(e.style.getPropertyValue("src"));
      });
  }
  function He(e, t) {
    return Re(this, void 0, void 0, function () {
      return Be(this, function (n) {
        switch (n.label) {
          case 0:
            ...
            return [4, ze(F(e.ownerDocument.styleSheets), t)];
          case 1:
            return [2, je(n.sent())];
        }
      });
              ...
              [
                ...
                Promise.all(
                  n.map(function (e) {
                    ...
                    return Ie(e.cssText, n, t);
                  }),
                ),
              ]
            );
          case 2:
            return [2, o.sent().join("\n")];
        }
      });
    });
  }
        ...
        switch (s.label) {
          case 0:
            return null == t.fontEmbedCSS
              ? [3, 1]
              : ((o = t.fontEmbedCSS), [3, 5]);
          case 1:
            return t.skipFonts ? ((r = null), [3, 4]) : [3, 2];
          case 2:
            return [4, Ue(e, t)];
          case 3:
            ((r = s.sent()), (s.label = 4));
  ...
  function Ye(e) {
    return Ke(this, arguments, void 0, function (e, t) {
      var n, o, r, i;
      return (
        void 0 === t && (t = {}),
        We(this, function (a) {
          switch (a.label) {
            ...
            case 1:
              return [4, qe((i = a.sent()), t)];
            case 2:
              return (a.sent(), [4, Oe(i, t)]);
            case 3:
              return (
                a.sent(),
                (function (e, t) {
                ...
                t.skipAutoScale ||
                  (function (e) {
                    (e.width > Y || e.height > Y) &&
                      (e.width > Y && e.height > Y
                        ? e.width > e.height
                          ? ((e.height *= Y / e.width), (e.width = Y))
                          : ((e.width *= Y / e.height), (e.height = Y))
                        : e.width > Y
                          ? ((e.height *= Y / e.width), (e.width = Y))
                          : ((e.width *= Y / e.height), (e.height = Y)));
                  })(a),
  ...
  var $e,
    ...
    nt = console.error,
    ot = ["Audio callback had starved sending audio by"],
    rt = !1,
    it = Math.random().toString(36).substring(2);
  function at(e, t) {
    (void 0 === t && (t = !0),
      S.gameID && !S.isPlayground
        ? tt(function (t) {
            try {
              var n = e.message || Xe(e);
              (et.push({ n: e.name, m: n, s: JSON.stringify(e.stack) }),
                $e && $e({ name: e.name, message: n, stack: e.stack }));
  ...
  function st(e) {
    Ze(e.reason)
      ...
      : at({
          ...
          message: JSON.stringify(e.reason) || Xe(e),
        });
  }
  function ct(e) {
    Ze(e.error) ? at(e.error) : at(e);
  }
  function ut() {
    if (!rt) {
      ((rt = !0),
        window.addEventListener("unhandledrejection", st),
        window.addEventListener("error", ct));
      try {
        console.error = function () {
          ...
          (ot.some(function (e) {
            return n.includes(e);
          }) || at({ name: "console.error", message: n }, !1),
            nt.apply(console, e));
        };
      } catch (e) {}
    }
  }
  ("undefined" == typeof window || S.isPlayground || ut(),
    (dt = "pokiSdkHidden"),
    (pt = "pokiSdkInsideContainer"),
    (ft = "pokiSdkPauseButtonContainer"),
    (ht = "pokiSdkPauseButton"),
    (vt = "pokiSdkPauseButtonBG"),
    (gt = "pokiSdkStartAdButton"),
    (mt = "pokiSdkProgressBar"),
    (yt = "pokiSdkSpinnerContainer"),
    (wt = "pokiSdkVisible"),
    (kt =
      ("\n."
        .concat(
    ...
    (xt = function () {
      ...
      return kt(void 0, St([], e, !0), void 0, function (e) {
        var t;
        return (
          void 0 === e && (e = null),
          At(this, function (n) {
    ...
    (Tt = function (e, t) {
      return kt(void 0, void 0, void 0, function () {
        var n, o, r, i, a, s, c, u, l, d, p, f, h, v, g, m, y, w, b, k, A, S, x;
          ...
          switch (E.label) {
            case 0:
              return (
                ...
                ((c = new Image()).crossOrigin = "Anonymous"),
            ...
            case 1:
              return (
                ...
                (v = p[2]),
                (g = p[3]),
                ((m = document.createElement("canvas")).width = f.width),
                (m.height = f.height),
                (y = m.getContext("2d")).drawImage(f, 0, 0),
                (w = m.width / h.width),
                (b = h.height * w),
                (k = m.height - b),
                y.drawImage(h, 0, k, m.width, b),
                (A = v.height * w),
                It(y, v, 64 * w, k + 20 * w, A, A, 24 * w),
                ...
                (y.textBaseline = "top"),
                (y.fillStyle = "#002b50"),
                (y.font = "700 ".concat(56 * w, "px TorusBold,sans-serif")),
                y.fillText(n, S, x),
                [2, m.toDataURL()]
              );
          }
    ...
    (It = function (e, t, n, o, r, i, a) {
      (e.save(), e.beginPath());
      var s = n + r,
        c = o + i;
      (e.moveTo(n + a, o),
        e.lineTo(s - a, o),
        e.quadraticCurveTo(s, o, s, o + a),
        e.lineTo(s, c - a),
        e.quadraticCurveTo(s, c, s - a, c),
        e.lineTo(n + a, c),
        e.quadraticCurveTo(n, c, n, c - a),
        e.lineTo(n, o + a),
        e.quadraticCurveTo(n, o, n + a, o),
        e.closePath(),
        e.clip(),
        e.drawImage(t, n, o, r, i),
        e.restore());
    }),
    (Pt = function () {
      return kt(void 0, void 0, void 0, function () {
        ...
        return At(this, function (c) {
          switch (c.label) {
                ...
                (n = function (e) {
                  ...
                  return (
                    ...
                    !(null === (n = e.classList) || void 0 === n
                      ...
                      : n.contains(lt)) &&
                    "true" !==
                      (null === (o = e.getAttribute) || void 0 === o
                        ? void 0
                        : o.call(e, "data-poki-playtest-skip"))
                  );
                }),
            ...
            case 2:
              return ((a = c.sent()), [3, 4]);
            case 3:
              return ((s = c.sent()), console.error(s), [3, 4]);
            case 4:
              return (
                (document.body.style.minWidth = o),
                (document.body.style.minHeight = r),
  ...
  var Vt = function (e, t, n, o) {
    ...
    en = 24;
  ((g() || m() || _t) && (en = 12),
    qt.setAttribute("data-poki-no-playtest", "true"),
    qt.addEventListener("webglcontextlost", function () {
      (console.info(
  ...
  var tn = { x: 0, y: 0 },
    ...
    dn = -1;
  function pn(e) {
    if (null !== Ut && Ht.length) {
      var t = Ht[0],
        n = t.width / Ut.width,
        o = t.height / Ut.height,
        r = (e.clientX - Ut.left) * n,
        i = (e.clientY - Ut.top) * o;
      ((tn.x = Math.max(0, Math.min(r, t.width))),
        (tn.y = Math.max(0, Math.min(i, t.height))));
    }
  }
  var fn = function (e) {
      Ht.length && qt && pn(e);
    ...
    hn = function (e) {
      Ht.length &&
        ...
        (0 === e.button
          ...
          : 2 === e.button
            ? ((rn = !0), (an = !1))
            : 1 === e.button && ((nn = !0), (on = !1), (rn = !0), (an = !1)),
        pn(e));
    },
    vn = function (e) {
      0 === e.button
  ...
  function gn() {
    ...
    e &&
      qt &&
      Kt &&
      ((Kt.fillStyle = "rgba(255, 255, 255, 0.5)"),
      Kt.fillRect(0, 0, qt.width, qt.height),
      (Kt.font = "48px Arial"),
      (Kt.fillStyle = "#009cff"),
      (Kt.textAlign = "center"),
      Kt.fillText(e, qt.width / 2, qt.height / 2));
  }
  function mn(e) {
    if (qt && Ht.length) {
      var t = Ht[0],
      ...
      if (n !== ln || o !== dn || e) {
        ((ln = n), (dn = o));
        var r = (Ut = t.getBoundingClientRect()).width,
          i = Ut.height;
        (0 !== r && 0 !== i) || ((r = n), (i = o));
        var a = g() || m(),
          s = _t ? 1024 : a ? 640 : 1280,
          c = Math.min(s / r, s / i, 1);
        ((r = Math.round(r * c)),
          (i = Math.round(i * c)),
          (cn = r / n),
          (un = i / o),
          e || qt.width !== r || qt.height !== i
            ? ((qt.width = r),
              (qt.height = i),
              console.info(
        ...
        switch (r.label) {
          case 0:
            ...
            if (
              (Wt ||
                ...
                0 === Ht.length
                  ? ((Wt.width = qt.width), (Wt.height = qt.height))
                  : ((Wt.width = Ht[0].width), (Wt.height = Ht[0].height)),
                Wt.addEventListener("contextlost", function () {
                  ((Wt = null), (Yt = null));
                })),
              !Yt && !(Yt = Wt.getContext("2d")))
            )
              return [2];
            r.label = 1;
          case 1:
            return (r.trys.push([1, 5, , 6]), performance.now(), [4, Ct(e)]);
          case 2:
            return (t = r.sent()) && t.length > 10
              ? [
                  4,
          ...
          case 3:
            ((n = r.sent()),
              requestAnimationFrame(function () {
                Wt &&
                  Yt &&
                  (Yt.clearRect(0, 0, Wt.width, Wt.height),
                  Yt.drawImage(
                    n,
                    0,
                    0,
          ...
          case 5:
            return (
              ...
              Jt++,
              ko.__playtestCaptureHTML === yo && Jt > 10 && (jt = !0),
              [3, 6]
            );
          case 6:
            return [2];
  ...
  function kn(e) {
    if (!jt) {
      Ht = e;
      for (var t = 0; t < Qt.length; t++) Qt[t].stop();
      for (t = 0; t < Zt.length; t++) Zt[t].readable.cancel();
      for (t = 0; t < Xt.length; t++) Xt[t].cancel();
      for (t = 0; t < $t.length; t++) $t[t].close();
      if (((Qt = []), (Zt = []), (Xt = []), ($t = []), 0 !== Ht.length))
        try {
          if (Lt) {
            var n = function (e) {
              var t = Ht[e].captureStream(en).getVideoTracks()[0];
              (Qt.push(t), $t.push(null));
              var n = new Blob(
                  [
              ...
              o.onmessage = function (t) {
                var n = t.data;
                $t.length <= e ||
                  (null !== $t[e] && $t[e].close(), ($t[e] = n));
              };
              try {
                o.postMessage({ track: t });
              } catch (e) {
                (console.error(
            ...
            for (t = 0; t < Ht.length; t++) n(t);
          } else {
            var o = function (e) {
              var t = Ht[e].captureStream(en).getVideoTracks()[0],
                n = new window.MediaStreamTrackProcessor(t),
                o = n.readable.getReader();
              (Qt.push(t), Zt.push(n), Xt.push(o), $t.push(null));
              var r = function () {
                o.read().then(function (t) {
                  ...
                  n || $t.length <= e
                    ? o.close()
                    : (null !== $t[e] && $t[e].close(), ($t[e] = o), r());
                });
              };
              r();
            };
            for (t = 0; t < Ht.length; t++) o(t);
          }
          mn(!0);
        } catch (e) {
          (console.error(
  ...
  function An() {
    var e = ko.__playtestCanvas;
    if ((null == e ? void 0 : e.length) && yn(e)) return e;
    var t = 0,
          ...
          a >= t &&
            (function (e) {
              ...
              for (var t = e, n = !0; t && t !== document.body; ) {
                ...
                if ("hidden" === o.visibility) return !1;
                if (n && (0 === t.offsetWidth || 0 === t.offsetHeight))
                  return !1;
                ("absolute" === o.position && (n = !1), (t = t.parentElement));
              }
              var r = e.getBoundingClientRect(),
                i = window.innerHeight || document.documentElement.clientHeight,
                a = window.innerWidth || document.documentElement.clientWidth;
              return !(r.right < 0 || r.bottom < 0 || r.left > a || r.top > i);
            })(e) &&
            (a > t && (o = []),
            o.push({ canvas: e, style: n, index: o.length }),
            (t = a));
        }
      }),
      0 === o.length)
    ) {
      if (ko.__playtestCaptureHTML === yo) {
        var r = document.createElement("canvas");
        return (
          (r.width = window.innerWidth),
          (r.height = window.innerHeight),
          r.setAttribute("data-poki-html-canvas", "true"),
          (r.pokiHtmlDummyCanvas = !0),
          [r]
        );
      }
      return [];
  ...
  function Sn(e) {
    ...
    ((jt = !1), kn(e), mn(!0));
    var t,
      n = qt.captureStream(en);
    (window.addEventListener("pointermove", fn, { capture: !0, passive: !0 }),
      window.addEventListener("pointerdown", hn, { capture: !0, passive: !0 }),
      window.addEventListener("pointerup", vn, { capture: !0, passive: !0 }),
      window.addEventListener("contextmenu", vn, { capture: !0, passive: !0 }));
    var o,
      r = 0;
    if (ko.__playtestCaptureHTML === yo) {
      var i = 0;
      t = setInterval(function () {
        if (qt) {
          var e = !!Ht[0].pokiHtmlDummyCanvas;
          !e ||
            (Ht[0].width === window.innerWidth &&
              Ht[0].height === window.innerHeight) ||
            ((Ht[0].width = window.innerWidth),
            (Ht[0].height = window.innerHeight));
          var t = !1;
          if (
    ...
    var a = function () {
      if (jt || !qt || !Ht.length || r > 10)
        return (
          ...
          window.removeEventListener("pointerup", vn),
          window.removeEventListener("contextmenu", vn),
          clearInterval(t),
          (ko.__playtestCaptureHTML = ""),
          (qt = null),
          (Kt = null),
          (Wt = null),
          (Yt = null),
      ...
      ((r = 0),
        mn(!1),
        ko.__playtestCaptureHTML === mo
          ? ((ko.__playtestCaptureHTML = ""), wn(!1))
          : ko.__playtestCaptureHTML === wo &&
            ((ko.__playtestCaptureHTML = ""), (Wt = null), (Yt = null)),
        Kt.clearRect(0, 0, qt.width, qt.height));
      ...
      (Wt &&
        Kt.drawImage(Wt, 0, 0, Wt.width, Wt.height, 0, 0, qt.width, qt.height),
        Gt(tn, nn, rn, cn, un, Kt),
        nn && on && ((nn = !1), (on = !1)),
        rn && an && ((rn = !1), (an = !1)),
        gn());
    };
    return (
      (o = setInterval(a, 1e3 / en)),
  ...
  function Pn() {
    var e,
      t,
      n,
      o = document.getElementById("poki-playtest-popup-reject"),
      r = document.getElementById("poki-playtest-popup-resolve");
    (null == o || o.removeEventListener("pointerdown", Pn),
      ...
      null === (e = document.getElementById("poki-playtest-popup-wrapper")) ||
        void 0 === e ||
        e.remove(),
      null === (t = document.getElementById("poki-playtest-template-markup")) ||
        void 0 === t ||
        t.remove(),
      null === (n = document.getElementById("poki-playtest-template-style")) ||
        void 0 === n ||
        n.remove());
  }
  function Cn(e) {
  ...
  function _n(e) {
    ...
    !(function (e) {
      ...
      ((t.innerHTML = Tn), e.appendChild(t.content));
          ...
          (function (e) {
            ...
            i &&
              [
                ...
                return i.addEventListener(e, Cn);
              });
          })({ rejectCallback: n, resolveCallback: o }));
      }));
  }
    ...
    return (
      ...
      (e.prototype.stats = function () {
        ...
        if (0 !== this.seconds.length) {
          ...
          return (
            isNaN(r) && (r = 0),
            "".concat(t, "|").concat(n, "|").concat(o, "|").concat(r)
          );
        }
      }),
      e
  ...
  function On(e) {
    for (var t = [], n = 0, o = 0; o < e.length; o++)
      if (n > 0) n--;
        ...
        var r = e[o];
        if ("string" == typeof r)
          ((n = (r.match(/%c/g) || []).length), t.push(r.replace(/%c/g, "")));
        else
          try {
            t.push(String(r));
          } catch (e) {
  ...
  var Rn,
    ...
    jn = 0,
    Hn = Gn(
      Gn([], Object.values(e.tracking.screen), !0),
      [
    ...
    Un =
      (((Rn = {})[e.tracking.screen.commercialBreak] = "commercialBreak"),
      (Rn[e.tracking.screen.gameLoadingFinished] = "gameLoadingFinished"),
      (Rn[e.tracking.screen.gameplayStart] = "gameplayStart"),
      (Rn[e.tracking.screen.gameplayStop] = "gameplayStop"),
      (Rn[e.tracking.screen.rewardedBreak] = "rewardedBreak"),
      Rn),
    qn = [],
    Kn = [];
  try {
    var Wn = function (e) {
      ...
      ((console[e] = function () {
        ...
        (t.apply(console, n),
          Kn &&
            Kn.push({ timeMs: performance.now(), level: e, message: On(n) }));
      }),
        qn.push(function () {
          console[e] = t;
        }));
    };
    (Wn("log"), Wn("info"), Wn("warn"), Wn("error"));
  } catch (e) {}
  function Yn() {
    ((Fn = null),
  ...
  function Jn(t, n) {
    ...
    o &&
      ((zn = new WebSocket(
        ...
        (to.track(e.tracking.playtest.error, { message: "websocket error" }),
          console.info("%cPOKI_PLAYTEST:%c error", "font-weight: bold", ""));
      }),
      zn.addEventListener("open", function () {
        if (zn) {
          if (zn.readyState === zn.OPEN) {
            ...
            try {
              var i = document.createElement("canvas"),
                ...
                s = i.getContext("webgl2", a);
              if (
                (s ||
                  (s = i.getContext("webgl", a)) ||
                  (s = i.getContext("experimental-webgl", a)),
                s)
              ) {
                var c = s,
                  u = c.getExtension("WEBGL_debug_renderer_info");
                (u && (r = c.getParameter(u.UNMASKED_RENDERER_WEBGL)),
                  r || (r = c.getParameter(c.RENDERER)));
              }
            } catch (e) {}
          ...
          (document.addEventListener("keydown", function (e) {
            h[e.code] || ((h[e.code] = !0), (v = !0));
          }),
            document.addEventListener("keyup", function (e) {
              h[e.code] && ((h[e.code] = !1), (v = !0));
            }));
          var g = setInterval(function () {
            ...
            (v &&
              ...
              zn.readyState === zn.OPEN &&
              zn.send(
                JSON.stringify({ type: "keyboard", offset: f(), keys: h }),
              ),
              (v = !1),
              e.forEach(function (e) {
                h[e] || delete h[e];
          ...
          ((Vn = function (e, t) {
            if (zn && zn.readyState === zn.OPEN) {
              zn.send(Xe({ type: "sdk-event", offset: f(t), event: e }));
              var n = Un[e];
              n &&
                zn.send(
                  Xe({
            ...
            ($e = function (e) {
              zn &&
                zn.readyState === zn.OPEN &&
                zn.send(
                  JSON.stringify({ type: "error", offset: f(), error: e }),
                );
            }),
            qn.forEach(function (e) {
              return e();
          ...
          var y = function (t) {
            var n = t.position;
            if (zn && zn.readyState === zn.OPEN) {
              var o = e.tracking.screen.commercialBreak,
                r = "Commercial Break";
              (n === e.ads.position.rewarded &&
                ((o = e.tracking.screen.rewardedBreak), (r = "Rewarded Break")),
                bn(r),
                zn.send(
                  JSON.stringify({ type: "sdk-event", offset: f(), event: o }),
                ));
            }
          };
          L.addEventListener(e.playtest.startVideo, y);
          var w = function () {
            bn("");
          };
          ...
          zn.addEventListener("close", function (t) {
            (console.info(
              ...
              (Vn = function () {}),
              L.removeEventListener(e.playtest.startVideo, y),
              ...
              (zn = null),
              Yn(),
              to.track(e.tracking.playtest.closed, {
                reason: ""
                  .concat(t.reason, ":")
                  .concat(t.code, ":")
                  .concat(t.wasClean),
  ...
  function Qn(t, n) {
    var o;
    if (n)
      (to.track(e.tracking.playtest.showModal, { show: !0 }),
        console.info("%cPOKI_PLAYTEST:%c init", "font-weight: bold", "", n),
        ((o = (null == t ? void 0 : t.gameTitle) || "this game"),
        new Promise(function (e, t) {
          return Bn(void 0, void 0, void 0, function () {
            return Nn(this, function (n) {
              return (
                ...
                _n({ rejectCallback: t, resolveCallback: e, gameTitle: o }),
                [2]
              );
            });
          });
          ...
          .then(function () {
            to.track(e.tracking.playtest.accepted);
            var t = performance.now() + 12e4,
              o = setInterval(function () {
                ...
                !(function () {
                  ...
                  jn &&
                  r - jn > 1e4 &&
                  (to.track(e.tracking.playtest.noCanvas),
                  console.info(
                ...
                var i = An();
                if (i.length) {
                  (clearInterval(o), to.track(e.tracking.playtest.starting));
                  try {
                    Jn(i, n);
                  } catch (e) {}
                }
                r > t &&
                  (to.track(e.tracking.playtest.notLoaded),
                  clearInterval(o),
                  console.info(
          ...
          .catch(function (t) {
            (to.track(e.tracking.playtest.rejected),
              console.info(
      ...
      ((Vn = function (n) {
        var o = performance.now() / 1e3,
          i = n === e.tracking.screen.gameplayStart;
        !(function (e, t, n, o) {
    ...
    eo = (function () {
      ...
      return (
        (a.track = function (t, n) {
          ...
          if (-1 === Xn.indexOf(t))
            throw new TypeError(
              "Invalid 'event', must be one of ".concat(Xn.join(", ")),
            );
          if ("object" != typeof i)
          ...
          if (null == s ? void 0 : s.pokiAdServer)
            switch (t) {
              case e.tracking.ads.status.started:
                var c = s.creativeId;
                (L.addVideoDataAnnotations({ houseAdId: c }),
                  (i.houseAdId = c));
                break;
              case e.tracking.ads.status.impression:
                c = null == i ? void 0 : i.creativeId;
                (D(Zn(Zn({}, i), { event: "video-impression", creativeId: c })),
                  L.addVideoDataAnnotations({ houseAdId: c }),
                  (i.houseAdId = c));
                break;
              ...
              case e.tracking.ads.status.completed:
                D(Zn(Zn({}, i), { event: "video-complete" }));
            }
          if ((t.includes("pokiTrackingRewardedWeb") && (i = s), T.log)) {
            if (
              "test" ===
              (null ===
                (r =
            ...
            Object.keys(i).length
              ? console.info(
                  "%cPOKI_TRACKER:%c Tracked event '".concat(t, "' with data:"),
                  "font-weight: bold",
                  "",
                  i,
                )
          ...
          (!(function (t) {
            if (
              ...
              try {
                (Vn(t.event),
                  null !== Fn &&
                    Fn.push({ event: t.event, timeMs: performance.now() }));
              } catch (e) {
                console.error("%cPOKI_PLAYTEST:%c", "font-weight: bold", "", e);
              }
          })({ event: t, data: i }),
            a.logToObserver
              ? a.pushEvent("sdk", "message", {
                  content: {
                    event: t,
                    data: i,
                    pokifordevs: { game_id: S.gameID, game_version_id: void 0 },
                  },
                  type: e.message.event,
                })
              : x.sendMessage(e.message.event, { event: t, data: i }));
        }),
        ...
        (a.setRequireConsent = function (e) {
          ((a.cmpRequired = e), a.setupObserverIfCMP());
        }),
        (a.setupObserverWithCMP = function (e) {
          ((a.cmpIndex = e), a.setupObserverIfCMP());
        }),
        (a.setupObserverIfCMP = function () {
          if (void 0 !== a.cmpRequired && void 0 !== a.cmpIndex)
            if (a.cmpRequired) {
              ...
              window.__tcfapi("addEventListener", 2, function (e, t) {
                !t ||
                  ...
                  (window.__tcfapi("getNonIABVendorConsents", 2, function (e) {
                    e &&
                      e.nonIabVendorConsents &&
                      e.nonIabVendorConsents[a.cmpIndex || 0] &&
                      a.setupObserver();
                  }),
                  window.__tcfapi(
                    "removeEventListener",
            ...
            } else a.setupObserver();
        }),
        (a.setupObserver = function () {
          (($n._pokiSessionGlobalName = "pokiSession"),
            ($n._pokiUserGlobalName = "pokiUser"),
            ($n._pokiContextGlobalName = "pokiContext"),
            ($n._pokiTrackerGlobalName = "pokiTracker"),
            (function (e, a, f) {
              var h = null;
              try {
                ((h = u())
              ...
              var e,
                ...
                a =
                  ...
                  void 0 === r
                    ? void 0
                    : r.is_new) || !1;
              (i || ((i = t("poki_uid")), (a = "1" === t("poki_uid_new"))),
                (i &&
                  (function (e) {
                  ...
                  ((i = o()), (a = !0)),
                n("poki_uid", i),
                n("poki_uid_new", a ? "1" : "0"),
                (window[window._pokiUserGlobalName] = { id: i, is_new: a }));
            })(),
            ($n[$n._pokiContextGlobalName] = {
              tag: null,
              site: { id: null, domain: window.location.hostname, prefix: "" },
              page: {
                id: S.contentGameID,
                type: "external",
              ...
              user: $n[$n._pokiUserGlobalName],
              session: $n[$n._pokiSessionGlobalName],
            }),
            ($n.pokiGTM = $n.pokiGTM || []),
            O("https://a.poki-cdn.com/t2.js"),
            (a.logToObserver = !0));
        }),
        (a.logToObserver = !1),
  ...
  const no = function () {
    ...
    if (window.crypto && crypto.getRandomValues && Uint32Array) {
      var o = new Uint32Array(12);
      crypto.getRandomValues(o);
      for (n = 0; n < 12; n++) t += String.fromCharCode(255 & o[n]);
    } else
      for (n = 0; n < 12; n++)
        t += String.fromCharCode(Math.floor(256 * Math.random()));
    return btoa(t).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, "");
  };
  var oo = function (e, t, n, o) {
      return new (n || (n = Promise))(function (r, i) {
        function a(e) {
          try {
            c(o.next(e));
    ...
    ao = Math.random().toString(36).substring(2);
  function so() {
      ...
      (e.collectAndLog = function () {
        return oo(this, void 0, void 0, function () {
          ...
          return ro(this, function (n) {
            switch (n.label) {
              case 0:
                return (n.trys.push([0, 2, , 3]), (t = {}), [4, so()]);
              case 1:
                return (
                  (t.cookies = n.sent()),
  ...
  function fo() {
    window.navigator.userAgent.match(po) &&
      !S.isPlayground &&
        ...
        ((this.gameStarted = !1),
          ...
          (this.asyncScreenshotLoader = function () {
            window.addEventListener(
              "message",
              function (t) {
                return vo(o, void 0, void 0, function () {
                  var n;
                            ...
                            kt(void 0, void 0, void 0, function () {
                              ...
                              return At(this, function (s) {
                                switch (s.label) {
                                  ...
                                  case 4:
                                    return (
                                      (a = { screenshot: n, errors: et }),
                                      r.callback && (a.callback = r.callback),
                                      x.sendMessage(
          ...
          (this.setDebug = function (t) {
            (void 0 === t && (t = !0),
              window.location.hostname.endsWith("poki-gdn.com")
                ? t && to.track(e.tracking.debugTrueInProduction)
                : ((T.debug = t),
                    ...
                    ? (function () {
                        if (rt) {
                          ((rt = !1),
                            ...
                            window.removeEventListener("error", ct));
                          try {
                            console.error = nt;
                          } catch (e) {}
                        }
          ...
          (this.gameLoadingFinished = function () {
            ...
            (clearInterval(window.pokiCancelProgressInterval),
              to.track(e.tracking.screen.gameLoadingFinished, {
                transferSize: lo(),
                trackers: ((o = window),
                (r = []),
                ("function" != typeof o.ga && "function" != typeof o.gtag) ||
                  r.push("ga"),
                o.mixpanel &&
                  "function" == typeof o.mixpanel.track &&
                  r.push("mixpanel"),
                "function" == typeof o.GameAnalytics && r.push("gameanalytics"),
                (o.kongregateAPI || o.kongregate) && r.push("kongregate"),
                o.FlurryAgent && r.push("flurry"),
                o.Countly && r.push("countly"),
                o.amplitude && r.push("amplitude"),
                r).join(","),
                error_session_id: it,
                now:
                  Math.round(
          ...
          (this.gameplayStart = function (t) {
            if (o.ignoreEvents())
              ...
              ((o.duringGameplay = !0),
                o.gameStarted ||
                  ((o.gameStarted = !0),
                  to.track(e.tracking.screen.firstRound),
                  o.monetization.startStartAdsAfterTimer()));
              var n = o.badEventsCounter;
              (setTimeout(function () {
                var r;
                (performance.now() - o.lastInteractionTime < 5e3 &&
                  (r = o.lastInteractionEvent),
                  to.track(
                    e.tracking.screen.gameplayStart,
                    ho(ho({}, t), {
                      fps: o.fpsStats.stats(),
                      badEvents: n,
                      interaction: r,
                    }),
                  ));
              }, 0),
                clearTimeout(o.playerActiveTimeout),
                (o.playerActiveTimeout = setTimeout(function () {
                  (window.addEventListener(
                    "pointermove",
                    o.__playerIsActiveEvent,
                  ),
                    document.addEventListener(
                      "keydown",
                      o.__playerIsActiveEvent,
                ...
                o.lastGamePlayStop &&
                  (o.lastGamePlayStop > performance.now() - 50 &&
                    o.badEventsCounter++,
                  (o.lastGamePlayStop = 0)));
            }
          }),
          (this.gameplayStop = function (t) {
            o.ignoreEvents()
              ? T.debug &&
                console.error("gameplayStop ignored because of too many events")
              : ((o.duringGameplay = !1),
                to.track(
                  e.tracking.screen.gameplayStop,
                  ho(ho({}, t), { fps: o.fpsStats.stats() }),
                ),
                clearTimeout(o.playerActiveTimeout),
                window.removeEventListener(
                  "pointermove",
                ...
                (o.lastGamePlayStop = performance.now()));
          }),
          (this.measure = function (t, n, o) {
            (void 0 === n && (n = ""),
              void 0 === o && (o = ""),
              to.track(e.tracking.measure, {
                category: "".concat(t),
                action: "".concat(n),
                label: "".concat(o),
                p4d_game_id: S.gameID,
          ...
          (this.customEvent = function (t, n, r) {
            (void 0 === r && (r = {}),
              t && n
                ? ((t = String(t)),
                  (n = String(n)),
          ...
          (this.rewardedBreak = function (t, n, r, i) {
            return new Promise(function (a) {
              var s,
                c = {};
              ("function" == typeof t
                ? ((s = t),
                  void 0 !== n && (c.category = n),
                  void 0 !== r && (c.details = r),
                  void 0 !== i && (c.placement = i))
                : (void 0 !== t && (c.category = t),
                  void 0 !== n && (c.details = n),
                  void 0 !== r && (c.placement = r)),
                setTimeout(function () {
                  c.category &&
                    performance.now() - o.lastInteractionTime < 500 &&
                    (c.from = o.lastInteractionEvent);
          ...
          (this.displayAd = function (t, n, r, i) {
            var a = no();
            to.track(e.tracking.screen.displayAd, {
              size: n,
              opportunityId: a,
              duringGameplay: o.duringGameplay,
            });
            var s = {
              container: t,
              opportunityId: a,
              ...
              new Promise(function (n, o) {
                ...
                if (S.isPokiIframe || S.isInspector) {
                  ...
                  (i.forEach(function (e) {
                    void 0 !== t[e] &&
                      null !== t[e] &&
                      r.set("gd".concat(e), t[e]);
                  }),
                    n("".concat(a, "?").concat(r.toString())),
                    x.sendMessage(e.message.setPokiURLParams, { params: t }));
                } else
          ...
          (this.enableEventTracking = function (e) {
            window.top === window && to.setupObserverWithCMP(e || 0);
          }),
          (this.error = function (e, t) {
            console.error("PokiSDK.".concat(e, ": ").concat(t));
          }),
          (this.__playerIsActiveEvent = function () {
            (window.removeEventListener("pointermove", o.__playerIsActiveEvent),
              document.removeEventListener("keydown", o.__playerIsActiveEvent),
              to.track(e.tracking.screen.playerActive),
              (o.playerActiveTimeout = setTimeout(function () {
                (window.addEventListener(
                  "pointermove",
                  o.__playerIsActiveEvent,
          ...
          (this.__interactionEvent = function (e) {
            ("pointerdown" === e.type
              ? (o.lastInteractionEvent = "pointerdown")
              : "keydown" === e.type
                ? (o.lastInteractionEvent = "keydown-".concat(e.code))
                : (o.lastInteractionEvent = "unknown"),
              (o.lastInteractionTime = performance.now()));
          }),
          ...
          setInterval(function () {
            o.badEventsCounter = Math.max(o.badEventsCounter - 1, 0);
          }, 1e3));
      }
      return (
            ...
            new Promise(function (o) {
              (n.monetization.init(
                ho(
                  {
                    onReady: function () {
                      (v("preroll") && n.monetization.forcePreroll(), o());
                    },
                  },
                  t,
                ),
                ...
                document.location.search.length <= 1 &&
                  (x.sendMessage(e.message.sendInspectorBadBehavior, {
  ...
  function xo(e) {
    var t = "/".concat(Ao, "/debug-display/debug-display-").concat(e);
    return (
      T.debug ||
        (t = S.isPokiIframe
          ? "/"
  ...
  const Io = function () {
    ...
    var n = encodeURIComponent(
      ...
      o = "https://devs-api.poki.com/gameinfo/@sdk?href="
        .concat(n, "&referrer=")
        .concat(t);
    return fetch(o, {
      method: "GET",
      ...
      .catch(function (e) {
        return (function (e) {
          return Eo(this, void 0, void 0, function () {
            var t, n, o, r, i, a, s, c, u, l, d, p;
            return To(this, function (f) {
              switch (f.label) {
                case 0:
                  (console.error(e), (f.label = 1));
                case 1:
                  return (
                    f.trys.push([1, 4, , 5]),
                ...
                case 3:
                  if (
                    ...
                    try {
                      ((u = new XMLHttpRequest()).open("POST", c, !0),
                        u.send(n));
                    } catch (e) {}
                  return [3, 5];
                case 4:
  ...
  var Po = (function () {
    ...
    return (
      (t.prototype.setTimings = function (e) {
        var t = So.adTiming,
          n = e.preroll,
          o = void 0 === n ? t.preroll : n,
          r = e.timePerTry,
          i = void 0 === r ? t.timePerTry : r,
          a = e.timeBetweenAds,
          s = void 0 === a ? t.timeBetweenAds : a,
          c = e.startAdsAfter,
          u = void 0 === c ? t.startAdsAfter : c;
        this.timings = {
          preroll: !1 !== o,
          timePerTry: i,
          timeBetweenAds: s,
        ...
        switch (o.label) {
          case 0:
            return "1" === v("playtest")
              ? [3, 2]
              : e.playtestRecord
                ? e.playtestVersion && e.playtestVersion !== S.versionID
                  ? [2, void 0]
                  : ((t = g() || m() || _t),
                    "desktop" === e.playtestDeviceCategory && t
                      ? [2, void 0]
                      : "mobile" !== e.playtestDeviceCategory || t
                        ? [4, Mo()]
                        : [2, void 0])
                : [2, void 0];
          case 1:
            if (!o.sent()) return [2, void 0];
            o.label = 2;
          case 2:
            return (
  ...
  var Bo = function () {
      S.isPokiIframe &&
        (setTimeout(uo.trackSavegames, 1e4),
    ...
    jo = (function () {
      function t() {
        var t = this;
        ((this.callbacks = {}),
          (this.adTiming = So.adTiming),
          (this.mutationChecker = new MutationObserver(
            this.mutationObserved.bind(this),
          )),
          (this.videoState = Fo),
          (this.adTimings = new Co({ fake: !0 })),
          (this.initializing = !1),
              ...
              if (T.debug) r();
                ...
                (0,
                  Io()
                    .then(function (e) {
                      ((t.adTiming =
                        (null == e ? void 0 : e.adTiming) || So.adTiming),
                        (t.specialConditions =
                          (null == e ? void 0 : e.specialConditions) || []),
                        r(),
                        e &&
                          Do(e)
                            .then(function (t) {
          ...
          (this.postSDKMessage = function (n) {
            for (var o = [], r = 1; r < arguments.length; r++)
              o[r - 1] = arguments[r];
            return No(t, Vo([n], o, !0), void 0, function (t, n) {
              return (
                void 0 === n && (n = {}),
                Go(this, function (o) {
                  return (
                    x.sendMessage(
                      e.message.sendCommand,
                      { event: t, data: n },
                      window.top,
                    ),
                    [2]
          ...
          (this.handleMessageReceived = function (n) {
            var o, r, i, a, s, c, u, l, d, p, f, h;
            switch (
              null === (o = null == n ? void 0 : n.data) || void 0 === o
                ? void 0
                : o.type
            ) {
              ...
              case "hoist_videoAd_onStart":
                g = (
                  null === (l = null == n ? void 0 : n.data) || void 0 === l
                    ? void 0
                    : l.data
                ).opportunityId;
                if (t.videoState !== zo) return;
                if (!t.callbacks[g]) return;
                var y = t.callbacks[g],
                  w = y.onStart,
                  b = y.position;
                (w && w(),
                  L.dispatchEvent(e.playtest.startVideo, { position: b }),
                  (t.videoState = "playing"));
                break;
              case "hoist_videoAd_onFinish":
                var k =
                    null === (d = null == n ? void 0 : n.data) || void 0 === d
                      ? void 0
                      : d.data,
                  A = ((g = k.opportunityId), k.rewardAllowed);
                if (!t.callbacks[g]) return;
                var S = t.callbacks[g],
                  x = S.onFinish;
                b = S.position;
                if (t.videoState === zo)
                  return (
                    x && (b === e.ads.position.rewarded ? x(!!A) : x()),
                    (t.videoState = Fo),
                    void delete t.callbacks[g]
                  );
                (x && x(A),
                  L.dispatchEvent(e.playtest.stopVideo),
                  (t.videoState = Fo),
                  delete t.callbacks[g]);
                break;
              case "hoist_playgroundInit":
                (null === (f = (p = t.callbacks).playgroundInit) ||
                  void 0 === f ||
                  f.call(p),
              ...
              case "hoist_displayAd_destroy":
                var E = (
                  null === (h = null == n ? void 0 : n.data) || void 0 === h
                    ? void 0
                    : h.data
                ).containerID;
          ...
          (this.cleanAdContainer = function (e) {
            var t = document.querySelector(
              '*[data-poki-ad-container-id="'.concat(e, '"]'),
            );
            if (t) {
      ...
      return (
        ...
        (t.prototype.setVolume = function (e) {
          this.postSDKMessage("setVolume", { volume: e || 1 });
        }),
          ...
          this.videoState === Fo
            ? ((this.videoState = zo),
              (this.callbacks[a] = {
                ...
                onFinish: function (e) {
                  o && "function" == typeof o && o({ rewardAllowed: e });
                },
              }),
            ...
            : o &&
              (r === e.ads.position.rewarded ? o({ rewardAllowed: !1 }) : o());
        }),
        (t.prototype.displayAd = function (e) {
          if (S.kioskMode) return !1;
          var t = e.container,
            n = e.size,
            o = e.opportunityId,
            r = e.onCanDestroy,
          ...
          if (!t)
            return (
              console.error("displayAd: given container doesn't exist"),
              !1
            );
          var a = t.getAttribute("data-poki-ad-container-id") || no();
          (this.cleanAdContainer(a),
            t.setAttribute("data-poki-ad-container-id", a),
            t.setAttribute("data-poki-opportunity-id", o));
          var s = n.split("x").map(function (e) {
              return parseInt(e, 10);
            }),
            c = s[0],
            u = s[1],
            l = document.createElement("div");
          ((l.style.width = "".concat(c, "px")),
        ...
        (t.prototype.destroyAd = function (e) {
          ...
          } else console.error("destroyAd: given container doesn't exist");
        }),
        (t.prototype.mutationObserved = function (e) {
          var t = this;
          e.forEach(function (e) {
            var n, o, r, i, a;
            ("childList" === (null == e ? void 0 : e.type) &&
              (null ===
                (o =
                  null === (n = e.removedNodes) || void 0 === n
                    ? void 0
                    : n.forEach) ||
                void 0 === o ||
                o.call(n, function (e) {
                  var n;
                  (null === (n = null == e ? void 0 : e.getAttribute) ||
                  void 0 === n
                    ? void 0
                    : n.call(e, "data-poki-ad-container-id")) && t.destroyAd(e);
                })),
              "attributes" === (null == e ? void 0 : e.type) &&
                (null ===
                  (i =
                    null === (r = null == e ? void 0 : e.target) || void 0 === r
                      ? void 0
                      : r.getAttribute) || void 0 === i
                  ? void 0
                  : i.call(r, "data-poki-ad-container-id")) &&
                ("none" ===
                  (null == (a = e.target) ? void 0 : a.style.display) ||
                  parseInt(a.style.opacity, 10) < 1 ||
                  "hidden" === a.style.visibility) &&
                t.destroyAd(e.target));
          });
        }),
    ...
    Ko = (function (e) {
      function t() {
        var t = this,
          n = new Ho();
        return (
          ((t = e.call(this, n) || this).SDK = n),
          window.addEventListener(
            "message",
            t.monetization.handleMessageReceived,
          ),
          t
        );
      }
  ...
  var Wo = new Ko();
  for (var Yo in Wo) window.PokiSDK[Yo] = Wo[Yo];
})();
