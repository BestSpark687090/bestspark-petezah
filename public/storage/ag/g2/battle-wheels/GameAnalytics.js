...
(!(function (e) {
  for (
    ...
    (c &&
      (8 > l && (o[l] = d(e.pow(u, 0.5))), (a[l] = d(e.pow(u, 1 / 3))), l++),
      u++);
  }
  var f = [];
  s = s.SHA256 = r.extend({
        ...
        (!(function (e) {
          ...
          (function (e) {
            ((e[(e.Undefined = 0)] = "Undefined"),
              ...
              (e[(e.InvalidEventPartCharacters = 4)] =
              ...
              (e[(e.NotFoundInAvailableCurrencies = 8)] =
                "NotFoundInAvailableCurrencies"),
              (e[(e.InvalidAmount = 9)] = "InvalidAmount"),
              (e[(e.NotFoundInAvailableItemTypes = 10)] =
              ...
              (e[(e.InvalidEventIdCharacters = 13)] =
                "InvalidEventIdCharacters"),
              (e[(e.InvalidProgressionStatus = 15)] =
...
var i;
(i.EGAErrorSeverity, i.EGAProgressionStatus, i.EGAResourceFlowType);
(!(function (e) {
  !(function (e) {
    var n;
    !(function (e) {
        ...
        r = (function () {
          ...
          return (
            ...
            (e.decode64 = function (n) {
              ...
              do {
                ((t =
                  (e.keyStr.indexOf(n.charAt(l++)) << 2) |
                  ((s = e.keyStr.indexOf(n.charAt(l++))) >> 4)),
                  (r =
                    ((15 & s) << 4) |
                    ((o = e.keyStr.indexOf(n.charAt(l++))) >> 2)),
      ...
      var u = (function () {
        ...
        return (
          (n.validateBusinessEvent = function (e, i, u, l, c) {
            return n.validateCurrency(e)
              ? i < 0
                ...
                : n.validateShortString(u, !0)
                  ? n.validateEventPartLength(l, !1)
                    ? n.validateEventPartCharacters(l)
                      ? n.validateEventPartLength(c, !1)
                        ? n.validateEventPartCharacters(c)
                          ? null
                          : (t.w(
          ...
          (n.validateResourceEvent = function (u, l, c, v, g, f, m) {
            return u == e.EGAResourceFlowType.Undefined
              ? (t.w(
              ...
              : l
                ? i.stringArrayContainsString(f, l)
                  ? c > 0
                    ? v
                      ? n.validateEventPartLength(v, !1)
                        ? n.validateEventPartCharacters(v)
                          ? i.stringArrayContainsString(m, v)
                            ? n.validateEventPartLength(g, !1)
                              ? n.validateEventPartCharacters(g)
                                ? null
                                : (t.w(
          ...
          (n.validateAdEvent = function (i, u, l, c) {
            return i == e.EGAAdAction.Undefined
              ...
              : u == e.EGAAdType.Undefined
                ...
                : n.validateShortString(l, !1)
                  ? n.validateString(c, !1)
                    ? null
                    : (t.w(
          ...
          (n.validateKeys = function (e, n) {
            return !(
              !i.stringMatch(e, /^[A-z0-9]{32}$/) ||
              !i.stringMatch(n, /^[A-z0-9]{40}$/)
            );
          }),
          ...
          (n.validateEventIdLength = function (e) {
            return (
              !!e && !!i.stringMatch(e, /^[^:]{1,64}(?::[^:]{1,64}){0,4}$/)
            );
          }),
          ...
          (n.validateArrayOfStrings = function (e, n, i, r, s) {
            ...
            if ((o || (o = "Array"), !s))
              return (
                t.w(o + " validation failed: array cannot be null. "),
                !1
              );
            if (0 == i && 0 == s.length)
              return (
                t.w(o + " validation failed: array cannot be empty. "),
                !1
              );
            if (e > 0 && s.length > e)
              return (
      ...
      var i = (function () {
        ...
        return (
          ...
          (e.getBrowserVersionString = function () {
            ...
            if (
              "Chrome" === i[1] &&
              null != (n = t.match(/\b(OPR|Edge|UBrowser)\/(\d+)/))
            )
              return n
                .slice(1)
                .join(" ")
            ...
            return (
              null != (n = t.match(/version\/(\d+)/i)) && r.splice(1, 1, n[1]),
              r.join(" ").toLowerCase()
            );
          }),
      ...
      var s = (function () {
        ...
        return (
          ...
          (e.save = function (n) {
            e.isStorageAvailable()
              ? (localStorage.setItem(
                  e.StringFormat(e.KeyFormat, n, e.EventsStoreKey),
                  JSON.stringify(e.instance.eventsStore),
                ),
                localStorage.setItem(
                  e.StringFormat(e.KeyFormat, n, e.SessionsStoreKey),
                  JSON.stringify(e.instance.sessionsStore),
                ),
                localStorage.setItem(
                  e.StringFormat(e.KeyFormat, n, e.ProgressionStoreKey),
                  JSON.stringify(e.instance.progressionStore),
                ),
                localStorage.setItem(
                  e.StringFormat(e.KeyFormat, n, e.ItemsStoreKey),
          ...
          (e.setItem = function (n, t, i) {
            ...
            i
              ? (e.instance.storeItems[r] = i)
              : r in e.instance.storeItems && delete e.instance.storeItems[r];
          }),
          ...
          (e.getStore = function (n) {
            switch (n) {
              ...
              default:
                return (
                  r.w("GAStore.getStore(): Cannot find store: " + n),
                  null
                );
            }
          }),
        ...
        u = (function () {
          ...
          return (
            ...
            (e.setAvailableCustomDimensions01 = function (n) {
              t.validateCustomDimensions(n) &&
                ((e.instance.availableCustomDimensions01 = n),
            ...
            (e.setAvailableCustomDimensions02 = function (n) {
              t.validateCustomDimensions(n) &&
                ((e.instance.availableCustomDimensions02 = n),
                e.validateAndFixCurrentDimensions(),
                r.i(
            ...
            (e.setAvailableCustomDimensions03 = function (n) {
              t.validateCustomDimensions(n) &&
                ((e.instance.availableCustomDimensions03 = n),
                e.validateAndFixCurrentDimensions(),
                r.i(
            ...
            (e.setAvailableResourceCurrencies = function (n) {
              t.validateResourceCurrencies(n) &&
                ((e.instance.availableResourceCurrencies = n),
                r.i(
            ...
            (e.setAvailableResourceItemTypes = function (n) {
              t.validateResourceItemTypes(n) &&
                ((e.instance.availableResourceItemTypes = n),
                r.i(
            ...
            (e.getProgressionTries = function (n) {
              return n in e.instance.progressionTries
                ? e.instance.progressionTries[n]
                : 0;
            }),
            (e.clearProgressionTries = function (n) {
              n in e.instance.progressionTries &&
                delete e.instance.progressionTries[n];
              var t = [];
            ...
            (e.getEventAnnotations = function () {
              ...
              if (
                (t.validateConnectionType(r) && (n.connection_type = r),
              ...
              return (
                e.instance.abId && (n.ab_id = e.instance.abId),
                e.instance.abVariantId &&
                  (n.ab_variant_id = e.instance.abVariantId),
            ...
            (e.cacheIdentifier = function () {
              e.instance.userId
                ...
                : e.instance.defaultUserId &&
                  (e.instance.identifier = e.instance.defaultUserId);
            }),
            (e.ensurePersistedStates = function () {
              s.isStorageAvailable() && s.load(e.getGameKey());
              var n = e.instance;
              (n.setDefaultId(
                null != s.getItem(e.getGameKey(), e.DefaultUserIdKey)
                  ? s.getItem(e.getGameKey(), e.DefaultUserIdKey)
                  : i.createGuid(),
              ),
                (n.sessionNum =
                  null != s.getItem(e.getGameKey(), e.SessionNumKey)
                    ? Number(s.getItem(e.getGameKey(), e.SessionNumKey))
                    : 0),
                (n.transactionNum =
                  null != s.getItem(e.getGameKey(), e.TransactionNumKey)
                    ? Number(s.getItem(e.getGameKey(), e.TransactionNumKey))
                    : 0),
                n.currentCustomDimension01
                  ...
                  : ((n.currentCustomDimension01 =
                      null != s.getItem(e.getGameKey(), e.Dimension01Key)
                ...
                n.currentCustomDimension02
                  ...
                  : ((n.currentCustomDimension02 =
                      null != s.getItem(e.getGameKey(), e.Dimension02Key)
                        ? s.getItem(e.getGameKey(), e.Dimension02Key)
                        : ""),
                    n.currentCustomDimension02),
                n.currentCustomDimension03
                  ...
                  : ((n.currentCustomDimension03 =
                      null != s.getItem(e.getGameKey(), e.Dimension03Key)
                        ? s.getItem(e.getGameKey(), e.Dimension03Key)
                        : ""),
                    n.currentCustomDimension03));
              var t =
                null != s.getItem(e.getGameKey(), e.SdkConfigCachedKey)
                  ? s.getItem(e.getGameKey(), e.SdkConfigCachedKey)
                  : "";
              if (t) {
            ...
            (e.getConfigurationStringValue = function (n, t) {
              return e.instance.configurations[n]
                ? e.instance.configurations[n].toString()
                : t;
            }),
            ...
            (e.addRemoteConfigsListener = function (n) {
              e.instance.remoteConfigsListeners.indexOf(n) < 0 &&
                e.instance.remoteConfigsListeners.push(n);
            }),
            ...
            (e.addOnBeforeUnloadListener = function (n) {
              e.instance.beforeUnloadListeners.indexOf(n) < 0 &&
                e.instance.beforeUnloadListeners.push(n);
            }),
            ...
            (e.notifyBeforeUnloadListeners = function () {
              for (
                var n = e.instance.beforeUnloadListeners, t = 0;
                t < n.length;
                ++t
              )
        ...
        r = (function () {
          ...
          return (
            (e.execute = function (n, r, s, o) {
              var a = new Date();
              if (
                (e.timestampMap[r] || (e.timestampMap[r] = a),
                e.countMap[r] || (e.countMap[r] = 0),
                (a.getTime() - e.timestampMap[r].getTime()) / 1e3 >= 3600 &&
                  ((e.timestampMap[r] = a), (e.countMap[r] = 0)),
        ...
        c = (function () {
          ...
          return (
            ...
            (e.prototype.sendSdkErrorEvent = function (n, r, a, d, u, l, c) {
              if (
                t.isEventSubmissionEnabled() &&
                s.validateSdkErrorEvent(l, c, n, r, a)
              ) {
                var v,
                  g = this.baseUrl + "/" + l + "/" + this.eventsUrlPath,
                  f = "",
                ...
                (y.push(m),
                  (v = JSON.stringify(y))
                    ? o.execute(g, f, v, c)
                    : i.w("sendSdkErrorEvent: JSON encoding failed."));
              }
            }),
            (e.sendEventInArrayRequestCallback = function (i, r, s, o) {
              ...
              var m = e.instance.processRequestResponse(
                v,
                i.statusText,
                c,
                "Events",
              ...
              if (
                m == n.EGAHTTPApiResponse.Ok ||
                m == n.EGAHTTPApiResponse.Created ||
                m == n.EGAHTTPApiResponse.BadRequest
              ) {
                var E = c ? JSON.parse(c) : {};
                if (null == E)
                  return (
                    s(n.EGAHTTPApiResponse.JsonDecodeFailed, null, g, f),
                    void e.instance.sendSdkErrorEvent(
                      a.Http,
                      d.EventsHttp,
                      u.FailHttpJsonDecode,
                      l.Undefined,
                      c,
                      t.getGameKey(),
                      t.getGameSecret(),
            ...
            (e.initRequestCallback = function (i, r, o, c) {
              ...
              var f = v ? JSON.parse(v) : {},
                m = e.instance.processRequestResponse(
                  g,
                  i.statusText,
                  v,
                  "Init",
              ...
              if (
                ...
                if (null == f)
                  return (
                    o(n.EGAHTTPApiResponse.JsonDecodeFailed, null, "", 0),
                    void e.instance.sendSdkErrorEvent(
                      a.Http,
                      d.InitHttp,
                      u.FailHttpJsonDecode,
                ...
                if (m !== n.EGAHTTPApiResponse.BadRequest) {
                  ...
                  E
                    ? o(m, E, "", 0)
                    : o(n.EGAHTTPApiResponse.BadResponse, null, "", 0);
                } else o(m, null, "", 0);
              } else o(m, null, "", 0);
            }),
      ...
      (c = (function () {
        ...
        return (
          (c.customEventFieldsErrorCallback = function (n, t) {
            if (s.isEventSubmissionEnabled()) {
              ...
              (c.timestampMap[n] || (c.timestampMap[n] = i),
                ...
                (i.getTime() - c.timestampMap[n].getTime()) / 1e3 >= 3600 &&
                  ((c.timestampMap[n] = i), (c.countMap[n] = 0)),
            ...
            if (s.isEventSubmissionEnabled()) {
              ...
              ((e.category = c.CategorySessionStart),
                ...
                t.setItem(
                  s.getGameKey(),
                  s.SessionNumKey,
                  s.getSessionNum().toString(),
                ),
                c.addDimensionsToEvent(e));
              var n = s.instance.currentGlobalCustomEventFields;
              (c.addCustomFieldsToEvent(
                e,
                s.validateAndCleanCustomFields(
                  n,
                  c.customEventFieldsErrorCallback,
                ),
              ),
                c.addEventToStore(e),
            ...
            if (s.isEventSubmissionEnabled()) {
              ...
              if (null == m) {
                ...
                (d &&
                  ...
                  (p.score = Math.round(a)),
                  n === e.EGAProgressionStatus.Fail &&
                    s.incrementProgressionTries(E),
          ...
          (c.addErrorEvent = function (e, n, t, i, r) {
            if ((void 0 === r && (r = !1), s.isEventSubmissionEnabled())) {
              ...
              if (null == d) {
                ...
                (o.i(
                  "Add ERROR event: {severity:" + a + ", message:" + n + "}",
                ),
                  c.addEventToStore(v));
              } else
                u.instance.sendSdkErrorEvent(
            ...
            if (s.isEventSubmissionEnabled()) {
              ...
              if (null == h) {
                ...
                ((A.category = c.CategoryAds),
                  ...
                  (A.ad_type = E),
                  (A.ad_action = m),
                  n == e.EGAAdAction.FailedShow &&
                    p.length > 0 &&
                    (A.ad_fail_show_reason = p),
                  !v ||
                ...
                (c.addCustomFieldsToEvent(
                  ...
                  o.i(
                    "Add AD event: {ad_sdk_name:" +
                      ...
                      ", ad_action:" +
                      m +
                      (n == e.EGAAdAction.FailedShow && p.length > 0
                        ? ", ad_fail_show_reason:" + p
                        : "") +
                      (!v ||
                      (t != e.EGAAdType.RewardedVideo && t != e.EGAAdType.Video)
                        ? ""
                        : ", ad_duration:" + d) +
                      "}",
                  ),
          ...
          (c.processEvents = function (e, d) {
            if (s.isEventSubmissionEnabled())
              try {
                ...
                if (!E || 0 == E.length)
                  return (
                    o.i("Event queue: No events to send"),
                    void c.updateSessionStore()
                  );
                if (E.length > c.MaxEventCount) {
                  if (!(E = t.select(i.Events, g, !0, c.MaxEventCount))) return;
                ...
                if (
                  (o.i("Event queue: Sending " + E.length + " events."),
                ...
                (o.e("Error during ProcessEvents(): " + e.stack),
                  u.instance.sendSdkErrorEvent(
                    n.EGASdkErrorCategory.Json,
                    n.EGASdkErrorArea.ProcessEvents,
                    n.EGASdkErrorAction.JsonError,
                    n.EGASdkErrorParameter.Undefined,
                    e.stack,
                    s.getGameKey(),
                    s.getGameSecret(),
                  ));
          ...
          (c.processEventsCallback = function (e, n, s, a) {
            var u = [];
            if ((u.push(["status", r.Equal, s]), e === d.Ok))
              (t.delete(i.Events, u),
              ...
              if (n) {
                var c,
                  v = 0;
                for (var g in n) (0 == v && (c = n[g]), ++v);
                e === d.BadRequest && c.constructor === Array
                  ? o.w(
                      "Event queue: " +
                        a +
                        " events sent. " +
                ...
                try {
                  if (
                    ...
                    return (
                      ...
                      void u.instance.sendSdkErrorEvent(
                        n.EGASdkErrorCategory.Database,
                        n.EGASdkErrorArea.AddEventsToStore,
                        n.EGASdkErrorAction.DatabaseTooLarge,
                        n.EGASdkErrorParameter.Undefined,
                        "",
                        s.getGameKey(),
                        s.getGameSecret(),
                  ...
                  ((g.category = d.category),
                    ...
                    t.insert(i.Events, g),
                    e.category == c.CategorySessionEnd
                      ? t.delete(i.Sessions, [
                          ["session_id", r.Equal, d.session_id],
                        ])
                      : c.updateSessionStore(),
          ...
          (c.adActionToString = function (n) {
            return n == e.EGAAdAction.Clicked ||
              n == e.EGAAdAction[e.EGAAdAction.Clicked]
              ? "clicked"
              : n == e.EGAAdAction.Show ||
                  n == e.EGAAdAction[e.EGAAdAction.Show]
                ? "show"
                : n == e.EGAAdAction.FailedShow ||
                    n == e.EGAAdAction[e.EGAAdAction.FailedShow]
                  ? "failed_show"
                  : n == e.EGAAdAction.RewardReceived ||
                      n == e.EGAAdAction[e.EGAAdAction.RewardReceived]
                    ? "reward_received"
                    : "";
          }),
          (c.adErrorToString = function (n) {
            return n == e.EGAAdError.Unknown ||
              n == e.EGAAdError[e.EGAAdError.Unknown]
              ? "unknown"
              : n == e.EGAAdError.Offline ||
                  n == e.EGAAdError[e.EGAAdError.Offline]
                ? "offline"
                : n == e.EGAAdError.NoFill ||
                    n == e.EGAAdError[e.EGAAdError.NoFill]
                  ? "no_fill"
                  : n == e.EGAAdError.InternalError ||
                      n == e.EGAAdError[e.EGAAdError.InternalError]
                    ? "internal_error"
                    : n == e.EGAAdError.InvalidRequest ||
                        n == e.EGAAdError[e.EGAAdError.InvalidRequest]
                      ? "invalid_request"
                      : n == e.EGAAdError.UnableToPrecache ||
                          n == e.EGAAdError[e.EGAAdError.UnableToPrecache]
                        ? "unable_to_precache"
                        : "";
          }),
          (c.adTypeToString = function (n) {
            return n == e.EGAAdType.Video || n == e.EGAAdType[e.EGAAdType.Video]
              ? "video"
              : n == e.EGAAdType.RewardedVideo ||
                  n == e.EGAAdError[e.EGAAdType.RewardedVideo]
                ? "rewarded_video"
                : n == e.EGAAdType.Playable ||
                    n == e.EGAAdError[e.EGAAdType.Playable]
                  ? "playable"
                  : n == e.EGAAdType.Interstitial ||
                      n == e.EGAAdError[e.EGAAdType.Interstitial]
                    ? "interstitial"
                    : n == e.EGAAdType.OfferWall ||
                        n == e.EGAAdError[e.EGAAdType.OfferWall]
                      ? "offer_wall"
                      : n == e.EGAAdType.Banner ||
                          n == e.EGAAdError[e.EGAAdType.Banner]
                        ? "banner"
                        : "";
          }),
        ...
        s = (function () {
          ...
          return (
            ...
            (e.getTimedBlockById = function (n) {
              return n in e.instance.id2TimedBlockMap
      ...
      c = (function () {
        ...
        return (
          ...
          (c.init = function () {
            if (
              (o.touch(),
              (c.methodMap.configureAvailableCustomDimensions01 =
                c.configureAvailableCustomDimensions01),
              (c.methodMap.configureAvailableCustomDimensions02 =
                c.configureAvailableCustomDimensions02),
              (c.methodMap.configureAvailableCustomDimensions03 =
                c.configureAvailableCustomDimensions03),
              (c.methodMap.configureAvailableResourceCurrencies =
                c.configureAvailableResourceCurrencies),
              (c.methodMap.configureAvailableResourceItemTypes =
                c.configureAvailableResourceItemTypes),
              (c.methodMap.configureBuild = c.configureBuild),
              (c.methodMap.configureSdkGameEngineVersion =
                c.configureSdkGameEngineVersion),
              (c.methodMap.configureGameEngineVersion =
                c.configureGameEngineVersion),
              ...
              (c.methodMap.setEnabledManualSessionHandling =
                c.setEnabledManualSessionHandling),
              (c.methodMap.setEnabledEventSubmission =
                c.setEnabledEventSubmission),
              ...
              (c.methodMap.setGlobalCustomEventFields =
                c.setGlobalCustomEventFields),
              ...
              (c.methodMap.addRemoteConfigsListener =
                c.addRemoteConfigsListener),
              (c.methodMap.removeRemoteConfigsListener =
                c.removeRemoteConfigsListener),
              (c.methodMap.getRemoteConfigsValueAsString =
                c.getRemoteConfigsValueAsString),
              (c.methodMap.isRemoteConfigsReady = c.isRemoteConfigsReady),
              (c.methodMap.getRemoteConfigsContentAsString =
                c.getRemoteConfigsContentAsString),
              (c.methodMap.addOnBeforeUnloadListener =
                c.addOnBeforeUnloadListener),
              (c.methodMap.removeOnBeforeUnloadListener =
                c.removeOnBeforeUnloadListener),
              void 0 !== c.getGlobalObject() &&
                void 0 !== c.getGlobalObject().GameAnalytics &&
                void 0 !== c.getGlobalObject().GameAnalytics.q)
            ) {
              var e = c.getGlobalObject().GameAnalytics.q;
              for (var t in e) c.gaCommand.apply(null, e[t]);
            }
          ...
          (c.configureBuild = function (e) {
            (void 0 === e && (e = ""),
              n.performTaskOnGAThread(function () {
                c.isSdkReady(!0, !1)
                  ? t.w("Build version must be set before SDK is initialized.")
                  : a.validateBuild(e)
                    ? r.setBuild(e)
                    : t.i(
          ...
          (c.initialize = function (e, i) {
            ...
            ((s.async = !0),
              ...
              (s.block = function () {
                c.isSdkReady(!0, !1)
                  ? t.w("SDK already initialized. Can only be called once.")
                  : a.validateKeys(e, i)
                    ? (r.setKeys(e, i), c.internalInitialize())
                    : t.w(
          ...
          (c.addBusinessEvent = function (e, t, i, s, a, d, u) {
            if (
              ...
              if (!c.isSdkReady(!0, !0, "Could not add business event")) return;
              l.addBusinessEvent(e, t, i, s, a, d, u);
            } else
              n.performTaskOnGAThread(function () {
                c.isSdkReady(!0, !0, "Could not add business event") &&
                  l.addBusinessEvent(e, t, i, s, a, d, u);
              });
          }),
          (c.addResourceEvent = function (t, i, s, a, d, u, v) {
            if (
              ...
              if (!c.isSdkReady(!0, !0, "Could not add resource event")) return;
              l.addResourceEvent(t, i, s, a, d, u, v);
            } else
              n.performTaskOnGAThread(function () {
                c.isSdkReady(!0, !0, "Could not add resource event") &&
                  l.addResourceEvent(t, i, s, a, d, u, v);
              });
          }),
          ...
          (c.addDesignEvent = function (e, t, i, s) {
            if (
              ...
              if (!c.isSdkReady(!0, !0, "Could not add design event")) return;
          ...
          (c.addErrorEvent = function (t, i, s, a) {
            if (
              ...
              if (!c.isSdkReady(!0, !0, "Could not add error event")) return;
              l.addErrorEvent(t, i, s, a);
            } else
              n.performTaskOnGAThread(function () {
                c.isSdkReady(!0, !0, "Could not add error event") &&
                  l.addErrorEvent(t, i, s, a);
              });
          }),
          (c.addAdEventWithNoAdReason = function (t, i, s, a, d, u, v) {
            if (
              (void 0 === t && (t = e.EGAAdAction.Undefined),
              ...
              if (!c.isSdkReady(!0, !0, "Could not add ad event")) return;
              l.addAdEvent(t, i, s, a, d, 0, !1, u, v);
            } else
              n.performTaskOnGAThread(function () {
                c.isSdkReady(!0, !0, "Could not add ad event") &&
                  l.addAdEvent(t, i, s, a, d, 0, !1, u, v);
              });
          }),
              ...
              n.performTaskOnGAThread(function () {
                e
                  ? (r.setEnabledEventSubmission(e),
                    t.i("Event submission enabled"))
                  : (t.i("Event submission disabled"),
                    r.setEnabledEventSubmission(e));
              }));
          }),
          ...
          (c.newSession = function () {
            (t.i("Starting a new session."),
              ...
              s.instance.requestInit(
                r.instance.configsHash,
          ...
          (c.startNewSessionCallback = function (e, s) {
            if ((e !== d.Ok && e !== d.Created) || !s)
              ...
              ((r.instance.configsHash = s.configs_hash ? s.configs_hash : ""),
                ...
                (r.instance.abVariantId = s.ab_variant_id
                  ? s.ab_variant_id
                  : ""),
                i.setItem(
                  r.getGameKey(),
                  r.SdkConfigCachedKey,
                  u.encode64(JSON.stringify(s)),
                ),
            ...
            if (
              ((r.instance.clientServerTimeOffset = r.getSdkConfig().time_offset
                ? r.getSdkConfig().time_offset
                : 0),
            ...
            (null != f && (f.running = !1), (c.initTimedBlockId = -1));
          }),
          ...
          (c.isSdkReady = function (e, n, i) {
            return (
              ...
              e && !r.isInitialized()
                ...
                : e && !r.isEnabled()
                  ? (n && t.w(i + "SDK is disabled"), !1)
                  : !(e && !r.sessionIsStarted()) ||
                    (n && t.w(i + "Session has not started yet"), !1)
            );
          }),
