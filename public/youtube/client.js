        ...
        function l(t, e, r, i) {
          ...
          if (
            ...
            void 0 === (s = t._events)
              ...
              : (void 0 !== s.newListener && (t.emit('newListener', e, r.listener ? r.listener : r), (s = t._events)), (n = s[e])),
            void 0 === n)
          )
            ((n = s[e] = r), ++t._eventsCount);
          else if (
            ('function' == typeof n ? (n = s[e] = i ? [r, n] : [n, r]) : i ? n.unshift(r) : n.push(r), (o = h(t)) > 0 && n.length > o && !n.warned)
          ) {
            n.warned = !0;
            var c = new Error(
  ...
  (() => {
    ...
    const i = class extends t {
      ...
      overrideParseFromString() {
        this.ctx.override(this.domProto, 'parseFromString', (t, r, i) => {
          ...
          let [o, s] = i;
          const n = new e({ string: o, type: s }, t, r);
      ...
      overrideCreateTreeWalker() {
        this.ctx.override(this.docProto, 'createTreeWalker', (t, r, i) => {
          ...
          const h = new e({ root: o, show: s, filter: n, expandEntityReferences: a }, t, r);
          return (
    ...
    const o = class extends t {
      ...
      overrideAttribute() {
        (this.ctx.override(this.elemProto, 'getAttribute', (t, r, i) => {
          ...
          this.ctx.override(this.elemProto, 'setAttribute', (t, r, i) => {
            if (2 > i.length) return t.apply(r, i);
            let [o, s] = i;
            const n = new e({ name: o, value: s }, t, r);
      ...
      overrideInsertAdjacentHTML() {
        this.ctx.override(this.elemProto, 'insertAdjacentHTML', (t, r, i) => {
          if (2 > i.length) return t.apply(r, i);
          let [o, s] = i;
          const n = new e({ position: o, html: s }, t, r);
      ...
      overrideInsertAdjacentText() {
        this.ctx.override(this.elemProto, 'insertAdjacentText', (t, r, i) => {
          if (2 > i.length) return t.apply(r, i);
          let [o, s] = i;
          const n = new e({ position: o, text: s }, t, r);
    ...
    const s = class extends t {
      ...
      overrideParent() {
        (this.ctx.overrideDescriptor(this.nodeProto, 'parentNode', {
          get: (t, r) => {
            const i = new e({ node: t.call(r) }, t, r);
          ...
          this.ctx.overrideDescriptor(this.nodeProto, 'parentElement', {
            get: (t, r) => {
              const i = new e({ element: t.call(r) }, t, r);
      ...
      overrideOwnerDocument() {
        this.ctx.overrideDescriptor(this.nodeProto, 'ownerDocument', {
          get: (t, r) => {
            const i = new e({ document: t.call(r) }, t, r);
      ...
      overrideNameValue() {
        (this.ctx.overrideDescriptor(this.attrProto, 'name', {
          ...
          this.ctx.overrideDescriptor(this.attrProto, 'value', {
            get: (t, r) => {
              const i = new e({ name: this.name.get.call(r), value: t.call(r) }, t, r);
              return (this.emit('getValue', i), i.intercepted ? i.returnValue : i.data.value);
            },
            set: (t, r, [i]) => {
              const o = new e({ name: this.name.get.call(r), value: i }, t, r);
      ...
      overrideItemMethods() {
        (this.ctx.override(this.attrProto, 'getNamedItem', (t, r, i) => {
          ...
          this.ctx.override(this.attrProto, 'getNamedItemNS', (t, r, i) => {
            if (2 > i.length) return t.apply(r, i);
            let [o, s] = i;
            const n = new e({ namespace: o, localName: s }, t, r);
      ...
      overrideFunction() {
        this.ctx.override(
          ...
          (t, r, i) => {
            ...
            const n = new e({ script: o, args: s }, t, r);
    ...
    const h = class extends t {
      ...
      overrideGetPropertyNames() {
        this.ctx.override(this.Object, 'getOwnPropertyNames', (t, r, i) => {
          if (!i.length) return t.apply(r, i);
          let [o] = i;
          const s = new e({ names: t.call(r, o) }, t, r);
      ...
      overrideGetOwnPropertyDescriptors() {
        this.ctx.override(this.Object, 'getOwnPropertyDescriptors', (t, r, i) => {
          if (!i.length) return t.apply(r, i);
          let [o] = i;
          const s = new e({ descriptors: t.call(r, o) }, t, r);
    ...
    const l = class extends t {
      ...
      overrideRequest() {
        return (
          !!this.fetch &&
          (this.ctx.override(this.window, 'fetch', (t, r, i) => {
            if (!i.length || i[0] instanceof this.Request) return t.apply(r, i);
            let [o, s = {}] = i;
            const n = new e({ input: o, options: s }, t, r);
          ...
          this.ctx.override(
            ...
            (t, r, i) => {
              if (!i.length) return new t(...i);
              let [o, s = {}] = i;
              const n = new e({ input: o, options: s }, t);
      ...
      overrideHeaders() {
        return (
          ...
          this.ctx.override(this.headersProto, 'get', (t, r, [i]) => {
            ...
            const o = new e({ name: i, value: t.call(r, i) }, t, r);
          ...
          this.ctx.override(this.headersProto, 'has', (t, r, i) => {
            ...
            let [o] = i;
            const s = new e({ name: o, value: t.call(r, o) }, t, r);
    ...
    const c = class extends t {
      ...
      overrideOpen() {
        this.ctx.override(this.xhrProto, 'open', (t, r, i) => {
          ...
          const l = new e({ method: o, input: s, async: n, user: a, password: h }, t, r);
          return (
            this.emit('open', l),
      ...
      overrideConstruct() {
        (this.ctx.override(
          ...
          (t, r, i) => {
            if (!i.length) return new t(...i);
            let [o, s = {}] = i;
            const n = new e({ url: o, config: s }, t, r);
    ...
    const u = class extends t {
      ...
      overridePushState() {
        this.ctx.override(this.historyProto, 'pushState', (t, r, i) => {
          if (2 > i.length) return t.apply(r, i);
          let [o, s, n = ''] = i;
          const a = new e({ state: o, title: s, url: n }, t, r);
      ...
      constructor(t) {
        (super(),
          ...
          (this.href = this.WorkerLocation
            ? t.nativeMethods.getOwnPropertyDescriptor(this.workerLocProto, 'href')
      ...
      emulate(t, e) {
                    ...
                    switch (o) {
                      ...
                      case 'hash':
                        i.emit(
                          'hashchange',
                          r.href,
                          t.trim().startsWith('#') ? new URL(t.trim(), r.href).href : new URL('#' + t.trim(), r.href).href,
                          i
                        );
                        break;
                      default: {
        ...
        return (
          ...
          'assign' in this.location &&
            this.ctx.nativeMethods.defineProperty(r, 'assign', {
              value: this.ctx.wrap(this.location, 'assign', (t, i, o) => {
                ((o.length && i === r) || t.call(i), (i = this.location));
                let [s] = o;
                const n = new URL(s, r.href);
          ...
          'ancestorOrigins' in this.location &&
            this.ctx.nativeMethods.defineProperty(r, 'ancestorOrigins', {
              get() {
                const t = [];
    ...
    const w = class extends t {
      ...
      overridePostMessage() {
        this.ctx.override(this.window, 'postMessage', (t, r, i) => {
          ...
          const a = new e({ message: o, origin: s, transfer: n, worker: this.ctx.worker }, t, r);
          return (
            this.emit('postMessage', a),
            a.intercepted
              ? a.returnValue
              : this.ctx.worker
                ? a.target.call(a.that, a.data.message, a.data.transfer)
                : a.target.call(a.that, a.data.message, a.data.origin, a.data.transfer)
          );
        });
      }
      wrapPostMessage(t, r, i = !1) {
        return this.ctx.wrap(t, r, (r, o, s) => {
          ...
          const l = new e({ message: n, origin: a, transfer: h, worker: this.ctx.worker }, r, t);
          return (
            ...
            l.intercepted
              ...
              : i
                ...
                : l.target.call(l.that, l.data.message, l.data.origin, l.data.transfer)
          );
        });
      }
    ...
    const v = class extends t {
      ...
      overrideSendBeacon() {
        this.ctx.override(this.navProto, 'sendBeacon', (t, r, i) => {
          if (!i.length) return t.apply(r, i);
          let [o, s = ''] = i;
          const n = new e({ url: o, data: s }, t, r);
    ...
    const m = class extends t {
      ...
      overrideWorker() {
        this.ctx.override(
          ...
          (t, r, i) => {
            if (!i.length) return new t(...i);
            let [o, s = {}] = i;
            const n = new e({ url: o, options: s }, t, r);
      ...
      overridePostMessage() {
        this.ctx.override(this.workerProto, 'postMessage', (t, r, i) => {
          if (!i.length) return t.apply(r, i);
          let [o, s = []] = i;
          const n = new e({ message: o, transfer: s }, t, r);
    ...
    const y = class extends t {
      ...
      overrideMethods() {
        (this.ctx.override(this.storeProto, 'getItem', (t, r, i) => {
          ...
          let [o] = i;
          const s = new e({ name: o }, t, this.wrappers.get(r) || r);
          ...
          this.ctx.override(this.storeProto, 'setItem', (t, r, i) => {
            ...
            let [o, s] = i;
            const n = new e({ name: o, value: s }, t, this.wrappers.get(r) || r);
          ...
          this.ctx.override(this.storeProto, 'key', (t, r, i) => {
            if (!i.length) return t.apply(this.wrappers.get(r) || r, i);
            let [o] = i;
            const s = new e({ index: o }, t, this.wrappers.get(r) || r);
      ...
      overrideLength() {
        this.ctx.overrideDescriptor(this.storeProto, 'length', {
          get: (t, r) => {
            const i = new e({ length: t.call(this.wrappers.get(r) || r) }, t, this.wrappers.get(r) || r);
      ...
      overrideSetGetProperty() {
        (this.ctx.override(this.cssStyleProto, 'getPropertyValue', (t, r, i) => {
          ...
          this.ctx.override(this.cssStyleProto, 'setProperty', (t, r, i) => {
            if (2 > i.length) return t.apply(r, i);
            let [o, s] = i;
            const n = new e({ property: o, value: s }, t, r);
    ...
    const x = class extends t {
      ...
      overrideWebSocket() {
        (this.ctx.override(
          ...
          (t, r, i) => {
            if (!i.length) return new t(...i);
            const o = new e({ args: i }, t, r);
            return (this.emit('websocket', o), o.intercepted ? o.returnValue : new o.target(o.data.url, o.data.protocols));
          },
          !0
        ),
      ...
      overrideProtocol() {
        this.ctx.overrideDescriptor(this.wsProto, 'protocol', {
          get: (t, r) => {
            const i = new e({ value: t.call(r) }, t, r);
            return (this.emit('protocol', i), i.data.value);
          }
        });
      }
      overrideReadyState() {
        this.ctx.overrideDescriptor(this.wsProto, 'readyState', {
          get: (t, r) => {
            const i = new e({ value: t.call(r) }, t, r);
            return (this.emit('readyState', i), i.data.value);
          }
        });
      }
      overrideSend() {
        this.ctx.override(this.wsProto, 'send', (t, r, i) => {
          const o = new e({ args: i }, t, r);
          return (this.emit('send', o), o.intercepted ? o.returnValue : o.target.call(o.that, o.data.args));
        });
      }
    };
    class b extends t {
      constructor(t = self, e, r = !t.window) {
        (super(),
          ...
          (this.worker = r),
          (this.bareClient = e),
          (this.fetch = new l(this)),
          (this.xhr = new c(this)),
          (this.idb = new f(this)),
          (this.history = new u(this)),
          (this.element = new o(this)),
          (this.node = new s(this)),
          (this.document = new i(this)),
          (this.function = new a(this)),
          (this.object = new h(this)),
          (this.websocket = new x(this)),
          (this.message = new w(this)),
          (this.navigator = new v(this)),
          (this.eventSource = new d(this)),
          (this.attribute = new n(this)),
          (this.url = new g(this)),
          (this.workers = new m(this)),
          (this.location = new p(this)),
          (this.storage = new y(this)),
          (this.style = new P(this)));
      }
      override(t, e, r, i) {
    ...
    'object' == typeof self && (self.UVClient = b);
  })();
})();
