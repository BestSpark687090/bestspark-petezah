...
Designed for restricted enviornments like schools or workplaces.
...
```bash
git clone https://github.com/PeteZah-Games/PeteZahGames
cd PeteZahGames
pnpm install
# Install depends, you don't need to use it if you already have all of them
pnpm install:deps
pnpm build
pnpm start
```
